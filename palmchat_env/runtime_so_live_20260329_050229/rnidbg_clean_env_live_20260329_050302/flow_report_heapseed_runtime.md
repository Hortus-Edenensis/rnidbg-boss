...
- status: `ok`
- native_log: `/Users/haojiejack/github/drizzle-dumper-rust/boss_purecalc/risk/fengkong-slide-solver/artifacts/runtime_so_live_20260329_050229/rnidbg_clean_env_live_20260329_050302/rnidbg_trace_clean_env/palmchat_native.log`
- config_path: `/Users/haojiejack/github/drizzle-dumper-rust/boss_purecalc/risk/fengkong-slide-solver/artifacts/runtime_so_live_20260329_050229/rnidbg_clean_env_live_20260329_050302/rnidbg_config.clean_env.device_maps_full.heapseed_runtime.json`
- trace_out_dir: `/Users/haojiejack/github/drizzle-dumper-rust/boss_purecalc/risk/fengkong-slide-solver/artifacts/runtime_so_live_20260329_050229/rnidbg_clean_env_live_20260329_050302/rnidbg_trace_clean_env`
- flow: `setLxData->createCKey->getEncryptedCKey->cipherWithHashKey`

## Steps
- `cipherWithHashKey` duration_ms=91787 done_note=`bytes_len=64` return=`object:byte_array(len=64)`
- `createCKey` duration_ms=38
- `getEncryptedCKey` duration_ms=53 done_note=`bytes_len=256`
