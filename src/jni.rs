...
impl<T: Clone> Jni<T> for TestJni<'_, T> {
    fn resolve_method(
        ...
        unimplemented!(
            "MyJni resolve_method: signature: L{};->{}{}, static={}",
            class.name,
            name,
            signature,
            is_static
    ...
    fn call_method_v(
        ...
        unimplemented!(
            "MyJni call acc={:?}, class={}, method={}, signature={}",
            acc,
            class.name,
            method.name,
            method.signature
    ...
    fn get_field_value(
        ...
        unimplemented!(
            "MyJni get_field_value: class={}, field={}, signature={}",
            class.name,
            field.name,
            field.signature
        );
    ...
    fn set_field_value(
        ...
        unimplemented!(
            "MyJni set_field_value: class={}, field={}, signature={}",
            class.name,
            field.name,
            field.signature
        );
