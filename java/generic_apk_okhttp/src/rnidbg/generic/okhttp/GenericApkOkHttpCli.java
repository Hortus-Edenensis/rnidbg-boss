...
public final class GenericApkOkHttpCli {
    private GenericApkOkHttpCli() {}
    ...
    private static Envelope execute(RequestSpec spec) throws Exception {
        ...
        if (spec.bodyBase64 != null) {
            ...
            MediaType mediaType = spec.contentType != null ? MediaType.parse(spec.contentType) : null;
    ...
    private static final class Envelope {
        ...
        static Envelope success(
                ...
                Headers headers) {
            return new Envelope(
                    status, body, bodyBase64, bodyUtf8, bodySize, message, protocol, headers, null);
        }
        ...
        String toJson() {
            ...
            json.append("\"engine\":\"generic_apk_okhttp\"");
            if (this.error != null) {
    ...
    private static String headersToJson(Headers headers) {
        ...
        for (int i = 0; i < headers.size(); i++) {
            ...
            json.append(jsonString(headers.name(i)));
            json.append(':');
            json.append(jsonString(headers.value(i)));
        }
        json.append('}');
        return json.toString();
    }
