...
public class DoubleMetaphone implements StringEncoder {
    ...
    private static final String[] SILENT_START = {"GN", "KN", "PN", VZZzW.b, "PS"};
    private static final String[] L_R_N_M_B_H_F_V_W_SPACE = {"L", "R", "N", "M", WkAdxAdConfigMg.DSP_NAME_BAIDU, "H", "F", ExifInterface.GPS_MEASUREMENT_INTERRUPTED, "W", " "};
    private static final String[] ES_EP_EB_EL_EY_IB_IL_IN_IE_EI_ER = {"ES", "EP", "EB", "EL", "EY", "IB", "IL", STManager.REGION_OF_IN, "IE", "EI", "ER"};
    private static final String[] L_T_K_S_N_M_B_Z = {"L", ExifInterface.GPS_DIRECTION_TRUE, "K", ExifInterface.LATITUDE_SOUTH, "N", "M", WkAdxAdConfigMg.DSP_NAME_BAIDU, "Z"};
                ...
                if (contains(str, i2, 3, "CIA")) {
                    ...
                    if (contains(str, i, 2, "CK", "CG", "CQ")) {
                        ...
                        if (!contains(str, i2, 2, " C", " Q", " G")) {
                            if (!contains(str, i2, 1, WkAdxAdConfigMg.DSP_NAME_CSJ, "K", "Q") || contains(str, i2, 2, "CE", "CI")) {
                                return i2;
                            }
                        }
    ...
    private int handleGH(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i) {
        if (i > 0 && !isVowel(charAt(str, i - 1))) {
            ...
            if ((i <= 1 || !contains(str, i - 2, 1, WkAdxAdConfigMg.DSP_NAME_BAIDU, "H", "D")) && ((i <= 2 || !contains(str, i - 3, 1, WkAdxAdConfigMg.DSP_NAME_BAIDU, "H", "D")) && (i <= 3 || !contains(str, i - 4, 1, WkAdxAdConfigMg.DSP_NAME_BAIDU, "H")))) {
                if (i > 2 && charAt(str, i - 1) == 'U' && contains(str, i - 3, 1, WkAdxAdConfigMg.DSP_NAME_CSJ, WkAdxAdConfigMg.DSP_NAME_GDT, "L", "R", ExifInterface.GPS_DIRECTION_TRUE)) {
    ...
    */
    ...
    private int handleP(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i) {
        ...
        if (contains(str, i2, 1, "P", WkAdxAdConfigMg.DSP_NAME_BAIDU)) {
            i2 = i + 2;
        }
        return i2;
    }
    ...
    */
    ...
    private int handleX(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i) {
        ...
        int i2 = i + 1;
        return contains(str, i2, 1, WkAdxAdConfigMg.DSP_NAME_CSJ, "X") ? i + 2 : i2;
    }
