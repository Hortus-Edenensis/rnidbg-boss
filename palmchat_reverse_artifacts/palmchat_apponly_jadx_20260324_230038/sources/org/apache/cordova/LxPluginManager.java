...
public class LxPluginManager extends CordovaPlugin implements ab3, ba3 {
    ...
    public void initialize(CordovaInterface cordovaInterface, CordovaWebView cordovaWebView) {
        ...
        wl2 wl2VarCreateGeneralPlugin = LxApiProxy.getInstance().getPluginFactory().createGeneralPlugin(cordovaInterface.getActivity(), cordovaWebView);
    ...
    public void requestPermissions(ib3 ib3Var, int i, String[] strArr) {
        this.webView.requestPermissions(this, this.mCallbackMap.b(ib3Var, i), strArr);
    }
