            ...
            try {
                ...
                if (matcher.matches()) {
                    ...
                    if (strGroup != null) {
                        ...
                        this.whiteList.add(new URLPattern(HttpHost.DEFAULT_SCHEME_NAME, str2, strGroup3, strGroup4));
                        this.whiteList.add(new URLPattern(BaseConstants.SCHEME_HTTPS, str2, strGroup3, strGroup4));
                    }
                }
