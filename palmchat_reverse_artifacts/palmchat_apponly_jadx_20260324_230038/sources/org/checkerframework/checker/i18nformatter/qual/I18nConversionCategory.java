...
public enum I18nConversionCategory {
    UNUSED(null, null),
    GENERAL(null, null),
    DATE(new Class[]{Date.class, Number.class}, new String[]{FFmpegMediaMetadataRetriever.METADATA_KEY_DATE, "time"}),
    NUMBER(new Class[]{Number.class}, new String[]{EventParams.KEY_PARAM_NUMBER, "choice"});
