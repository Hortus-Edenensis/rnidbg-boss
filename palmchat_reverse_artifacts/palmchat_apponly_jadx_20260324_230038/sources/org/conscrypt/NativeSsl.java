...
final class NativeSsl {
    ...
    public void doHandshake(FileDescriptor fileDescriptor, int i) throws IOException, CertificateException {
    ...
    public void setCertificate(String str) throws SSLException, CertificateEncodingException {
