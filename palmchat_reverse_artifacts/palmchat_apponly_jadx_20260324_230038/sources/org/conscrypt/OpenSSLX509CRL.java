...
final class OpenSSLX509CRL extends X509CRL {
    ...
    private void verifyInternal(PublicKey publicKey, String str) throws SignatureException, NoSuchAlgorithmException, InvalidKeyException, CRLException, NoSuchProviderException {
    ...
    private void verifyOpenSSL(OpenSSLKey openSSLKey) throws SignatureException, NoSuchAlgorithmException, InvalidKeyException {
        try {
