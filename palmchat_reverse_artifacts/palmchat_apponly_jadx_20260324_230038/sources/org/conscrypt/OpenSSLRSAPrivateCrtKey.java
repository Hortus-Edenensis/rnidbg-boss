...
final class OpenSSLRSAPrivateCrtKey extends OpenSSLRSAPrivateKey implements RSAPrivateCrtKey {
    ...
    public static OpenSSLKey getInstance(RSAPrivateCrtKey rSAPrivateCrtKey) throws InvalidKeyException {
        ...
        try {
            ...
            byte[] byteArray3 = publicExponent == null ? null : publicExponent.toByteArray();
            byte[] byteArray4 = privateExponent.toByteArray();
            byte[] byteArray5 = primeP == null ? null : primeP.toByteArray();
            byte[] byteArray6 = primeQ == null ? null : primeQ.toByteArray();
            byte[] byteArray7 = primeExponentP == null ? null : primeExponentP.toByteArray();
            byte[] byteArray8 = primeExponentQ == null ? null : primeExponentQ.toByteArray();
            if (crtCoefficient != null) {
                byteArray2 = crtCoefficient.toByteArray();
            }
            return new OpenSSLKey(NativeCrypto.EVP_PKEY_new_RSA(byteArray, byteArray3, byteArray4, byteArray5, byteArray6, byteArray7, byteArray8, byteArray2));
        } catch (Exception e) {
