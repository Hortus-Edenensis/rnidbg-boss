...
public final class OpenSSLProvider extends Provider {
    ...
    public OpenSSLProvider(String str, boolean z) {
        ...
        put("Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.2", EncryptUtils.AES_ENCRYPT_ALGORITHM);
        put("Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.22", EncryptUtils.AES_ENCRYPT_ALGORITHM);
        put("Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.42", EncryptUtils.AES_ENCRYPT_ALGORITHM);
        ...
        put("Alg.Alias.MessageDigest.SHA256", x.dW);
        put("Alg.Alias.MessageDigest.2.16.840.1.101.3.4.2.1", x.dW);
        ...
        put("Alg.Alias.KeyPairGenerator.1.2.840.113549.1.1.1", EncryptUtils.RSA_ENCRYPT_ALGORITHM);
        put("Alg.Alias.KeyPairGenerator.1.2.840.113549.1.1.7", EncryptUtils.RSA_ENCRYPT_ALGORITHM);
        put("Alg.Alias.KeyPairGenerator.2.5.8.1.1", EncryptUtils.RSA_ENCRYPT_ALGORITHM);
        ...
        put("Alg.Alias.KeyFactory.1.2.840.113549.1.1.1", EncryptUtils.RSA_ENCRYPT_ALGORITHM);
        put("Alg.Alias.KeyFactory.1.2.840.113549.1.1.7", EncryptUtils.RSA_ENCRYPT_ALGORITHM);
        put("Alg.Alias.KeyFactory.2.5.8.1.1", EncryptUtils.RSA_ENCRYPT_ALGORITHM);
        ...
        putSignatureImplClass(RSAUtil.SIGNATURE_ALGORITHM, "OpenSSLSignature$SHA256RSA");
        put("Alg.Alias.Signature.SHA256withRSAEncryption", RSAUtil.SIGNATURE_ALGORITHM);
        put("Alg.Alias.Signature.SHA256/RSA", RSAUtil.SIGNATURE_ALGORITHM);
        put("Alg.Alias.Signature.1.2.840.113549.1.1.11", RSAUtil.SIGNATURE_ALGORITHM);
        put("Alg.Alias.Signature.OID.1.2.840.113549.1.1.11", RSAUtil.SIGNATURE_ALGORITHM);
        put("Alg.Alias.Signature.2.16.840.1.101.3.4.2.1with1.2.840.113549.1.1.1", RSAUtil.SIGNATURE_ALGORITHM);
        put("Alg.Alias.Signature.2.16.840.1.101.3.4.2.1with1.2.840.113549.1.1.11", RSAUtil.SIGNATURE_ALGORITHM);
