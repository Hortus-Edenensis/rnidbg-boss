...
final class SSLUtils {
    ...
    static final boolean USE_ENGINE_SOCKET_BY_DEFAULT = Boolean.parseBoolean(System.getProperty("org.conscrypt.useEngineSocketByDefault", ex.V));
    ...
    public static String getServerX509KeyType(long j) throws SSLException {
        ...
        if (strSSL_CIPHER_get_kx_name.equals("RSA") || strSSL_CIPHER_get_kx_name.equals("DHE_RSA") || strSSL_CIPHER_get_kx_name.equals("ECDHE_RSA")) {
            return "RSA";
        }
