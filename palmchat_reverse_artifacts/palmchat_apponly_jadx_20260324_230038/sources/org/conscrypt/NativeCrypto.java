...
public final class NativeCrypto {
    ...
    public interface SSLHandshakeCallbacks {
        void clientCertificateRequested(byte[] bArr, int[] iArr, byte[][] bArr2) throws SSLException, CertificateEncodingException;
    ...
    public static native int BIO_read(long j, byte[] bArr) throws IOException;

    public static native void BIO_write(long j, byte[] bArr, int i, int i2) throws IndexOutOfBoundsException, IOException;

    public static native int ECDH_compute_key(byte[] bArr, int i, NativeRef.EVP_PKEY evp_pkey, NativeRef.EVP_PKEY evp_pkey2) throws IndexOutOfBoundsException, InvalidKeyException;
    ...
    public static native int ENGINE_SSL_read_BIO_heap(long j, NativeSsl nativeSsl, long j2, byte[] bArr, int i, int i2, SSLHandshakeCallbacks sSLHandshakeCallbacks) throws IndexOutOfBoundsException, IOException;
    ...
    public static native int ENGINE_SSL_write_BIO_heap(long j, NativeSsl nativeSsl, long j2, byte[] bArr, int i, int i2, SSLHandshakeCallbacks sSLHandshakeCallbacks) throws IndexOutOfBoundsException, IOException;
    ...
    public static native int EVP_AEAD_CTX_open(long j, byte[] bArr, int i, byte[] bArr2, int i2, byte[] bArr3, byte[] bArr4, int i3, int i4, byte[] bArr5) throws IndexOutOfBoundsException, BadPaddingException, ShortBufferException;

    public static native int EVP_AEAD_CTX_seal(long j, byte[] bArr, int i, byte[] bArr2, int i2, byte[] bArr3, byte[] bArr4, int i3, int i4, byte[] bArr5) throws IndexOutOfBoundsException, BadPaddingException, ShortBufferException;
    ...
    public static native void X509_CRL_verify(long j, OpenSSLX509CRL openSSLX509CRL, NativeRef.EVP_PKEY evp_pkey) throws BadPaddingException, IllegalBlockSizeException, SignatureException, NoSuchAlgorithmException, InvalidKeyException;
    ...
    private static int X509_NAME_hash(X500Principal x500Principal, String str) {
        try {
            ...
            return ((bArrDigest[3] & UByte.MAX_VALUE) << 24) | ((bArrDigest[0] & UByte.MAX_VALUE) << 0) | ((bArrDigest[1] & UByte.MAX_VALUE) << 8) | ((bArrDigest[2] & UByte.MAX_VALUE) << 16);
