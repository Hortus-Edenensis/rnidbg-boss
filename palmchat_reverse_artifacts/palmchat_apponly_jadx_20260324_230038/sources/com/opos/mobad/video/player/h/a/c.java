...
public class c extends a {
    public c(Context context, int i, a.InterfaceC0778a interfaceC0778a, com.opos.mobad.d.a aVar) {
    ...
    private void a(RelativeLayout relativeLayout) {
        ...
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(com.opos.cmn.an.h.f.a.a(this.f10366a, 68.0f), com.opos.cmn.an.h.f.a.a(this.f10366a, 68.0f));
        layoutParams.addRule(14);
        layoutParams.addRule(2, this.p);
        layoutParams.bottomMargin = com.opos.cmn.an.h.f.a.a(this.f10366a, 12.0f);
    ...
    private void b(RelativeLayout relativeLayout) {
        ...
        layoutParams.addRule(14);
        layoutParams.bottomMargin = com.opos.cmn.an.h.f.a.a(this.f10366a, 50.0f);
    ...
    public void g() {
        ...
        if (relativeLayout != null) {
            relativeLayout.setBackgroundColor(Color.parseColor("#1F000000"));
        }
        ...
        this.h.setId(this.q);
        TextView textView3 = new TextView(this.f10366a);
        this.d = textView3;
        ...
        h.a(this.i, new ColorDrawable(Color.parseColor("#8A42464C")));
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(com.opos.cmn.an.h.f.a.a(this.f10366a, 268.0f), com.opos.cmn.an.h.f.a.b(this.f10366a));
    ...
    public RelativeLayout.LayoutParams i() {
        ...
        layoutParams.addRule(11);
        layoutParams.topMargin = com.opos.cmn.an.h.f.a.a(this.f10366a, 24.0f);
    ...
    private void a(RelativeLayout relativeLayout, com.opos.mobad.template.d.d dVar, boolean z) {
        if (this.s == null) {
            ...
            layoutParams.bottomMargin = com.opos.cmn.an.h.f.a.a(this.f10366a, 8);
    ...
    private void b(RelativeLayout relativeLayout, com.opos.mobad.template.d.d dVar, boolean z) {
        if (this.s == null) {
            ...
            layoutParams.bottomMargin = com.opos.cmn.an.h.f.a.a(this.f10366a, z ? 42 : 82);
    ...
    private void c(com.opos.mobad.template.d.d dVar) {
        ...
        if (this.s == null && (list = dVar.d) != null && list.size() > 0 && dVar.d.get(0) != null) {
            ...
            RelativeLayout relativeLayout = this.b;
            if (relativeLayout != null) {
                relativeLayout.setTag(eVar.f9414a);
            }
            com.opos.mobad.ui.c.e.a(eVar.f9414a, eVar.b, com.opos.cmn.an.h.f.a.b(this.f10366a) / 3, com.opos.cmn.an.h.f.a.c(this.f10366a), this.t, this.l, new e.b() { // from class: com.opos.mobad.video.player.h.a.c.1
                @Override // com.opos.mobad.ui.c.e.b
                public void a(Bitmap bitmap) {
                    RelativeLayout relativeLayout2;
                    if (c.this.u || (relativeLayout2 = c.this.b) == null) {
                        return;
                    }
                    Object tag = relativeLayout2.getTag();
                    if ((tag instanceof String) && ((String) tag).equals(eVar.f9414a)) {
                        BitmapDrawable bitmapDrawableA = h.a(c.this.f10366a, h.a(3, bitmap));
                        if (bitmapDrawableA != null) {
                            h.a(c.this.b, bitmapDrawableA);
                        }
                    }
                }
            }, this.w);
    ...
    public void a(com.opos.mobad.template.d.d dVar) {
        ...
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(com.opos.cmn.an.h.f.a.a(this.f10366a, 174.0f), -2);
        layoutParams.addRule(12);
        float f = 24;
        layoutParams.leftMargin = com.opos.cmn.an.h.f.a.a(this.f10366a, f);
        layoutParams.bottomMargin = com.opos.cmn.an.h.f.a.a(this.f10366a, f);
    ...
    public void b(com.opos.mobad.template.d.d dVar) {
        ...
        float f = 24;
        layoutParams.bottomMargin = com.opos.cmn.an.h.f.a.a(this.f10366a, f);
        layoutParams.rightMargin = com.opos.cmn.an.h.f.a.a(this.f10366a, f);
