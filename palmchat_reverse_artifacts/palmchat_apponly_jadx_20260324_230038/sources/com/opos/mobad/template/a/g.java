...
public class g extends com.opos.mobad.template.cmn.baseview.b {
    ...
    public g(Context context, a aVar, com.opos.mobad.d.a aVar2) {
        super(context);
        this.f9289a = new p() { // from class: com.opos.mobad.template.a.g.2
            @Override // com.opos.mobad.template.cmn.p
            public void b(View view, int[] iArr) {
                com.opos.cmn.an.f.a.b("LogoTipBar", "onFeedBackClick");
                if (g.this.g != null) {
                    g.this.g.a(view, iArr);
                }
            }
        };
        this.h = aVar;
    ...
    public static g a(Context context, int i, com.opos.mobad.d.a aVar) {
        return new g(context, new a(10, 21, 30, 14, 4, 0, 3.0f, i, false, 12, 6.36f, 3.56f), aVar);
    }
    ...
    private void b() {
        ...
        this.d.setTextSize(1, this.h.f9292a);
        ...
        if (this.h.i) {
            ...
            this.b = textView4;
            textView4.setTextSize(1, this.h.f9292a);
    ...
    public void a(a.InterfaceC0778a interfaceC0778a) {
        com.opos.cmn.an.f.a.b("LogoTipBar", "setListener " + interfaceC0778a);
        this.g = interfaceC0778a;
    }

    private void a(com.opos.mobad.template.d.e eVar, final String str) {
        com.opos.mobad.template.h.a(this.g, eVar.f9414a, this.i, eVar.b, new com.opos.mobad.template.b() { // from class: com.opos.mobad.template.a.g.1
            @Override // com.opos.mobad.template.b
            public void a(Bitmap bitmap) {
                int iA;
                BitmapDrawable bitmapDrawableA = bitmap != null ? com.opos.mobad.template.h.a(g.this.getContext(), bitmap) : null;
                ...
                if (bitmapDrawableA != null) {
                    com.opos.mobad.template.h.a(g.this.d, bitmapDrawableA);
                    iA = com.opos.cmn.an.h.f.a.a(g.this.getContext(), g.this.h.c);
                } else {
                    g.this.d.setText(str);
                    g.this.d.setMinWidth(com.opos.cmn.an.h.f.a.a(g.this.getContext(), g.this.h.b));
                    iA = -2;
                }
                layoutParams.width = iA;
                layoutParams.height = com.opos.cmn.an.h.f.a.a(g.this.getContext(), g.this.h.d);
    ...
    public void a(boolean z, boolean z2, com.opos.mobad.template.d.e eVar, String str) {
        ...
        if (z) {
            ...
            this.f.setOnClickListener(this.f9289a);
            this.f.setOnTouchListener(this.f9289a);
            this.d.setOnClickListener(this.f9289a);
            textView = this.d;
            pVar = this.f9289a;
        } else {
            if (this.h.f == 0) {
