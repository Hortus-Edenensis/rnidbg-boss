...
public class r implements d {
    ...
    private com.opos.mobad.template.cmn.baseview.c f10145a;
    ...
    private final View.OnTouchListener w = new View.OnTouchListener() { // from class: com.opos.mobad.template.i.r.1
        @Override // android.view.View.OnTouchListener
        public boolean onTouch(View view, MotionEvent motionEvent) {
            if (motionEvent.getAction() == 0) {
                r.this.i = (int) motionEvent.getX();
                r.this.j = (int) motionEvent.getY();
                r.this.n = false;
            } else if (2 == motionEvent.getAction()) {
                int y = (int) motionEvent.getY();
                int x = (int) motionEvent.getX();
                if (r.this.d == j.SLIDE_UP && y <= 0 && !r.this.n) {
                    r.this.a(x, y);
                }
            } else if (1 == motionEvent.getAction()) {
                r.this.k = (int) motionEvent.getX();
                r.this.l = (int) motionEvent.getY();
                if (r.this.d == j.SLIDE_UP && ((r.this.i == r.this.k && r.this.j == r.this.l) || (r.this.j - r.this.l > ((double) r.this.m) * 0.4d && !r.this.n))) {
                    r rVar = r.this;
                    rVar.a(rVar.k, r.this.l);
                }
            }
            return true;
        }
    };
    private final Runnable x = new Runnable() { // from class: com.opos.mobad.template.i.r.2
    ...
    private final int[] s = {1728053247, 16777215};

    public r(Context context, j jVar, int i) {
        ...
        this.m = iA2;
        this.f10145a = new com.opos.mobad.template.cmn.baseview.c(context);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, iA2);
        this.f10145a.setPadding(0, 0, 0, com.opos.cmn.an.h.f.a.a(context, iA));
        layoutParams.addRule(13);
        this.b.addView(this.f10145a, layoutParams);
    ...
    private void h() {
        ...
        this.f.setTextColor(ColorUtils.setAlphaComponent(-1, MediaPlayer.MEDIA_PLAYER_OPTION_MEDIACODEC_DROP_NONREF));
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.addRule(14);
        layoutParams.addRule(12);
        this.f10145a.addView(this.f, layoutParams);
        a(this.f);
    }

    private void g() {
        this.f10145a.setOnTouchListener(this.w);
    }
    ...
    private void i() {
        ...
        this.f10145a.addView(this.g, layoutParams);
        a(this.g);
    }
    ...
    private void j() {
        ...
        this.f10145a.addView(relativeLayout, layoutParams4);
    }
    ...
    private ValueAnimator a(final View view, int i, int i2) {
        ...
        valueAnimatorOfInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.opos.mobad.template.i.r.3
