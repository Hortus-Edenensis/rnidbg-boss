...
public final class o {
    ...
    public boolean e() {
        boolean z = (this.f8399a[this.b] & (128 >> this.c)) != 0;
        d();
        return z;
    }
    ...
    public void b(byte[] bArr, int i, int i2) {
        a.b(this.c == 0);
        System.arraycopy(this.f8399a, this.b, bArr, i, i2);
        this.b += i2;
        g();
    }
    ...
    public void a(byte[] bArr, int i, int i2) {
        ...
        int i8 = this.c;
        if (i8 + i7 > 8) {
            byte[] bArr3 = this.f8399a;
            int i9 = this.b;
            this.b = i9 + 1;
            bArr[i3] = (byte) (b3 | ((byte) ((bArr3[i9] & UByte.MAX_VALUE) << i8)));
            this.c = i8 - 8;
        }
        int i10 = this.c + i7;
        this.c = i10;
        byte[] bArr4 = this.f8399a;
        int i11 = this.b;
