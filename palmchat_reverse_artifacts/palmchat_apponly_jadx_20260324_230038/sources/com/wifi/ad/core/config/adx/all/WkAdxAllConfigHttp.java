...
public class WkAdxAllConfigHttp {
    ...
    private static byte[] createRequestByte(Context context, String str, String str2, String str3) {
        try {
            ...
            builderNewBuilder2.setAppid(str);
            ...
            WifiLog.d("H5Ad createRequestByte pb e " + e.toString());
            return null;
        }
    }
    ...
    public static String getServerUrl() {
        ...
        return Boolean.valueOf(wifiNestAd.isDebugUrl()).booleanValue() ? "https://t1.lianxinapp.com/sdkconfig/adstrategies" : wifiNestAd.getNewRequestUrl() ? "https://short.lianxinapp.com/sdkconfig/adstrategies" : "https://di.wkangg.com/sdkconfig/adstrategies";
    }

    public static void postResponseData(Context context, String str, String str2, String str3, IWkConfigCallBack iWkConfigCallBack) {
        postServerUrl(createRequestByte(context, str, str2, str3), context, str, iWkConfigCallBack);
    }
    ...
    */
    private static void postServerUrl(byte[] bArr, Context context, String str, IWkConfigCallBack iWkConfigCallBack) throws Throwable {
        ...
        WkAdxAllResponse.AllStrategiesResponse from;
        ...
        if (httpURLConnectionCreateConnection != null) {
            ...
            if (200 == responseCode) {
                from = WkAdxAllResponse.AllStrategiesResponse.parseFrom(httpURLConnectionCreateConnection.getInputStream());
                if (httpURLConnectionCreateConnection != null) {
