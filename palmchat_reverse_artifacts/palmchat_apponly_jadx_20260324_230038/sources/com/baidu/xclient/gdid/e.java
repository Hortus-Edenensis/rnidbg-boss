...
public class e {
    ...
    public static String f4309a = "sec_gd_config_mshield";
    public static volatile e b;
    public SharedPreferences c;
    public SharedPreferences.Editor d;

    public e() {
        SharedPreferences sharedPreferences = d.b.getSharedPreferences(f4309a, 0);
    ...
    public String k() {
        String strB = b("k_ply_s_n", "");
        if (!TextUtils.isEmpty(strB)) {
            return new String(Base64.decode(strB, 1));
        }
        ...
        try {
            ...
            jSONObject.put("i", 1);
            jSONObject.put("m", 0);
            jSONObject.put(RXScreenCaptureService.KEY_WIDTH, 1);
            jSONObject.put("s", 1);
            jSONObject.put("c", 0);
            jSONObject.put("y", 20);
            jSONObject.put("z", 20);
