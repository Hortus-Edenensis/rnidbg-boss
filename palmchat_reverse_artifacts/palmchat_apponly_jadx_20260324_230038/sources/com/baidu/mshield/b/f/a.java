...
public class a {
        ...
        try {
            if (i == 16) {
                ...
                if (bArr2 == null || bArr2.length != 16) {
                    f4025a = Base64.decode(new byte[]{77, 122, 65, 121, 77, 84, 73, 120, 77, 68, 74, 107, 97, 87, 78, 49, 90, 71, 108, 104, 89, 103, kotlin.io.encoding.Base64.padSymbol, kotlin.io.encoding.Base64.padSymbol}, 0);
                }
                bArr = f4025a;
            } else if (i != 24) {
                bArr = new byte[0];
    ...
    public static synchronized byte[] a() {
        ...
        try {
            byte[] bArr2 = c;
            if (bArr2 == null || bArr2.length != 16) {
                c = Base64.decode(new byte[]{78, 68, 65, 121, 77, 122, 85, 120, 78, 122, 74, 108, 97, 71, 78, 110, 90, 109, 108, 106, 89, 81, kotlin.io.encoding.Base64.padSymbol, kotlin.io.encoding.Base64.padSymbol, 10}, 0);
            }
            bArr = c;
        } finally {
        }
