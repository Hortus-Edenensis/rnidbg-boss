...
public final class TrafficPois extends MessageMicro {
    ...
    public static final class Content extends MessageMicro {
        ...
        public static final class End extends MessageMicro {
            ...
            public int getSerializedSize() {
                ...
                if (hasNum()) {
                    iComputeInt32Size += CodedOutputStreamMicro.computeInt32Size(3, getNum());
                }
                if (hasUid()) {
                    iComputeInt32Size += CodedOutputStreamMicro.computeStringSize(4, getUid());
                }
                if (hasAddr()) {
                    iComputeInt32Size += CodedOutputStreamMicro.computeStringSize(5, getAddr());
                }
                if (hasGeo()) {
                    iComputeInt32Size += CodedOutputStreamMicro.computeStringSize(6, getGeo());
                }
                if (hasExt()) {
                    iComputeInt32Size += CodedOutputStreamMicro.computeStringSize(7, getExt());
                }
                if (hasPoiType()) {
                    iComputeInt32Size += CodedOutputStreamMicro.computeInt32Size(8, getPoiType());
                }
                if (hasIndoorFloor()) {
                    iComputeInt32Size += CodedOutputStreamMicro.computeStringSize(9, getIndoorFloor());
                }
                if (hasIndoorParentUid()) {
                    iComputeInt32Size += CodedOutputStreamMicro.computeStringSize(10, getIndoorParentUid());
                }
                if (hasDist()) {
                    iComputeInt32Size += CodedOutputStreamMicro.computeInt32Size(11, getDist());
                }
                if (hasDirection()) {
                    iComputeInt32Size += CodedOutputStreamMicro.computeInt32Size(12, getDirection());
                }
                if (hasDescribe()) {
                    iComputeInt32Size += CodedOutputStreamMicro.computeStringSize(13, getDescribe());
                }
                if (hasImageUrl()) {
                    iComputeInt32Size += CodedOutputStreamMicro.computeBytesSize(14, getImageUrl());
                }
                if (hasHistoryAddress()) {
                    iComputeInt32Size += CodedOutputStreamMicro.computeStringSize(15, getHistoryAddress());
                }
        ...
        public static final class Start extends MessageMicro {
            ...
            public int getSerializedSize() {
                ...
                if (hasIndoorFloor()) {
                    iComputeInt32Size += CodedOutputStreamMicro.computeStringSize(7, getIndoorFloor());
                }
                if (hasIndoorParentUid()) {
                    iComputeInt32Size += CodedOutputStreamMicro.computeStringSize(8, getIndoorParentUid());
                }
                if (hasDescribe()) {
                    iComputeInt32Size += CodedOutputStreamMicro.computeStringSize(9, getDescribe());
                }
                if (hasImageUrl()) {
                    iComputeInt32Size += CodedOutputStreamMicro.computeBytesSize(10, getImageUrl());
                }
                if (hasHistoryAddress()) {
                    iComputeInt32Size += CodedOutputStreamMicro.computeStringSize(11, getHistoryAddress());
                }
                this.cachedSize = iComputeInt32Size;
                return iComputeInt32Size;
            }
        ...
        public static final class WayPoints extends MessageMicro {
            ...
            public int getSerializedSize() {
                ...
                if (hasDist()) {
                    iComputeInt32Size += CodedOutputStreamMicro.computeInt32Size(9, getDist());
                }
                if (hasDirection()) {
                    iComputeInt32Size += CodedOutputStreamMicro.computeInt32Size(10, getDirection());
                }
                if (hasDescribe()) {
                    iComputeInt32Size += CodedOutputStreamMicro.computeStringSize(11, getDescribe());
                }
                if (hasImageUrl()) {
                    iComputeInt32Size += CodedOutputStreamMicro.computeBytesSize(12, getImageUrl());
                }
                if (hasHistoryAddress()) {
                    iComputeInt32Size += CodedOutputStreamMicro.computeStringSize(13, getHistoryAddress());
                }
                this.cachedSize = iComputeInt32Size;
                return iComputeInt32Size;
            }
    ...
    public static final class ImageShow extends MessageMicro {
        ...
        @Override // com.google.protobuf.micro.MessageMicro
        public int getSerializedSize() {
            int iComputeBytesSize = hasImageExt() ? 0 + CodedOutputStreamMicro.computeBytesSize(1, getImageExt()) : 0;
            if (hasResBound()) {
                iComputeBytesSize += CodedOutputStreamMicro.computeStringSize(2, getResBound());
            }
    ...
    public static final class Option extends MessageMicro {
        ...
        public int getSerializedSize() {
            ...
            while (it.hasNext()) {
                iComputeStringSizeNoTag2 += CodedOutputStreamMicro.computeStringSizeNoTag(it.next());
            }
            int size = iComputeStringSizeNoTag2 + 0 + (getCityListList().size() * 1);
            Iterator<String> it2 = getPrioFlagList().iterator();
            int iComputeStringSizeNoTag3 = 0;
            while (it2.hasNext()) {
                iComputeStringSizeNoTag3 += CodedOutputStreamMicro.computeStringSizeNoTag(it2.next());
            }
            int size2 = size + iComputeStringSizeNoTag3 + (getPrioFlagList().size() * 1);
            Iterator<String> it3 = getWpWdList().iterator();
            int iComputeStringSizeNoTag4 = 0;
            while (it3.hasNext()) {
                iComputeStringSizeNoTag4 += CodedOutputStreamMicro.computeStringSizeNoTag(it3.next());
            }
            int size3 = size2 + iComputeStringSizeNoTag4 + (getWpWdList().size() * 1);
            if (hasSWd()) {
                size3 += CodedOutputStreamMicro.computeStringSize(4, getSWd());
            }
            Iterator<String> it4 = getEWdList().iterator();
            while (it4.hasNext()) {
                iComputeStringSizeNoTag += CodedOutputStreamMicro.computeStringSizeNoTag(it4.next());
            }
            int size4 = size3 + iComputeStringSizeNoTag + (getEWdList().size() * 1);
            if (hasIfNav()) {
    ...
    public int getSerializedSize() {
        ...
        if (hasCurrentCity()) {
            iComputeMessageSize += CodedOutputStreamMicro.computeMessageSize(2, getCurrentCity());
        }
        if (hasContent()) {
            iComputeMessageSize += CodedOutputStreamMicro.computeMessageSize(3, getContent());
        }
        Iterator<SuggestQuery> it = getSuggestQueryList().iterator();
        while (it.hasNext()) {
            iComputeMessageSize += CodedOutputStreamMicro.computeMessageSize(4, it.next());
        }
        if (hasSuggestQueryFlag()) {
            iComputeMessageSize += CodedOutputStreamMicro.computeInt32Size(5, getSuggestQueryFlag());
        }
        if (hasImgeShow()) {
            iComputeMessageSize += CodedOutputStreamMicro.computeMessageSize(6, getImgeShow());
        }
        if (hasListType()) {
            iComputeMessageSize += CodedOutputStreamMicro.computeInt32Size(7, getListType());
        }
        this.cachedSize = iComputeMessageSize;
        return iComputeMessageSize;
    }
