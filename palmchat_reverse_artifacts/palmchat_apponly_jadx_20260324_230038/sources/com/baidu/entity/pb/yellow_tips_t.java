...
public final class yellow_tips_t extends MessageMicro {
    ...
    public int getSerializedSize() {
        int iComputeInt32Size = hasTipsType() ? 0 + CodedOutputStreamMicro.computeInt32Size(1, getTipsType()) : 0;
        if (hasName()) {
            iComputeInt32Size += CodedOutputStreamMicro.computeBytesSize(2, getName());
        }
        if (hasRoutePreviewOff()) {
            iComputeInt32Size += CodedOutputStreamMicro.computeBoolSize(3, getRoutePreviewOff());
        }
