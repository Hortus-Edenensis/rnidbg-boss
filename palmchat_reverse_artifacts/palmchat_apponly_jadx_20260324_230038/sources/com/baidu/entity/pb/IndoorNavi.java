...
public final class IndoorNavi extends MessageMicro {
    ...
    public static final class Option extends MessageMicro {
        ...
        public static final class TipsInfo extends MessageMicro {
            ...
            public static final class ButtonInfo extends MessageMicro {
                ...
                public int getSerializedSize() {
                    int iComputeInt32Size = hasButtonLoc() ? 0 + CodedOutputStreamMicro.computeInt32Size(1, getButtonLoc()) : 0;
                    if (hasButtonParaval()) {
                        iComputeInt32Size += CodedOutputStreamMicro.computeInt32Size(2, getButtonParaval());
                    }
                    if (hasButtonText()) {
                        iComputeInt32Size += CodedOutputStreamMicro.computeStringSize(3, getButtonText());
                    }
                    if (hasButtonStatus()) {
                        iComputeInt32Size += CodedOutputStreamMicro.computeInt32Size(4, getButtonStatus());
                    }
            ...
            @Override // com.google.protobuf.micro.MessageMicro
            public int getSerializedSize() {
                int iComputeStringSize = hasTipsText() ? 0 + CodedOutputStreamMicro.computeStringSize(1, getTipsText()) : 0;
        ...
        @Override // com.google.protobuf.micro.MessageMicro
        public int getSerializedSize() {
            int iComputeInt32Size = hasError() ? 0 + CodedOutputStreamMicro.computeInt32Size(1, getError()) : 0;
            if (hasTotal()) {
                iComputeInt32Size += CodedOutputStreamMicro.computeInt32Size(2, getTotal());
            }
            if (hasType()) {
                iComputeInt32Size += CodedOutputStreamMicro.computeInt32Size(3, getType());
            }
    ...
    public static final class Routes extends MessageMicro {
        ...
        public static final class Legs extends MessageMicro {
            ...
            public static final class Steps extends MessageMicro {
                ...
                public static final class IndoorTurnType extends MessageMicro {
                    ...
                    @Override // com.google.protobuf.micro.MessageMicro
                    public int getSerializedSize() {
                        int iComputeInt32Size = hasSpathIndex() ? 0 + CodedOutputStreamMicro.computeInt32Size(1, getSpathIndex()) : 0;
                        if (hasTurnType()) {
                            iComputeInt32Size += CodedOutputStreamMicro.computeInt32Size(2, getTurnType());
                        }
                        this.cachedSize = iComputeInt32Size;
                        return iComputeInt32Size;
                    }
                ...
                public static final class Pois extends MessageMicro {
                    ...
                    public int getSerializedSize() {
                        ...
                        int size = iComputeStringSize + (getLocationList().size() * 8) + (getLocationList().size() * 1);
                        if (hasDetail()) {
                ...
                public static final class YawInfo extends MessageMicro {
                    ...
                    @Override // com.google.protobuf.micro.MessageMicro
                    public int getSerializedSize() {
                        int iComputeInt32Size = hasStartSpathIndex() ? 0 + CodedOutputStreamMicro.computeInt32Size(1, getStartSpathIndex()) : 0;
                        if (hasEndSpathIndex()) {
                            iComputeInt32Size += CodedOutputStreamMicro.computeInt32Size(2, getEndSpathIndex());
                        }
                        if (hasYawThreshold()) {
                            iComputeInt32Size += CodedOutputStreamMicro.computeInt32Size(3, getYawThreshold());
                        }
                        this.cachedSize = iComputeInt32Size;
                        return iComputeInt32Size;
                    }
        ...
        public int getSerializedSize() {
            ...
            int iComputeInt32Size = hasDistance() ? CodedOutputStreamMicro.computeInt32Size(1, getDistance()) + 0 : 0;
            if (hasDuration()) {
            ...
            if (hasLocLevel()) {
                iComputeInt32Size += CodedOutputStreamMicro.computeInt32Size(4, getLocLevel());
            }
            Iterator<Integer> it2 = getMbrLeftdownLocationList().iterator();
            int iComputeInt32SizeNoTag2 = 0;
            while (it2.hasNext()) {
                iComputeInt32SizeNoTag2 += CodedOutputStreamMicro.computeInt32SizeNoTag(it2.next().intValue());
            }
            int size = iComputeInt32Size + iComputeInt32SizeNoTag2 + (getMbrLeftdownLocationList().size() * 1);
            Iterator<Integer> it3 = getMbrRightupLocationList().iterator();
            while (it3.hasNext()) {
                iComputeInt32SizeNoTag += CodedOutputStreamMicro.computeInt32SizeNoTag(it3.next().intValue());
            }
            int size2 = size + iComputeInt32SizeNoTag + (getMbrRightupLocationList().size() * 1);
            if (hasFacilityType()) {
