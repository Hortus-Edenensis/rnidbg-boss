...
public final class action_t extends MessageMicro {
    ...
    public int getSerializedSize() {
        int iComputeInt32Size = hasKey() ? 0 + CodedOutputStreamMicro.computeInt32Size(1, getKey()) : 0;
        if (hasValue()) {
            iComputeInt32Size += CodedOutputStreamMicro.computeBytesSize(2, getValue());
        }
        if (hasText()) {
            iComputeInt32Size += CodedOutputStreamMicro.computeBytesSize(3, getText());
        }
