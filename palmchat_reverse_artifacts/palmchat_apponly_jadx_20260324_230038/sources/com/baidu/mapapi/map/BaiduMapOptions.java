...
public final class BaiduMapOptions implements Parcelable {
    ...
    public BaiduMapOptions() {
        this.f3609a = new MapStatus(0.0f, new LatLng(39.914935d, 116.403119d), 0.0f, 12.0f, null, null);
        this.b = false;
        this.c = 1;
        this.d = true;
        this.e = true;
    ...
    public q a() {
        return new q().a(this.f3609a.a()).a(this.b).a(this.c).c(this.d).d(this.e).b(this.f).e(this.g);
    }
    ...
    public BaiduMapOptions(Parcel parcel) {
        ...
        this.h = true;
        this.i = true;
        this.f3609a = (MapStatus) parcel.readParcelable(MapStatus.class.getClassLoader());
