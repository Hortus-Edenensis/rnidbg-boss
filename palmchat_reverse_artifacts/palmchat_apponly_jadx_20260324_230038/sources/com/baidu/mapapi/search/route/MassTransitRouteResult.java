...
public final class MassTransitRouteResult extends SearchResult {
    ...
    private TransitResultNode f3810a;
    ...
    public void writeToParcel(Parcel parcel, int i) {
        parcel.writeParcelable(this.f3810a, 1);
    ...
    public MassTransitRouteResult(Parcel parcel) {
        this.f3810a = (TransitResultNode) parcel.readParcelable(TransitResultNode.class.getClassLoader());
