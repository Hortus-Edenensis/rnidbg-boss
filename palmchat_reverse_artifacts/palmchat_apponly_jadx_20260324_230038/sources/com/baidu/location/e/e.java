...
public class e {
    ...
    public class b {
        ...
        public double a(a aVar) {
            e eVar = e.this;
            a aVar2 = this.b;
            double d = aVar2.f3527a;
            a aVar3 = this.f3528a;
            a aVar4 = eVar.new a(d - aVar3.f3527a, aVar2.b - aVar3.b);
            e eVar2 = e.this;
            double d2 = aVar.f3527a;
            a aVar5 = this.f3528a;
            a aVar6 = eVar2.new a(d2 - aVar5.f3527a, aVar.b - aVar5.b);
            return (aVar4.f3527a * aVar6.b) - (aVar4.b * aVar6.f3527a);
        }

        public boolean b(a aVar) {
            return e.this.a(a(aVar)) == 0 && aVar.f3527a < Math.max(this.f3528a.f3527a, this.b.f3527a) + 1.0E-8d && aVar.f3527a > Math.min(this.f3528a.f3527a, this.b.f3527a) - 1.0E-8d && aVar.b < Math.max(this.f3528a.b, this.b.b) + 1.0E-8d && aVar.b > Math.min(this.f3528a.b, this.b.b) - 1.0E-8d;
        }
    }
    ...
    public boolean a(double d, double d2) {
        try {
            ...
            for (b bVar : this.d) {
                ...
                int iA2 = a(bVar.f3528a.b - aVar.b);
                int iA3 = a(bVar.b.b - aVar.b);
                if (iA > 0 && iA2 <= 0 && iA3 > 0) {
                    i++;
                }
                if (iA < 0 && iA3 <= 0 && iA2 > 0) {
