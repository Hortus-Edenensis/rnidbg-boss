...
public final class LocationClientOption {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f3392a[LocationMode.Battery_Saving.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f3392a[LocationMode.Device_Sensors.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f3392a[LocationMode.Fuzzy_Locating.ordinal()] = 4;
    ...
    public LocationClientOption() {
        ...
        this.openGps = false;
        this.scanSpan = 0;
        this.timeOut = ErrorCode.REASON_TEE;
    ...
    public void setLocationMode(LocationMode locationMode) {
        int i = AnonymousClass1.f3392a[locationMode.ordinal()];
        if (i == 1) {
            this.openGps = true;
            this.priority = 1;
        } else if (i == 2) {
    ...
    public LocationClientOption(LocationClientOption locationClientOption) {
        ...
        this.f3391a = locationClientOption.f3391a;
