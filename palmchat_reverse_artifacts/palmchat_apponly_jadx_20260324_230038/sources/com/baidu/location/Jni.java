...
public class Jni {
    ...
    public static double[] coorEncrypt(double d2, double d3, String str) {
        ...
        try {
            String[] strArrSplit = b(d2, d3, str.equals("gcj2wgs") ? 16 : str.equals("bd09") ? f3384a : str.equals("bd09ll") ? b : str.equals("gcj02") ? c : str.equals(BDLocation.BDLOCATION_WGS84_TO_GCJ02) ? d : str.equals(BDLocation.BDLOCATION_BD09_TO_GCJ02) ? e : str.equals(BDLocation.BDLOCATION_BD09LL_TO_GCJ02) ? f : str.equals("wgs842mc") ? h : -1, 132456).split(":");
