...
public class c extends BDAnimation {
    ...
    public ObjectAnimator a(Marker marker) {
        ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(marker, FFmpegMediaMetadataRetriever.METADATA_KEY_VIDEO_ROTATION, this.g);
