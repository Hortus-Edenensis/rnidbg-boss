...
public final class IndoorMapInfo implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (TextUtils.equals(this.f4156a, indoorMapInfo.f4156a) && TextUtils.equals(this.b, indoorMapInfo.b) && Arrays.equals(this.c, indoorMapInfo.c)) {
    ...
    public String toString() {
        return "IndoorMapInfo:building_id:" + this.f4156a + ";floor_id:" + this.b + ";indoor_type:" + this.e + ";floor_list:" + Arrays.toString(this.c) + ";floor_attribute:" + Arrays.toString(this.d);
    }
