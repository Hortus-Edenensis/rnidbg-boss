...
public class d {
    ...
    public static final long f11028a = 1000;
    ...
    public static String[] k = new String[EnumC0903d.values().length];
    ...
    static {
        ...
        for (int i5 = 0; i5 < EnumC0903d.values().length; i5++) {
            k[i5] = EnumC0903d.values()[i5].toString();
        }
        Map<String, String[]> map4 = l;
        if (map4 != null) {
            map4.put(EnumC0903d.class.getName(), k);
        }
    }
