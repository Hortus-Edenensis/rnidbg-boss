...
public class a implements UMImprintChangeCallback {
    ...
    private static HandlerThread f11033a = null;
    ...
    private static FileObserverC0904a i = null;
    ...
    /* JADX INFO: compiled from: SearchBox */
    public static class FileObserverC0904a extends FileObserver {
        public FileObserverC0904a(String str) {
            super(str);
        }
    ...
    public a(Context context, Handler handler) {
        ...
        try {
            if (f11033a == null) {
                ...
                f11033a = handlerThread;
                handlerThread.start();
                if (i == null) {
                    FileObserverC0904a fileObserverC0904a = new FileObserverC0904a(UMFrUtils.getEnvelopeDirPath(context));
                    i = fileObserverC0904a;
                    fileObserverC0904a.startWatching();
                    ULog.d("--->>> FileMonitor has already started!");
                }
                j();
                if (b == null) {
                    b = new Handler(f11033a.getLooper()) { // from class: com.umeng.commonsdk.framework.a.3
