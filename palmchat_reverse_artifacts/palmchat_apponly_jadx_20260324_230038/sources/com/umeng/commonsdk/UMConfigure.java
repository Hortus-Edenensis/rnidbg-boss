...
public class UMConfigure {
    ...
    private static void setWraperType(String str, String str2) {
        if (!TextUtils.isEmpty(str)) {
            if (str.equals("native")) {
                com.umeng.commonsdk.stateless.a.f11057a = "native";
                a.f11063a = "native";
            } else if (str.equals(WRAPER_TYPE_COCOS2DX_X)) {
                com.umeng.commonsdk.stateless.a.f11057a = WRAPER_TYPE_COCOS2DX_X;
                a.f11063a = WRAPER_TYPE_COCOS2DX_X;
            } else if (str.equals(WRAPER_TYPE_COCOS2DX_XLUA)) {
                com.umeng.commonsdk.stateless.a.f11057a = WRAPER_TYPE_COCOS2DX_XLUA;
                a.f11063a = WRAPER_TYPE_COCOS2DX_XLUA;
            } else if (str.equals(WRAPER_TYPE_UNITY)) {
                com.umeng.commonsdk.stateless.a.f11057a = WRAPER_TYPE_UNITY;
                a.f11063a = WRAPER_TYPE_UNITY;
            } else if (str.equals(WRAPER_TYPE_REACTNATIVE)) {
                com.umeng.commonsdk.stateless.a.f11057a = WRAPER_TYPE_REACTNATIVE;
                a.f11063a = WRAPER_TYPE_REACTNATIVE;
            } else if (str.equals(WRAPER_TYPE_PHONEGAP)) {
                com.umeng.commonsdk.stateless.a.f11057a = WRAPER_TYPE_PHONEGAP;
                a.f11063a = WRAPER_TYPE_PHONEGAP;
            } else if (str.equals(WRAPER_TYPE_WEEX)) {
                com.umeng.commonsdk.stateless.a.f11057a = WRAPER_TYPE_WEEX;
                a.f11063a = WRAPER_TYPE_WEEX;
            } else if (str.equals(WRAPER_TYPE_HYBRID)) {
                com.umeng.commonsdk.stateless.a.f11057a = WRAPER_TYPE_HYBRID;
                a.f11063a = WRAPER_TYPE_HYBRID;
            } else if (str.equals(WRAPER_TYPE_FLUTTER)) {
                com.umeng.commonsdk.stateless.a.f11057a = WRAPER_TYPE_FLUTTER;
                a.f11063a = WRAPER_TYPE_FLUTTER;
            }
        }
        if (TextUtils.isEmpty(str2)) {
            return;
    ...
    public static void init(Context context, String str, String str2, int i, String str3) {
        ...
        try {
            ...
            if (com.umeng.commonsdk.statistics.b.f11064a.indexOf("e") >= 0 && (declaredMethod4 = MobclickAgent.class.getDeclaredMethod("disableExceptionCatch", new Class[0])) != null) {
        ...
        try {
            ...
            if (declaredMethod16 != null && (objInvoke = declaredMethod16.invoke(cls8, new Object[0])) != null && (declaredMethod = cls8.getDeclaredMethod("init", Context.class)) != null) {
                declaredMethod.setAccessible(true);
