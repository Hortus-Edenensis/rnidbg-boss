...
public class DataHelper {
    ...
    public static byte[] decrypt(byte[] bArr, byte[] bArr2) throws Exception {
        ...
        cipher.init(2, new SecretKeySpec(bArr2, EncryptUtils.AES_ENCRYPT_ALGORITHM), new IvParameterSpec(UMUtils.genIv()));
    ...
    public static byte[] encrypt(byte[] bArr, byte[] bArr2) throws Exception {
        Cipher cipher = Cipher.getInstance("AES/CBC/PKCS7Padding");
        cipher.init(1, new SecretKeySpec(bArr2, EncryptUtils.AES_ENCRYPT_ALGORITHM), new IvParameterSpec(UMUtils.genIv()));
        return cipher.doFinal(bArr);
    }
