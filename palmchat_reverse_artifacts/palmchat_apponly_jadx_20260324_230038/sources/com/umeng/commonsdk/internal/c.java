...
public class c implements UMLogDataProtocol {
    ...
    public static final String f11038a = bd.b().b(bd.q);
        ...
        if (m) {
            ...
            a(this.e, new OnGetOaidListener() { // from class: com.umeng.commonsdk.internal.c.4
                ...
                public void onGetOaid(String str) {
                    ...
                    try {
                        SharedPreferences sharedPreferences = c.this.e.getSharedPreferences(i.f11083a, 0);
    ...
    */
            ...
            switch (i2) {
                ...
                case a.h /* 32771 */:
                    if (obj != null && (obj instanceof com.umeng.commonsdk.internal.utils.b)) {
                        ...
                        try {
                            jSONObject.put("le", bVar.f11045a);
                ...
                case a.z /* 32792 */:
                    ...
                    if (obj instanceof Integer) {
                        ...
                        SharedPreferences sharedPreferences = this.e.getApplicationContext().getSharedPreferences(f11038a, 0);
                        if (sharedPreferences != null) {
                ...
                case a.A /* 32793 */:
                    ...
                    if (obj instanceof JSONObject) {
                        ...
                        if (jSONObject4.has(a.J)) {
                            ...
                            SharedPreferences sharedPreferences2 = this.e.getApplicationContext().getSharedPreferences(f11038a, 0);
                ...
                case a.G /* 32805 */:
                    ...
                    if (sharedPreferencesA != null) {
                        long j2 = sharedPreferencesA.getLong(au.f10859a, 0L);
                        if (j2 < Long.MAX_VALUE) {
                            j2++;
                        }
                        sharedPreferencesA.edit().putLong(au.f10859a, j2).commit();
                    }
    ...
    private void b(Context context) {
        try {
            ...
            jSONObject.put(com.umeng.commonsdk.statistics.b.a(bt.g), strImprintProperty);
