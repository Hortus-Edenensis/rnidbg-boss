...
public class DBFileTraversalUtil {
    ...
    private static ExecutorService f10986a = Executors.newSingleThreadExecutor();
    ...
    public static void traverseDBFiles(String str, final FileLockCallback fileLockCallback, final a aVar) {
        ...
        if (file.exists() && file.isDirectory()) {
            f10986a.execute(new Runnable() { // from class: com.umeng.analytics.process.DBFileTraversalUtil.1
