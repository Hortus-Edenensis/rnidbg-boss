...
public class UMProcessDBHelper {
                ...
                try {
                    ...
                    for (a aVar : list) {
                        try {
                            ...
                            contentValues.put(a.InterfaceC0901a.f, aVar.f);
                            contentValues.put("__av", aVar.g);
                            contentValues.put("__vc", aVar.h);
                            contentValues.put("__s", aVar.d);
                            sQLiteDatabaseA.insert(a.InterfaceC0901a.f10996a, null, contentValues);
                        } catch (Exception unused) {
                        }
                    }
    ...
    */
    private List<a> readEventByProcess(String str) throws Throwable {
        ...
        try {
            sQLiteDatabaseA.beginTransaction();
            cursorQuery = sQLiteDatabaseA.query(a.InterfaceC0901a.f10996a, null, null, null, null, null, null);
            if (cursorQuery != null) {
                while (cursorQuery.moveToNext()) {
                    try {
                        try {
                            a aVar = new a();
                            aVar.f10994a = cursorQuery.getInt(0);
                            ...
                            aVar.f = cursorQuery.getString(cursorQuery.getColumnIndex(a.InterfaceC0901a.f));
        ...
        try {
            ...
            if (size > 0) {
                for (int i = 0; i < size; i++) {
                    sQLiteDatabaseA.delete(a.InterfaceC0901a.f10996a, "rowid=?", new String[]{String.valueOf(list.get(i).f10994a)});
                }
            } else {
                sQLiteDatabaseA.delete(a.InterfaceC0901a.f10996a, null, null);
            }
            sQLiteDatabaseA.setTransactionSuccessful();
            sQLiteDatabaseA.endTransaction();
        } catch (Exception unused2) {
    ...
    public void deleteMainProcessEventDatasByIds(List<Integer> list) {
        ...
        try {
            ...
            while (it.hasNext()) {
                sQLiteDatabaseA.delete(a.InterfaceC0901a.f10996a, "id=?", new String[]{String.valueOf(it.next())});
            }
            sQLiteDatabaseA.setTransactionSuccessful();
        } catch (Exception unused) {
            if (sQLiteDatabaseA != null) {
                ...
                try {
                    ...
                    if (cursorQuery != null) {
                        ...
                        while (cursorQuery.moveToNext()) {
                            ...
                            String string3 = cursorQuery.getString(cursorQuery.getColumnIndex(a.InterfaceC0901a.f));
    ...
    public JSONObject readVersionInfoFromColumId(Integer num) throws Throwable {
        ...
        try {
            ...
            try {
                try {
                    sQLiteDatabaseA.beginTransaction();
                    Cursor cursorQuery = sQLiteDatabaseA.query(a.InterfaceC0901a.f10996a, null, "rowid=?", new String[]{String.valueOf(num)}, null, null, null);
                    if (cursorQuery != null) {
                        try {
                            try {
