...
public final class ci {
    ...
    private static final Comparator f10906a = new a();
    ...
    public static int a(List list, List list2) {
        ...
        for (int i = 0; i < list.size(); i++) {
            int iCompare = f10906a.compare(list.get(i), list2.get(i));
            if (iCompare != 0) {
                return iCompare;
            }
        }
    ...
    public static int a(Set set, Set set2) {
        ...
        while (it.hasNext() && it2.hasNext()) {
            int iCompare = f10906a.compare(it.next(), it2.next());
            if (iCompare != 0) {
                return iCompare;
            }
        }
    ...
    public static int a(Map map, Map map2) {
        ...
        while (it.hasNext() && it2.hasNext()) {
            ...
            Comparator comparator2 = f10906a;
