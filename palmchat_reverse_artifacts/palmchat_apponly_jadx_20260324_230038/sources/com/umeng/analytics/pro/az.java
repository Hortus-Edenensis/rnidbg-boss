...
public class az {
    ...
    public static Handler f10863a = null;
    ...
    public static void a(Context context, int i, int i2, a aVar, Object obj, long j) {
        ...
        if (c == null || f10863a == null) {
            a();
        }
        try {
            Handler handler = f10863a;
            if (handler != null) {
                Message messageObtainMessage = handler.obtainMessage();
                messageObtainMessage.what = i;
                messageObtainMessage.arg1 = i2;
                messageObtainMessage.obj = obj;
                f10863a.sendMessageDelayed(messageObtainMessage, j);
            }
    ...
    private static synchronized void a() {
        try {
            if (c == null) {
                ...
                handlerThread.start();
                if (f10863a == null) {
                    f10863a = new Handler(c.getLooper()) { // from class: com.umeng.analytics.pro.az.1
