...
public class u {
    ...
    private static final String f10980a = "fs_lc_tl_uapp";
    ...
    public static class a {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private static final u f10981a = new u();
    ...
    private void b(Context context) {
        try {
            String string = PreferenceWrapper.getDefault(context).getString(f10980a, null);
    ...
    private void c(Context context) {
        try {
            if (this.h != null) {
                PreferenceWrapper.getDefault(g).edit().putString(f10980a, this.h.toString()).commit();
            }
