...
public class q {
    ...
    private static Context f10972a = null;
    ...
    public static class b {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private static final q f10974a = new q();
    ...
    public static q a(Context context) {
        if (f10972a == null && context != null) {
            f10972a = context.getApplicationContext();
        }
        return b.f10974a;
    }
    ...
    private void i() {
        JSONObject jSONObjectB = b(UMEnvelopeBuild.maxDataSpace(f10972a));
        ...
        if (f10972a == null || jSONObject == null || jSONObject2 == null) {
            return;
        }
        UMRTLog.i(UMRTLog.RTLOG_TAG, "--->>> constructInstantMessage: request build envelope.");
        JSONObject jSONObjectBuildEnvelopeWithExtHeader = UMEnvelopeBuild.buildEnvelopeWithExtHeader(f10972a, jSONObject, jSONObject2);
    ...
    private void j() {
        ...
        JSONObject jSONObjectA = a(UMEnvelopeBuild.maxDataSpace(f10972a));
    ...
    private JSONObject l() {
        ...
        try {
            ...
            int verticalType = AnalyticsConfig.getVerticalType(f10972a);
            jSONObject.put(com.umeng.commonsdk.statistics.b.a(f.i), verticalType);
            String str = "9.8.8";
            if (verticalType == 1) {
                String gameSdkVersion = AnalyticsConfig.getGameSdkVersion(f10972a);
                if (!TextUtils.isEmpty(gameSdkVersion)) {
                    str = gameSdkVersion;
                }
                jSONObject.put(com.umeng.commonsdk.statistics.b.a("sdk_version"), str);
            } else {
                jSONObject.put(com.umeng.commonsdk.statistics.b.a("sdk_version"), "9.8.8");
            }
            String strMD5 = HelperUtils.MD5(AnalyticsConfig.getSecretKey(f10972a));
            if (!TextUtils.isEmpty(strMD5)) {
                jSONObject.put(com.umeng.commonsdk.statistics.b.a("secret"), strMD5);
            }
            String strImprintProperty = UMEnvelopeBuild.imprintProperty(f10972a, "pr_ve", null);
            SharedPreferences sharedPreferences = PreferenceWrapper.getDefault(f10972a);
            String strImprintProperty2 = UMEnvelopeBuild.imprintProperty(f10972a, f.at, "");
            ...
            String strImprintProperty3 = UMEnvelopeBuild.imprintProperty(f10972a, f.au, "");
            ...
            if (sharedPreferences != null) {
                ...
                if (!TextUtils.isEmpty(string)) {
                    ...
                    sharedPreferences.edit().putString("pre_version", string).putString("cur_version", DeviceConfig.getAppVersionName(f10972a)).putString("pre_date", str2).remove("vers_name").remove("vers_code").remove("vers_date").remove("vers_pre_version").commit();
                }
            }
        } catch (Throwable th) {
            th.printStackTrace();
    ...
    private String m() {
        ...
        try {
            strImprintProperty = UMEnvelopeBuild.imprintProperty(f10972a, "pr_ve", null);
        } catch (Throwable unused) {
        }
        if (!TextUtils.isEmpty(strImprintProperty)) {
            ...
            if (this.c == null) {
                this.c = PreferenceWrapper.getDefault(f10972a);
            }
            String string2 = this.c.getString("pre_version", "");
            String appVersionName = DeviceConfig.getAppVersionName(f10972a);
    ...
    private String n() {
        String strImprintProperty = null;
        try {
            strImprintProperty = UMEnvelopeBuild.imprintProperty(f10972a, "ud_da", null);
            if (TextUtils.isEmpty(strImprintProperty)) {
    ...
    private void o() {
        try {
            ...
            this.j = 0;
            this.k = System.currentTimeMillis();
            PreferenceWrapper.getDefault(f10972a).edit().putLong(o, System.currentTimeMillis()).putInt(p, 0).commit();
        } catch (Throwable unused) {
        }
    }
    ...
    private void r() {
        ...
        try {
            if (!s() || (context = f10972a) == null || (sharedPreferences = PreferenceWrapper.getDefault(context)) == null || sharedPreferences.getLong(l, 0L) != 0) {
                return;
            }
    ...
    public void d() {
        try {
            ...
            PreferenceWrapper.getDefault(f10972a).edit().putLong(n, this.k).putInt(q, this.i).putInt(r, this.j).commit();
        } catch (Throwable unused) {
        }
    }
    ...
    private void b(JSONObject jSONObject) {
        ...
        if (k.a(UMGlobalContext.getAppContext(f10972a)).c() || (jSONObjectF = k.a(UMGlobalContext.getAppContext(f10972a)).f()) == null) {
            return;
        }
        ...
        try {
            if (TextUtils.isEmpty(strOptString)) {
                jSONObject.put(com.umeng.commonsdk.statistics.b.a("app_version"), UMUtils.getAppVersionName(f10972a));
            } else {
                jSONObject.put(com.umeng.commonsdk.statistics.b.a("app_version"), strOptString);
            }
            if (TextUtils.isEmpty(strOptString2)) {
                jSONObject.put(com.umeng.commonsdk.statistics.b.a("version_code"), UMUtils.getAppVersionCode(f10972a));
            } else {
    ...
    public static class c {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private ReportPolicy.ReportStrategy f10975a = null;
        private int b = -1;
        private int c = -1;
        private int d = -1;
        private int e = -1;
        ...
        public c() {
            this.f = null;
            this.f = ABTest.getService(q.f10972a);
        }
        ...
        public void b() {
            int iA;
            Defcon service = Defcon.getService(q.f10972a);
            if (service.isOpen()) {
                ReportPolicy.ReportStrategy reportStrategy = this.f10975a;
                this.f10975a = (reportStrategy instanceof ReportPolicy.DefconPolicy) && reportStrategy.isValid() ? this.f10975a : new ReportPolicy.DefconPolicy(StatTracer.getInstance(q.f10972a), service);
            } else {
                boolean z = Integer.valueOf(UMEnvelopeBuild.imprintProperty(q.f10972a, "integrated_test", "-1")).intValue() == 1;
                if (UMConfigure.isDebugLog() && z && !MLog.DEBUG) {
                    UMLog.mutlInfo(l.K, 3, "\\|", null, null);
                }
                if (MLog.DEBUG && z) {
                    this.f10975a = new ReportPolicy.DebugPolicy(StatTracer.getInstance(q.f10972a));
                } else if (this.f.isInTest() && "RPT".equals(this.f.getTestName())) {
                    if (this.f.getTestPolicy() == 6) {
                        if (Integer.valueOf(UMEnvelopeBuild.imprintProperty(q.f10972a, "test_report_interval", "-1")).intValue() != -1) {
                            iA = a(90000);
                        } else {
                            iA = this.c;
                            if (iA <= 0) {
                    ...
                    this.f10975a = b(this.f.getTestPolicy(), iA);
                } else {
                    int i = this.d;
                    int i2 = this.e;
                    int i3 = this.b;
            ...
            if (UMConfigure.isDebugLog()) {
                try {
                    ReportPolicy.ReportStrategy reportStrategy2 = this.f10975a;
        ...
        public int[] a(int i, int i2) {
            int iIntValue = Integer.valueOf(UMEnvelopeBuild.imprintProperty(q.f10972a, "report_policy", "-1")).intValue();
            int iIntValue2 = Integer.valueOf(UMEnvelopeBuild.imprintProperty(q.f10972a, "report_interval", "-1")).intValue();
        ...
        public int a(int i) {
            int iIntValue = Integer.valueOf(UMEnvelopeBuild.imprintProperty(q.f10972a, "test_report_interval", "-1")).intValue();
        ...
        private ReportPolicy.ReportStrategy b(int i, int i2) {
            ...
            if (i == 4) {
                ReportPolicy.ReportStrategy reportStrategy3 = this.f10975a;
                return reportStrategy3 instanceof ReportPolicy.ReportDaily ? reportStrategy3 : new ReportPolicy.ReportDaily(StatTracer.getInstance(q.f10972a));
            }
            if (i == 5) {
                ReportPolicy.ReportStrategy reportStrategy4 = this.f10975a;
                return reportStrategy4 instanceof ReportPolicy.ReportWifiOnly ? reportStrategy4 : new ReportPolicy.ReportWifiOnly(q.f10972a);
            }
            if (i == 6) {
                ReportPolicy.ReportStrategy reportStrategy5 = this.f10975a;
                ...
                return new ReportPolicy.ReportByInterval(StatTracer.getInstance(q.f10972a), i2);
            }
            if (i == 8) {
                ReportPolicy.ReportStrategy reportStrategy6 = this.f10975a;
                return reportStrategy6 instanceof ReportPolicy.SmartPolicy ? reportStrategy6 : new ReportPolicy.SmartPolicy(StatTracer.getInstance(q.f10972a));
            }
            if (i != 11) {
                ReportPolicy.ReportStrategy reportStrategy7 = this.f10975a;
                return reportStrategy7 instanceof ReportPolicy.ReportAtLaunch ? reportStrategy7 : new ReportPolicy.ReportAtLaunch();
            }
            ReportPolicy.ReportStrategy reportStrategy8 = this.f10975a;
    ...
    private void c(JSONObject jSONObject) {
        try {
            if (!k.a(f10972a).e()) {
                JSONObject jSONObjectG = k.a(f10972a).g();
                if (jSONObjectG != null) {
    ...
    public static class d {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private Map<String, Object> f10976a;
        private String b;
        private String c;
        private long d;
    ...
    private void h(Object obj) {
        try {
            ...
            k.a(f10972a).a(strOptString, obj.toString(), 2);
        } catch (Throwable unused) {
        }
    }
    ...
    public JSONObject b(long j) {
        if (TextUtils.isEmpty(aa.a().d(UMGlobalContext.getAppContext(f10972a)))) {
            return null;
        }
        JSONObject jSONObjectB = k.a(UMGlobalContext.getAppContext(f10972a)).b(false);
        String[] strArrA = com.umeng.analytics.c.a(f10972a);
    ...
    public void a(Object obj, int i) {
        if (com.umeng.commonsdk.utils.c.a()) {
            ...
            try {
                ...
                j.a(f10972a);
                com.umeng.commonsdk.utils.c.c(f10972a);
            } catch (Throwable unused) {
            }
        }
        if (AnalyticsConfig.enable) {
            try {
                if (i != 4358) {
                    switch (i) {
                        case 4097:
                            if (UMUtils.isMainProgress(f10972a)) {
                                if (obj != null) {
                                    e(obj);
                                }
                            ...
                            UMProcessDBHelper.getInstance(f10972a).insertEventsInSubProcess(UMFrUtils.getSubProcessName(f10972a), new JSONArray().put(obj));
                            return;
                        case 4098:
                            if (obj != null) {
                                e(obj);
                            ...
                            switch (i) {
                                ...
                                case a.o /* 4356 */:
                                    ...
                                    if (obj instanceof JSONObject) {
                                        JSONObject jSONObject = (JSONObject) obj;
                                        if (jSONObject.has(DeviceInfoUtil.UID_TAG) && jSONObject.has(f.M)) {
                                            string = jSONObject.getString(f.M);
                                            string2 = jSONObject.getString(DeviceInfoUtil.UID_TAG);
                                        }
                                        a(string2, string);
                                        return;
                                    }
                                                ...
                                                default:
                                                    switch (i) {
                                                        ...
                                                        case a.B /* 8210 */:
                                                            ...
                                                            if (!UMUtils.isMainProgress(f10972a) || (this.b.c() instanceof ReportPolicy.ReportQuasiRealtime)) {
                                                                return;
                                                            }
                                                            a(true);
                                                            return;
                                                            ...
                                                            switch (i) {
                                                                case a.E /* 8213 */:
                                                                    if (FieldManager.allow(com.umeng.commonsdk.utils.d.E)) {
                                                                        if (DeviceConfig.getGlobleActivity(f10972a) != null) {
                                                                            w.b(f10972a);
                                                                        }
                                                                        Context context3 = f10972a;
                                                                ...
                                                                case a.F /* 8214 */:
                                                                    if (obj != null && (obj instanceof JSONObject)) {
                                                                        ...
                                                                        Context context4 = f10972a;
                                                                        String str = AnalyticsConfig.RTD_SP_FILE;
                                                                        com.umeng.common.b.a(context4, str, "startTime", strOptString);
                                                                        com.umeng.common.b.a(f10972a, str, AnalyticsConfig.RTD_PERIOD, strOptString2);
                                                                        com.umeng.common.b.a(f10972a, str, "debugkey", strOptString3);
                                                                        return;
                                                                    }
                                                                    return;
                                                                case a.G /* 8215 */:
                                                                    com.umeng.common.b.a(f10972a, AnalyticsConfig.RTD_SP_FILE);
                                                                    return;
                                                                default:
                                                                    return;
                                                            }
    ...
    private void g(Object obj) {
        try {
            ...
            if (jSONObject != null && jSONObject.length() > 0) {
                ...
                String string2 = jSONObject.getString(DeviceInfoUtil.UID_TAG);
                ...
                w.a().a(f10972a, j);
                String strC = aa.a().c(f10972a);
                boolean zB = w.a().b(f10972a, j, false);
                com.umeng.analytics.c.a(f10972a, string, string2);
                UMRTLog.i(UMRTLog.RTLOG_TAG, "--->>> onProfileSignIn: force generate new session: session id = " + strC);
                w.a().a(f10972a, j, true);
                if (zB) {
                    w.a().b(f10972a, j);
                }
            }
    ...
    private void f(Object obj) {
        try {
            ...
            if (jSONObject != null && jSONObject.length() > 0) {
                ...
                w.a().a(f10972a, j);
                UMRTLog.i(UMRTLog.RTLOG_TAG, "--->>> onProfileSignIn: force generate new session: session id = " + aa.a().c(f10972a));
                boolean zB = w.a().b(f10972a, j, false);
                com.umeng.analytics.c.b(f10972a);
                w.a().a(f10972a, j, true);
                if (zB) {
                    w.a().b(f10972a, j);
                }
    ...
    public JSONObject b(boolean z2) {
        ...
        try {
            ...
            if (strArrA != null && !TextUtils.isEmpty(strArrA[0]) && !TextUtils.isEmpty(strArrA[1])) {
                ...
                jSONObject3.put("puid", strArrA[1]);
                if (jSONObject3.length() > 0) {
                    ...
                    Map<String, Object> mapC = com.umeng.analytics.c.c(f10972a);
            ...
            if (ABTest.getService(f10972a).isInTest()) {
                JSONObject jSONObject5 = new JSONObject();
                jSONObject5.put(ABTest.getService(f10972a).getTestName(), ABTest.getService(f10972a).getGroupInfo());
                jSONObjectA.put(f.K, jSONObject5);
            }
            t.a().a(jSONObjectA, f10972a);
        } catch (Throwable unused) {
        }
        return jSONObjectA;
    }
    ...
    public void a(boolean z2) {
        if (c(z2)) {
            if (!(this.b.c() instanceof ReportPolicy.ReportQuasiRealtime)) {
                if (UMEnvelopeBuild.isReadyBuild(f10972a, UMLogDataProtocol.UMBusinessType.U_APP)) {
            ...
            if (z2) {
                if (UMEnvelopeBuild.isOnline(f10972a)) {
    ...
    public JSONObject a(long j) {
        if (TextUtils.isEmpty(aa.a().d(f10972a))) {
            return null;
        }
    ...
    private JSONObject a(JSONObject jSONObject, long j) {
        try {
            ...
            return s.a(f10972a, j, jSONObject);
        } catch (Throwable unused) {
            return jSONObject;
        }
    }
    ...
    public void a(Object obj, boolean z2) {
        ...
        } else if (UMEnvelopeBuild.isOnline(f10972a) && d(true)) {
            i();
        }
    }
}
