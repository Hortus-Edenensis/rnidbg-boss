...
public class b implements p, v {
    ...
    private static Context f10834a = null;
    ...
    static {
        ...
        if (appContext != null) {
            f10834a = appContext.getApplicationContext();
        }
    }
    ...
    private void i(Context context) {
        try {
            ...
            if (f10834a == null) {
                f10834a = context.getApplicationContext();
            }
    ...
    public String f() {
        if (UMUtils.isMainProgress(f10834a)) {
            return q;
        }
    ...
    public synchronized void k() {
        ...
        if (this.k != null) {
            SharedPreferences.Editor editorEdit = PreferenceWrapper.getDefault(f10834a).edit();
    ...
    public void a(Context context) {
        ...
        try {
            ...
            if (UMUtils.isMainProgress(f10834a)) {
                ...
                UMWorkDispatch.registerConnStateObserver(CoreProtocol.getInstance(f10834a));
            }
        } catch (Throwable unused2) {
        }
    }
    ...
    public void d(Context context) {
        ...
        try {
            ...
            if (context2 != null) {
                ...
                PreferenceWrapper.getDefault(f10834a).edit().commit();
            }
        } catch (Throwable unused) {
        }
    }
    ...
    public void b(Context context, String str) {
        try {
            ...
            if (!TextUtils.isEmpty(str)) {
                ...
                map.put(f.aK, str);
                a(f10834a, f.aJ, (Map<String, Object>) map, -1L, false);
                return;
            }
            UMLog.aq(l.O, 0, "\\|");
        } catch (Throwable th) {
    ...
    public void a(Context context, Throwable th) {
        if (context != null && th != null) {
            ...
            try {
                ...
                a(f10834a, DataHelper.convertExceptionToString(th));
                return;
            } catch (Exception e) {
                if (MLog.DEBUG) {
                    MLog.e(e);
    ...
    public void a(Context context, String str, String str2, long j, int i2) {
        ...
        try {
            ...
            u.a(f10834a).a(str, str2, j, i2, string);
        } catch (Throwable th) {
            if (MLog.DEBUG) {
                MLog.e(th);
            }
    ...
    private void a(Context context, String str, Map<String, Object> map, long j, boolean z2) {
        try {
            ...
            u.a(f10834a).a(str, map, j, string, z2);
        } catch (Throwable th) {
            if (MLog.DEBUG) {
                MLog.e(th);
            }
    ...
    public void a(Throwable th) {
        try {
            ...
            if (AnalyticsConfig.enable) {
                ...
                w wVar = this.f;
                if (wVar != null) {
                    wVar.c(f10834a, Long.valueOf(System.currentTimeMillis()));
                }
                if (th != null) {
                    JSONObject jSONObject = new JSONObject();
                    jSONObject.put("ts", System.currentTimeMillis());
                    ...
                    k.a(f10834a).a(this.f.c(), jSONObject.toString(), 1);
                }
                q.a(f10834a).d();
                x.a(f10834a);
                if (UMConfigure.AUTO_ACTIVITY_PAGE_COLLECTION == MobclickAgent.PageMode.AUTO) {
    ...
    public void a(double d, double d2) {
        ...
        if (AnalyticsConfig.f10826a == null) {
            AnalyticsConfig.f10826a = new double[2];
        }
        double[] dArr = AnalyticsConfig.f10826a;
        dArr[0] = d;
        dArr[1] = d2;
    }
    ...
    public void a(Context context, MobclickAgent.EScenarioType eScenarioType) {
        ...
        if (eScenarioType != null) {
            a(f10834a, eScenarioType.toValue());
        }
        if (this.j && this.n) {
            return;
        }
