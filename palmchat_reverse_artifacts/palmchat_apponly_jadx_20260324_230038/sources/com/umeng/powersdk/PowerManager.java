...
public class PowerManager {
    ...
    private static Context f11131a = null;
    ...
    public static void init(Context context, EfsReporter efsReporter) {
        ...
        f11131a = context.getApplicationContext();
        c = efsReporter;
        d = new PowerConfigManager(context, efsReporter);
        b = true;
        final c cVar = c.a.f11139a;
        try {
            ...
            final Handler handler = new Handler(handlerThread.getLooper()) { // from class: com.umeng.powersdk.c.1
                ...
                public final void handleMessage(Message message) {
                    ...
                    if (message.what == c.this.f11135a) {
                        try {
                            handlerThread.quit();
            ...
            handler.post(new Runnable() { // from class: com.umeng.powersdk.c.2
                ...
                public final void run() {
                    try {
                            ...
                            public final void run() {
                                if (c.this.e) {
                                    if (SystemClock.elapsedRealtime() - jElapsedRealtime > i2 * 1000) {
                                        handler2.sendEmptyMessage(c.this.f11135a);
                                        return;
                                    }
                                    try {
                        ...
                        handler.sendEmptyMessage(c.this.f11135a);
                    }
                }
            });
        } catch (Throwable unused) {
