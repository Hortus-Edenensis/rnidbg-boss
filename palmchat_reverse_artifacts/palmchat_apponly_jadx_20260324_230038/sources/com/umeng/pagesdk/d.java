...
public final class d {
    ...
    private static Map<String, Map> f11127a = new HashMap();
    private static c b;

    private static void a(String str) {
        Map map;
        if (TextUtils.isEmpty(str) || (map = f11127a.get(str)) == null || (r0 = map.entrySet().iterator()) == null) {
            return;
        }
        ...
        if (jSONArray != null) {
            ...
            try {
                ...
                b.a(PageManger.getApplicationContext()).a(new b.InterfaceC0912b() { // from class: com.umeng.pagesdk.d.1
                    @Override // com.umeng.pagesdk.b.InterfaceC0912b
                    public final void a(a aVar) {
                        try {
                            jSONObject2.put("te", aVar.c);
                            jSONObject2.put("le", aVar.f11121a);
    ...
    public static void b(String str, String str2, boolean z) {
        ...
        if (str2.equals("UM_onResume")) {
            ...
            a(str);
            if (TextUtils.isEmpty(str) || !f11127a.containsKey(str)) {
                return;
            }
            f11127a.remove(str);
            return;
