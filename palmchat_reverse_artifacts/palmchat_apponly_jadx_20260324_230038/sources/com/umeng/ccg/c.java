...
public class c {
    ...
    public static Handler f11003a = null;
    ...
    public static void a(Context context, int i2, int i3, a aVar, Object obj, long j2) {
        ...
        if (A == null || f11003a == null) {
            a();
        }
        try {
            Handler handler = f11003a;
            if (handler != null) {
                Message messageObtainMessage = handler.obtainMessage();
                messageObtainMessage.what = i2;
                messageObtainMessage.arg1 = i3;
                messageObtainMessage.obj = obj;
                f11003a.sendMessageDelayed(messageObtainMessage, j2);
            }
    ...
    private static synchronized void a() {
        try {
            if (A == null) {
                ...
                handlerThread.start();
                if (f11003a == null) {
                    f11003a = new Handler(A.getLooper()) { // from class: com.umeng.ccg.c.1
