...
public class q {
    ...
    public static final int f7491a = 3;
    ...
    public void c() {
        for (s sVar : this.f.a()) {
            ...
            if ((rVarA != null ? rVarA.d(sVar.c) : null) == null) {
                a(sVar.f7495a, sVar.d, (PackageInfo) null);
            }
        }
    }
        ...
        try {
            ...
            for (s sVar : this.f.a()) {
                ...
                if (canonicalPath != null) {
                    sVar.m = canonicalPath + bi.j + sVar.f7495a;
    ...
    public boolean a(s sVar, String str, String str2) {
        ...
        try {
            if (!this.f.b(sVar.f7495a)) {
                this.f.a(sVar);
            }
            rVarA = r.a(this.e.getApplicationContext(), true);
            this.f.a(sVar.f7495a, 1);
            b(sVar.c);
        } catch (Throwable unused) {
        }
        if (!rVarA.a(sVar, true)) {
            file.delete();
            a(sVar.f7495a, sVar.d, null, true, null);
            this.f.a(sVar.f7495a, 0);
            return false;
        }
        sVar = rVarA.c(sVar.e);
        if (sVar == null) {
