...
public class ah {
    ...
    private static final String f7389a = "YW5kcm9pZC5hcHAuQWN0aXZpdHlUaHJlYWQ=";
    ...
    private void b(JSONObject jSONObject, int i) {
        try {
            Object objA = dh.a(new String(c.a(f7389a.getBytes(), 2)), (Object) null, "getPackageManager", new Object[0]);
            if (objA != null) {
                a(objA, jSONObject, i);
            }
    ...
    private void d(JSONObject jSONObject, int i) {
        Object objA;
        try {
            Object objA2 = dh.a(new String(c.a(f7389a.getBytes(), 2)), (Object) null, "currentActivityThread", new Object[0]);
