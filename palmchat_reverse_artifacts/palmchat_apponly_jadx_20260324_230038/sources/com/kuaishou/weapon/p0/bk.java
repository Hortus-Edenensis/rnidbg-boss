...
public class bk {
    ...
    private static final String f7417a = "/proc/cpuinfo";
    ...
    public static String a() {
        try {
            ...
            if (!TextUtils.isEmpty(str2)) {
                sb.append(com.huawei.openalliance.ad.constant.x.aQ + str2);
            }
            String strA = bh.a("ro.product.cpu.abilist");
            if (!TextUtils.isEmpty(strA)) {
                sb.append(com.huawei.openalliance.ad.constant.x.aQ + strA);
            }
            return sb.toString();
    ...
    public static bj b() throws IOException {
        ...
        String[] strArrSplit;
        try {
            fileInputStream = new FileInputStream(new File(f7417a));
            try {
