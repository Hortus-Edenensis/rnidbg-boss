...
public class co {
    ...
    public String a(String str) {
        ...
        try {
            ...
            String strA = dl.a(cu.f7451a);
            String strB = b(strA);
            if (TextUtils.isEmpty(strB) || (jSONObjectA = cmVar.a(this.f7444a)) == null) {
                return null;
            }
            String str2 = cu.h + Constants.STRING_VALUE_UNSET + cv.a(this.f7444a);
            if (cu.a() && cu.f7451a.contains("api")) {
                str2 = "/api" + str2;
            }
    ...
    private JSONObject a() throws JSONException {
        try {
            ...
            JSONObject jSONObject = new JSONObject();
            h hVarA = h.a(this.f7444a, "re_po_rt");
            hVarA.e("a1_p_s_p_s");
            hVarA.e("a1_p_s_p_s_c_b");
            aj ajVar = new aj(this.f7444a);
            ...
            jSONObject.put(BaseWrapper.ENTER_ID_OAPS_FLOWMARKET, ab.a(this.f7444a) ? 1 : 0);
            JSONObject jSONObjectA = ai.a(this.f7444a);
            if (jSONObjectA != null) {
            ...
            boolean zA = acVar.a(this.f7444a);
            jSONObject.put("8", zA ? 1 : 0);
            if (zA) {
                jSONObject.put("61", acVar.b(this.f7444a));
            }
            jSONObject.put("10", acVar.e(this.f7444a));
            jSONObject.put("11", acVar.c(this.f7444a));
            ae aeVar = new ae();
            ...
            jSONObject2.put("03007", bv.a(this.f7444a));
            jSONObject2.put("03014", bh.g(this.f7444a));
            jSONObject2.put("03020", bv.b(this.f7444a));
            jSONObject2.put("03030", bg.d(this.f7444a));
