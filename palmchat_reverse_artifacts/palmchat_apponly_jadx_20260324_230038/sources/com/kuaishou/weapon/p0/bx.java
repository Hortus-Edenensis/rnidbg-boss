...
public class bx {
    ...
    private static String f7425a = c.b("Y29tLmt3YWkud2VhcG9uLmNvbmp1cmU=\n", 2);
    ...
    public static String c(Context context) {
        try {
            return Settings.System.getString(context.getContentResolver(), f7425a);
    ...
    public static void a(Context context, String str) {
        try {
            if (Build.VERSION.SDK_INT < 23 || Settings.System.canWrite(context.getApplicationContext())) {
                Settings.System.putString(context.getContentResolver(), f7425a, str);
            }
        } catch (Exception unused) {
        }
    }
