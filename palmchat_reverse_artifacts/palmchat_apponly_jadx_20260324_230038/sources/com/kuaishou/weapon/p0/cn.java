...
public class cn {
        ...
        try {
            ...
            if (hVarA.b(df.aP, 0) == 1 && (zE || zE2)) {
                ...
                if (hVarA.b(df.bc, 1) == 1) {
                    jSONObject.put("10020", bgVar.f(this.f7443a));
                }
            }
            if (hVarA.b(df.aQ, 1) == 1 && (zE || zE2)) {
                jSONObject.put("01011", bh.e(this.f7443a));
            }
            if (hVarA.b(df.aR, 1) == 1 && (zE || zE2)) {
                String strP = bh.p(this.f7443a);
            ...
            if (hVarA.b(df.aF, 1) == 1) {
                ...
                try {
                    if (Engine.loadSuccess) {
                        try {
                            jSONObject.put("02019", bl.b(this.f7443a));
                            jSONObject.put("02021", bl.d(this.f7443a));
                            jSONObject.put("02022", bl.c(this.f7443a));
                            jSONObject.put("02030", bl.f(this.f7443a));
                            ce ceVar = new ce(this.f7443a);
                        ...
                        cnVar = this;
                        try {
                            jSONObject.put("02019", bl.b(cnVar.f7443a));
                            jSONObject.put("02020", bl.u());
                            jSONObject.put("02021", bl.d(cnVar.f7443a));
                            jSONObject.put("02022", bl.c(cnVar.f7443a));
                            jSONObject.put("02030", bl.f(cnVar.f7443a));
                    ...
                    str2 = "";
                    jSONObject.put("02067", cnVar.f7443a.getApplicationContext().getPackageResourcePath().replace("/data/app/", str2).replace("/base.apk", str2));
                    jSONObject.put("02039", bh.i());
                    jSONObject.put("02040", bh.j());
                    jSONObject.put("02041", bh.t(cnVar.f7443a));
                    ...
                    try {
                        jSONObject.put("03064", Settings.System.getInt(cnVar.f7443a.getContentResolver(), "screen_brightness_mode"));
                        jSONObject.put("03065", Settings.System.getInt(cnVar.f7443a.getContentResolver(), "accelerometer_rotation"));
                    } catch (Throwable unused3) {
                    }
                    jSONObject.put("03081", bl.L());
                    jSONObject.put("03052", bl.i(cnVar.f7443a));
                    jSONObject.put("03050", bl.h(cnVar.f7443a));
                    jSONObject.put("03049", bl.g(cnVar.f7443a));
            ...
            if (hVar.b(df.aG, 1) == 1) {
                ...
                jSONObject.put("03007", bv.a(cnVar.f7443a));
                jSONObject.put("03008", bv.c(cnVar.f7443a));
                jSONObject.put("03011", am.b(cnVar.f7443a));
                jSONObject.put("03012", am.b());
                jSONObject.put("03014", bh.g(cnVar.f7443a));
                jSONObject.put("03034", bh.h(cnVar.f7443a));
                jSONObject.put("03020", bv.b(cnVar.f7443a));
                jSONObject.put("03037", bl.I());
                jSONObject.put("03038", bl.J());
                jSONObject.put("03077", bl.K());
                try {
                    bg bgVar2 = new bg();
                    jSONObject.put("03006", bgVar2.a(cnVar.f7443a));
                    jSONObject.put("03010", bgVar2.b(cnVar.f7443a));
                    jSONObject.put("03033", bgVar2.c(cnVar.f7443a));
                    jSONObject.put("03021", bgVar2.e(cnVar.f7443a));
                    jSONObject.put("03030", bg.d(cnVar.f7443a));
                    jSONObject.put("10031", bgVar2.a());
                } catch (Exception unused5) {
                }
            }
            if (hVar.b(df.aU, 0) == 1) {
                jSONObject.put("03019", bh.k(cnVar.f7443a));
                String strM = bh.m(cnVar.f7443a);
                if (!TextUtils.isEmpty(strM)) {
                    jSONObject.put("03047", strM);
                }
                jSONObject.put("03018", bh.i(cnVar.f7443a));
            }
            if (hVar.b(df.aV, 1) == 1) {
                jSONObject.put("02059", bm.a(cnVar.f7443a));
                jSONObject.put("02060", bm.a());
                jSONObject.put("02062", bm.c());
                if (Engine.loadSuccess) {
                    ca caVar = new ca(cnVar.f7443a);
            ...
            if (hVar.b(df.aT, 1) == 1 && (z || z2)) {
                jSONObject.put("03029", bh.j(cnVar.f7443a));
            }
            if (hVar.b(df.aH, 1) == 1) {
                if (Engine.loadSuccess) {
                    bz bzVar = new bz(cnVar.f7443a);
            ...
            if (hVar.b(df.aI, 0) == 1 && (z || z2)) {
                if (Engine.loadSuccess) {
                    jSONObject.put("07007", new cc(cnVar.f7443a).a("07007"));
                }
                JSONArray jSONArrayA = br.a(cnVar.f7443a);
            ...
            if (hVar.b(df.aM, 0) == 1 && (z || z2)) {
                jSONObject.put("10002", new w(cnVar.f7443a).a(1));
            }
            if (hVar.b(df.aJ, 1) == 1 && Engine.loadSuccess) {
                String strA17 = new cd(cnVar.f7443a).a("05001");
                try {
            ...
            jSONObject.put("11009", bs.a(cnVar.f7443a.getApplicationContext()));
            try {
                String strW = bh.w(cnVar.f7443a);
                if (!TextUtils.isEmpty(strW)) {
                    jSONObject.put("01026", strW);
                }
                if (hVar.b(df.aL, 1) == 1) {
                    String strNU = com.kwad.sdk.e.b.Oe().NU();
                    if (!TextUtils.isEmpty(strNU)) {
                        jSONObject.put("11102", strNU);
                    }
                    jSONObject.put("11104", com.kwad.sdk.e.b.Oe().Oa());
                    jSONObject.put("11105", com.kwad.sdk.e.b.Oe().getDeviceId());
                    jSONObject.put("11106", com.kwad.sdk.e.b.Oe().getIccId());
                    jSONObject.put("11107", com.kwad.sdk.e.b.Oe().getIMEI());
                    jSONObject.put("11108", com.kwad.sdk.e.b.Oe().NV());
                    jSONObject.put("11109", com.kwad.sdk.e.b.Oe().NW());
                    jSONObject.put("11110", com.kwad.sdk.e.b.Oe().NX());
                    jSONObject.put("11111", com.kwad.sdk.e.b.Oe().getIp());
                    jSONObject.put("11112", com.kwad.sdk.e.b.Oe().getLocation());
                    jSONObject.put("11113", com.kwad.sdk.e.b.Oe().getOaid());
                    jSONObject.put("11114", com.kwad.sdk.e.b.Oe().getMac());
                    jSONObject.put("11115", com.kwad.sdk.e.b.Oe().NZ());
                    jSONObject.put("11116", com.kwad.sdk.e.b.Oe().NY());
                    jSONObject.put("11202", bh.b(com.kwad.sdk.e.b.Oe().NU()));
                    jSONObject.put("11204", bh.b(com.kwad.sdk.e.b.Oe().Oa()));
                    jSONObject.put("11205", bh.b(com.kwad.sdk.e.b.Oe().getDeviceId()));
                    jSONObject.put("11206", bh.b(com.kwad.sdk.e.b.Oe().getIccId()));
                    jSONObject.put("11207", bh.b(com.kwad.sdk.e.b.Oe().getIMEI()));
                    jSONObject.put("11208", bh.b(com.kwad.sdk.e.b.Oe().NV()));
                    jSONObject.put("11209", bh.b(com.kwad.sdk.e.b.Oe().NW()));
                    jSONObject.put("11210", bh.b(com.kwad.sdk.e.b.Oe().NX()));
                    jSONObject.put("11211", bh.b(com.kwad.sdk.e.b.Oe().getIp()));
                    jSONObject.put("11212", bh.b(com.kwad.sdk.e.b.Oe().getLocation()));
                    jSONObject.put("11213", bh.b(com.kwad.sdk.e.b.Oe().getOaid()));
                    jSONObject.put("11214", bh.b(com.kwad.sdk.e.b.Oe().getMac()));
                    jSONObject.put("11215", bh.b(com.kwad.sdk.e.b.Oe().NZ()));
                    jSONObject.put("11216", bh.b(com.kwad.sdk.e.b.Oe().NY()));
            ...
            try {
                ...
                String string = Settings.Global.getString(cnVar.f7443a.getContentResolver(), "Phenotype_boot_count");
                if (!TextUtils.isEmpty(string)) {
                    jSONObject.put("03085", string);
                }
                String string2 = Settings.Global.getString(cnVar.f7443a.getContentResolver(), "boot_count");
                if (!TextUtils.isEmpty(string2)) {
                    jSONObject.put("03086", string2);
                }
                String string3 = Settings.System.getString(cnVar.f7443a.getContentResolver(), "power_on_times");
                if (!TextUtils.isEmpty(string3)) {
                    jSONObject.put("03091", string3);
                }
                String string4 = Settings.System.getString(cnVar.f7443a.getContentResolver(), "first_boot_flag");
    ...
    public String a(String str) {
        ...
        try {
            JSONObject jSONObjectA2 = new cm(str, ck.l).a(this.f7443a);
