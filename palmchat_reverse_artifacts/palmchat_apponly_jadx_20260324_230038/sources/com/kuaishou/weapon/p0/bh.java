...
public class bh {
    ...
    public static String b(Context context) {
        try {
            return c(com.kwad.sdk.e.b.Oe().getIMEI());
    ...
    public static String d(Context context) {
        try {
            return c(com.kwad.sdk.e.b.Oe().NX());
        } catch (Throwable unused) {
            return bi.d;
        }
    }
    ...
    public static String e(Context context) {
        try {
            return c(com.kwad.sdk.e.b.Oe().getIccId());
        } catch (Throwable unused) {
            return bi.d;
        }
    }
    ...
    public static String f(Context context) {
        try {
            return c(com.kwad.sdk.e.b.Oe().NU());
        } catch (Throwable unused) {
            return bi.d;
        }
    }
    ...
    public static String i(Context context) {
        try {
            ...
            return string.endsWith(com.huawei.openalliance.ad.constant.x.aQ) ? string.substring(0, string.length() - 1) : string;
    ...
    public static String j(Context context) {
        ...
        try {
            ...
            if (string == null) {
                string = com.igexin.push.core.b.m;
            }
            String str = "1=" + string + com.huawei.openalliance.ad.constant.x.aQ;
            ...
            if (inputMethodManager != null && (enabledInputMethodList = inputMethodManager.getEnabledInputMethodList()) != null) {
                ...
                for (InputMethodInfo inputMethodInfo : enabledInputMethodList) {
                    ...
                    if (packageName == null) {
                        packageName = com.igexin.push.core.b.m;
                    }
                    String settingsActivity = inputMethodInfo.getSettingsActivity();
                    if (settingsActivity == null) {
                        settingsActivity = com.igexin.push.core.b.m;
                    }
                    if (packageManager != null) {
                        try {
                            if (!packageName.equals(com.igexin.push.core.b.m) && !settingsActivity.equals(com.igexin.push.core.b.m) && (activityInfo = packageManager.getActivityInfo(new ComponentName(packageName, settingsActivity), 0)) != null) {
                                i = activityInfo.launchMode;
                            }
                        } catch (Exception unused) {
                        }
                    }
                    str = str + packageName + "-" + settingsActivity + "-" + String.format(TimeModel.NUMBER_FORMAT, Integer.valueOf(i)) + com.huawei.openalliance.ad.constant.x.aQ;
                }
            }
            return str;
    ...
    public static int t(Context context) {
        try {
            String strC = c(com.kwad.sdk.e.b.Oe().NY());
    ...
    public static int u(Context context) {
        try {
            String strC = c(com.kwad.sdk.e.b.Oe().NZ());
            if (!TextUtils.isEmpty(strC) && !strC.startsWith("RISK")) {
                return Integer.parseInt(strC);
            }
            return -1;
    ...
    public static String w(Context context) {
        try {
            return c(com.kwad.sdk.e.b.Oe().getOaid());
        } catch (Throwable unused) {
            return "";
        }
    }
        ...
        try {
            ...
            if (jSONObjectZ != null && (itKeys = jSONObjectZ.keys()) != null) {
                ...
                while (itKeys.hasNext()) {
                    ...
                    sb.append(str);
                    str = com.huawei.openalliance.ad.constant.x.aQ;
                    sb.append(next);
    ...
    public static String b(Context context, int i) {
        try {
            return i == 1 ? c(com.kwad.sdk.e.b.Oe().NV()) : c(com.kwad.sdk.e.b.Oe().getIMEI());
        } catch (Throwable unused) {
            return bi.d;
        }
    }
    ...
    public static double c() {
        try {
            String strC = c(com.kwad.sdk.e.b.Oe().getLocation());
            if (!TextUtils.isEmpty(strC) && !strC.startsWith("RISK")) {
    ...
    public static String d() {
        try {
            String strC = c(com.kwad.sdk.e.b.Oe().Oa());
            if (!TextUtils.isEmpty(strC) && !strC.startsWith("RISK")) {
    ...
    public static String e() {
        try {
            String strC = c(com.kwad.sdk.e.b.Oe().Oc());
    ...
    public static JSONArray f() {
        try {
            String strC = c(com.kwad.sdk.e.b.Oe().Ob());
            if (!TextUtils.isEmpty(strC) && !strC.startsWith("RISK")) {
    ...
    public static String g() {
        try {
            return c(com.kwad.sdk.e.b.Oe().getIp());
        } catch (Throwable unused) {
            return bi.c;
        }
    }
    ...
    public static String h() {
        try {
            return c(com.kwad.sdk.e.b.Oe().getMac());
        } catch (Throwable unused) {
            return bi.c;
        }
    }
    ...
    public static String a(Context context, int i) {
        try {
            if (i == 1) {
                return c(com.kwad.sdk.e.b.Oe().NV());
            }
            return c(com.kwad.sdk.e.b.Oe().getIMEI());
        } catch (Throwable unused) {
            return bi.d;
    ...
    public static String c(String str) {
        ...
        try {
            ...
            if (i != 0) {
                return i == 3 ? bi.c : i == 1 ? bi.f7415a : bi.d;
            }
