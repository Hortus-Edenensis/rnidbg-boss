...
public class t {
    ...
    public static final String f7496a = "k";
    ...
    public int c(int i2) {
        ...
        int i3 = 0;
        try {
            cursorQuery = this.C.query(bi.q, new String[]{"n"}, "k=" + i2, null, null, null, null);
            if (cursorQuery != null) {
                try {
    ...
    public long a(s sVar) {
        ...
        try {
            if (b(sVar.f7495a)) {
                jInsert = this.C.update(bi.q, contentValues, "k=" + sVar.f7495a, null);
            } else {
                contentValues.put(f7496a, Integer.valueOf(sVar.f7495a));
    ...
    public void b() {
        ...
        try {
            ...
            for (s sVar2 : arrayList) {
                ...
                this.C.delete(bi.q, "k=" + sVar2.f7495a, null);
                List<Integer> list = r.b;
                if (list != null && !list.contains(Integer.valueOf(sVar2.f7495a))) {
                    dn.c(this.D.getFilesDir().getCanonicalPath() + bi.j + sVar2.f7495a);
                }
        ...
        try {
            ...
            if (cursorQuery != null) {
                while (cursorQuery.moveToNext()) {
                    try {
                        s sVar = new s();
                        sVar.f7495a = cursorQuery.getInt(cursorQuery.getColumnIndex(f7496a));
