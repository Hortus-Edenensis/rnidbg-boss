                ...
                while (true) {
                    ...
                    if (line != null) {
                        if (!line.contains("@Hw") && !line.contains(".apk@classes.dex") && !line.contains("WebViewGoogle") && !line.contains("FeatureFramework") && !line.contains("framework@oppo") && !line.contains("framework@mediatek")) {
                            ...
                            if (!line.contains(packageName) && line.contains("/data/") && line.contains(Constants.LIBRARY_SUFFIX)) {
                                hashSet.add(line.substring(line.indexOf("/data/"), line.indexOf(Constants.LIBRARY_SUFFIX) + 3));
