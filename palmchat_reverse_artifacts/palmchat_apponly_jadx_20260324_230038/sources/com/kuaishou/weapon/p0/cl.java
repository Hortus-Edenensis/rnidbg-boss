...
public class cl {
    ...
    public JSONObject a() {
        ...
        try {
            ...
            jSONObject.put(BaseWrapper.ENTER_ID_OAPS_FLOWMARKET, ab.a(this.f7441a) ? 1 : 0);
            JSONObject jSONObjectA = ai.a(this.f7441a);
            if (jSONObjectA != null) {
                jSONObject.put("4", jSONObjectA);
            }
            z zVar = new z();
            JSONArray jSONArrayA = zVar.a(this.f7441a);
            ...
            boolean zA = acVar.a(this.f7441a);
            jSONObject.put("8", zA ? 1 : 0);
            if (zA) {
                jSONObject.put("61", acVar.b(this.f7441a));
            }
            jSONObject.put("181", acVar.f(this.f7441a) ? 1 : 0);
            jSONObject.put("9", acVar.d(this.f7441a));
            jSONObject.put("10", acVar.e(this.f7441a));
            jSONObject.put("11", acVar.c(this.f7441a));
            ae aeVar = new ae();
            ...
            if (setC != null) {
                str = BaseWrapper.ENTER_ID_OAPS_RECENTS;
            ...
            if (setA != null) {
                jSONObject.put(BaseWrapper.ENTER_ID_OAPS_ASSISTANT_SCREEN, setA);
                if (setB != null || setC != null) {
                    ...
                    jSONObject.put(BaseWrapper.ENTER_ID_GAME_CENTER, anVar.a(this.f7441a, 13, hashSet));
                    jSONObject.put(BaseWrapper.ENTER_ID_AD_SDK, anVar.a(this.f7441a, 14, hashSet));
                    jSONObject.put("15", anVar.a(this.f7441a, 15, hashSet));
                    jSONObject.put("16", anVar.a(this.f7441a, 16, hashSet));
                    jSONObject.put(BaseWrapper.ENTER_ID_17, anVar.a(this.f7441a, 17, hashSet));
                    jSONObject.put(BaseWrapper.ENTER_ID_18, anVar.a(this.f7441a, 18, hashSet));
                    jSONObject.put(BaseWrapper.ENTER_ID_19, anVar.a(this.f7441a, 19, hashSet));
                    jSONObject.put(BaseWrapper.ENTER_ID_SYSTEM_HELPER, anVar.a(this.f7441a, 20, hashSet));
                    jSONObject.put("21", anVar.a(this.f7441a, 21, hashSet));
            ...
            jSONObject2.put("03007", bv.a(this.f7441a));
            jSONObject2.put("03014", bh.g(this.f7441a));
            jSONObject2.put("03020", bv.b(this.f7441a));
            jSONObject2.put("03030", bg.d(this.f7441a));
            ...
            jSONObject.put("145", ahVar.a(this.f7441a));
            jSONObject.put("132", dk.a());
            jSONObject.put("133", new aj(this.f7441a).g());
            if (hVarA.b(df.an, 1) == 1) {
                jSONObject.put("139", dl.c(this.f7441a));
                jSONObject.put("140", dl.d(this.f7441a));
            ...
            if (Engine.loadSuccess) {
                as asVar = new as(this.f7441a, 100);
                ...
                if (hVarA.b(df.ab, 1) == 1) {
                    ...
                    aq aqVar3 = new aq(this.f7441a, 4);
                ...
                if (hVarA.b(df.aj, 0) == 1) {
                    av avVar = new av(this.f7441a, 100);
                    ...
                    av avVar2 = new av(this.f7441a, 200);
                    jSONObject.put("173", avVar2.a("173"));
                    jSONObject.put("182", avVar2.a("182"));
                }
                if (hVarA.b(df.Y, 1) == 1) {
                    jSONObject.put("129", new be(this.f7441a, 4).a("129"));
                    be beVar = new be(this.f7441a, 1);
                    jSONObject.put("121", beVar.a(beVar.a(), "121"));
                    be beVar2 = new be(this.f7441a, 2);
                ...
                if (hVarA.b(df.U, 1) == 1) {
                    ba baVar = new ba(this.f7441a, 100);
                    ...
                    jSONObject.put("177", new ba(this.f7441a, 500).d("177"));
                }
                if ((zE || zE2) && hVarA.b(df.W, 0) == 1) {
                    jSONObject.put("158", new ba(this.f7441a, 300).b("158"));
                }
                if (hVarA.b(df.am, 0) == 1) {
                    bd bdVar = new bd(this.f7441a);
                    jSONObject.put("162", bdVar.a("162"));
                    jSONObject.put("160", bdVar.a(bdVar.a(), "160"));
                    ba baVar2 = new ba(this.f7441a, 400);
            ...
            jSONObject.put(PushConsts.SEND_MESSAGE_ERROR_GENERAL, this.c);
            try {
    ...
    public String a(String str) {
        ...
        try {
            JSONObject jSONObjectA2 = new cm(str, ck.l).a(this.f7441a);
