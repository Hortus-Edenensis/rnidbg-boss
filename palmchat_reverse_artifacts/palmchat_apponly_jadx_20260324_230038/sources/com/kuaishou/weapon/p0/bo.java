...
public class bo {
            ...
            try {
                ...
                while (true) {
                    try {
                        ...
                        String[] strArrSplit = a(line).split(com.huawei.openalliance.ad.constant.x.aQ);
    ...
    public static String a(String str) {
        try {
            return str.replace("      ", com.huawei.openalliance.ad.constant.x.aQ).replace("     ", com.huawei.openalliance.ad.constant.x.aQ).replace("    ", com.huawei.openalliance.ad.constant.x.aQ).replace("   ", com.huawei.openalliance.ad.constant.x.aQ).replace("  ", com.huawei.openalliance.ad.constant.x.aQ).replace(" ", com.huawei.openalliance.ad.constant.x.aQ);
        } catch (Throwable unused) {
            return null;
        }
    }
