...
public class z {
    ...
    private String f7516a = i.a("f118f1f9431de3a626df48d7302911", "0820");
        ...
        try {
            ...
            try {
                ...
                while (true) {
                    ...
                    if ((line.endsWith(com.huawei.hms.ads.dynamicloader.b.b) || line.endsWith(TdFileUtils.PLUGIN_FILE_TAIL) || line.endsWith(".dex") || line.endsWith(".odex") || line.endsWith(Constants.LIBRARY_SUFFIX)) && !line.contains("gson.jar") && !line.contains("volley.jar") && !line.contains("FwkPlugin") && (iIndexOf = line.indexOf(47)) >= 0) {
                        String strSubstring = line.substring(iIndexOf);
                        if (strSubstring.contains(this.f7516a) || strSubstring.contains(this.b) || strSubstring.contains(this.c)) {
