...
public class bw {
    ...
    public JSONObject a() {
        try {
            ...
            h hVarA = h.a(this.f7424a, "re_po_rt");
            ...
            jSONObject.put("11013", Integer.parseInt(bx.a(this.f7424a.getApplicationContext()), 2));
            jSONObject.put("11012", bx.b(this.f7424a));
            try {
            ...
            String strW = bh.w(this.f7424a);
            if (!TextUtils.isEmpty(strW)) {
                jSONObject.put("01026", strW);
            }
            if (iB == 1) {
                try {
                    JSONObject jSONObjectA = ai.a(this.f7424a);
                    if (jSONObjectA != null) {
                        jSONObject.put("11015", jSONObjectA);
                    }
                    if (Engine.loadSuccess) {
                        ce ceVar = new ce(this.f7424a);
                    ...
                    jSONObject.put("02021", bl.d(this.f7424a));
                    jSONObject.put("02022", bl.c(this.f7424a));
                    jSONObject.put("02044", bl.t());
                    jSONObject.put("11009", bs.a(this.f7424a.getApplicationContext()));
                    if (Engine.loadSuccess) {
                        bz bzVar = new bz(this.f7424a);
    ...
    public String a(String str) {
        try {
            synchronized (d) {
                JSONObject jSONObjectA = new cm(str, ck.l).a(this.f7424a);
                if (jSONObjectA == null) {
                    return null;
                }
