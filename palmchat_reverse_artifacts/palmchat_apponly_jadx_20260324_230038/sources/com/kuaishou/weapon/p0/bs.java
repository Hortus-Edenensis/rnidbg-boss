...
public final class bs {
    ...
    public static final String f7422a = "weapon.set";
    ...
    private static String d(Context context) {
        try {
            ...
            return new bn(context).a(f.a(str).toUpperCase() + HiAnalyticsConstant.REPORT_VAL_SEPARATOR + string.toUpperCase(), bi.u);
    ...
    private static void c(Context context, String str) {
        try {
            if (b(context)) {
                ...
                Settings.System.putString(contentResolver, f7422a, sb.toString());
            }
        } catch (Exception unused) {
        }
    }
