    ...
    public JSONObject a() {
        try {
            ...
            if (iOptInt != 1) {
                ...
                dp.a(this.j).a(dp.f7478a, 1, false);
                return null;
            }
                        ...
                        if ((System.currentTimeMillis() - this.n.a(dp.b)) - (((long) this.n.a(dp.c, 6)) * 3600000) > 0) {
                                ...
                                if (sVarA != null) {
                                    ...
                                    if (iIndexOf < 0 || !sVarA.y) {
                                        ...
                                        if (dn.b(sVarA.d, sVar.d)) {
                                            int i2 = sVarA.x;
                                            if (i2 != sVar.x) {
                                                this.l.c(sVarA.f7495a, i2);
                                            }
                                            if (!this.l.d(sVarA.f7495a)) {
                                                arrayList2.add(sVarA);
                                            }
                                            it = itKeys2;
                                            jSONObject = jSONObjectA;
                            ...
                            for (s sVar2 : listA) {
                                if (!arrayList4.contains(sVar2.c)) {
                                    ...
                                    if (list != null) {
                                        list.add(Integer.valueOf(sVar2.f7495a));
                                    }
                                    this.k.a(sVar2.c);
                                }
                            }
                            for (s sVar3 : arrayList3) {
                                if (!arrayList4.contains(sVar3.c)) {
                                    ...
                                    if (list2 != null) {
                                        list2.add(Integer.valueOf(sVar3.f7495a));
                                    }
                                    this.k.a(sVar3.c);
                                }
                            }
                            ...
                            for (s sVar4 : arrayList5) {
                                if (sVar4 != null) {
                                    if (arrayList.contains(sVar4)) {
                                        this.k.a(sVar4.f7495a, sVar4.d, (PackageInfo) null);
    ...
    private void a(s sVar) {
        try {
            if (!TextUtils.isEmpty(sVar.j) && sVar.j.length() >= 10) {
                ...
                File file = new File(this.m, sVar.f7495a + "-" + sVar.d + ".tmp");
                File file2 = new File(this.m, sVar.f7495a + "-" + sVar.d + ".zip");
                ...
                if (zA) {
                    ...
                    this.s.put(Integer.valueOf(sVar.f7495a), new a(3));
                }
                ...
                if (zA && sVar.j.equals(strA)) {
                    ...
                    if (this.k.a(sVar, (String) null, (String) null)) {
                        ...
                        if (map != null && !map.containsKey(Integer.valueOf(sVar.f7495a))) {
                            this.s.put(Integer.valueOf(sVar.f7495a), new a(1));
                        }
                        this.n.a(dp.b, System.currentTimeMillis(), true);
                        return;
                    }
                    Map<Integer, a> map2 = this.s;
                    if (map2 != null && !map2.containsKey(Integer.valueOf(sVar.f7495a))) {
                        this.s.put(Integer.valueOf(sVar.f7495a), new a(4));
                    }
                    this.k.a(sVar.f7495a, sVar.d, (PackageInfo) null);
                    return;
                }
                if (file.exists()) {
                    file.length();
