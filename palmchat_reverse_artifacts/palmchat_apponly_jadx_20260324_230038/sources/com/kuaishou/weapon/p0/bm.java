                ...
                while (true) {
                    try {
                        ...
                        if (line == null) {
                            ...
                            if (strA.contains("-") && strA.contains(com.huawei.openalliance.ad.constant.x.aQ)) {
                                String[] strArrSplit = strA.replace(";;;", com.huawei.openalliance.ad.constant.x.aQ).split(com.huawei.openalliance.ad.constant.x.aQ);
