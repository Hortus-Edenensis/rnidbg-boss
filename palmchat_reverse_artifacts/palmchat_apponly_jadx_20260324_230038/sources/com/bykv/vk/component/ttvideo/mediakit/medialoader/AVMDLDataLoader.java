            ...
            synchronized (AVMDLDataLoader.class) {
                if (mInstance == null) {
                    try {
                        ...
                        k.nr("ttmdl", "create native exception".concat(String.valueOf(e)));
                        mInstance = null;
                    }
                }
            }
    ...
    */
        ...
        if (!z) {
            try {
                try {
                    ...
                    k.nr("ttmn", "other exception when loading avmdl library: ".concat(String.valueOf(th)));
                }
            } catch (UnsatisfiedLinkError e) {
                k.nr("ttmn", "Can't load avmdl library: ".concat(String.valueOf(e)));
            }
    ...
    private void initLogThread(final Handler.Callback callback) {
        if (this.mMsgThread == null) {
            fx fxVar = new fx() { // from class: com.bykv.vk.component.ttvideo.mediakit.medialoader.AVMDLDataLoader.1
            ...
            this.mMsgThread = fxVar;
            fxVar.setName("mdl_log_handler");
    ...
    private void setConfigureInternal(AVMDLDataLoaderConfigure aVMDLDataLoaderConfigure) {
        ...
        if (i4 > 0) {
            _setIntValue(this.mHandle, KeyIsEnableEventInfo, i4);
        }
    ...
    public void onEventInfo(Object obj) {
        ...
        try {
            ...
            if (map.containsKey(WkInteractiveManager.TimingTypeOff)) {
                loaderEventInfo.off = ((Long) map.get(WkInteractiveManager.TimingTypeOff)).longValue();
            }
            ...
            if (strValueOf != "") {
                for (String str : strValueOf.split(HttpClient.NEWLINE)) {
    ...
    public int start() {
        ...
        initNativeHandle();
        new fx(new Runnable() { // from class: com.bykv.vk.component.ttvideo.mediakit.medialoader.AVMDLDataLoader.2
    ...
    */
    public static synchronized int init(boolean z, boolean z2) {
        ...
        if (!z) {
            ...
            if (z2) {
                k.nr("ttmn", "try to load pcdn lib");
                try {
                    try {
                        iz.u("avmdlp2p");
                    } catch (Throwable th2) {
                        k.nr("ttmn", "other exception when loading avmdl library: ".concat(String.valueOf(th2)));
                    }
                } catch (UnsatisfiedLinkError e2) {
                    k.nr("ttmn", "Can't load avmdlp2p library: ".concat(String.valueOf(e2)));
                }
            }
            tryLoadTTNetLoaderPlugin();
            return mIsLibraryLoaded ? -1 : 0;
    ...
    public static synchronized int init(boolean z, boolean z2, boolean z3) {
        ...
        if (z3) {
            try {
                ...
                k.nr("ttmn", "load avmdlv2 failed: ".concat(String.valueOf(e)));
            }
            if (mIsLibraryLoaded) {
                try {
                    try {
                        ...
                        k.nr("ttmn", "Can't load avmdl library: ".concat(String.valueOf(e2)));
                    }
                } catch (Throwable th) {
                    k.nr("ttmn", "other exception when loading avmdl library: ".concat(String.valueOf(th)));
                }
                if (z2) {
                    ...
                    try {
                        try {
                            ...
                            k.nr("ttmn", "Can't load avmdlp2p library: ".concat(String.valueOf(e3)));
                        }
                    } catch (Throwable th2) {
                        k.nr("ttmn", "other exception when loading avmdl library: ".concat(String.valueOf(th2)));
                    }
