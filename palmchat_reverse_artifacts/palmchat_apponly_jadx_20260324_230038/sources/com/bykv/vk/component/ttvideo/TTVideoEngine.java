...
public class TTVideoEngine implements com.bykv.vk.component.ttvideo.log.a, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnSeekCompleteListener, MediaPlayer.OnVideoSizeChangedListener {
    ...
    private int j0 = 0;
    private int k0 = 5000;
    private boolean t = l0;
    private final com.bykv.vk.component.ttvideo.utils.a W = new com.bykv.vk.component.ttvideo.utils.a();

    /* JADX INFO: compiled from: SearchBox */
    public class a implements Runnable {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ MediaPlayer f4950a;

        public a(TTVideoEngine tTVideoEngine, MediaPlayer mediaPlayer) {
            this.f4950a = mediaPlayer;
        }

        @Override // java.lang.Runnable
        public void run() {
            MediaPlayer mediaPlayer = this.f4950a;
            if (mediaPlayer != null) {
                try {
                    mediaPlayer.release();
    ...
    public static class c implements Runnable {
        ...
        public void run() {
            ...
            if (tTVideoEngine == null || tTVideoEngine.b == 5 || (map = this.f4952a) == null || map.size() <= 0) {
                return;
            }
            for (String str : this.f4952a.keySet()) {
                String str2 = this.f4952a.get(str);
    ...
    public void setIntOption(int i, int i2) {
        if (i == 11) {
            ...
            MediaPlayer mediaPlayer = this.H;
            if (mediaPlayer != null) {
                mediaPlayer.setIntOption(81, i2);
                return;
            }
            return;
        }
        if (i == 12) {
            ...
            if (mediaPlayer2 != null) {
                mediaPlayer2.setIntOption(9, i2 * 1000000);
                return;
            }
            return;
        }
        if (i == 118) {
            ...
            if (mediaPlayer3 != null) {
                mediaPlayer3.setIntOption(86, i2);
                return;
            }
            return;
        }
        ...
        if (i == 202) {
            ...
            if (mediaPlayer4 != null) {
                mediaPlayer4.setIntOption(110, i2);
                return;
            }
            return;
        }
        if (i == 322) {
            ...
            if (mediaPlayer5 != null) {
                mediaPlayer5.setIntOption(211, i2);
                return;
            }
            return;
        }
        ...
        if (mediaPlayer6 != null) {
            mediaPlayer6.setIntOption(223, i2);
        }
        DataLoaderHelper.getDataLoader().setIntValue(512, i2);
    }

    public void setIsMute(boolean z) {
        String.format("setIsMute:%s", Boolean.valueOf(z));
        this.K = z;
        b(z);
    }
    ...
    public Map versionInfo() {
        ...
        map.put(t.x, TTPlayerConfiger.getValue(14, ""));
    ...
    private void c() {
        ...
        if (!this.f4949a && mediaPlayer.getIntOption(62, -100) == 0 && !this.i && this.T && this.f) {
            k();
        }
    }
    ...
    private void d(int i) {
        ...
        VideoEngineSimpleCallback videoEngineSimpleCallback = this.B;
        if (videoEngineSimpleCallback != null) {
            videoEngineSimpleCallback.onRenderSeekComplete(i);
        }
    }
    ...
    private void a(int i, int i2) {
        int i3 = this.l;
        if (i3 != i) {
            if (i == 2 && this.f4949a && !this.c && i3 != 3) {
                this.V = i2;
            }
            this.l = i;
            VideoEngineSimpleCallback videoEngineSimpleCallback = this.B;
