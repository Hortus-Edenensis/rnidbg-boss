...
public class a implements MediaPlayer {
    ...
    private MediaPlayerClient f4953a;

    public static MediaPlayer a(Context context, int i) {
        a aVar = new a();
        synchronized (a.class) {
            aVar.f4953a = i == 1 ? OSPlayerClient.create(aVar, context) : TTPlayerClient.create(aVar, context);
        }
        return aVar;
    }
    ...
    public int getCurrentPosition() {
        MediaPlayerClient mediaPlayerClient = this.f4953a;
    ...
    public boolean isOSPlayer() {
        return this.f4953a instanceof OSPlayerClient;
    }
    ...
    public void setIsMute(boolean z) {
        ...
        if (!isOSPlayer()) {
            this.f4953a.setIsMute(z);
            return;
        }
        float f = z ? 0.0f : 1.0f;
        try {
            this.f4953a.setVolume(f, f);
    ...
    public void setSurface(Surface surface) {
        ...
        if ((surface == null || surface.isValid()) && (mediaPlayerClient = this.f4953a) != null) {
