...
public class DataLoaderHelper implements AVMDLDataLoaderListener, AVMDLStartCompleteListener {
    ...
    public class c {
        ...
        public class a {
            ...
            public void a(long j) {
                ...
                if (this.d.size() == 0) {
                    this.d.add(new C0151a(this));
                }
                this.d.get(0).f4945a = 0L;
                this.d.get(0).b = j;
            }

            public long b() {
                List<C0151a> list = this.d;
            ...
            public boolean a() {
                ...
                List<C0151a> list = this.d;
                C0151a c0151a = list != null ? list.get(list.size() - 1) : null;
                if (this.f == null) {
                    return c0151a != null && this.b > 0 && c0151a.f4945a + c0151a.b >= jMin;
                }
                return true;
            }
        }
    ...
    public class d {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final ReentrantLock f4946a;
        private final ArrayList<b> b;
        private long c;

        private d(DataLoaderHelper dataLoaderHelper) {
            this.f4946a = new ReentrantLock();
        ...
        public b d(String str) {
            ...
            while (true) {
                ...
                if (!TextUtils.isEmpty(bVar2.f4941a) && bVar2.f4941a.equals(str)) {
                    bVar = bVar2;
                    break;
                }
                i++;
        ...
        public b b(b bVar) {
            b bVarC;
            if (TextUtils.isEmpty(bVar.f4941a)) {
                bVarC = null;
            } else {
                bVarC = d(bVar.f4941a);
                if (bVarC != null) {
            ...
            while (it.hasNext() && (bVarC = c(it.next().f4942a)) == null) {
            }
            return bVarC;
        }
    ...
    public String _proxyUrl(String str, String str2, long j, String[] strArr, String str3) {
        if (this.f4940a != 0 || TextUtils.isEmpty(str) || strArr == null || strArr.length <= 0) {
            return null;
        }
        String[] strArr2 = (String[]) strArr.clone();
        for (String str4 : strArr2) {
    ...
    private void a(b bVar) {
        ...
        while (true) {
            ...
            if (!TextUtils.isEmpty(bVar2.f4941a) && !TextUtils.isEmpty(bVar.f4941a) && bVar2.f4941a.equals(bVar.f4941a)) {
                z = false;
                break;
            }
            i++;
        }
        if (!z || (arrayListA = a(bVar.f4941a)) == null || arrayListA.size() == 0) {
            return;
        }
    ...
    private void a(b bVar, b.a aVar) {
        ...
        String str = aVar.f4942a;
        String[] strArr = aVar.c;
        if (strArr != null) {
            String strA = a(str, bVar.f4941a, aVar.f, 0L, strArr, aVar.d);
            aVar.b = strA;
            if (!TextUtils.isEmpty(strA)) {
                this.d.a(bVar);
                if (aVar.f > 0) {
                ...
                String.format("[preload] exect preload task ,key is %s; videoId = %s", aVar.f4942a, bVar.f4941a);
                return;
            }
        }
        bVar.a(-100001);
    ...
    private void a(AVMDLDataLoaderNotifyInfo aVMDLDataLoaderNotifyInfo, boolean z, boolean z2) {
        ...
        try {
            ...
            if (jLongValue2 > 0 || z2) {
                ...
                String str3 = TextUtils.isEmpty(bVarB.f4941a) ? str : bVarB.f4941a;
                ...
                if (loadProgressByRawKey.b() || z2) {
                    ...
                    dataLoaderTaskProgressInfo.mVideoId = bVarB.f4941a;
