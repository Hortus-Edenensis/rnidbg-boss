...
public class CineMove {
    ...
    private native int nativeProcess(int i, int i2, int i3, int i4, int i5, boolean z, boolean z2, Integer num);
    ...
    public int process(int i, EffectsSDKEffectConstants.PixlFormat pixlFormat, int i2, int i3, int i4, boolean z, Integer num) {
        if (!this.mInited) {
            return -1;
        }
        int iNativeProcess = nativeProcess(i, pixlFormat.getValue(), i2, i3, i4, this.mIsFirstFrame, z, num);
        if (iNativeProcess != 0) {
