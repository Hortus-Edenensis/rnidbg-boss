...
public class ChromaKeying {
    ...
    private native int nativeDetect(ByteBuffer byteBuffer, int i, int i2, int i3, int i4, int i5, BefChromaKeyingInfo befChromaKeyingInfo);
    ...
    public BefChromaKeyingInfo detect(ByteBuffer byteBuffer, EffectsSDKEffectConstants.PixlFormat pixlFormat, int i, int i2, int i3, EffectsSDKEffectConstants.Rotation rotation) {
        if (!this.mInited) {
            return null;
        }
        BefChromaKeyingInfo befChromaKeyingInfo = new BefChromaKeyingInfo();
        int iNativeDetect = nativeDetect(byteBuffer, pixlFormat.getValue(), i, i2, i3, rotation.id, befChromaKeyingInfo);
        if (iNativeDetect == 0) {
