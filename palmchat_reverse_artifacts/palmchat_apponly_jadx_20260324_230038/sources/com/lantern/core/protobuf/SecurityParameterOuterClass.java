...
public final class SecurityParameterOuterClass {
    ...
    /* JADX INFO: renamed from: com.lantern.core.protobuf.SecurityParameterOuterClass$1, reason: invalid class name */
    /* JADX INFO: compiled from: SearchBox */
    ...
    public static final class SecurityParameter extends GeneratedMessageLite<SecurityParameter, Builder> implements SecurityParameterOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<SecurityParameter, Builder> implements SecurityParameterOrBuilder {
            ...
            public Builder clearKv() {
                copyOnWrite();
                ((SecurityParameter) this.instance).clearKv();
                return this;
            }
            ...
            public Builder clearSessionId() {
                copyOnWrite();
                ((SecurityParameter) this.instance).clearSessionId();
                return this;
            }
            ...
            @Override // com.lantern.core.protobuf.SecurityParameterOuterClass.SecurityParameterOrBuilder
            ...
            @Override // com.lantern.core.protobuf.SecurityParameterOuterClass.SecurityParameterOrBuilder
            public int getKv() {
                return ((SecurityParameter) this.instance).getKv();
            }
            ...
            public ByteString getSessionId() {
                return ((SecurityParameter) this.instance).getSessionId();
            }
            ...
            public Builder setKv(int i) {
                copyOnWrite();
                ((SecurityParameter) this.instance).setKv(i);
                return this;
            }
            ...
            public Builder setSessionId(ByteString byteString) {
                copyOnWrite();
                ((SecurityParameter) this.instance).setSessionId(byteString);
                return this;
            }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (AnonymousClass1.$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke[methodToInvoke.ordinal()]) {
                ...
                case 5:
                    ...
                    int i3 = this.kv_;
                    boolean z2 = i3 != 0;
                    int i4 = securityParameter.kv_;
                    this.kv_ = visitor.visitInt(z2, i3, i4 != 0, i4);
                    ByteString byteString = this.sessionId_;
                    ByteString byteString2 = ByteString.EMPTY;
                    boolean z3 = byteString != byteString2;
                    ByteString byteString3 = securityParameter.sessionId_;
                    this.sessionId_ = visitor.visitByteString(z3, byteString, byteString3 != byteString2, byteString3);
        ...
        public int getSerializedSize() {
            ...
            int i3 = this.kv_;
            if (i3 != 0) {
                iComputeStringSize += CodedOutputStream.computeInt32Size(10, i3);
            }
            if (!this.sessionId_.isEmpty()) {
                iComputeStringSize += CodedOutputStream.computeBytesSize(11, this.sessionId_);
            }
