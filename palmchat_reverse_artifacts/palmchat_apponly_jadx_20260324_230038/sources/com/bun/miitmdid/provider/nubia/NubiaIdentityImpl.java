...
public class NubiaIdentityImpl {
    ...
    private static Object generalMethod(Context context, String str, @Nullable String str2, String str3, Class<?> cls) {
        try {
            ...
            p0.d(TAG, "generalMethod: failed:" + bundleCall.getString("message"));
            return null;
        } catch (Exception e) {
            p0.d(TAG, "generalMethod: Exception: " + e.getMessage());
            return null;
        }
    }
