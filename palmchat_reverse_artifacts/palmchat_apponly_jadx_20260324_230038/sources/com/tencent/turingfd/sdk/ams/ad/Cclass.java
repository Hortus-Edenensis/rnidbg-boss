...
/* JADX INFO: renamed from: com.tencent.turingfd.sdk.ams.ad.class, reason: invalid class name */
/* JADX INFO: compiled from: SearchBox */
/* JADX INFO: loaded from: classes10.dex */
public class Cclass {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final String f10753a = Cfinally.a(Cfinally.S0);
    ...
    public static void a(X509Certificate x509Certificate, Cranberry cranberry) throws Exception {
        byte[] extensionValue = x509Certificate.getExtensionValue(f10753a);
        if (extensionValue != null && extensionValue.length != 0) {
            try {
                ...
                cranberry.c = jSONObject.getString(c);
                cranberry.b = jSONObject.getInt(d);
                cranberry.f10684a = jSONObject.getLong(b);
                return;
            } catch (Exception e2) {
                StringBuilder sbA = Banana.a(WkAdxAdConfigMg.DSP_NAME_CSJ);
