...
public class b extends AsyncTask<Void, Void, a> {
            ...
            if (bArr != null && bArr.length != 0) {
                ...
                try {
                    ...
                    if (i != 0) {
                        ...
                        aVar.f10650a = OAuthErrCode.WechatAuth_Err_NormalErr;
                    ...
                    if (string != null && string.length() != 0) {
                        ...
                        if (bArrDecode != null && bArrDecode.length != 0) {
                            aVar.f10650a = OAuthErrCode.WechatAuth_Err_OK;
                            aVar.e = bArrDecode;
                        ...
                        aVar.f10650a = OAuthErrCode.WechatAuth_Err_JsonDecodeErr;
                        return aVar;
                    }
    ...
    public a doInBackground(Void[] voidArr) throws Throwable {
        ...
        String str = String.format("https://open.weixin.qq.com/connect/sdk/qrconnect?appid=%s&noncestr=%s&timestamp=%s&scope=%s&signature=%s", this.f10649a, this.c, this.d, this.b, this.e);
