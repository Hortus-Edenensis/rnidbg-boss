...
class MMSharedPreferences implements SharedPreferences {
    ...
    private final String[] columns = {"_id", "key", "type", ActionUtils.PAYMENT_AMOUNT};
    ...
    private Object getValue(String str) {
        try {
            Cursor cursorQuery = this.cr.query(a.f10654a, this.columns, "key = ?", new String[]{str}, null);
            if (cursorQuery == null) {
                return null;
            }
            Object objA = cursorQuery.moveToFirst() ? com.tencent.mm.opensdk.channel.a.a.a(cursorQuery.getInt(cursorQuery.getColumnIndex("type")), cursorQuery.getString(cursorQuery.getColumnIndex(ActionUtils.PAYMENT_AMOUNT))) : null;
            cursorQuery.close();
            return objA;
        } catch (Exception e) {
    ...
    public Map<String, ?> getAll() {
        try {
            Cursor cursorQuery = this.cr.query(a.f10654a, this.columns, null, null, null);
            if (cursorQuery == null) {
                return null;
            }
            int columnIndex = cursorQuery.getColumnIndex("key");
            int columnIndex2 = cursorQuery.getColumnIndex("type");
            int columnIndex3 = cursorQuery.getColumnIndex(ActionUtils.PAYMENT_AMOUNT);
    ...
    public static class REditor implements SharedPreferences.Editor {
        ...
        */
        public boolean commit() {
            ...
            if (this.clear) {
                this.cr.delete(a.f10654a, null, null);
                this.clear = false;
            }
            Iterator<String> it = this.remove.iterator();
            while (it.hasNext()) {
                this.cr.delete(a.f10654a, "key = ?", new String[]{it.next()});
            }
            ...
            while (true) {
                ...
                if (value == null) {
                    ...
                    if (i != 0) {
                        ...
                        contentValues.put(ActionUtils.PAYMENT_AMOUNT, value.toString());
                    }
                    if (!z) {
                        this.cr.update(a.f10654a, contentValues, "key = ?", new String[]{next.getKey()});
                    }
                }
