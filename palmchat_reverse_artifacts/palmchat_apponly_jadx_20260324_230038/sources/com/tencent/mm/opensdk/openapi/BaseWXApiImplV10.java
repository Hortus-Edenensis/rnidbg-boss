...
class BaseWXApiImplV10 implements IWXAPI {
    ...
    public BaseWXApiImplV10(Context context, String str, boolean z, int i) {
        ...
        this.launchMode = i;
        b.f10655a = context.getApplicationContext();
    }
    ...
    private boolean handleWxInternalRespType(String str, IWXAPIEventHandler iWXAPIEventHandler) {
        ...
        if (queryParameter.equals("subscribemessage")) {
            ...
            resp.templateID = uri.getQueryParameter(WfConstant.EXTRA_KEY_TEMPLATE_ID);
    ...
    public void unregisterApp() {
        ...
        c0890a.f10645a = "com.tencent.mm";
        c0890a.b = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
        c0890a.c = "weixin://unregisterapp?appid=" + this.appId;
        a.a(this.context, c0890a);
    }
    ...
    public boolean registerApp(String str, long j) {
        ...
        a.C0890a c0890a = new a.C0890a();
        c0890a.f10645a = "com.tencent.mm";
        c0890a.b = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
        c0890a.c = "weixin://registerapp?appid=" + this.appId;
        c0890a.d = j;
        return a.a(this.context, c0890a);
    }
}
