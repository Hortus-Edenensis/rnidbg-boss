...
public class DefaultExtractorsFactory2 implements ExtractorsFactory {
            ...
            case 4:
                ...
                if (constructor == null) {
                    ...
                    try {
                        ...
                        throw new IllegalStateException("Unexpected error creating FLAC extractor" + e.getMessage());
                    }
                }
                break;
            case 5:
                ac3Extractor = new FlvExtractor(this.flvMode);
                break;
            case 6:
    ...
    public synchronized DefaultExtractorsFactory2 setAdtsExtractorFlags(int i) {
        this.adtsFlags = i;
        return this;
    }

    public synchronized DefaultExtractorsFactory2 setAmrExtractorFlags(int i) {
        this.amrFlags = i;
        return this;
    }

    public synchronized DefaultExtractorsFactory2 setConstantBitrateSeekingEnabled(boolean z) {
        this.constantBitrateSeekingEnabled = z;
        return this;
    }

    public synchronized DefaultExtractorsFactory2 setFlacExtractorFlags(int i) {
        this.flacFlags = i;
        return this;
    }

    public synchronized DefaultExtractorsFactory2 setFlvExtractorFlags(int i) {
        this.flvMode = i;
        return this;
    }

    public synchronized DefaultExtractorsFactory2 setFragmentedMp4ExtractorFlags(int i) {
        this.fragmentedMp4Flags = i;
        return this;
    }

    public synchronized DefaultExtractorsFactory2 setMatroskaExtractorFlags(int i) {
        this.matroskaFlags = i;
        return this;
    }

    public synchronized DefaultExtractorsFactory2 setMp3ExtractorFlags(int i) {
        this.mp3Flags = i;
        return this;
    }

    public synchronized DefaultExtractorsFactory2 setMp4ExtractorFlags(int i) {
        this.mp4Flags = i;
        return this;
    }

    public synchronized DefaultExtractorsFactory2 setTsExtractorFlags(int i) {
        this.tsFlags = i;
        return this;
    }

    public synchronized DefaultExtractorsFactory2 setTsExtractorMode(int i) {
        this.tsMode = i;
        return this;
    }

    public synchronized DefaultExtractorsFactory2 setTsExtractorTimestampSearchBytes(int i) {
