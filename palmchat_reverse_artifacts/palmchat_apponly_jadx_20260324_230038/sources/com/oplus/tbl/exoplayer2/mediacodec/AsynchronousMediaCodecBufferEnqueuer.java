...
class AsynchronousMediaCodecBufferEnqueuer {
    ...
    private static void copy(CryptoInfo cryptoInfo, MediaCodec.CryptoInfo cryptoInfo2) {
        ...
        if (Util.SDK_INT >= 24) {
            qi.a();
            cryptoInfo2.setPattern(lr0.a(cryptoInfo.encryptedBlocks, cryptoInfo.clearBlocks));
        }
    }
    ...
    public void start() {
        ...
        this.handler = new Handler(this.handlerThread.getLooper()) { // from class: com.oplus.tbl.exoplayer2.mediacodec.AsynchronousMediaCodecBufferEnqueuer.1
