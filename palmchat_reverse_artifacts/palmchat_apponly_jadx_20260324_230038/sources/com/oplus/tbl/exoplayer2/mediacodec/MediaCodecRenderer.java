...
import com.oplus.tbl.exoplayer2.drm.FrameworkMediaCrypto;
...
public abstract class MediaCodecRenderer extends BaseRenderer {
    private static final byte[] ADAPTATION_WORKAROUND_BUFFER = {0, 0, 1, 103, 66, -64, 11, -38, 37, -112, 0, 0, 1, 104, -50, 15, 19, 32, 0, 0, 1, 101, -120, -124, dn.k, -50, 113, 24, -96, 0, 47, -65, 28, 49, -61, 39, 93, 120};
    ...
    public static class DecoderInitializationException extends Exception {
        ...
        private static String buildCustomDiagnosticInfo(int i) {
            return "com.oplus.tbl.exoplayer2.mediacodec.MediaCodecRenderer_" + (i < 0 ? "neg_" : "") + Math.abs(i);
        }

        /* JADX INFO: Access modifiers changed from: private */
        @CheckResult
        public DecoderInitializationException copyWithFallbackException(DecoderInitializationException decoderInitializationException) {
            Log.e("DecoderInitializationException", "Will throw decoder initialization exception and copy with fall back.");
    ...
    public MediaCodecRenderer(int i, MediaCodecAdapter.Factory factory, MediaCodecSelector mediaCodecSelector, boolean z, float f) {
        super(i);
        this.TAG = "MediaCodecRenderer_ins_" + Thread.currentThread().getId();
    ...
    private void bypassRead() throws ExoPlaybackException {
        ...
        do {
            this.bypassSampleBuffer.clear();
            int source = readSource(formatHolder, this.bypassSampleBuffer, false);
            if (source == -5) {
    ...
    private boolean drainOutputBuffer(long j, long j2) throws ExoPlaybackException {
        ...
        if (!hasOutputBuffer()) {
            if (this.codecNeedsEosOutputExceptionWorkaround && this.codecReceivedEos) {
                ...
                TraceUtil.beginSection("dequeueOutputBuffer");
                iDequeueOutputBufferIndex = this.codec.dequeueOutputBufferIndex(this.outputBufferInfo);
            ...
            TraceUtil.beginSection("getOutputBuffer");
            this.outputBuffer = this.codec.getOutputBuffer(iDequeueOutputBufferIndex);
            TraceUtil.endSection();
            ByteBuffer byteBuffer2 = this.outputBuffer;
            if (byteBuffer2 != null) {
                byteBuffer2.position(this.outputBufferInfo.offset);
        ...
        if (this.codecNeedsEosOutputExceptionWorkaround && this.codecReceivedEos) {
            ...
            zProcessOutputBuffer = processOutputBuffer(j, j2, mediaCodecAdapter2, byteBuffer4, i2, bufferInfo5.flags, 1, bufferInfo5.presentationTimeUs, this.isDecodeOnlyOutputBuffer, this.isLastOutputBuffer, this.outputFormat);
        }
    ...
    private boolean feedInputBuffer() throws ExoPlaybackException {
        ...
        if (this.inputIndex < 0) {
            ...
            TraceUtil.beginSection("getInputBuffer");
        ...
        this.largestQueuedPresentationTimeUs = c2Mp3TimestampTracker2 != null ? Math.max(j2, this.buffer.timeUs) : Math.max(j2, j);
        this.buffer.flip();
        ...
        try {
            if (zIsEncrypted) {
                ...
                TraceUtil.beginSection("queueInputBuffer");
    ...
    private List<MediaCodecInfo> getAvailableCodecInfos(boolean z) throws MediaCodecUtil.DecoderQueryException {
        ...
        if (decoderInfos.isEmpty() && z) {
            ...
            if (!decoderInfos.isEmpty()) {
                Log.w(this.TAG, "Drm session requires secure decoder for " + this.inputFormat.sampleMimeType + ", but no secure decoder available. Trying to proceed with " + decoderInfos + ".");
            }
        }
        return decoderInfos;
    }
    ...
    private void initCodec(MediaCodecInfo mediaCodecInfo, MediaCrypto mediaCrypto) throws Exception {
        ...
        try {
            ...
            mediaCodecAdapterCreateAdapter = (!this.enableAsynchronousBufferQueueing || i < 23) ? this.codecAdapterFactory.createAdapter(mediaCodecCreateDecoderByType) : new AsynchronousMediaCodecAdapter.Factory(getTrackType(), this.forceAsyncQueueingSynchronizationWorkaround, this.enableSynchronizeCodecInteractionsWithQueueing).createAdapter(mediaCodecCreateDecoderByType);
        } catch (Exception e) {
            e = e;
        }
        try {
            ...
            configureCodec(mediaCodecInfo, mediaCodecAdapterCreateAdapter, this.inputFormat, mediaCrypto, f);
            TraceUtil.endSection();
            TraceUtil.beginSection("startCodec");
            mediaCodecAdapterCreateAdapter.start();
            TraceUtil.endSection();
    ...
    private void maybeInitCodecWithFallback(MediaCrypto mediaCrypto, boolean z) throws DecoderInitializationException {
        if (this.availableCodecInfos == null) {
            try {
                ...
                Log.e(this.TAG, "Will throw decoder initialization exception for decoder query exception");
                throw new DecoderInitializationException(this.inputFormat, e, z, -49998);
            }
        }
        if (this.availableCodecInfos.isEmpty()) {
            Log.e(this.TAG, "Will throw decoder initialization exception for available decoder empty");
        ...
        while (this.codec == null) {
            ...
            try {
                ...
                Log.w(this.TAG, "Failed to initialize decoder: " + mediaCodecInfoPeekFirst, e2);
    ...
    private void setCodecDrmSession(@Nullable DrmSession drmSession) {
        dh1.b(this.codecDrmSession, drmSession);
    ...
    private boolean updateCodecOperatingRate(Format format) throws ExoPlaybackException {
        ...
        bundle.putFloat(IMediaFormat.KEY_OPERATING_RATE, codecOperatingRateV23);
    ...
    public abstract void enableMayRenderStartOfStream();
    ...
    */
    public DecoderReuseEvaluation onInputFormatChanged(FormatHolder formatHolder) throws ExoPlaybackException {
        ...
        if (format.sampleMimeType == null) {
            throw createRendererException(new IllegalArgumentException(), format);
        }
    ...
    public void onStreamChanged(Format[] formatArr, long j, long j2) throws ExoPlaybackException {
        ...
        if (i == this.pendingOutputStreamOffsetsUs.length) {
            Log.w(this.TAG, "Too many stream changes, so dropping offset: " + this.pendingOutputStreamOffsetsUs[this.pendingOutputStreamOffsetCount - 1]);
        } else {
        ...
        try {
            ...
            if (this.inputFormat != null || readToFlagsOnlyBuffer(true)) {
                ...
                if (this.bypassEnabled) {
                    ...
                    while (!isBufferFull() && feedInputBuffer() && shouldContinueRendering(jElapsedRealtime)) {
                    }
                    TraceUtil.endSection();
                    maybeDetectStuck();
                } else {
    ...
    @Override // com.oplus.tbl.exoplayer2.BaseRenderer, com.oplus.tbl.exoplayer2.RendererCapabilities
