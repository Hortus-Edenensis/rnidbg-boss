...
public final class MediaCodecUtil {
    ...
    public static final class MediaCodecListCompatV16 implements MediaCodecListCompat {
        ...
        @Override // com.oplus.tbl.exoplayer2.mediacodec.MediaCodecUtil.MediaCodecListCompat
    ...
    private static void applyWorkarounds(String str, List<MediaCodecInfo> list) {
        if ("audio/raw".equals(str)) {
            ...
            sortByScore(list, new ScoreProvider() { // from class: com.oplus.tbl.exoplayer2.mediacodec.d
                @Override // com.oplus.tbl.exoplayer2.mediacodec.MediaCodecUtil.ScoreProvider
        ...
        if (i < 21 && list.size() > 1) {
            ...
            if ("OMX.SEC.mp3.dec".equals(str2) || "OMX.SEC.MP3.Decoder".equals(str2) || "OMX.brcm.audio.mp3.decoder".equals(str2)) {
                sortByScore(list, new ScoreProvider() { // from class: com.oplus.tbl.exoplayer2.mediacodec.e
                    @Override // com.oplus.tbl.exoplayer2.mediacodec.MediaCodecUtil.ScoreProvider
                    public final int getScore(Object obj) {
    ...
    private static Pair<Integer, Integer> getAv1ProfileAndLevel(String str, String[] strArr, @Nullable ColorInfo colorInfo) {
        ...
        if (strArr.length >= 4) {
            ...
            if (i != 0) {
                ...
                int i5 = i3 != 8 ? (colorInfo == null || !(colorInfo.hdrStaticInfo != null || (i4 = colorInfo.colorTransfer) == 7 || i4 == 6)) ? 2 : 4096 : 1;
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:58:0x0103 A[Catch: Exception -> 0x0151, TRY_ENTER, TryCatch #5 {Exception -> 0x0151, blocks: (B:3:0x0009, B:5:0x001c, B:61:0x0122, B:8:0x002e, B:11:0x0039, B:55:0x00fb, B:58:0x0103, B:60:0x0109, B:62:0x012c, B:63:0x014f), top: B:78:0x0009 }] */
    /* JADX WARN: Removed duplicated region for block: B:7:0x0026  */
    /* JADX WARN: Removed duplicated region for block: B:82:0x012c A[ADDED_TO_REGION, REMOVE, SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    ...
    public static List<MediaCodecInfo> getDecoderInfosSortedByFormatSupport(List<MediaCodecInfo> list, final Format format) {
        ...
        sortByScore(arrayList, new ScoreProvider() { // from class: com.oplus.tbl.exoplayer2.mediacodec.f
            @Override // com.oplus.tbl.exoplayer2.mediacodec.MediaCodecUtil.ScoreProvider
            public final int getScore(Object obj) {
    ...
    */
    ...
    private static <T> void sortByScore(List<T> list, final ScoreProvider<T> scoreProvider) {
        Collections.sort(list, new Comparator() { // from class: com.oplus.tbl.exoplayer2.mediacodec.c
