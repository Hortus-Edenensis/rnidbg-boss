...
public final class SimpleCache implements Cache {
    ...
    public void initialize() {
        ...
        if (fileArrListFiles == null) {
            ...
            if (jLoadUid != -1) {
                ...
                cacheFileMetadataIndex = this.fileIndex;
            ...
            try {
                ...
                try {
                    ...
                    String str2 = "Failed to initialize cache indices: " + this.cacheDir;
                    Log.e(TAG, str2, e3);
        ...
        this.initializationException = cacheException;
    }
    ...
    */
    ...
    public SimpleCache(File file, CacheEvictor cacheEvictor, CachedContentIndex cachedContentIndex, @Nullable CacheFileMetadataIndex cacheFileMetadataIndex) {
        ...
        new Thread("ExoPlayer:SimpleCacheInit") { // from class: com.oplus.tbl.exoplayer2.upstream.cache.SimpleCache.1
