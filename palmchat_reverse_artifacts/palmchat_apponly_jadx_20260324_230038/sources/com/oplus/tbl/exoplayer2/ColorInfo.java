...
public final class ColorInfo implements Bundleable {
    ...
    @Deprecated
    public static final Bundleable.Creator<ColorInfo> CREATOR = new Bundleable.Creator() { // from class: vg0
    ...
    private static String colorSpaceToString(int i) {
        return i != -1 ? i != 6 ? i != 10 ? i != 1 ? i != 2 ? "Undefined color space" : "BT601" : "BT709" : "Display-P3" : "BT2020" : "Unset color space";
    }
