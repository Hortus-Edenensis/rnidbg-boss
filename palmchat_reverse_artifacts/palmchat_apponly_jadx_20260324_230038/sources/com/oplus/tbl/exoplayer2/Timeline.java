...
public abstract class Timeline {
    public static final Timeline EMPTY = new Timeline() { // from class: com.oplus.tbl.exoplayer2.Timeline.1
    ...
    public static final class Window {
        ...
        private static final MediaItem EMPTY_MEDIA_ITEM = new MediaItem.Builder().setMediaId("Timeline").setUri(Uri.EMPTY).build();
    ...
    public final Pair<Object, Long> getPeriodPosition(Window window, Period period, int i, long j, long j2) {
        ...
        while (true) {
            ...
            if (durationUs == -9223372036854775807L || positionInFirstPeriodUs < durationUs || i2 >= window.lastPeriodIndex) {
                break;
            }
