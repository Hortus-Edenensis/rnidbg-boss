...
public final class MetadataRetriever {
    ...
    public static final class MetadataRetrieverInternal {
        ...
        private final o65<TrackGroupArray> trackGroupsFuture;
        ...
        public MetadataRetrieverInternal(MediaSourceFactory mediaSourceFactory, Clock clock) {
            ...
            this.trackGroupsFuture = o65.E();
        }

        public r33<TrackGroupArray> retrieveMetadata(MediaItem mediaItem) {
    ...
    public static r33<TrackGroupArray> retrieveMetadata(MediaSourceFactory mediaSourceFactory, MediaItem mediaItem) {
        return retrieveMetadata(mediaSourceFactory, mediaItem, Clock.DEFAULT);
    }

    private static r33<TrackGroupArray> retrieveMetadata(MediaSourceFactory mediaSourceFactory, MediaItem mediaItem, Clock clock) {
