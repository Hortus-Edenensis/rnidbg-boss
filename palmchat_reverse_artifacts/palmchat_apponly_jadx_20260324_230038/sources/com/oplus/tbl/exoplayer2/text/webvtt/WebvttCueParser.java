...
import com.oplus.tbl.exoplayer2.text.webvtt.WebvttCueParser;
...
public final class WebvttCueParser {
    ...
    public static class Element {
        private static final Comparator<Element> BY_START_POSITION_ASC = new Comparator() { // from class: com.oplus.tbl.exoplayer2.text.webvtt.a
    ...
    /* JADX WARN: Removed duplicated region for block: B:49:0x009f A[LOOP:0: B:47:0x0099->B:49:0x009f, LOOP_END] */
    /*
    ...
    */
    private static void applySpansForTag(@Nullable String str, StartTag startTag, List<Element> list, SpannableStringBuilder spannableStringBuilder, List<WebvttCssStyle> list2) {
        ...
        int length;
        int i2;
        List<StyleMatch> applicableStyles;
        Object styleSpan;
        i = startTag.position;
