...
public final class Cea608Decoder extends CeaDecoder {
    ...
    private static char getExtendedEsFrChar(byte b) {
        return (char) SPECIAL_ES_FR_CHARACTER_SET[b & TELogUtils.DEBUG_LEVEL_V];
    }

    private static char getExtendedPtDeChar(byte b) {
        return (char) SPECIAL_PT_DE_CHARACTER_SET[b & TELogUtils.DEBUG_LEVEL_V];
    }
    ...
    private void maybeUpdateIsInCaptionService(byte r3, byte r4) {
        ...
        L22:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.oplus.tbl.exoplayer2.text.cea.Cea608Decoder.maybeUpdateIsInCaptionService(byte, byte):void");
    }
