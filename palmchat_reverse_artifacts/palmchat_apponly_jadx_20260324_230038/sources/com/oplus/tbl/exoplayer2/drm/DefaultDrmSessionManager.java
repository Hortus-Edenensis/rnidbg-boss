...
public class DefaultDrmSessionManager implements DrmSessionManager {
    ...
    public class MediaDrmEventListener implements ExoMediaDrm.OnEventListener {
        ...
        @Override // com.oplus.tbl.exoplayer2.drm.ExoMediaDrm.OnEventListener
    ...
    public class ProvisioningManagerImpl implements DefaultDrmSession.ProvisioningManager {
        ...
        @Override // com.oplus.tbl.exoplayer2.drm.DefaultDrmSession.ProvisioningManager
    ...
    public class ReferenceCountListenerImpl implements DefaultDrmSession.ReferenceCountListener {
        ...
        @Override // com.oplus.tbl.exoplayer2.drm.DefaultDrmSession.ReferenceCountListener
        public void onReferenceCountDecremented(final DefaultDrmSession defaultDrmSession, int i) {
            if (i == 1 && DefaultDrmSessionManager.this.sessionKeepaliveMs != -9223372036854775807L) {
                ...
                ((Handler) Assertions.checkNotNull(DefaultDrmSessionManager.this.sessionReleasingHandler)).postAtTime(new Runnable() { // from class: com.oplus.tbl.exoplayer2.drm.b
