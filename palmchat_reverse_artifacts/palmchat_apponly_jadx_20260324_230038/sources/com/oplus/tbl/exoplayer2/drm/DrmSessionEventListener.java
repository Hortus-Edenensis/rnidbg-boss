    ...
    public static class EventDispatcher {
        ...
        public void drmKeysLoaded() {
            for (ListenerAndHandler listenerAndHandler : this.listenerAndHandlers) {
                ...
                Util.postOrRun(listenerAndHandler.handler, new Runnable() { // from class: sh1
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f20746a.lambda$drmKeysLoaded$1(drmSessionEventListener);
                    }
                });
            }
        }
        ...
        public void drmKeysRemoved() {
            for (ListenerAndHandler listenerAndHandler : this.listenerAndHandlers) {
                final DrmSessionEventListener drmSessionEventListener = listenerAndHandler.listener;
                Util.postOrRun(listenerAndHandler.handler, new Runnable() { // from class: yh1
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f22200a.lambda$drmKeysRemoved$4(drmSessionEventListener);
                    }
                });
            }
        }
        ...
        public void drmKeysRestored() {
            for (ListenerAndHandler listenerAndHandler : this.listenerAndHandlers) {
                final DrmSessionEventListener drmSessionEventListener = listenerAndHandler.listener;
                Util.postOrRun(listenerAndHandler.handler, new Runnable() { // from class: vh1
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f21444a.lambda$drmKeysRestored$3(drmSessionEventListener);
                    }
                });
            }
        }
        ...
        public void drmSessionAcquired() {
            for (ListenerAndHandler listenerAndHandler : this.listenerAndHandlers) {
                final DrmSessionEventListener drmSessionEventListener = listenerAndHandler.listener;
                Util.postOrRun(listenerAndHandler.handler, new Runnable() { // from class: jh1
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f18403a.lambda$drmSessionAcquired$0(drmSessionEventListener);
                    }
                });
            }
        }
        ...
        public void drmSessionManagerError(final Exception exc) {
            for (ListenerAndHandler listenerAndHandler : this.listenerAndHandlers) {
                final DrmSessionEventListener drmSessionEventListener = listenerAndHandler.listener;
                Util.postOrRun(listenerAndHandler.handler, new Runnable() { // from class: ph1
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f20017a.lambda$drmSessionManagerError$2(drmSessionEventListener, exc);
                    }
                });
            }
        }
        ...
        public void drmSessionReleased() {
            for (ListenerAndHandler listenerAndHandler : this.listenerAndHandlers) {
                final DrmSessionEventListener drmSessionEventListener = listenerAndHandler.listener;
                Util.postOrRun(listenerAndHandler.handler, new Runnable() { // from class: mh1
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f19216a.lambda$drmSessionReleased$5(drmSessionEventListener);
                    }
                });
            }
        }
