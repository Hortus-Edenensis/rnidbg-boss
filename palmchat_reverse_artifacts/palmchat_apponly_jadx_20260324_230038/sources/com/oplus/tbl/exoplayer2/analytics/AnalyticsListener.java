...
public interface AnalyticsListener {
    ...
    public static final int EVENT_BUFFERING_STUCKED = 1038;
    ...
    public static final int EVENT_VIDEO_STUCKED = 1037;
    ...
    public static final class EventTime {
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            return this.realtimeMs == eventTime.realtimeMs && this.windowIndex == eventTime.windowIndex && this.eventPlaybackPositionMs == eventTime.eventPlaybackPositionMs && this.currentWindowIndex == eventTime.currentWindowIndex && this.currentPlaybackPositionMs == eventTime.currentPlaybackPositionMs && this.totalBufferedDurationMs == eventTime.totalBufferedDurationMs && m54.a(this.timeline, eventTime.timeline) && m54.a(this.mediaPeriodId, eventTime.mediaPeriodId) && m54.a(this.currentTimeline, eventTime.currentTimeline) && m54.a(this.currentMediaPeriodId, eventTime.currentMediaPeriodId);
        }

        public int hashCode() {
            return m54.b(Long.valueOf(this.realtimeMs), this.timeline, Integer.valueOf(this.windowIndex), this.mediaPeriodId, Long.valueOf(this.eventPlaybackPositionMs), this.currentTimeline, Integer.valueOf(this.currentWindowIndex), this.currentMediaPeriodId, Long.valueOf(this.currentPlaybackPositionMs), Long.valueOf(this.totalBufferedDurationMs));
        }
    }
        ...
        public void setEventTimes(SparseArray<EventTime> sparseArray) {
            ...
            for (int i = 0; i < size(); i++) {
                ...
                if (sparseArray != null && sparseArray.get(i2) != null) {
                    this.eventTimes.append(i2, sparseArray.get(i2));
                }
            }
        }
    }
    ...
    void onBufferingStucked(EventTime eventTime, BufferingStuckResult bufferingStuckResult);
    ...
    void onSeekCompleted(EventTime eventTime, SeekResult seekResult);
    ...
    void onVideoDecoderInitialized(EventTime eventTime, String str, long j, boolean z);
    ...
    void onVideoStucked(EventTime eventTime, VideoStuckResult videoStuckResult);
