...
import com.oplus.tbl.exoplayer2.util.StandaloneMediaClock;
...
final class DefaultMediaClock implements MediaClock {
    ...
    public long getPendingDataOffsetUs() {
        return this.isUsingStandaloneClock ? this.standaloneClock.getPendingDataOffsetUs() : ((MediaClock) Assertions.checkNotNull(this.rendererClock)).getPendingDataOffsetUs();
    }
