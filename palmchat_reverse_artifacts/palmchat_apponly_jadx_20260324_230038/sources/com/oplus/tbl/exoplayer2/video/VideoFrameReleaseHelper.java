...
public final class VideoFrameReleaseHelper {
    ...
    public static final class Api17 {
        ...
        public static boolean isPlaceholderSurface(@Nullable Surface surface) {
            return surface instanceof DummySurface;
        }
    }
    ...
    */
    ...
    public void onStarted() {
        ...
        if (this.displayHelper != null) {
            ...
            this.displayHelper.register(new DisplayHelper.Listener() { // from class: cc6
                @Override // com.oplus.tbl.exoplayer2.video.VideoFrameReleaseHelper.DisplayHelper.Listener
                public final void onDefaultDisplayChanged(Display display) {
                    this.f1950a.updateDefaultDisplayRefreshRateParams(display);
                }
            });
        }
        updateSurfacePlaybackFrameRate(false);
    ...
    public static final class DisplayHelperV16 implements DisplayHelper {
        ...
        @Override // com.oplus.tbl.exoplayer2.video.VideoFrameReleaseHelper.DisplayHelper
    ...
    /* JADX INFO: compiled from: SearchBox */
    @RequiresApi(17)
    public static final class DisplayHelperV17 implements DisplayManager.DisplayListener, DisplayHelper {
