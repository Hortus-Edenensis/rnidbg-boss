package com.oplus.tbl.exoplayer2.extractor.amr;
...
public final class AmrExtractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() { // from class: y9
    ...
    private int getFrameSizeInBytes(int i) throws ParserException {
        ...
        sb.append(this.isWideBand ? ld.I : "NB");
