    ...
    */
    private static Pair<Format, Long> parseCsdBuffer(CsdBuffer csdBuffer, String str) {
        ...
        if (i7 == 2) {
            ...
            if (i7 != 4) {
                f2 = 1.0f;
                Format formatBuild = new Format.Builder().setId(str).setSampleMimeType("video/mpeg2").setWidth(i5).setHeight(i6).setPixelWidthHeightRatio(f2).setInitializationData(Collections.singletonList(bArrCopyOf)).build();
        ...
        f2 = f / i;
        Format formatBuild2 = new Format.Builder().setId(str).setSampleMimeType("video/mpeg2").setWidth(i5).setHeight(i6).setPixelWidthHeightRatio(f2).setInitializationData(Collections.singletonList(bArrCopyOf)).build();
        i2 = (bArrCopyOf[7] & 15) - 1;
        if (i2 < 0) {
        }
