...
import com.oplus.tbl.exoplayer2.metadata.emsg.EventMessageEncoder;
...
public class FragmentedMp4Extractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() { // from class: u22
    ...
    private void onMoovContainerAtomRead(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        List<TrackSampleTable> traks = AtomParsers.parseTraks(containerAtom, new GaplessInfoHolder(), mehd, drmInitDataFromAtoms, (this.flags & 16) != 0, false, new u42() { // from class: x22
            @Override // defpackage.u42
            public final Object apply(Object obj) {
                return this.f21861a.modifyTrack((Track) obj);
            }
        });
    ...
    */
    private static int parseTrun(TrackBundle trackBundle, int i, int i2, ParsableByteArray parsableByteArray, int i3) throws ParserException {
        ...
        boolean z6 = (fullAtomFlags & 256) != 0;
        boolean z7 = (fullAtomFlags & 512) != 0;
        boolean z8 = (fullAtomFlags & 1024) != 0;
        boolean z9 = (fullAtomFlags & 2048) != 0;
        ...
        if (jArr2 != null && jArr2.length == 1) {
            ...
            int i9 = i8;
            boolean z10 = (track.type == 2 || (i2 & 1) == 0) ? false : true;
            ...
            i5 = i3;
            while (i5 < i4) {
                int iCheckNonNegative = checkNonNegative(z6 ? parsableByteArray.readInt() : defaultSampleValues.duration);
                if (z7) {
                    z = z6;
                ...
                if (z9) {
                    z3 = z7;
                    z4 = z8;
                    iArr2[i5] = (int) ((((long) parsableByteArray.readInt()) * 1000000) / j3);
                } else {
                    z3 = z7;
                    z4 = z8;
                    iArr2[i5] = 0;
                }
                long jScaleLargeTimestamp2 = Util.scaleLargeTimestamp(j5, 1000000L, j3) - j4;
                jArr3[i5] = jScaleLargeTimestamp2;
                if (!trackFragment.nextFragmentDecodeTimeIncludesMoov) {
                    jArr3[i5] = jScaleLargeTimestamp2 + trackBundle2.moovSampleTable.durationUs;
                }
                iArr[i5] = iCheckNonNegative2;
                zArr[i5] = ((i7 >> 16) & 1) == 0 && (!z11 || i5 == 0);
        ...
        j = 0;
        jScaleLargeTimestamp = j;
        int[] iArr3 = trackFragment.sampleSizeTable;
        int[] iArr22 = trackFragment.sampleCompositionTimeOffsetUsTable;
        long[] jArr32 = trackFragment.sampleDecodingTimeUsTable;
    ...
    */
    private boolean readAtomHeader(ExtractorInput extractorInput) throws IOException {
        ...
        if (j != 1) {
            ...
            long position2 = extractorInput.getPosition() - ((long) this.atomHeaderBytesRead);
            int i = this.atomType;
