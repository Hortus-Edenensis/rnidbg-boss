...
import com.oplus.tbl.exoplayer2.extractor.Id3Peeker;
...
import com.oplus.tbl.exoplayer2.extractor.mp3.Seeker;
...
public final class Mp3Extractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() { // from class: jr3
    ...
    private static final Id3Decoder.FramePredicate REQUIRED_ID3_FRAME_PREDICATE = new Id3Decoder.FramePredicate() { // from class: mr3
    ...
    */
    private Seeker maybeReadSeekFrame(ExtractorInput extractorInput) throws IOException {
        ...
        if (xingSeekerCreate != null && !this.gaplessInfoHolder.hasGaplessInfo()) {
            extractorInput.resetPeekPosition();
            extractorInput.advancePeekPosition(i + MediaPlayer.MEDIA_PLAYER_OPTION_VIDEO_CODEC_ID);
