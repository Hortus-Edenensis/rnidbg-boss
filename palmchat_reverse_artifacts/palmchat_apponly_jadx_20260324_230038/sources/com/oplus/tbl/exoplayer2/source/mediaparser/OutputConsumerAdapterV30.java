...
import com.oplus.tbl.exoplayer2.extractor.DummyExtractorOutput;
...
public final class OutputConsumerAdapterV30 implements MediaParser.OutputConsumer {
    ...
    public static final class DataReaderAdapter implements DataReader {
        ...
        public int read(byte[] bArr, int i, int i2) throws IOException {
            return ea4.a(Util.castNonNull(this.input)).read(bArr, i, i2);
        }
    }
    ...
    public static final class SeekMapAdapter implements SeekMap {
        ...
        public SeekMap.SeekPoints getSeekPoints(long j) {
            ...
            return obj == seekPoints.second ? new SeekMap.SeekPoints(asExoPlayerSeekPoint(bk3.a(obj))) : new SeekMap.SeekPoints(asExoPlayerSeekPoint(bk3.a(obj)), asExoPlayerSeekPoint(bk3.a(seekPoints.second)));
        }
    ...
    private static ColorInfo getColorInfo(MediaFormat mediaFormat) {
        ...
        int integer = mediaFormat.getInteger(IMediaFormat.KEY_COLOR_TRANSFER, -1);
        int integer2 = mediaFormat.getInteger(IMediaFormat.KEY_COLOR_RANGE, -1);
        int integer3 = mediaFormat.getInteger(IMediaFormat.KEY_COLOR_STANDARD, -1);
        if (array == null && integer == -1 && integer2 == -1 && integer3 == -1) {
            return null;
        }
        return new ColorInfo.Builder().setColorSpace(integer3).setColorRange(integer2).setColorTransfer(integer).setHdrStaticInfo(array).build();
    }
    ...
    private static int getSelectionFlags(MediaFormat mediaFormat) {
        return getFlag(mediaFormat, IMediaFormat.KEY_IS_FORCED_SUBTITLE, 2) | getFlag(mediaFormat, IMediaFormat.KEY_IS_AUTOSELECT, 4) | 0 | getFlag(mediaFormat, IMediaFormat.KEY_IS_DEFAULT, 1);
    }
    ...
    private static DrmInitData toExoPlayerDrmInitData(@Nullable String str, @Nullable android.media.DrmInitData drmInitData) {
        ...
        return new com.oplus.tbl.exoplayer2.drm.DrmInitData(str, schemeDataArr);
    }
