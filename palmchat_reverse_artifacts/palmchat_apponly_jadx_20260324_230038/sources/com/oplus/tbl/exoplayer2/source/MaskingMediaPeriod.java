...
public final class MaskingMediaPeriod implements MediaPeriod, MediaPeriod.Callback {
    ...
    public long getLargestQueuedTimeUsByType(int i) {
        return ((MediaPeriod) Util.castNonNull(this.mediaPeriod)).getLargestQueuedTimeUsByType(i);
    }

    @Override // com.oplus.tbl.exoplayer2.source.MediaPeriod
    public long getNextKeyFramePositionUs(long j) {
        return ((MediaPeriod) Util.castNonNull(this.mediaPeriod)).getNextKeyFramePositionUs(j);
    }
    ...
    public boolean seekToUsInGop(long j, boolean z) {
        return ((MediaPeriod) Util.castNonNull(this.mediaPeriod)).seekToUsInGop(j, z);
    }
