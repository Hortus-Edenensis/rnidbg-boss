...
public final class DownloadHelper {
    ...
    public static final class MediaPreparer implements Handler.Callback, MediaPeriod.Callback, MediaSource.MediaSourceCaller {
        ...
        private final Handler downloadHelperHandler = Util.createHandlerForCurrentOrMainLooper(new Handler.Callback() { // from class: com.oplus.tbl.exoplayer2.offline.a
            @Override // android.os.Handler.Callback
            public final boolean handleMessage(Message message) {
                return this.f7652a.handleDownloadHelperCallbackMessage(message);
            }
        });
    ...
    public DownloadHelper(MediaItem mediaItem, @Nullable MediaSource mediaSource, DefaultTrackSelector.Parameters parameters, RendererCapabilities[] rendererCapabilitiesArr) {
        ...
        defaultTrackSelector.init(new TrackSelector.InvalidationListener() { // from class: hf1
    ...
    public static RendererCapabilities[] getRendererCapabilities(RenderersFactory renderersFactory) {
        Renderer[] rendererArrCreateRenderers = renderersFactory.createRenderers(Util.createHandlerForCurrentOrMainLooper(), new VideoRendererEventListener() { // from class: com.oplus.tbl.exoplayer2.offline.DownloadHelper.1
            ...
            public /* synthetic */ void onVideoDisabled(DecoderCounters decoderCounters) {
                hd6.f(this, decoderCounters);
            }

            @Override // com.oplus.tbl.exoplayer2.video.VideoRendererEventListener
            public /* synthetic */ void onVideoEnabled(DecoderCounters decoderCounters) {
                hd6.g(this, decoderCounters);
            }
            ...
            public /* synthetic */ void onAudioDisabled(DecoderCounters decoderCounters) {
                mk.c(this, decoderCounters);
            }

            @Override // com.oplus.tbl.exoplayer2.audio.AudioRendererEventListener
            public /* synthetic */ void onAudioEnabled(DecoderCounters decoderCounters) {
                mk.d(this, decoderCounters);
            }
    ...
    public void onMediaPreparationFailed(final IOException iOException) {
        ((Handler) Assertions.checkNotNull(this.callbackHandler)).post(new Runnable() { // from class: jf1
            @Override // java.lang.Runnable
            public final void run() {
                this.f18395a.lambda$onMediaPreparationFailed$5(iOException);
            }
        });
    }
    ...
    public void onMediaPrepared() {
        ...
        ((Handler) Assertions.checkNotNull(this.callbackHandler)).post(new Runnable() { // from class: lf1
            @Override // java.lang.Runnable
            public final void run() {
                this.f18967a.lambda$onMediaPrepared$4();
            }
        });
    }
    ...
    public void prepare(final Callback callback) {
        ...
        if (mediaSource != null) {
            ...
            this.callbackHandler.post(new Runnable() { // from class: nf1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f19503a.lambda$prepare$3(callback);
                }
            });
        }
    }
