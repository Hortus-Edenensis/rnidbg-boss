...
import com.oplus.tbl.exoplayer2.scheduler.Scheduler;
import com.oplus.tbl.exoplayer2.util.Assertions;
import com.oplus.tbl.exoplayer2.util.Log;
import com.oplus.tbl.exoplayer2.util.NotificationUtil;
...
public abstract class DownloadService extends Service {
    public static final String ACTION_ADD_DOWNLOAD = "com.oplus.tbl.exoplayer.downloadService.action.ADD_DOWNLOAD";
    public static final String ACTION_INIT = "com.oplus.tbl.exoplayer.downloadService.action.INIT";
    public static final String ACTION_PAUSE_DOWNLOADS = "com.oplus.tbl.exoplayer.downloadService.action.PAUSE_DOWNLOADS";
    public static final String ACTION_REMOVE_ALL_DOWNLOADS = "com.oplus.tbl.exoplayer.downloadService.action.REMOVE_ALL_DOWNLOADS";
    public static final String ACTION_REMOVE_DOWNLOAD = "com.oplus.tbl.exoplayer.downloadService.action.REMOVE_DOWNLOAD";
    private static final String ACTION_RESTART = "com.oplus.tbl.exoplayer.downloadService.action.RESTART";
    public static final String ACTION_RESUME_DOWNLOADS = "com.oplus.tbl.exoplayer.downloadService.action.RESUME_DOWNLOADS";
    public static final String ACTION_SET_REQUIREMENTS = "com.oplus.tbl.exoplayer.downloadService.action.SET_REQUIREMENTS";
    public static final String ACTION_SET_STOP_REASON = "com.oplus.tbl.exoplayer.downloadService.action.SET_STOP_REASON";
    ...
    public static final class DownloadManagerHelper implements DownloadManager.Listener {
        ...
        public void attachService(final DownloadService downloadService) {
            ...
            if (this.downloadManager.isInitialized()) {
                Util.createHandlerForCurrentOrMainLooper().postAtFrontOfQueue(new Runnable() { // from class: com.oplus.tbl.exoplayer2.offline.c
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f7653a.lambda$attachService$0(downloadService);
                    }
                });
            }
        }
        ...
        @Override // com.oplus.tbl.exoplayer2.offline.DownloadManager.Listener
        ...
        public /* synthetic */ void onRequirementsStateChanged(DownloadManager downloadManager, Requirements requirements, int i) {
            tf1.f(this, downloadManager, requirements, i);
        }
    ...
    public final class ForegroundNotificationUpdater {
        ...
        public void update() {
            ...
            if (this.periodicUpdatesStarted) {
                ...
                this.handler.postDelayed(new Runnable() { // from class: com.oplus.tbl.exoplayer2.offline.d
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f7654a.update();
                    }
    ...
    public int onStartCommand(@Nullable Intent intent, int i, int i2) {
        ...
        switch (action) {
            case "com.oplus.tbl.exoplayer.downloadService.action.REMOVE_DOWNLOAD":
                if (stringExtra != null) {
                ...
                break;
            case "com.oplus.tbl.exoplayer.downloadService.action.REMOVE_ALL_DOWNLOADS":
                downloadManager.removeAllDownloads();
                break;
            case "com.oplus.tbl.exoplayer.downloadService.action.RESUME_DOWNLOADS":
                downloadManager.resumeDownloads();
                break;
            case "com.oplus.tbl.exoplayer.downloadService.action.INIT":
            case "com.oplus.tbl.exoplayer.downloadService.action.RESTART":
                break;
            case "com.oplus.tbl.exoplayer.downloadService.action.ADD_DOWNLOAD":
                ...
                break;
            case "com.oplus.tbl.exoplayer.downloadService.action.PAUSE_DOWNLOADS":
                downloadManager.pauseDownloads();
                break;
            case "com.oplus.tbl.exoplayer.downloadService.action.SET_REQUIREMENTS":
                ...
                break;
            case "com.oplus.tbl.exoplayer.downloadService.action.SET_STOP_REASON":
