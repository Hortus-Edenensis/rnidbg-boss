...
public final class DownloadManager {
    ...
    public static final class InternalHandler extends Handler {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:22:0x0053, code lost:
            ...
            com.oplus.tbl.exoplayer2.util.Log.e(com.oplus.tbl.exoplayer2.offline.DownloadManager.TAG, "Failed to update index.", r0);
         */
        /*
    ...
    public static class Task extends Thread implements Downloader.ProgressListener {
        ...
        @Override // com.oplus.tbl.exoplayer2.offline.Downloader.ProgressListener
    ...
    public DownloadManager(Context context, DatabaseProvider databaseProvider, Cache cache, DataSource.Factory factory) {
        this(context, databaseProvider, cache, factory, new k41());
    }
    ...
    public DownloadManager(Context context, WritableDownloadIndex writableDownloadIndex, DownloaderFactory downloaderFactory) {
        ...
        Handler handlerCreateHandlerForCurrentOrMainLooper = Util.createHandlerForCurrentOrMainLooper(new Handler.Callback() { // from class: pf1
            @Override // android.os.Handler.Callback
            public final boolean handleMessage(Message message) {
                return this.f20005a.handleMainMessage(message);
            }
        });
        ...
        this.internalHandler = internalHandler;
        RequirementsWatcher.Listener listener = new RequirementsWatcher.Listener() { // from class: rf1
            @Override // com.oplus.tbl.exoplayer2.scheduler.RequirementsWatcher.Listener
            public final void onRequirementsStateChanged(RequirementsWatcher requirementsWatcher, int i) {
                this.f20459a.onRequirementsStateChanged(requirementsWatcher, i);
            }
        };
