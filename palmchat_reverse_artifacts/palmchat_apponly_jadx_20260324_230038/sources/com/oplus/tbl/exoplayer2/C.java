...
public final class C {
    ...
    public static final int COLOR_SPACE_DISPLAY_P3 = 10;
    ...
    public static final int EXPAND_CONTEXT_RECEIVER_EXPORT = 2;
    ...
    public static final int FORMAT_UNSUPPORTED_COPYRIGHT_TYPE = 5;
    ...
    public static final int VIDEO_DECODER_HARDWARE = 0;
    public static final int VIDEO_DECODER_SOFTWARE = 1;
    public static final int VIDEO_DECODER_UNKNOWN = 2;
    ...
    @Documented
    @Retention(RetentionPolicy.SOURCE)
    public @interface VideoDecoderType {
    }
    ...
    public static String getFormatSupportString(int i) {
        ...
        if (i == 5) {
            return "NO_UNSUPPORTED_COPYRIGHT";
        }
