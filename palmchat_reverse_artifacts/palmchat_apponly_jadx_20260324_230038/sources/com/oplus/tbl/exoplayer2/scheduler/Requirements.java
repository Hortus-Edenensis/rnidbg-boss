...
public final class Requirements implements Parcelable {
    public static final Parcelable.Creator<Requirements> CREATOR = new Parcelable.Creator<Requirements>() { // from class: com.oplus.tbl.exoplayer2.scheduler.Requirements.1
    ...
    private boolean isDeviceCharging(Context context) {
        Intent intentRegisterReceiver = Util.SDK_INT >= 33 ? context.registerReceiver(null, new IntentFilter("android.intent.action.BATTERY_CHANGED"), 2) : context.registerReceiver(null, new IntentFilter("android.intent.action.BATTERY_CHANGED"));
    ...
    private boolean isStorageNotLow(Context context) {
        return Util.SDK_INT >= 33 ? context.registerReceiver(null, new IntentFilter("android.intent.action.DEVICE_STORAGE_LOW"), 2) == null : context.registerReceiver(null, new IntentFilter("android.intent.action.DEVICE_STORAGE_LOW")) == null;
    }
