...
public abstract class MappingTrackSelector extends TrackSelector {
    ...
    public static final class MappedTrackInfo {
        public static final int RENDERER_SUPPORT_EXCEEDS_CAPABILITIES_TRACKS = 3;
        public static final int RENDERER_SUPPORT_NO_TRACKS = 0;
        public static final int RENDERER_SUPPORT_PLAYABLE_TRACKS = 4;
        public static final int RENDERER_SUPPORT_UNSUPPORTED_COPYRIGHT_TRACKS = 2;
        ...
        public int getTrackSupport(int i, int i2, int i3) {
            return rv4.d(this.rendererFormatSupports[i][i2][i3]);
        }
        ...
        public int getAdaptiveSupport(int i, int i2, int[] iArr) {
            ...
            while (i3 < iArr.length) {
                ...
                iMin = Math.min(iMin, rv4.c(this.rendererFormatSupports[i][i2][i3]));
                i3++;
                i4 = i5;
            }
    ...
    private static int findRenderer(RendererCapabilities[] rendererCapabilitiesArr, TrackGroup trackGroup, int[] iArr, boolean z) throws ExoPlaybackException {
        ...
        for (int i2 = 0; i2 < rendererCapabilitiesArr.length; i2++) {
            ...
            for (int i3 = 0; i3 < trackGroup.length; i3++) {
                iMax = Math.max(iMax, rv4.d(rendererCapabilities.supportsFormat(trackGroup.getFormat(i3))));
            }
    ...
    @Override // com.oplus.tbl.exoplayer2.trackselection.TrackSelector
