    ...
    public long getCurrentPositionUs(boolean z) {
        ...
        if (!this.notifiedPositionIncreasing) {
            ...
            if (playbackHeadPositionUs > j3) {
                ...
                this.listener.onPositionAdvancing(System.currentTimeMillis() - C.usToMs(Util.getPlayoutDurationForMediaDuration(C.usToMs(playbackHeadPositionUs - j3), this.audioTrackPlaybackSpeed)));
            }
        }
