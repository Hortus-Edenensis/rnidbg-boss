...
public final class AudioCapabilitiesReceiver {
    ...
    public AudioCapabilities register() {
        ...
        if (this.receiver != null) {
            ...
            intentRegisterReceiver = Util.SDK_INT >= 33 ? this.context.registerReceiver(this.receiver, intentFilter, null, this.handler, 2) : this.context.registerReceiver(this.receiver, intentFilter, null, this.handler);
        }
