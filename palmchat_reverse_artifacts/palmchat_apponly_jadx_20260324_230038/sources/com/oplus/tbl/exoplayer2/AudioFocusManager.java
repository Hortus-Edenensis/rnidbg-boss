...
final class AudioFocusManager {
    ...
    public class AudioFocusListener implements AudioManager.OnAudioFocusChangeListener {
        ...
        public void onAudioFocusChange(final int i) {
            this.eventHandler.post(new Runnable() { // from class: com.oplus.tbl.exoplayer2.a
                @Override // java.lang.Runnable
                public final void run() {
                    this.f7573a.lambda$onAudioFocusChange$0(i);
                }
            });
        }
    }
    ...
    private int requestAudioFocusV26() {
        ...
        if (audioFocusRequest == null || this.rebuildAudioFocusRequest) {
            if (audioFocusRequest == null) {
                tj.a();
                builderA = ak.a(this.focusGain);
            } else {
                tj.a();
                builderA = sj.a(this.audioFocusRequest);
            }
            this.audioFocusRequest = builderA.setAudioAttributes(((AudioAttributes) Assertions.checkNotNull(this.audioAttributes)).getAudioAttributesV21()).setWillPauseWhenDucked(willPauseWhenDucked()).setOnAudioFocusChangeListener(this.focusListener).build();
