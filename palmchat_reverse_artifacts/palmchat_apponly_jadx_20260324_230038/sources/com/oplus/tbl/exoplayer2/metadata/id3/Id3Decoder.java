...
public final class Id3Decoder extends SimpleMetadataDecoder {
    ...
    public static final FramePredicate NO_FRAMES_PREDICATE = new FramePredicate() { // from class: bq2
        @Override // com.oplus.tbl.exoplayer2.metadata.id3.Id3Decoder.FramePredicate
    ...
    */
    ...
    private static Id3Header decodeHeader(ParsableByteArray parsableByteArray) {
        ...
        if (parsableByteArray.bytesLeft() < 10) {
            ...
            sb.append(String.format("%06X", Integer.valueOf(unsignedInt24)));
            string = sb.toString();
        }
        Log.w(TAG, string);
        return null;
