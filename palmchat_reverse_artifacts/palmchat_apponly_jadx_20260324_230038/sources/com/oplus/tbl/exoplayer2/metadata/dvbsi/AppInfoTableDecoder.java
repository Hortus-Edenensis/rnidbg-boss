package com.oplus.tbl.exoplayer2.metadata.dvbsi;
                ...
                if (bits2 == 2) {
                    ...
                    if (bits4 == 3) {
                        while (parsableBitArray.getBytePosition() < bytePosition3) {
                            bytesAsString = parsableBitArray.readBytesAsString(parsableBitArray.readBits(8), f10.f17407a);
                    ...
                    bytesAsString2 = parsableBitArray.readBytesAsString(bits3, f10.f17407a);
                }
