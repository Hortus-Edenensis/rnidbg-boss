...
import com.oplus.tbl.exoplayer2.drm.UnsupportedMediaCrypto;
...
public final class Format implements Parcelable {
    public static final Parcelable.Creator<Format> CREATOR = new Parcelable.Creator<Format>() { // from class: com.oplus.tbl.exoplayer2.Format.1
    ...
    public final long firstSampleOffsetUs;
    ...
    public static final class Builder {
        ...
        private long firstSampleOffsetUs;
        ...
        public Builder setFirstSampleOffsetUs(long j) {
            this.firstSampleOffsetUs = j;
            return this;
        }
        ...
        private Builder(Format format) {
            ...
            this.displayWidth = format.displayWidth;
            this.displayHeight = format.displayHeight;
            ...
            this.firstSampleOffsetUs = format.firstSampleOffsetUs;
    ...
    public Format(Parcel parcel) {
        ...
        this.hasPrerollSamples = Util.readBoolean(parcel);
        ...
        this.firstSampleOffsetUs = parcel.readLong();
    ...
    @Deprecated
    public static Format createAudioSampleFormat(@Nullable String str, @Nullable String str2, @Nullable String str3, int i, int i2, int i3, int i4, int i5, int i6, int i7, long j, @Nullable List<byte[]> list, @Nullable DrmInitData drmInitData, int i8, @Nullable String str4, @Nullable Metadata metadata) {
        return new Builder().setId(str).setLanguage(str4).setSelectionFlags(i8).setAverageBitrate(i).setPeakBitrate(i).setCodecs(str3).setMetadata(metadata).setSampleMimeType(str2).setMaxInputSize(i2).setInitializationData(list).setDrmInitData(drmInitData).setChannelCount(i3).setSampleRate(i4).setPcmEncoding(i5).setEncoderDelay(i6).setEncoderPadding(i7).setFirstSampleOffsetUs(j).build();
    }
    ...
    public int hashCode() {
        if (this.hashCode == 0) {
            ...
            int iHashCode7 = (((((((((((((((((((((((((((((((((((iHashCode6 + (str6 == null ? 0 : str6.hashCode())) * 31) + this.maxInputSize) * 31) + ((int) this.subsampleOffsetUs)) * 31) + this.width) * 31) + this.height) * 31) + this.displayWidth) * 31) + this.displayHeight) * 31) + Float.floatToIntBits(this.frameRate)) * 31) + this.rotationDegrees) * 31) + Float.floatToIntBits(this.pixelWidthHeightRatio)) * 31) + this.stereoMode) * 31) + this.channelCount) * 31) + this.sampleRate) * 31) + this.pcmEncoding) * 31) + this.encoderDelay) * 31) + this.encoderPadding) * 31) + ((int) this.firstSampleOffsetUs)) * 31) + this.accessibilityChannel) * 31;
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeLong(this.firstSampleOffsetUs);
    ...
    private Format(Builder builder) {
        ...
        this.firstSampleOffsetUs = builder.firstSampleOffsetUs;
        this.accessibilityChannel = builder.accessibilityChannel;
        this.exoMediaCryptoType = (builder.exoMediaCryptoType != null || drmInitData == null) ? builder.exoMediaCryptoType : UnsupportedMediaCrypto.class;
    }
