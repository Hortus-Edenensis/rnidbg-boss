...
public abstract class AbstractConcatenatedTimeline extends Timeline {
    private static final String TAG = "AbstractConcatenatedTimeline";
    ...
    public int getNextWindowIndex(int i, int i2, boolean z) {
        ...
        if (childIndexByWindowIndex == -1) {
            Log.e(TAG, "getNextWindowIndex windowIndex: " + i);
            return -1;
        }
    ...
    public final Timeline.Period getPeriod(int i, Timeline.Period period, boolean z) {
        ...
        if (childIndexByPeriodIndex == -1) {
            Log.e(TAG, "getPeriod periodIndex " + i);
        }
    ...
    public final Timeline.Period getPeriodByUid(Object obj, Timeline.Period period) {
        ...
        if (childIndexByChildUid == -1) {
            Log.e(TAG, "getPeriodByUid childUid " + childTimelineUidFromConcatenatedUid);
            return period;
        }
    ...
    public int getPreviousWindowIndex(int i, int i2, boolean z) {
        ...
        int childIndexByWindowIndex = getChildIndexByWindowIndex(i);
        if (childIndexByWindowIndex == -1) {
            Log.e(TAG, "getPreviousWindowIndex windowIndex: " + i);
            return -1;
        }
        int firstWindowIndexByChildIndex = getFirstWindowIndexByChildIndex(childIndexByWindowIndex);
    ...
    public final Object getUidOfPeriod(int i) {
        ...
        Log.e(TAG, "getUidOfPeriod periodIndex " + i);
        return null;
    }
    ...
    public final Timeline.Window getWindow(int i, Timeline.Window window, long j) {
        int childIndexByWindowIndex = getChildIndexByWindowIndex(i);
        if (childIndexByWindowIndex == -1) {
            Log.e(TAG, "getWindow windowIndex " + i);
        }
        int firstWindowIndexByChildIndex = getFirstWindowIndexByChildIndex(childIndexByWindowIndex);
