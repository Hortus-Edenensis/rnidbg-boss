...
public final class g {
    ...
    private static final String f7128a = "IDCConfigParse";
    ...
    public static void a(String str, boolean z) {
        ...
        String[] strArrA4;
        String[] strArrA5;
        com.igexin.c.a.c.a.b(f7128a, " parse idc config data : ".concat(String.valueOf(str)));
        try {
        ...
        if (jSONObject.has(WkAdxAdConfigMg.DSP_NAME_BAIDU) && (strArrA3 = a(jSONObject, WkAdxAdConfigMg.DSP_NAME_BAIDU)) != null && strArrA3.length > 0) {
            SDKUrlConfig.BI_ADDRESS_IPS = strArrA3;
        }
        if (jSONObject.has(WkAdxAdConfigMg.DSP_NAME_CSJ) && (strArrA2 = a(jSONObject, WkAdxAdConfigMg.DSP_NAME_CSJ)) != null && strArrA2.length > 0) {
