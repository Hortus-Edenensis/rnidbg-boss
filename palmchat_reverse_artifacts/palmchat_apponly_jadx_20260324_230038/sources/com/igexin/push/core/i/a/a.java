...
public final class a {
    ...
    private static final String f7273a = "BufferGifDecoder";
    ...
    private static int a(i iVar, int i, int i2) {
        ...
        com.igexin.c.a.c.a.b(f7273a, "Downsampling GIF, sampleSize: " + iMax + ", target dimens: [" + i + "x" + i2 + "], actual dimens: [" + iVar.h + "x" + iVar.i + "]");
        return iMax;
    }
    ...
    public final f a(ByteBuffer byteBuffer, int i, int i2) {
        ...
        try {
            ...
            if (iVarB.e > 0 && iVarB.d == 0) {
                ...
                int iMax = Math.max(1, iMin == 0 ? 0 : Integer.highestOneBit(iMin));
                com.igexin.c.a.c.a.b(f7273a, "Downsampling GIF, sampleSize: " + iMax + ", target dimens: [" + i + "x" + i2 + "], actual dimens: [" + iVarB.h + "x" + iVarB.i + "]");
