...
public final class d implements PushMessageInterface {
    ...
    public static final String f7155a = "BasicAction";

    @Override // com.igexin.push.extension.mod.PushMessageInterface
    public final boolean executeAction(PushTaskBean pushTaskBean, BaseActionBean baseActionBean) {
        long jCurrentTimeMillis = System.currentTimeMillis() + (((com.igexin.push.core.b.h) baseActionBean).f7174a * 1000);
    ...
    public final BaseActionBean parseAction(JSONObject jSONObject) {
        try {
            ...
            if (jSONObject.has("duration")) {
                hVar.f7174a = Long.valueOf(jSONObject.getString("duration")).longValue();
            }
            return hVar;
