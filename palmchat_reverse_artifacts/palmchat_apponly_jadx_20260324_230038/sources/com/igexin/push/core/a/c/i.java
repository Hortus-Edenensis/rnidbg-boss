...
public final class i implements PushMessageInterface {
    ...
    private static final String f7160a = "PopupAction";
    private long b = 0;
    ...
    private static void b(PushTaskBean pushTaskBean) {
        ...
        boolean z = !com.igexin.push.a.g.f7082a && zIsAppForeground;
        ...
        if (!z || zBooleanValue || z2) {
            com.igexin.c.a.c.a.b(f7160a, "has one popup = " + com.igexin.push.a.g.f7082a + " , appForeground = " + zIsAppForeground + " , is guardAndTranslucent = " + z2 + " , has Translucent popu " + zBooleanValue);
            return;
        }
    ...
    public final boolean executeAction(PushTaskBean pushTaskBean, BaseActionBean baseActionBean) {
        ...
        com.igexin.c.a.c.a.b(f7160a, "startActivity PopuAction");
    ...
    public final BaseActionBean parseAction(JSONObject jSONObject) {
        ...
        try {
            ...
            mVar.f7179a = new m.b(jSONObject2.optJSONObject("mask"), mVar.c, mVar.d, f, f2);
            mVar.b = new m.b(jSONObject2.optJSONObject(EventParams.KEY_PARAM_TEMPLATE), mVar.c, mVar.d, f, f2);
    ...
    public final PushMessageInterface.ActionPrepareState prepareExecuteAction(PushTaskBean pushTaskBean, BaseActionBean baseActionBean) {
        boolean zIsAppForeground = CommonUtil.isAppForeground();
        boolean z = (baseActionBean instanceof com.igexin.push.core.b.m) && !com.igexin.push.a.g.f7082a && zIsAppForeground;
        ...
        com.igexin.c.a.c.a.b(f7160a, "has one popup = " + com.igexin.push.a.g.f7082a + " , appForeground = " + zIsAppForeground + " , is guardAndTranslucent = " + z3 + " ,overLimitTime = " + z2 + " , has Translucent popu " + zBooleanValue);
