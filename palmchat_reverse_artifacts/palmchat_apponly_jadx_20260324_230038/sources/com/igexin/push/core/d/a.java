...
public final class a implements e {
    ...
    private static final String f7201a = "DycSdkConfig";
    ...
    private static void d() {
        ...
        GtcManager.getInstance().loadSdk(new SdkInfo.Builder().appid(com.igexin.push.core.e.f7217a).cid(com.igexin.push.core.e.A).moduleName(com.igexin.push.core.b.j).version("3.3.7.0").build());
    }
    ...
    private static Map<String, String> a(Context context, f fVar) {
        return com.getui.gtc.dyc.b.a.a(context, fVar.f7214a);
    }

    private Map<String, String> a(boolean z) {
        SDKUrlConfig.getConfigServiceUrl();
        String str = com.igexin.push.core.e.f7217a;
        Map<String, String> mapA = a(com.igexin.push.core.e.l, new f.a().b(com.igexin.push.core.b.j).a(SDKUrlConfig.getConfigServiceUrl()).f("3.3.7.0").c(com.igexin.push.core.e.f7217a).d(com.igexin.push.core.e.A).e(com.getui.gtc.dyc.b.b.f5752a).a(z ? 1L : 86400000L).a(new g() { // from class: com.igexin.push.core.d.a.1
            @Override // com.igexin.push.core.d.g
            public final void a(String str2) {
                com.igexin.c.a.c.a.a(a.f7201a, str2);
        ...
        if (map != null) {
            try {
                if (map.size() != 0) {
                    ...
                    com.igexin.push.config.d.f7126a = a("sdk.querytag.interval", Long.valueOf(com.igexin.push.config.d.f7126a)).longValue();
                ...
                com.igexin.c.a.c.a.a(f7201a, th.toString());
            }
            return true;
        }
        return false;
