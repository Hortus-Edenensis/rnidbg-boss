...
public final class m extends BaseActionBean implements Serializable {
    ...
    public static class b implements Serializable {
        ...
        public b(JSONObject jSONObject, String str, String str2, float f, float f2) {
            ...
            this.F = f;
            this.G = f2;
            this.f7181a = jSONObject.optString("type");
            ...
            if (jSONObjectOptJSONObject2 != null) {
                ...
                if (jSONObjectOptJSONObject3 != null) {
                    this.u = jSONObjectOptJSONObject3.optString(Constant.MAP_KEY_TOP, null);
                ...
                if (jSONObjectOptJSONObject4 != null) {
                    this.y = jSONObjectOptJSONObject4.optString(Constant.MAP_KEY_TOP, null);
            ...
            if (jSONObjectOptJSONObject5 != null) {
                ...
                if (jSONObjectOptJSONObject6 != null) {
                    str3 = "";
                    this.l = Color.argb((int) (jSONObjectOptJSONObject6.optDouble("a") * 255.0d), (int) jSONObjectOptJSONObject6.optDouble(com.kuaishou.weapon.p0.t.k), (int) jSONObjectOptJSONObject6.optDouble("g"), (int) jSONObjectOptJSONObject6.optDouble(com.kuaishou.weapon.p0.t.l));
                } else {
                    str3 = "";
                }
                JSONObject jSONObjectOptJSONObject7 = jSONObjectOptJSONObject5.optJSONObject("backgroundColor");
                if (jSONObjectOptJSONObject7 != null) {
                    this.m = Color.argb((int) (jSONObjectOptJSONObject7.optDouble("a") * 255.0d), (int) jSONObjectOptJSONObject7.optDouble(com.kuaishou.weapon.p0.t.k), (int) jSONObjectOptJSONObject7.optDouble("g"), (int) jSONObjectOptJSONObject7.optDouble(com.kuaishou.weapon.p0.t.l));
                }
                ...
                if (jSONObjectOptJSONObject8 != null) {
                    this.n = Color.argb((int) (jSONObjectOptJSONObject8.optDouble("a") * 255.0d), (int) jSONObjectOptJSONObject8.optDouble(com.kuaishou.weapon.p0.t.k), (int) jSONObjectOptJSONObject8.optDouble("g"), (int) jSONObjectOptJSONObject8.optDouble(com.kuaishou.weapon.p0.t.l));
                }
            ...
            if (jSONObjectOptJSONObject9 != null && (jSONObjectOptJSONObject = jSONObjectOptJSONObject9.optJSONObject(ZZ00Z.x)) != null) {
                GTPopupMessage gTPopupMessage = new GTPopupMessage();
                gTPopupMessage.setElementType(this.e);
                GTPopupMessage.GtAction gtAction = new GTPopupMessage.GtAction(jSONObjectOptJSONObject.optString(VideoActivity.EXTRA_KEY_ACTION_TYPE), jSONObjectOptJSONObject.optString(CommonCode.Resolution.HAS_RESOLUTION_FROM_APK), jSONObjectOptJSONObject.optString("url"), jSONObjectOptJSONObject.optBoolean("closePopup", false));
                String str4 = this.f;
    ...
    private void a(JSONObject jSONObject) {
        ...
        if (jSONObjectOptJSONObject2 != null) {
            ...
            f = Float.parseFloat(strOptString.substring(0, strOptString.length() - 2));
        ...
        float f3 = f;
        float f4 = f2;
        this.f7179a = new b(jSONObject.optJSONObject("mask"), this.c, this.d, f3, f4);
        this.b = new b(jSONObject.optJSONObject(EventParams.KEY_PARAM_TEMPLATE), this.c, this.d, f3, f4);
