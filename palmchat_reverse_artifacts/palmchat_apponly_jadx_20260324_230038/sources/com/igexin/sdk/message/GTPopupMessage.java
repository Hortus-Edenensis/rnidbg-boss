...
public class GTPopupMessage extends BaseMessage {
    ...
    public static class EventProperties implements Serializable {
        ...
        public String toString() {
            return "{\"$popup_plan_name\":\"" + this.$popup_plan_name + Typography.quote + ", \"$popup_node_name\":\"" + this.$popup_node_name + Typography.quote + ", \"$popup_click_modal\":\"" + this.$popup_click_modal + Typography.quote + ", \"$popup_node_modal_name\":\"" + this.$popup_node_modal_name + Typography.quote + '}';
        }
    }
