...
class nr implements Application.ActivityLifecycleCallbacks {
    Fragment u;

    public nr(Fragment fragment) {
        this.u = fragment;
    }

    @Override // android.app.Application.ActivityLifecycleCallbacks
    public void onActivityPostSaveInstanceState(@NonNull Activity activity, @NonNull Bundle bundle) {
        if (this.u.getActivity() == activity && activity.getClassLoader() != this.u.getClass().getClassLoader()) {
            try {
