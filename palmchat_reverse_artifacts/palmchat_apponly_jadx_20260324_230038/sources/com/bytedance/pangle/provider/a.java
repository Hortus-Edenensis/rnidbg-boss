...
import com.bytedance.pangle.util.jk;
import java.io.File;
...
public class a {
    ...
    private static Uri a(String str, Uri uri, String str2) {
        ...
        String strU = jk.u(u.u(pluginProcessNameByAuthority, str, uri));
        return Uri.parse("content://" + ContentProviderManager.getInstance().getSystemProviderInfoMap().get(pluginProcessNameByAuthority).nr + File.separator + "proxy?provider_params=" + strU);
    }
    ...
    public static Bundle a(ContentResolver contentResolver, String str, String str2, String str3, Bundle bundle, String str4) {
        ...
        String str5 = ContentProviderManager.getInstance().getSystemProviderInfoMap().get(ContentProviderManager.getInstance().getPluginProcessNameByAuthority(str)).nr;
        if (bundle == null) {
            bundle = new Bundle();
        }
