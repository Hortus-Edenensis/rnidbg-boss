...
public class PluginActivityWrapper extends GenerateActivityWrapper {
    ...
    public PluginActivityWrapper(Activity activity, PluginContext pluginContext) {
        ...
        try {
            if (!activity.isDestroyed()) {
                ...
                if (i >= 29) {
                    this.mOriginActivity.registerActivityLifecycleCallbacks(new com.bytedance.pangle.u() { // from class: com.bytedance.pangle.wrapper.PluginActivityWrapper.1
                    });
                } else if (i >= 24) {
                    setTag();
                } else {
    ...
    private void registerApplicationLifecycleCallbacks() {
        ...
        appApplication.registerActivityLifecycleCallbacks(new com.bytedance.pangle.u() { // from class: com.bytedance.pangle.wrapper.PluginActivityWrapper.2
    ...
    private void setTag() {
        ...
        decorView.setTag(pluginPackageName.hashCode(), new com.bytedance.pangle.u() { // from class: com.bytedance.pangle.wrapper.PluginActivityWrapper.3
        });
    }
}
