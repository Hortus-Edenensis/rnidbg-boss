...
@Keep
public abstract class GenerateProxyAppCompatActivity extends AppCompatActivity implements nr {
    ...
    @Override // android.app.Activity, com.bytedance.pangle.activity.nr
    public void finish() {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
    ...
    @Override // com.bytedance.pangle.activity.nr
