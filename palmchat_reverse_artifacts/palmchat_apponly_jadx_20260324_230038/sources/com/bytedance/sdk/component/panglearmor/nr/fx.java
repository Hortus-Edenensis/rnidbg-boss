...
public class fx {
    public static float[] u(List<Float> list, List<Float> list2, List<Float> list3, List<Float> list4, List<Float> list5, List<Float> list6) {
    ...
    @NonNull
    public static int[][] u(List<JSONObject> list, long j, long j2) throws JSONException {
        int size = list.size();
        ...
        return new int[][]{u(dArr, j), u(dArr2, j2), u(dArr3, j2)};
    }

    @NonNull
    public static int[] u(double[] dArr, long j) {
        if (j <= 0 || j > 360) {
            return new int[0];
        }
    ...
    @NonNull
    public static int[] u(LinkedList<JSONObject> linkedList, int i) {
        int[] iArr = new int[i];
