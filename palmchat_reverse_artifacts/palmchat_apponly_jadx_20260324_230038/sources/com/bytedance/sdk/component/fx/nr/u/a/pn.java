...
public final class pn implements HostnameVerifier {
    public static final pn u = new pn();
    ...
    private boolean fx(String str, X509Certificate x509Certificate) {
        ...
        if (z || (strU = new b(x509Certificate.getSubjectX500Principal()).u("cn")) == null) {
            return false;
        }
    ...
    public boolean u(String str, X509Certificate x509Certificate) {
        return com.bytedance.sdk.component.fx.nr.u.fx.fx(str) ? nr(str, x509Certificate) : fx(str, x509Certificate);
    }
    ...
    public static List<String> u(X509Certificate x509Certificate) {
        List<String> listU = u(x509Certificate, 7);
        List<String> listU2 = u(x509Certificate, 2);
        ArrayList arrayList = new ArrayList(listU.size() + listU2.size());
