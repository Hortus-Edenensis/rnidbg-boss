...
public class u {
    ...
    public static void u(Context context, String str, int i, String[] strArr, long[] jArr, VideoEventEngineUploader videoEventEngineUploader) {
        if (u) {
            return;
        }
        try {
    ...
    public static TTVideoEngine u(Context context) {
