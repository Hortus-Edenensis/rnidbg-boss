...
public class b {
        ...
        try {
            ...
            while (itKeys.hasNext()) {
                ...
                if (objOpt2 == null || objOpt2 == JSONObject.NULL) {
                    ...
                    jSONObject3.put(next, u((JSONObject) objOpt, (JSONObject) objOpt2));
                } else if ((objOpt instanceof JSONArray) && (objOpt2 instanceof JSONArray)) {
                    jSONObject3.put(next, u((JSONArray) objOpt, (JSONArray) objOpt2));
                } else {
    ...
    private static JSONArray u(JSONArray jSONArray, JSONArray jSONArray2) {
            ...
            try {
                ...
                if (objOpt2 != null && objOpt2 != JSONObject.NULL) {
                    if ((objOpt instanceof JSONObject) && (objOpt2 instanceof JSONObject)) {
                        jSONArray3.put(i, u((JSONObject) objOpt, (JSONObject) objOpt2));
                    } else if ((objOpt instanceof JSONArray) && (objOpt2 instanceof JSONArray)) {
                        jSONArray3.put(i, u((JSONArray) objOpt, (JSONArray) objOpt2));
                    } else {
