...
public class b implements Function<SparseArray<Object>, Object> {
    private final TTAdNative.NativeAdListener u;

    public b(TTAdNative.NativeAdListener nativeAdListener) {
    ...
    public Object apply(SparseArray<Object> sparseArray) {
        ...
        switch (valueSetA.intValue(-99999987)) {
            ...
            case 143102:
                ...
                while (it.hasNext()) {
                    arrayList2.add(new l(k.u(it.next())));
                }
                this.u.onNativeAdLoad(arrayList2);
                return null;
            default:
                return null;
        }
