...
import com.bytedance.sdk.openadsdk.my.u.u.n;
...
public class u implements Function<SparseArray<Object>, Object> {
    private final TTAdNative.DrawFeedAdListener u;

    public u(TTAdNative.DrawFeedAdListener drawFeedAdListener) {
        this.u = drawFeedAdListener;
    }
    ...
    public Object apply(SparseArray<Object> sparseArray) {
        ...
        switch (valueSetA.intValue(-99999987)) {
            ...
            case 172102:
                ...
                this.u.onDrawFeedAdLoad(arrayList2);
                return null;
            default:
                return null;
        }
