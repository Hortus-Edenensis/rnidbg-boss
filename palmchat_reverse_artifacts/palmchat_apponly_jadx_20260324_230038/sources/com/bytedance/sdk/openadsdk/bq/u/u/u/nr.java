...
public class nr implements Function<SparseArray<Object>, Object> {
    private final TTAdNative.FeedAdListener u;

    public nr(TTAdNative.FeedAdListener feedAdListener) {
        this.u = feedAdListener;
    }
    ...
    public Object apply(SparseArray<Object> sparseArray) {
        ...
        switch (valueSetA.intValue(-99999987)) {
            ...
            case 164102:
                ...
                while (it.hasNext()) {
                    arrayList2.add(new a((Function) it.next()));
                }
                this.u.onFeedAdLoad(arrayList2);
                return null;
            default:
                return null;
        }
