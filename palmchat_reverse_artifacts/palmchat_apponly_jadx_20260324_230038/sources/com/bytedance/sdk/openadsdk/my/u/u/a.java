...
public class a implements TTFeedAd {
    private ValueSet nr;
    ...
    public Bitmap getAdLogo() {
        return (Bitmap) this.nr.objectValue(140002, Bitmap.class);
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public View getAdView() {
        View view = (View) this.nr.objectValue(140016, View.class);
        com.bytedance.sdk.openadsdk.api.iz.pn("wzj", "1-ApiFeed:view=".concat(String.valueOf(view)));
        return view;
    }

    @Override // com.bytedance.sdk.openadsdk.TTFeedAd
    public int getAdViewHeight() {
        return this.nr.intValue(160004);
    }

    @Override // com.bytedance.sdk.openadsdk.TTFeedAd
    public int getAdViewWidth() {
        return this.nr.intValue(160003);
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public int getAppCommentNum() {
        return this.nr.intValue(140006);
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public int getAppScore() {
        return this.nr.intValue(140005);
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public int getAppSize() {
        return this.nr.intValue(140007);
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public String getButtonText() {
        return this.nr.stringValue(140018);
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public ComplianceInfo getComplianceInfo() {
        return new fx(k.u(this.nr.objectValue(140014, Object.class)));
    }

    @Override // com.bytedance.sdk.openadsdk.TTFeedAd
    public TTFeedAd.CustomizeVideo getCustomVideo() {
        return new com.bytedance.sdk.openadsdk.c.u.u.u.u(k.u(this.nr.objectValue(160002, Object.class)));
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public String getDescription() {
        return this.nr.stringValue(140004);
    }
    ...
    public DislikeInfo getDislikeInfo() {
        return new b(k.u(this.nr.objectValue(140013, Object.class)));
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public DownloadStatusController getDownloadStatusController() {
        return new pn(k.u(this.nr.objectValue(140015, Object.class)));
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public TTImage getIcon() {
        return new t(k.u(this.nr.objectValue(140009, Object.class)));
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public List<TTImage> getImageList() {
        List arrayList = (List) this.nr.objectValue(140010, List.class);
        if (arrayList == null) {
        ...
        while (it.hasNext()) {
            arrayList2.add(new t(k.u(it.next())));
        }
        return arrayList2;
    }
    ...
    public int getImageMode() {
        return this.nr.intValue(140012);
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public int getInteractionType() {
        return this.nr.intValue(140011);
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public Map<String, Object> getMediaExtraInfo() {
        return (Map) this.nr.objectValue(140017, Map.class);
    }
    ...
    public String getSource() {
        return this.nr.stringValue(140008);
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public String getTitle() {
        return this.nr.stringValue(140003);
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public TTImage getVideoCoverImage() {
        return new t(k.u(this.nr.objectValue(140001, Object.class)));
    }

    @Override // com.bytedance.sdk.openadsdk.TTFeedAd
    public double getVideoDuration() {
        return this.nr.doubleValue(160001);
    }
    ...
    public void registerViewForInteraction(ViewGroup viewGroup, View view, TTNativeAd.AdInteractionListener adInteractionListener) {
        ...
        sparseArray.put(2, new com.bytedance.sdk.openadsdk.qq.u.u.u.u(adInteractionListener));
        sparseArray.put(-99999985, Void.class);
        this.u.apply(sparseArray);
    }
    ...
    public void setEasyPlayWidgetListener(TTNativeAd.EasyPlayWidgetListener easyPlayWidgetListener) {
        ...
        sparseArray.put(0, new com.bytedance.sdk.openadsdk.qq.u.u.u.nr(easyPlayWidgetListener));
        sparseArray.put(-99999985, Void.class);
        this.u.apply(sparseArray);
    }
    ...
    public void setExpressRenderListener(TTNativeAd.ExpressRenderListener expressRenderListener) {
        ...
        if (expressRenderListener instanceof MediationExpressRenderListener) {
            sparseArray.put(0, new com.bytedance.sdk.openadsdk.mediation.ad.u.u.nr.iz((MediationExpressRenderListener) expressRenderListener));
            sparseArray.put(1, 1);
        } else {
            sparseArray.put(0, new com.bytedance.sdk.openadsdk.qq.u.u.u.fx(expressRenderListener));
            sparseArray.put(1, 0);
        }
        this.u.apply(sparseArray);
    }
    ...
    public void setVideoAdListener(TTFeedAd.VideoAdListener videoAdListener) {
        ...
        sparseArray.put(0, new com.bytedance.sdk.openadsdk.c.u.u.nr.u(videoAdListener));
        sparseArray.put(-99999985, Void.class);
        this.u.apply(sparseArray);
    }
    ...
    public void setVideoRewardListener(TTFeedAd.VideoRewardListener videoRewardListener) {
        ...
        sparseArray.put(0, new com.bytedance.sdk.openadsdk.c.u.u.nr.nr(videoRewardListener));
        sparseArray.put(-99999985, Void.class);
        this.u.apply(sparseArray);
    }
    ...
    public void registerViewForInteraction(ViewGroup viewGroup, List<View> list, List<View> list2, TTNativeAd.AdInteractionListener adInteractionListener) {
        ...
        sparseArray.put(3, new com.bytedance.sdk.openadsdk.qq.u.u.u.u(adInteractionListener));
        sparseArray.put(-99999985, Void.class);
        this.u.apply(sparseArray);
    }
    ...
    public void registerViewForInteraction(ViewGroup viewGroup, List<View> list, List<View> list2, View view, TTNativeAd.AdInteractionListener adInteractionListener) {
        ...
        sparseArray.put(4, new com.bytedance.sdk.openadsdk.qq.u.u.u.u(adInteractionListener));
        sparseArray.put(-99999985, Void.class);
        this.u.apply(sparseArray);
    }
    ...
    public void registerViewForInteraction(ViewGroup viewGroup, List<View> list, List<View> list2, List<View> list3, View view, TTNativeAd.AdInteractionListener adInteractionListener) {
        ...
        sparseArray.put(5, new com.bytedance.sdk.openadsdk.qq.u.u.u.u(adInteractionListener));
        sparseArray.put(-99999985, Void.class);
        this.u.apply(sparseArray);
    }
    ...
    public void registerViewForInteraction(ViewGroup viewGroup, List<View> list, List<View> list2, List<View> list3, List<View> list4, View view, TTNativeAd.AdInteractionListener adInteractionListener) {
        ...
        sparseArray.put(6, new com.bytedance.sdk.openadsdk.qq.u.u.u.u(adInteractionListener));
        sparseArray.put(-99999985, Void.class);
        this.u.apply(sparseArray);
    }
    ...
    public void registerViewForInteraction(Activity activity, ViewGroup viewGroup, List<View> list, List<View> list2, List<View> list3, TTNativeAd.AdInteractionListener adInteractionListener, IMediationViewBinder iMediationViewBinder) {
        ...
        sparseArray.put(5, new com.bytedance.sdk.openadsdk.qq.u.u.u.u(adInteractionListener));
        sparseArray.put(6, new com.bytedance.sdk.openadsdk.mediation.ad.u.u.nr.pn(iMediationViewBinder));
        sparseArray.put(-99999985, Void.class);
        this.u.apply(sparseArray);
    }
}
