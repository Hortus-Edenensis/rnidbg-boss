...
public class iz implements com.bytedance.sdk.openadsdk.res.layout.u {
    ...
    private View fx(Context context) {
        ...
        RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(y.fx(context, 44.0f), y.fx(context, 44.0f));
        layoutParams2.addRule(14);
        ...
        layoutParams4.setMargins(0, y.fx(context, 6.0f), 0, y.fx(context, 20.0f));
        ...
        RelativeLayout.LayoutParams layoutParams5 = new RelativeLayout.LayoutParams(-2, y.fx(context, 28.0f));
        layoutParams5.addRule(3, 2114387764);
        layoutParams5.addRule(14);
        layoutParams5.addRule(15);
        layoutParams5.setMargins(0, 0, 0, 0);
        textView3.setLayoutParams(layoutParams5);
        textView3.setMinWidth(y.fx(context, 72.0f));
        GradientDrawable gradientDrawable = new GradientDrawable();
        gradientDrawable.setColor(Color.parseColor("#2A90D7"));
        gradientDrawable.setCornerRadius(y.fx(context, 6.0f));
        textView3.setBackground(gradientDrawable);
        textView3.setGravity(17);
        textView3.setPadding(y.fx(context, 2.0f), y.fx(context, 2.0f), y.fx(context, 2.0f), y.fx(context, 2.0f));
    ...
    public View nr(Context context) {
        ...
        relativeLayout.addView(fx(context));
