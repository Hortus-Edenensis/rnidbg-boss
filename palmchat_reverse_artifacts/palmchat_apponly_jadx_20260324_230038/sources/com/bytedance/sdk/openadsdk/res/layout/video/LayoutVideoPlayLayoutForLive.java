...
public class LayoutVideoPlayLayoutForLive extends RelativeLayout {
    ...
    private void u(Context context) {
        ...
        View viewNr = new fx().nr(context);
        viewNr.setId(2114387888);
        relativeLayout.addView(viewNr);
        View viewNr2 = new b().nr(context);
        viewNr2.setId(2114387688);
        relativeLayout.addView(viewNr2);
        ...
        RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(-1, y.fx(context, 1.5f));
        ...
        View tTViewStub = new TTViewStub(context, new iz());
        ...
        View tTViewStub2 = new TTViewStub(context, new nr());
        ...
        View tTViewStub3 = new TTViewStub(context, new x());
