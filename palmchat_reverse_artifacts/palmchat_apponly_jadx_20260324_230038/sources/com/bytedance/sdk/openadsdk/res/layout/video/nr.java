...
public class nr extends u {
    ...
    public View nr(Context context) {
        RelativeLayout relativeLayoutU = u(context, 2114387953);
        ...
        RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(y.fx(context, 72.0f), y.fx(context, 72.0f));
        layoutParams2.addRule(14);
        layoutParams2.addRule(15);
        layoutParams2.setMargins(0, y.fx(context, 30.0f), 0, 0);
        ...
        layoutParams4.setMargins(0, y.fx(context, 24.0f), 0, 0);
        ...
        relativeLayoutU.addView(relativeLayout);
