...
public class FlowLayout extends ViewGroup {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i6 = 0; i6 < childCount; i6++) {
            ...
            if ((measuredWidth + marginLayoutParams.leftMargin + marginLayoutParams.rightMargin) * i5 > (width - getPaddingLeft()) - getPaddingRight()) {
                this.nr.add(Integer.valueOf(iMax));
        ...
        for (int i7 = 0; i7 < size; i7++) {
            List<View> list = this.u.get(i7);
            int iIntValue = this.nr.get(i7).intValue();
    ...
    public void onMeasure(int i, int i2) {
        ...
        k.nr("TAG", "sizeWidth = " + size + "|sizeHeight = " + size2);
        k.nr("TAG", "width = " + iMax + ", height = " + i3);
        if (mode != 1073741824) {
