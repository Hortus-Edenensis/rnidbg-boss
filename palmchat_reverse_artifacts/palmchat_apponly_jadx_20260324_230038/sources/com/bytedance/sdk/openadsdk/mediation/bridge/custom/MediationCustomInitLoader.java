...
public abstract class MediationCustomInitLoader extends u {
    ...
    public <T> T applyFunction(int i, ValueSet valueSet, Class<T> cls) {
        if (i == 8240) {
            initAdn((Context) valueSet.objectValue(AVMDLDataLoader.KeyIsLiveWaitP2pReadyThreshold, Context.class), wc7.k((SparseArray) valueSet.objectValue(8424, SparseArray.class)).a());
        } else {
            if (i == 8139) {
    ...
    public final void initAdn(Context context, ValueSet valueSet) {
        ...
        TTCustomController tTCustomControllerU = u(mediationInitConfigCreate);
        Map customInitMap = mediationInitConfigCreate.getCustomInitMap();
        if (customInitMap == null) {
            customInitMap = new HashMap();
        }
        customInitMap.put("custom_controller", tTCustomControllerU);
    ...
    public final boolean isInit() {
        ...
        return ((Boolean) MediationValueUtil.objectValue(this.u.apply(sparseArray), Boolean.class, Boolean.FALSE)).booleanValue();
    }
    ...
    private TTCustomController u(final MediationInitConfig mediationInitConfig) {
        return new TTCustomController() { // from class: com.bytedance.sdk.openadsdk.mediation.bridge.custom.MediationCustomInitLoader.1
            ...
            /* JADX INFO: renamed from: alist */
            public boolean getMAlist() {
                MediationInitConfig mediationInitConfig2 = mediationInitConfig;
                return mediationInitConfig2 != null ? mediationInitConfig2.appList() : super.getMAlist();
            }
            ...
            public LocationProvider getTTLocation() {
                ...
                return new LocationProvider() { // from class: com.bytedance.sdk.openadsdk.mediation.bridge.custom.MediationCustomInitLoader.1.1
                    ...
                    /* JADX INFO: renamed from: getLatitude */
                    public double getMLatitude() {
                        return latitude;
                    }

                    @Override // com.bytedance.sdk.openadsdk.LocationProvider
                    /* JADX INFO: renamed from: getLongitude */
