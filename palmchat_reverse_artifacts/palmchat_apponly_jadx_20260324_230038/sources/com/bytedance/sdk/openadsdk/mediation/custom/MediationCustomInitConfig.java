...
public class MediationCustomInitConfig {
    ...
    public String toString() {
        return "MediationCustomInitConfig{mAppId='" + this.u + "', mAppKey='" + this.nr + "', mADNName='" + this.fx + "', mAdnInitClassName='" + this.b + "', mBannerClassName='" + this.pn + "', mInterstitialClassName='" + this.iz + "', mRewardClassName='" + this.x + "', mFullVideoClassName='" + this.n + "', mSplashClassName='" + this.f5426a + "', mFeedClassName='" + this.jk + "', mDrawClassName='" + this.t + "'}";
    }
    ...
    public MediationCustomInitConfig(ValueSet valueSet) {
        if (valueSet != null) {
            ...
            this.f5426a = valueSet.stringValue(8541);
