...
public class m extends com.bytedance.sdk.component.u.pn<JSONObject, JSONObject> {
    private WeakReference<com.bytedance.sdk.openadsdk.core.ja> u;

    public m(com.bytedance.sdk.openadsdk.core.ja jaVar) {
    ...
    public static void u(com.bytedance.sdk.component.u.o oVar, com.bytedance.sdk.openadsdk.core.ja jaVar) {
        oVar.u("sendPlayableReward", (com.bytedance.sdk.component.u.pn<?, ?>) new m(jaVar));
    }
