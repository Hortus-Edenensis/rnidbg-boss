...
public class b implements com.bytedance.sdk.component.t.u.u.fx {

    @com.bytedance.sdk.component.t.nr.u(u = "privacy_popup_listener")
    private iz.u b;
    ...
    public boolean u(Map<String, Object> map, Map<String, Object> map2, com.bytedance.sdk.component.t.u.u uVar) {
        ...
        TTDelegateActivity.nr(this.u, this.fx, this.pn);
        uVar.u(map2);
        return true;
    }

    private iz.u u() {
        return new iz.u() { // from class: com.bytedance.sdk.openadsdk.core.a.u.nr.b.1
            @Override // com.bytedance.sdk.openadsdk.core.y.iz.u
            public void onDialogBtnNo() {
                if (b.this.b == null) {
                    return;
                }
                b.this.b.onDialogBtnNo();
                b bVar = b.this;
                bVar.u(bVar.x);
            }
