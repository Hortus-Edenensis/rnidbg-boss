...
public class SlideUpLoadMoreArrow extends LinearLayout {
    ...
    private void b() {
        ...
        layoutParams.topMargin = y.fx(context, 80.0f);
        layoutParams.gravity = 1;
        addView(u(getContext()), layoutParams);
        TextView textView = new TextView(context);
        textView.setTextColor(-1);
        if (Build.VERSION.SDK_INT >= 28) {
            textView.setLineHeight(y.fx(context, 17.0f));
        }
        textView.setTextSize(2, 12.0f);
        textView.setText(q.u(context, "tt_reward_slip_up_lp_tip"));
        LinearLayout.LayoutParams layoutParams2 = new LinearLayout.LayoutParams(-2, -2);
        layoutParams2.topMargin = y.fx(context, 6.0f);
        layoutParams2.bottomMargin = y.fx(context, this.u);
    ...
    private void u(View view, View view2) {
        ...
        ObjectAnimator objectAnimatorOfFloat2 = ObjectAnimator.ofFloat(view, "translationY", 0.0f, y.fx(getContext(), -5.0f));
        ...
        ObjectAnimator objectAnimatorOfFloat4 = ObjectAnimator.ofFloat(view2, "translationY", y.fx(getContext(), -6.0f));
        ...
        this.nr.playTogether(objectAnimatorOfFloat, objectAnimatorOfFloat3, objectAnimatorOfFloat2, objectAnimatorOfFloat4);
    }

    public void u() {
        if (this.nr.isStarted()) {
            return;
        }
        this.nr.start();
    }
