...
public class x {
    private static void callback(com.bytedance.sdk.component.a.nr nrVar, ITTHttpCallback iTTHttpCallback) {
        if (nrVar != null && nrVar.a()) {
            if (iTTHttpCallback != null) {
                iTTHttpCallback.onResponse(nrVar.pn());
            }
        } else {
            boolean zIsEmpty = true ^ TextUtils.isEmpty(nrVar != null && nrVar.fx() != null ? nrVar.fx() : null);
            if (iTTHttpCallback != null) {
                iTTHttpCallback.onError(new Exception(zIsEmpty ? nrVar.fx() : nrVar != null ? String.valueOf(nrVar.nr()) : ""));
            }
        }
    }
    ...
    public static void postBody(String str, byte[] bArr, String str2, int i, ITTHttpCallback iTTHttpCallback) {
        if (bArr == null) {
            ...
            pnVarNr.u(str);
            pnVarNr.u(str2, bArr);
            callback(pnVarNr.u(), iTTHttpCallback);
        }
    }
}
