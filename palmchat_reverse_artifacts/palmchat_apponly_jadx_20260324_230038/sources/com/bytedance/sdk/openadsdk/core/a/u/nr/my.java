...
public class my implements com.bytedance.sdk.component.t.u.u.fx {
    ...
    @com.bytedance.sdk.component.t.nr.u(u = "type")
    private String u;
    ...
    public boolean u(Map<String, Object> map, Map<String, Object> map2, com.bytedance.sdk.component.t.u.u uVar) {
        if (!u()) {
            com.bytedance.sdk.component.utils.k.nr("UChain_ReportStatsAction", "ifHasAllRequiredParam = false");
            uVar.nr(map2);
            return false;
        }
        final JSONObject jSONObjectU = u(map);
        final int iJk = jp.jk(this.fx);
        com.bytedance.sdk.openadsdk.core.qq.s.u().nr(new com.bytedance.sdk.openadsdk.t.u.u() { // from class: com.bytedance.sdk.openadsdk.core.a.u.nr.my.1
            @Override // com.bytedance.sdk.openadsdk.t.u.u
            public com.bytedance.sdk.openadsdk.core.qq.u.u u() throws Exception {
                return com.bytedance.sdk.openadsdk.core.qq.u.nr.nr().u(my.this.u).n(my.this.nr).u(iJk).nr(jSONObjectU.toString());
            }
        }, this.u);
        uVar.u(map2);
        return true;
