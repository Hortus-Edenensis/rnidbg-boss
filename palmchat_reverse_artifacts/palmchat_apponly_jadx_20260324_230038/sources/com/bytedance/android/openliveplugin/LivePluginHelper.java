...
import com.bytedance.sdk.component.jk.fx;
...
public class LivePluginHelper {
    ...
    public static final ScheduledExecutorService sExecutor = fx.fx(new DefaultThreadFactory());
    ...
    public static class DefaultThreadFactory implements ThreadFactory {
        ...
        public Thread newThread(Runnable runnable) {
            com.bytedance.sdk.component.jk.b.fx fxVar = new com.bytedance.sdk.component.jk.b.fx(this.group, runnable, this.namePrefix + this.threadNumber.getAndIncrement(), 0L);
            if (fxVar.isDaemon()) {
                fxVar.setDaemon(false);
            }
            if (fxVar.getPriority() != 10) {
    ...
    public static void logVersionInfo() {
        ...
        try {
            ...
            iz.fx("live init", "version_info: lib_version_name=2.1.1.4-tob-tob-61440787; sdkApiVersionName=2.1.1.4-tob-tob-61440787; pluginVersionCode=" + ((Long) pair.first).longValue() + "; pluginVersionName=" + ((String) pair.second));
        } catch (Throwable th) {
            iz.u(th);
        }
    }
