...
public class iz extends x<Integer> {
    public iz(List<com.bytedance.adsdk.lottie.iz.u<Integer>> list) {
        super(list);
    }
    ...
    public int fx(com.bytedance.adsdk.lottie.iz.u<Integer> uVar, float f) {
        ...
        return (fxVar == 0 || (num = (Integer) fxVar.u(uVar.iz, uVar.x.floatValue(), uVar.u, uVar.nr, f, b(), n())) == null) ? com.bytedance.adsdk.lottie.pn.n.u(uVar.n(), uVar.a(), f) : num.intValue();
    }
