    ...
    */
    ...
    public void init(@Nullable final EglBase.Context context, final int[] iArr, RendererCommon.GlDrawer glDrawer, boolean z) {
        synchronized (this.handlerLock) {
            ...
            ThreadUtils.invokeAtFrontUninterruptibly(handlerWithExceptionCallback, new Runnable() { // from class: uk1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f21233a.lambda$init$0(context, iArr);
                }
            });
    ...
    public void onFrame(RXVideoFrameInterface rXVideoFrameInterface) {
        ...
        synchronized (this.handlerLock) {
            ...
            synchronized (this.frameLock) {
                ...
                this.renderThreadHandler.post(new Runnable() { // from class: wk1
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f21737a.renderFrameOnRenderThread();
                    }
                });
            }
            if (z) {
    ...
    public void release() {
        ...
        synchronized (this.handlerLock) {
            ...
            this.renderThreadHandler.postAtFrontOfQueue(new Runnable() { // from class: qk1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f20269a.lambda$release$1(countDownLatch);
                }
            });
            final Looper looper = this.renderThreadHandler.getLooper();
            this.renderThreadHandler.post(new Runnable() { // from class: sk1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f20766a.lambda$release$2(looper);
                }
            });
    ...
    public void releaseEglSurface(final Runnable runnable) {
        ...
        synchronized (this.handlerLock) {
            ...
            if (handler == null) {
                ...
                this.renderThreadHandler.postAtFrontOfQueue(new Runnable() { // from class: cl1
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f2005a.lambda$releaseEglSurface$5(runnable);
                    }
                });
            }
        }
    ...
    public void removeFrameListener(final FrameListener frameListener) {
        ...
        synchronized (this.handlerLock) {
            ...
            postToRenderThread(new Runnable() { // from class: al1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f1250a.lambda$removeFrameListener$4(countDownLatch, frameListener);
                }
            });
            ThreadUtils.awaitUninterruptibly(countDownLatch);
        }
    ...
    public void clearImage(final float f, final float f2, final float f3, final float f4) {
        synchronized (this.handlerLock) {
            ...
            handler.postAtFrontOfQueue(new Runnable() { // from class: el1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f17311a.lambda$clearImage$6(f, f2, f3, f4);
                }
            });
        }
    }
    ...
    public void addFrameListener(final FrameListener frameListener, final float f, @Nullable final RendererCommon.GlDrawer glDrawer, final boolean z) {
        postToRenderThread(new Runnable() { // from class: yk1
            @Override // java.lang.Runnable
            public final void run() {
                this.f22213a.lambda$addFrameListener$3(glDrawer, frameListener, f, z);
            }
        });
    }
