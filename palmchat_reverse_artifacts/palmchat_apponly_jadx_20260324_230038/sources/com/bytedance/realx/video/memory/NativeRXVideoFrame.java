...
public class NativeRXVideoFrame implements RXVideoFrameInterface {
    ...
    RefObject refCounted = new RefObject(new Runnable() { // from class: tt3
        @Override // java.lang.Runnable
        public final void run() {
            this.f21065a.lambda$new$0();
        }
    });
    ...
    public int getRotatedHeight() {
        ...
        int height = andRetainVideoFrameMemory.getHeight();
        andRetainVideoFrameMemory.release();
        return getRotation().value() % EffectConstants.ROTATION_DEGREES_180 == 0 ? height : width;
    }
    ...
    public int getRotatedWidth() {
        ...
        int height = andRetainVideoFrameMemory.getHeight();
        andRetainVideoFrameMemory.release();
        return getRotation().value() % EffectConstants.ROTATION_DEGREES_180 == 0 ? width : height;
    }
