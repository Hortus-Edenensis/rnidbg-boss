...
public class JavaI420Buffer implements VideoFrame.I420Buffer {
    ...
    public static JavaI420Buffer allocate(int i, int i2) {
        ...
        return new JavaI420Buffer(i, i2, byteBufferSlice, i, byteBufferSlice2, i4, byteBufferNativeAllocateByteBuffer.slice(), i4, new Runnable() { // from class: yx2
    ...
    public static VideoFrame.Buffer cropAndScaleI420(final VideoFrame.I420Buffer i420Buffer, int i, int i2, int i3, int i4, int i5, int i6) {
        ...
        i420Buffer.retain();
        return wrap(i5, i6, dataY.slice(), i420Buffer.getStrideY(), dataU.slice(), i420Buffer.getStrideU(), dataV.slice(), i420Buffer.getStrideV(), new Runnable() { // from class: zx2
            @Override // java.lang.Runnable
            public final void run() {
                i420Buffer.release();
            }
    ...
    public static JavaI420Buffer allocate(int i, int i2, int i3, int i4) {
        ...
        return new JavaI420Buffer(i, i2, byteBufferSlice, i3, byteBufferSlice2, i5, byteBufferNativeAllocateByteBuffer.slice(), i5, new Runnable() { // from class: xx2
            @Override // java.lang.Runnable
            public final void run() {
                JniCommon.nativeFreeByteBuffer(byteBufferNativeAllocateByteBuffer);
            }
