...
public class VideoFrame implements RefCounted {
    ...
    public int getRotatedHeight() {
        return this.rotation % EffectConstants.ROTATION_DEGREES_180 == 0 ? this.buffer.getHeight() : this.buffer.getWidth();
    }

    public int getRotatedWidth() {
        return this.rotation % EffectConstants.ROTATION_DEGREES_180 == 0 ? this.buffer.getWidth() : this.buffer.getHeight();
    }
