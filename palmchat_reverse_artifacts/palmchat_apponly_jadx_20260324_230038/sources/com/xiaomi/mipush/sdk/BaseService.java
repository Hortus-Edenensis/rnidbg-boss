...
public abstract class BaseService extends Service {
    ...
    public static class a extends Handler {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private WeakReference<BaseService> f11346a;

        public a(WeakReference<BaseService> weakReference) {
            this.f11346a = weakReference;
        }
        ...
        public void handleMessage(Message message) {
            ...
            if (message.what != 1001 || (weakReference = this.f11346a) == null || (baseService = weakReference.get()) == null) {
                return;
            }
    ...
    public void onStart(Intent intent, int i) {
        ...
        if (this.f11345a == null) {
            this.f11345a = new a(new WeakReference(this));
        }
        this.f11345a.a();
    }
