...
public enum gk {
    ...
    OnetrackSwitch(MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_CODEC_ID),
    NotificationGroupUpdateTimeSwitch(MediaPlayer.MEDIA_PLAYER_OPTION_VIDEO_CODEC_ID),
    KASwitch(MediaPlayer.MEDIA_PLAYER_OPTION_META_DATA_INFO),
    IntelligentHeartbeatForUnsupportWifiDigestBoolean(MediaPlayer.MEDIA_PLAYER_OPTION_SEEK_END_ENABLE),
