...
public class aw {
    ...
    private static final Map<Class<?>, Class<?>> f11428a;

    /* JADX INFO: compiled from: SearchBox */
    public static class a<T> {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public final Class<? extends T> f11429a;
    ...
    public static <T> T a(String str, String str2) {
        try {
            return (T) a((Class<? extends Object>) C1401r.a(null, str), (Object) null, str2);
        } catch (Exception e) {
    ...
    public static <T> T b(Object obj, String str, Object... objArr) {
        return (T) a(obj.getClass(), str, a(objArr)).invoke(obj, m181a(objArr));
    }
    ...
    public static <T> T a(String str, String str2, Object... objArr) {
        try {
            return (T) a(C1401r.a(null, str), str2, objArr);
        } catch (Exception e) {
    ...
    public static <T> T a(Class<?> cls, String str, Object... objArr) {
        return (T) a(cls, str, a(objArr)).invoke(null, m181a(objArr));
    }
    ...
    private static Object[] m181a(Object... objArr) {
        if (objArr == null || objArr.length <= 0) {
            return null;
        }
