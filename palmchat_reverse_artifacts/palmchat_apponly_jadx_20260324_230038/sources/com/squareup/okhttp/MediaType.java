...
public final class MediaType {
    ...
    public static MediaType parse(String str) {
        ...
        for (int iEnd = matcher.end(); iEnd < str.length(); iEnd = matcher2.end()) {
            ...
            if (strGroup3 != null && strGroup3.equalsIgnoreCase("charset")) {
                if (strGroup2 != null) {
                    throw new IllegalArgumentException("Multiple charsets: " + str);
                }
                strGroup2 = matcher2.group(2) != null ? matcher2.group(2) : matcher2.group(3);
            }
        }
        return new MediaType(str, lowerCase, lowerCase2, strGroup2);
    }
