...
final class f implements com.kwad.library.solder.lib.a.f {
    ...
    private void a(com.kwad.library.solder.lib.a.e eVar, File file) throws PluginError.UpdateError {
        ...
        Log.d("PluginUpdaterImpl", "start download pluginId: " + eVar.BH());
        f.a aVar = this.auQ;
        if (aVar != null) {
            aVar.a(eVar, file);
            Log.i("PluginUpdaterImpl", "finish download pluginId: " + eVar.BH() + " cost:" + (System.currentTimeMillis() - jCurrentTimeMillis));
            return;
        }
