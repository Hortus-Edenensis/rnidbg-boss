...
public abstract class j extends DialogFragment {
    ...
    public final View onCreateView(LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, Bundle bundle) {
        LayoutInflater layoutInflaterEB = com.kwad.sdk.o.m.eB(com.kwad.sdk.o.m.wrapContextIfNeed(layoutInflater.getContext()));
        if (getDialog() != null) {
            getDialog().requestWindowFeature(1);
        }
        return a(layoutInflaterEB, viewGroup);
    }

    @Override // android.app.DialogFragment, android.app.Fragment
    @NonNull
    public LayoutInflater onGetLayoutInflater(@Nullable Bundle bundle) {
        return com.kwad.sdk.o.m.eB(com.kwad.sdk.o.m.wrapContextIfNeed(super.onGetLayoutInflater(bundle).getContext()));
    }
