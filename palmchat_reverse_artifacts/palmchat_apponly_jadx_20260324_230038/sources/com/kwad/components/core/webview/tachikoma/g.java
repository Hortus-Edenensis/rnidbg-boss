...
public final class g {
    ...
    public void aM(Context context) {
        ...
        SdkConfigData sdkConfigDataHl = com.kwad.sdk.core.config.e.Hl();
        if (context == null || (jSONObjectOptJSONObject = sdkConfigDataHl.toJson().optJSONObject("appConfig")) == null || (jSONArrayOptJSONArray = jSONObjectOptJSONObject.optJSONArray("tkServiceConfigs")) == null) {
            return;
        }
    ...
    public final void b(Context context, String str, b bVar) {
        ...
        JSONObject jSONObjectOptJSONObject = sdkConfigDataHl.toJson().optJSONObject("styleTemplatesConfig");
