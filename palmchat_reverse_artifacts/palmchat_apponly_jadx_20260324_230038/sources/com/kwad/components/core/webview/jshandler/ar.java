...
public final class ar implements com.kwad.sdk.core.webview.c.a {
    ...
    public final void a(String str, @NonNull com.kwad.sdk.core.webview.c.c cVar) {
        ...
        try {
            ...
            if (com.kwad.components.core.e.d.f.a(this.mContext, cVar2.bd(com.kwad.sdk.core.response.b.a.m64do(com.kwad.sdk.core.response.b.e.er(adTemplateA))), JumpFrom.H5, adTemplateA) == 1) {
                cVar.a(null);
            } else {
                cVar.onError(-1, "跳转失败");
            }
