...
public final class a {
    ...
    public void bc(String str) {
        try {
            ...
            c0562a.parseJson(new JSONObject(str));
            if (q(c0562a.url, c0562a.packageName)) {
                return;
            }
            if (this.PB == null) {
                p(c0562a.url, c0562a.packageName);
            }
            a.C0539a c0539aAv = new a.C0539a(this.eQ.UA.getContext()).as(true).at(false).aE(this.mAdTemplate).av(false);
            if (this.PB.w(c0539aAv)) {
                return;
            }
            this.PB.d(this.afQ);
            this.PB.v(c0539aAv);
