...
public class z implements com.kwad.sdk.core.webview.c.a {
    ...
    @Nullable
    public final com.kwad.components.core.e.d.d Q(long j) {
    ...
    public final void a(String str, @NonNull com.kwad.sdk.core.webview.c.c cVar) {
        ...
        if (this.ags.MD() && aVar.adTemplate == null) {
            cVar.onError(-1, "native adTemplate is null");
            return;
        }
        if (this.ags.aRN && !aVar.aSO) {
                ...
                public final void doTask() {
                    ...
                    if (bVar.aRO) {
                        ...
                        if (adTemplate != null) {
                            ...
                            List<AdTemplate> listMC = bVar.MC();
                            com.kwad.sdk.core.webview.d.b.a aVar3 = aVar;
                            adTemplate = com.kwad.sdk.core.response.b.e.a(listMC, aVar3.creativeId, aVar3.adStyle);
                        } else {
                        ...
                        z.this.Y(com.kwad.components.core.e.d.a.a(z.this.a(new a.C0539a(z.this.ags.Vs.getContext()).aE(adTemplate).b(dVarQ).ao(strY).as(z.a(z.this, aVar)).at(z.this.agF).d(z.this.ags.mReportExtData).aD(aVar.ahJ).aB(aVar.aSN).aC(aVar.mH).au(z.this.agG || aVar.PG).aH(z.this.agE).ap(z.this.agJ).aw(z.this.agH).aA(true).a(new a.b() { // from class: com.kwad.components.core.webview.jshandler.z.1.1
    ...
    public a.C0539a a(a.C0539a c0539a, com.kwad.sdk.core.webview.d.b.a aVar, AdTemplate adTemplate) {
        ...
        if (dVar2 != null && !TextUtils.isEmpty(dVar2.PI)) {
            c0539a.ap(aVar.ahK.PI);
        }
        com.kwad.sdk.core.webview.d.b.d dVar3 = aVar.ahK;
        if (dVar3 != null && (i = dVar3.convertType) != 0) {
            c0539a.aF(i);
        }
        if (com.kwad.sdk.core.response.b.e.eK(adTemplate) && (dVar = aVar.ahK) != null && dVar.aSQ != null) {
            aj.a aVar2 = new aj.a();
            com.kwad.sdk.core.webview.d.b.c cVar = aVar.ahK.aSQ;
            aVar2.g((float) cVar.x, (float) cVar.y);
            com.kwad.sdk.core.webview.d.b.c cVar2 = aVar.ahK.aSQ;
            aVar2.f((float) cVar2.x, (float) cVar2.y);
            com.kwad.sdk.core.webview.d.b.c cVar3 = aVar.ahK.aSQ;
            aVar2.C(cVar3.width, cVar3.height);
            c0539a.d(aVar2);
        } else {
            com.kwad.sdk.widget.g gVar = this.ags.aRL;
            if (gVar != null) {
                c0539a.d(gVar.getTouchCoords());
            }
        }
        c0539a.a(null, null, null);
        return c0539a;
    }
