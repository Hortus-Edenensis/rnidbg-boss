...
public final class a implements m {
            ...
            bw.runOnUiThread(new bg() { // from class: com.kwad.components.core.webview.tachikoma.a.a.1
                ...
                public final void doTask() {
                    ...
                    if (bVar.aRO) {
                        ...
                        com.kwad.components.core.e.d.a.a(a.this.a(new a.C0539a(a.this.ags.Vs.getContext()).aE(adTemplate).b(dVarQ).ao(strY).as(a.a(a.this, aVar)).at(a.this.agF).d(a.this.ags.mReportExtData).aD(aVar.ahJ).aB(aVar.aSN).aC(aVar.mH).au(a.this.agG || aVar.PG).aH(a.this.agE).ap(a.this.agJ).aw(a.this.agH).aA(true).a(new a.b() { // from class: com.kwad.components.core.webview.tachikoma.a.a.1.1
    ...
    public final a.C0539a a(a.C0539a c0539a, com.kwad.sdk.core.webview.d.b.a aVar, AdTemplate adTemplate) {
