...
public class am implements com.kwad.sdk.core.webview.c.a {
    ...
    public static final class b extends com.kwad.sdk.core.report.a {
        ...
        public final void parseJson(@Nullable JSONObject jSONObject) {
            ...
            this.PI = jSONObject.optString(AssistPushConsts.MSG_TYPE_PAYLOAD);
        ...
        public final JSONObject toJson() {
            ...
            com.kwad.sdk.utils.aa.putValue(jSONObject, VideoActivity.EXTRA_KEY_ACTION_TYPE, this.actionType);
            com.kwad.sdk.utils.aa.putValue(jSONObject, AssistPushConsts.MSG_TYPE_PAYLOAD, this.PI);
    ...
    public void a(@NonNull b bVar) {
        ...
        if (bVar.actionType == 1) {
            ...
            if (this.ags.MC() != null) {
                for (AdTemplate adTemplate : this.ags.MC()) {
