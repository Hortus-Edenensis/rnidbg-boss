    ...
    */
    public final boolean shouldInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (viewFindTopChildUnder2 == this.Zz && this.Zk == 2) {
                l(viewFindTopChildUnder2, pointerId);
            }
            int i = this.Zq[pointerId];
            ...
            if (actionMasked != 3) {
                if (actionMasked == 5) {
                    ...
                    a(x2, y2, pointerId2);
                    int i2 = this.Zk;
                    if (i2 != 0 && i2 == 2 && (viewFindTopChildUnder = findTopChildUnder((int) x2, (int) y2)) == this.Zz) {
                        l(viewFindTopChildUnder, pointerId2);
                    }
                } else if (actionMasked == 6) {
                    bf(MotionEventCompat.getPointerId(motionEvent, actionIndex));
                }
            }
        } else if (this.Zm != null && this.Zn != null) {
            int pointerCount = MotionEventCompat.getPointerCount(motionEvent);
            for (int i3 = 0; i3 < pointerCount; i3++) {
                ...
                if (bi(pointerId3)) {
                    ...
                    float f = x3 - this.Zm[pointerId3];
                    float f2 = y3 - this.Zn[pointerId3];
                    ...
                    if (z) {
                        ...
                        this.Zi.D(viewFindTopChildUnder3);
                        int top = viewFindTopChildUnder3.getTop();
                        int iBc = this.Zi.bc(((int) f2) + top);
                        int iTh = this.Zi.th();
                        if (iTh == 0 || (iTh > 0 && iBc == top)) {
                            break;
                        }
                        b(f, f2, pointerId3);
                        if (this.Zk == 1 || (z && l(viewFindTopChildUnder3, pointerId3))) {
                            break;
                        }
                    }
                }
    ...
    private boolean a(View view, float f, float f2) {
        ...
        return (this.Zi.th() > 0) && Math.abs(f2) > ((float) this.Zl);
    }
