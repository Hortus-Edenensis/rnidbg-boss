...
public class DownloadLandPageActivity extends com.kwad.components.core.m.b<com.kwad.components.core.page.d.e> {
    ...
    public static void launch(@NonNull Context context, @NonNull AdTemplate adTemplate, boolean z) {
        Class cls = aq.SM() ? AdWebViewActivity.class : KsFullScreenLandScapeVideoActivity.class;
        ...
        if (com.kwad.sdk.core.response.b.a.aG(adInfo)) {
            ...
            downloadProgressBar.setOnClickListener(new View.OnClickListener() { // from class: com.kwad.components.core.page.DownloadLandPageActivity.5
                ...
                public final void onClick(View view) {
                    ...
                    DownloadLandPageActivity.this.mApkDownloadHelper.v(new a.C0539a(DownloadLandPageActivity.this.getActivity()).as(true).at(false).aE(DownloadLandPageActivity.this.mAdTemplate).av(false));
    ...
    public int getLayoutId() {
        return aq.SM() ? R.layout.ksad_activity_ad_land_page : R.layout.ksad_activity_land_page_horizontal;
    }
    ...
    public void initView() {
        ...
        detailVideoView.g(true, com.kwad.sdk.core.config.e.HR());
