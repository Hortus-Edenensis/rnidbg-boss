...
public final class a {
    ...
    private void c(@NonNull KsAdVideoPlayConfig ksAdVideoPlayConfig) {
        ...
        if (aVarEV == null) {
            ...
            this.cq.a(new b.a(adTemplate).a(adTemplate.mVideoPlayerStatus).dt(com.kwad.sdk.core.response.b.e.et(adTemplate)).du(h.b(com.kwad.sdk.core.response.b.e.es(adTemplate))).b(new com.kwad.sdk.contentalliance.a.a.a(adTemplate, System.currentTimeMillis())).Ga(), null);
            a.InterfaceC0618a interfaceC0618a = new a.InterfaceC0618a() { // from class: com.kwad.components.core.page.splitLandingPage.view.a.3
