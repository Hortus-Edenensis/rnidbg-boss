...
public final class b extends Presenter {
    ...
    public final void as() {
        super.as();
        final com.kwad.components.core.page.recycle.e eVar = (com.kwad.components.core.page.recycle.e) PC();
            ...
            public final void onClick(View view) {
                try {
                    if (com.kwad.sdk.core.response.b.a.aG(adInfoEr)) {
                        if (eVar.PB != null) {
                            com.kwad.components.core.e.d.a.a(new a.C0539a(b.this.getActivity()).as(false).at(false).ax(true).aE(eVar.adTemplate).av(false));
