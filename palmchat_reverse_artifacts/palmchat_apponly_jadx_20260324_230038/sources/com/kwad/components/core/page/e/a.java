...
public final class a implements com.kwad.components.core.m.a.a {
    ...
    private void br() {
        this.Mp.a(new b.a(this.mAdTemplate).dt(this.BE).du(h.b(e.es(this.mAdTemplate))).a(this.mVideoPlayerStatus).b(com.kwad.sdk.contentalliance.a.a.a.bT(this.mAdTemplate)).Ga(), this.mDetailVideoView);
