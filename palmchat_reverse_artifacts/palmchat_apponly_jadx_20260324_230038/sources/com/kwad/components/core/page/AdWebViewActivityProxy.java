...
public class AdWebViewActivityProxy extends com.kwad.components.core.proxy.f {
    ...
    private com.kwad.components.core.page.a.b mLandPageViewListener = new com.kwad.components.core.page.a.b() { // from class: com.kwad.components.core.page.AdWebViewActivityProxy.4
        ...
        public final void rM() {
            ...
            if (com.kwad.components.core.q.a.ua().uc() || !com.kwad.sdk.core.config.e.Hf()) {
                AdWebViewActivityProxy.this.finish();
                return;
            }
    ...
    public static class a {
        ...
        public static class C0552a {
            ...
            public final C0552a aG(AdTemplate adTemplate) {
                this.adTemplate = adTemplate;
                return this;
            }

            public final C0552a aH(String str) {
                this.UJ = str;
                return this;
            }

            public final C0552a aI(boolean z) {
                this.UT = z;
                return this;
            }

            public final C0552a aJ(boolean z) {
                this.UN = z;
                return this;
            }

            public final C0552a aK(boolean z) {
                this.UP = z;
                return this;
            }

            public final C0552a aQ(int i) {
                this.UO = i;
                return this;
            }

            public final C0552a b(k kVar) {
                this.US = kVar;
                return this;
            }

            public final C0552a q(AdResultData adResultData) {
            ...
            public final C0552a aI(String str) {
                this.UK = str;
                return this;
            }

            public final C0552a aJ(String str) {
                this.UQ = str;
                return this;
            }
        }
    ...
    private com.kwad.components.core.page.widget.a buildDialog() {
        return new com.kwad.components.core.page.widget.a(getActivity(), new a.InterfaceC0556a() { // from class: com.kwad.components.core.page.AdWebViewActivityProxy.7
            @Override // com.kwad.components.core.page.widget.a.InterfaceC0556a
    ...
    public boolean handleMiddlePageDialog() {
        boolean z = false;
        if (this.mAdTemplate == null || !com.kwad.sdk.core.config.e.Hf()) {
            return false;
        }
    ...
    private void initContentView() {
        ...
        boolean z = i == 2 || i == 3;
        a aVarRV = new a.C0552a().aH(this.mPageTitle).aI(this.mPageUrl).aJ(this.mH5AuthUrl).aG(this.mAdTemplate).aI(this.mShowPermission).aJ(this.mAutoShow).aQ(this.mLandingPageType).aK(this.mDisableShowConfirmDialog).rV();
        if (z) {
    ...
    public boolean isFormAdExitInterceptEnable() {
        ...
        if (com.kwad.sdk.core.config.e.Hn() && this.mAdTemplate.mIsFromContent) {
            return true;
        }
        return com.kwad.sdk.core.config.e.Ho() && !this.mAdTemplate.mIsFromContent;
    }
        ...
        if (isFormAdExitInterceptEnable()) {
            try {
                if (this.mKsExitInterceptDialogV2 == null) {
                    this.mKsExitInterceptDialogV2 = new com.kwad.components.core.page.widget.a(getActivity(), new a.InterfaceC0556a() { // from class: com.kwad.components.core.page.AdWebViewActivityProxy.6
                        @Override // com.kwad.components.core.page.widget.a.InterfaceC0556a
                        public final void a(DialogInterface dialogInterface) {
                            com.kwad.sdk.core.adlog.c.p(AdWebViewActivityProxy.this.mAdTemplate, 104);
                            dialogInterface.dismiss();
    ...
    public static void launch(Context context, AdTemplate adTemplate) {
        launch(context, new a.C0552a().aI(com.kwad.sdk.core.response.b.b.cR(adTemplate)).aG(adTemplate).rV());
    }
}
