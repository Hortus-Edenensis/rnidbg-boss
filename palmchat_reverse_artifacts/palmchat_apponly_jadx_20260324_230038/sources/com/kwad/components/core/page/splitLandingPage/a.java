...
public final class a extends h {
    ...
    private void initView() {
        ...
        this.WV = aVar;
        aVar.a(new a.InterfaceC0555a() { // from class: com.kwad.components.core.page.splitLandingPage.a.3
            @Override // com.kwad.components.core.page.splitLandingPage.view.a.InterfaceC0555a
        ...
        this.WT.setSplitScrollWebViewListener(new SplitScrollWebView.a() { // from class: com.kwad.components.core.page.splitLandingPage.a.5
            ...
            public final boolean sM() {
                if (!a.this.WV.sN() && com.kwad.sdk.core.config.e.GE() == 2) {
                    return false;
                }
                ...
                } else if (com.kwad.sdk.core.config.e.GE() == 1) {
                    animatorSet.playTogether(animatorA);
                }
                animatorSet.addListener(new AnimatorListenerAdapter() { // from class: com.kwad.components.core.page.splitLandingPage.a.5.1
                    ...
                    public final void onAnimationEnd(Animator animator) {
                        ...
                        a.this.UB.sK();
                        if (com.kwad.sdk.core.config.e.GE() != 2 || a.this.UB.isComplete()) {
                            return;
                        }
                        a.this.WV.sO();
                    }
    ...
    public boolean sI() {
        ...
        AnimatorSet animatorSet = new AnimatorSet();
        if (com.kwad.sdk.core.config.e.GE() == 2 && this.WV.isVisible()) {
            this.WV.sK();
