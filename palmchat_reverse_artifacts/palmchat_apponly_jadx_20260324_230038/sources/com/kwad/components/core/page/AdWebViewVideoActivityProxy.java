...
public class AdWebViewVideoActivityProxy extends i {
    ...
    private com.kwad.components.core.page.widget.a buildDialog() {
        return new com.kwad.components.core.page.widget.a(getActivity(), new a.InterfaceC0556a() { // from class: com.kwad.components.core.page.AdWebViewVideoActivityProxy.4
    ...
    public a.C0539a getAdClickConfig(boolean z) {
        return new a.C0539a(getActivity()).as(z).ax(true).at(false).aE(this.mAdTemplate).av(false);
    }
    ...
    private void initView() {
        ...
        aVar.a(new a.InterfaceC0528a() { // from class: com.kwad.components.core.page.AdWebViewVideoActivityProxy.3
            @Override // com.kwad.components.core.b.a.InterfaceC0528a
        ...
        if (com.kwad.sdk.core.config.e.GE() != 0) {
