...
public class FeedVideoView extends b<AdResultData, AdTemplate> implements NestedScrollingChild {
    ...
    public final void a(@NonNull KsAdVideoPlayConfig ksAdVideoPlayConfig, com.kwad.components.core.e.d.d dVar) {
        ...
        if (aVar == null) {
            ...
            if (com.kwad.sdk.core.config.e.GE() == 2) {
    ...
    private void a(com.kwad.components.core.video.a aVar, final com.kwad.sdk.core.video.videoview.a aVar2) {
        ...
        this.Xe.setAdClickListener(new a.InterfaceC0561a() { // from class: com.kwad.components.core.widget.FeedVideoView.10
            ...
            public final void a(int i, aj.a aVar3) {
                ...
                com.kwad.components.core.e.d.a.a(new a.C0539a(FeedVideoView.this.getContext()).aE(FeedVideoView.this.mAdTemplate).ax(true).b(FeedVideoView.this.mApkDownloadHelper).aD(i3).as(z).au(true).aC(i2).d(aVar3).a(new a.b() { // from class: com.kwad.components.core.widget.FeedVideoView.10.1
        ...
        this.amx.setOnSeekBarChangeListener(new ScaleAnimSeekBar.a() { // from class: com.kwad.components.core.widget.FeedVideoView.11
            ...
            public final void a(ScaleAnimSeekBar scaleAnimSeekBar, boolean z) {
                if (z) {
                    ...
                    FeedVideoView.this.ams.setText(bu.aq((int) ((aVar2.getDuration() * ((long) scaleAnimSeekBar.getProgress())) / ((long) scaleAnimSeekBar.getMaxProgress()))));
                }
            }
