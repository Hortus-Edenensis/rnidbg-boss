...
public class ComplianceTextView extends TextView {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        this.aml = typedArrayObtainStyledAttributes.getDimensionPixelOffset(R.styleable.ksad_ComplianceTextView_ksad_width_in_landscape, 154);
    ...
    private void b(String str, String str2, String str3, String str4, String str5, String str6, String str7) {
        ...
        if (!TextUtils.isEmpty(this.amj)) {
            ...
            spannableStringBuilder.setSpan(new ClickableSpan() { // from class: com.kwad.components.core.widget.ComplianceTextView.2
                ...
                public final void onClick(@NonNull View view) {
                    AdWebViewActivityProxy.launch(ComplianceTextView.this.getContext(), new AdWebViewActivityProxy.a.C0552a().aH("功能介绍").aI(ComplianceTextView.this.amj).aI(true).aG(ComplianceTextView.this.mAdTemplate).rV());
                }
        ...
        if (!TextUtils.isEmpty(this.ami)) {
            ...
            spannableStringBuilder.setSpan(new ClickableSpan() { // from class: com.kwad.components.core.widget.ComplianceTextView.3
                @Override // android.text.style.ClickableSpan
                public final void onClick(@NonNull View view) {
                    AdWebViewActivityProxy.launch(ComplianceTextView.this.getContext(), new AdWebViewActivityProxy.a.C0552a().aH("权限信息").aI(ComplianceTextView.this.ami).aI(true).aG(ComplianceTextView.this.mAdTemplate).rV());
                }
        ...
        if (!TextUtils.isEmpty(this.amk)) {
            ...
            spannableStringBuilder.setSpan(new ClickableSpan() { // from class: com.kwad.components.core.widget.ComplianceTextView.4
                @Override // android.text.style.ClickableSpan
                public final void onClick(@NonNull View view) {
                    AdWebViewActivityProxy.launch(ComplianceTextView.this.getContext(), new AdWebViewActivityProxy.a.C0552a().aH("隐私政策").aI(ComplianceTextView.this.amk).aI(true).aG(ComplianceTextView.this.mAdTemplate).rV());
                }
