...
public final class a extends e implements h {
    ...
    private void ao(Context context) {
        ...
        try {
            ...
            jSONObject.put("64", 0);
            if (com.kwad.sdk.core.config.e.a(com.kwad.sdk.core.config.c.aFW)) {
    ...
    public void qs() {
        ...
        if (TextUtils.isEmpty(strDf)) {
            ag.ad(this.mContext, strTK);
            return;
        }
        if (TextUtils.equals(strDf, strTK)) {
            return;
        }
        this.QB = "";
        this.QC = 0L;
    ...
    public final String qt() {
        return (com.kwad.sdk.core.config.e.Hh() || System.currentTimeMillis() >= qw() || TextUtils.isEmpty(qv())) ? qx() : "";
    }
