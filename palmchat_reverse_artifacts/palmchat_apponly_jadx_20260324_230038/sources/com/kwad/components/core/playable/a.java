...
public final class a implements p {
    ...
    /* JADX INFO: compiled from: SearchBox */
    public static class C0558a implements bj.b {
    ...
    public void bj(int i) {
        ...
        long jHD = e.HD();
        if (jHD <= 0 || SystemClock.elapsedRealtime() - this.ZH <= jHD) {
            com.kwad.components.core.e.d.a.a(new a.C0539a(this.mContext).aE(this.mAdTemplate).b(this.mApkDownloadHelper).as(false).aC(i).d(this.mRootContainer.getTouchCoords()).au(true));
        }
    }
    ...
    private KsAdWebView.e jv() {
        return new KsAdWebView.e() { // from class: com.kwad.components.core.playable.a.2
            ...
            public final void onPageFinished() {
                Iterator it = a.this.ZL.iterator();
                while (it.hasNext()) {
    ...
    private void a(b bVar, com.kwad.components.core.webview.a aVar, d dVar) {
        aVar.a(new bj(bVar, dVar, new C0558a(this)));
        aVar.a(new as(new as.b() { // from class: com.kwad.components.core.playable.a.3
            ...
            public final void a(as.a aVar2) {
                ...
                Iterator it = a.this.ZK.iterator();
                while (it.hasNext()) {
