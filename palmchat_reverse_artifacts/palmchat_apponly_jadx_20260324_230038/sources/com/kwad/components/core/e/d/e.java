...
public final class e {
    ...
    public static int F(a.C0539a c0539a) {
        Context context = c0539a.getContext();
        final AdTemplate adTemplate = c0539a.getAdTemplate();
        String strB = b(c0539a, adTemplate);
        if (TextUtils.isEmpty(strB)) {
            return 0;
        }
        final AdInfo adInfoEr = com.kwad.sdk.core.response.b.e.er(adTemplate);
        final String strA = a(strB, c0539a, adInfoEr);
    ...
    public static int a(final a.C0539a c0539a, int i) {
        Context context = c0539a.getContext();
        final AdTemplate adTemplate = c0539a.getAdTemplate();
        String strB = b(c0539a, adTemplate);
        if (TextUtils.isEmpty(strB)) {
        ...
        if (activityFromContext == null || !com.kwad.sdk.core.response.b.a.U(adInfoEr) || c0539a.pu()) {
            final String strA = a(strB, c0539a, adInfoEr);
            final int i2 = 1;
            return com.kwad.sdk.core.download.a.b.a(context, strA, new b.a() { // from class: com.kwad.components.core.e.d.e.1
                ...
                public final void onStart() {
                    ...
                    com.kwad.sdk.core.adlog.c.aBQ = e.aq(strA);
                    com.kwad.sdk.commercial.f.a.h(adTemplate, strA);
                }

                @Override // com.kwad.sdk.core.download.a.b.a
                public final void onSuccess() {
                    com.kwad.sdk.core.adlog.c.a aVarPF = c0539a.pF();
                    if (ql()) {
                        if (aVarPF.PJ == null) {
                            aVarPF.PJ = new a.C0601a();
                        }
                        aVarPF.PJ.aBC = true;
                    }
                    com.kwad.sdk.commercial.f.a.i(adTemplate, strA);
    ...
    public static void aC(boolean z) {
        com.kwad.sdk.core.adlog.c.aBR = z;
    }
    ...
    private static String b(a.C0539a c0539a, AdTemplate adTemplate) {
        ...
        for (AdInfo.AdConversionInfo.DeeplinkItemInfo deeplinkItemInfo : adInfoEr.adConversionInfo.deeplinkConf) {
            boolean zContains = deeplinkItemInfo.areaConf.contains(Integer.valueOf(c0539a.ea()));
            boolean zContains2 = deeplinkItemInfo.sceneConf.contains(Integer.valueOf(c0539a.py()));
    ...
    private static String a(String str, a.C0539a c0539a, AdInfo adInfo) {
        AdTemplate adTemplate = c0539a.getAdTemplate();
        if (com.kwad.sdk.core.response.b.a.bn(adInfo)) {
            str = b(c0539a, adInfo, str);
        }
        if (com.kwad.sdk.core.response.b.a.cS(adInfo)) {
            str = a(c0539a, adInfo, str);
        }
        return ((com.kwad.sdk.core.response.b.a.cK(adInfo) || com.kwad.sdk.core.response.b.a.cQ(adInfo)) && adTemplate.mAdScene != null) ? a(str, c0539a.getContext(), adTemplate.mAdScene) : str;
    }

    private static String b(a.C0539a c0539a, AdInfo adInfo, String str) {
        long jMax = c0539a.getAdTemplate().getmCurPlayTime();
        if (jMax > 0) {
    ...
    public static void a(final AdTemplate adTemplate, final String str, final int i) {
        ...
        aD(true);
        int iHd = com.kwad.sdk.core.config.e.Hd();
        com.kwad.sdk.core.config.e.He();
        int iAbs = Math.abs(iHd);
        if (iAbs > 0) {
    ...
    private static String a(a.C0539a c0539a, AdInfo adInfo, String str) {
        String strCall;
        String strValueOf;
        if (!com.kwad.sdk.core.response.b.a.bk(adInfo)) {
            return str;
        }
        Callable<String> callablePt = c0539a.pt();
        if (callablePt != null) {
            try {
