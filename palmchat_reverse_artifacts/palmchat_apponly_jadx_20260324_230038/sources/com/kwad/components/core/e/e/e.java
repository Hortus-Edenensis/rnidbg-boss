...
public final class e extends j {
    ...
    public static void a(Activity activity, a.C0539a c0539a) {
        if (activity == null || c0539a == null) {
            return;
        }
        e eVar = new e();
        eVar.Qt = c0539a;
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        g.qo().qp();
        a.C0539a c0539a = this.Qt;
        if (c0539a != null) {
            com.kwad.sdk.core.adlog.c.b(c0539a.getAdTemplate(), 229, (JSONObject) null);
        }
