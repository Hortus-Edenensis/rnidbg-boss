...
public final class d implements NetworkMonitor.a, com.kwad.sdk.core.download.c, com.kwad.sdk.core.webview.a {
    ...
    private int A(a.C0539a c0539a) {
        ...
        if (iE == 2) {
            return d(c0539a.getContext(), c0539a.getAdTemplate());
        }
        if (iE == 3) {
            return 1;
        }
    ...
    private boolean B(a.C0539a c0539a) {
        if (c0539a.pD() || this.mAdInfo.status == 4 || !com.kwad.sdk.core.response.b.b.dw(this.PW) || !C(c0539a)) {
            return false;
        }
        return com.kwad.components.core.e.c.b.a(c0539a.getContext(), new b.a().aD(this.PW).an(com.kwad.sdk.core.response.b.b.dv(this.PW)).a(this.PZ).c(this.mOnDismissListener).po());
    }

    private static boolean C(a.C0539a c0539a) {
        AdInfo adInfoEr = com.kwad.sdk.core.response.b.e.er(c0539a.getAdTemplate());
        if (com.kwad.sdk.core.response.b.a.bx(adInfoEr) && (DownloadLandPageActivity.showingAdWebViewLandPage || AdWebViewVideoActivityProxy.showingAdWebViewVideoActivity || c0539a.getAdTemplate().isWebViewDownload)) {
            return true;
        }
        return com.kwad.sdk.core.response.b.a.by(adInfoEr) && !ao.isWifiConnected(c0539a.getContext());
    }

    private int D(a.C0539a c0539a) {
        Activity activityFromContext = m.getActivityFromContext(c0539a.getContext());
        if (activityFromContext == null || !com.kwad.sdk.core.response.b.a.U(this.mAdInfo) || c0539a.pu() || c0539a.pz()) {
            return pZ();
        }
        c0539a.aA(1);
    ...
    public static int E(a.C0539a c0539a) {
        AdInfo adInfoEr = com.kwad.sdk.core.response.b.e.er(c0539a.getAdTemplate());
    ...
    private void pQ() {
        com.kwad.sdk.core.download.b.IL();
    ...
    private boolean pU() {
        if (Build.VERSION.SDK_INT < 29) {
            if (this.PW.mIsFromContent && com.kwad.sdk.core.config.e.GD()) {
                zQa = qa();
                if (zQa) {
                    com.kwad.sdk.core.adlog.c.bY(this.PW);
                }
            } else if (!this.PW.mIsFromContent && com.kwad.sdk.core.config.e.Hj()) {
    ...
    private boolean qa() {
        ...
        if (e.a(new a.C0539a(context).aE(this.PW), 1) == 1) {
            return true;
        }
    ...
    private boolean x(a.C0539a c0539a) {
        boolean zL = com.kwad.sdk.utils.e.l(c0539a.getContext(), this.PW);
        if (zL) {
    ...
    private int y(a.C0539a c0539a) {
        ...
        if (c0539a.pK() && com.kwad.sdk.core.config.e.GV()) {
            return z(c0539a);
        }
        if (com.kwad.sdk.core.response.b.e.eG(this.PW) && c0539a.pM() != 2) {
            return d(c0539a.getContext(), c0539a.getAdTemplate());
        }
        if (c0539a.pG()) {
            return A(c0539a);
    ...
    public final void b(String str, com.kwad.sdk.core.download.e eVar) {
        if (this.mAdInfo.downloadId.equals(str)) {
            if (this.mAdInfo.status != 4 && eVar.IP()) {
    ...
    public final void g(String str, com.kwad.sdk.core.download.e eVar) {
        if (this.mAdInfo.downloadId.equals(str) && eVar.IP()) {
            eVar.IO();
    ...
    public final void pP() {
        com.kwad.sdk.core.download.b.IL().a(this, this.PW);
        if (com.kwad.sdk.core.config.e.Hv()) {
    ...
    public final int u(a.C0539a c0539a) {
        int i = this.mAdInfo.status;
        if (i != 0 && i != 1) {
            switch (i) {
                case 4:
        ...
        return x(c0539a) ? 11 : 0;
    }

    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    public final int v(a.C0539a c0539a) {
        this.PX = false;
        pW();
        switch (this.mAdInfo.status) {
            ...
            case 2:
            case 3:
                if (c0539a.pB() && this.downloadPauseEnable) {
                    return qd();
                }
                return 0;
            case 4:
    ...
    public final boolean w(a.C0539a c0539a) {
        return this.mAdInfo.status == 0 && x(c0539a);
    }
    ...
    public final void c(String str, com.kwad.sdk.core.download.e eVar) {
        if (this.mAdInfo.downloadId.equals(str)) {
            WeakHashMap<String, Integer> weakHashMap = com.kwad.sdk.core.download.b.aHW;
            Integer num = weakHashMap.get(str);
            if (num != null && num.intValue() == 2) {
                this.PW.downLoadType = 2;
                weakHashMap.remove(str);
            }
            if (this.mAdInfo.status != 2 && eVar.IP()) {
    ...
    public final void d(String str, com.kwad.sdk.core.download.e eVar) {
        if (this.mAdInfo.downloadId.equals(str)) {
            if (this.mAdInfo.status != 5 && eVar.IP()) {
    ...
    public final void a(String str, String str2, com.kwad.sdk.core.download.e eVar) {
        if (this.mAdInfo.downloadId.equals(str)) {
            ...
            if (eVar.IP()) {
                ...
                com.kwad.sdk.core.a.Gb().e(str, this.PW);
                ...
                ApkCacheManager.getInstance().Iy();
            }
        }
    }
