...
public final class a implements IAdInnerEcHostProvider {
    private static void a(Activity activity, String str) {
        ...
        if (str.contains("kwaishop-c-pay-result")) {
            PayResultActivityProxy.launch(activity, new AdWebViewActivityProxy.a.C0552a().aI(str).aQ(2).rV());
        } else {
            WebPageActivityProxy.launch(activity, new AdWebViewActivityProxy.a.C0552a().aI(str).aQ(2).rV());
        }
    }
    ...
    private static boolean h(Context context, String str) {
        ...
        if (!str.startsWith("kwaimerchant://openhalfweb")) {
            ...
            com.kwad.sdk.utils.e.c(null, context, com.kwad.sdk.core.config.e.Ij(), "com.smile.gifmaker");
            return true;
        }
    ...
    public final String getMac() {
        return bd.dC(ServiceProvider.getContext());
    }
    ...
    public final String getMerchantVersion() {
        return com.kwad.sdk.core.config.e.Im() ? BuildConfig.SDK_VER_NAME : "1.0.0";
    }

    @Override // com.kwad.components.offline.api.core.adInnerEc.IAdInnerEcHostProvider
    public final String getNetworkType() {
        return ao.m68do(ServiceProvider.getContext());
    }
