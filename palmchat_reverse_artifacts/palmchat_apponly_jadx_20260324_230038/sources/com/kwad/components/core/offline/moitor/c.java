...
public final class c {
    private static void a(d dVar, boolean z) {
        com.kwad.sdk.commercial.c.d(com.kwad.sdk.commercial.d.FH().cR(z ? ILoggerReporter.Category.ERROR_LOG : ILoggerReporter.Category.APM_LOG).i(z ? 1.0d : 0.01d).O("ad_sdk_offline_component_update", "load_status").z(dVar).a(com.kwai.adclient.kscommerciallogger.model.a.bjx));
    }
