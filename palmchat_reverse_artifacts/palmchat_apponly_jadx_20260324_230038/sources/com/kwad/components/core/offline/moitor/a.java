...
public final class a {
    ...
    private static void a(b bVar, boolean z) {
        com.kwad.sdk.commercial.c.d(com.kwad.sdk.commercial.d.FH().cR(z ? ILoggerReporter.Category.ERROR_LOG : ILoggerReporter.Category.APM_LOG).i(z ? 1.0d : 0.01d).O("ad_sdk_offline_component_monitor", "load_status").z(bVar).a(com.kwai.adclient.kscommerciallogger.model.a.bjx));
    }
