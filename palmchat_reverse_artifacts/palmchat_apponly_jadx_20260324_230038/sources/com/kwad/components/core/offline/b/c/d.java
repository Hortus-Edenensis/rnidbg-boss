...
public final class d {
    public static com.kwad.sdk.contentalliance.a.a.b a(PlayVideoInfo playVideoInfo) {
        ...
        return new b.a(playVideoInfo.videoUrl).du(playVideoInfo.manifest).b(a(playVideoInfo.ksplayerLogParams)).a(playVideoInfo.videoPlayerStatus).bs(playVideoInfo.isNoCache).Ga();
    }
    ...
    public static c.InterfaceC0617c a(final IMediaPlayer iMediaPlayer, final IMediaPlayer.OnErrorListener onErrorListener) {
        if (onErrorListener == null) {
            return null;
        }
        return new c.InterfaceC0617c() { // from class: com.kwad.components.core.offline.b.c.d.8
