...
public final class k implements IOfflineHostApi {
    ...
    public final void adLiveErrorReport(int i, String str, String str2, Long l, int i2, String str3) {
        ...
        com.kwad.sdk.commercial.c.d(com.kwad.sdk.commercial.d.FH().cR(ILoggerReporter.Category.ERROR_LOG).i(1.0d).O("ad_sdk_live_video_error_monitor", "status").b(BusinessType.OTHER).z(new AdLivePlayMonitorInfo().setScene(i).setAppId(str).setAuthorId(str2).setUserId(l).setErrorCode(i2).setErrorMsg(str3)).a(com.kwai.adclient.kscommerciallogger.model.b.bjS));
    }
    ...
    public final String getWaynePlayerPlayConfig() {
        return com.kwad.sdk.core.config.e.If();
    }
