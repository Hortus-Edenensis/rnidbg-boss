...
public class a extends com.kwad.sdk.core.video.videoview.b implements View.OnClickListener {
    ...
    public a(Context context, @NonNull AdTemplate adTemplate, @NonNull com.kwad.sdk.core.video.videoview.c cVar) {
        ...
        this.adB = new com.kwad.sdk.core.download.a.a() { // from class: com.kwad.components.core.video.a.1
            ...
            public final void onPaused(int i) {
                a.this.adw.setText(com.kwad.sdk.core.response.b.a.KI());
            }
    ...
    private void bs(int i) {
        try {
            InterfaceC0561a interfaceC0561a = this.ady;
            if (interfaceC0561a != null) {
                interfaceC0561a.a(i, this.ado.getTouchCoords());
            }
        } catch (Throwable th) {
    ...
    private void init() {
        ...
        this.adz = com.kwad.components.core.video.a.d.a(this.mAdTemplate, this.aPx.getMediaPlayerType(), false);
        uR();
    }
    ...
    public void ac() {
        if (!this.aPx.isIdle()) {
            if (this.aPx.isPaused() || this.aPx.LW()) {
                uW();
                this.aPx.restart();
                return;
            }
    ...
    public void setAdClickListener(InterfaceC0561a interfaceC0561a) {
        this.ady = interfaceC0561a;
    }
    ...
    public final void uW() {
        this.aPx.setKsPlayLogParam(com.kwad.sdk.contentalliance.a.a.a.bT(this.mAdTemplate));
    }
    ...
    public final void uY() {
        long currentPosition = this.aPx.getCurrentPosition();
        long duration = this.aPx.getDuration();
        this.pT.setSecondaryProgress(this.aPx.getBufferPercentage());
