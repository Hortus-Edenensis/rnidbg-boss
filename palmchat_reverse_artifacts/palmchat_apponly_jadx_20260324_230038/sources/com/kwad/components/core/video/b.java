...
public final class b {
    ...
    public void uY() {
        ...
        if (this.adS != null) {
            Iterator<l> it = this.adS.iterator();
            while (it.hasNext()) {
    ...
    private boolean vg() {
        if (this.adP && ((Boolean) com.kwad.sdk.core.config.e.b(com.kwad.sdk.core.config.c.aGw)).booleanValue()) {
            return true;
        }
        return ((Boolean) com.kwad.sdk.core.config.e.b(com.kwad.sdk.core.config.c.aGw)).booleanValue() && ((Boolean) com.kwad.sdk.core.config.e.b(com.kwad.sdk.core.config.c.aGx)).booleanValue();
    }
    ...
    private b(@Nullable DetailVideoView detailVideoView, int i) {
        ...
        this.adW = new c.e() { // from class: com.kwad.components.core.video.b.4
            ...
            public final void a(com.kwad.sdk.core.video.a.c cVar) {
                try {
                    ...
                    b bVar = b.this;
                    bVar.onPlayStateChanged(bVar.adF);
                    Iterator it = b.this.adU.iterator();
                    while (it.hasNext()) {
                        ((c.e) it.next()).a(b.this.adG);
                    }
                } catch (Throwable th) {
                    ServiceProvider.reportSdkCaughtException(th);
                }
        ...
        this.adZ = new c.InterfaceC0617c() { // from class: com.kwad.components.core.video.b.7
    ...
    public final void a(@NonNull com.kwad.sdk.contentalliance.a.a.b bVar, boolean z, boolean z2, @NonNull DetailVideoView detailVideoView) {
        ...
        if (cVarA == null) {
            cVarA = com.kwad.sdk.core.video.a.e.a(this.mContext, z, com.kwad.sdk.core.config.e.CR(), com.kwad.sdk.core.config.e.CS(), this.adQ);
        }
        if (cVarA != null) {
            try {
                DetailVideoView detailVideoView2 = this.mDetailVideoView;
                if (detailVideoView2 != null) {
                    detailVideoView2.bu(cVarA.getMediaPlayerType());
                }
    ...
    public final void a(com.kwad.sdk.core.video.a.c cVar, int i, int i2) {
        Iterator<c.d> it = this.adM.iterator();
        while (it.hasNext()) {
            c.d next = it.next();
            if (next == null) {
                it.remove();
