...
public final class a {
            ...
            if (!OC.get() && !OB) {
                ...
                h.execute(new bg() { // from class: com.kwad.components.core.d.a.2
                    ...
                    public final void doTask() {
                        if (e.b(com.kwad.sdk.core.config.c.aDi)) {
    ...
    private static boolean oK() {
        return e.b(com.kwad.sdk.core.config.c.aDj);
    }
    ...
    public static void oL() {
        ...
        Iterator<Throwable> it = OD.iterator();
        while (it.hasNext()) {
    ...
    public static com.kwad.sdk.crash.c oN() {
        ...
        return aVarFG.el(BuildConfig.VERSION_CODE).fH(ExceptionMessage.getSdkCrashVersionName(l.DP().getApiVersion(), 1)).em(l.DP().getApiVersionCode()).en(1).fF("com.kwad.sdk").fI(context.getPackageName()).fJ(ServiceProvider.getSDKConfig().appId).fK(ServiceProvider.getSDKConfig().appName).fL(m.cN(context)).fM(bVarAj.aUk).fN(bVarAj.aUl).fC(bd.getDeviceId()).fD(ServiceProvider.getSDKConfig().appId).fB(bVarAj.version).fO(bVarAj.aUn).fP(bVarAj.aUm).fA(AnalyticsConstants.SDK_TYPE).fE(strAn).a(new com.kwad.sdk.crash.h() { // from class: com.kwad.components.core.d.a.5
            ...
            public final void a(int i, ExceptionMessage exceptionMessage) {
                ...
                Iterator it = a.OG.iterator();
                while (it.hasNext()) {
                    ((c) it.next()).onCrashOccur(i, exceptionMessage.mCrashDetail);
                }
            }
        }).d(oO()).e(oP()).H(e.GN()).m(e.a(com.kwad.sdk.core.config.c.aFP)).Ni();
    }
