...
public class e {
    ...
    public final boolean qI() {
        ...
        return (!ag.Sf() || qJ()) && this.expire > 0 && !TextUtils.isEmpty(this.serviceToken) && !TextUtils.isEmpty(this.sid) && this.userId > 0 && System.currentTimeMillis() < this.expire;
    }
    ...
    public static void a(Context context, AdTemplate adTemplate, k kVar) {
        ...
        if (atomicBoolean.get()) {
            String strIk = com.kwad.sdk.core.config.e.Ik();
            if (TextUtils.isEmpty(strIk)) {
                kVar.oB();
            } else {
                AdWebViewActivityProxy.launch(context, new AdWebViewActivityProxy.a.C0552a().aI(com.kwad.sdk.core.response.b.b.cR(adTemplate)).aJ(strIk).aG(adTemplate).aQ(3).b(kVar).rV());
            }
        }
    }
