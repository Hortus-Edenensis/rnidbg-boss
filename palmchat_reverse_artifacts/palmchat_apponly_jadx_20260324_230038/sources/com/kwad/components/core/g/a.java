...
public final class a {
    ...
    public static void a(final BusinessType businessType) {
        GlobalThreadPools.Lq().execute(new Runnable() { // from class: com.kwad.components.core.g.a.1
            ...
            public final void run() {
                try {
                    ...
                    JSONObject jSONObject = new JSONObject(strIg);
                    ...
                    if (zOptBoolean2 && a.QG.incrementAndGet() <= a.QF) {
                        c.d(d.FH().cR(ILoggerReporter.Category.APM_LOG).i(1.0d).b(businessType).O("ad_sdk_feature_info_collect", "default_type").i(b.qy().aH(zOptBoolean).aJ(a.QF).toJson()));
                    }
                } catch (Throwable th) {
