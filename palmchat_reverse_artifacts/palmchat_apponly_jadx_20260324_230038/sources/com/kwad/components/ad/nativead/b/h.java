...
public final class h extends com.kwad.components.ad.nativead.a.a implements View.OnClickListener, View.OnTouchListener {
    ...
    private void fD() {
        com.kwad.components.core.e.d.a.a(new a.C0539a(getContext()).aE(this.pp.mAdTemplate).b(this.pp.mApkDownloadHelper).A(this.pp.pq.getPlayDuration()).a(new a.b() { // from class: com.kwad.components.ad.nativead.b.h.3
    ...
    private void fG() {
        com.kwad.components.core.e.d.a.a(new a.C0539a(getContext()).aE(this.pp.mAdTemplate).aD(2).a(new a.b() { // from class: com.kwad.components.ad.nativead.b.h.2
            @Override // com.kwad.components.core.e.d.a.b
            public final void onAdClicked() {
