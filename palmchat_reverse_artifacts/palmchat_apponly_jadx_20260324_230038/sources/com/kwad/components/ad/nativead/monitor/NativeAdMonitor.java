...
public final class NativeAdMonitor {
    ...
    private static void c(a aVar) {
        try {
            c.d(d.FH().cR(ILoggerReporter.Category.APM_LOG).i(0.01d).O("ad_sdk_native_container_monitor", LocationConst.HDYawConst.KEY_HD_YAW_STATE).b(BusinessType.AD_NATIVE).z(aVar).a(com.kwai.adclient.kscommerciallogger.model.a.bjx));
        } catch (Exception e) {
