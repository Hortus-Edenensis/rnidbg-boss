...
public final class a extends b {
    ...
    private void br() {
        this.Mp.a(new b.a(this.mAdTemplate).dt(e.et(this.mAdTemplate)).du(h.b(e.es(this.mAdTemplate))).a(this.mAdTemplate.mVideoPlayerStatus).bs(this.hasNoCache).b(com.kwad.sdk.contentalliance.a.a.a.bT(this.mAdTemplate)).Ga(), true, true, this.mDetailVideoView);
