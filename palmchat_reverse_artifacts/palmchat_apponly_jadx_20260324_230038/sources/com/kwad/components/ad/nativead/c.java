...
public final class c {
    public static void loadNativeAd(KsScene ksScene, @NonNull final KsLoadManager.NativeAdListener nativeAdListener) {
        ...
        KsAdLoadManager.M().a(new a.C0560a().e(new ImpInfo(sceneImplCovert)).aQ(zB).a(new com.kwad.components.core.request.d() { // from class: com.kwad.components.ad.nativead.c.1
        ...
        try {
            ...
            if (adResultData.isAdResultDataEmpty()) {
                bw.runOnUiThread(new bg() { // from class: com.kwad.components.ad.nativead.c.4
                    @Override // com.kwad.sdk.utils.bg
                    public final void doTask() {
                        nativeAdListener.onError(com.kwad.sdk.core.network.e.aJc.errorCode, TextUtils.isEmpty(adResultData.testErrorMsg) ? com.kwad.sdk.core.network.e.aJc.msg : adResultData.testErrorMsg);
                    }
                });
                return;
            }
