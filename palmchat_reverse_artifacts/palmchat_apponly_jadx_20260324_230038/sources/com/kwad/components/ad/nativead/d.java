...
public final class d extends AbstractKsNativeAd implements DialogInterface.OnDismissListener, DialogInterface.OnShowListener, com.kwad.components.core.internal.api.a {
    ...
    private a oV = new a() { // from class: com.kwad.components.ad.nativead.d.2
        ...
        public final void m(View view) {
            if (d.this.oM != null) {
                d.this.oM.onAdClicked(new FrameLayout(m.ew(view.getContext())), d.this);
            }
        }
    ...
    @Nullable
    /* JADX INFO: renamed from: fp, reason: merged with bridge method [inline-methods] */
    ...
    public final KsLiveInfo getLiveInfo() {
        if (com.kwad.sdk.core.config.e.a(com.kwad.sdk.core.config.c.aGb)) {
    ...
    public final Map<String, Object> getMediaExtraInfo() {
        ...
        if (com.kwad.sdk.core.config.e.Hi()) {
    ...
    private static boolean c(aj.a aVar) {
        return (Math.abs(aVar.SE() - aVar.SG()) < 20) && (Math.abs(aVar.SF() - aVar.SH()) < 20);
    }
        ...
        if (com.kwad.sdk.core.response.b.a.aj(this.mAdInfo) || com.kwad.sdk.core.response.b.b.dd(this.mAdTemplate)) {
            ...
            this.oG = new b.e() { // from class: com.kwad.components.ad.nativead.d.8
                ...
                public final void f(final double d) {
                    if (d.this.fr() && b.bX()) {
                        com.kwad.components.core.e.d.a.a(new a.C0539a(m.wrapContextIfNeed(view.getContext())).aE(d.this.mAdTemplate).b(d.this.mApkDownloadHelper).az(false).a(new a.b() { // from class: com.kwad.components.ad.nativead.d.8.1
    ...
    public void l(final View view) {
        ...
        this.oF = new b.c() { // from class: com.kwad.components.ad.nativead.d.9
            ...
            public final void B(final String str) {
                if (bz.q(view, (int) (com.kwad.sdk.core.config.e.Hw() * 100.0f)) && d.this.fr() && b.bX()) {
                    com.kwad.components.core.e.d.a.a(new a.C0539a(m.wrapContextIfNeed(view.getContext())).aE(d.this.mAdTemplate).b(d.this.mApkDownloadHelper).az(false).a(new a.b() { // from class: com.kwad.components.ad.nativead.d.9.1
                        @Override // com.kwad.components.core.e.d.a.b
                        public final void onAdClicked() {
    ...
    public static /* synthetic */ boolean b(d dVar, aj.a aVar) {
        return c(aVar);
    }
    ...
    private void b(final ViewGroup viewGroup) {
        ...
        if (!com.kwad.sdk.core.config.e.Hz() && com.kwad.sdk.core.config.e.Hy() >= 0.0f) {
            d(viewGroup);
            com.kwad.components.core.widget.a aVar = new com.kwad.components.core.widget.a(viewGroup.getContext(), viewGroup);
            viewGroup.addView(aVar);
            NativeAdMonitor.a(viewGroup, 2);
            aVar.setViewCallback(new a.InterfaceC0573a() { // from class: com.kwad.components.ad.nativead.d.6
                ...
                public final void ab() {
                    try {
                        long jUf = d.this.getTimerHelper().Uf();
                        if (d.this.mAdTemplate.mPvReported && d.this.oQ) {
                            com.kwad.sdk.core.adlog.c.a(d.this.mAdTemplate, jUf, (JSONObject) null);
                            d.this.oQ = false;
                        }
                        if (com.kwad.sdk.core.response.b.a.cT(d.this.mAdInfo)) {
                            com.kwad.sdk.core.adlog.c.m(d.this.mAdTemplate, ((int) jUf) / 1000);
                        }
                        d.this.bz.i(d.this);
                        b.fn().a(d.this.oG);
                        b.fn().a(d.this.oF);
                ...
                public final void ax() {
                    try {
                        if (d.this.mAdTemplate.mPvReported && d.this.oQ) {
                            com.kwad.sdk.core.adlog.c.a(d.this.mAdTemplate, d.this.getTimerHelper().Uf(), (JSONObject) null);
                            d.this.oQ = false;
                            b.fn().a(d.this.oG);
                            b.fn().a(d.this.oF);
                ...
                public final void c(View view) {
                    if (!d.this.mAdTemplate.mPvReported) {
                        ...
                        if (com.kwad.sdk.core.response.b.a.cS(d.this.mAdInfo)) {
                            ...
                            c0601a.showLiveStyle = d.this.oS;
                            c0601a.showLiveStatus = d.this.oR;
                            bVar.b(c0601a);
                        }
            ...
            view.setOnTouchListener(new View.OnTouchListener() { // from class: com.kwad.components.ad.nativead.d.3
                ...
                public final boolean onTouch(View view2, MotionEvent motionEvent) {
                    ...
                    if (action == 0) {
                        ...
                        if (iArrS[1] != 1 && com.kwad.sdk.core.config.e.GG()) {
                            if (d.b(d.this, aVar)) {
    ...
    public void a(@Nullable Activity activity, final View view, final aj.a aVar, int i, boolean z, final int i2) {
        ...
        com.kwad.components.core.e.d.a.a(new a.C0539a(contextWrapContextIfNeed).aE(this.mAdTemplate).b(this.mApkDownloadHelper).aG(i).as(true).A(playDuration).az(z).a(new a.b() { // from class: com.kwad.components.ad.nativead.d.5
            @Override // com.kwad.components.core.e.d.a.b
            public final void onAdClicked() {
