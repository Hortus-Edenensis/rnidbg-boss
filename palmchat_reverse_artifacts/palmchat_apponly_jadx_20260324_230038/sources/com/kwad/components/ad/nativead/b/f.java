...
public final class f extends com.kwad.components.ad.nativead.a.a implements View.OnClickListener, View.OnTouchListener {
    ...
    private void T(int i) {
        ...
        a.C0539a c0539aB = new a.C0539a(getContext()).aE(this.mAdTemplate).aD(i).b(this.mApkDownloadHelper);
        com.kwad.components.ad.nativead.a.b bVar = this.pp;
        com.kwad.components.core.e.d.a.a(c0539aB.A((bVar == null || (aVar = bVar.pq) == null) ? 0L : aVar.getPlayDuration()).a(new a.b() { // from class: com.kwad.components.ad.nativead.b.f.3
    ...
    private void fD() {
        com.kwad.components.core.e.d.a.a(new a.C0539a(getContext()).aE(this.pp.mAdTemplate).b(this.pp.mApkDownloadHelper).A(this.pp.pq.getPlayDuration()).a(new a.b() { // from class: com.kwad.components.ad.nativead.b.f.4
            @Override // com.kwad.components.core.e.d.a.b
            public final void onAdClicked() {
