...
public final class e extends KSRelativeLayout implements com.kwad.sdk.core.j.c {
    ...
    private KSAdVideoPlayConfigImpl f7525pl;
    ...
    private com.kwad.sdk.core.webview.d.a.a getClickListener() {
        return new com.kwad.sdk.core.webview.d.a.a() { // from class: com.kwad.components.ad.nativead.e.11
            ...
            public final void a(com.kwad.sdk.core.webview.d.b.a aVar) {
                ...
                a.C0539a c0539aAw = new a.C0539a(e.this.getContext()).aE(e.this.mAdTemplate).b(e.this.mApkDownloadHelper).as(false).aD(i).ay(aVar.Pt).aw(zBd);
                IAdLivePlayModule iAdLivePlayModule = e.this.hR;
                com.kwad.components.core.e.d.a.a(c0539aAw.A(iAdLivePlayModule == null ? 0L : iAdLivePlayModule.getPlayDuration()).ap(str).au(true).a(new a.b() { // from class: com.kwad.components.ad.nativead.e.11.1
    ...
    private aq.a getOpenNewPageListener() {
        return new aq.a() { // from class: com.kwad.components.ad.nativead.e.9
            ...
            public final void a(com.kwad.components.core.webview.a.b bVar) {
                AdWebViewActivityProxy.launch(e.this.mContext, new AdWebViewActivityProxy.a.C0552a().aH(bVar.title).aI(bVar.url).aG(e.this.mAdTemplate).rV());
            }
        };
    }
    ...
    public final void a(Context context, AdTemplate adTemplate, @Nullable com.kwad.components.core.e.d.d dVar, @NonNull KSAdVideoPlayConfigImpl kSAdVideoPlayConfigImpl) {
        ...
        this.f7525pl = kSAdVideoPlayConfigImpl;
        ...
        if (this.f7525pl.getVideoSoundValue() != 0) {
            this.mIsAudioEnable = this.f7525pl.isVideoSoundEnable();
        } else {
