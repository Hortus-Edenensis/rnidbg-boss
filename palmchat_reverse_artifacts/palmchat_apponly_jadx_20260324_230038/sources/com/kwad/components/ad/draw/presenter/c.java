...
public final class c extends com.kwad.components.ad.draw.b.a implements View.OnClickListener {
    ...
    private KsAppDownloadListener dW = new com.kwad.sdk.core.download.a.a() { // from class: com.kwad.components.ad.draw.presenter.c.2
        ...
        public final void onPaused(int i) {
            super.onPaused(i);
            c.this.dQ.setText(com.kwad.sdk.core.response.b.a.KI());
            c.this.dR.e(com.kwad.sdk.core.response.b.a.KI(), i);
        }
    ...
    private void a(boolean z, int i) {
        com.kwad.components.core.e.d.a.a(new a.C0539a(this.dN.getContext()).aE(this.mAdTemplate).b(this.mApkDownloadHelper).aD(i).as(z).a(new a.b() { // from class: com.kwad.components.ad.draw.presenter.c.3
