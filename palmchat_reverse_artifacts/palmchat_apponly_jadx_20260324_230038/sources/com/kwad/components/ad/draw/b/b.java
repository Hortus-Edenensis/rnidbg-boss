...
public final class b extends com.kwad.sdk.mvp.a {
    ...
    public final void a(int i, Context context, final int i2, int i3) {
        a.C0539a c0539aAD = new a.C0539a(context).aE(this.mAdTemplate).b(this.mApkDownloadHelper).as(false).aD(i3);
        IAdLivePlayModule iAdLivePlayModule = this.dC;
        com.kwad.components.core.e.d.a.a(c0539aAD.A(iAdLivePlayModule == null ? 0L : iAdLivePlayModule.getPlayDuration()).aA(true).aC(i2).aB(i).a(new a.b() { // from class: com.kwad.components.ad.draw.b.b.1
