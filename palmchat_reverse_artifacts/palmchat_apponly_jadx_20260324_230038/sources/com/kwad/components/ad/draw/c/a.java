...
public final class a extends b {
    ...
    private void br() {
        this.Mp.a(new b.a(this.mAdTemplate).dt(e.et(this.mAdTemplate)).du(h.b(e.es(this.mAdTemplate))).a(this.mAdTemplate.mVideoPlayerStatus).b(new com.kwad.sdk.contentalliance.a.a.a(this.mAdTemplate, System.currentTimeMillis())).Ga(), this.mDetailVideoView);
