...
public class DrawCardApp extends FrameLayout implements View.OnClickListener {
        ...
        if (this.dW == null) {
            this.dW = new com.kwad.sdk.core.download.a.a() { // from class: com.kwad.components.ad.draw.view.playcard.DrawCardApp.1
                ...
                public final void onPaused(int i) {
                    super.onPaused(i);
                    DrawCardApp.this.gl.e(com.kwad.sdk.core.response.b.a.KI(), i);
                }
    ...
    public void onClick(View view) {
        if (view != this.gd) {
            com.kwad.components.core.e.d.a.a(new a.C0539a(getContext()).aE(this.mAdTemplate).b(this.mApkDownloadHelper).as(view == this.gl).aD(view == this.gl ? 1 : 2).a(new a.b() { // from class: com.kwad.components.ad.draw.view.playcard.DrawCardApp.2
    ...
    public final void a(@NonNull AdTemplate adTemplate, a aVar) {
        ...
        boolean z2 = !TextUtils.isEmpty(strAA);
        if (z2) {
