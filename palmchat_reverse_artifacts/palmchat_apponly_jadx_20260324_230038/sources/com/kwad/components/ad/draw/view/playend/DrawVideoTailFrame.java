...
public class DrawVideoTailFrame extends FrameLayout implements View.OnClickListener {
    ...
    private KsAppDownloadListener getAppDownloadListener() {
        return new a() { // from class: com.kwad.components.ad.draw.view.playend.DrawVideoTailFrame.1
            ...
            public final void onPaused(int i) {
                super.onPaused(i);
                DrawVideoTailFrame.this.gA.e(com.kwad.sdk.core.response.b.a.KI(), i);
            }
    ...
    public void onClick(View view) {
        com.kwad.components.core.e.d.a.a(new a.C0539a(getContext()).aE(this.mAdTemplate).b(this.mApkDownloadHelper).aD(view == this.gA ? 1 : 2).as(view == this.gA).a(new a.b() { // from class: com.kwad.components.ad.draw.view.playend.DrawVideoTailFrame.2
