...
public final class d {
    public static void loadDrawAd(KsScene ksScene, @NonNull final KsLoadManager.DrawAdListener drawAdListener) {
        ...
        KsAdLoadManager.M().a(new a.C0560a().e(new ImpInfo(sceneImplCovert)).aQ(zB).a(new com.kwad.components.core.request.d() { // from class: com.kwad.components.ad.draw.d.1
            ...
            public final void b(@NonNull AdResultData adResultData) {
                ...
                if (arrayList.isEmpty()) {
                    onError(com.kwad.sdk.core.network.e.aJc.errorCode, TextUtils.isEmpty(adResultData.testErrorMsg) ? com.kwad.sdk.core.network.e.aJc.msg + "(无视频资源)" : adResultData.testErrorMsg);
                } else {
