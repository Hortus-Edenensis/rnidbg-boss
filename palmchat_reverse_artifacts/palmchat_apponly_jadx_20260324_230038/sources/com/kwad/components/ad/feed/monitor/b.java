...
public final class b {
    ...
    private static void b(com.kwad.sdk.commercial.c.a aVar, boolean z) {
        try {
            c.d(d.FH().cR(z ? ILoggerReporter.Category.ERROR_LOG : ILoggerReporter.Category.APM_LOG).i(z ? 0.01d : 0.001d).O("ad_sdk_feed_load", "status").b(BusinessType.AD_FEED).z(aVar).a(com.kwai.adclient.kscommerciallogger.model.a.bjx));
        } catch (Exception e) {
    ...
    public static void c(AdTemplate adTemplate, int i, int i2) {
        ...
        aa.putValue(jSONObject, "feedLoadOptimizeType", e.GF());
        aa.putValue(jSONObject, "feedLoadOptimizeExternalEnable", e.GI());
    ...
    private static void b(com.kwad.sdk.commercial.c.a aVar) {
        try {
            c.d(d.FH().cR(ILoggerReporter.Category.APM_LOG).i(0.01d).O("ad_sdk_feed_callback", "callback_type").b(BusinessType.AD_FEED).z(aVar).a(com.kwai.adclient.kscommerciallogger.model.a.bjx));
        } catch (Exception e) {
    ...
    private static void a(String str, FeedErrorInfo feedErrorInfo, double d) {
        try {
            c.d(d.FH().cR(ILoggerReporter.Category.ERROR_LOG).b(BusinessType.AD_FEED).O(str, MapController.DEFAULT_LAYER_TAG).cS(str).a(com.kwai.adclient.kscommerciallogger.model.a.bjx).z(feedErrorInfo).i(d));
        } catch (Exception e) {
