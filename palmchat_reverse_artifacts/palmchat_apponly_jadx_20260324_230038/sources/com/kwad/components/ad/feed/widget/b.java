...
public abstract class b extends a implements View.OnClickListener, com.kwad.sdk.widget.d {
    ...
    private void b(View view, final int i) {
        if (view == this.hC) {
            ...
            ci();
            com.kwad.components.core.e.d.a.a(new a.C0539a(getContext()).aE(this.mAdTemplate).aB(5).aC(i).b(this.mApkDownloadHelper).aD(view == this.hH ? 1 : 2).as(view == this.hH).a(new a.b() { // from class: com.kwad.components.ad.feed.widget.b.2
