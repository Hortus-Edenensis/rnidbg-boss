...
public abstract class c extends a implements View.OnClickListener, com.kwad.sdk.widget.d {
    ...
    public c(@NonNull Context context) {
        ...
        this.hQ = new a.InterfaceC0561a() { // from class: com.kwad.components.ad.feed.widget.c.4
            ...
            public final void a(int i, aj.a aVar) {
                ...
                c.this.ci();
                com.kwad.components.core.e.d.a.a(new a.C0539a(c.this.getContext()).aE(c.this.mAdTemplate).b(c.this.mApkDownloadHelper).aD(i3).as(z).au(true).aB(5).aC(i2).d(aVar).aw(true).a(new a.b() { // from class: com.kwad.components.ad.feed.widget.c.4.1
        ...
        this.cA = new a.b() { // from class: com.kwad.components.ad.feed.widget.c.2
            ...
            public final void onVideoPlayError(int i, int i2) {
                com.kwad.components.ad.feed.monitor.b.a(c.this.mAdTemplate, 2, 1, com.kwad.sdk.core.response.b.a.L(c.this.mAdInfo), i + " " + i2, SystemClock.elapsedRealtime() - c.this.ht);
            }
    ...
    */
    public void onClick(View view) {
        ...
        if (view == this.hL && (aVar = this.cq) != null && aVar.isIdle()) {
            ...
            if (view == this.hA) {
                ...
                i = (view == this.hH || view == this.gD || view == this.hG) ? 1 : view == this.gw ? 13 : view == this.ee ? 14 : (view == this.hE || view == this.hF) ? 101 : view == this.cq ? 100 : 35;
            }
            a(this.cq, view == this.hH, i);
        }
    }
    ...
    public final void b(@NonNull KsAdVideoPlayConfig ksAdVideoPlayConfig) {
        ...
        this.cq.a(new b.a(this.mAdTemplate).dt(strL).du(com.kwad.sdk.core.response.b.h.b(com.kwad.sdk.core.response.b.e.es(this.mAdTemplate))).a(this.mAdTemplate.mVideoPlayerStatus).b(com.kwad.sdk.contentalliance.a.a.a.bT(this.mAdTemplate)).Ga(), null);
    ...
    private void a(com.kwad.sdk.core.video.videoview.a aVar, boolean z, final int i) {
        ...
        if (aVar != null || this.hS) {
            ...
            ci();
            a.C0539a c0539aAs = new a.C0539a(getContext()).aE(this.mAdTemplate).b(this.mApkDownloadHelper).as(z);
            IAdLivePlayModule iAdLivePlayModule = this.hR;
            com.kwad.components.core.e.d.a.a(c0539aAs.A(iAdLivePlayModule == null ? 0L : iAdLivePlayModule.getPlayDuration()).aD(i2).aw(true).a(new a.b() { // from class: com.kwad.components.ad.feed.widget.c.11
                @Override // com.kwad.components.core.e.d.a.b
                public final void onAdClicked() {
                    c.this.bs(i);
                }
