...
public class FeedDownloadActivityProxy extends com.kwad.components.core.proxy.f implements View.OnClickListener {
    ...
    public void onClick(View view) {
        com.kwad.components.core.e.d.a.a(new a.C0539a(view.getContext()).aE(this.mAdTemplate).b(this.mApkDownloadHelper).aD(view == this.mProgressBarTv ? 1 : 2).as(view == this.mProgressBarTv).a(new a.b() { // from class: com.kwad.components.ad.feed.FeedDownloadActivityProxy.2
