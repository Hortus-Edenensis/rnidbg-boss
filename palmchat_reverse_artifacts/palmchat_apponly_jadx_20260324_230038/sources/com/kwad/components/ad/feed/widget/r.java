...
public final class r extends com.kwad.components.core.widget.b<AdResultData, AdTemplate> implements com.kwad.sdk.widget.d {
    ...
    public void cE() {
        ...
        if (this.hg == null) {
            this.hg = new d.InterfaceC0477d() { // from class: com.kwad.components.ad.feed.widget.r.11
                @Override // com.kwad.components.ad.feed.d.InterfaceC0477d
                public final boolean b(final double d) {
                    if (!bz.q(r.this.jb, (int) (com.kwad.sdk.core.config.e.Hw() * 100.0f)) || !r.this.fr() || !com.kwad.components.ad.feed.d.bX()) {
                        return false;
                    }
                    com.kwad.components.core.e.d.a.a(new a.C0539a(r.this.getContext()).aE(r.this.mAdTemplate).b(r.this.mApkDownloadHelper).aD(2).as(false).au(false).aC(157).aB(5).aw(true).a(new a.b() { // from class: com.kwad.components.ad.feed.widget.r.11.1
    ...
    public void cS() {
        float fDc = com.kwad.sdk.core.response.b.b.dc(this.mAdTemplate);
        if (this.hg == null) {
            this.hg = new d.InterfaceC0477d() { // from class: com.kwad.components.ad.feed.widget.r.2
                @Override // com.kwad.components.ad.feed.d.InterfaceC0477d
    ...
    */
    public boolean getMuteStatus() {
        boolean z;
        boolean z2 = true;
        if (com.kwad.sdk.core.config.e.hD() || !com.kwad.components.core.s.a.aG(this.mContext).ur()) {
            if (this.fD != null) {
    ...
    private void init(Context context) {
        int iA = com.kwad.sdk.core.config.e.a(com.kwad.sdk.core.config.c.aFD);
    ...
    public final void d(@NonNull AdResultData adResultData) {
        ...
        if (com.kwad.sdk.core.response.b.b.df(this.mAdTemplate) > 0.0d) {
            this.mHeight = (int) (((double) this.mWidth) * com.kwad.sdk.core.response.b.b.df(this.mAdTemplate));
        } else {
        ...
        this.iR = new b.a() { // from class: com.kwad.components.ad.feed.widget.r.9
            ...
            public final void onAdShow() {
                if (r.this.mIsNative) {
                    ...
                    c0601a.aBu = String.valueOf(feedTypeFromInt.getFeedDefaultType() == null ? 0 : feedTypeFromInt.getFeedDefaultType().getDefaultType());
                    bVar.b(c0601a);
    ...
    public boolean a(boolean z, boolean z2) {
        ...
        return com.kwad.sdk.core.config.e.Hp() ? z : z2;
    }
    ...
    public void a(final com.kwad.components.core.webview.tachikoma.f.d dVar) {
        float fDc = com.kwad.sdk.core.response.b.b.dc(this.mAdTemplate);
        if (this.hg == null) {
            this.hg = new d.InterfaceC0477d() { // from class: com.kwad.components.ad.feed.widget.r.3
                @Override // com.kwad.components.ad.feed.d.InterfaceC0477d
                public final boolean b(double d) {
                    if (!bz.q(r.this.jb, (int) (com.kwad.sdk.core.config.e.Hw() * 100.0f)) || !r.this.fr() || !com.kwad.components.ad.feed.d.bX()) {
                        return false;
