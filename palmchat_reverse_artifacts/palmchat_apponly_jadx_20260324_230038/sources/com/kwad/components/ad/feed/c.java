...
public final class c extends AbstractKsFeedAd implements com.kwad.components.core.internal.api.a {
    ...
    private com.kwad.components.core.widget.b<?, ?> C(Context context) {
        ...
        if (width < com.kwad.sdk.core.config.e.a(com.kwad.sdk.core.config.c.aFQ) * ((double) m.getScreenWidth(context))) {
    ...
    private void bW() {
        if (this.mAdTemplate != null) {
            com.kwad.sdk.core.diskcache.b.a.IJ().remove("feed_ad_cache_" + this.mAdTemplate.posId);
        }
    }
                    ...
                    try {
                        if (adRenderListener != null) {
                            if (c.this.gJ == null) {
                                ...
                                com.kwad.sdk.core.network.e eVar = com.kwad.sdk.core.network.e.aJh;
    ...
    public final void setVideoPlayConfig(@Nullable KsAdVideoPlayConfig ksAdVideoPlayConfig) {
        if (ksAdVideoPlayConfig instanceof KSAdVideoPlayConfigImpl) {
            ...
            if (kSAdVideoPlayConfigImpl.getVideoAutoPlayType() != 0) {
                ...
                this.bU.setDataFlowAutoStart(com.kwad.sdk.core.config.e.Hp());
                try {
