...
public final class q extends com.kwad.components.core.widget.b<AdResultData, AdTemplate> implements View.OnClickListener, com.kwad.sdk.widget.d {
    ...
    private d hO;
    private final a.InterfaceC0561a hQ;
    private IAdLivePlayModule hR;
    private boolean hS;
    private d.InterfaceC0477d hg;
    private long ht;
    private float hu;
    private float hv;
    ...
    public q(@NonNull Context context) {
        ...
        this.hQ = new a.InterfaceC0561a() { // from class: com.kwad.components.ad.feed.widget.q.11
            ...
            public final void a(int i, aj.a aVar) {
                ...
                q.this.cF();
                com.kwad.components.core.e.d.a.a(new a.C0539a(q.this.getContext()).aE(q.this.mAdTemplate).b(q.this.mApkDownloadHelper).aD(i3).as(z).au(true).aC(i2).d(aVar).aw(true).a(new a.b() { // from class: com.kwad.components.ad.feed.widget.q.11.1
    ...
    private void bc() {
        ...
        this.iP.a(new b.a().aP(this.mAdTemplate).bb(com.kwad.sdk.core.response.b.b.cX(this.mAdTemplate)).d(this.mAdWebView).l(this.it).f(this.mApkDownloadHelper).a(this.iQ));
    ...
    public void cE() {
        ...
        d.InterfaceC0477d interfaceC0477d = new d.InterfaceC0477d() { // from class: com.kwad.components.ad.feed.widget.q.18
            @Override // com.kwad.components.ad.feed.d.InterfaceC0477d
            public final boolean b(final double d) {
                if (!bz.q(q.this.it, (int) (com.kwad.sdk.core.config.e.Hw() * 100.0f)) || !q.this.fr()) {
                    return false;
                }
                com.kwad.components.core.e.d.a.a(new a.C0539a(q.this.getContext()).aE(q.this.mAdTemplate).b(q.this.mApkDownloadHelper).aD(2).as(false).au(false).aC(157).aB(5).aw(true).a(new a.b() { // from class: com.kwad.components.ad.feed.widget.q.18.1
                    @Override // com.kwad.components.core.e.d.a.b
                    public final void onAdClicked() {
        ...
        this.hg = interfaceC0477d;
        com.kwad.components.ad.feed.d.a(fDc, this.mContext, interfaceC0477d);
    }
    ...
    public aq.a getOpenNewPageListener() {
        return new aq.a() { // from class: com.kwad.components.ad.feed.widget.q.19
            ...
            public final void a(com.kwad.components.core.webview.a.b bVar) {
                AdWebViewActivityProxy.launch(q.this.mContext, new AdWebViewActivityProxy.a.C0552a().aH(bVar.title).aI(bVar.url).aI(true).aG(q.this.mAdTemplate).rV());
            }
        };
    }
    ...
    private a.b getVideoPlayCallback() {
        return new a.b() { // from class: com.kwad.components.ad.feed.widget.q.8
            ...
            public final void onVideoPlayError(int i, int i2) {
                com.kwad.components.ad.feed.monitor.b.a(q.this.mAdTemplate, 2, 1, com.kwad.sdk.core.response.b.a.L(q.this.mAdInfo), i + " " + i2, SystemClock.elapsedRealtime() - q.this.ht);
            }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (!com.kwad.sdk.core.config.e.HB() || !com.kwad.sdk.core.response.b.d.eg(this.mAdTemplate)) {
    ...
    public void E(final int i) {
        cF();
        com.kwad.components.core.e.d.a.a(new a.C0539a(getContext()).aE(this.mAdTemplate).b(this.mApkDownloadHelper).aD(1).as(true).aC(i).aB(5).au(false).aw(true).a(new a.b() { // from class: com.kwad.components.ad.feed.widget.q.9
            @Override // com.kwad.components.core.e.d.a.b
            public final void onAdClicked() {
                q.this.bs(i);
            }
    ...
    private void r(AdTemplate adTemplate) {
        ...
        } else if (com.kwad.sdk.core.response.b.b.df(this.mAdTemplate) > 0.0d) {
            this.it.setRatio(com.kwad.sdk.core.response.b.b.df(this.mAdTemplate));
    ...
    public final void ab() {
        ...
        d.InterfaceC0477d interfaceC0477d = this.hg;
        if (interfaceC0477d != null) {
            com.kwad.components.ad.feed.d.a(interfaceC0477d);
        }
        IAdLivePlayModule iAdLivePlayModule = this.hR;
        if (iAdLivePlayModule != null) {
    ...
    public final void b(@NonNull KsAdVideoPlayConfig ksAdVideoPlayConfig) {
        ...
        this.cq.a(new b.a(this.mAdTemplate).dt(strL).du(com.kwad.sdk.core.response.b.h.b(com.kwad.sdk.core.response.b.e.es(this.mAdTemplate))).a(this.mAdTemplate.mVideoPlayerStatus).b(new com.kwad.sdk.contentalliance.a.a.a(this.mAdTemplate, System.currentTimeMillis())).Ga(), null);
        a.InterfaceC0618a interfaceC0618a = new a.InterfaceC0618a() { // from class: com.kwad.components.ad.feed.widget.q.7
    ...
    /* JADX INFO: compiled from: SearchBox */
    public class AnonymousClass12 extends com.kwad.components.core.webview.c {
        ...
        public final void a(com.kwad.sdk.core.webview.d.b.a aVar) {
            ...
            com.kwad.components.core.e.d.a.a(new a.C0539a(q.this.getContext()).aE(q.this.mAdTemplate).b(q.this.mApkDownloadHelper).as(q.a(q.this, aVar)).aD(i).aC(aVar.mH).ap((dVar == null || TextUtils.isEmpty(dVar.PI)) ? "" : aVar.ahK.PI).aB(5).ay(aVar.Pt).aw(zBd).A(q.this.hR == null ? 0L : q.this.hR.getPlayDuration()).au(true).a(new a.b() { // from class: com.kwad.components.ad.feed.widget.q.12.5
                @Override // com.kwad.components.core.e.d.a.b
                public final void onAdClicked() {
                    if (q.this.amb != null) {
                        q.this.amb.onAdClicked();
    ...
    public static /* synthetic */ boolean a(q qVar, com.kwad.sdk.core.webview.d.b.a aVar) {
        return b(aVar);
    }
    ...
    private void a(com.kwad.sdk.core.video.videoview.a aVar, final int i) {
        if (aVar != null) {
            ...
            cF();
            com.kwad.components.core.e.d.a.a(new a.C0539a(getContext()).aE(this.mAdTemplate).b(this.mApkDownloadHelper).aD(2).aw(com.kwad.sdk.core.response.b.a.bd(this.mAdInfo)).a(new a.b() { // from class: com.kwad.components.ad.feed.widget.q.10
                @Override // com.kwad.components.core.e.d.a.b
                public final void onAdClicked() {
                    q.this.bs(i);
                }
