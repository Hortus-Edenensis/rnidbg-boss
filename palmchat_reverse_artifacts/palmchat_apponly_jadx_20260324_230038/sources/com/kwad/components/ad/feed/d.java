...
public final class d {
    ...
    public static class c {
        private InterfaceC0477d hg;
        private Context mContext;

        public c(InterfaceC0477d interfaceC0477d, Context context) {
    ...
    public static void a(float f, Context context, InterfaceC0477d interfaceC0477d) {
        if (gX == null) {
            a(f, context);
        }
        ha.add(new c(interfaceC0477d, context));
    }
    ...
    public static void a(InterfaceC0477d interfaceC0477d) {
        for (c cVar : ha) {
            if (cVar != null && cVar.hg == interfaceC0477d) {
                ha.remove(cVar);
            }
        }
