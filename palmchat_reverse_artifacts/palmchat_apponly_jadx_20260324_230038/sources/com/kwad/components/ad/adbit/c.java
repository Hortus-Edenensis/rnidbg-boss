...
public final class c {
    ...
    public static boolean c(@NonNull final com.kwad.components.core.request.model.a aVar) {
        ...
        GlobalThreadPools.Ll().submit(new bg() { // from class: com.kwad.components.ad.adbit.c.3
    ...
    public static String getBidRequestTokenV2(KsScene ksScene) {
        final com.kwad.components.core.request.model.a aVarTR = new a.C0560a().e(new ImpInfo(SceneImpl.covert(ksScene))).a(new com.kwad.components.core.request.d()).tR();
    ...
    public static String a(SceneImpl sceneImpl) {
        ...
        final com.kwad.components.core.request.model.a aVarTR = new a.C0560a().e(new ImpInfo(sceneImpl)).a(new com.kwad.components.core.request.d()).tR();
    ...
    private static void a(String str, @NonNull com.kwad.components.core.request.model.a aVar) {
        try {
            ...
            if (listA.isEmpty()) {
                com.kwad.components.core.request.model.a.a(aVar, com.kwad.sdk.core.network.e.aJc.errorCode, TextUtils.isEmpty(adBitResultData.testErrorMsg) ? com.kwad.sdk.core.network.e.aJc.msg : adBitResultData.testErrorMsg, false);
            } else {
