...
public final class g {
    ...
    public static void loadBannerAd(KsScene ksScene, @NonNull final KsLoadManager.BannerAdListener bannerAdListener) {
        if (!l.DP().CW()) {
            ...
            bw.runOnUiThread(new bg() { // from class: com.kwad.components.ad.c.g.1
                ...
                public final void doTask() {
                    bannerAdListener.onError(com.kwad.sdk.core.network.e.aJc.errorCode, com.kwad.sdk.core.network.e.aJc.msg + "sdk not init");
                }
            });
            return;
        }
        ksScene.setAdNum(com.kwad.sdk.core.config.e.HY());
        bV = ksScene;
        ...
        KsAdLoadManager.M().a(new a.C0560a().e(new ImpInfo(sceneImplCovert)).aQ(zB).a(new j() { // from class: com.kwad.components.ad.c.g.3
            ...
            public final void onError(final int i, final String str) {
                int i2 = com.kwad.sdk.core.network.e.aJc.errorCode;
