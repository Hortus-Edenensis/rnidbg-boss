...
public final class a extends c<com.kwad.components.ad.c.c> implements View.OnClickListener, d {
    ...
    public a(Context context, AdTemplate adTemplate, InterfaceC0472a interfaceC0472a) {
        super(context);
        ...
        this.cA = new a.b() { // from class: com.kwad.components.ad.c.b.a.1
            ...
            public final void onVideoPlayError(int i, int i2) {
                InterfaceC0472a interfaceC0472a2 = a.this.cy;
    ...
    private boolean ao() {
        boolean z;
        boolean z2 = true;
        if (com.kwad.sdk.core.config.e.HA() || !com.kwad.components.core.s.a.aG(this.mContext).ur()) {
    ...
    public boolean f(boolean z) {
        ...
        if (!com.kwad.sdk.core.config.e.HA()) {
    ...
    public final void onClick(View view) {
        ...
        if (view == this.cs || view == this.f7517cn) {
    ...
    public final void a(KsAdVideoPlayConfig ksAdVideoPlayConfig) {
        ...
        this.cq.a(new b.a(this.mAdTemplate).dt(strL).du(h.b(com.kwad.sdk.core.response.b.e.es(this.mAdTemplate))).a(this.mAdTemplate.mVideoPlayerStatus).b(com.kwad.sdk.contentalliance.a.a.a.bT(this.mAdTemplate)).Ga(), null);
