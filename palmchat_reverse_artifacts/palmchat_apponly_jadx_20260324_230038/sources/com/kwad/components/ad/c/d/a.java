...
public final class a extends c {
    ...
    private void b(ViewGroup viewGroup) {
        ...
        aVar.setViewCallback(new a.InterfaceC0573a() { // from class: com.kwad.components.ad.c.d.a.1
    ...
    public final void a(o oVar) {
        ...
        oVar.a(new o.a() { // from class: com.kwad.components.ad.c.d.a.3
            ...
            public final boolean isMuted() {
                boolean z;
                try {
                    if (e.HA() || !com.kwad.components.core.s.a.aG(a.this.cD.mContext).ur()) {
                        z = (!(a.this.cD.bJ instanceof KSAdVideoPlayConfigImpl) || ((KSAdVideoPlayConfigImpl) a.this.cD.bJ).getVideoSoundValue() == 0) ? !com.kwad.sdk.core.response.b.a.bY(com.kwad.sdk.core.response.b.e.er(a.this.cD.mAdTemplate)) : !a.this.cD.bJ.isVideoSoundEnable();
                    }
