...
public final class c extends a {
    ...
    private bg cN = new bg() { // from class: com.kwad.components.ad.c.c.c.1
        ...
        public final void doTask() {
            if (c.this.cM) {
                ...
                if (!c.this.cI || (c.this.cK >= e.HX() && com.kwad.sdk.core.response.b.a.dv(com.kwad.sdk.core.response.b.e.er(c.this.cD.mAdTemplate)))) {
                    c.this.av();
                    c.this.cJ = true;
                    c.b(c.this, true);
                    if (c.this.cK >= e.HX()) {
    ...
    public final void av() {
        ...
        try {
            com.kwad.components.ad.c.b.a aVar = new com.kwad.components.ad.c.b.a(getContext(), this.cD.bK.get(this.cO), new a.InterfaceC0472a() { // from class: com.kwad.components.ad.c.c.c.3
                @Override // com.kwad.components.ad.c.b.a.InterfaceC0472a
                public final void a(final int i, int i2, final AdTemplate adTemplate) {
                    a.C0539a c0539aA = new a.C0539a(c.this.getContext()).aE(adTemplate).ax(true).b(new d(adTemplate)).au(false).aD(i2).aC(i).a(new a.b() { // from class: com.kwad.components.ad.c.c.c.3.1
                    ...
                    com.kwad.components.core.e.d.a.a(c0539aA);
                    if (com.kwad.components.core.e.d.a.c(c0539aA)) {
                        return;
                    }
                    c.this.cD.X();
                }
                ...
                public final void d(AdTemplate adTemplate) {
                    ...
                    a.C0601a c0601a = new a.C0601a();
                    c0601a.templateId = "101";
                    c0601a.aBF = com.kwad.sdk.core.response.b.a.dv(com.kwad.sdk.core.response.b.e.er(c.this.cD.mAdTemplate)) ? 1 : 2;
                    bVar.b(c0601a);
    ...
    public final void aw() {
        ...
        KsAdLoadManager.M().a(new a.C0560a().e(new ImpInfo(sceneImplCovert)).aQ(zB).a(new j() { // from class: com.kwad.components.ad.c.c.c.7
            ...
            public final void a(@NonNull AdResultData adResultData, boolean z) {
                ...
                if (c.this.cD.bK.isEmpty()) {
                    onError(com.kwad.sdk.core.network.e.aJc.errorCode, TextUtils.isEmpty(adResultData.testErrorMsg) ? com.kwad.sdk.core.network.e.aJc.msg : adResultData.testErrorMsg);
                    k.ar("bannerAd_", "数据为空");
                }
            }
    ...
    private void b(ViewGroup viewGroup) {
        ...
        aVar.setViewCallback(new a.InterfaceC0573a() { // from class: com.kwad.components.ad.c.c.c.2
