...
public class KsRotateTypeTwoView extends c {
    ...
    public final Animator fO() {
        ...
        animatorSet.playSequentially(ObjectAnimator.ofFloat(interactionView, MapBundleKey.MapObjKey.OBJ_SS_ARROW_ROTATION, 0.0f, -25.0f).setDuration(500L), ObjectAnimator.ofFloat(interactionView, MapBundleKey.MapObjKey.OBJ_SS_ARROW_ROTATION, -25.0f, 25.0f).setDuration(500L), ObjectAnimator.ofFloat(interactionView, MapBundleKey.MapObjKey.OBJ_SS_ARROW_ROTATION, 25.0f, -12.0f).setDuration(200L), ObjectAnimator.ofFloat(interactionView, MapBundleKey.MapObjKey.OBJ_SS_ARROW_ROTATION, -12.0f, 0.0f).setDuration(100L));
        return animatorSet;
    }
