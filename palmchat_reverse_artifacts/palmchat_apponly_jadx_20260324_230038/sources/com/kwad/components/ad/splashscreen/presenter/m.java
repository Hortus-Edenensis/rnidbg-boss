...
public final class m extends i implements View.OnClickListener, com.kwad.components.ad.splashscreen.g, com.kwad.sdk.core.g.a {
    ...
    public final void mA() {
        AdMatrixInfo.RotateInfo rotateInfoM65do = com.kwad.sdk.core.response.b.b.m65do(this.GC.mAdTemplate);
        com.kwad.sdk.core.g.c cVar = this.gY;
        if (cVar != null) {
            cVar.b(rotateInfoM65do);
            return;
        }
        com.kwad.sdk.core.g.c cVar2 = new com.kwad.sdk.core.g.c(rotateInfoM65do);
        this.gY = cVar2;
        cVar2.a(this);
    }
