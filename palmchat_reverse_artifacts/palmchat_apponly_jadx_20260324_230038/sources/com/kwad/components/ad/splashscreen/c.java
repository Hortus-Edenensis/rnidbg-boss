...
public final class c extends com.kwad.components.core.m.c<h> implements DialogInterface.OnDismissListener, DialogInterface.OnShowListener {
    ...
    */
    public final void ab() {
        ...
        try {
            if (getRootView() != null) {
                z = getRootView().getVisibility() == 0;
                try {
                    if (getRootView() != null && getRootView().getParent() != null && (getRootView().getParent() instanceof View)) {
                        if (((View) getRootView().getParent()).getVisibility() == 0) {
                            z2 = true;
                        }
                    }
        ...
        com.kwad.components.ad.splashscreen.monitor.b.a(this.mAdTemplate, l.DP().Er(), z, z2);
    ...
    public final void a(@NonNull ViewGroup viewGroup) {
        ...
        this.mRootContainer.findViewById(R.id.splash_play_card_view).setOnClickListener(new View.OnClickListener() { // from class: com.kwad.components.ad.splashscreen.c.2
            ...
            public final void onClick(View view) {
                if (com.kwad.sdk.c.a.a.Fq() || !c.n(c.this.mAdInfo) || c.this.SR == null) {
                    return;
                }
