...
public final class a extends b implements c {
    ...
    public a(@NonNull AdTemplate adTemplate, @NonNull final DetailVideoView detailVideoView, KsVideoPlayConfig ksVideoPlayConfig) {
        ...
        File fileCr = com.kwad.sdk.core.diskcache.b.a.IJ().cr(strBa);
    ...
    private void br() {
        com.kwad.sdk.contentalliance.a.a.b bVarGa = new b.a(this.mAdTemplate).a(this.mVideoPlayerStatus).dt(this.BE).du(com.kwad.sdk.core.response.b.h.b(e.es(this.mAdTemplate))).b(com.kwad.sdk.contentalliance.a.a.a.bT(this.mAdTemplate)).Ga();
        this.JJ = SystemClock.elapsedRealtime();
        com.kwad.components.ad.splashscreen.monitor.b.mk();
        com.kwad.components.ad.splashscreen.monitor.b.e(this.mAdTemplate, 1, this.GI);
        this.Mp.a(bVarGa, this.mDetailVideoView);
