...
public final class h extends com.kwad.sdk.mvp.a {
    ...
    public static boolean af(AdTemplate adTemplate) {
        ...
        return com.kwad.sdk.core.config.e.Hf() && (splashPlayCardTKInfoDz = com.kwad.sdk.core.response.b.b.dz(adTemplate)) != null && !TextUtils.isEmpty(splashPlayCardTKInfoDz.templateId) && splashPlayCardTKInfoDz.renderType == 1;
    }

    private void me() {
        mf();
        Iterator<g> it = this.FQ.iterator();
        while (it.hasNext()) {
            it.next().lR();
        }
    }
    ...
    private void mg() {
        Iterator<f> it = this.FR.iterator();
        while (it.hasNext()) {
            it.next().lN();
        }
    }
    ...
    public final void U(Context context) {
        ...
        if (!com.kwad.sdk.core.config.e.Id()) {
    ...
    public final void ag(boolean z) {
        ...
        if (z && com.kwad.sdk.core.config.e.Id()) {
            com.kwad.components.core.s.b.ut().a(this.mAdTemplate, null, null);
        }
    ...
    public final void mb() {
        ...
        if (!r(com.kwad.sdk.core.response.b.e.er(this.mAdTemplate)) || this.mAdTemplate.converted) {
            ...
            bv bvVar = this.mTimerHelper;
            if (bvVar != null) {
                c0601a.duration = bvVar.getTime();
            }
            com.kwad.sdk.core.adlog.c.b(this.mAdTemplate, new com.kwad.sdk.core.adlog.c.b().dw(14).dE(22).b(c0601a), (JSONObject) null);
            com.kwad.components.ad.splashscreen.monitor.a.mi().ak(this.mAdTemplate);
            KsSplashScreenAd.SplashScreenAdInteractionListener splashScreenAdInteractionListener = this.FB;
            if (splashScreenAdInteractionListener != null) {
                splashScreenAdInteractionListener.onAdShowEnd();
    ...
    public final void a(final int i, Context context, final int i2, int i3, final a aVar) {
        ...
        com.kwad.components.core.e.d.a.a(new a.C0539a(context).aE(this.mAdTemplate).b(this.mApkDownloadHelper).aD(i3).as(i3 == 1).aC(i2).aB(i).a(new a.b() { // from class: com.kwad.components.ad.splashscreen.h.1
