...
public class b {
    ...
    public static void a(@NonNull AdTemplate adTemplate, int i, long j, long j2) {
        ...
        com.kwad.sdk.commercial.c.j(new SplashMonitorInfo().setType(adTemplate.notNetworkRequest ? 2 : 1).setStatus(3).setLoadDataTime(adTemplate.loadDataTime).setCheckStatus(i).setCheckDataTime(jElapsedRealtime).setBeforeLoadDataTime(j2).setLoadProcessType(e.a(com.kwad.components.ad.splashscreen.b.a.Gn) ? 1L : 2L).setLoadAndCheckDataTime(adTemplate.loadDataTime + jElapsedRealtime).setBuriedPointOptimizeType(e.a(com.kwad.sdk.core.config.c.aGu)).setVisibleCheckDelayTime(e.Ie()).setPreloadId(com.kwad.sdk.core.response.b.a.ba(com.kwad.sdk.core.response.b.e.er(adTemplate))).setAdTemplate(adTemplate));
    }

    public static void al(@NonNull AdTemplate adTemplate) {
        AdInfo adInfoEr = com.kwad.sdk.core.response.b.e.er(adTemplate);
        com.kwad.sdk.commercial.c.m(new SplashMonitorInfo().setLoadType(adTemplate.splashAdLoadType).setStatus(4).setBuriedPointOptimizeType(e.a(com.kwad.sdk.core.config.c.aGu)).setVisibleCheckDelayTime(e.Ie()).setCreativeId(com.kwad.sdk.core.response.b.a.K(adInfoEr)).setType(com.kwad.sdk.core.response.b.a.be(adInfoEr) ? 2 : 1).setAdTemplate(adTemplate));
    }
    ...
    public static void e(@NonNull AdTemplate adTemplate, long j) {
        com.kwad.sdk.commercial.c.j(new SplashMonitorInfo().setType(adTemplate.notNetworkRequest ? 2 : 1).setStatus(2).setBeforeLoadDataTime(j).setLoadDataTime(adTemplate.loadDataTime).setLoadProcessType(e.a(com.kwad.components.ad.splashscreen.b.a.Gn) ? 1L : 2L).setBuriedPointOptimizeType(e.a(com.kwad.sdk.core.config.c.aGu)).setVisibleCheckDelayTime(e.Ie()).setPreloadId(com.kwad.sdk.core.response.b.a.ba(com.kwad.sdk.core.response.b.e.er(adTemplate))).setAdTemplate(adTemplate));
    }

    public static void f(long j, long j2) {
        com.kwad.sdk.commercial.c.j(new SplashMonitorInfo().setStatus(11).setBeforeLoadDataTime(j2).setLoadProcessType(e.a(com.kwad.components.ad.splashscreen.b.a.Gn) ? 1L : 2L).setBuriedPointOptimizeType(e.a(com.kwad.sdk.core.config.c.aGu)).setVisibleCheckDelayTime(e.Ie()).setPosId(j));
    }
    ...
    public static void u(long j) {
        com.kwad.sdk.commercial.c.j(new SplashMonitorInfo().setStatus(1).setLoadProcessType(e.a(com.kwad.components.ad.splashscreen.b.a.Gn) ? 1L : 2L).setBuriedPointOptimizeType(e.a(com.kwad.sdk.core.config.c.aGu)).setVisibleCheckDelayTime(e.Ie()).setPosId(j));
    }
    ...
    public static void f(@NonNull AdTemplate adTemplate, long j) {
        com.kwad.sdk.commercial.c.m(new SplashMonitorInfo().setLoadType(adTemplate.splashAdLoadType).setStatus(1).setBuriedPointOptimizeType(e.a(com.kwad.sdk.core.config.c.aGu)).setVisibleCheckDelayTime(e.Ie()).setType(com.kwad.sdk.core.response.b.a.be(com.kwad.sdk.core.response.b.e.er(adTemplate)) ? 2 : 1).setCostTime(j).setLoadProcessType(e.a(com.kwad.components.ad.splashscreen.b.a.Gn) ? 1L : 2L).setAdTemplate(adTemplate));
    }
    ...
    public static void a(@NonNull List<AdTemplate> list, long j, long j2) {
        ...
        while (it.hasNext()) {
            arrayList.add(com.kwad.sdk.core.response.b.a.ba(com.kwad.sdk.core.response.b.e.er(it.next())));
        }
    ...
    public static void a(@NonNull AdTemplate adTemplate, long j, int i, int i2) {
        ...
        File fileCr = com.kwad.sdk.core.diskcache.b.a.IJ().cr(com.kwad.sdk.core.response.b.a.ba(adInfoEr));
        com.kwad.sdk.commercial.c.g(false, new SplashMonitorInfo().setStatus(1).setPreloadId(com.kwad.sdk.core.response.b.a.ba(adInfoEr)).setCostTime(j).setCacheValidTime(((long) adInfoEr.adPreloadInfo.validityPeriod) * 1000).setSize((fileCr == null || !fileCr.exists()) ? 0L : fileCr.length()).setUrl(strL).setMaterialType(com.kwad.sdk.core.response.b.a.bd(adInfoEr) ? 1 : 2).setType(i).setRequestType(i2).setAdTemplate(adTemplate));
    }
    ...
    public static void a(@NonNull AdTemplate adTemplate, long j, long j2, long j3) {
        AdInfo adInfoEr = com.kwad.sdk.core.response.b.e.er(adTemplate);
        com.kwad.sdk.commercial.c.m(new SplashMonitorInfo().setLoadType(adTemplate.splashAdLoadType).setStatus(2).setType(com.kwad.sdk.core.response.b.a.be(adInfoEr) ? 2 : 1).setCostTime(j).setAddLoadTime(j2).setRequestLoadTime(j3).setBuriedPointOptimizeType(e.a(com.kwad.sdk.core.config.c.aGu)).setVisibleCheckDelayTime(e.Ie()).setCreativeId(com.kwad.sdk.core.response.b.a.K(adInfoEr)).setPreloadId(com.kwad.sdk.core.response.b.a.ba(adInfoEr)).setLoadProcessType(e.a(com.kwad.components.ad.splashscreen.b.a.Gn) ? 1L : 2L).setAdTemplate(adTemplate));
    }
