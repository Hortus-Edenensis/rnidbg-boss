    ...
    private CloseCountDownView.a IN = new CloseCountDownView.a() { // from class: com.kwad.components.ad.splashscreen.presenter.endcard.c.1
        ...
        public final void ei() {
            ...
            if (c.this.GC.mTimerHelper != null) {
                c0601a.duration = c.this.GC.mTimerHelper.getTime();
            }
            com.kwad.sdk.core.adlog.c.b(c.this.GC.mAdTemplate, new com.kwad.sdk.core.adlog.c.b().dw(1).b(c0601a).dE(6), (JSONObject) null);
            c.this.GC.md();
        }
        ...
        public final void mq() {
            ...
            com.kwad.sdk.core.adlog.c.b(c.this.GC.mAdTemplate, new com.kwad.sdk.core.adlog.c.b().dw(14).b(c0601a).dE(6), (JSONObject) null);
            c.this.GC.mh();
        }
    };
