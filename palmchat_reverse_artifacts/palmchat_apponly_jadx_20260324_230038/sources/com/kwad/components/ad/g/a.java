...
public final class a {
    ...
    public static Map<String, AppPackageInfo> P(Context context) {
        ...
        if (hVar != null && s.RL()) {
            try {
                List<String> listEo = br.eo(context);
                ...
                if (listEo != null && !listEo.isEmpty()) {
                    Iterator<String> it2 = listEo.iterator();
                    while (it2.hasNext()) {
                        try {
    ...
    public static JSONArray[] b(Context context, List<String> list) {
        ...
        h hVar = (h) ServiceProvider.get(h.class);
        if (context == null || list == null || list.isEmpty() || hVar == null || !s.RL()) {
            return jSONArrayArr;
        }
        HashMap map = new HashMap();
    ...
    public static JSONObject a(AppPackageInfo appPackageInfo) {
        ...
        aa.putValue(jSONObject, WfConstant.EVENT_KEY_APP_NAME, appPackageInfo.appName);
        return jSONObject;
    }
