...
public final class f {
    public static void a(KsScene ksScene, @NonNull final e eVar) {
        ...
        KsAdLoadManager.M().a(new a.C0560a().e(new ImpInfo(sceneImplCovert)).aQ(zB).a(new j() { // from class: com.kwad.components.ad.fullscreen.f.2
            ...
            public final void a(@NonNull AdResultData adResultData, boolean z) {
                ...
                if (!zHU && arrayList2.isEmpty()) {
                    com.kwad.sdk.core.network.e eVar2 = com.kwad.sdk.core.network.e.aJd;
