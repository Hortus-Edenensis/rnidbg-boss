...
public final class b extends com.kwad.components.ad.reward.presenter.b implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        if (view == this.jZ) {
            com.kwad.components.core.e.d.a.a(new a.C0539a(view.getContext()).aE(this.mAdTemplate).b(this.mApkDownloadHelper).aC(40).aB(1).as(false).ao(this.tq.gJ()).aD(1).a(new a.b() { // from class: com.kwad.components.ad.fullscreen.c.a.b.2
