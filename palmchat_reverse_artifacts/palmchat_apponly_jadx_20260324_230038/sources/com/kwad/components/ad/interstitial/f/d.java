...
public final class d extends b {
    ...
    public final void as() {
        ...
        getContext();
        final boolean zSM = aq.SM();
        this.mi.mj.setRatio(b(zSM, zAX));
        ...
        viewGroup.post(new bg() { // from class: com.kwad.components.ad.interstitial.f.d.3
            ...
            public final void doTask() {
                ViewGroup.LayoutParams layoutParamsA = zSM ? d.a(d.this.getRootView().getWidth(), zAX) : d.N(d.this.getRootView().getHeight());
    ...
    public void e(int i, int i2) {
        if (this.mi.a(new c.C0488c(getContext()).l(this.mM).a(this.mN.getTouchCoords()).L(i).M(i2)) && com.kwad.components.ad.interstitial.d.b.t(this.mAdTemplate)) {
            c cVar = this.mi;
            if (cVar.kV != null) {
