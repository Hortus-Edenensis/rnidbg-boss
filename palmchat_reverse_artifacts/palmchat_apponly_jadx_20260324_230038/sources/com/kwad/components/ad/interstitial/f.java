...
public final class f {
    public static void loadInterstitialAd(@NonNull KsScene ksScene, @NonNull final KsLoadManager.InterstitialAdListener interstitialAdListener) {
        if (!l.DP().CW()) {
            ...
            bw.runOnUiThread(new bg() { // from class: com.kwad.components.ad.interstitial.f.1
                ...
                public final void doTask() {
                    interstitialAdListener.onError(com.kwad.sdk.core.network.e.aJc.errorCode, com.kwad.sdk.core.network.e.aJc.msg + "sdk not init");
                }
            });
            return;
        }
        ...
        KsAdLoadManager.M().a(new a.C0560a().e(new ImpInfo(sceneImplCovert)).aQ(zB).a(new com.kwad.components.core.request.d() { // from class: com.kwad.components.ad.interstitial.f.2
            ...
            public final void a(@NonNull AdResultData adResultData, boolean z) {
                    ...
                    for (AdTemplate adTemplate : adTemplateList) {
                        if (adTemplate != null) {
                            ...
                            if (TextUtils.isEmpty(strL)) {
                                ...
                                if (com.kwad.sdk.core.config.e.GJ() || zS) {
                                    arrayList2.add(adTemplate);
                                }
                            }
                        }
                    ...
                    for (AdTemplate adTemplate2 : adTemplateList) {
                        if (adTemplate2 != null) {
                            ...
                            if (TextUtils.isEmpty(strL2)) {
                                ...
                                if (com.kwad.sdk.core.config.e.GJ() || zS2) {
                                    arrayList.add(e.f(adResultDataA));
                                }
                            }
                        }
                ...
                if (arrayList.size() != 0) {
                    ...
                    onError(com.kwad.sdk.core.network.e.aJc.errorCode, TextUtils.isEmpty(adResultData.testErrorMsg) ? com.kwad.sdk.core.network.e.aJc.msg : adResultData.testErrorMsg);
                    com.kwad.components.ad.interstitial.report.realtime.a.eX();
                    com.kwad.components.ad.interstitial.report.realtime.a.a(com.kwad.sdk.core.network.e.aJc);
                    k.ar("insertAd_", "onInterstitialAdCacheFailed");
                }
            }
