...
public final class a extends b {
    ...
    private OrientationEventListener f7523me;
    ...
    public final void onUnbind() {
        super.onUnbind();
        OrientationEventListener orientationEventListener = this.f7523me;
    ...
    private void a(final c cVar) {
        ...
        this.f7523me = orientationEventListener;
        if (orientationEventListener.canDetectOrientation()) {
            this.f7523me.enable();
        } else {
            this.f7523me.disable();
        }
    }
}
