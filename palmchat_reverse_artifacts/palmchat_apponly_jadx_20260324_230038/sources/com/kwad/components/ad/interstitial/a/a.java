    ...
    public static boolean s(@NonNull AdTemplate adTemplate) {
        ...
        if (iDz < 0) {
            ...
            if (w.O(fileCr)) {
                ...
                zA = com.kwad.sdk.core.diskcache.b.a.IJ().a(strL, c0614a);
                str = c0614a.msg;
            }
            ...
            f fVarB = com.kwad.sdk.core.config.e.HT() == 1 ? com.kwad.sdk.core.videocache.c.a.b(ServiceProvider.getContext(), 1, 0) : com.kwad.sdk.core.config.e.HT() == 2 ? com.kwad.sdk.core.videocache.c.a.b(ServiceProvider.getContext(), 1, 1) : com.kwad.sdk.core.videocache.c.a.ca(ServiceProvider.getContext());
            zA = !fVarB.fb(strL) ? fVarB.a(strL, iDz * 1024, c0614a2, null) : true;
            str = c0614a2.msg;
            adTemplate.setDownloadSize(((long) iDz) * 1024);
