...
public final class b extends com.kwad.components.ad.b implements KsInterstitialAd {
    ...
    public final void showInterstitialAd(Activity activity, @Nullable KsVideoPlayConfig ksVideoPlayConfig) {
        ...
        if (com.kwad.sdk.core.config.e.GK() && (activity == null || activity.isFinishing())) {
        ...
        if (activity == null || activity.isFinishing()) {
            ...
            com.kwad.sdk.core.network.e eVar = com.kwad.sdk.core.network.e.aJi;
        ...
        if (!l.DP().CW()) {
            ...
            com.kwad.sdk.core.network.e eVar2 = com.kwad.sdk.core.network.e.aJj;
