...
public final class c extends a {
    ...
    private com.kwad.components.ad.interstitial.f.c eZ() {
        ...
        com.kwad.components.ad.interstitial.g.b bVar = new com.kwad.components.ad.interstitial.g.b(kSFrameLayout, com.kwad.sdk.core.config.e.GQ());
        cVar.kN = bVar;
        bVar.xJ();
        cVar.mw = this.mw;
        cVar.mm = this.mm;
    ...
    public final void fd() {
        if (this.mi != null) {
            this.mi.a(new c.C0488c(this.mContext).l(true).M(1).n(true).L(2));
        }
    }
    ...
    private d a(Context context, AdInfo adInfo, com.kwad.components.ad.interstitial.f.c cVar) {
        ...
        if (com.kwad.sdk.core.response.b.a.aX(adInfo) && aq.SM()) {
            z = false;
        }
        aVar.y(z);
