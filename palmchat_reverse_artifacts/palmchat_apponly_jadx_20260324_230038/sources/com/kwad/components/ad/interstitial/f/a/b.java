...
public final class b extends a {
    ...
    private aq.a getOpenNewPageListener() {
        return new aq.a() { // from class: com.kwad.components.ad.interstitial.f.a.b.8
            ...
            public final void a(com.kwad.components.core.webview.a.b bVar) {
                AdWebViewActivityProxy.launch(b.this.getContext(), new AdWebViewActivityProxy.a.C0552a().aH(bVar.title).aI(bVar.url).aI(true).q(b.this.mi.mAdResultData).rV());
            }
        };
    }
    ...
    public void d(double d) {
        this.mi.a(new c.C0488c(getContext()).m(true).c(d).L(2).a(this.mi.fV.getTouchCoords()).M(157));
    ...
    public final void a(t tVar, com.kwad.sdk.core.webview.b bVar) {
        ...
        this.ny = bVarI;
        if (bVarI != null) {
            bVarI.a(new b.InterfaceC0482b() { // from class: com.kwad.components.ad.interstitial.f.a.b.10
                @Override // com.kwad.components.ad.h.a.a.b.InterfaceC0482b
    ...
    private z a(com.kwad.sdk.core.webview.b bVar) {
        return new z(bVar, this.mi.mApkDownloadHelper, new com.kwad.sdk.core.webview.d.a.a() { // from class: com.kwad.components.ad.interstitial.f.a.b.2
            ...
            public final void a(com.kwad.sdk.core.webview.d.b.a aVar) {
                if (aVar != null) {
                    com.kwad.components.ad.interstitial.report.a.eP().a(b.this.mi.mAdTemplate, aVar.aSN, aVar.mH);
                    b.this.mi.mk = true;
                    b.this.mi.c(aVar.aSN, aVar.mH);
