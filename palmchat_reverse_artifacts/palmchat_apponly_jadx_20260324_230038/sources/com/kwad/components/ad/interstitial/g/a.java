        ...
        if (dVar != null && (ownerActivity = dVar.getOwnerActivity()) != null && !ownerActivity.isFinishing()) {
            ...
            if (iDP > com.kwad.sdk.core.response.b.a.cx(adInfoEr) && iDQ < com.kwad.sdk.core.response.b.a.cy(adInfoEr)) {
                ...
                if (com.kwad.sdk.core.response.b.a.cz(adInfoEr) == 1) {
                    new com.kwad.components.core.page.widget.a(ownerActivity, com.kwad.sdk.core.response.b.a.cA(adInfoEr), new a.InterfaceC0556a() { // from class: com.kwad.components.ad.interstitial.g.a.1
                    ...
                    com.kwad.sdk.core.adlog.c.d(cVar.mAdTemplate, new JSONObject(), new com.kwad.sdk.core.adlog.c.b().dx(149).dC(8));
                    return true;
                }
            }
        }
