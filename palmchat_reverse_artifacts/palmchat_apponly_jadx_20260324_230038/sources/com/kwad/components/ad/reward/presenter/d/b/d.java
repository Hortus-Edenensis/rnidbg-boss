...
public final class d extends com.kwad.components.ad.reward.presenter.b implements View.OnClickListener, c {
    ...
    public final void onClick(View view) {
        if (view == this.zs || view == this.zr) {
            com.kwad.components.core.e.d.a.a(new a.C0539a(view.getContext()).aE(this.tq.mAdTemplate).b(this.tq.mApkDownloadHelper).as(false).aD(2).a(new a.b() { // from class: com.kwad.components.ad.reward.presenter.d.b.d.2
