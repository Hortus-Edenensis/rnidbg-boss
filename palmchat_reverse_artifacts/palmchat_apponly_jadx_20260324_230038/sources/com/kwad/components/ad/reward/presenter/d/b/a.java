...
public final class a extends com.kwad.components.ad.reward.presenter.b implements View.OnClickListener, c {
    ...
    public final void onClick(View view) {
        if (view == this.zk || view == this.zl) {
            com.kwad.components.core.e.d.a.a(new a.C0539a(view.getContext()).aE(this.tq.mAdTemplate).b(this.tq.mApkDownloadHelper).as(false).aD(1).a(new a.b() { // from class: com.kwad.components.ad.reward.presenter.d.b.a.1
