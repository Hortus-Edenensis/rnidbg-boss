...
public abstract class d extends com.kwad.components.ad.reward.presenter.b implements DialogInterface.OnDismissListener, com.kwad.components.ad.reward.k.a.e, y.a {
    ...
    private bj.b zS = new bj.b() { // from class: com.kwad.components.ad.reward.presenter.f.d.1
        ...
        public final void ae(int i) {
            ...
            com.kwad.components.core.e.d.a.a(new a.C0539a(d.this.getContext()).aE(d.this.tq.mAdTemplate).b(d.this.tq.mApkDownloadHelper).as(false));
    ...
    public void a(t tVar, com.kwad.sdk.core.webview.b bVar) {
        ...
        dVar.a(new d.a() { // from class: com.kwad.components.ad.reward.presenter.f.d.11
            ...
            public final void a(final q qVar) {
                com.kwad.components.core.e.d.a.a(new a.C0539a(d.this.getContext()).aE(d.this.tq.mAdTemplate).b(d.this.tq.mApkDownloadHelper).aD(1).a(new a.b() { // from class: com.kwad.components.ad.reward.presenter.f.d.11.1
        ...
        eVar.a(new e.a() { // from class: com.kwad.components.ad.reward.presenter.f.d.12
            ...
            public final void kh() {
                com.kwad.components.core.e.d.a.a(new a.C0539a(d.this.getContext()).aE(d.this.tq.mAdTemplate).b(d.this.tq.mApkDownloadHelper).aD(2).a(new a.b() { // from class: com.kwad.components.ad.reward.presenter.f.d.12.1
                    @Override // com.kwad.components.core.e.d.a.b
                    public final void onAdClicked() {
                        d.this.kc();
                    }
    ...
    */
    public final void a(a.C0563a c0563a) {
        a.c cVar;
        com.kwad.components.ad.reward.g gVar = this.tq;
        if (gVar == null || gVar.rG == null) {
            return;
        }
        try {
            cVar = new a.c();
            cVar.parseJson(new JSONObject(c0563a.agc));
            switch (c0563a.agb) {
                case "adClickCallback":
                    this.tq.rG.cV();
                    break;
                case "videoPlayStartCallback":
                    this.tq.rG.onVideoPlayStart();
                    break;
                case "videoPlayErrorCallback":
                    this.tq.rG.onVideoPlayError(cVar.errorCode, cVar.agd);
                    break;
                case "videoPlayEndCallback":
                    this.tq.rG.onVideoPlayEnd();
                    break;
                case "adSkipWithPlayTimeCallback":
                    this.tq.rG.onVideoSkipToEnd(cVar.age);
                    break;
                case "adCloseCallback":
                    this.tq.rG.i(cVar.agf);
                    break;
