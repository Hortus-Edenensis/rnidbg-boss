...
public final class c extends com.kwad.components.ad.reward.presenter.b implements d {
    ...
    private void d(View view, final boolean z) {
        com.kwad.components.core.e.d.a.a(new a.C0539a(view.getContext()).aE(this.mAdTemplate).a(new a.b() { // from class: com.kwad.components.ad.reward.presenter.platdetail.c.1
