...
public class KsRewardVideoAdControl implements com.kwad.components.core.internal.api.a, KsRewardVideoAd {
    ...
    private void gr() {
        ...
        this.mAdTemplate.isNativeRewardPreview = com.kwad.sdk.core.response.b.a.cg(this.mAdInfo) && !z;
    }
    ...
    public List<KSAdInfoData> getKSAdInfoDatas() {
        ...
        if (com.kwad.sdk.core.config.e.a(com.kwad.sdk.core.config.c.aGa) && (adResultData = this.mAdResultData) != null && adResultData.getAdTemplateList().size() > 0) {
            Iterator<AdTemplate> it = this.mAdResultData.getAdTemplateList().iterator();
            while (it.hasNext()) {
                arrayList.add(com.kwad.sdk.core.response.b.a.dl(com.kwad.sdk.core.response.b.e.er(it.next())));
            }
        }
        return arrayList;
    }
    ...
    public void showRewardVideoAd(Activity activity, KsVideoPlayConfig ksVideoPlayConfig) {
        ...
        if (!com.kwad.sdk.core.config.e.HU() && !isAdEnable()) {
    ...
    public static /* synthetic */ boolean a(KsRewardVideoAdControl ksRewardVideoAdControl, boolean z) {
