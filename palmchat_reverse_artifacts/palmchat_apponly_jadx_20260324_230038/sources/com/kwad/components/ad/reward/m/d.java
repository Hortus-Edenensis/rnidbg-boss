...
public final class d extends com.kwad.components.ad.k.b implements g.a {
    ...
    private void br() {
        ...
        this.Mp.a(new b.a(this.mAdTemplate).dt(this.BE).du(h.b(com.kwad.sdk.core.response.b.e.es(this.mAdTemplate))).a(this.mVideoPlayerStatus).b(com.kwad.sdk.contentalliance.a.a.a.bT(this.mAdTemplate)).Ga(), this.mDetailVideoView);
    ...
    public final void le() {
        Iterator<Object> it = this.BI.iterator();
        while (it.hasNext()) {
            it.next();
        }
    }
