...
public class c extends b {
    ...
    public int iE() {
        getContext();
        if (com.kwad.components.ad.reward.g.O(this.tq.mAdTemplate) && !aq.SM()) {
            return 0;
        }
        if (com.kwad.components.ad.reward.g.N(this.tq.mAdTemplate) && !aq.SM()) {
            return 0;
        }
        if ((!com.kwad.sdk.core.response.b.e.eD(this.tq.mAdTemplate) || aq.SM()) && !com.kwad.components.ad.reward.g.g(this.vD)) {
            return (com.kwad.sdk.core.response.b.a.cK(this.vD) && com.kwad.components.ad.reward.a.b.hN() && !aq.SM()) ? 0 : 8;
        }
        return 0;
    }
