...
public class f extends a implements j, a.InterfaceC0546a {
    ...
    public final void onUnbind() {
        super.onUnbind();
        this.tq.b((a.InterfaceC0546a) this);
    ...
    public final void a(@Nullable com.kwad.sdk.core.webview.d.b.a aVar) {
        ...
        if (aVar.adTemplate != null && !aVar.aSP) {
            this.tq.rG.cV();
            return;
        }
        ...
        tVar.c(new com.kwad.components.core.webview.jshandler.j(new p() { // from class: com.kwad.components.ad.reward.presenter.f.f.4
            ...
            public final void a(com.kwad.components.core.webview.jshandler.j jVar, String str) {
                if (TextUtils.equals(str, "autoCallApp")) {
                    jVar.ba(com.kwad.components.ad.reward.g.g(com.kwad.sdk.core.response.b.e.er(f.this.tq.mAdTemplate)) && com.kwad.sdk.core.local.a.Jl() && f.this.tq.mScreenOrientation == 0);
                }
            }
        }));
    }
