...
public class RewardRetryTaskManagerImpl implements RewardRetryTaskManager {
    ...
    private void performConvert(@NonNull final Context context, final AdTemplate adTemplate, com.kwad.components.core.e.d.d dVar, final RewardRetryTaskManager.RetryRewardConvertResultListener retryRewardConvertResultListener) {
        a.C0539a c0539aA = new a.C0539a(m.wrapContextIfNeed(context)).aE(adTemplate).b(dVar).a(new a.b() { // from class: com.kwad.components.ad.reward.retryReward.RewardRetryTaskManagerImpl.1
            ...
            public final void onAdClicked() {
                ...
                GlobalThreadPools.Lq().execute(new bg() { // from class: com.kwad.components.ad.reward.retryReward.RewardRetryTaskManagerImpl.1.1
        ...
        com.kwad.components.core.e.d.c.q(c0539aA);
    }
