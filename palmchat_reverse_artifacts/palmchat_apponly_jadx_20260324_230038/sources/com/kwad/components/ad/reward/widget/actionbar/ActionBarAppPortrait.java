...
public class ActionBarAppPortrait extends LinearLayout implements d {
    ...
    private void lB() {
        ...
        boolean z = !TextUtils.isEmpty(strAA);
    ...
    private void d(View view, final boolean z) {
        ...
        com.kwad.components.core.e.d.a.a(new a.C0539a(view.getContext()).aE(this.mAdTemplate).b(this.mApkDownloadHelper).aB(1).aC(i).as(view == this.EO).aD(i).a(new a.b() { // from class: com.kwad.components.ad.reward.widget.actionbar.ActionBarAppPortrait.2
