...
public final class a extends com.kwad.components.ad.reward.presenter.b implements View.OnClickListener, ca.a {
    ...
    public final void onClick(View view) {
        if (view == this.yC || view == this.yD) {
            com.kwad.components.core.e.d.a.a(new a.C0539a(view.getContext()).aE(this.mAdTemplate).b(this.mApkDownloadHelper).aD(2).A(this.tq.rH.getPlayDuration()).a(new a.b() { // from class: com.kwad.components.ad.reward.presenter.platdetail.a.a.5
