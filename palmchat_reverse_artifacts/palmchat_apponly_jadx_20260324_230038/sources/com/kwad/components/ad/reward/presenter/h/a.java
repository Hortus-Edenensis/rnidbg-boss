...
public final class a extends g implements j {
    ...
    private final m jE = new m() { // from class: com.kwad.components.ad.reward.presenter.h.a.3
        ...
        public final void onMediaPlayProgress(long j, long j2) {
            ...
            long jAN = ((long) com.kwad.sdk.core.response.b.a.aN(a.this.mAdInfo)) * 1000;
    ...
    public final void as() {
        ...
        if (aq.SM()) {
            ...
            this.Ax = ((long) com.kwad.sdk.core.response.b.a.aM(adInfoEr)) * 1000;
            e eVar = this.tq.rH;
            if (eVar != null) {
                eVar.a(this.jE);
            }
    ...
    public final void a(@Nullable com.kwad.sdk.core.webview.d.b.a aVar) {
        this.tq.rG.cV();
        c.d("jky", "onAdClicked convertPageType: " + aVar.aSM);
        if (com.kwad.sdk.core.response.b.a.aP(this.mAdInfo)) {
            com.kwad.components.core.q.a.ua().bo(aVar.aSM);
            if (aVar.aSM == -1) {
                com.kwad.components.core.q.a.ua().aT(false);
                com.kwad.components.core.q.a.ua().bp(0);
            } else {
