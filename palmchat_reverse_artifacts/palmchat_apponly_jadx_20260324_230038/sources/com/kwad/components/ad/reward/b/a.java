...
public final class a extends d implements View.OnClickListener {
    ...
    public static class C0502a {
        ...
        private C0502a(@NonNull CouponInfo couponInfo) {
        ...
        @Nullable
        private static C0502a a(CouponInfo couponInfo) {
            if (couponInfo == null) {
                return null;
            }
            return new C0502a(couponInfo);
        }
        ...
        @Nullable
        public static C0502a Q(AdTemplate adTemplate) {
    ...
    private void a(C0502a c0502a) {
        ...
        if (textView != null) {
            textView.setText(c0502a.getTitle());
        }
        TextView textView2 = this.tQ;
        if (textView2 != null) {
            textView2.setText(c0502a.Q(this.mRootContainer.getContext()));
        }
        TextView textView3 = this.fv;
        if (textView3 != null) {
            textView3.setText(c0502a.hS());
        }
        Button button = this.tR;
        if (button != null) {
            button.setText(c0502a.hT());
        }
    }
