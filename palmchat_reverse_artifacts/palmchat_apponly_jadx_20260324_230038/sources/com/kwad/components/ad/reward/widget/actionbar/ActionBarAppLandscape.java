...
public class ActionBarAppLandscape extends LinearLayout implements d {
    ...
    private void lB() {
        ...
        boolean zIsEmpty = true ^ TextUtils.isEmpty(strAA);
        if (zIsEmpty) {
    ...
    private void d(View view, final boolean z) {
        com.kwad.components.core.e.d.a.a(new a.C0539a(view.getContext()).aE(this.mAdTemplate).b(this.mApkDownloadHelper).as(view == this.EO).aD(view == this.EP ? 1 : 2).a(new a.b() { // from class: com.kwad.components.ad.reward.widget.actionbar.ActionBarAppLandscape.2
