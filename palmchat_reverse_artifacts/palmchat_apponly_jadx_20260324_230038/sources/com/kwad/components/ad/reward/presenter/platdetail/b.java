...
public final class b extends com.kwad.components.ad.reward.presenter.b {
    ...
    private Animator q(View view) {
        ...
        float fTx = this.xM.Tx() / this.xL.Tx();
        ObjectAnimator objectAnimatorOfFloat2 = ObjectAnimator.ofFloat(view, "scaleX", 1.0f, fTw);
        ObjectAnimator objectAnimatorOfFloat3 = ObjectAnimator.ofFloat(view, "scaleY", 1.0f, fTx);
