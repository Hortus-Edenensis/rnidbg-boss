...
public final class o extends b implements View.OnClickListener, com.kwad.components.ad.reward.presenter.platdetail.actionbar.a {
    ...
    private synchronized void iJ() {
        ...
        com.kwad.sdk.core.adlog.c.d(this.tq.mAdTemplate, (JSONObject) null, new com.kwad.sdk.core.adlog.c.b().dx(192).aw(this.tq.rH.getPlayDuration()));
        this.wf = true;
    }
    ...
    public final void onClick(View view) {
        ...
        com.kwad.sdk.core.adlog.c.e(this.tq.mAdTemplate, null, new com.kwad.sdk.core.adlog.c.b().dx(192).aw(this.tq.rH.getPlayDuration()));
    }
