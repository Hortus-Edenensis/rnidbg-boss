...
public class ActionBarH5 extends FrameLayout implements d {
    ...
    private void d(View view, final boolean z) {
        com.kwad.components.core.e.d.a.a(new a.C0539a(view.getContext()).aE(this.mAdTemplate).aD(view == this.EW ? 1 : 2).a(new a.b() { // from class: com.kwad.components.ad.reward.widget.actionbar.ActionBarH5.1
