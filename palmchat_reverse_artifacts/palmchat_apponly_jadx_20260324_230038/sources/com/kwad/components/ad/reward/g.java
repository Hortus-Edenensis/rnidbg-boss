...
public final class g extends com.kwad.components.core.m.a {
    ...
    private List<a> sD;
    private List<b> sE;
    private List<a.InterfaceC0546a> sF;
    private boolean sa;
    public boolean sb;
    public boolean sc;
    ...
    public final void d(DialogInterface dialogInterface) {
        Iterator<DialogInterface.OnDismissListener> it = this.sn.iterator();
        while (it.hasNext()) {
    ...
    public final List<a.InterfaceC0546a> gS() {
        return this.sF;
    }
    ...
    public final void a(long j, long j2, int i) {
        Iterator<com.kwad.components.ad.reward.e.e> it = this.rR.iterator();
        while (it.hasNext()) {
            it.next().dr();
        }
    }
    ...
    public final void b(a.InterfaceC0546a interfaceC0546a) {
        List<a.InterfaceC0546a> list = this.sF;
        if (list != null) {
            list.remove(interfaceC0546a);
        }
    }
    ...
    public final void a(int i, Context context, final int i2, int i3, long j, boolean z, final com.kwad.sdk.core.adlog.c.b bVar) {
        com.kwad.components.core.e.d.a.a(new a.C0539a(context).aE(this.mAdTemplate).b(this.mApkDownloadHelper).as(false).aD(i3).A(j).aC(i2).aB(i).ao(gJ()).a(new Callable<String>() { // from class: com.kwad.components.ad.reward.g.8
            /* JADX INFO: Access modifiers changed from: private */
