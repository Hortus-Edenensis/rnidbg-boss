...
public final class a {
    ...
    public static void a(Context context, @NonNull final SoLoadListener soLoadListener) {
        ...
        if (AbiUtil.isArm64(context)) {
            ...
            if (TextUtils.isEmpty(strGR)) {
                strGR = zUseTkLite ? "https://p1-lm.adkwai.com/udata/pkg/KS-Android-KSAdSDk/tachikoma/3.3.58/ks_tk_so_v8_lite_3358" : "https://p1-lm.adkwai.com/udata/pkg/KS-Android-KSAdSDk/tachikoma/3.3.58/ks_tk_so_v8_3358";
            }
            ...
            strGR = e.GR();
            if (TextUtils.isEmpty(strGR)) {
                strGR = zUseTkLite ? "https://p1-lm.adkwai.com/udata/pkg/KS-Android-KSAdSDk/tachikoma/3.3.58/ks_tk_so_v7_lite_3358" : "https://p1-lm.adkwai.com/udata/pkg/KS-Android-KSAdSDk/tachikoma/3.3.58/ks_tk_so_v7_3358";
            }
        ...
        b bVar = new b();
        bVar.avM = com.kwad.sdk.core.network.idc.a.Jz().es(strGR);
        bVar.enable = true;
        bVar.avL = str;
    ...
    public static boolean useTkLite() {
        if (apc == null) {
            apc = Boolean.valueOf(!e.a(com.kwad.sdk.core.config.c.aDN));
        }
