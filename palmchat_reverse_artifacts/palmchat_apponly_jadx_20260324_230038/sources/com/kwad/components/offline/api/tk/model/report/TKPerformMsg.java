...
public class TKPerformMsg extends BaseOfflineCompoJsonParse<TKPerformMsg> implements Serializable {
    ...
    public void parseJson(TKPerformMsg tKPerformMsg, JSONObject jSONObject) {
        ...
        tKPerformMsg.source = jSONObject.optInt(az.at);
        ...
        tKPerformMsg.templateId = jSONObject.optString(WfConstant.EXTRA_KEY_TEMPLATE_ID);
        if (jSONObject.opt(WfConstant.EXTRA_KEY_TEMPLATE_ID) == JSONObject.NULL) {
    ...
    public JSONObject toJson(TKPerformMsg tKPerformMsg, JSONObject jSONObject) {
        ...
        if (i != 0) {
            JsonHelper.putValue(jSONObject, az.at, i);
        }
        ...
        if (str3 != null && !str3.equals("")) {
            JsonHelper.putValue(jSONObject, WfConstant.EXTRA_KEY_TEMPLATE_ID, tKPerformMsg.templateId);
        }
