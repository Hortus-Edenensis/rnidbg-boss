...
public final class NativeExceptionMessage extends ExceptionMessage {
    ...
    public String mFingerprint = MediaInfo.RENDERER_TYPE_UNKNOWN;
    public String mRevision = MediaInfo.RENDERER_TYPE_UNKNOWN;
    public String mRegister = MediaInfo.RENDERER_TYPE_UNKNOWN;
    public String mSignal = MediaInfo.RENDERER_TYPE_UNKNOWN;
    public String mCode = MediaInfo.RENDERER_TYPE_UNKNOWN;
    public String mManuallyKill = MediaInfo.RENDERER_TYPE_UNKNOWN;
    public String mFaultAddr = MediaInfo.RENDERER_TYPE_UNKNOWN;
