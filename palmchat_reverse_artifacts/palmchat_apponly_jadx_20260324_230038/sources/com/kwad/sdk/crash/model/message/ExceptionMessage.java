...
public abstract class ExceptionMessage implements b, Serializable {
    ...
    public String mCrashDetail = MediaInfo.RENDERER_TYPE_UNKNOWN;
    public String mMemoryInfo = MediaInfo.RENDERER_TYPE_UNKNOWN;
    public String mDiskInfo = MediaInfo.RENDERER_TYPE_UNKNOWN;
    public String mProcessName = MediaInfo.RENDERER_TYPE_UNKNOWN;
    public int mExceptionType = 0;
    public String mCrashType = getTypeCommon();
    public String mThreadName = MediaInfo.RENDERER_TYPE_UNKNOWN;
    public String mIsAppOnForeground = MediaInfo.RENDERER_TYPE_UNKNOWN;
    public String mLogUUID = MediaInfo.RENDERER_TYPE_UNKNOWN;
    public String mVirtualApp = MediaInfo.RENDERER_TYPE_UNKNOWN;
    public String mCustomMsg = MediaInfo.RENDERER_TYPE_UNKNOWN;
    public String mThreadOverflow = MediaInfo.RENDERER_TYPE_UNKNOWN;
    public String mFdOverflow = MediaInfo.RENDERER_TYPE_UNKNOWN;
    public String mTaskId = MediaInfo.RENDERER_TYPE_UNKNOWN;
    public String mErrorMessage = "";
    public String mVersionCode = MediaInfo.RENDERER_TYPE_UNKNOWN;
    public boolean mVersionConflict = false;
    public String mAppVersionBeforeLastUpload = MediaInfo.RENDERER_TYPE_UNKNOWN;
    ...
    public String mAbi = MediaInfo.RENDERER_TYPE_UNKNOWN;
