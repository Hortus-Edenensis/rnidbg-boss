...
public final class g {
    ...
    private static final File aVU = new File("/proc/self/fd");
    private static final File aVV = new File("/proc/self/task");
    ...
    public static void F(File file) throws Throwable {
        try {
            d.a(SystemUtil.fp(21) ? new String[]{"logcat", "-v", "threadtime", "-b", "main", "-b", "system", "-b", com.umeng.analytics.pro.f.ax, "-b", "crash", "-d", "-f", file.getPath()} : new String[]{"logcat", "-v", "threadtime", "-b", "main", "-b", "system", "-b", com.umeng.analytics.pro.f.ax, "-d", "-f", file.getPath()}, 0);
        } catch (IOException e) {
    ...
    public static void I(File file) {
        try {
            ...
            z.callMethod(field, "dumpGfxInfo", fileDescriptor2, new String[]{SystemUtil.getProcessName(com.kwad.sdk.crash.e.Nj().getContext())});
        } catch (Exception e) {
            com.kwad.sdk.core.d.c.printStackTraceOnly(e);
        }
    }
    ...
    public static void a(ExceptionMessage exceptionMessage, int i) {
        com.kwad.sdk.crash.h hVarNp = com.kwad.sdk.crash.e.Nj().Np();
        if (hVarNp == null) {
            com.kwad.sdk.core.d.c.d("tag", "getter is null!");
        } else {
            exceptionMessage.mCustomMsg = hVarNp.oW().toString();
        }
    }
    ...
    private static void e(@NonNull ExceptionMessage exceptionMessage) {
        exceptionMessage.mVirtualApp = com.kwad.sdk.crash.e.Nj().Nm();
        exceptionMessage.mVersionCode = com.kwad.sdk.crash.e.Nj().getSdkVersion();
    }
    ...
    private static void a(@NonNull ExceptionMessage exceptionMessage, @Nullable Context context) {
        if (exceptionMessage instanceof JavaExceptionMessage) {
            if (MediaInfo.RENDERER_TYPE_UNKNOWN.equals(exceptionMessage.mThreadName)) {
        ...
        exceptionMessage.mUsageTimeMills = com.kwad.sdk.crash.e.Nj().Nq();
        exceptionMessage.mAbi = AbiUtil.isArm64(context) ? "arm64" : "arm";
        exceptionMessage.mVersionConflict = TextUtils.equals(exceptionMessage.mVersionCode, ExceptionMessage.getSdkCrashVersionName("1.0", com.kwad.sdk.crash.e.Nj().Nn()));
    ...
    private static void b(@NonNull ExceptionMessage exceptionMessage, @Nullable Context context) {
        ...
        if (!com.kwad.sdk.crash.d.aTG.matcher(absolutePath).matches() && !com.kwad.sdk.crash.d.aTH.matcher(absolutePath).matches()) {
            Matcher matcher = com.kwad.sdk.crash.d.aTI.matcher(absolutePath);
            Matcher matcher2 = com.kwad.sdk.crash.d.aTJ.matcher(absolutePath);
            if (matcher.matches()) {
    ...
    private static void a(ExceptionMessage exceptionMessage, MemoryInfo memoryInfo, @Nullable Context context) throws Throwable {
        SystemUtil.a aVarTF = SystemUtil.TF();
        aVarTF.bfY = Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory();
        aVarTF.bfU = SystemUtil.TE();
        long pss = Debug.getPss();
        aVarTF.bfX = pss;
        memoryInfo.mTotalMB = (int) (aVarTF.bfU / 1048576);
        memoryInfo.mJavaHeapLimitMB = (int) (com.kwad.sdk.crash.d.aTF / 1048576.0d);
        memoryInfo.mJavaHeapMB = (int) (aVarTF.bfY / 1048576);
        memoryInfo.mVssMB = (int) (aVarTF.bfV / 1024);
        memoryInfo.mRssMB = (int) (aVarTF.bfW / 1024);
        memoryInfo.mPssMB = (int) (pss / 1024);
        memoryInfo.mThreadsCount = aVarTF.mThreadsCount;
        memoryInfo.mFdCount = NT();
        if (context != null) {
            memoryInfo.mAvailableMB = (int) (SystemUtil.ea(context) / 1048576);
        }
        ...
        if (memoryInfo.mFdCount > 800) {
            ...
            File[] fileArrListFiles = aVU.listFiles();
    ...
    private static void a(MemoryInfo memoryInfo) {
        ...
        for (File file : fileArrListFiles) {
            ...
            if (!TextUtils.isEmpty(threadInfo.mName)) {
                threadInfo.mName = ak(threadInfo.mName, "\n");
