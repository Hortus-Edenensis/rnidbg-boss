...
public final class c extends b {
    ...
    public static class a {
        private static final c aUb = new c(0);
    }
    ...
    public final void init(File file, com.kwad.sdk.crash.f fVar, e eVar) {
        ...
        if (com.kwad.sdk.crash.e.Nj().isDebug()) {
    ...
    private void a(@NonNull Throwable th, @NonNull ExceptionMessage exceptionMessage, @Nullable Context context, boolean z) throws Throwable {
        ...
        try {
            ...
            if (this.mLogDir.exists() || this.mLogDir.mkdirs()) {
                ...
                exceptionMessage.mErrorMessage += "create " + Ny().mLogDir.getPath() + " failed!\n";
                z2 = false;
            }
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            com.kwad.sdk.n.b.QF().gW(exceptionMessage.mCrashDetail);
                            return;
                        } catch (Throwable th3) {
                            if (uploader != null) {
                                try {
