...
public class g {
    ...
    private static Messenger bdr;
    private static volatile ExecutorService bds;
    private static volatile AppStatusRules bdt;
    private static com.kwad.sdk.collector.h bdu;
        ...
        public final void doTask() {
            com.kwad.sdk.collector.c.a(this.dq, new c.a() { // from class: com.kwad.sdk.utils.g.2.1
                ...
                public final void b(AppStatusRules appStatusRules) {
                    ...
                    AppStatusRules unused = g.bdt = appStatusRules;
                    g.b(AnonymousClass2.this.dq, g.bdt);
                    g.cC(AnonymousClass2.this.dq);
                    boolean zEp = br.ep(AnonymousClass2.this.dq);
                    boolean zIsAppStatusTargetNotEmpty = AppStatusRules.isAppStatusTargetNotEmpty(g.bdt);
                    com.kwad.sdk.core.d.c.d("AppStatusHelper", "appStatusTargetNotEmpty: " + zIsAppStatusTargetNotEmpty + ", permissionGranted: " + zEp);
                    if (zEp && zIsAppStatusTargetNotEmpty) {
                        long jObtainDefaultScanInterval = g.bdt.obtainDefaultScanInterval();
                    ...
                    boolean zIsUploadTargetNotEmpty = AppStatusRules.isUploadTargetNotEmpty(g.bdt);
                    boolean z = g.bdt.obtainUploadConfigFileMaxSize() > 0;
                    com.kwad.sdk.core.d.c.d("AppStatusHelper", "uploadTargetNotEmpty: " + zIsUploadTargetNotEmpty + ", enableUpload: " + z);
                    if (zIsUploadTargetNotEmpty && z && zEp) {
                        g.Ri();
                        g.bds.submit(new Runnable() { // from class: com.kwad.sdk.utils.g.2.1.1
                            @Override // java.lang.Runnable
                            public final void run() {
                                try {
                                    com.kwad.sdk.collector.j.a(AnonymousClass2.this.dq, g.bdt);
                                } catch (Throwable th) {
    ...
    public static AppStatusRules Rg() {
        return bdt;
    }
    ...
    public static boolean Rh() {
        if (bdr == null) {
            try {
                bdr = new Messenger(new c(Looper.getMainLooper()));
    ...
    public static void Ri() {
        if (bds == null) {
            synchronized (g.class) {
                if (bds == null) {
                    ExecutorService executorServiceLp = GlobalThreadPools.Lp();
                    bds = executorServiceLp;
                    com.kwad.sdk.core.threads.c.a((ThreadPoolExecutor) executorServiceLp, "appStatusHelper");
                }
            }
        }
    }
    ...
    public static void a(Context context, long j, com.kwad.sdk.collector.h hVar) {
        ...
        if (zIsInMainProcess) {
            ...
            aiA.postDelayed(new AnonymousClass2(context), 30000L);
        }
    }
    ...
    public static void cE(Context context) {
        ...
        boolean zRj = Rj();
        com.kwad.sdk.core.d.c.d("AppStatusHelper", "isServiceAvailable: " + zRj);
        if (zRj) {
    ...
    private static List<com.kwad.sdk.collector.model.b> cG(Context context) {
        ...
        AppStatusRules appStatusRulesRg = Rg();
        for (AppStatusRules.Strategy strategy : com.kwad.sdk.collector.i.c(appStatusRulesRg)) {
            arrayList.addAll(a(strategy));
            strategy.setNeedSaveLaunchTime(System.currentTimeMillis());
        }
        AppStatusRules.Strategy strategyD = com.kwad.sdk.collector.i.d(appStatusRulesRg);
    ...
    public static class a implements com.kwad.sdk.core.b {
        ...
        private List<Long> bdA = new ArrayList();
        ...
        public final void parseJson(@Nullable JSONObject jSONObject) {
            ...
            this.appName = jSONObject.optString(WfConstant.EVENT_KEY_APP_NAME);
            ...
            if (jSONArrayOptJSONArray != null) {
                ...
                for (int i = 0; i < length; i++) {
                    try {
                        this.bdA.add(Long.valueOf(jSONArrayOptJSONArray.getLong(i)));
        ...
        public final JSONObject toJson() {
            ...
            aa.putValue(jSONObject, WfConstant.EVENT_KEY_APP_NAME, this.appName);
            aa.putValue(jSONObject, "packageName", this.packageName);
            JSONArray jSONArray = new JSONArray();
            Iterator<Long> it = this.bdA.iterator();
            while (it.hasNext()) {
    ...
    public static void a(final Context context, final b bVar) {
        ...
        Ri();
        bds.submit(new Runnable() { // from class: com.kwad.sdk.utils.g.4
            @Override // java.lang.Runnable
            public final void run() {
                List listCF;
                try {
                    HashSet hashSet = new HashSet();
                    if (!br.ep(context) || (listCF = g.cF(context)) == null) {
                        return;
                    }
                    Iterator it = listCF.iterator();
                    while (it.hasNext()) {
    ...
    private static List<com.kwad.sdk.collector.model.b> a(AppStatusRules.Strategy strategy) {
        ...
        return com.kwad.sdk.collector.b.Fr().a(strategy);
    }
                ...
                if (data.containsKey("allStrategyJson")) {
                    ...
                    if (string != null) {
                        listA2 = aa.a(string, new com.kwad.sdk.core.c<AppStatusRules.Strategy>() { // from class: com.kwad.sdk.utils.g.c.2
                            private static AppStatusRules.Strategy Rt() {
