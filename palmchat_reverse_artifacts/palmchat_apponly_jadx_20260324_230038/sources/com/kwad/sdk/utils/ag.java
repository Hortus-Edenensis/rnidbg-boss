...
public final class ag {
    ...
    public static String Sm() {
        Context context = getContext();
        return context == null ? "" : bn.TB() ? b(context, "ksadsdk_splash_local_ad_force_active", "KEY_SPLASH_DAILY_SHOW_COUNT", "") : b(context, "ksadsdk_splash_daily_show_count", "KEY_SPLASH_DAILY_SHOW_COUNT", "");
    }

    public static String Sn() {
        Context context = getContext();
        return context == null ? "" : bn.TD() ? h("ksadsdk_reward_full_ad_jump_direct", "KEY_REWARD_AUTO_CALL_APP_CARD_SHOW_COUNT", "") : b(context, "ksadsdk_reward_auto_call_app_card_show_count", "KEY_REWARD_AUTO_CALL_APP_CARD_SHOW_COUNT", "");
    }
    ...
    public static boolean Ss() {
        return !TextUtils.isEmpty(Sr());
    }

    public static boolean St() {
        return (TextUtils.isEmpty(Sq()) || Su()) ? false : true;
    }

    private static boolean Su() {
        long jCurrentTimeMillis = (System.currentTimeMillis() - Sj()) / 1000;
        long jSi = Si();
        return jSi != 0 && jCurrentTimeMillis >= jSi;
    }
