...
public final class h {
    ...
    public static String Co() {
        String str = "https://" + com.kwad.sdk.core.network.idc.a.Jz().X("api", "open.e.kuaishou.com");
        com.kwad.sdk.components.d.f(DevelopMangerComponents.class);
        return str;
    }

    private static String Cp() {
        return "https://" + com.kwad.sdk.core.network.idc.a.Jz().X("eapi", "api.e.kuaishou.com");
    }
