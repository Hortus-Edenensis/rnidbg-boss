...
public class LruDiskCache implements DiskCache {
    ...
    public void clear() {
        ...
        try {
            initCache(this.cache.getDirectory(), this.reserveCacheDir, this.cache.getMaxSize(), this.cache.ID());
    ...
    public boolean save(String str, InputStream inputStream, IoUtils.CopyListener copyListener) {
        a.C0604a c0604aDR = this.cache.dR(getKey(str));
        if (c0604aDR == null) {
            return false;
        }
        BufferedOutputStream bufferedOutputStream = new BufferedOutputStream(c0604aDR.dK(0), this.bufferSize);
        try {
