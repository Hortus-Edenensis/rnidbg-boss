...
final class a extends SQLiteOpenHelper implements c {
    private static final String[] aQw = {"_id", "url", "length", IMediaFormat.KEY_MIME};
    ...
    public final n fi(String str) throws Throwable {
        ...
        n nVarH = null;
        try {
            cursorQuery = getReadableDatabase().query("SourceInfo", aQw, "url=?", new String[]{str}, null, null, null);
            if (cursorQuery != null) {
                try {
    ...
    private static ContentValues a(n nVar) {
        ...
        contentValues.put("length", Long.valueOf(nVar.aQq));
        contentValues.put(IMediaFormat.KEY_MIME, nVar.aQr);
