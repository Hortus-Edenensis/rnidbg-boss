...
public class b implements c<Activity> {
    ...
    public static Activity getCurrentActivity() {
        ...
        if (a.Jg().isEnable()) {
            return a.Jg().getCurrentActivity();
        }
        return null;
    }
    ...
    public static boolean isAppOnForeground() {
        ...
        if (a.Jg().isEnable()) {
            return a.Jg().isAppOnForeground();
        }
        return false;
    }

    public static boolean isEnable() {
        return Jj() || a.Jg().isEnable();
    }
    ...
    public final void init(Context context) {
        ...
        Application applicationUS = m.US();
        if (applicationUS != null) {
            this.mApplication = applicationUS;
            a.Jg().init(this.mApplication);
            a.Jg().a(this);
        }
    }
