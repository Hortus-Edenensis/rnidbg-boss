...
public class AdResultData extends BaseResultData {
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:18:0x007b -> B:55:0x007e). Please report as a decompilation issue!!! */
    ...
    public void parseJson(JSONObject jSONObject) {
        ...
        try {
            ...
            String strOptString2 = jSONObject.optString("adGlobalConfigInfo");
            eVar = (e) d.f(e.class);
            if (!bp.isNullString(strOptString2)) {
                String responseData = eVar.getResponseData(strOptString2);
            ...
            try {
                String strOptString3 = jSONObject.optString("pageInfo");
                if (!bp.isNullString(strOptString3)) {
                    this.pageInfo.parseJson(new JSONObject(eVar.getResponseData(strOptString3)));
                }
            } catch (Exception e) {
                c.d("json bug", e.toString());
                c.printStackTrace(e);
            }
            strOptString = jSONObject.optString("impAdInfo");
        } catch (Throwable th2) {
        ...
        String responseData2 = eVar.getResponseData(strOptString);
        try {
            ...
            try {
                ...
                com.kwad.sdk.commercial.e.a.a(this.mScene, this.llsid, strOptString, responseData2);
                jSONArray = null;
            }
            ...
            for (int i = 0; i < jSONArray.length(); i++) {
                ...
                if (jSONObjectOptJSONObject != null) {
                    ...
                    if (sceneImpl != null && !styleMatch(sceneImpl, adTemplate)) {
                        ...
                        com.kwad.sdk.commercial.e.a.c(adTemplate, MapBundleKey.MapObjKey.OBJ_AD_STYLE, String.valueOf(i2));
                    }
                }
            }
            return;
        } catch (Throwable unused2) {
            com.kwad.sdk.commercial.e.a.a(this.mScene, this.llsid, strOptString);
            return;
        }
        c.printStackTrace(th2);
    }
