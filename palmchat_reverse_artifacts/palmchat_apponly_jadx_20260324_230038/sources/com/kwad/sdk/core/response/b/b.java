...
public final class b {
    private static Random aNB = new Random();
    ...
    public static long cG(@NonNull AdTemplate adTemplate) {
        return ((long) cD(adTemplate).changeTime) * 1000;
    }
    ...
    public static AdMatrixInfo.RotateInfo m65do(@NonNull AdTemplate adTemplate) {
        try {
    ...
    public static boolean dD(AdTemplate adTemplate) {
        AdInfo adInfoEr = e.er(adTemplate);
        if (g(adInfoEr) || e.eD(adTemplate)) {
            return false;
        }
        return !(cz(adTemplate).cardType == 4) && e.er(adTemplate).adStyleInfo2.playDetailInfo.detailCommonInfo.rewardInteractionType <= 0 && adInfoEr.adMatrixInfo.adDataV2.fullScreenInfo.interactionInfo.interactiveStyle == 2;
    }
    ...
    public static boolean dE(AdTemplate adTemplate) {
        ...
        return ((cz(adTemplate).cardType == 4) || e.er(adTemplate).adStyleInfo2.playDetailInfo.detailWebCardInfo.cardType == 4 || adInfoEr.adMatrixInfo.adDataV2.neoVideoInfo.interactionInfo.interactiveStyle != 2) ? false : true;
    }
