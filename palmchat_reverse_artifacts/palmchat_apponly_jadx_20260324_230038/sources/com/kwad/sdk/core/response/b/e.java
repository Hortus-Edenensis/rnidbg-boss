...
public final class e {
    ...
    public static String ev(@NonNull AdTemplate adTemplate) {
        g gVarKJ = KJ();
        String strKN = gVarKJ == null ? "" : gVarKJ.KN();
        return TextUtils.isEmpty(strKN) ? strKN : a.Z(er(adTemplate));
    }
    ...
    public static long ex(@NonNull AdTemplate adTemplate) {
        ...
        g gVarKJ = KJ();
        return gVarKJ == null ? adTemplate.hashCode() : gVarKJ.KP();
    }
