...
public final class a implements g {
    ...
    public final String av(String str) throws Throwable {
        try {
            String strFg = v.fg(0);
            return new String(c.IZ().encode(b.encrypt(strFg.getBytes("UTF-8"), b.compress(str.getBytes()))), "UTF-8");
    ...
    public final String getResponseData(String str) {
        try {
            return new String(b.decompress(b.decrypt(v.fg(0), c.Jb().decode(str.getBytes()))), "UTF-8");
        } catch (Exception unused) {
            return str;
        }
    }
