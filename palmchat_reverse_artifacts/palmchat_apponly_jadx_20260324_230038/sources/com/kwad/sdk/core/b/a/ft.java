...
public final class ft implements com.kwad.sdk.core.d<HybridLoadMsg> {
    ...
    private static void a(HybridLoadMsg hybridLoadMsg, JSONObject jSONObject) {
        ...
        hybridLoadMsg.state = jSONObject.optInt(LocationConst.HDYawConst.KEY_HD_YAW_STATE);
    ...
    private static JSONObject b(HybridLoadMsg hybridLoadMsg, JSONObject jSONObject) {
        ...
        if (i2 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, LocationConst.HDYawConst.KEY_HD_YAW_STATE, i2);
        }
