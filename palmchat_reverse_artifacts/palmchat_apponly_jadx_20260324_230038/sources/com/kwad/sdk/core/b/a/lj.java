...
public final class lj implements com.kwad.sdk.core.d<TKAdLiveShopItemInfo> {
    ...
    private static void a(TKAdLiveShopItemInfo tKAdLiveShopItemInfo, JSONObject jSONObject) {
        ...
        tKAdLiveShopItemInfo.imageUrl = jSONObject.optString(com.huawei.hms.ads.ld.f6599a);
    ...
    private static JSONObject b(TKAdLiveShopItemInfo tKAdLiveShopItemInfo, JSONObject jSONObject) {
        ...
        if (str2 != null && !str2.equals("")) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, com.huawei.hms.ads.ld.f6599a, tKAdLiveShopItemInfo.imageUrl);
        }
        ...
        if (str4 != null && !str4.equals("")) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, OapsKey.KEY_PRICE, tKAdLiveShopItemInfo.price);
        }
        return jSONObject;
    }
}
