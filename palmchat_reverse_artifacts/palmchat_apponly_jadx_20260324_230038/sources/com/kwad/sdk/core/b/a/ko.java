...
public final class ko implements com.kwad.sdk.core.d<AdMatrixInfo.SplashEndCardTKInfo> {
    ...
    private static void a(AdMatrixInfo.SplashEndCardTKInfo splashEndCardTKInfo, JSONObject jSONObject) {
        ...
        splashEndCardTKInfo.endCardFullScreenClick = jSONObject.optBoolean("endCardFullScreenClick", new Boolean(com.huawei.hms.ads.ex.Code).booleanValue());
        splashEndCardTKInfo.endCardShowCountDown = jSONObject.optBoolean("endCardShowCountDown", new Boolean(com.huawei.hms.ads.ex.V).booleanValue());
    }
