...
public final class kb implements com.kwad.sdk.core.d<SceneImpl> {
    ...
    private static void a(SceneImpl sceneImpl, JSONObject jSONObject) {
        ...
        sceneImpl.backUrl = jSONObject.optString(FrameworkBaseActivity.PARAMS_INTENT_FINISH_FORWARD_URL);
    ...
    private static JSONObject b(SceneImpl sceneImpl, JSONObject jSONObject) {
        ...
        if (i2 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "action", i2);
        }
        ...
        if (str2 != null && !str2.equals("")) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, FFmpegMediaMetadataRetriever.METADATA_KEY_COMMENT, sceneImpl.comment);
        }
        ...
        if (str3 != null && !str3.equals("")) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, FrameworkBaseActivity.PARAMS_INTENT_FINISH_FORWARD_URL, sceneImpl.backUrl);
        }
