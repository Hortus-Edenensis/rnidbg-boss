...
public final class dt implements com.kwad.sdk.core.d<AdInfo.DownloadSafeInfo> {
    ...
    private static void a(AdInfo.DownloadSafeInfo downloadSafeInfo, JSONObject jSONObject) {
        ...
        downloadSafeInfo.appName = jSONObject.optString(WfConstant.EVENT_KEY_APP_NAME);
        ...
        downloadSafeInfo.downloadPauseEnable = jSONObject.optBoolean("downloadPauseEnable", new Boolean(com.huawei.hms.ads.ex.V).booleanValue());
        ...
        downloadSafeInfo.webPageTipbarSwitch = jSONObject.optBoolean("webPageTipbarSwitch", new Boolean(com.huawei.hms.ads.ex.V).booleanValue());
    ...
    private static JSONObject b(AdInfo.DownloadSafeInfo downloadSafeInfo, JSONObject jSONObject) {
        ...
        if (str2 != null && !str2.equals("")) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, WfConstant.EVENT_KEY_APP_NAME, downloadSafeInfo.appName);
        }
