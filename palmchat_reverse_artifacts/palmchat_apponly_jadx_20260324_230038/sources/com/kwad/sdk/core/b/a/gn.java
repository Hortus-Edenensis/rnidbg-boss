...
public final class gn implements com.kwad.sdk.core.d<InterstitialReportInfo> {
    ...
    private static void a(InterstitialReportInfo interstitialReportInfo, JSONObject jSONObject) {
        ...
        interstitialReportInfo.materialType = jSONObject.optInt(WfConstant.EXTRA_KEY_MATERIAL_TYPE);
        ...
        interstitialReportInfo.videoUrl = jSONObject.optString(WfConstant.EXTRA_KEY_VIDEO_URL);
    ...
    private static JSONObject b(InterstitialReportInfo interstitialReportInfo, JSONObject jSONObject) {
        ...
        if (str != null && !str.equals("")) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, WfConstant.EXTRA_KEY_VIDEO_URL, interstitialReportInfo.videoUrl);
        }
