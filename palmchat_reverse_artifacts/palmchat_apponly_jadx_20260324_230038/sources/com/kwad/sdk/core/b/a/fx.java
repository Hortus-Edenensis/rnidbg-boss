...
public final class fx implements com.kwad.sdk.core.d<ImpInfo> {
    ...
    private static void a(ImpInfo impInfo, JSONObject jSONObject) {
        ...
        impInfo.backUrl = jSONObject.optString(FrameworkBaseActivity.PARAMS_INTENT_FINISH_FORWARD_URL);
    ...
    private static JSONObject b(ImpInfo impInfo, JSONObject jSONObject) {
        ...
        if (str3 != null && !str3.equals("")) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, FFmpegMediaMetadataRetriever.METADATA_KEY_COMMENT, impInfo.comment);
        }
        String str4 = impInfo.backUrl;
        if (str4 != null && !str4.equals("")) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, FrameworkBaseActivity.PARAMS_INTENT_FINISH_FORWARD_URL, impInfo.backUrl);
        }
