...
public final class by implements com.kwad.sdk.core.d<com.kwad.sdk.commercial.c.a> {
    ...
    private static void a(com.kwad.sdk.commercial.c.a aVar, JSONObject jSONObject) {
        ...
        aVar.templateId = jSONObject.optString(WfConstant.EXTRA_KEY_TEMPLATE_ID);
        ...
        aVar.errorCode = jSONObject.optInt(SDKInitializer.SDK_BROADTCAST_INTENT_EXTRA_INFO_KEY_ERROR_CODE);
    ...
    private static JSONObject b(com.kwad.sdk.commercial.c.a aVar, JSONObject jSONObject) {
        ...
        if (str != null && !str.equals("")) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, WfConstant.EXTRA_KEY_TEMPLATE_ID, aVar.templateId);
        }
        ...
        if (i2 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, SDKInitializer.SDK_BROADTCAST_INTENT_EXTRA_INFO_KEY_ERROR_CODE, i2);
        }
