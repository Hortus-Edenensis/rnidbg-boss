...
public final class jo implements com.kwad.sdk.core.d<RewardMonitorInfo> {
    ...
    private static void a(RewardMonitorInfo rewardMonitorInfo, JSONObject jSONObject) {
        ...
        rewardMonitorInfo.videoUrl = jSONObject.optString(WfConstant.EXTRA_KEY_VIDEO_URL);
        ...
        rewardMonitorInfo.materialType = jSONObject.optInt(WfConstant.EXTRA_KEY_MATERIAL_TYPE);
    ...
    private static JSONObject b(RewardMonitorInfo rewardMonitorInfo, JSONObject jSONObject) {
        ...
        if (str != null && !str.equals("")) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, WfConstant.EXTRA_KEY_VIDEO_URL, rewardMonitorInfo.videoUrl);
        }
        ...
        if (i10 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, WfConstant.EXTRA_KEY_MATERIAL_TYPE, i10);
        }
