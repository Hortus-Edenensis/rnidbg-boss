...
public final class aw implements com.kwad.sdk.core.d<AdTemplate> {
    private static void l(AdTemplate adTemplate, JSONObject jSONObject) {
        ...
        adTemplate.subType = jSONObject.optInt(SharePluginInfo.ISSUE_SUB_TYPE);
        ...
        adTemplate.mIsForceJumpLandingPage = jSONObject.optBoolean("mIsForceJumpLandingPage", new Boolean(com.huawei.hms.ads.ex.V).booleanValue());
        ...
        adTemplate.fromCache = jSONObject.optBoolean("fromCache", new Boolean(com.huawei.hms.ads.ex.V).booleanValue());
    ...
    private static JSONObject m(AdTemplate adTemplate, JSONObject jSONObject) {
        ...
        if (i3 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, SharePluginInfo.ISSUE_SUB_TYPE, i3);
        }
