...
public final class dx implements com.kwad.sdk.core.d<com.kwad.components.ad.draw.a.a> {
    ...
    private static JSONObject b(com.kwad.components.ad.draw.a.a aVar, JSONObject jSONObject) {
        ...
        if (i2 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, WfConstant.EXTRA_KEY_MATERIAL_TYPE, i2);
        }
        ...
        int i6 = aVar.adStyle;
        if (i6 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, MapBundleKey.MapObjKey.OBJ_AD_STYLE, i6);
        }
        return jSONObject;
    }
}
