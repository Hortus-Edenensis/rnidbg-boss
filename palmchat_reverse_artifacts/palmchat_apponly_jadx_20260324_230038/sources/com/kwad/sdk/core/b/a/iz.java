...
public final class iz implements com.kwad.sdk.core.d<ah.a> {
    ...
    private static void a(ah.a aVar, JSONObject jSONObject) {
        ...
        if (JSONObject.NULL.toString().equals(aVar.ahc)) {
            aVar.ahc = "";
        }
        aVar.ahd = jSONObject.optString("manufacturer");
        if (JSONObject.NULL.toString().equals(aVar.ahd)) {
            aVar.ahd = "";
        }
        aVar.model = jSONObject.optString(WkParams.MODEL);
        ...
        if (JSONObject.NULL.toString().equals(aVar.ahf)) {
            aVar.ahf = "";
        }
        aVar.ahg = jSONObject.optInt("osApi");
        aVar.ahh = jSONObject.optString("language");
        if (JSONObject.NULL.toString().equals(aVar.ahh)) {
            aVar.ahh = "";
        }
    ...
    private static JSONObject b(ah.a aVar, JSONObject jSONObject) {
        ...
        if (str8 != null && !str8.equals("")) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, WkParams.MODEL, aVar.model);
        }
        String str9 = aVar.Mi;
        ...
        if (str11 != null && !str11.equals("")) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "language", aVar.ahh);
        }
