...
public final class ks implements com.kwad.sdk.core.d<SplashMonitorInfo> {
    ...
    private static void a(SplashMonitorInfo splashMonitorInfo, JSONObject jSONObject) {
        ...
        splashMonitorInfo.materialType = jSONObject.optInt(WfConstant.EXTRA_KEY_MATERIAL_TYPE);
        ...
        splashMonitorInfo.templateId = jSONObject.optString(WfConstant.EXTRA_KEY_TEMPLATE_ID);
    ...
    private static JSONObject b(SplashMonitorInfo splashMonitorInfo, JSONObject jSONObject) {
        ...
        com.kwad.sdk.utils.aa.putValue(jSONObject, OapsKey.KEY_IDS, splashMonitorInfo.ids);
        ...
        if (j7 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "size", j7);
        }
        ...
        if (i5 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, WfConstant.EXTRA_KEY_MATERIAL_TYPE, i5);
        }
        ...
        if (i7 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, HiAnalyticsConstant.BI_KEY_UPDATE_TYPE, i7);
        }
        ...
        if (str5 != null && !str5.equals("")) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, WfConstant.EXTRA_KEY_TEMPLATE_ID, splashMonitorInfo.templateId);
        }
