...
public final class j implements com.kwad.sdk.core.d<AdInfo.AdBaseInfo> {
    ...
    private static void a(AdInfo.AdBaseInfo adBaseInfo, JSONObject jSONObject) {
        ...
        adBaseInfo.appName = jSONObject.optString(WfConstant.EVENT_KEY_APP_NAME);
    ...
    private static JSONObject b(AdInfo.AdBaseInfo adBaseInfo, JSONObject jSONObject) {
        ...
        if (str11 != null && !str11.equals("")) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, WfConstant.EVENT_KEY_APP_NAME, adBaseInfo.appName);
        }
        ...
        if (str24 != null && !str24.equals("")) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, "clickUrl", adBaseInfo.clickUrl);
        }
