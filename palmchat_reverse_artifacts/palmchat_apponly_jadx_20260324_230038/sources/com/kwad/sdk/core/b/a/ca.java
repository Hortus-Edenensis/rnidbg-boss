...
public final class ca implements com.kwad.sdk.core.d<com.kwad.sdk.crash.online.monitor.a.a> {
    ...
    private static void a(com.kwad.sdk.crash.online.monitor.a.a aVar, JSONObject jSONObject) {
        ...
        if (jSONArrayOptJSONArray != null) {
            for (int i = 0; i < jSONArrayOptJSONArray.length(); i++) {
                aVar.aUT.add((String) jSONArrayOptJSONArray.opt(i));
            }
        }
        ...
        if (jSONArrayOptJSONArray2 != null) {
            for (int i2 = 0; i2 < jSONArrayOptJSONArray2.length(); i2++) {
                aVar.aUU.add((String) jSONArrayOptJSONArray2.opt(i2));
            }
        }
        ...
        if (jSONArrayOptJSONArray3 != null) {
            for (int i3 = 0; i3 < jSONArrayOptJSONArray3.length(); i3++) {
                aVar.aUV.add((String) jSONArrayOptJSONArray3.opt(i3));
            }
        }
        aVar.aUW = new ArrayList();
        ...
        if (jSONArrayOptJSONArray4 != null) {
            for (int i4 = 0; i4 < jSONArrayOptJSONArray4.length(); i4++) {
                aVar.aUW.add((String) jSONArrayOptJSONArray4.opt(i4));
            }
        }
        ...
        aVar.aUZ = jSONObject.optInt("afterFilterSystemCheckNum", new Integer("5").intValue());
        aVar.aVa = jSONObject.optInt("batchNum", new Integer("10").intValue());
        aVar.aAi = jSONObject.optDouble("ratio", new Double("0.01").doubleValue());
        aVar.aVb = jSONObject.optInt("monitorSwitch");
    }
    ...
    private static JSONObject b(com.kwad.sdk.crash.online.monitor.a.a aVar, JSONObject jSONObject) {
        ...
        com.kwad.sdk.utils.aa.putValue(jSONObject, "systemFilterList", aVar.aUT);
        com.kwad.sdk.utils.aa.putValue(jSONObject, "sdkFilterList", aVar.aUU);
        com.kwad.sdk.utils.aa.putValue(jSONObject, "matrixPrinterNameList", aVar.aUV);
        com.kwad.sdk.utils.aa.putValue(jSONObject, "commonPrinterNameList", aVar.aUW);
        com.kwad.sdk.utils.aa.putValue(jSONObject, "featureConfigList", aVar.aUX);
        com.kwad.sdk.utils.aa.putValue(jSONObject, "afterFilterSystemCheckNum", aVar.aUZ);
        com.kwad.sdk.utils.aa.putValue(jSONObject, "batchNum", aVar.aVa);
        com.kwad.sdk.utils.aa.putValue(jSONObject, "ratio", aVar.aAi);
        int i = aVar.aVb;
        if (i != 0) {
