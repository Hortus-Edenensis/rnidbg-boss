...
public final class mi implements com.kwad.sdk.core.d<d.b> {
    ...
    private static void a(d.b bVar, JSONObject jSONObject) {
        ...
        bVar.videoUrl = jSONObject.optString(WfConstant.EXTRA_KEY_VIDEO_URL);
        ...
        bVar.adStyle = jSONObject.optInt(MapBundleKey.MapObjKey.OBJ_AD_STYLE);
    ...
    private static JSONObject b(d.b bVar, JSONObject jSONObject) {
        ...
        if (str != null && !str.equals("")) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, WfConstant.EXTRA_KEY_VIDEO_URL, bVar.videoUrl);
        }
        long j5 = bVar.llsid;
        if (j5 != 0) {
        ...
        int i2 = bVar.adStyle;
        if (i2 != 0) {
            com.kwad.sdk.utils.aa.putValue(jSONObject, MapBundleKey.MapObjKey.OBJ_AD_STYLE, i2);
        }
        int i3 = bVar.afw;
        if (i3 != 0) {
