...
public class StatusInfo extends com.kwad.sdk.core.response.a.a {
    public int aNr;
    public int aNs;
    public SplashAdInfo aNt;
    public NativeAdRequestInfo aNu;
    public List<f> aNv;
    ...
    public static final class SplashAdInfo extends com.kwad.sdk.core.response.a.a implements Serializable {
        ...
        public static SplashAdInfo create(SceneImpl sceneImpl) {
            ...
            splashAdInfo.dailyShowCount = com.kwad.sdk.utils.c.Rf();
    ...
    private StatusInfo(SceneImpl sceneImpl) {
        try {
            int i = 1;
            this.aNr = ((com.kwad.sdk.service.a.f) ServiceProvider.get(com.kwad.sdk.service.a.f.class)).CU() ? 1 : 0;
            if (!((com.kwad.sdk.service.a.f) ServiceProvider.get(com.kwad.sdk.service.a.f.class)).CV()) {
                i = 0;
            }
            this.aNs = i;
            this.aNv = com.kwad.sdk.core.local.a.Jm();
            this.aNu = NativeAdRequestInfo.create(sceneImpl);
            this.aNt = SplashAdInfo.create(sceneImpl);
        } catch (Throwable th) {
