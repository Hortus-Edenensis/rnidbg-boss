...
public final class a {
    private static AdHttpProxy aJY;
    ...
    public static boolean a(String str, OutputStream outputStream, C0614a c0614a, long j, boolean z, AdHttpResponseListener adHttpResponseListener) {
        boolean zJw = Jw();
        AdHttpProxy adHttpProxyCm = aJY;
        if (adHttpProxyCm == null) {
            com.kwad.sdk.core.d.c.d("VideoCacheHelper", "isAdCacheEnable:" + zJw);
            adHttpProxyCm = zJw ? g.Cm() : new com.kwad.sdk.core.network.c.a();
            aJY = adHttpProxyCm;
        }
