...
public final class b {
    public static void Gm() {
        GlobalThreadPools.Lq().execute(new bg() { // from class: com.kwad.sdk.core.adlog.b.2
            @Override // com.kwad.sdk.utils.bg
            public final void doTask() {
                com.kwad.sdk.core.adlog.a.a aVarGs = com.kwad.sdk.core.adlog.a.b.Gp().Gs();
                if (aVarGs != null) {
                    JSONObject jSONObject = aVarGs.aBT;
                    aa.putValue(jSONObject, "retryCount", aVarGs.retryCount);
                    aa.putValue(jSONObject, "cacheType", 1);
                    b.a(aVarGs.url, jSONObject, aVarGs.aBU, aVarGs);
                }
            }
        });
    }
    ...
    public static void a(@NonNull final com.kwad.sdk.core.adlog.c.a aVar) {
        GlobalThreadPools.Lq().execute(new bg() { // from class: com.kwad.sdk.core.adlog.b.1
            @Override // com.kwad.sdk.utils.bg
            public final void doTask() {
                a aVar2 = new a(aVar);
    ...
    public static void a(String str, JSONObject jSONObject, @NonNull com.kwad.sdk.core.adlog.c.a aVar, @Nullable com.kwad.sdk.core.adlog.a.a aVar2) {
        ...
        try {
            ...
            if (!ao.isNetworkConnected(ServiceProvider.getContext())) {
                ...
                com.kwad.sdk.core.adlog.a.b.Gp().a(aVar2, str, jSONObject, aVar, 100004, "no network");
                return;
            }
            if (bw.hR(str)) {
            ...
            adLogRequestResult.parseResult(cVarDoPost.aIW);
            int i2 = cVarDoPost.code;
            if (i2 != 200) {
                int iCM = e.cM(i2);
                String str2 = cVarDoPost.aIW;
                com.kwad.sdk.core.adlog.b.c.d(adTemplate, i, str, iCM, str2, aVar2);
                com.kwad.sdk.core.adlog.a.b.Gp().a(aVar2, str, jSONObject, aVar, iCM, str2);
                return;
            }
            if (adLogRequestResult.isResultOk()) {
                com.kwad.sdk.core.adlog.b.c.b(adTemplate, i, aVar2);
                b(aVar);
                com.kwad.sdk.core.adlog.a.b.Gp().Gq();
                return;
            }
            ...
            com.kwad.sdk.core.adlog.a.b.Gp().a(aVar2, str, jSONObject, aVar, i3, str3);
        } catch (Throwable th) {
