...
@Keep
public class WarmUpResponse extends BaseResultData {
    ...
    public static class ResourceItem implements b, Serializable {
        ...
        public void parseJson(JSONObject jSONObject) {
            ...
            this.endTime = jSONObject.optLong(bq.f.h);
        ...
        public JSONObject toJson() {
            ...
            aa.putValue(jSONObject, "md5", this.md5);
            aa.putValue(jSONObject, bq.f.h, this.endTime);
