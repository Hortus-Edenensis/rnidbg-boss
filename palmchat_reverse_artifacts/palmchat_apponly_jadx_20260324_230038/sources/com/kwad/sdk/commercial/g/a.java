...
public final class a {
    ...
    public static void j(AdTemplate adTemplate, int i, String str) {
        try {
            a(adTemplate, b.FO().cV(1).de(str).cW(i));
        } catch (Throwable th) {
    ...
    public static void k(AdTemplate adTemplate, int i, String str) {
        try {
            a(adTemplate, b.FO().cV(2).de(str).cW(i));
        } catch (Throwable th) {
            ServiceProvider.reportSdkCaughtException(th);
        }
    }
    ...
    public static void l(AdTemplate adTemplate, int i, String str) {
        try {
            a(adTemplate, b.FO().cV(4).de(str).cW(i));
        } catch (Throwable th) {
            ServiceProvider.reportSdkCaughtException(th);
        }
    }
    ...
    public static void m(AdTemplate adTemplate, int i, String str) {
        try {
            a(adTemplate, b.FO().cV(5).de(str).cW(i));
        } catch (Throwable th) {
            ServiceProvider.reportSdkCaughtException(th);
        }
    }
    ...
    private static void a(AdTemplate adTemplate, boolean z, com.kwad.sdk.commercial.c.a aVar) {
        ...
        c.d(d.FH().cR(ILoggerReporter.Category.APM_LOG).i(z ? 0.1d : 0.01d).b(e.bh(adTemplate)).O("ad_sdk_landing_page_performance", "status").z(aVar));
    }

    public static void a(AdTemplate adTemplate, int i, String str, String str2) {
        try {
            a(adTemplate, true, b.FO().cV(3).de(str).cW(i).setErrorCode(100009).setErrorMsg(str2));
        } catch (Throwable th) {
            ServiceProvider.reportSdkCaughtException(th);
        }
    }
    ...
    public static void a(AdTemplate adTemplate, int i, String str, int i2, String str2) {
        try {
            a(adTemplate, true, b.FO().cV(6).de(str).cW(i).setErrorCode(i2).setErrorMsg(str2));
        } catch (Throwable th) {
            ServiceProvider.reportSdkCaughtException(th);
        }
    }
