...
public final class a {
    ...
    public static void b(AdTemplate adTemplate, String str, String str2, int i, int i2) {
        try {
            a(adTemplate, b.FJ().cQ(2).cU(str).cV(str2).cS(i).cR(i2));
        } catch (Throwable th) {
    ...
    private static void a(AdTemplate adTemplate, boolean z, com.kwad.sdk.commercial.c.a aVar) {
        ...
        c.d(d.FH().cR(ILoggerReporter.Category.APM_LOG).i(z ? 0.1d : 0.01d).b(e.bh(adTemplate)).O("ad_sdk_appstore_performance", "status").z(aVar));
    }
    ...
    public static void a(AdTemplate adTemplate, String str, String str2, int i, int i2) {
        try {
            a(adTemplate, b.FJ().cQ(1).cU(str).cV(str2).cS(i).cR(i2));
        } catch (Throwable th) {
            ServiceProvider.reportSdkCaughtException(th);
        }
    }
    ...
    public static void a(AdTemplate adTemplate, String str, String str2, int i, int i2, String str3) {
        try {
            a(adTemplate, true, b.FJ().cQ(4).cU(str).cV(str2).cS(i).cR(i2).setErrorCode(100006).setErrorMsg(str3));
        } catch (Throwable th) {
            ServiceProvider.reportSdkCaughtException(th);
        }
    }
