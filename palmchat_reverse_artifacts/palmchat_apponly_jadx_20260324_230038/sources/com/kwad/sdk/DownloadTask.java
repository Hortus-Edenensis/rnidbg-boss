...
public class DownloadTask implements Serializable {
    ...
    */
    public void onConnected(com.kwad.framework.filedownloader.a aVar, String str, boolean z, int i, int i2) {
        ...
        long availableBytes = new File(this.mDestinationDir).exists() ? com.kwad.sdk.crash.utils.h.getAvailableBytes(this.mDestinationDir) : !bc.useStoragePermissionDisable() ? com.kwad.sdk.crash.utils.h.getAvailableBytes(Environment.getExternalStorageDirectory().getPath()) : j;
        if (availableBytes < j) {
            c.Ce().cancel(aVar.getId());
            notifyDownloadCanceled();
            onLowStorage(aVar);
            return;
        }
