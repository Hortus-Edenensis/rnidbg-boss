...
public final class f {
    ...
    @NonNull
    private static List<g> bu(Context context) {
        String[] strArrCW;
        CopyOnWriteArrayList copyOnWriteArrayList = new CopyOnWriteArrayList();
        if (context != null && (strArrCW = y.cW(context)) != null) {
            for (String str : strArrCW) {
                int iAw = au.aw(context, str);
                copyOnWriteArrayList.add(new g(str, iAw == 0 ? g.PERMISSION_GRANTED : iAw == -1 ? g.PERMISSION_DENIED : g.azs));
            }
        }
