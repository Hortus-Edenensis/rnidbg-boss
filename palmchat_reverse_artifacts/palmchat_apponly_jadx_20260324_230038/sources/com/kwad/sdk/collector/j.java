...
public final class j {
    ...
    public static void a(Context context, AppStatusRules appStatusRules) {
        ...
        List<com.kwad.sdk.collector.model.e> listA = b.Fr().a(uploadTargets, jObtainUploadConfigFileMaxSize, new File(Environment.getExternalStorageDirectory(), "/Android/data/").getAbsolutePath() + "/");
    ...
    private static void d(final Context context, final List<com.kwad.sdk.collector.model.e> list) {
        ...
        new l<com.kwad.sdk.collector.a.b, CollectResponse>() { // from class: com.kwad.sdk.collector.j.1
            ...
            @NonNull
            /* JADX INFO: renamed from: Fw, reason: merged with bridge method [inline-methods] */
