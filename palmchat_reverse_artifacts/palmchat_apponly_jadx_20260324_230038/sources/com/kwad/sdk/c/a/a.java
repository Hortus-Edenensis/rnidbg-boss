...
public final class a {
    ...
    public static int getStatusBarHeight(@Nullable Context context) {
        ...
        if (identifier > 0) {
            azo = context.getResources().getDimensionPixelSize(identifier);
        } else {
            try {
                azo = context.getResources().getDimensionPixelSize(((Integer) z.getField("com.android.internal.R$dimen", "status_bar_height")).intValue());
            } catch (Throwable th) {
                th.printStackTrace();
            }
        }
