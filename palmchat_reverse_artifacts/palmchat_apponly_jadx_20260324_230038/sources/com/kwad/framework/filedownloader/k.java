...
final class k implements t {
    ...
    private void p(MessageSnapshot messageSnapshot) {
        a.InterfaceC0580a interfaceC0580a = this.aqm;
        if (interfaceC0580a == null) {
            ...
            if (!this.aqp && interfaceC0580a.yv().yk() != null) {
    ...
    public final void m(MessageSnapshot messageSnapshot) {
        if (com.kwad.framework.filedownloader.f.d.atL) {
            a.InterfaceC0580a interfaceC0580a = this.aqm;
            com.kwad.framework.filedownloader.f.d.c(this, "notify error %s %s", interfaceC0580a, interfaceC0580a.yv().yp());
        }
        this.aqn.yE();
        p(messageSnapshot);
    }
    ...
    public final String toString() {
        ...
        a.InterfaceC0580a interfaceC0580a = this.aqm;
        objArr[0] = Integer.valueOf(interfaceC0580a == null ? -1 : interfaceC0580a.yv().getId());
    ...
    public final void yZ() {
        ...
        a aVarYv = interfaceC0580a.yv();
        i iVarYk = aVarYv.yk();
        x.a aVarYw = interfaceC0580a.yw();
        bN(bYn);
        if (iVarYk == null) {
            return;
        }
