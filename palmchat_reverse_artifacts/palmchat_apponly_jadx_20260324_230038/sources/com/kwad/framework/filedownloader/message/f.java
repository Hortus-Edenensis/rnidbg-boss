    ...
    public static MessageSnapshot a(byte b, com.kwad.framework.filedownloader.d.c cVar, d.a aVar) {
        ...
        if (b != -1) {
            ...
            if (b == 2) {
                ...
                if (cVar.yt()) {
                    return new d.c(id, aVar.Ai(), cVar.getTotal(), cVar.AE(), filename);
                }
                return new h.c(id, aVar.Ai(), (int) cVar.getTotal(), cVar.AE(), filename);
            }
            if (b == 3) {
                if (cVar.yt()) {
            ...
            if (b != 5) {
                if (b != 6) {
                    ...
                    if (cVar.yt()) {
                        return new d.C0588d(id, cVar.AD(), illegalStateException);
                    }
            ...
            if (cVar.yt()) {
                ...
                dVar = new h.C0589h(id, (int) cVar.AD(), aVar.getException(), aVar.yr());
            }
        } else if (cVar.yt()) {
            dVar = new d.C0588d(id, cVar.AD(), aVar.getException());
        } else {
