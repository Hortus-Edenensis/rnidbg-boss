...
public final class d implements a.c, x, x.a, x.b {
    ...
    public final boolean pause() {
        ...
        b((byte) -2);
        a.InterfaceC0580a interfaceC0580aYJ = this.apM.yJ();
        com.kwad.framework.filedownloader.a aVarYv = interfaceC0580aYJ.yv();
        q.zk().b(this);
        if (com.kwad.framework.filedownloader.f.d.atL) {
        ...
        h.yT().b(interfaceC0580aYJ);
        h.yT().a(interfaceC0580aYJ, com.kwad.framework.filedownloader.message.f.e(aVarYv));
        r.zm().zq().e(interfaceC0580aYJ);
        return true;
    }
    ...
    public final void start() {
        ...
        try {
            ...
            synchronized (this.apH) {
                ...
                if (h.yT().a(interfaceC0580aYJ)) {
                    vVarZq.e(interfaceC0580aYJ);
                    h.yT().b(interfaceC0580aYJ);
                }
                h.yT().a(interfaceC0580aYJ, messageSnapshotG);
            }
        } catch (Throwable th) {
            th.printStackTrace();
            h.yT().a(interfaceC0580aYJ, g(th));
        }
    }
