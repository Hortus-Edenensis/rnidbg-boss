...
import com.amap.api.col.p0002sl.nl;
import com.amap.api.col.p0002sl.np;
...
public class Inner_3dMap_location extends Location implements Cloneable {
    ...
    public Inner_3dMap_location m41clone() {
        try {
            super.clone();
    ...
    public JSONObject toJson(int i) {
        try {
            ...
            jSONObject.put(MapBundleKey.MapObjKey.OBJ_SS_POINAME, this.poiName);
    ...
    public String toString() {
        ...
        try {
            ...
            stringBuffer.append(TECameraSettings.PictureCallback.ERROR_CODE_SPLIT_REGEX + this.errorCode + "#");
    ...
    public String toStr(int i) {
        ...
        try {
            ...
            nl.a(th, "AMapLocation", "toStr part2");
            json = null;
        }
        if (json == null) {
            return null;
