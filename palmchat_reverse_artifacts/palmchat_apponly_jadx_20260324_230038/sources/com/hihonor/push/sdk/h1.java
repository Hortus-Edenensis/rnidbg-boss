...
public class h1 {
    ...
    public final SharedPreferences f6453a;
    ...
    public h1(Context context, String str) {
        ...
        if (Build.VERSION.SDK_INT < 24) {
            this.f6453a = context.getSharedPreferences(str, 0);
            return;
        }
        ...
        this.f6453a = contextCreateDeviceProtectedStorageContext.getSharedPreferences(str, 0);
    }

    public boolean a(String str, String str2) {
        SharedPreferences.Editor editorEdit;
        SharedPreferences sharedPreferences = this.f6453a;
