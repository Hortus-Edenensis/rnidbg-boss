package com.zm.fda.oaid.interfaces.heytap.openid;
...
public interface IOpenID extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IOpenID {
        public static final String DESCRIPTOR = OO22Z.a("Y29tLmhleXRhcC5vcGVuaWQuSU9wZW5JRA==");
        ...
        public static class Proxy implements IOpenID {
            ...
            @Override // com.zm.fda.oaid.interfaces.heytap.openid.IOpenID
