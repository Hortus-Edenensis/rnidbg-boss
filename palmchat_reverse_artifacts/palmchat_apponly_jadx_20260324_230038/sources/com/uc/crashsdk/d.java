...
public final class d {
    ...
    private static ICrashClient f10819a = null;
    ...
    public static void a(String str, String str2, String str3) {
        ...
        if (f10819a != null) {
            ...
            try {
                if (zEquals) {
                    f10819a.onLogGenerated(file, str3);
                } else {
                    f10819a.onClientProcessLogGenerated(str2, file, str3);
                }
            } catch (Throwable th) {
    ...
    public static File a(File file) {
        ICrashClient iCrashClient = f10819a;
