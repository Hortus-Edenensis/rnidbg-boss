...
public class BinderAdapter implements ServiceConnection {
    ...
    private void e() {
        ...
        try {
            ComponentName componentName = new ComponentName(this.f6515a.getApplicationInfo().packageName, "com.huawei.hms.activity.BridgeActivity");
    ...
    public void unBind() {
        Util.unBindServiceCatchException(this.f6515a, this);
    }
    ...
    private void a() {
        ...
        synchronized (this.f) {
            if (this.f6515a.bindService(intent, this, 1)) {
                g();
            } else {
                this.g = true;
                e();
