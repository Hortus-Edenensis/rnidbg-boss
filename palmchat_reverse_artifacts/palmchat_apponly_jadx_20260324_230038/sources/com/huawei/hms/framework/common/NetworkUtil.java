...
public class NetworkUtil {
    ...
    public static String getHost(String str) {
        return TextUtils.isEmpty(str) ? "" : u56.b(str);
    }
        ...
        try {
            if (networkType == 3) {
                ...
                if (cellSignalStrengths.size() > 0) {
                    ...
                    List cellSignalStrengths2 = signalStrength.getCellSignalStrengths(fx3.a());
                    if (cellSignalStrengths2.size() > 0) {
                        dbm = gx3.a(cellSignalStrengths2.get(0)).getDbm();
                    } else {
                ...
                List cellSignalStrengths5 = signalStrength.getCellSignalStrengths(cx3.a());
                if (cellSignalStrengths5.size() <= 0) {
                    return Integer.MAX_VALUE;
                }
                dbm = og7.a(cellSignalStrengths5.get(0)).getDbm();
            }
            i = dbm;
            return i;
        } catch (Throwable th) {
    ...
    public static int getNrCsiRsrp(Context context) {
        ...
        try {
            ...
            List cellSignalStrengths = signalStrength.getCellSignalStrengths(cx3.a());
            if (cellSignalStrengths.size() > 0) {
                return og7.a(cellSignalStrengths.get(0)).getCsiRsrp();
            }
        } catch (Throwable th) {
    ...
    public static int getNrCsiRsrq(Context context) {
        ...
        try {
            ...
            List cellSignalStrengths = signalStrength.getCellSignalStrengths(cx3.a());
            if (cellSignalStrengths.size() > 0) {
                return og7.a(cellSignalStrengths.get(0)).getCsiRsrq();
            }
        } catch (Throwable th) {
    ...
    public static int getNrCsiSinr(Context context) {
        ...
        try {
            ...
            List cellSignalStrengths = signalStrength.getCellSignalStrengths(cx3.a());
            if (cellSignalStrengths.size() > 0) {
                return og7.a(cellSignalStrengths.get(0)).getCsiSinr();
            }
        } catch (Throwable th) {
    ...
    public static Map<String, Integer> getNrSignalInfo(Context context) {
        ...
        try {
            if (Build.VERSION.SDK_INT > 28) {
                List cellSignalStrengths = signalStrength.getCellSignalStrengths(cx3.a());
                if (cellSignalStrengths.size() > 0) {
                    map.put(SignalType.NR_DBM, Integer.valueOf(og7.a(cellSignalStrengths.get(0)).getDbm()));
                    map.put(SignalType.NR_CSIRSRP, Integer.valueOf(og7.a(cellSignalStrengths.get(0)).getCsiRsrp()));
                    map.put(SignalType.NR_CSIRSRQ, Integer.valueOf(og7.a(cellSignalStrengths.get(0)).getCsiRsrq()));
                    map.put(SignalType.NR_CSISINR, Integer.valueOf(og7.a(cellSignalStrengths.get(0)).getCsiSinr()));
                    map.put(SignalType.NR_SSRSRP, Integer.valueOf(og7.a(cellSignalStrengths.get(0)).getSsRsrp()));
                    map.put(SignalType.NR_SSRSRQ, Integer.valueOf(og7.a(cellSignalStrengths.get(0)).getSsRsrq()));
                    map.put(SignalType.NR_SSSINR, Integer.valueOf(og7.a(cellSignalStrengths.get(0)).getSsSinr()));
                }
            }
        } catch (Throwable th) {
            Logger.i(TAG, "getLteRssi: throwable:" + th.getClass());
    ...
    public static int getNrSsRsrp(Context context) {
        ...
        try {
            ...
            List cellSignalStrengths = signalStrength.getCellSignalStrengths(cx3.a());
            if (cellSignalStrengths.size() > 0) {
                return og7.a(cellSignalStrengths.get(0)).getSsRsrp();
            }
        } catch (Throwable th) {
    ...
    public static int getNrSsRsrq(Context context) {
        ...
        try {
            ...
            List cellSignalStrengths = signalStrength.getCellSignalStrengths(cx3.a());
            if (cellSignalStrengths.size() > 0) {
                return og7.a(cellSignalStrengths.get(0)).getSsRsrq();
            }
        } catch (Throwable th) {
    ...
    public static int getNrSsSinr(Context context) {
        ...
        try {
            ...
            List cellSignalStrengths = signalStrength.getCellSignalStrengths(cx3.a());
            if (cellSignalStrengths.size() > 0) {
                return og7.a(cellSignalStrengths.get(0)).getSsSinr();
            }
        } catch (Throwable th) {
    ...
    public static boolean isUserUnlocked(Context context) {
        ...
        if (Build.VERSION.SDK_INT < 24 || (userManager = (UserManager) ContextCompat.getSystemService(context, bd.m)) == null) {
            return true;
        }
        try {
