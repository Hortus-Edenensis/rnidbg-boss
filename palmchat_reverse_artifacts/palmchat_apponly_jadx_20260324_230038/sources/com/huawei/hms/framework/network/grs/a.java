...
public class a {
    ...
    private final GrsBaseInfo f6716a;
    ...
    /* JADX INFO: compiled from: SearchBox */
    public static class C0443a implements com.huawei.hms.framework.network.grs.b {
        ...
        public C0443a(String str, Map<String, String> map, IQueryUrlsCallBack iQueryUrlsCallBack, Context context, GrsBaseInfo grsBaseInfo, com.huawei.hms.framework.network.grs.e.a aVar) {
            this.f6717a = str;
            this.b = map;
        ...
        public void a() {
            ...
            if (map != null && !map.isEmpty()) {
                Logger.i(a.e, "GrsClientManager.ayncGetGrsUrls: Return [%s] Urls: %s", this.f6717a, StringUtils.anonymizeMessage(new JSONObject(this.b).toString()));
                this.c.onCallBackSuccess(this.b);
                return;
            }
            if (this.b != null) {
                Logger.i(a.e, "GrsClientManager.ayncGetGrsUrls：Return [%s] Urls is Empty", this.f6717a);
                this.c.onCallBackFail(-3);
                return;
            }
            Logger.i(a.e, "GrsClientManager.ayncGetGrsUrls: Get URL from Local JSON File");
            Map<String, String> mapA = com.huawei.hms.framework.network.grs.f.b.a(this.d.getPackageName()).a(this.d, this.f, this.e, this.f6717a, true);
            if (mapA == null || mapA.isEmpty()) {
                Logger.e(a.e, "The serviceName[%s] is not configured in the JSON configuration files to reveal all the details", this.f6717a);
            }
            if (mapA == null) {
                mapA = new ConcurrentHashMap<>();
            }
            Logger.i(a.e, "GrsClientManager.ayncGetGrsUrls: Return [%s] Urls: %s", this.f6717a, StringUtils.anonymizeMessage(new JSONObject(mapA).toString()));
        ...
        public void a(com.huawei.hms.framework.network.grs.g.d dVar) {
            ...
            String strJ = dVar.j();
            Map<String, String> mapA = a.a(strJ, this.f6717a);
            if (mapA.isEmpty()) {
                Map<String, String> map = this.b;
                if (map == null || map.isEmpty()) {
                    if (this.b != null) {
                    ...
                    if (!TextUtils.isEmpty(strJ)) {
                        Logger.e(a.e, "The serviceName[%s] is not configured on the GRS server.", this.f6717a);
                    }
                    Logger.i(a.e, "GrsClientManager.ayncGetGrsUrls: Get URL from Local JSON File");
                    Map<String, String> mapA2 = com.huawei.hms.framework.network.grs.f.b.a(this.d.getPackageName()).a(this.d, this.f, this.e, this.f6717a, true);
                    ...
                    Logger.i(a.e, "GrsClientManager.ayncGetGrsUrls: Return [%s] Urls: %s", this.f6717a, StringUtils.anonymizeMessage(new JSONObject(mapA2).toString()));
                    this.c.onCallBackSuccess(mapA2);
                    return;
                }
                Logger.i(a.e, "GrsClientManager.ayncGetGrsUrls: Return [%s][%s] Url: %s", this.f6717a, StringUtils.anonymizeMessage(new JSONObject(this.b).toString()));
                iQueryUrlsCallBack = this.c;
                mapA = this.b;
            } else {
                Logger.i(a.e, "GrsClientManager.ayncGetGrsUrls: Get URL from Current Called GRS Server Return [%s] Urls: %s", this.f6717a, StringUtils.anonymizeMessage(new JSONObject(mapA).toString()));
                iQueryUrlsCallBack = this.c;
            }
    ...
    public static class b implements com.huawei.hms.framework.network.grs.b {
        ...
        public void a() {
            if (!TextUtils.isEmpty(this.d)) {
                Logger.i(a.e, "GrsClientManager.ayncGetGrsUrl: Return [%s][%s] Url: %s", this.f6718a, this.b, StringUtils.anonymizeMessage(this.d));
                this.c.onCallBackSuccess(this.d);
                return;
            }
            if (!TextUtils.isEmpty(this.d)) {
                Logger.i(a.e, "GrsClientManager.ayncGetGrsUrl：Return [%s][%s] Url is Empty", this.f6718a, this.b);
                this.c.onCallBackFail(-3);
                return;
            }
            Logger.i(a.e, "GrsClientManager.ayncGetGrsUrl: Get URL from Local JSON File");
            String strA = com.huawei.hms.framework.network.grs.f.b.a(this.e.getPackageName()).a(this.e, this.g, this.f, this.f6718a, this.b, true);
            if (strA == null || strA.isEmpty()) {
                Logger.e(a.e, "The serviceName[%s][%s] is not configured in the JSON configuration files to reveal all the details", this.f6718a, this.b);
            }
            Logger.i(a.e, "GrsClientManager.ayncGetGrsUrl: Return [%s][%s] Url: %s", this.f6718a, this.b, StringUtils.anonymizeMessage(strA));
        ...
        public void a(com.huawei.hms.framework.network.grs.g.d dVar) {
            ...
            String str;
            String strJ = dVar.j();
            Map<String, String> mapA = a.a(strJ, this.f6718a);
            if (mapA.containsKey(this.b)) {
                String str2 = a.e;
                String str3 = this.b;
                Logger.i(str2, "GrsClientManager.ayncGetGrsUrl: Get URL from Current Called GRS Server, Return [%s][%s] Url: %s", this.f6718a, str3, StringUtils.anonymizeMessage(mapA.get(str3)));
                ...
                if (TextUtils.isEmpty(this.d)) {
                    ...
                    if (!TextUtils.isEmpty(strJ)) {
                        Logger.e(a.e, "The serviceName[%s][%s] is not configured on the GRS server.", this.f6718a, this.b);
                    }
                    Logger.i(a.e, "GrsClientManager.ayncGetGrsUrl: Get URL from Local JSON File");
                    String strA = com.huawei.hms.framework.network.grs.f.b.a(this.e.getPackageName()).a(this.e, this.g, this.f, this.f6718a, this.b, true);
                    if (strA == null || strA.isEmpty()) {
                ...
                String str4 = a.e;
                String str5 = this.b;
                Logger.i(str4, "GrsClientManager.ayncGetGrsUrl: Return [%s][%s] Url: %s", this.f6718a, str5, StringUtils.anonymizeMessage(mapA.get(str5)));
                iQueryUrlCallBack = this.c;
                str = this.d;
            }
    ...
    public String a(Context context, String str, int i) {
        com.huawei.hms.framework.network.grs.g.d dVarA = this.c.a(new com.huawei.hms.framework.network.grs.g.j.c(this.f6716a, context), str, this.d, i);
        return dVarA == null ? "" : dVarA.m() ? this.b.a().a(this.f6716a.getGrsParasKey(true, true, context), "") : dVarA.j();
    }
    ...
    public String a(String str, String str2, Context context, int i) {
        ...
        if (TextUtils.isEmpty(strA)) {
            ...
            strA = com.huawei.hms.framework.network.grs.f.b.a(context.getPackageName()).a(context, this.b, this.f6716a, str, str2, true);
            if (strA == null || strA.isEmpty()) {
    ...
    public Map<String, String> a(String str, Context context, int i) {
        ...
        if (mapA.isEmpty()) {
            ...
            mapA = com.huawei.hms.framework.network.grs.f.b.a(context.getPackageName()).a(context, this.b, this.f6716a, str, true);
            if (mapA == null || mapA.isEmpty()) {
    ...
    private Map<String, String> a(String str, com.huawei.hms.framework.network.grs.e.b bVar, Context context) {
        Map<String, String> mapA = this.b.a(this.f6716a, str, bVar, context);
        if (mapA != null && !mapA.isEmpty()) {
            Logger.i(e, "GrsClientManager.getUrlsLocal: Get URL from GRS Server Cache");
            return mapA;
        }
        Map<String, String> mapA2 = com.huawei.hms.framework.network.grs.f.b.a(context.getPackageName()).a(context, this.b, this.f6716a, str, false);
    ...
    public void a(String str, IQueryUrlsCallBack iQueryUrlsCallBack, Context context, int i) {
        ...
        Map<String, String> mapA = a(str, bVar, context);
        if (!bVar.a()) {
            this.c.a(new com.huawei.hms.framework.network.grs.g.j.c(this.f6716a, context), new C0443a(str, mapA, iQueryUrlsCallBack, context, this.f6716a, this.b), str, this.d, i);
            return;
        }
        if (mapA.isEmpty()) {
    ...
    public void a(String str, String str2, IQueryUrlCallBack iQueryUrlCallBack, Context context, int i) {
        ...
        if (!bVar.a()) {
            this.c.a(new com.huawei.hms.framework.network.grs.g.j.c(this.f6716a, context), new b(str, str2, iQueryUrlCallBack, str3, context, this.f6716a, this.b), str, this.d, i);
