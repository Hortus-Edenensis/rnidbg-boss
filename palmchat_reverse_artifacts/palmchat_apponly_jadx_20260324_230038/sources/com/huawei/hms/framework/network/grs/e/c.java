...
public class c {
    ...
    private final PLSharedPreferences f6724a;
    ...
    public String a(String str, String str2) {
        String string;
        PLSharedPreferences pLSharedPreferences = this.f6724a;
        if (pLSharedPreferences == null) {
            return str2;
        }
        synchronized (pLSharedPreferences) {
            string = this.f6724a.getString(str, str2);
        }
        return string;
    }
    ...
    public void b(String str, String str2) {
        ...
        synchronized (pLSharedPreferences) {
            this.f6724a.putString(str, str2);
        }
    }
