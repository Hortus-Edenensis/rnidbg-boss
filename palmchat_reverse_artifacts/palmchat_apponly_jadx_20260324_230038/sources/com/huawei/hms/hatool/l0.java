...
public class l0 {
    ...
    private void b() {
        ...
        String strA = n1.a(this.f6773a, this.b, this.e);
    ...
    private h1 d() {
        return k.a(this.d, this.f6773a, this.b, this.e, this.c);
    }
    ...
    public void a() {
        ...
        b0 b0VarC;
        String str;
        String strA = a(this.f6773a, this.b);
        if (!TextUtils.isEmpty(strA) || "preins".equals(this.b)) {
            if (!"_hms_config_tag".equals(this.f6773a) && !"_openness_config_tag".equals(this.f6773a)) {
                b();
            }
            h1 h1VarD = d();
            if (h1VarD != null) {
                ...
                if (bArrA.length == 0) {
                    ...
                    d1Var = new f(bArrA, strA, this.f6773a, this.b, this.e, this.d);
                    b0VarC = b0.b();
                }
            } else {
                d1Var = new d1(this.d, this.f6773a, this.e, this.b);
                b0VarC = b0.c();
            }
            b0VarC.a(d1Var);
            return;
