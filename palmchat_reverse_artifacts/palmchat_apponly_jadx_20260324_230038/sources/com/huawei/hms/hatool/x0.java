...
public class x0 extends o {
    ...
    public static Pair<String, String> e(Context context) {
        if (c0.a(context, com.kuaishou.weapon.p0.g.c)) {
        ...
        return (TextUtils.isEmpty(networkOperator) || TextUtils.equals(networkOperator, com.igexin.push.core.b.m)) ? new Pair<>("", "") : networkOperator.length() > 3 ? new Pair<>(networkOperator.substring(0, 3), networkOperator.substring(3)) : new Pair<>("", "");
    }
}
