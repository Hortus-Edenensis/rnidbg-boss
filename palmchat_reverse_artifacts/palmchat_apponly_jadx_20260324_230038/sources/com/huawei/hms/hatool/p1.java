...
public class p1 {
    ...
    public static boolean b(String str) {
        if (p.f6782a.booleanValue()) {
            return true;
        }
        for (String str2 : f6785a) {
            if (a(str, str2, 2)) {
                return true;
            }
        }
    ...
    public static boolean a(String str, String str2, int i) {
        ...
        if (TextUtils.isEmpty(strA) || TextUtils.isEmpty(str2)) {
            ...
            if (!TextUtils.isEmpty(strA2)) {
                if (str2.equals(yz4.b(strA))) {
                    return true;
                }
                if (!str2.equals(yz4.b(strA2))) {
                    return false;
                }
                try {
