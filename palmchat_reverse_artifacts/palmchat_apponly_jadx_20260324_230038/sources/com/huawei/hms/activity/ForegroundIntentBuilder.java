...
public class ForegroundIntentBuilder {
    ...
    public Intent build() {
        String packageName;
        String appId;
        Intent intentStartBridgeActivity = BridgeActivity.getIntentStartBridgeActivity(this.f6502a, ForegroundBusDelegate.class.getName());
        Context context = this.f;
        if (context != null) {
            packageName = context.getPackageName();
            appId = Util.getAppId(this.f);
        } else {
            packageName = this.f6502a.getPackageName();
            appId = Util.getAppId(this.f6502a);
        }
    ...
    public ForegroundIntentBuilder setInnerHms() {
        this.e = this.f6502a.getPackageName();
        return this;
    }
