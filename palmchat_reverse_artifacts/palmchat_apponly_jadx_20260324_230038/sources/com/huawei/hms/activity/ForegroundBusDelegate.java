...
public class ForegroundBusDelegate implements IBridgeActivityDelegate {
    ...
    public void h() {
        ...
        String packageName = this.f ? activityG.getPackageName() : HMSPackageManager.getInstance(activityG.getApplicationContext()).getHMSPackageNameForMultiService();
        ...
        intent.putExtra(HMS_FOREGROUND_REQ_HEADER, this.f6500a.toJson());
    ...
    public void onBridgeActivityCreate(Activity activity) {
        ...
        try {
            ...
            if (TextUtils.isEmpty(this.f6500a.getApiName())) {
    ...
    private void b() {
        Map<String, String> mapFromForegroundRequestHeader = HiAnalyticsUtil.getInstance().getMapFromForegroundRequestHeader(this.f6500a);
        mapFromForegroundRequestHeader.put(HiAnalyticsConstant.HaKey.BI_KEY_DIRECTION, HiAnalyticsConstant.Direction.REQUEST);
        mapFromForegroundRequestHeader.put("version", HiAnalyticsUtil.versionCodeToName(String.valueOf(this.f6500a.getKitSdkVersion())));
        if (g() != null) {
