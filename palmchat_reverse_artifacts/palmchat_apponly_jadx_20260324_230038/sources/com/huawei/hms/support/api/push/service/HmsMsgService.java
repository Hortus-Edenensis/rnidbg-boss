...
public class HmsMsgService extends Service {
    ...
    public static class a extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (Objects.equals(this.f6860a.getApplicationContext().getPackageManager().getNameForUid(message.sendingUid), HMSPackageManager.getInstance(this.f6860a).getHMSPackageName()) && data != null) {
                PackageManagerHelper.PackageStates hMSPackageStates = HMSPackageManager.getInstance(this.f6860a).getHMSPackageStates();
                ...
                if (hMSPackageStates == packageStates) {
                    if (HMSPackageManager.getInstance(this.f6860a).getHMSPackageStates() != packageStates) {
