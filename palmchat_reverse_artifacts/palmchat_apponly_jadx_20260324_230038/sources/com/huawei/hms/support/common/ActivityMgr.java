...
public final class ActivityMgr implements Application.ActivityLifecycleCallbacks {
    ...
    private WeakReference<Activity> f6861a;
    ...
    public Activity getCurrentActivity() {
        if (this.f6861a == null) {
            HMSLog.i("ActivityMgr", "mCurrentActivity is " + this.f6861a);
            return null;
        }
        HMSLog.i("ActivityMgr", "mCurrentActivity.get() is " + this.f6861a.get());
        return this.f6861a.get();
    }
