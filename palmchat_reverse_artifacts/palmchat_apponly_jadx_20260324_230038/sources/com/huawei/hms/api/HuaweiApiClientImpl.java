...
public class HuaweiApiClientImpl extends HuaweiApiClient implements InnerApiClient, ServiceConnection {
    ...
    public class c extends IAIDLCallback.Stub {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ ResultCallback f6658a;

        public c(ResultCallback resultCallback) {
            this.f6658a = resultCallback;
        }
        ...
        public void call(DataBuffer dataBuffer) {
            if (dataBuffer == null) {
                ...
                this.f6658a.onResult(new BundleResult(-1, null));
                return;
            }
            ...
            this.f6658a.onResult(bundleResult);
        }
    }
    ...
    public class e implements ResultCallback<ResolveResult<ConnectResp>> {
        ...
        public class a implements Runnable {
            ...
            /* JADX INFO: renamed from: a, reason: collision with root package name */
            final /* synthetic */ ResolveResult f6660a;

            public a(ResolveResult resolveResult) {
                this.f6660a = resolveResult;
            }

            @Override // java.lang.Runnable
            public void run() {
                HuaweiApiClientImpl.this.a((ResolveResult<ConnectResp>) this.f6660a);
            }
        }
    ...
    public class f implements ResultCallback<ResolveResult<DisconnectResp>> {
        ...
        public class a implements Runnable {
            ...
            /* JADX INFO: renamed from: a, reason: collision with root package name */
            final /* synthetic */ ResolveResult f6662a;

            public a(ResolveResult resolveResult) {
                this.f6662a = resolveResult;
            }

            @Override // java.lang.Runnable
            public void run() {
                HuaweiApiClientImpl.this.b((ResolveResult<DisconnectResp>) this.f6662a);
            }
        }
    ...
    public void disableLifeCycleManagement(Activity activity) {
        ...
        AutoLifecycleFragment.getInstance(activity).stopAutoManage(this.f6655a);
    }
