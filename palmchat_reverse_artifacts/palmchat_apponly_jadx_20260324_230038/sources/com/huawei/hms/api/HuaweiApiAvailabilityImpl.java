...
final class HuaweiApiAvailabilityImpl extends HuaweiApiAvailability {
    ...
    private static final HuaweiApiAvailabilityImpl f6652a = new HuaweiApiAvailabilityImpl();

    /* JADX INFO: compiled from: SearchBox */
    public class a implements BusResponseCallback {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ it5[] f6653a;

        public a(it5[] it5VarArr) {
            this.f6653a = it5VarArr;
        }
        ...
        public BusResponseResult innerError(Activity activity, int i, String str) {
            ...
            this.f6653a[0].b(new AvailabilityException());
            return null;
        }
    ...
    public Task<Void> getHuaweiServicesReady(Activity activity) {
        ...
        it5 it5Var = new it5();
        it5[] it5VarArr = {it5Var};
        Task<Void> taskA = it5Var.a();
        ...
        if (resolveErrorIntent != null) {
            ForegroundIntentBuilder.registerResponseCallback(ResolutionDelegate.CALLBACK_METHOD, new a(it5VarArr));
            ...
            it5VarArr[0].b(new AvailabilityException());
        }
        return taskA;
    }
