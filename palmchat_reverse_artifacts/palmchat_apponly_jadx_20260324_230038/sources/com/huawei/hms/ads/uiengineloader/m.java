...
public final class m implements j {
    ...
    private static final String f6632a = "HMSClassLoaderStrategy";
    ...
    public final ClassLoader a(Context context, String str, int i, PackageInfo packageInfo) {
        ...
        af.b(f6632a, "The api version is:" + Build.VERSION.SDK_INT + ", callingPkg is HMS, use the hmsNativePath.");
        return new com.huawei.hms.ads.dynamicloader.d(str, string, context.getClassLoader());
    }

    public static boolean a(Context context) {
        String str;
        String packageName = context.getPackageName();
        af.b(f6632a, "The pkg name of clientContext is:".concat(String.valueOf(packageName)));
        if (!a(context, packageName)) {
            if (context instanceof ContextWrapper) {
                Context baseContext = ((ContextWrapper) context).getBaseContext();
                String packageName2 = baseContext.getPackageName();
                af.b(f6632a, "The pkg name of baseContext is:".concat(String.valueOf(packageName2)));
                str = a(baseContext, packageName2) ? "The base context is HMS context, cp is HMS." : "The context is HMS context, cp is HMS.";
            }
            af.b(f6632a, "The cp is not HMS.");
            return false;
        }
        af.b(f6632a, str);
        return true;
    ...
    private static boolean a(Context context, String str) {
        ...
        if (TextUtils.isEmpty(str)) {
            af.b(f6632a, "Get pkg name failed: null.");
            return false;
        }
        if (!f.contains(str)) {
            if (!str.startsWith("com.huawei.hwid")) {
                af.b(f6632a, "The pkg does not start with HMS prefix.");
                return false;
            }
            try {
                PackageInfo packageInfo = context.getPackageManager().getPackageInfo(context.getPackageName(), 4);
                if (packageInfo == null) {
                    af.c(f6632a, "Get callPackage packageInfo failed: null.");
                    return false;
                }
                ServiceInfo[] serviceInfoArr = packageInfo.services;
                if (serviceInfoArr == null) {
                    af.c(f6632a, "Get service Info failed: null.");
                    return false;
                }
                ...
                af.b(f6632a, "The calling package is not HMS.");
                return false;
            } catch (PackageManager.NameNotFoundException unused) {
                af.c(f6632a, "Get callPackage packageInfo NameNotFoundException.");
                return false;
            } catch (Throwable th) {
                af.c(f6632a, "Get callPackage packageInfo ex: " + th.getClass().getSimpleName());
                return false;
            }
        }
