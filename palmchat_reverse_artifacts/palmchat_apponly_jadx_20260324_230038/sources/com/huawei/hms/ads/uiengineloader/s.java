...
public final class s implements u {
    ...
    private static final String f6637a = "DecompressedLdStrategy";
    ...
    private static Context b(Context context, y yVar) throws com.huawei.hms.ads.dynamicloader.j {
        ...
        if (iDynamicLoaderAsInterface == null) {
            af.c(f6637a, "Get iDynamicLoader failed: null.");
            return null;
        }
    ...
    public final Context a(Context context, y yVar) {
        ...
        if (yVar == null) {
            ...
            if (TextUtils.isEmpty(str2)) {
                ...
                bundle.putString(com.huawei.hms.ads.dynamicloader.b.e, yVar.f);
                bundle.putString("module_name", yVar.f6645a);
                af.b(f6637a, "loaderVersionType is : " + yVar.f);
                try {
                    ...
                    af.b(f6637a, "The module is a loader, use it to load first.");
                    yVar.e = str2;
                    IDynamicLoader iDynamicLoaderAsInterface = IDynamicLoader.Stub.asInterface(w.a(context, str2));
                    if (iDynamicLoaderAsInterface == null) {
                        af.c(f6637a, "Get iDynamicLoader failed: null.");
                        return null;
                    }
    ...
    private static y b(Context context, String str, String str2) {
        ...
        if (context == null || TextUtils.isEmpty(str)) {
            af.c(f6637a, "The context or moduleName is null.");
            return yVar;
        }
        try {
            yVar = a(context, str);
            if (yVar.d > 0) {
                af.b(f6637a, "Successfully get module info from decompressed asset path.");
                v.a(context, str, yVar.d, str2);
                return yVar;
            }
        } catch (Exception e) {
            af.b(f6637a, "getDataModuleInfo failed." + e.getClass().getSimpleName());
        }
        return yVar;
    }
    ...
    private static y a(File file, String str) {
        ...
        if (list == null || list.length == 0) {
            af.c(f6637a, "No version in module path.");
            return yVar;
        }
        int i = 0;
        ...
        if (i == 0) {
            af.c(f6637a, "Cannot get module version path.");
            return yVar;
        }
        w.a(i, ad.a(file), list, f6637a);
        StringBuilder sb = new StringBuilder();
        sb.append(ad.a(file));
        ...
        if (!file2.exists()) {
            af.c(f6637a, "Cannot find module apk int local path.");
            return yVar;
        }
        ...
        yVar.b = strA;
        yVar.d = i;
        af.b(f6637a, "Get module info from decompressed asset path success: ModuleName:" + str + ", ModuleVersion:" + i);
        return yVar;
    }
                ...
                try {
                    for (String str3 : bundle2.keySet()) {
                        ...
                        if (str3.startsWith(d)) {
                            ...
                            af.b(f6637a, "The module defined the armeabiType:".concat(String.valueOf(i)));
                            bundle.putInt("armeabiType", i);
                        }
                    }
                    af.c(f6637a, "The moduleType is:".concat(String.valueOf(string)));
                    return string;
                } catch (Throwable th) {
