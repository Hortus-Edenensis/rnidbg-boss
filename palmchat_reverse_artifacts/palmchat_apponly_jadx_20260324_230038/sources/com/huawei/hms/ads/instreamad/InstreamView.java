...
public class InstreamView extends PPSPlacementView implements IInstreamView {
    ...
    private MediaMuteListener f6581a;
    ...
    public class a implements f {
        ...
        public void Code() {
            if (InstreamView.this.f6581a != null) {
                InstreamView.this.f6581a.onMute();
            }
        }
        ...
        public void V() {
            if (InstreamView.this.f6581a != null) {
                InstreamView.this.f6581a.onUnmute();
            }
        }
    }
