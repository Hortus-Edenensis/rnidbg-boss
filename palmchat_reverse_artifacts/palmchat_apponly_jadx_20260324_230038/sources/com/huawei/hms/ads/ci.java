...
public class ci extends MediaPlayerAgent implements MediaStateListener, com.huawei.openalliance.ad.media.listener.c {
    ...
    public ci(Context context, com.huawei.hms.ads.uiengine.a aVar) {
        super(context);
        this.V = aVar;
    }
    ...
    public void V(MediaStateListener mediaStateListener) {
        try {
            ...
            bundle.putBinder(bq.f.s, (IBinder) ObjectWrapper.wrap(this));
            this.V.I(bundle);
        } catch (Throwable th) {
