...
public class CusWhyThisAdView extends RelativeLayout {
    ...
    private HorizontalScrollView f6647a;
    ...
    private void Code(Context context, AttributeSet attributeSet) {
        ...
        relativeLayout.setVisibility(8);
        this.f6647a = (HorizontalScrollView) findViewById(R.id.hiad_whythisad_horizontal_List);
    ...
    public void Code(String str) {
        ...
        HorizontalScrollView horizontalScrollView2 = this.f6647a;
