...
public class h {
    ...
    private static final String f6556a = "h";
    ...
    public static Context a(Context context, Bundle bundle) {
        try {
            if (bundle == null) {
                af.d(f6556a, "Failed to read query result");
                return null;
            }
            String str = f6556a;
            ...
            if (!TextUtils.isEmpty(string) && new File(string).exists()) {
                ...
                String string2 = bundle.getString(b.e, "v1");
                ...
                try {
                    ...
                    af.b(p.f6634a, "failed to init Module " + e.getClass().getSimpleName());
                }
                return iVar;
            }
            ...
            af.c(f6556a, "createModuleContext err: %s" + th.getClass().getSimpleName());
            return null;
        }
    }
