...
public final class a implements ServiceConnection {
    ...
    public static final ThreadPoolExecutor f6572a = new ThreadPoolExecutor(0, 3, 60, TimeUnit.SECONDS, new LinkedBlockingQueue(2048), new ThreadPoolExecutor.DiscardPolicy());
    ...
    public void onServiceConnected(ComponentName componentName, final IBinder iBinder) {
        ...
        f6572a.execute(new Runnable() { // from class: com.huawei.hms.ads.identifier.a.1
