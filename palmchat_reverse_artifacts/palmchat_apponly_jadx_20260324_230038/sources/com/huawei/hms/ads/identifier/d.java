...
public abstract class d {
    ...
    private static final byte[] f6577a = new byte[0];
    ...
    public static class a {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private static final Long f6579a = 120000L;
        ...
        public boolean c() {
            synchronized (this.g) {
                ...
                return j + f6579a.longValue() > System.currentTimeMillis();
            }
        }
    ...
    private static String f(Context context) {
        ...
        e.f6580a.execute(new Runnable() { // from class: com.huawei.hms.ads.identifier.d.1
