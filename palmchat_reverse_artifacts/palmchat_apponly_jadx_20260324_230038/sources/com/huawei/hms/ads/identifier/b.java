...
public class b {
    ...
    private static final Uri f6574a = new Uri.Builder().scheme("content").authority("com.huawei.hwid.pps.apiprovider").path("/oaid_scp/get").build();
    ...
    public static AdvertisingIdClient.Info a(final Context context) {
        if (context == null || !a(context, f6574a)) {
            return null;
        }
        ...
        if (TextUtils.isEmpty(strA)) {
            ...
            e.f6580a.execute(new Runnable() { // from class: com.huawei.hms.ads.identifier.b.1
        ...
        e.f6580a.execute(new Runnable() { // from class: com.huawei.hms.ads.identifier.b.2
            @Override // java.lang.Runnable
            public void run() {
                aVarA.a(b.e(context));
            }
    ...
    public static String e(Context context) {
        ...
        try {
            cursorQuery = context.getContentResolver().query(f6574a, null, null, null, null);
            if (cursorQuery != null && cursorQuery.moveToFirst()) {
