...
public class HMSPackageManager {
    ...
    public class b implements Runnable {
        ...
        public void run() {
            ...
            try {
                List<ResolveInfo> listQueryIntentServices = HMSPackageManager.this.f6893a.getPackageManager().queryIntentServices(new Intent("com.huawei.hms.core.aidlservice"), 128);
    ...
    private void e(String str) {
        if (SystemUtils.isHuawei() || SystemUtils.isSystemApp(this.f6893a, str) || Build.VERSION.SDK_INT < 28 || b(str)) {
    ...
    private Pair<String, String> g() {
        try {
            List<ResolveInfo> listQueryIntentServices = this.f6893a.getPackageManager().queryIntentServices(new Intent("com.huawei.hms.core.aidlservice"), 128);
            if (listQueryIntentServices == null || listQueryIntentServices.size() == 0) {
    ...
    private Pair<String, String> h() {
        ...
        for (PackagePriorityInfo packagePriorityInfo : arrayListI) {
            String str = packagePriorityInfo.f6894a;
    ...
    private ArrayList<PackagePriorityInfo> i() {
        try {
            List<ResolveInfo> listQueryIntentServices = this.f6893a.getPackageManager().queryIntentServices(new Intent(PackageConstants.GENERAL_SERVICES_ACTION), 128);
    ...
    private boolean l() {
        Bundle bundle;
        PackageManager packageManager = this.f6893a.getPackageManager();
    ...
    private boolean c() {
        String hmsPath = ReadApkFileUtil.getHmsPath(this.f6893a);
        if (hmsPath == null) {
    ...
    private boolean a(String str, String str2, String str3) {
        if (!TextUtils.isEmpty(str2) && !TextUtils.isEmpty(str3)) {
            ...
            if (!com.huawei.hms.device.a.a(com.huawei.hms.device.a.a(this.f6893a), listB)) {
