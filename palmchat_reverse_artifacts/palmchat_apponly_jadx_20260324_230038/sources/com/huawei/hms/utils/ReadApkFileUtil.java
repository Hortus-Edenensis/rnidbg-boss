...
public class ReadApkFileUtil {
    ...
    private static final String f6900a = "ReadApkFileUtil";
    ...
    private static void b(byte[] bArr) throws Throwable {
        ...
        if (bArr == null) {
            HMSLog.e(f6900a, "manifest is null！");
            return;
        }
        ...
        try {
            ...
            try {
                ...
                try {
                    HMSLog.e(f6900a, "loadApkCert Exception!");
    ...
    private static boolean c() {
        try {
            ...
            HMSLog.i(f6900a, "verifyMDMSignatureV3 MDM verify Exception!:" + e2.getMessage());
        }
        if (a(Base64.decode(EMUI11_PK, 0), a(g, "SHA-384"), b(e), "SHA384withRSA")) {
            HMSLog.i(f6900a, "verifyMDMSignatureV3 verify successful!");
            return true;
        }
        HMSLog.i(f6900a, "verifyMDMSignatureV3 verify failure!");
        return false;
    }
    ...
    public static String getHmsPath(Context context) {
        try {
            ...
            HMSLog.e(f6900a, "HMS is not found!");
            return null;
        }
    }
    ...
    public static boolean isCertFound(String str) throws Throwable {
        ...
        try {
            ...
            e = e4;
            r32 = zipFile;
            HMSLog.e(f6900a, "isCertFound Exception!" + e.getMessage());
            r3 = r32;
            if (r32 != 0) {
                try {
                    r32.close();
            ...
            if (zipFile != 0) {
                try {
                    ...
                    HMSLog.e(f6900a, "zipFile.close Exception!" + e6.getMessage());
                }
            }
            throw th;
        }
    ...
    */
    public static boolean verifyApkHash(String str) throws Throwable {
        ...
        try {
            ...
            if (str3 != null) {
                if (str3.equals(strBytesToString)) {
                    try {
                        ...
                        HMSLog.i(f6900a, "close stream Exception!" + e3.getMessage());
                        return true;
                    }
                }
            }
            try {
                ...
                HMSLog.i(f6900a, "close stream Exception!" + e4.getMessage());
                return false;
            }
        } catch (Exception e5) {
            e = e5;
            zipFile2 = zipFile;
            HMSLog.i(f6900a, "verifyApkHash Exception!" + e.getMessage());
            if (zipFile2 == null) {
                return false;
            }
            try {
                ...
                str2 = f6900a;
                HMSLog.i(str2, "close stream Exception!" + e6.getMessage());
                return false;
            }
            if (zipFile != 0) {
                try {
                    ...
                    HMSLog.i(f6900a, "close stream Exception!" + e7.getMessage());
                }
            }
            throw th;
        } catch (Throwable th2) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        HMSLog.i(f6900a, "getManifestBytes Exception!" + e2.getMessage());
                        IOUtils.closeQuietly(inputStream);
    ...
    private static ArrayList<String> a(byte[] bArr) {
        ...
        try {
            ...
            HMSLog.e(f6900a, "getManifestLinesArrary IOException!");
            return null;
        }
    }
    ...
    private static boolean b() {
        try {
            ...
            HMSLog.i(f6900a, "verifyMDMSignatureV2 MDM verify Exception!:" + e2.getMessage());
        }
        if (a(Base64.decode(EMUI10_PK, 0), a(g, x.dW), b(d), RSAUtil.SIGNATURE_ALGORITHM)) {
            HMSLog.i(f6900a, "verifyMDMSignatureV2 verify successful!");
            return true;
        }
        HMSLog.i(f6900a, "verifyMDMSignatureV2 verify failure!");
        return false;
    }
        ...
        try {
            try {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    bufferedWriter.write(HttpClient.NEWLINE, 0, 2);
                }
                bufferedWriter.flush();
            } catch (Exception e2) {
                HMSLog.i(f6900a, "getManifestBytesbySorted Exception!" + e2.getMessage());
            }
            IOUtils.closeQuietly((OutputStream) byteArrayOutputStream);
    ...
    private static boolean a(byte[] bArr, byte[] bArr2, byte[] bArr3, String str) throws Exception {
        ...
        signature.initVerify(KeyFactory.getInstance(EncryptUtils.RSA_ENCRYPT_ALGORITHM).generatePublic(new X509EncodedKeySpec(bArr)));
