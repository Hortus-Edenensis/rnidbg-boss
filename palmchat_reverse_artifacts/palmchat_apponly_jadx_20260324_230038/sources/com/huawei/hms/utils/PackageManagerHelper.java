...
public class PackageManagerHelper {
    ...
    private final PackageManager f6898a;
    ...
    public PackageManagerHelper(Context context) {
        this.f6898a = context.getPackageManager();
    }

    private byte[] a(String str) {
        Signature[] signatureArr;
        try {
            PackageInfo packageInfo = this.f6898a.getPackageInfo(str, 64);
    ...
    public String getApplicationName(String str) {
        try {
            return this.f6898a.getApplicationLabel(this.f6898a.getApplicationInfo(str, 128)).toString();
    ...
    public long getPackageFirstInstallTime(String str) {
        try {
            PackageInfo packageInfo = this.f6898a.getPackageInfo(str, 128);
            if (packageInfo != null) {
    ...
    public String getPackageSigningCertificate(String str) {
        ...
        try {
            PackageInfo packageInfo = this.f6898a.getPackageInfo(str, 134217728);
    ...
    public PackageStates getPackageStates(String str) {
        ...
        try {
            return this.f6898a.getApplicationInfo(str, 128).enabled ? PackageStates.ENABLED : PackageStates.DISABLED;
        } catch (AndroidException | RuntimeException unused) {
    ...
    public int getPackageVersionCode(String str) {
        try {
            PackageInfo packageInfo = this.f6898a.getPackageInfo(str, 16);
            if (packageInfo != null) {
    ...
    public boolean hasProvider(String str, String str2) {
        ...
        try {
            PackageInfo packageInfo = this.f6898a.getPackageInfo(str, 8);
    ...
    public boolean verifyPackageArchive(String str, String str2, String str3) {
        ...
        try {
            packageArchiveInfo = this.f6898a.getPackageArchiveInfo(str, 64);
        } catch (Exception e) {
