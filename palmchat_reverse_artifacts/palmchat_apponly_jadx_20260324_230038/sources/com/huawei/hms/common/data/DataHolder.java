...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    */
    private static ArrayList<CursorWindow> iterCursorWindow(Builder builder, int i, List list) {
        ...
        cursorWindow2.setNumColumns(builder.f6688a.length);
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (!cursorWindow2.allocRow()) {
                ...
                try {
                    ...
                    cursorWindow.setNumColumns(builder.f6688a.length);
            ...
            for (int i3 = 0; i3 < builder.f6688a.length && (zPutValue = putValue(cursorWindow2, map.get(builder.f6688a[i3]), i2, i3)); i3++) {
            }
            if (!zPutValue) {
                ...
                cursorWindow3.setNumColumns(builder.f6688a.length);
    ...
    private DataHolder(Builder builder, int i, Bundle bundle) {
        this(builder.f6688a, getCursorWindows(builder, -1), i, (Bundle) null);
    }

    private DataHolder(Builder builder, int i, Bundle bundle, int i2) {
        this(builder.f6688a, getCursorWindows(builder, -1), i, bundle);
    }
}
