...
public abstract class BaseHmsClient implements AidlApiClient {
    ...
    public static final class ConnectionResultWrapper {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private HuaweiApi.RequestHandler f6696a;
        ...
        return new BinderAdapter.BinderCallBack() { // from class: com.huawei.hms.common.internal.BaseHmsClient.1
            ...
            public void onBinderFailed(int i2, Intent intent) {
                ...
                if (activeActivity == null) {
                    ...
                    BaseHmsClient.this.a(new ConnectionResult(10, PendingIntent.getActivity(BaseHmsClient.this.f6691a, 11, intent, 67108864)));
                    BaseHmsClient.this.d = null;
                    return;
                }
    ...
    public String getServiceAction() {
        HMSPackageManager hMSPackageManager = HMSPackageManager.getInstance(this.f6691a);
    ...
    public boolean c() {
        return HMSPackageManager.getInstance(this.f6691a).getHMSPackageStatesForMultiService() == PackageManagerHelper.PackageStates.ENABLED;
    }
    ...
    private void a(String str, String str2) {
        if (this.c.isUseInnerHms()) {
            m = InnerBinderAdapter.getInstance(this.f6691a, str2, str);
            if (isConnected()) {
        ...
        l = OuterBinderAdapter.getInstance(this.f6691a, str2, str);
        if (isConnected()) {
            HMSLog.i("BaseHmsClient", "The binder is already connected.");
            getAdapter().updateDelayTask();
            connectedInternal(getAdapter().getServiceBinder());
    ...
    private void b(AvailableAdapter availableAdapter, int i2) {
        ...
        if (!getClientSettings().isHasActivity()) {
            a(new ConnectionResult(26, HuaweiApiAvailability.getInstance().getErrPendingIntent(this.f6691a, i2, 0)));
            return;
        }
    ...
    private void a(int i2, boolean z) {
        ...
        if (z || !(i3 == 3 || i3 == 5)) {
            ...
            if (this.f6691a.getPackageName().equals(this.c.getInnerHmsPkg())) {
                HMSLog.i("BaseHmsClient", "service packageName is same, bind core service return");
                a();
                return;
            }
            if (Util.isAvailableLibExist(this.f6691a)) {
                AvailableAdapter availableAdapter = new AvailableAdapter(i2);
                int iIsHuaweiMobileServicesAvailable = availableAdapter.isHuaweiMobileServicesAvailable(this.f6691a);
            ...
            int iIsHuaweiMobileServicesAvailable2 = HuaweiApiAvailability.getInstance().isHuaweiMobileServicesAvailable(this.f6691a, i2);
