...
public class HuaweiApi<TOption extends Api.ApiOptions> {
    ...
    public static class RequestHandler<OptionsT extends Api.ApiOptions> implements BaseHmsClient.ConnectionCallbacks, BaseHmsClient.OnConnectionFailedListener {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final Queue<TaskApiCallbackWrapper> f6677a = new LinkedList();
        ...
        public void postMessage(final TaskApiCallbackWrapper taskApiCallbackWrapper) {
            ...
            this.f6677a.add(taskApiCallbackWrapper);
            ...
            this.b.post(requestHeader, taskApiCall.getRequestJson(), new AnyClient.CallBack() { // from class: com.huawei.hms.common.HuaweiApi.RequestHandler.2
                ...
                public void onCallback(IMessageEntity iMessageEntity, String str) {
                    ...
                    RequestManager.getHandler().post(new Runnable() { // from class: com.huawei.hms.common.HuaweiApi.RequestHandler.2.1
                        @Override // java.lang.Runnable
                        public void run() {
                            RequestHandler.this.f6677a.remove(taskApiCallbackWrapper);
                        }
                    });
                }
            });
        ...
        private TaskApiCallbackWrapper b(final TaskApiCallWrapper taskApiCallWrapper) {
            return new TaskApiCallbackWrapper(taskApiCallWrapper, new AnyClient.CallBack() { // from class: com.huawei.hms.common.HuaweiApi.RequestHandler.1
                ...
                /* JADX INFO: renamed from: a, reason: collision with root package name */
                private AtomicBoolean f6678a = new AtomicBoolean(true);
                ...
                public void onCallback(IMessageEntity iMessageEntity, String str) {
                    ...
                    if (this.f6678a.compareAndSet(true, false)) {
        ...
        public void c() {
            ...
            HMSLog.i("HuaweiApi", "run queue size = " + this.f6677a.size());
            Iterator<TaskApiCallbackWrapper> it = this.callbackWaitQueue.iterator();
            while (it.hasNext()) {
                a(it.next());
            }
            Iterator<TaskApiCallbackWrapper> it2 = this.f6677a.iterator();
            while (it2.hasNext()) {
                a(it2.next());
            }
        ...
        public void a(TaskApiCallWrapper taskApiCallWrapper) {
            ...
            int hmsVersionCode = HMSPackageManager.getInstance(((HuaweiApi) this.d).f6675a).getHmsVersionCode();
    ...
    public static class TaskApiCallbackWrapper {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final TaskApiCallWrapper f6684a;
        ...
        public TaskApiCallbackWrapper(TaskApiCallWrapper taskApiCallWrapper, AnyClient.CallBack callBack) {
            this.f6684a = taskApiCallWrapper;
            this.b = callBack;
        }
    ...
    public static class a<OptionsT extends Api.ApiOptions> implements Runnable {
        ...
        */
        ...
        @Override // java.lang.Runnable
        public void run() {
            RequestHandler requestHandler = new RequestHandler(this.f6685a);
            try {
    ...
    public Task<Boolean> disconnectService() {
        ...
        RequestManager.getHandler().post(new Runnable() { // from class: com.huawei.hms.common.HuaweiApi.1
            @Override // java.lang.Runnable
            public void run() {
                HuaweiApi.this.a((HuaweiApi<?>) this, (it5<Boolean>) it5Var);
            }
        });
        return it5Var.a();
    }
    ...
    public <TResult, TClient extends AnyClient> Task<TResult> doWrite(TaskApiCall<TClient, TResult> taskApiCall) {
        ...
        if (taskApiCall == null) {
            ...
            it5 it5Var = new it5();
            it5Var.b(new ApiException(Status.FAILURE));
            return it5Var.a();
        }
        HiAnalyticsInnerClient.reportEntryClient(this.f6675a, taskApiCall.getUri(), TextUtils.isEmpty(this.g.getSubAppID()) ? this.f : this.g.getSubAppID(), taskApiCall.getTransactionId(), String.valueOf(getKitSdkVersion()));
        if (this.n == null) {
    ...
    public AnyClient getClient(Looper looper, RequestHandler requestHandler) {
        return this.d.buildClient(this.f6675a, getClientSetting(), requestHandler, requestHandler);
    }

    public ClientSettings getClientSetting() {
        ClientSettings clientSettings = new ClientSettings(this.f6675a.getPackageName(), this.f6675a.getClass().getName(), getScopes(), this.e, null, this.g);
        if (!this.m) {
            String hMSPackageNameForMultiService = HMSPackageManager.getInstance(this.f6675a).getHMSPackageNameForMultiService();
    ...
    public void setInnerHms() {
        this.l = this.f6675a.getPackageName();
        this.m = true;
    ...
    private <TResult, TClient extends AnyClient> Task<TResult> a(TaskApiCall<TClient, TResult> taskApiCall) {
        ...
        it5 it5Var = new it5();
        RequestManager.getHandler().post(new a(this, new TaskApiCallWrapper(taskApiCall, it5Var)));
        return it5Var.a();
    }
