...
public class PushPreferences {
    ...
    protected SharedPreferences f6497a;
    ...
    public boolean clear() {
        SharedPreferences sharedPreferences = this.f6497a;
    ...
    public boolean removeKey(String str) {
        ...
        SharedPreferences sharedPreferences = this.f6497a;
        if (sharedPreferences == null || !sharedPreferences.contains(str) || (editorEdit = this.f6497a.edit()) == null) {
            return false;
        }
    ...
    public boolean write(ContentValues contentValues) {
        if (this.f6497a == null || contentValues == null) {
            return false;
        }
        boolean z = true;
    ...
    public boolean removeKey(String[] strArr) {
        ...
        for (String str : strArr) {
            if (this.f6497a.contains(str)) {
                this.f6497a.edit().remove(str);
            }
        }
        this.f6497a.edit().commit();
        return true;
    }
}
