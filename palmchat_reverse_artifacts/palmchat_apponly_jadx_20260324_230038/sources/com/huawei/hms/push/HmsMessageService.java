...
public class HmsMessageService extends Service {
    ...
    private final Messenger f6814a = new Messenger(new f(new b(this, null)));
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ...
            if (this.b.equals(BaseUtils.getLocalToken(applicationContext, this.f6815a))) {
                return;
            }
            HMSLog.i("HmsMessageService", "receive a new token, refresh the local token");
            BaseUtils.saveToken(applicationContext, this.f6815a, this.b);
        }
    }
