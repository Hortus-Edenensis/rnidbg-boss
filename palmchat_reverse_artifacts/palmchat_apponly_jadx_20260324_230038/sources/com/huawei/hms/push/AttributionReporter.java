...
public class AttributionReporter {
    ...
    private HuaweiApi<Api.ApiOptions.NoOptions> f6811a;
    private Context b;
    ...
    private AttributionReporter(Context context) {
        ...
        if (context instanceof Activity) {
            this.f6811a = new HuaweiApi<>((Activity) context, (Api<Api.ApiOptions>) api, (Api.ApiOptions) null, (AbstractClientBuilder) new PushClientBuilder());
        } else {
            this.f6811a = new HuaweiApi<>(context, (Api<Api.ApiOptions>) api, (Api.ApiOptions) null, new PushClientBuilder());
        }
        this.f6811a.setKitSdkVersion(61200300);
    }
    ...
    private Task<Void> a(AttributionEvent attributionEvent, Bundle bundle) {
        ...
        try {
            ...
            return this.f6811a.doWrite(new AttributionReportTask(PushNaming.PUSH_ANALYSIS_REPORT, JsonUtil.createJsonString(a(attributionEvent, new SafeBundle(bundle))), strReportEntry));
