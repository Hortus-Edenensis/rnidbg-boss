...
public class o {
    ...
    private JSONObject a(JSONObject jSONObject) throws JSONException {
        ...
        jSONObject2.put(EventParams.KEY_GROUP, this.f6832a);
    ...
    private void g(JSONObject jSONObject) {
        this.f6832a = jSONObject.optString(EventParams.KEY_GROUP);
        HMSLog.d("PushSelfShowLog", "NOTIFY_GROUP:" + this.f6832a);
    ...
    public byte[] n() {
        try {
            return a(a(b(u()), q())).toString().getBytes(m.f6829a);
        } catch (JSONException e) {
    ...
    public byte[] x() {
        return this.s.getBytes(m.f6829a);
    }
