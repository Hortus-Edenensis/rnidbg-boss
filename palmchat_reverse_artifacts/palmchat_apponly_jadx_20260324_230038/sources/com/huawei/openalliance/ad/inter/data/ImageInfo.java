...
public class ImageInfo implements Serializable {
    ...
    public ImageInfo(com.huawei.openalliance.ad.beans.metadata.ImageInfo imageInfo) {
        ...
        if (imageInfo != null) {
            ...
            if (!TextUtils.isEmpty(strI) && !this.originalUrl.startsWith(ce.HTTP.toString()) && !this.originalUrl.startsWith(ce.HTTPS.toString())) {
    ...
    public boolean Code() {
        String str = this.url;
        return str != null && str.startsWith(ce.CONTENT.toString());
    }
}
