...
public class FlowLayoutView extends ViewGroup {
    ...
    public void onMeasure(int i, int i2) {
        ...
        c cVar = this.B;
        if (cVar != null && !this.f6939a.contains(cVar)) {
            I();
        }
        Iterator<c> it = this.f6939a.iterator();
        while (it.hasNext()) {
            iCode += it.next().Code();
        }
        setMeasuredDimension(View.MeasureSpec.getSize(i), View.resolveSize(iCode + (this.F * (this.f6939a.size() - 1)) + getPaddingBottom() + getPaddingTop(), i2));
    }
