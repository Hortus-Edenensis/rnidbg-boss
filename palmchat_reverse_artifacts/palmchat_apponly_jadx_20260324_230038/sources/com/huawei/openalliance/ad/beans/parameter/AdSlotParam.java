...
public class AdSlotParam {
    ...
    public static final class a {
        ...
        private android.location.Location f6914a;
        ...
        public Location Code() {
            android.location.Location location = this.f6914a;
            if (location == null) {
                return null;
            }
            return new Location(Double.valueOf(location.getLongitude()), Double.valueOf(this.f6914a.getLatitude()));
        }
    ...
    public void B(String str) {
        ...
        if (al.Code(map2) || al.Code(this.contentBundleMap)) {
            ...
            if (this.contentBundleMap.containsKey("content") && this.contentBundleMap.containsKey(x.cs)) {
                this.contentBundleMap.remove(x.cs);
            }
