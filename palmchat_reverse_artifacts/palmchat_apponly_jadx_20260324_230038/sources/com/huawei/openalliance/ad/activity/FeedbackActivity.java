...
public class FeedbackActivity extends com.huawei.openalliance.ad.activity.a implements com.huawei.openalliance.ad.compliance.a {
    ...
    public static class a extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (feedbackActivity == null) {
                ...
                if (!bc.Code(action)) {
                    if (action.equals(x.dF + this.Code)) {
                        feedbackActivity.L();
                        context.unregisterReceiver(FeedbackActivity.r);
                        return;
                    }
                    if (action.equals(x.dG + this.Code)) {
                        context.unregisterReceiver(FeedbackActivity.r);
    ...
    private a Code(Context context, String str) {
        ...
        intentFilter.addAction(x.dF + str);
        intentFilter.addAction(x.dG + str);
        z.Code(context, aVar, intentFilter, z.i(getApplicationContext()), null);
        return aVar;
    }
        ...
        this.i.setOnClickListener(new View.OnClickListener() { // from class: com.huawei.openalliance.ad.activity.FeedbackActivity.1
            ...
            public void onClick(View view) {
                try {
                    ...
                    db.Code(feedbackActivity, feedbackActivity.b, "3");
                } catch (Throwable th) {
    ...
    public boolean B() {
        ...
        this.b = (AdContentData) safeIntent.getSerializableExtra(be.aU);
        this.s = safeIntent.getIntExtra(be.aJ, 0);
        if (this.b == null) {
            return false;
        }
        return super.B();
    ...
    public void onCreate(Bundle bundle) {
        try {
            ...
            D();
            db.Code(this, this.b, "0");
            WeakReference<Context> weakReference = p;
            if (weakReference != null) {
                bg.Code(this, weakReference.get());
            }
            AdContentData adContentData = this.b;
            if (adContentData != null) {
                r = Code(this, adContentData.L());
            }
            fh.V("FeedbackActivity", "onCreate: %s, instance: %s", Integer.valueOf(hashCode()), Integer.valueOf(this.s));
        } catch (Throwable th) {
            fh.I("FeedbackActivity", "onCreate error: %s", th.getClass().getSimpleName());
            Code(o.get(Integer.valueOf(this.s)));
            finish();
        }
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:11:0x002b A[Catch: all -> 0x002f, TRY_LEAVE, TryCatch #0 {all -> 0x002f, blocks: (B:3:0x0011, B:9:0x0021, B:10:0x0027, B:11:0x002b), top: B:18:0x0011 }] */
    ...
    */
    ...
    public static void Code(Context context, com.huawei.openalliance.ad.feedback.a aVar) {
        ...
        try {
            ...
            viewCode.getViewTreeObserver().addOnGlobalLayoutListener(new a.ViewTreeObserverOnGlobalLayoutListenerC0445a(viewCode, context, iArr2));
            Intent intent = new Intent(context, (Class<?>) FeedbackActivity.class);
            intent.putExtra(be.av, iArr);
            intent.putExtra(be.ay, iArr3);
            intent.setFlags(65536);
            intent.putExtra(be.aU, lVarCode.q());
            intent.putExtra(be.aJ, iNextInt);
