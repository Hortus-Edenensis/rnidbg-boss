...
public class AgProtocolActivity extends d {
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        ...
        fh.V("resolution", "requestCode=" + i + "resultCode=" + i2 + " appPackageName=" + this.f6911a);
        if (100 != i) {
            if (101 == i) {
            ...
            com.huawei.openalliance.ad.download.app.c.Code(this, 1001, this.f6911a, this.c, (Class) null);
        } else {
    ...
    public void onCreate(Bundle bundle) {
        ...
        i.I(new Runnable() { // from class: com.huawei.openalliance.ad.activity.AgProtocolActivity.1
            @Override // java.lang.Runnable
            public void run() {
                ...
                if (intent != null) {
                    try {
                        ...
                        AgProtocolActivity.this.f6911a = intent.getStringExtra(com.huawei.openalliance.ad.download.app.d.g);
    ...
    public void V() {
        db.Code(getApplicationContext(), this.b, this.f6911a, this.c, com.huawei.openalliance.ad.download.app.a.V);
    }
}
