    ...
    public void setImageDrawable(Drawable drawable) {
        if (drawable != null) {
            if (drawable instanceof dw) {
                ((dw) drawable).Code(new dy() { // from class: com.huawei.openalliance.ad.views.NativeWindowImageView.1
