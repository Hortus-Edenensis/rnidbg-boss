...
public class h extends g {
    ...
    private void B(float f) {
        this.f6987a.reset();
        this.f6987a.addArc(this.b, 90.0f, 180.0f);
        float f2 = this.d.right - this.e;
        if (Float.compare(Code(), V()) != 0) {
            Path path = this.f6987a;
            Rect rect = this.d;
        ...
        Rect rect2 = this.d;
        this.c.set(f2 - fV, rect2.top, f2 + fV, rect2.bottom);
        this.f6987a.addArc(this.c, 270.0f, 180.0f);
    }
    ...
    private void Z(float f) {
        ...
        Rect rect2 = this.d;
        this.f6987a.addRect(f2, rect2.top, fWidth + rect2.left, rect2.bottom, Path.Direction.CCW);
    }
    ...
    private void I(float f) {
        ...
        RectF rectF = this.c;
        Rect rect2 = this.d;
        rectF.set(rect2.left + fCode, rect2.top, (rect.left + rect.height()) - fCode, rect2.bottom);
        this.f6987a.addArc(this.c, 270.0f, -180.0f);
    }
