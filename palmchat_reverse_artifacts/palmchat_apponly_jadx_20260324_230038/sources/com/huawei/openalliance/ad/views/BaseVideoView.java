...
public abstract class BaseVideoView extends AutoScaleSizeRelativeLayout implements TextureView.SurfaceTextureListener, me {
    ...
    private final Set<com.huawei.openalliance.ad.media.listener.d> f6965a;
    private f aa;
    private d ab;
    ...
    public BaseVideoView(Context context) {
        ...
        this.f6965a = new CopyOnWriteArraySet();
            ...
            public void onReceive(Context context2, Intent intent) {
                if (TextUtils.equals(PushConsts.ACTION_BROADCAST_NETWORK_CHANGE, intent.getAction())) {
                    try {
                        ...
                        fh.V(str, "Build.VERSION: %s", Integer.valueOf(i2));
                        if (i2 < 29) {
    ...
    public void F(int i2) {
        Iterator<com.huawei.openalliance.ad.media.listener.d> it = this.f6965a.iterator();
        while (it.hasNext()) {
            it.next().V(i2);
        }
    }
            ...
            public void onReceive(Context context2, Intent intent) {
                if (TextUtils.equals(PushConsts.ACTION_BROADCAST_NETWORK_CHANGE, intent.getAction())) {
                    try {
                        ...
                        fh.V(str, "Build.VERSION: %s", Integer.valueOf(i22));
                        if (i22 < 29) {
                            NetworkInfo networkInfoCode = ap.Code(connectivityManager);
                            if (networkInfoCode == null || !networkInfoCode.isConnected()) {
                                BaseVideoView.this.k();
