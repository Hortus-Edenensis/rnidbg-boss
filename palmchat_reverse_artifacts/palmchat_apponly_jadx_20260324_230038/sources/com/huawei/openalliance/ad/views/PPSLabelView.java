...
public class PPSLabelView extends TextView {
    ...
    public static class c implements RemoteCallResultCallback<String> {
        ...
        public void onRemoteCallResult(String str, CallResult<String> callResult) {
            ...
            if (pPSLabelView != null) {
                if (TextUtils.isEmpty(data) || !data.startsWith(ce.CONTENT.toString())) {
    ...
    public PPSLabelView(Context context) {
        ...
        this.c = new View.OnClickListener() { // from class: com.huawei.openalliance.ad.views.PPSLabelView.1
            ...
            public void onClick(View view) {
                a aVar;
                WeakReference<gc> weakReference = PPSLabelView.this.I;
                if (weakReference != null) {
                    final gc gcVar = weakReference.get();
                    if (gcVar == null) {
                    ...
                    if (z.Code(iArrZ, 2) && z.Code(iArrB, 2) && (aVar = PPSLabelView.this.S) != null) {
                        fh.V(PPSLabelView.F, "adLabelClickListener %s", aVar);
    ...
    private String getDefaultAdSign() {
        return this.f6972a ? getResources().getString(R.string.hiad_ad_label_new) : "";
    }
    ...
    public void setTextWhenImgLoadFail(String str) {
        ...
        if (TextUtils.isEmpty(str) && !this.f6972a) {
            setVisibility(8);
        }
        setText(str);
        setClick(new SpannableStringBuilder(getText()));
