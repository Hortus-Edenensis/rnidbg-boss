...
public class PlacementVideoView extends PlacementMediaView implements ma {
    ...
    public PlacementVideoView(Context context) {
        ...
        this.m = new com.huawei.openalliance.ad.media.listener.b() { // from class: com.huawei.openalliance.ad.views.PlacementVideoView.2
            ...
            public void Code() {
                if (fh.Code()) {
                    fh.Code(PlacementVideoView.this.getTAG(), "contentId: %s onBufferingStart", ((PlacementMediaView) PlacementVideoView.this).I);
                }
        ...
        this.n = new MediaStateListener() { // from class: com.huawei.openalliance.ad.views.PlacementVideoView.3
            ...
            public void onMediaStart(MediaPlayerAgent mediaPlayerAgent, int i) {
                if (fh.Code()) {
                    fh.Code(PlacementVideoView.this.getTAG(), "contentId: %s onMediaStart:  %s", ((PlacementMediaView) PlacementVideoView.this).I, Integer.valueOf(i));
                }
    ...
    public void setPlacementAd(com.huawei.openalliance.ad.inter.data.h hVar) {
        ...
        sb.append(hVar == null ? com.igexin.push.core.b.m : hVar.d());
        fh.V(tag, sb.toString());
        b();
    ...
    public PlacementVideoView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.n = new MediaStateListener() { // from class: com.huawei.openalliance.ad.views.PlacementVideoView.3
            ...
            public void onMediaStart(MediaPlayerAgent mediaPlayerAgent, int i2) {
                if (fh.Code()) {
                    fh.Code(PlacementVideoView.this.getTAG(), "contentId: %s onMediaStart:  %s", ((PlacementMediaView) PlacementVideoView.this).I, Integer.valueOf(i2));
                }
                PlacementVideoView.this.g = true;
    ...
    public void Code(p pVar, boolean z) {
        ...
        ((PlacementMediaView) this).V = strE;
        this.L.setVideoFileUrl(strE);
        VideoView videoView = this.L;
        n nVar = this.Code;
        videoView.setContentId(nVar == null ? null : nVar.d());
        if (this.c) {
