...
public class SafeWebView extends WebView {
    ...
    public final class b extends WebViewClient {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public WebViewClient f6995a;
        public boolean b;

        @Override // android.webkit.WebViewClient
        public void doUpdateVisitedHistory(WebView webView, String str, boolean z) {
            WebViewClient webViewClient = this.f6995a;
        ...
        public b(WebViewClient webViewClient, boolean z) {
            this.f6995a = webViewClient;
            this.b = z;
        }
    ...
    public boolean isWhiteListUrl(String str) {
        ...
        return (whitelistWithPath == null || whitelistWithPath.length == 0) ? (whitelistNotMatchSubDomain == null || whitelistNotMatchSubDomain.length == 0) ? u56.e(str, whitelist) : u56.h(str, whitelistNotMatchSubDomain) : u56.c(str, whitelistWithPath);
    }
    ...
    public void loadDataWithBaseURL(String str, String str2, String str3, String str4, String str5) {
        ...
        if (TextUtils.isEmpty(this.f6994a)) {
            ...
            super.loadDataWithBaseURL(this.f6994a, str2, str3, str4, str5);
        }
    }
    ...
    public void loadUrl(String str) {
        ...
        if (TextUtils.isEmpty(this.f6994a)) {
            ...
            super.loadUrl(this.f6994a);
        }
    }

    public final void onCheckError(WebView webView, String str) {
        h73.e(f, "onCheckError url is not in white list ", str);
        webView.stopLoading();
    ...
    public void postUrl(String str, byte[] bArr) {
        ...
        if (TextUtils.isEmpty(this.f6994a)) {
            ...
            super.postUrl(this.f6994a, bArr);
        }
    }
