        ...
        if (this.m_i) {
            try {
                ...
                if (this.m_l == null) {
                    ...
                    Log.e("IDHelper", "3147");
                    if (this.m_l != null) {
                        (Build.VERSION.SDK_INT >= 24 ? this.m_l : this.m_l).release();
                        this.m_l = null;
                    }
                    return;
                }
                ...
                if (this.m_l != null) {
                    ContentProviderClient contentProviderClient = Build.VERSION.SDK_INT >= 24 ? this.m_l : this.m_l;
