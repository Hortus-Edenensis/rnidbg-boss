...
public class b {
    ...
    private com.cmic.sso.sdk.a.a f5471a;
    ...
    private b(boolean z) {
        com.cmic.sso.sdk.a.a aVarA = new a.C0321a().a();
        this.b = aVarA;
        if (z) {
            this.f5471a = aVarA;
        } else {
    ...
    public com.cmic.sso.sdk.a.a d() {
        return new a.C0321a().a(d.b(this.b.a())).c(d.a(this.b.c())).b(d.b(this.b.b())).d(d.c(this.b.d())).d(d.a(this.b.h())).e(d.b(this.b.i())).a(d.e(this.b.e())).b(d.d(this.b.f())).c(d.c(this.b.g())).f(d.f(this.b.j())).a(d.a(this.b.k())).b(d.b(this.b.l())).a();
    }
        ...
        try {
            ...
            if (jSONObject.has("Configlist")) {
                ...
                if (jSONObject2.has("LOGS_CONTROL")) {
                    String[] strArrSplit = jSONObject2.getString("LOGS_CONTROL").replace("h", "").split(ContainerUtils.FIELD_DELIMITER);
