...
class t {
    public static String a(long j, String str, boolean z, String str2, String str3, int i, String str4) {
        return Uri.encode("out_pid=" + j + ContainerUtils.FIELD_DELIMITER + "out_package_name" + ContainerUtils.KEY_VALUE_DELIMITER + str + ContainerUtils.FIELD_DELIMITER + "out_start_download" + ContainerUtils.KEY_VALUE_DELIMITER + z + ContainerUtils.FIELD_DELIMITER + "out_intent_from" + ContainerUtils.KEY_VALUE_DELIMITER + i + ContainerUtils.FIELD_DELIMITER + "enter_id" + ContainerUtils.KEY_VALUE_DELIMITER + str2 + ContainerUtils.FIELD_DELIMITER + "out_operator" + ContainerUtils.KEY_VALUE_DELIMITER + str3 + ContainerUtils.FIELD_DELIMITER + "out_match_type" + ContainerUtils.KEY_VALUE_DELIMITER + str4);
    }

    public static String a(Context context, long j, String str, boolean z, boolean z2, String str2, String str3, int i, String str4) {
        return "softmarket://market_appdetail?params=" + a(j, str, z, str2, str3, i, str4) + ContainerUtils.FIELD_DELIMITER + y.f + ContainerUtils.KEY_VALUE_DELIMITER + (z2 ? 1 : 0);
    }
    ...
    public static String a(Context context, String str, String str2, boolean z, boolean z2, String str3, String str4, String str5, int i) {
        return "softmarket://market_search_result?params=" + a(str, str2, z, str3, str4, i, str5) + ContainerUtils.FIELD_DELIMITER + y.f + ContainerUtils.KEY_VALUE_DELIMITER + (z2 ? 1 : 0);
    }

    public static String a(Context context, String str, boolean z, String str2, String str3, int i, String str4) {
        return "softmarket://market_latestact?params=" + a(str, str2, str3, i, str4) + ContainerUtils.FIELD_DELIMITER + y.f + ContainerUtils.KEY_VALUE_DELIMITER + (z ? 1 : 0);
    }

    private static String a(String str, String str2) {
        return Uri.encode("enter_id=" + str + ContainerUtils.FIELD_DELIMITER + "out_operator" + ContainerUtils.KEY_VALUE_DELIMITER + str2);
    }

    public static String a(String str, String str2, String str3, int i, String str4) {
        return Uri.encode("url=" + str + ContainerUtils.FIELD_DELIMITER + "out_intent_from" + ContainerUtils.KEY_VALUE_DELIMITER + i + ContainerUtils.FIELD_DELIMITER + "enter_id" + ContainerUtils.KEY_VALUE_DELIMITER + str2 + ContainerUtils.FIELD_DELIMITER + "out_operator" + ContainerUtils.KEY_VALUE_DELIMITER + str3 + ContainerUtils.FIELD_DELIMITER + "out_match_type" + ContainerUtils.KEY_VALUE_DELIMITER + str4);
    }

    private static String a(String str, String str2, boolean z, String str3, String str4, int i, String str5) {
        return Uri.encode("out_package_name=" + str2 + ContainerUtils.FIELD_DELIMITER + "out_app_name" + ContainerUtils.KEY_VALUE_DELIMITER + str + ContainerUtils.FIELD_DELIMITER + "out_operator" + ContainerUtils.KEY_VALUE_DELIMITER + str4 + ContainerUtils.FIELD_DELIMITER + "out_start_download" + ContainerUtils.KEY_VALUE_DELIMITER + z + ContainerUtils.FIELD_DELIMITER + "out_intent_from" + ContainerUtils.KEY_VALUE_DELIMITER + i + ContainerUtils.FIELD_DELIMITER + "enter_id" + ContainerUtils.KEY_VALUE_DELIMITER + str3 + ContainerUtils.FIELD_DELIMITER + "out_operator" + ContainerUtils.KEY_VALUE_DELIMITER + str4 + ContainerUtils.FIELD_DELIMITER + "out_match_type" + ContainerUtils.KEY_VALUE_DELIMITER + str5);
    }
