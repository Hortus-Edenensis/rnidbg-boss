...
final class j extends com.vivo.push.s {
    ...
    public final void a(com.vivo.push.v vVar) {
        if (this.f11282a.getPackageName().equals(com.vivo.push.util.z.a(this.f11282a))) {
            return;
        }
        com.vivo.push.b.j jVar = (com.vivo.push.b.j) vVar;
        int iD = jVar.d();
        int iE = jVar.e();
        com.vivo.push.util.t.d("OnChangePushStatusTask", "OnChangePushStatusTask serviceStatus is " + iD + " ; receiverStatus is " + iE);
        if (iD == 2) {
            b(this.f11282a);
        } else if (iD == 1) {
            a(this.f11282a);
