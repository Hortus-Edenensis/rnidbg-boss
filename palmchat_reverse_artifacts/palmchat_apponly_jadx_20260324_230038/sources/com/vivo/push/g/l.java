...
final class l extends aa {
    ...
    public final void a(com.vivo.push.v vVar) {
        ...
        int i = tVar.i();
        com.vivo.push.util.t.c("OnDelTagsTask", "doTask,删除成功的标签 = " + arrayListD + " 删除失败的= " + listE + " 错误码= " + i);
        String strH = tVar.h();
        if (arrayListD != null) {
        ...
        if (arrayList.size() > 0 || arrayList3.size() > 0) {
            com.vivo.push.util.t.c("OnDelTagsTask", "doTask1,删除成功的别名 = " + arrayList + " 删除失败的别名= " + arrayList3 + " 错误码= " + i);
            if (arrayList.size() > 0) {
                com.vivo.push.m.a();
                com.vivo.push.m.b(arrayList);
            }
            com.vivo.push.m.a().a(tVar.h(), i);
            com.vivo.push.t.b(new m(this, i, arrayList, arrayList3, strH));
        }
        if (arrayList2.size() > 0 || arrayList4.size() > 0) {
            com.vivo.push.util.t.c("OnDelTagsTask", "doTask1,删除成功的标签 = " + arrayList + " 删除失败的标签= " + arrayList3 + " 错误码= " + i);
            if (arrayList2.size() > 0) {
                com.vivo.push.m.a().c(arrayList2);
            }
            com.vivo.push.m.a().a(tVar.h(), i);
            com.vivo.push.t.b(new n(this, i, arrayList2, arrayList4, strH));
        }
    }
}
