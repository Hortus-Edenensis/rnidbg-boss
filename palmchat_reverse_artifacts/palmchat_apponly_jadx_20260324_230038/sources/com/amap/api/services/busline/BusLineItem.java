...
public class BusLineItem implements Parcelable {
    ...
    public String toString() {
        return this.b + " " + di.a(this.j) + "-" + di.a(this.k);
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel parcel, int i) {
        parcel.writeFloat(this.f3122a);
        ...
        parcel.writeString(di.a(this.j));
        parcel.writeString(di.a(this.k));
    ...
    public BusLineItem(Parcel parcel) {
        ...
        this.j = di.e(parcel.readString());
        this.k = di.e(parcel.readString());
