...
public class BusLineQuery implements Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (str2 == null) {
            if (busLineQuery.f3123a != null) {
                return false;
            }
        } else if (!str2.equals(busLineQuery.f3123a)) {
            return false;
        }
        String str3 = this.f;
        if (str3 == null) {
    ...
    public boolean weakEquals(BusLineQuery busLineQuery) {
        ...
        } else if (!busLineQuery.getQueryString().equals(this.f3123a)) {
            return false;
        }
        if (this.b == null) {
    ...
    public BusLineQuery m17clone() {
        BusLineQuery busLineQuery = new BusLineQuery(this.f3123a, this.e, this.b);
