...
public class RouteBusLineItem extends BusLineItem {
    ...
    public RouteBusLineItem(Parcel parcel) {
        ...
        this.f3224a = (BusStationItem) parcel.readParcelable(BusStationItem.class.getClassLoader());
    ...
    public boolean equals(Object obj) {
        ...
        BusStationItem busStationItem2 = this.f3224a;
        if (busStationItem2 == null) {
            if (routeBusLineItem.f3224a != null) {
                return false;
            }
        } else if (!busStationItem2.equals(routeBusLineItem.f3224a)) {
            return false;
        }
        return true;
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeParcelable(this.f3224a, i);
