...
public class BusStep implements Parcelable {
    ...
    private RouteBusWalkItem f3194a;
    ...
    public BusStep(Parcel parcel) {
        ...
        this.f3194a = (RouteBusWalkItem) parcel.readParcelable(RouteBusWalkItem.class.getClassLoader());
    ...
    public void setWalk(RouteBusWalkItem routeBusWalkItem) {
        this.f3194a = routeBusWalkItem;
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel parcel, int i) {
        parcel.writeParcelable(this.f3194a, i);
