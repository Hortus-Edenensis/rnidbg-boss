...
public class AMapLocationQualityReport implements Cloneable {
    ...
    AMapLocationClientOption.AMapLocationMode f3070a = AMapLocationClientOption.AMapLocationMode.Hight_Accuracy;

    public String getAdviseMessage() {
        StringBuffer stringBuffer = new StringBuffer();
        AMapLocationClientOption.AMapLocationMode aMapLocationMode = this.f3070a;
        ...
        if (this.f3070a != AMapLocationClientOption.AMapLocationMode.Device_Sensors) {
    ...
    public AMapLocationQualityReport m12clone() {
        ...
        try {
            ...
            aMapLocationQualityReport.setLocationMode(this.f3070a);
            aMapLocationQualityReport.setInstallHighDangerMockApp(this.g);
        } catch (Throwable th) {
            me.a(th, "AMapLocationQualityReport", "clone");
        }
