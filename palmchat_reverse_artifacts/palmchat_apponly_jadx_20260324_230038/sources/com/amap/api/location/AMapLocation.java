...
public class AMapLocation extends Location implements Parcelable, Cloneable {
    ...
    public static final Parcelable.Creator<AMapLocation> CREATOR = new Parcelable.Creator<AMapLocation>() { // from class: com.amap.api.location.AMapLocation.1
        private static AMapLocation a(Parcel parcel) {
            ...
            aMapLocation.f3062a = parcel.readString();
    ...
    public JSONObject toJson(int i) {
        try {
            ...
            jSONObject.put(EventParams.KEY_PARAM_NUMBER, this.n);
            jSONObject.put(MapBundleKey.MapObjKey.OBJ_SS_POINAME, this.j);
            ...
            jSONObject.put("poiid", this.f3062a);
    ...
    public String toString() {
        ...
        try {
            ...
            stringBuffer.append("poiid=" + this.f3062a + "#");
            stringBuffer.append("floor=" + this.b + "#");
            stringBuffer.append(TECameraSettings.PictureCallback.ERROR_CODE_SPLIT_REGEX + this.p + "#");
    ...
    public void writeToParcel(Parcel parcel, int i) {
        try {
            ...
            me.a(th, "AMapLocation", "writeToParcel");
        }
    }

    /* JADX INFO: renamed from: clone, reason: merged with bridge method [inline-methods] */
    public AMapLocation m10clone() {
        try {
            super.clone();
        } catch (Throwable unused) {
        }
        ...
        try {
            ...
            aMapLocation.setBuildingId(this.f3062a);
