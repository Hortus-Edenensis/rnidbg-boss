...
import com.amap.api.col.p0002sl.fq;
import com.amap.api.col.p0002sl.fr;
...
public class AMapUtils {
    ...
    public static class a extends Thread {
        ...
        public final void run() {
            if (this.b != null) {
                try {
                    ft.a(this.b, new gd.a(this.f3081a, "6.0.0", "AMAP_SDK_Android_2DMap_6.0.0").a(new String[]{"com.amap.api.maps"}).a());
                    interrupt();
                } catch (fq e) {
                    e.printStackTrace();
                }
    ...
    private static String a(PoiPara poiPara, Context context) {
        String str = String.format(Locale.US, "androidamap://arroundpoi?sourceApplication=%s&keywords=%s&dev=0", fr.b(context), poiPara.getKeywords());
    ...
    public static float calculateLineDistance(LatLng latLng, LatLng latLng2) {
        ...
        double d12 = dArr[2];
        return (float) (Math.asin(Math.sqrt(d11 + ((d12 - dSin4) * (d12 - dSin4))) / 2.0d) * 1.27420015798544E7d);
    }
    ...
    private static String a(NaviPara naviPara, Context context) {
        return String.format(Locale.US, "androidamap://navi?sourceApplication=%s&lat=%f&lon=%f&dev=0&style=%d", fr.b(context), Double.valueOf(naviPara.getTargetPoint().latitude), Double.valueOf(naviPara.getTargetPoint().longitude), Integer.valueOf(naviPara.getNaviStyle()));
    }
