...
public final class cx {
    ...
    private static Classify.DataCategory e(JSONObject jSONObject) {
        ...
        JSONArray jSONArrayOptJSONArray = jSONObject.optJSONArray(x.cw);
        ...
        dataCategory.defaultValue = jSONObject.optInt(MapController.DEFAULT_LAYER_TAG);
        ...
        dataCategory.img = jSONObject.optString(bh.Code);
        dataCategory.showType = jSONObject.optString("show_type");
        dataCategory.value = jSONObject.optString(ActionUtils.PAYMENT_AMOUNT);
    ...
    private static Classify.Category f(JSONObject jSONObject) {
        ...
        category.defaultValue = jSONObject.optInt(MapController.DEFAULT_LAYER_TAG);
        category.name = jSONObject.optString("name");
        category.value = jSONObject.optString(ActionUtils.PAYMENT_AMOUNT);
        category.classifyItemType = jSONObject.optString("classify_item_type");
        category.img = jSONObject.optString(bh.Code);
    ...
    private static ListData.BasicInfo j(JSONObject jSONObject) {
        ...
        basicInfo.category = jSONObject.optString(x.cw);
    ...
    private static List<Classify.Data> b(JSONArray jSONArray) {
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            ...
            if (jSONObjectOptJSONObject != null) {
                ...
                JSONArray jSONArrayOptJSONArray = jSONObjectOptJSONObject.optJSONArray(x.cw);
                ArrayList arrayList2 = new ArrayList();
                if (jSONArrayOptJSONArray != null) {
                    for (int i2 = 0; i2 < jSONArrayOptJSONArray.length(); i2++) {
                        JSONObject jSONObjectOptJSONObject2 = jSONArrayOptJSONArray.optJSONObject(i2);
    ...
    private static List<Classify.CheckedNode> a(JSONArray jSONArray) {
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            ...
            if (jSONObjectOptJSONObject != null) {
                ...
                checkedNode.id = jSONObjectOptJSONObject.optString("id");
                checkedNode.value = jSONObjectOptJSONObject.optString(ActionUtils.PAYMENT_AMOUNT);
