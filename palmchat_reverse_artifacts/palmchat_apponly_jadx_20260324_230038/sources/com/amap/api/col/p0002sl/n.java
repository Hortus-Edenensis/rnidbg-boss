...
public final class n implements LocationSource, Inner_3dMap_locationListener {
    ...
    private void a(boolean z) {
        cu cuVar;
        if (this.f != null && (cuVar = this.e) != null) {
            cuVar.c();
            cu cuVar2 = new cu(this.g);
            this.e = cuVar2;
            cuVar2.a(this);
