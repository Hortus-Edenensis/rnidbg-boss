...
public final class gw {
    ...
    private static byte[] a(byte[] bArr) {
        try {
            if (f2847a == null) {
                f2847a = ge.c("YAAAAAAAAAAAAAAAAAAAAAA").getBytes();
            }
            IvParameterSpec ivParameterSpec = new IvParameterSpec(f2847a);
            SecretKeySpec secretKeySpec = new SecretKeySpec(a(b()).getBytes("UTF-8"), ge.c("EQUVT"));
