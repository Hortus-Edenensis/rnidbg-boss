...
public class ek {
    ...
    public final void a(RouteSearch.FromAndTo fromAndTo, List<LatLonPoint> list) throws AMapException {
        ...
        if (list != null && list.size() != 0) {
            ...
            for (LatLonPoint latLonPoint : list) {
                dA2 += (double) di.a(from, latLonPoint);
                from = latLonPoint;
            }
            dA = dA2 + ((double) di.a(from, to));
        } else {
            dA = di.a(fromAndTo.getFrom(), fromAndTo.getTo());
        }
    ...
    public final void a(RouteSearch.FromAndTo fromAndTo) throws AMapException {
        ...
        if (this.o < ((double) di.a(fromAndTo.getFrom(), fromAndTo.getTo())) / 1000.0d) {
            throw new AMapException(AMapException.AMAP_OVER_DIRECTION_RANGE);
        }
    }
