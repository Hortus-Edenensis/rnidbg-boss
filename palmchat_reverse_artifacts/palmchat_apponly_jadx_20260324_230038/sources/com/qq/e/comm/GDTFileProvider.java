...
public class GDTFileProvider extends ContentProvider {
    ...
    public static class b implements a {
        ...
        public Uri a(File file) {
            try {
                ...
                return new Uri.Builder().scheme("content").authority(this.f10426a).encodedPath(Uri.encode(entry.getKey()) + '/' + Uri.encode(canonicalPath.substring(length), "/")).build();
            } catch (IOException unused) {
    ...
    private static a c(Context context, String str) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next == 2) {
                ...
                String attributeValue2 = xmlResourceParserLoadXmlMetaData.getAttributeValue(null, OapsWrapper.KEY_PATH);
    ...
    public void attachInfo(Context context, ProviderInfo providerInfo) {
        ...
        this.f10425a = b(context, providerInfo.authority);
    }

    @Override // android.content.ContentProvider
    public int delete(Uri uri, String str, String[] strArr) {
        return this.f10425a.a(uri).delete() ? 1 : 0;
    }

    @Override // android.content.ContentProvider
    public String getType(Uri uri) {
        File fileA = this.f10425a.a(uri);
    ...
    public ParcelFileDescriptor openFile(Uri uri, String str) throws FileNotFoundException {
        return ParcelFileDescriptor.open(this.f10425a.a(uri), a(str));
    }
