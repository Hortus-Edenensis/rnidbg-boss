...
public class NativeUnifiedAD extends NativeAbstractAD<NUADI> {
    ...
    public static class AdListenerAdapter implements ADListener {
        ...
        private NativeADUnifiedListener f10410a;

        public AdListenerAdapter(NativeADUnifiedListener nativeADUnifiedListener) {
            this.f10410a = nativeADUnifiedListener;
        }
        ...
        public void onADEvent(ADEvent aDEvent) {
            if (this.f10410a != null) {
                ...
                if (type != 100) {
                    ...
                    this.f10410a.onNoAD(AdErrorConvertor.getAdError(aDEvent));
                    return;
                }
                ...
                this.f10410a.onADLoaded(arrayList);
            }
        }
    }
