...
public class NativeExpressAD extends NativeAbstractAD<NEADI> implements IReward {
    ...
    public static class ADListenerAdapter implements ADListener {
        ...
        private NativeExpressADListener f10408a;
        ...
        public ADListenerAdapter(NativeExpressADListener nativeExpressADListener) {
            this.f10408a = nativeExpressADListener;
        }

        @Override // com.qq.e.comm.adevent.ADListener
        public void onADEvent(ADEvent aDEvent) {
            if (NativeExpressAD.b(this.f10408a, aDEvent) || NativeExpressAD.b(this.b, aDEvent) || NativeExpressAD.b(this.c, aDEvent)) {
                return;
            }
    ...
    public void a(NEADI neadi) {
        ...
        ((NEADI) this.f10390a).setServerSideVerificationOptions(this.p);
