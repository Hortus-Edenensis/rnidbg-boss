...
class ADListenerAdapter implements ADListener {
    ...
    private final UnifiedBannerADListener f10394a;
    ...
    public ADListenerAdapter(UnifiedBannerADListener unifiedBannerADListener) {
        this.f10394a = unifiedBannerADListener;
    }
    ...
    public void onADEvent(ADEvent aDEvent) {
        ...
        if (type == 100) {
            UnifiedBannerADListener unifiedBannerADListener = this.f10394a;
        ...
        if (type == 101) {
            UnifiedBannerADListener unifiedBannerADListener2 = this.f10394a;
        ...
        if (type == 303) {
            UnifiedBannerADListener unifiedBannerADListener3 = this.f10394a;
        ...
        switch (type) {
            case 103:
                UnifiedBannerADListener unifiedBannerADListener4 = this.f10394a;
            ...
            case 104:
                ...
                break;
            case 105:
                UnifiedBannerADListener unifiedBannerADListener5 = this.f10394a;
                if (unifiedBannerADListener5 != null) {
                    unifiedBannerADListener5.onADClicked();
                }
                break;
            case 106:
                UnifiedBannerADListener unifiedBannerADListener6 = this.f10394a;
