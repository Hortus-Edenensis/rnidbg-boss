...
public class m {
    ...
    @SuppressLint({"NewApi"})
    public static void a(View view, String str, int i, String str2, float[] fArr) {
        view.setBackground(a(str, i, str2, fArr));
    }
    ...
    private static Drawable a(String str, int i, String str2, float[] fArr) {
