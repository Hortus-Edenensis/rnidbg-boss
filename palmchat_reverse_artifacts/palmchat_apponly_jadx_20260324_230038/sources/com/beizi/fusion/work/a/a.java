...
public class a extends com.beizi.fusion.work.a {
    ...
    public String aw() {
        com.beizi.ad.v2.c.a aVar = this.s;
        if (aVar == null) {
            return null;
        }
        return aVar.h();
    ...
    */
    ...
    public void k() {
        v();
        ab();
        com.beizi.ad.v2.c.a aVar = new com.beizi.ad.v2.c.a(this.o, false);
        this.s = aVar;
        aVar.a(this.i);
        this.s.a(this.e);
        this.s.a(new com.beizi.ad.a() { // from class: com.beizi.fusion.work.a.a.1
