...
public class DevInfo {
    ...
    private String os = p.c();
    private String platform = "2";
    private String brand = p.a();
    private String model = p.b();

    public DevInfo(Context context) {
        this.context = context;
        this.sdkUID = an.a(context, KEY_SDK_UID_NEW);
        this.sdkUIDOrig = an.a(context, KEY_SDK_UID_ORIG);
        this.devType = p.d(context);
    ...
    private void generateSdkUID(Context context, String str, String str2) {
        ...
        String str3 = ao.a(str + "_" + str2 + "_" + ap.c(context) + "_1_" + strGenerateFourDigitRandom + "_" + strGenerateCurrentTimeMillis) + "_1_" + strGenerateFourDigitRandom + "_" + strGenerateCurrentTimeMillis;
        this.sdkUID = str3;
        an.a(context, KEY_SDK_UID_NEW, str3);
    }
