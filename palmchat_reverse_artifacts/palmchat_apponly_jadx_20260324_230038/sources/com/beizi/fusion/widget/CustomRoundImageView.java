...
public class CustomRoundImageView extends AppCompatImageView {
    ...
    public void draw(Canvas canvas) {
        canvas.saveLayer(this.f4767a, this.f, 31);
        RectF rectF = this.f4767a;
        float f = this.b;
        canvas.drawRoundRect(rectF, f, f, this.f);
        canvas.saveLayer(this.f4767a, this.e, 31);
        super.draw(canvas);
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        this.f4767a.set(0.0f, 0.0f, getWidth(), getHeight());
    }
