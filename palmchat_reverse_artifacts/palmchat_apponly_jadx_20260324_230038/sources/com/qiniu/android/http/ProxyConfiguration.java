    ...
    public Authenticator authenticator() {
        return new Authenticator() { // from class: com.qiniu.android.http.ProxyConfiguration.1
            ...
            public Request authenticate(Route route, Response response) throws IOException {
                ...
                return response.request().newBuilder().header(HttpHeaders.PROXY_AUTHORIZATION, Credentials.basic(proxyConfiguration.user, proxyConfiguration.password)).header("Proxy-Connection", HTTP.CONN_KEEP_ALIVE).build();
            }
        };
    }
