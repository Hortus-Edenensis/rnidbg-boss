...
public class RequestBuilder<TranscodeType> extends BaseRequestOptions<RequestBuilder<TranscodeType>> implements ModelTypes<RequestBuilder<TranscodeType>> {
    ...
    private RequestBuilder<TranscodeType> cloneWithNullErrorAndThumbnail() {
        return mo45clone().error((RequestBuilder) null).thumbnail((RequestBuilder) null);
    }
    ...
    private RequestBuilder<TranscodeType> loadGeneric(@Nullable Object obj) {
        if (isAutoCloneEnabled()) {
            return mo45clone().loadGeneric(obj);
        }
        this.model = obj;
    ...
    public RequestBuilder<TranscodeType> addListener(@Nullable RequestListener<TranscodeType> requestListener) {
        if (isAutoCloneEnabled()) {
            return mo45clone().addListener(requestListener);
        }
    ...
    public RequestBuilder<TranscodeType> error(@Nullable RequestBuilder<TranscodeType> requestBuilder) {
        if (isAutoCloneEnabled()) {
            return mo45clone().error((RequestBuilder) requestBuilder);
        }
    ...
    public RequestBuilder<TranscodeType> listener(@Nullable RequestListener<TranscodeType> requestListener) {
        if (isAutoCloneEnabled()) {
            return mo45clone().listener(requestListener);
        }
    ...
    public RequestBuilder<TranscodeType> thumbnail(@Nullable RequestBuilder<TranscodeType> requestBuilder) {
        if (isAutoCloneEnabled()) {
            return mo45clone().thumbnail(requestBuilder);
        }
    ...
    public RequestBuilder<TranscodeType> transition(@NonNull TransitionOptions<?, ? super TranscodeType> transitionOptions) {
        if (isAutoCloneEnabled()) {
            return mo45clone().transition(transitionOptions);
        }
    ...
    public ViewTarget<ImageView, TranscodeType> experimentalIntoFront(@NonNull ImageView imageView) {
        ...
        if (!isTransformationSet() && isTransformationAllowed() && imageView.getScaleType() != null) {
            switch (AnonymousClass1.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()]) {
                case 1:
                    baseRequestOptionsOptionalCenterCrop = mo45clone().optionalCenterCrop();
                    break;
                case 2:
                    baseRequestOptionsOptionalCenterCrop = mo45clone().optionalCenterInside();
                    break;
                case 3:
                case 4:
                case 5:
                    baseRequestOptionsOptionalCenterCrop = mo45clone().optionalFitCenter();
                    break;
                case 6:
                    baseRequestOptionsOptionalCenterCrop = mo45clone().optionalCenterInside();
                    break;
    ...
    public RequestBuilder<TranscodeType> mo45clone() {
        RequestBuilder<TranscodeType> requestBuilder = (RequestBuilder) super.mo45clone();
        requestBuilder.transitionOptions = requestBuilder.transitionOptions.m46clone();
        ...
        if (requestBuilder2 != null) {
            requestBuilder.thumbnailBuilder = requestBuilder2.mo45clone();
        }
        RequestBuilder<TranscodeType> requestBuilder3 = requestBuilder.errorBuilder;
        if (requestBuilder3 != null) {
            requestBuilder.errorBuilder = requestBuilder3.mo45clone();
        }
    ...
    public RequestBuilder<TranscodeType> error(Object obj) {
        ...
        return error((RequestBuilder) cloneWithNullErrorAndThumbnail().load2(obj));
    }
