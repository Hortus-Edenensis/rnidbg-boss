...
public final class k {
    ...
    public static final Pattern f2546a = Pattern.compile("([0-9]{1,2})[- ]([A-Za-z]{3,9})[- ]([0-9]{2,4})[ ]([0-9]{1,2}:[0-9][0-9]:[0-9][0-9])");
    ...
    public static long a(String str) {
        ...
        int i2;
        int i3;
        Matcher matcher = f2546a.matcher(str);
        if (matcher.find()) {
        ...
        time.set(aVarE.c, aVarE.b, aVarE.f2547a, i, i2, i3);
    ...
    public static int d(String str) {
        if (str.length() == 2) {
            ...
            return iCharAt >= 70 ? iCharAt + AMapException.CODE_AMAP_CLIENT_UNKNOWN_ERROR : iCharAt + 2000;
        }
        if (str.length() == 3) {
