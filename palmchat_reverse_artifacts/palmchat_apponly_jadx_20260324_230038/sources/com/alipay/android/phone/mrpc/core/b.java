...
public final class b implements HttpClient {
    ...
    public class a implements HttpRequestInterceptor {
        ...
        public final void process(HttpRequest httpRequest, HttpContext httpContext) {
            C0049b c0049b = b.this.f;
            if (c0049b != null && C0049b.a(c0049b) && (httpRequest instanceof HttpUriRequest)) {
                C0049b.a(c0049b, b.a((HttpUriRequest) httpRequest));
            }
        }
    ...
    public static class C0049b {
        ...
        public static /* synthetic */ void a(C0049b c0049b, String str) {
            Log.println(c0049b.b, c0049b.f2540a, str);
        }

        public static /* synthetic */ boolean a(C0049b c0049b) {
            return Log.isLoggable(c0049b.f2540a, c0049b.b);
        }
    }
    ...
    public static b a(String str) {
        ...
        schemeRegistry.register(new Scheme(BaseConstants.SCHEME_HTTPS, SSLCertificateSocketFactory.getHttpSocketFactory(30000, null), 443));
    ...
    public static void a(HttpRequest httpRequest) {
        httpRequest.addHeader(HttpHeaders.ACCEPT_ENCODING, Constants.CP_GZIP);
    }
