...
public final class e {
    ...
    public static Map<String, String> f2560a;
    ...
    public static synchronized String b(Context context, Map<String, String> map) {
        ...
        for (String str : b) {
            if (f2560a.containsKey(str)) {
                treeMap.put(str, f2560a.get(str));
            }
        }
        return l07.a(a(treeMap));
    }
    ...
    public static synchronized void c(Context context, Map<String, String> map) {
        ...
        f2560a.putAll(d.a(context));
        f2560a.putAll(c.a(context));
        f2560a.putAll(a.a(context, map));
    }
