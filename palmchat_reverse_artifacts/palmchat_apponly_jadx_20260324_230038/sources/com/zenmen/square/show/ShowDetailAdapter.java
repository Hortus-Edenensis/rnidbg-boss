...
public class ShowDetailAdapter extends LxFragmentStateAdapter<PagerFragment, SquareFeed> {
    public ShowDetailAdapter(@NonNull FragmentActivity fragmentActivity) {
    ...
    public PagerFragment m(int i) {
        List<D> list;
        return (i < 0 || (list = this.m) == 0 || list.size() <= i || ((SquareFeed) this.m.get(i)).adKey == null) ? new FeedShowDetailFragment() : new AdFragment();
    }
}
