...
public class SquareHackyViewPager extends ViewPager {
    public SquareHackyViewPager(Context context) {
        super(context);
    }
    ...
    public SquareHackyViewPager(Context context, AttributeSet attributeSet) {
