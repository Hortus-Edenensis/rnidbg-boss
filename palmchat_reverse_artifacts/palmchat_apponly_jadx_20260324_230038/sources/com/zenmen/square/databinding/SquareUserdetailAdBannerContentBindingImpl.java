...
public class SquareUserdetailAdBannerContentBindingImpl extends SquareUserdetailAdBannerContentBinding {
    ...
    public SquareUserdetailAdBannerContentBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
    ...
    public SquareUserdetailAdBannerContentBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
