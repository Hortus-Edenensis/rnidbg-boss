...
public class DynamicCornerImageView extends AppCompatImageView {
    private BitmapShader mBitmapShader;
    private int mBorderRadius;
    private Matrix mMatrix;
    private Paint mPaint;

    public DynamicCornerImageView(Context context) {
        this(context, null);
    }
    ...
    public DynamicCornerImageView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public DynamicCornerImageView(Context context, AttributeSet attributeSet, int i) {
