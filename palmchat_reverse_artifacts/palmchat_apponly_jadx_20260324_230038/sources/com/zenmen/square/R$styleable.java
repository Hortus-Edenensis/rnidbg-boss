...
public final class R$styleable {
    ...
    public static final int AdSDKProgressButton_buttonColor = 0;
    public static final int AdSDKProgressButton_cornerRadius = 1;
    public static final int AdSDKProgressButton_maxProgress = 2;
    public static final int AdSDKProgressButton_minProgress = 3;
    public static final int AdSDKProgressButton_progress = 4;
    public static final int AdSDKProgressButton_progressBackColor = 5;
    public static final int AdSDKProgressButton_progressColor = 6;
    public static final int AdSDKProgressButton_progressMargin = 7;
    ...
    public static final int BeiZiCircleProgressViewStyle_adScopeCircleColor = 0;
    public static final int BeiZiCircleProgressViewStyle_adScopeRadius = 1;
    public static final int BeiZiCircleProgressViewStyle_adScopeRingBgColor = 2;
    public static final int BeiZiCircleProgressViewStyle_adScopeRingColor = 3;
    public static final int BeiZiCircleProgressViewStyle_adScopeStrokeWidth = 4;
    public static final int BeiZiCircleProgressViewStyle_adScopeTextColor = 5;
    ...
    public static final int CircleFlowIndicator_count = 5;
    public static final int CircleFlowIndicator_fadeOut = 6;
    public static final int CircleFlowIndicator_inactiveColor = 7;
    public static final int CircleFlowIndicator_inactiveType = 8;
    public static final int CircleFlowIndicator_radius = 9;
    public static final int CircleFlowIndicator_spacing = 10;
    ...
    public static final int CircleProgressView_current_progress = 0;
    public static final int CircleProgressView_inner_circle_color = 1;
    public static final int CircleProgressView_inner_circle_size = 2;
    public static final int CircleProgressView_inner_text_color = 3;
    public static final int CircleProgressView_inner_text_size = 4;
    public static final int CircleProgressView_location_start = 5;
    public static final int CircleProgressView_progress_color = 6;
    public static final int CircleProgressView_progress_width = 7;
    public static final int CircleProgressView_stroke_color = 8;
    public static final int CircleProgressView_stroke_margin = 9;
    public static final int CircleProgressView_stroke_width = 10;
    ...
    public static final int ClearEditText_isGray = 0;
    public static final int ClickShowMoreLayout_click_text = 0;
    public static final int ClickShowMoreLayout_oneline_limit = 1;
    public static final int ClickShowMoreLayout_show_line = 2;
    public static final int ClickShowMoreLayout_suffix_color = 3;
    public static final int ClickShowMoreLayout_text_color = 4;
    public static final int ClickShowMoreLayout_text_size = 5;
    public static final int ClickShowMoreLayout_text_sync = 6;
    ...
    public static final int DateWheelPicker_wheel_items = 0;
    public static final int DateWheelPicker_year_max = 1;
    public static final int DateWheelPicker_year_min = 2;
    ...
    public static final int EffectiveShapeView_border_width = 0;
    ...
    public static final int EffectiveShapeView_esv_shape = 3;
    public static final int EffectiveShapeView_radius_x = 4;
    public static final int EffectiveShapeView_radius_x_dp = 5;
    public static final int EffectiveShapeView_radius_y = 6;
    public static final int EffectiveShapeView_radius_y_dp = 7;
    public static final int EffectiveShapeView_sides = 8;
    public static final int ExpandableTextView_ellipse_maxLines = 0;
    public static final int ExpandableTextView_maxLines_up_limited = 1;
    public static final int ExpandableTextView_suffix_color = 2;
    public static final int ExpandableTextView_sync_state = 3;
    ...
    public static final int FloatMenuItem_item_action = 0;
    public static final int FloatMenuItem_item_icon = 1;
    public static final int FloatMenuItem_item_text = 2;
    ...
    public static final int FlowLayout_singleLine = 3;
    ...
    public static final int ForceClickImageView_foregroundColor = 0;
    ...
    public static final int FriendCirclePtrListView_cacheColorHint = 0;
    public static final int FriendCirclePtrListView_choiceMode = 1;
    public static final int FriendCirclePtrListView_dividerHeight = 2;
    public static final int FriendCirclePtrListView_fastScrollStyle = 3;
    public static final int FriendCirclePtrListView_listSelector = 4;
    public static final int FriendCirclePtrListView_listview_divider = 5;
    public static final int FriendCirclePtrListView_lxfastScrollEnabled = 6;
    public static final int FriendCirclePtrListView_overScrollFooter = 7;
    public static final int FriendCirclePtrListView_overScrollHeader = 8;
    public static final int FriendCirclePtrListView_smoothScrollbar = 9;
    public static final int FriendCirclePtrListView_transcriptMode = 10;
    public static final int GiftPanel_ui_type = 0;
    public static final int GradientAlphaFrameLayout_gradientTopHeight = 0;
    ...
    public static final int LightingAnimationView1_la_colors1 = 0;
    public static final int LightingAnimationView1_la_duration1 = 1;
    public static final int LightingAnimationView1_la_k1 = 2;
    public static final int LightingAnimationView1_la_play_mode1 = 3;
    public static final int LightingAnimationView1_la_positions1 = 4;
    public static final int LightingAnimationView1_la_radius1 = 5;
    public static final int LightingAnimationView1_la_repeat1 = 6;
    public static final int LightingAnimationView1_la_w1 = 7;
    ...
    public static final int MatchPropInfoCardView_match_ui_type = 0;
    ...
    public static final int MultiImageLayout_max_ratio = 0;
    public static final int MultiImageLayout_spacing = 1;
    ...
    public static final int PostBar_squareBarTarget = 0;
    public static final int PraiseWidget_click_bg_color = 0;
    public static final int PraiseWidget_font_color = 1;
    public static final int PraiseWidget_font_size = 2;
    public static final int PraiseWidget_like_icon = 3;
    public static final int ProgressBarView_max = 0;
    public static final int ProgressBarView_ringColor = 1;
    public static final int ProgressBarView_ringProgressColor = 2;
    public static final int ProgressBarView_ringWidth = 3;
    public static final int ProgressBarView_showTextProgress = 4;
    ...
    public static final int RoundCornerCoverView_cornerRad = 0;
    ...
    public static final int SquareCommentLoadingView_square_duration = 0;
    public static final int SquareCommentLoadingView_square_gap = 1;
    public static final int SquareCommentLoadingView_square_initial_left_color = 2;
    public static final int SquareCommentLoadingView_square_initial_left_radius = 3;
    public static final int SquareCommentLoadingView_square_initial_right_color = 4;
    public static final int SquareCommentLoadingView_square_initial_right_radius = 5;
    public static final int SquareCommentLoadingView_square_ltrScale = 6;
    public static final int SquareCommentLoadingView_square_mixColor = 7;
    public static final int SquareCommentLoadingView_square_pause_duration = 8;
    public static final int SquareCommentLoadingView_square_rtlScale = 9;
    public static final int SquareCommentLoadingView_square_scale_end_fraction = 10;
    public static final int SquareCommentLoadingView_square_scale_start_fraction = 11;
    public static final int SquareEffectiveShapeView_square_decorations_direction = 0;
    public static final int SquareEffectiveShapeView_square_decorations_src = 1;
    public static final int SquareEffectiveShapeView_square_esv_shape = 2;
    public static final int SquareEffectiveShapeView_square_radius_x = 3;
    public static final int SquareEffectiveShapeView_square_radius_y = 4;
    public static final int SquareEffectiveShapeView_square_sides = 5;
    public static final int SquareRichEditText_square_richEditColorTopic = 0;
    public static final int SquareRichEditText_square_richMaxLength = 1;
    public static final int SquareRichTextView_square_linkColor = 0;
    public static final int SquareRichTextView_square_maxTextLength = 1;
    public static final int SquareRichTextView_square_topicColor = 2;
    public static final int SquareVEmojiLayout_square_emojiDeleteIconName = 0;
    public static final int SquareVEmojiLayout_square_emojiIndicatorFocus = 1;
    public static final int SquareVEmojiLayout_square_emojiIndicatorUnFocus = 2;
    public static final int SquareVEmojiLayout_square_emojiLayoutNumColumns = 3;
    public static final int SquareVEmojiLayout_square_emojiLayoutNumRows = 4;
    public static final int SquareVEmojiLayout_square_emojiMarginBottom = 5;
    public static final int SquareVEmojiLayout_square_emojiMarginTop = 6;
    ...
    public static final int WheelPicker_wheel_focus_item_half_height = 6;
    public static final int WheelPicker_wheel_font_path = 7;
    public static final int WheelPicker_wheel_indicator = 8;
    public static final int WheelPicker_wheel_indicator_color = 9;
    public static final int WheelPicker_wheel_indicator_size = 10;
    public static final int WheelPicker_wheel_item_align = 11;
    public static final int WheelPicker_wheel_item_space = 12;
    public static final int WheelPicker_wheel_item_text_color = 13;
    public static final int WheelPicker_wheel_item_text_size = 14;
    public static final int WheelPicker_wheel_maximum_width_text = 15;
    public static final int WheelPicker_wheel_maximum_width_text_position = 16;
    public static final int WheelPicker_wheel_same_width = 17;
    public static final int WheelPicker_wheel_selected_item_position = 18;
    public static final int WheelPicker_wheel_selected_item_text_color = 19;
    public static final int WheelPicker_wheel_selected_item_text_size = 20;
    public static final int WheelPicker_wheel_visible_item_count = 21;
    public static final int decor_avatar_avatar_radius = 0;
    public static final int decor_avatar_decor_radius = 1;
    public static final int header_finishText = 0;
    ...
    public static final int hw_ad_progress_button_hw_ad_fixedWidth = 0;
    public static final int hw_ad_progress_button_hw_ad_fontFamily = 1;
    public static final int hw_ad_progress_button_hw_ad_maxWidth = 2;
    public static final int hw_ad_progress_button_hw_ad_minWidth = 3;
    public static final int hw_ad_progress_button_hw_ad_resetWidth = 4;
    public static final int hw_ad_progress_button_hw_ad_styleIndex = 5;
    public static final int hw_ad_progress_button_hw_ad_textColor = 6;
    public static final int hw_ad_progress_button_hw_ad_textSize = 7;
    public static final int hw_ad_progress_button_hw_ad_typefaceIndex = 8;
    ...
    public static final int lx_portrait_view_portrait_padding = 0;
    public static final int lx_portrait_view_portrait_size_ratio = 1;
    public static final int lx_portrait_view_show_wave = 2;
    public static final int lx_portrait_view_text_size = 3;
    public static final int lx_portrait_view_wave_begin_color = 4;
    public static final int lx_portrait_view_wave_end_color = 5;
    public static final int square_button_btnIcon = 0;
    public static final int square_button_btnIconHeight = 1;
    public static final int square_button_btnIconWidth = 2;
    public static final int square_button_btnTex = 3;
    public static final int square_button_btnTexColor = 4;
    public static final int square_button_btnTexSize = 5;
    public static final int square_button_btnTextIconSpace = 6;
    public static final int user_level_style = 0;
    public static final int user_level_textLeftMargin = 1;
    public static final int user_level_textSize = 2;
    public static final int user_level_textStyle = 3;
    public static final int user_level_type = 4;
    public static final int venus_portrait_venus_init_radius = 0;
    public static final int venus_portrait_venus_max_radius = 1;
    public static final int venus_portrait_venus_portrait_margin = 2;
    public static final int venus_portrait_venus_text_size = 3;
    public static final int wave_view_init_radius = 0;
    public static final int wave_view_max_radius = 1;
    public static final int wave_view_wave_color_begin = 2;
    public static final int wave_view_wave_color_end = 3;
    public static final int wave_view_wave_duration = 4;
    public static final int wave_view_wave_speed = 5;
    ...
    public static final int[] BeiZiCircleProgressViewStyle = {R.attr.adScopeCircleColor, R.attr.adScopeRadius, R.attr.adScopeRingBgColor, R.attr.adScopeRingColor, R.attr.adScopeStrokeWidth, R.attr.adScopeTextColor};
    public static final int[] BeiZi_BackArrowView = {R.attr.beizi_bav_arrow_style, R.attr.beizi_bav_color, R.attr.beizi_bav_stroke_width};
    ...
    public static final int[] CircleFlowIndicator = {R.attr.activeColor, R.attr.activeRadius, R.attr.activeType, R.attr.centered, R.attr.circleSeparation, R.attr.count, R.attr.fadeOut, R.attr.inactiveColor, R.attr.inactiveType, R.attr.radius, R.attr.spacing};
    ...
    public static final int[] CircleProgressView = {R.attr.current_progress, R.attr.inner_circle_color, R.attr.inner_circle_size, R.attr.inner_text_color, R.attr.inner_text_size, R.attr.location_start, R.attr.progress_color, R.attr.progress_width, R.attr.stroke_color, R.attr.stroke_margin, R.attr.stroke_width};
    ...
    public static final int[] ClearEditText = {R.attr.isGray};
    public static final int[] ClickShowMoreLayout = {R.attr.click_text, R.attr.oneline_limit, R.attr.show_line, R.attr.suffix_color, R.attr.text_color, R.attr.text_size, R.attr.text_sync};
    ...
    public static final int[] DateWheelPicker = {R.attr.wheel_items, R.attr.year_max, R.attr.year_min};
    ...
    public static final int[] EffectiveShapeView = {R.attr.border_width, R.attr.decorations_direction, R.attr.decorations_src, R.attr.esv_shape, R.attr.radius_x, R.attr.radius_x_dp, R.attr.radius_y, R.attr.radius_y_dp, R.attr.sides};
    public static final int[] ExpandableTextView = {R.attr.ellipse_maxLines, R.attr.maxLines_up_limited, R.attr.suffix_color, R.attr.sync_state};
    ...
    public static final int[] FloatMenuItem = {R.attr.item_action, R.attr.item_icon, R.attr.item_text};
    ...
    public static final int[] FlowLayout = {R.attr.gravity, R.attr.itemSpacing, R.attr.lineSpacing, R.attr.singleLine};
    ...
    public static final int[] ForceClickImageView = {R.attr.foregroundColor};
    public static final int[] ForegroundLinearLayout = {android.R.attr.foreground, android.R.attr.foregroundGravity, R.attr.foregroundInsidePadding};
    public static final int[] Fragment = {android.R.attr.name, android.R.attr.id, android.R.attr.tag};
    public static final int[] FragmentContainerView = {android.R.attr.name, android.R.attr.tag};
    public static final int[] FriendCirclePtrListView = {R.attr.cacheColorHint, R.attr.choiceMode, R.attr.dividerHeight, R.attr.fastScrollStyle, R.attr.listSelector, R.attr.listview_divider, R.attr.lxfastScrollEnabled, R.attr.overScrollFooter, R.attr.overScrollHeader, R.attr.smoothScrollbar, R.attr.transcriptMode};
    public static final int[] GiftPanel = {R.attr.ui_type};
    public static final int[] GradientAlphaFrameLayout = {R.attr.gradientTopHeight};
    ...
    public static final int[] LightingAnimationView1 = {R.attr.la_colors1, R.attr.la_duration1, R.attr.la_k1, R.attr.la_play_mode1, R.attr.la_positions1, R.attr.la_radius1, R.attr.la_repeat1, R.attr.la_w1};
    ...
    public static final int[] MatchPropInfoCardView = {R.attr.match_ui_type};
    ...
    public static final int[] MultiImageLayout = {R.attr.max_ratio, R.attr.spacing};
    ...
    public static final int[] PostBar = {R.attr.squareBarTarget};
    public static final int[] PraiseWidget = {R.attr.click_bg_color, R.attr.font_color, R.attr.font_size, R.attr.like_icon};
    public static final int[] ProgressBarView = {R.attr.max, R.attr.ringColor, R.attr.ringProgressColor, R.attr.ringWidth, R.attr.showTextProgress};
    ...
    public static final int[] RoundCornerCoverView = {R.attr.cornerRad};
    ...
    public static final int[] SquareCommentLoadingView = {R.attr.square_duration, R.attr.square_gap, R.attr.square_initial_left_color, R.attr.square_initial_left_radius, R.attr.square_initial_right_color, R.attr.square_initial_right_radius, R.attr.square_ltrScale, R.attr.square_mixColor, R.attr.square_pause_duration, R.attr.square_rtlScale, R.attr.square_scale_end_fraction, R.attr.square_scale_start_fraction};
    public static final int[] SquareEffectiveShapeView = {R.attr.square_decorations_direction, R.attr.square_decorations_src, R.attr.square_esv_shape, R.attr.square_radius_x, R.attr.square_radius_y, R.attr.square_sides};
    public static final int[] SquareRichEditText = {R.attr.square_richEditColorTopic, R.attr.square_richMaxLength};
    public static final int[] SquareRichTextView = {R.attr.square_linkColor, R.attr.square_maxTextLength, R.attr.square_topicColor};
    public static final int[] SquareVEmojiLayout = {R.attr.square_emojiDeleteIconName, R.attr.square_emojiIndicatorFocus, R.attr.square_emojiIndicatorUnFocus, R.attr.square_emojiLayoutNumColumns, R.attr.square_emojiLayoutNumRows, R.attr.square_emojiMarginBottom, R.attr.square_emojiMarginTop};
    ...
    public static final int[] TwoLevelHeader = {R.attr.srlEnablePullToCloseTwoLevel, R.attr.srlEnableRefresh, R.attr.srlEnableTwoLevel, R.attr.srlFloorDuration, R.attr.srlFloorRage, R.attr.srlFloorRate, R.attr.srlMaxRage, R.attr.srlMaxRate, R.attr.srlRefreshRage, R.attr.srlRefreshRate};
    ...
    public static final int[] decor_avatar = {R.attr.avatar_radius, R.attr.decor_radius};
    public static final int[] header = {R.attr.finishText};
    ...
    public static final int[] hw_ad_progress_button = {R.attr.hw_ad_fixedWidth, R.attr.hw_ad_fontFamily, R.attr.hw_ad_maxWidth, R.attr.hw_ad_minWidth, R.attr.hw_ad_resetWidth, R.attr.hw_ad_styleIndex, R.attr.hw_ad_textColor, R.attr.hw_ad_textSize, R.attr.hw_ad_typefaceIndex};
    ...
    public static final int[] lx_portrait_view = {R.attr.portrait_padding, R.attr.portrait_size_ratio, R.attr.show_wave, R.attr.text_size, R.attr.wave_begin_color, R.attr.wave_end_color};
    public static final int[] square_button = {R.attr.btnIcon, R.attr.btnIconHeight, R.attr.btnIconWidth, R.attr.btnTex, R.attr.btnTexColor, R.attr.btnTexSize, R.attr.btnTextIconSpace};
    public static final int[] user_level = {R.attr.style, R.attr.textLeftMargin, R.attr.textSize, R.attr.textStyle, R.attr.type};
    public static final int[] venus_portrait = {R.attr.venus_init_radius, R.attr.venus_max_radius, R.attr.venus_portrait_margin, R.attr.venus_text_size};
    public static final int[] wave_view = {R.attr.init_radius, R.attr.max_radius, R.attr.wave_color_begin, R.attr.wave_color_end, R.attr.wave_duration, R.attr.wave_speed};
