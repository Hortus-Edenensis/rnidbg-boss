...
public class CropImageOptions implements Parcelable {
    ...
    public CropImageOptions() {
        ...
        this.maxZoom = 5;
        this.initialCropWindowPaddingRatio = 0.0f;
        this.fixAspectRatio = false;
        this.aspectRatioX = 1;
        this.aspectRatioY = 1;
        this.borderLineThickness = TypedValue.applyDimension(1, 1.0f, displayMetrics);
        ...
        this.borderCornerOffset = TypedValue.applyDimension(1, -4.0f, displayMetrics);
