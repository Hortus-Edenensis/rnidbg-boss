...
public class CharIndexView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        int measuredHeight = (int) (((double) getMeasuredHeight()) * 0.8d);
        ...
        while (true) {
            ...
            int i2 = rect.bottom;
            canvas.drawText(strValueOf, measuredWidth, (((i * length) + (((i2 - rect.top) + length) / 2)) - i2) + measuredHeight2, this.mPaint);
            i++;
        }
    }
    ...
    */
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            this.mPressed = false;
            invalidate();
            a aVar2 = this.mOnCharacterTouchedListener;
            if (aVar2 != null) {
                aVar2.F0();
            }
