...
public class LoopingViewPager extends ViewPager {
    ...
    private int defaultAutoLoopInterval;
    ...
    public class b implements Runnable {
        ...
        public void run() {
            LoopingViewPager.this.scroll2Next();
            LoopingViewPager loopingViewPager = LoopingViewPager.this;
            loopingViewPager.postDelayed(loopingViewPager.loop, LoopingViewPager.this.defaultAutoLoopInterval);
        }
    }
    ...
    public LoopingViewPager(Context context) {
        ...
        this.defaultAutoLoopInterval = 3000;
        this.loop = new b();
        init(context);
    }
    ...
    private void setAutoLoop(boolean z) {
        if (this.count > 1) {
            if (!z) {
                ...
                removeCallbacks(this.loop);
                postDelayed(this.loop, this.defaultAutoLoopInterval);
            }
        }
    }
    ...
    public void scroll2Next() {
        ...
        setCurrentItem(getNextPosition(), true);
    }
    ...
    public void setAutoLoopingInterval(int i) {
        this.defaultAutoLoopInterval = i;
    }
