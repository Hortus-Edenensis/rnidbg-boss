...
public class FragmentSuperExposeMyDynamicBindingImpl extends FragmentSuperExposeMyDynamicBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.anim_view, 9);
    }

    public FragmentSuperExposeMyDynamicBindingImpl(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
    ...
    public FragmentSuperExposeMyDynamicBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
