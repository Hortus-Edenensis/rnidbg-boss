...
public class SLightingAnimationView extends View {
    private int[] colors;
    ...
    public SLightingAnimationView(Context context) {
        this(context, null);
    }
    ...
    private void showAnimation(int i, int i2, int i3, long j) {
        try {
            ...
            this.mValueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: zz4
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    this.f22542a.lambda$showAnimation$0(f3, f4, valueAnimator2);
                }
            });
    ...
    public SLightingAnimationView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public SLightingAnimationView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            try {
                ...
                this.playMode = typedArrayObtainStyledAttributes.getInt(3, this.playMode);
                int i3 = typedArrayObtainStyledAttributes.getInt(6, this.mRepeatCount);
                this.mRepeatCount = i3;
                if (i3 < 0 && i3 != -1) {
                    this.mRepeatCount = -1;
                }
                this.mDuration = typedArrayObtainStyledAttributes.getInt(1, this.mDuration);
                this.mRadius = typedArrayObtainStyledAttributes.getDimensionPixelSize(5, this.mRadius);
                this.mk = typedArrayObtainStyledAttributes.getFloat(2, this.mk);
                this.mw = typedArrayObtainStyledAttributes.getDimensionPixelSize(7, this.mw);
