...
public class CircleFixedRatioImageView extends AppCompatImageView {
    private int mMaxHeight;
    private int mProportionHeight;
    private int mProportionWidth;

    public CircleFixedRatioImageView(Context context) {
        this(context, null);
    }
    ...
    private void initCustomAttrs(Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.CircleFixedRatioImageView);
    ...
    public CircleFixedRatioImageView(Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public CircleFixedRatioImageView(Context context, @Nullable AttributeSet attributeSet, int i) {
