...
public class UserDetailFeedAdapterNew extends BaseRecyclerViewAdapter<a> {
    ...
    public static class ViewHolder extends BaseRecyclerViewHolder<a> {
        ...
        public void o(a aVar, int i) {
            ...
            if (aVar != null && (squareDynamicLifeBeanInfo = aVar.f13670a) != null) {
                this.h.setVisibility(squareDynamicLifeBeanInfo.feedType == 1 ? 0 : 8);
                this.f.setVisibility(aVar.f13670a.feedType == 1 ? 8 : 0);
                this.g.setVisibility(aVar.f13670a.feedType != 3 ? 8 : 0);
                if (!TextUtils.isEmpty(aVar.f13670a.thumbUrl) && aVar.f13670a.feedType != 1) {
                    hc2.a(m()).load(a46.g(iB, iB2, aVar.f13670a.thumbUrl)).error(R.drawable.icon_default_thumbnail).into(this.f);
                    return;
                } else {
                    if (TextUtils.isEmpty(aVar.f13670a.content)) {
                        return;
                    }
                    this.h.setText(vl1.c(aVar.f13670a.content.trim(), this.h.getContext(), vl1.j));
                    return;
                }
            }
    ...
    public static class a implements BaseRecyclerViewAdapter.c {
        ...
        public SquareDynamicLifeBeanInfo f13670a;
        public Feed b;
    }
    ...
    public BaseRecyclerViewHolder h(ViewGroup viewGroup, View view, int i) {
        ViewHolder viewHolder = new ViewHolder(this.e, viewGroup, R.layout.list_item_user_detail_feed_new);
        p(viewHolder);
        return viewHolder;
    }
