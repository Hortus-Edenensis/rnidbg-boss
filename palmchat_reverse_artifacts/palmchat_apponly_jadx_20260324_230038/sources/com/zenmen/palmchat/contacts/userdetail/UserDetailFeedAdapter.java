...
public class UserDetailFeedAdapter extends BaseRecyclerViewAdapter<a> {
    ...
    public static class ViewHolder extends BaseRecyclerViewHolder<a> {
        ...
        public ViewHolder(Context context, ViewGroup viewGroup, int i) {
            ...
            this.f = (ImageView) l(R.id.iv_image);
            this.g = (ImageView) l(R.id.iv_video);
            this.h = (TextView) l(R.id.text_thumbnail);
            this.i = a46.j(this.itemView.getContext(), 4.0f, R.drawable.icon_default_thumbnail);
        }
        ...
        public void o(a aVar, int i) {
            ...
            if (aVar != null && (squareDynamicLifeBeanInfo = aVar.f13669a) != null) {
                ...
                this.f.setVisibility(aVar.f13669a.feedType == 1 ? 8 : 0);
                this.g.setVisibility(aVar.f13669a.feedType != 3 ? 8 : 0);
                if (!TextUtils.isEmpty(aVar.f13669a.thumbUrl) && aVar.f13669a.feedType != 1) {
                    hc2.a(m()).load(a46.g(iB, iB2, aVar.f13669a.thumbUrl)).error(R.drawable.icon_default_thumbnail).into(this.f);
                    return;
                } else {
                    if (TextUtils.isEmpty(aVar.f13669a.content)) {
                        return;
                    }
                    this.h.setText(vl1.c(aVar.f13669a.content.trim(), this.h.getContext(), vl1.j));
                    return;
                }
            }
    ...
    public UserDetailFeedAdapter(@NonNull Context context, @NonNull List<a> list) {
        super(context, list);
    }
    ...
    public BaseRecyclerViewHolder h(ViewGroup viewGroup, View view, int i) {
        ViewHolder viewHolder = new ViewHolder(this.e, viewGroup, R.layout.list_item_user_detail_feed);
        p(viewHolder);
        return viewHolder;
    }
    ...
    public static class a implements BaseRecyclerViewAdapter.c {
        ...
        public SquareDynamicLifeBeanInfo f13669a;
        public Feed b;

        public a(SquareDynamicLifeBeanInfo squareDynamicLifeBeanInfo) {
            this.f13669a = squareDynamicLifeBeanInfo;
        }
