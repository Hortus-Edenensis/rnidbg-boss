...
import com.zenmen.palmchat.databinding.LayoutUserDetailEnergyViewBinding;
...
public class UserDetailEnergyView extends FrameLayout {
    private LightingAnimationView animView;
    private LayoutUserDetailEnergyViewBinding binding;
    ...
    public class a implements View.OnClickListener {
        ...
        public final /* synthetic */ Context f13738a;
        ...
        public void onClick(View view) {
            ...
            UserDetailEnergyView.this.reportProfileEnergyClick();
            SAppUtil.I(this.f13738a, SAppUtil.G(), true, false);
        }
    }
    ...
    public class b extends go2<LXBaseNetBean<SocialActiveWeekValuesV1Bean>> {
        ...
        public sw4 getRequestArgs() {
            return sw4.b(1, this.f13739a, this.b).f(this.c);
        }
        ...
        public void onResult(boolean z, LXBaseNetBean<SocialActiveWeekValuesV1Bean> lXBaseNetBean, Exception exc) {
            ...
            if (q05.o((Activity) UserDetailEnergyView.this.context)) {
                return;
            }
            if (!z || lXBaseNetBean == null || (socialActiveWeekValuesV1Bean = lXBaseNetBean.data) == null) {
                UserDetailEnergyView.this.setVisibility(8);
                return;
            }
            ...
            UserDetailEnergyView.this.setVisibility(0);
            int progressPercentage = socialActiveWeekValuesV1Bean2.getProgressPercentage();
            UserDetailEnergyView.this.currentEnergyValue = progressPercentage;
            UserDetailEnergyView.this.setEnergyPercentage(progressPercentage);
            UserDetailEnergyView userDetailEnergyView = UserDetailEnergyView.this;
            userDetailEnergyView.reportProfileEnergyShow(userDetailEnergyView.currentContactInfoItem, progressPercentage);
        }
    }

    public UserDetailEnergyView(@NonNull Context context) {
        this(context, null);
    }
    ...
    private void init(Context context) {
        ...
        this.binding = (LayoutUserDetailEnergyViewBinding) DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.layout_user_detail_energy_view, this, true);
        this.energyTipPopup = new EnergyTipPopupWindow(context);
        this.animView = this.binding.f13906a;
    ...
    public /* synthetic */ void lambda$setEnergyPercentage$0(int i) {
        LayoutUserDetailEnergyViewBinding layoutUserDetailEnergyViewBinding;
        ConstraintLayout constraintLayout;
        if (q05.o((Activity) this.context) || (layoutUserDetailEnergyViewBinding = this.binding) == null || (constraintLayout = layoutUserDetailEnergyViewBinding.f) == null) {
            return;
        }
        ...
        if (iMax >= dpToPx(this.context, 30)) {
            ...
            this.binding.c.setTextColor(Color.parseColor("#FCF2EB"));
        } else {
            ((ViewGroup.MarginLayoutParams) layoutParams).width = width;
            layoutParams.startToStart = 0;
            layoutParams.endToEnd = 0;
            this.binding.c.setTextColor(Color.parseColor("#FF9642"));
        }
        ...
        this.energyTipPopup.r(this.binding.g);
    }
    ...
    private void startLightingAnimation() {
        ...
        if (this.animView != null) {
            ...
            this.binding.f13906a.setmDuration(i * 1000);
            if (i2 > 0) {
                this.binding.f13906a.startLightingAnimation(i2 - 1);
            } else {
                this.binding.f13906a.startLightingAnimation(i2);
            }
        }
    }
    ...
    private void updateViewByFriendMode(int i) {
        ...
        a.b bVar2;
        if (i == 0) {
            LayoutUserDetailEnergyViewBinding layoutUserDetailEnergyViewBinding = this.binding;
            if (layoutUserDetailEnergyViewBinding != null && (textView2 = layoutUserDetailEnergyViewBinding.e) != null) {
                com.zenmen.palmchat.contacts.widget.a aVar = this.profileEnergyConfig;
        ...
        LayoutUserDetailEnergyViewBinding layoutUserDetailEnergyViewBinding2 = this.binding;
        if (layoutUserDetailEnergyViewBinding2 != null && (textView = layoutUserDetailEnergyViewBinding2.e) != null) {
    ...
    public void setEnergyPercentage(final int i) {
        LayoutUserDetailEnergyViewBinding layoutUserDetailEnergyViewBinding = this.binding;
        if (layoutUserDetailEnergyViewBinding == null) {
            return;
        }
        if (i > 100) {
            i = 100;
        }
        layoutUserDetailEnergyViewBinding.c.setText(i + "%");
        this.binding.d.setProgress(i);
        this.binding.f.post(new Runnable() { // from class: n66
            @Override // java.lang.Runnable
            public final void run() {
                this.f19448a.lambda$setEnergyPercentage$0(i);
            }
        });
    }
    ...
    public UserDetailEnergyView(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public UserDetailEnergyView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
