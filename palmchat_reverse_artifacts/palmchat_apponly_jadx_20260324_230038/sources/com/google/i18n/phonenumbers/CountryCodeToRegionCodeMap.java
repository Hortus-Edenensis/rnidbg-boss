...
public class CountryCodeToRegionCodeMap {
    public static Map<Integer, List<String>> getCountryCodeToRegionCodeMap() {
        HashMap map = new HashMap(MediaPlayer.MEDIA_PLAYER_OPTION_PREPARE_CACHE_MS);
        ...
        arrayList.add("SX");
        arrayList.add("TC");
        arrayList.add(GlobalSetting.TT_SDK_WRAPPER);
        arrayList.add("VC");
        arrayList.add("VG");
        arrayList.add("VI");
        map.put(1, arrayList);
        ...
        arrayList24.add(RequirementDefine.REQUIREMENT_AR_TAG);
        ...
        arrayList29.add(STManager.REGION_OF_MY);
        ...
        arrayList31.add(STManager.REGION_OF_ID);
        map.put(62, arrayList31);
        ArrayList arrayList32 = new ArrayList(1);
        arrayList32.add(STManager.REGION_OF_PH);
        ...
        arrayList35.add(STManager.REGION_OF_TH);
        ...
        arrayList38.add(STManager.REGION_OF_VN);
        ...
        arrayList41.add(STManager.REGION_OF_IN);
        ...
        arrayList50.add("TN");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_MEDIACODEC_DROP_NONREF), arrayList50);
        ArrayList arrayList51 = new ArrayList(1);
        arrayList51.add("LY");
        map.put(218, arrayList51);
        ArrayList arrayList52 = new ArrayList(1);
        arrayList52.add("GM");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_FASTOPEN_LIVE_STREAM), arrayList52);
        ArrayList arrayList53 = new ArrayList(1);
        arrayList53.add("SN");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_VIDEO_DECODER_ERROR), arrayList53);
        ArrayList arrayList54 = new ArrayList(1);
        arrayList54.add(ZW2Vz.c);
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_DECODER_ERROR), arrayList54);
        ...
        arrayList62.add("MU");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_NETWORK_TRY_COUNT), arrayList62);
        ArrayList arrayList63 = new ArrayList(1);
        arrayList63.add("LR");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_ALOG_WRITE_FUNC_ADDR), arrayList63);
        ...
        arrayList73.add("GA");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_INDEX_CACHE), arrayList73);
        ArrayList arrayList74 = new ArrayList(1);
        arrayList74.add("CG");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_FRAG_RANGE), arrayList74);
        ArrayList arrayList75 = new ArrayList(1);
        arrayList75.add("CD");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_VIDEO_RANGE_SIZE), arrayList75);
        ArrayList arrayList76 = new ArrayList(1);
        arrayList76.add("AO");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_RANGE_SIZE), arrayList76);
        ArrayList arrayList77 = new ArrayList(1);
        arrayList77.add("GW");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_VIDEO_RENDER_ERROR), arrayList77);
        ArrayList arrayList78 = new ArrayList(1);
        arrayList78.add("IO");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_HIJACK_EXIT), arrayList78);
        ArrayList arrayList79 = new ArrayList(1);
        arrayList79.add(AssistPushConsts.MSG_KEY_ACTION);
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_DISABLE_LOOPER_TIMEOUT), arrayList79);
        ArrayList arrayList80 = new ArrayList(1);
        arrayList80.add("SC");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_SEEK_INTERRUPT), arrayList80);
        ArrayList arrayList81 = new ArrayList(1);
        arrayList81.add("SD");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_TT_HLS_DRM_TOKEN), arrayList81);
        ArrayList arrayList82 = new ArrayList(1);
        arrayList82.add("RW");
        map.put(250, arrayList82);
        ArrayList arrayList83 = new ArrayList(1);
        arrayList83.add("ET");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_PROCESSOR_ADDR), arrayList83);
        ArrayList arrayList84 = new ArrayList(1);
        arrayList84.add("SO");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_HW_DEC_DROP_NON_REF), arrayList84);
        ArrayList arrayList85 = new ArrayList(1);
        arrayList85.add("DJ");
        map.put(253, arrayList85);
        ArrayList arrayList86 = new ArrayList(1);
        arrayList86.add("KE");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_ADAPTIVE_WORK_AROUND_MODE), arrayList86);
        ...
        arrayList90.add("MZ");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_RANGE_MODE), arrayList90);
        ArrayList arrayList91 = new ArrayList(1);
        arrayList91.add("ZM");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_RANGE_TIME), arrayList91);
        ArrayList arrayList92 = new ArrayList(1);
        arrayList92.add("MG");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_SET_RADIO_MODE), arrayList92);
        ArrayList arrayList93 = new ArrayList(2);
        arrayList93.add("RE");
        arrayList93.add("YT");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_ASYNC), arrayList93);
        ArrayList arrayList94 = new ArrayList(1);
        arrayList94.add("ZW");
        map.put(263, arrayList94);
        ArrayList arrayList95 = new ArrayList(1);
        arrayList95.add("NA");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_VIDEO_SAVED_HOST_TIME), arrayList95);
        ArrayList arrayList96 = new ArrayList(1);
        arrayList96.add("MW");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_VIDEO_TRAN_CONNECT_TIME), arrayList96);
        ArrayList arrayList97 = new ArrayList(1);
        arrayList97.add("LS");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_VIDEO_FIRST_PACKET_TIME), arrayList97);
        ArrayList arrayList98 = new ArrayList(1);
        arrayList98.add("BW");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_SAVED_HOST_TIME), arrayList98);
        ArrayList arrayList99 = new ArrayList(1);
        arrayList99.add("SZ");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_TRAN_CONNECT_TIME), arrayList99);
        ArrayList arrayList100 = new ArrayList(1);
        arrayList100.add("KM");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_FIRST_PACKET_TIME), arrayList100);
        ArrayList arrayList101 = new ArrayList(2);
        arrayList101.add("SH");
        arrayList101.add("TA");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_HTTP_AUTO_RANGE_OFFSET), arrayList101);
        ArrayList arrayList102 = new ArrayList(1);
        arrayList102.add("ER");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_OPEN_TIMEOUT), arrayList102);
        ArrayList arrayList103 = new ArrayList(1);
        arrayList103.add("AW");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_SKIP_BUFFER_LIMIT), arrayList103);
        ArrayList arrayList104 = new ArrayList(1);
        arrayList104.add("FO");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_LIVE_START_INDEX), arrayList104);
        ArrayList arrayList105 = new ArrayList(1);
        arrayList105.add("GL");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_REFRESH_BY_TIME), arrayList105);
        ArrayList arrayList106 = new ArrayList(1);
        arrayList106.add("GI");
        map.put(350, arrayList106);
        ArrayList arrayList107 = new ArrayList(1);
        arrayList107.add(AssistPushConsts.MSG_VALUE_PAYLOAD);
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_QUIC_CONFIG_CACHED), arrayList107);
        ArrayList arrayList108 = new ArrayList(1);
        arrayList108.add("LU");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_QUIC_CHLO_COUNT), arrayList108);
        ArrayList arrayList109 = new ArrayList(1);
        arrayList109.add("IE");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_QUIC_SCFG_ADDRESS), arrayList109);
        ArrayList arrayList110 = new ArrayList(1);
        arrayList110.add("IS");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_QUIC_ENABLE_CERT_VERIFY), arrayList110);
        ArrayList arrayList111 = new ArrayList(1);
        arrayList111.add("AL");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_QUIC_OPEN_RESULT), arrayList111);
        ArrayList arrayList112 = new ArrayList(1);
        arrayList112.add("MT");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_QUIC_INIT_MTU), arrayList112);
        ...
        arrayList114.add("FI");
        arrayList114.add("AX");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_SPEEDX_DROP), arrayList114);
        ArrayList arrayList115 = new ArrayList(1);
        arrayList115.add("BG");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_SPEEDX_DROP_FPS_LIMIT), arrayList115);
        ArrayList arrayList116 = new ArrayList(1);
        arrayList116.add("LT");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_LOADCONTROL_BUFFERINGTIMEOUT), arrayList116);
        ArrayList arrayList117 = new ArrayList(1);
        arrayList117.add("LV");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_PRIMING_WORK_AROUND), arrayList117);
        ArrayList arrayList118 = new ArrayList(1);
        arrayList118.add("EE");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_DECODE_MULTI_SEI), arrayList118);
        ArrayList arrayList119 = new ArrayList(1);
        arrayList119.add("MD");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_SET_FORCE_DECODE_SWITCH), arrayList119);
        ArrayList arrayList120 = new ArrayList(1);
        arrayList120.add("AM");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_SET_FORCE_DECODE_MS_GAPS), arrayList120);
        ArrayList arrayList121 = new ArrayList(1);
        arrayList121.add("BY");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_SET_FORCE_RENDER_MS_GAPS), arrayList121);
        ArrayList arrayList122 = new ArrayList(1);
        arrayList122.add("AD");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_SET_AVPH_AUDIO_QUERY), arrayList122);
        ArrayList arrayList123 = new ArrayList(1);
        arrayList123.add("MC");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_SET_AVPH_VIDEO_QUERY), arrayList123);
        ArrayList arrayList124 = new ArrayList(1);
        arrayList124.add("SM");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_SET_AUDIO_DEVICE_TYPE), arrayList124);
        ArrayList arrayList125 = new ArrayList(1);
        arrayList125.add("VA");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_QUEUE_MAX_FULL), arrayList125);
        ArrayList arrayList126 = new ArrayList(1);
        arrayList126.add("UA");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_STALL_COUNTER), arrayList126);
        ArrayList arrayList127 = new ArrayList(1);
        arrayList127.add("RS");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_RENDER_STALL_200), arrayList127);
        ArrayList arrayList128 = new ArrayList(1);
        arrayList128.add("ME");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_RENDER_STALL_300), arrayList128);
        ArrayList arrayList129 = new ArrayList(1);
        arrayList129.add("HR");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_VIDEO_DEMUXER_STALL_500), arrayList129);
        ArrayList arrayList130 = new ArrayList(1);
        arrayList130.add("SI");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_VIDEO_DECODER_PRE_STALL_500), arrayList130);
        ArrayList arrayList131 = new ArrayList(1);
        arrayList131.add("BA");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_VIDEO_DECODER_POST_STALL_500), arrayList131);
        ArrayList arrayList132 = new ArrayList(1);
        arrayList132.add("MK");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_QUIC_MAX_CRYPTO_RETRANSMISSIONS), arrayList132);
        ArrayList arrayList133 = new ArrayList(1);
        arrayList133.add("CZ");
        map.put(Integer.valueOf(HttpStatus.SC_METHOD_FAILURE), arrayList133);
        ...
        arrayList165.add("PW");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_CMAF_OPTIMIZE_RETRY), arrayList165);
        ArrayList arrayList166 = new ArrayList(1);
        arrayList166.add("WF");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_CMAF_SKIP_INIT_SECTION), arrayList166);
        ...
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_RTC_ANSWER_RECV_TIME), arrayList178);
        ArrayList arrayList179 = new ArrayList(1);
        arrayList179.add("KP");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_SUB_FIRST_LOAD_TIME), arrayList179);
        ArrayList arrayList180 = new ArrayList(1);
        arrayList180.add("HK");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_MASK_STREAM_OPENED_TIME), arrayList180);
        ArrayList arrayList181 = new ArrayList(1);
        arrayList181.add("MO");
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_OPEN_SUB_RETRY_TIMES), arrayList181);
        ...
        arrayList186.add(GlobalSetting.BD_SDK_WRAPPER);
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_RTC_HARDWARE_DECODE), arrayList186);
        ArrayList arrayList187 = new ArrayList(1);
        arrayList187.add(PhoneNumberUtil.REGION_CODE_FOR_NON_GEO_ENTITY);
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_RTC_MAX_JITTER_BUFFER_DELAY), arrayList187);
        ArrayList arrayList188 = new ArrayList(1);
        arrayList188.add(PhoneNumberUtil.REGION_CODE_FOR_NON_GEO_ENTITY);
        map.put(Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_RTC_ENABLE_RTC_UNINIT_LOCK_FREE), arrayList188);
        ...
        arrayList190.add(STManager.REGION_OF_TW);
        ...
        arrayList214.add("KG");
        map.put(Integer.valueOf(ErrorCode.DETAIL_HTTP_CODE_OTHER), arrayList214);
        ArrayList arrayList215 = new ArrayList(1);
        arrayList215.add("UZ");
        map.put(Integer.valueOf(ErrorCode.DETAIL_HTTP_TIMEOUT), arrayList215);
        return map;
    }
}
