...
public abstract class NavigationBarItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public static class ActiveIndicatorTransform {
        ...
        public float calculateAlpha(@FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) float f, @FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) float f2) {
            return AnimationUtils.lerp(0.0f, 1.0f, f2 == 0.0f ? 0.8f : 0.0f, f2 == 0.0f ? 1.0f : 0.2f, f);
        }

        public float calculateScaleX(@FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) float f, @FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) float f2) {
            return AnimationUtils.lerp(SCALE_X_HIDDEN, 1.0f, f);
        }

        public float calculateScaleY(@FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) float f, @FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) float f2) {
            return 1.0f;
        }

        public void updateForProgress(@FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) float f, @FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) float f2, @NonNull View view) {
    ...
    private void maybeAnimateActiveIndicatorToProgress(@FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) final float f) {
    ...
    public void setActiveIndicatorProgress(@FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) float f, float f2) {
