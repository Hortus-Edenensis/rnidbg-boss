...
public final class FadeProvider implements VisibilityAnimatorProvider {
    ...
    private static Animator createFadeAnimator(final View view, final float f, final float f2, @FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) final float f3, @FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) final float f4, final float f5) {
