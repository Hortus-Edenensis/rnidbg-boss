...
class TransitionUtils {
    ...
    public static float lerp(float f, float f2, @FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) float f3, @FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) float f4, @FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) float f5) {
        return lerp(f, f2, f3, f4, f5, false);
    }

    public static float lerp(float f, float f2, @FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) float f3, @FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) float f4, @FloatRange(from = 0.0d) float f5, boolean z) {
    ...
    public static int lerp(int i, int i2, @FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) float f, @FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) float f2, @FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) float f3) {
        return f3 < f ? i : f3 > f2 ? i2 : (int) lerp(i, i2, (f3 - f) / (f2 - f));
    }

    public static ShapeAppearanceModel lerp(ShapeAppearanceModel shapeAppearanceModel, ShapeAppearanceModel shapeAppearanceModel2, final RectF rectF, final RectF rectF2, @FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) final float f, @FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) final float f2, @FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) final float f3) {
