...
public final class CollapsingTextHelper {
    ...
    @ColorInt
    private static int blendARGB(@ColorInt int i, @ColorInt int i2, @FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) float f) {
        float f2 = 1.0f - f;
    ...
    private float calculateFadeModeTextAlpha(@FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) float f) {
