...
public final class IcyHeaders implements Metadata.Entry {
        ...
        if (list != null) {
            ...
            try {
                ...
                if (i2 > 0) {
                    ...
                    try {
                        y53.i(TAG, "Invalid bitrate: " + str4);
                        z = false;
                        i2 = -1;
                    } catch (NumberFormatException unused) {
                        y53.i(TAG, "Invalid bitrate header: " + str4);
                        i = i2;
                        z = false;
                    }
                }
        ...
        if (list6 != null) {
            ...
            try {
                ...
                if (i4 > 0) {
                    ...
                    try {
                        y53.i(TAG, "Invalid metadata interval: " + str5);
                        z2 = z;
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return this.bitrate == icyHeaders.bitrate && g86.c(this.genre, icyHeaders.genre) && g86.c(this.name, icyHeaders.name) && g86.c(this.url, icyHeaders.url) && this.isPublic == icyHeaders.isPublic && this.metadataInterval == icyHeaders.metadataInterval;
    }
