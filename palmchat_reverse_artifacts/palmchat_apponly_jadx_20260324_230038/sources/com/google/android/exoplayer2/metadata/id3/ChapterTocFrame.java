...
public final class ChapterTocFrame extends Id3Frame {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return this.isRoot == chapterTocFrame.isRoot && this.isOrdered == chapterTocFrame.isOrdered && g86.c(this.elementId, chapterTocFrame.elementId) && Arrays.equals(this.children, chapterTocFrame.children) && Arrays.equals(this.subFrames, chapterTocFrame.subFrames);
    }
    ...
    public ChapterTocFrame(Parcel parcel) {
        super("CTOC");
        this.elementId = (String) g86.j(parcel.readString());
        this.isRoot = parcel.readByte() != 0;
        this.isOrdered = parcel.readByte() != 0;
        this.children = (String[]) g86.j(parcel.createStringArray());
