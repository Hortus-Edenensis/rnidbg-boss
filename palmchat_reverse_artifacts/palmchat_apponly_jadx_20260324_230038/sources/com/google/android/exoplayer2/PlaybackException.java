...
public class PlaybackException extends Exception implements f {
    ...
    private static final String FIELD_INT_ERROR_CODE = g86.w0(0);
    private static final String FIELD_LONG_TIMESTAMP_MS = g86.w0(1);
    private static final String FIELD_STRING_MESSAGE = g86.w0(2);
    private static final String FIELD_STRING_CAUSE_CLASS_NAME = g86.w0(3);
    private static final String FIELD_STRING_CAUSE_MESSAGE = g86.w0(4);
    public static final f.a<PlaybackException> CREATOR = new f.a() { // from class: hj4
    ...
    public PlaybackException(@Nullable String str, @Nullable Throwable th, int i) {
        this(str, th, i, ed0.f17276a.elapsedRealtime());
    }
    ...
    */
    public boolean errorInfoEquals(@Nullable PlaybackException playbackException) {
        ...
        if (playbackException != null && getClass() == playbackException.getClass()) {
            ...
            } else if (!g86.c(cause.getMessage(), cause2.getMessage()) || !g86.c(cause.getClass(), cause2.getClass())) {
                return false;
            }
            return this.errorCode == playbackException.errorCode && g86.c(getMessage(), playbackException.getMessage()) && this.timestampMs == playbackException.timestampMs;
        }
        return false;
    }
