...
public final class DrmInitData implements Comparator<SchemeData>, Parcelable {
    ...
    public static final class SchemeData implements Parcelable {
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            return g86.c(this.licenseServerUrl, schemeData.licenseServerUrl) && g86.c(this.mimeType, schemeData.mimeType) && g86.c(this.uuid, schemeData.uuid) && Arrays.equals(this.data, schemeData.data);
        }
        ...
        public boolean matches(UUID uuid) {
            return zv.f22519a.equals(this.uuid) || uuid.equals(this.uuid);
        }
        ...
        public SchemeData(UUID uuid, @Nullable String str, String str2, @Nullable byte[] bArr) {
            this.uuid = (UUID) vh.e(uuid);
            this.licenseServerUrl = str;
            this.mimeType = (String) vh.e(str2);
            this.data = bArr;
        }
    ...
    public DrmInitData copyWithSchemeType(@Nullable String str) {
        return g86.c(this.schemeType, str) ? this : new DrmInitData(str, false, this.schemeDatas);
    }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return g86.c(this.schemeType, drmInitData.schemeType) && Arrays.equals(this.schemeDatas, drmInitData.schemeDatas);
    }
    ...
    public DrmInitData merge(DrmInitData drmInitData) {
        ...
        vh.g(str2 == null || (str = drmInitData.schemeType) == null || TextUtils.equals(str2, str));
        String str3 = this.schemeType;
        if (str3 == null) {
            str3 = drmInitData.schemeType;
        }
        return new DrmInitData(str3, (SchemeData[]) g86.L0(this.schemeDatas, drmInitData.schemeDatas));
    }
    ...
    public DrmInitData(Parcel parcel) {
        ...
        SchemeData[] schemeDataArr = (SchemeData[]) g86.j((SchemeData[]) parcel.createTypedArray(SchemeData.CREATOR));
        this.schemeDatas = schemeDataArr;
        this.schemeDataCount = schemeDataArr.length;
    }
}
