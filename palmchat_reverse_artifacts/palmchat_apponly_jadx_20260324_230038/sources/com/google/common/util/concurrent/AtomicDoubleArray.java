...
public class AtomicDoubleArray implements Serializable {
    ...
    private void readObject(ObjectInputStream objectInputStream) throws ClassNotFoundException, IOException {
        ...
        ImmutableLongArray.c cVarBuilder = ImmutableLongArray.builder();
        for (int i2 = 0; i2 < i; i2++) {
            cVarBuilder.a(Double.doubleToRawLongBits(objectInputStream.readDouble()));
        }
        this.longs = new AtomicLongArray(cVarBuilder.d().toArray());
    }
