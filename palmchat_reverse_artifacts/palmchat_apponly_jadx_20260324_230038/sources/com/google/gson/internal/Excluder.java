...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    public <T> TypeAdapter<T> create(final Gson gson, final TypeToken<T> typeToken) {
        ...
        if (z || z2) {
            return new TypeAdapter<T>() { // from class: com.google.gson.internal.Excluder.1
                ...
                public TypeAdapter<T> f6289a;

                public final TypeAdapter<T> delegate() {
                    TypeAdapter<T> typeAdapter = this.f6289a;
                    if (typeAdapter != null) {
                        return typeAdapter;
                    }
                    TypeAdapter<T> delegateAdapter = gson.getDelegateAdapter(Excluder.this, typeToken);
                    this.f6289a = delegateAdapter;
    ...
    public Excluder disableInnerClassSerialization() {
        Excluder excluderM54clone = m54clone();
        excluderM54clone.serializeInnerClasses = false;
        return excluderM54clone;
    }
    ...
    public Excluder excludeFieldsWithoutExposeAnnotation() {
        Excluder excluderM54clone = m54clone();
        excluderM54clone.requireExpose = true;
        return excluderM54clone;
    }
    ...
    public Excluder withExclusionStrategy(ExclusionStrategy exclusionStrategy, boolean z, boolean z2) {
        ...
        if (z) {
            ...
            excluderM54clone.serializationStrategies = arrayList;
            arrayList.add(exclusionStrategy);
        }
        if (z2) {
            ArrayList arrayList2 = new ArrayList(this.deserializationStrategies);
            excluderM54clone.deserializationStrategies = arrayList2;
    ...
    public Excluder withModifiers(int... iArr) {
        Excluder excluderM54clone = m54clone();
        excluderM54clone.modifiers = 0;
        for (int i : iArr) {
            excluderM54clone.modifiers = i | excluderM54clone.modifiers;
        }
        return excluderM54clone;
    }
    ...
    public Excluder withVersion(double d) {
        Excluder excluderM54clone = m54clone();
        excluderM54clone.version = d;
        return excluderM54clone;
    }

    /* JADX INFO: renamed from: clone, reason: merged with bridge method [inline-methods] */
    public Excluder m54clone() {
        try {
