...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    public static final class b<K, V> {
        ...
        public void a(g<K, V> gVar) {
            ...
            while (true) {
                ...
                int i7 = this.c;
                if (i7 == 0) {
                    g<K, V> gVar2 = this.f6290a;
                    g<K, V> gVar3 = gVar2.f6295a;
                    g<K, V> gVar4 = gVar3.f6295a;
                    gVar3.f6295a = gVar4.f6295a;
                    this.f6290a = gVar3;
                    gVar3.b = gVar4;
                    gVar3.c = gVar2;
                    gVar3.i = gVar2.i + 1;
                    ...
                    g<K, V> gVar5 = this.f6290a;
                    g<K, V> gVar6 = gVar5.f6295a;
                    this.f6290a = gVar6;
                    gVar6.c = gVar5;
                    gVar6.i = gVar5.i + 1;
                    gVar5.f6295a = gVar6;
    ...
    public static class c<K, V> {
        ...
        public g<K, V> a() {
            g<K, V> gVar = this.f6291a;
            if (gVar == null) {
                return null;
            }
            g<K, V> gVar2 = gVar.f6295a;
            gVar.f6295a = null;
            g<K, V> gVar3 = gVar.c;
            while (true) {
                g<K, V> gVar4 = gVar2;
    ...
    public abstract class f<T> implements Iterator<T> {
        ...
        public f() {
            this.f6294a = LinkedHashTreeMap.this.header.d;
            this.c = LinkedHashTreeMap.this.modCount;
        }

        public final g<K, V> a() {
            g<K, V> gVar = this.f6294a;
        ...
        public final boolean hasNext() {
            return this.f6294a != LinkedHashTreeMap.this.header;
        }
    ...
    public g<K, V> find(K k, boolean z) {
        ...
        if (gVar != null) {
            gVar2 = new g<>(gVar, k, iSecondaryHash, gVar5, gVar5.e);
            if (i < 0) {
                gVar.b = gVar2;
            } else {
                gVar.c = gVar2;
    ...
    public g<K, V> findByEntry(Map.Entry<?, ?> entry) {
        ...
        if (gVarFindByObject != null && equal(gVarFindByObject.h, entry.getValue())) {
    ...
    public V remove(Object obj) {
        ...
        if (gVarRemoveInternalByKey != null) {
            return gVarRemoveInternalByKey.h;
        }
        return null;
    }
    ...
    public static final class g<K, V> implements Map.Entry<K, V> {
        ...
        public String toString() {
            return this.f + ContainerUtils.KEY_VALUE_DELIMITER + this.h;
        }
