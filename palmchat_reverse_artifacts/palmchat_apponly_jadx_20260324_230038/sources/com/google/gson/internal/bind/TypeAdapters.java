...
public final class TypeAdapters {
    ...
    public static final class EnumTypeAdapter<T extends Enum<T>> extends TypeAdapter<T> {
        ...
        public final Map<String, T> f6323a = new HashMap();
        ...
        public class a implements PrivilegedAction<Void> {
            ...
            /* JADX INFO: renamed from: a, reason: collision with root package name */
            public final /* synthetic */ Field f6324a;
            ...
            public Void run() {
                this.f6324a.setAccessible(true);
                return null;
            }
        }
                    ...
                    if (field.isEnumConstant()) {
                        ...
                        if (serializedName != null) {
                            ...
                            for (String str : serializedName.alternate()) {
                                this.f6323a.put(str, r4);
                            }
                        }
                        this.f6323a.put(strName, r4);
                        this.b.put(r4, strName);
                    }
                }
        ...
        public T read2(JsonReader jsonReader) throws IOException {
            if (jsonReader.peek() != JsonToken.NULL) {
                return this.f6323a.get(jsonReader.nextString());
            }
            jsonReader.nextNull();
            return null;
        }
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f6325a[JsonToken.BOOLEAN.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f6325a[JsonToken.STRING.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f6325a[JsonToken.NULL.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f6325a[JsonToken.BEGIN_ARRAY.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f6325a[JsonToken.BEGIN_OBJECT.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f6325a[JsonToken.END_DOCUMENT.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f6325a[JsonToken.NAME.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f6325a[JsonToken.END_OBJECT.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f6325a[JsonToken.END_ARRAY.ordinal()] = 10;
    ...
    static {
            ...
            */
            public BitSet read2(JsonReader jsonReader) throws IOException {
                ...
                while (jsonTokenPeek != JsonToken.END_ARRAY) {
                    int i2 = a.f6325a[jsonTokenPeek.ordinal()];
        ...
        BOOLEAN_AS_STRING = new TypeAdapter<Boolean>() { // from class: com.google.gson.internal.bind.TypeAdapters.4
            ...
            /* JADX INFO: renamed from: b, reason: merged with bridge method [inline-methods] */
            public void write(JsonWriter jsonWriter, Boolean bool) throws IOException {
                jsonWriter.value(bool == null ? b.m : bool.toString());
            }
        };
        ...
        TypeAdapter<JsonElement> typeAdapter15 = new TypeAdapter<JsonElement>() { // from class: com.google.gson.internal.bind.TypeAdapters.27
            ...
            public JsonElement read2(JsonReader jsonReader) throws IOException {
                ...
                switch (a.f6325a[jsonReader.peek().ordinal()]) {
                    case 1:
