...
public final class MapTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public final class Adapter<K, V> extends TypeAdapter<Map<K, V>> {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public final TypeAdapter<K> f6307a;
        public final TypeAdapter<V> b;
        public final ObjectConstructor<? extends Map<K, V>> c;

        public Adapter(Gson gson, Type type, TypeAdapter<K> typeAdapter, Type type2, TypeAdapter<V> typeAdapter2, ObjectConstructor<? extends Map<K, V>> objectConstructor) {
            this.f6307a = new TypeAdapterRuntimeTypeWrapper(gson, typeAdapter, type);
        ...
        public Map<K, V> read2(JsonReader jsonReader) throws IOException {
            ...
            if (jsonTokenPeek == JsonToken.BEGIN_ARRAY) {
                ...
                while (jsonReader.hasNext()) {
                    jsonReader.beginArray();
                    K k = this.f6307a.read2(jsonReader);
                    if (mapConstruct.put(k, this.b.read2(jsonReader)) != null) {
                ...
                while (jsonReader.hasNext()) {
                    ...
                    K k2 = this.f6307a.read2(jsonReader);
                    if (mapConstruct.put(k2, this.b.read2(jsonReader)) != null) {
        ...
        public void write(JsonWriter jsonWriter, Map<K, V> map) throws IOException {
            ...
            if (!MapTypeAdapterFactory.this.f6306a) {
            ...
            for (Map.Entry<K, V> entry2 : map.entrySet()) {
                JsonElement jsonTree = this.f6307a.toJsonTree(entry2.getKey());
