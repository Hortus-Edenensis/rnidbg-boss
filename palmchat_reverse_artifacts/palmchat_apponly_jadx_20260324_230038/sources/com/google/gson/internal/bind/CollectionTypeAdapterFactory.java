...
public final class CollectionTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public static final class Adapter<E> extends TypeAdapter<Collection<E>> {
        ...
        public final TypeAdapter<E> f6305a;
        public final ObjectConstructor<? extends Collection<E>> b;

        public Adapter(Gson gson, Type type, TypeAdapter<E> typeAdapter, ObjectConstructor<? extends Collection<E>> objectConstructor) {
            this.f6305a = new TypeAdapterRuntimeTypeWrapper(gson, typeAdapter, type);
        ...
        public Collection<E> read2(JsonReader jsonReader) throws IOException {
            ...
            while (jsonReader.hasNext()) {
                collectionConstruct.add(this.f6305a.read2(jsonReader));
            }
            jsonReader.endArray();
        ...
        public void write(JsonWriter jsonWriter, Collection<E> collection) throws IOException {
            ...
            while (it.hasNext()) {
                this.f6305a.write(jsonWriter, it.next());
            }
            jsonWriter.endArray();
        }
    }
