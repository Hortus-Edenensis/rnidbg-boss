...
class Camera2Session implements CameraSession {
    ...
    public class CaptureSessionCallback extends CameraCaptureSession.StateCallback {
        ...
        public /* synthetic */ void lambda$onConfigured$0(VideoFrame videoFrame) {
            ...
            VideoFrame videoFrame2 = new VideoFrame(ty.a((TextureBufferImpl) videoFrame.getBuffer(), Camera2Session.this.isCameraFrontFacing, -Camera2Session.this.cameraOrientation), Camera2Session.this.getFrameOrientation(), videoFrame.getTimestampNs());
            ...
            try {
                ...
                Camera2Session.this.surfaceTextureHelper.startListening(new VideoSink() { // from class: com.ss.bytertc.base.media.camera.d
                    ...
                    public final void onFrame(VideoFrame videoFrame) {
                        this.f10631a.lambda$onConfigured$0(videoFrame);
                    }
                });
