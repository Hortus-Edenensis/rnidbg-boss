...
public class RXScreenCaptureService extends Service {
    ...
    private void audioDispose() {
        this.mHandler.post(new Runnable() { // from class: as4
    ...
    private void changeCaptureFormat(Intent intent) {
        ...
        this.mHandler.post(new Runnable() { // from class: zr4
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private void createNotificationChannel() {
        ...
        if (i >= 26) {
            ((NotificationManager) getSystemService("notification")).createNotificationChannel(sz3.a("notification_id", "notification_name", 2));
        }
    ...
    private void dispose(Intent intent) {
        ...
        this.mHandler.post(new Runnable() { // from class: xr4
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private void startAudioCapture() {
        ...
        this.mHandler.post(new Runnable() { // from class: yr4
            @Override // java.lang.Runnable
            public final void run() {
                this.f22256a.lambda$startAudioCapture$4();
            }
        });
    }
    ...
    private void startCapture(Intent intent) {
        ...
        this.mHandler.post(new Runnable() { // from class: cs4
            @Override // java.lang.Runnable
            public final void run() {
                this.f16908a.lambda$startCapture$0(intExtra, intExtra2, intExtra3, intExtra4);
            }
        });
    }
    ...
    private void stop() {
        ...
        this.mHandler.post(new Runnable() { // from class: ds4
            @Override // java.lang.Runnable
            public final void run() {
                this.f17132a.lambda$stop$7();
            }
        });
    }

    private void stopAudioCapture() {
        this.mHandler.post(new Runnable() { // from class: bs4
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private void stopCapture(Intent intent) {
        this.mHandler.post(new Runnable() { // from class: wr4
            @Override // java.lang.Runnable
            public final void run() {
