...
public class InternalRemoteVideoStats {
    ...
    @CalledByNative
    private static InternalRemoteVideoStats create(int i, int i2, float f, float f2, int i3, int i4, int i5, int i6, long j, boolean z, int i7, int i8, int i9, int i10, int i11, int i12, int i13) {
