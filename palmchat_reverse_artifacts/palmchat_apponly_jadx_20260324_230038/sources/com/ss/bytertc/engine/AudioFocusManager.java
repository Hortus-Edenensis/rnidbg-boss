...
public class AudioFocusManager {
    ...
    private Application.ActivityLifecycleCallbacks mActivityLifecycleCallback = new Application.ActivityLifecycleCallbacks() { // from class: com.ss.bytertc.engine.AudioFocusManager.2
        ...
        public void onActivityResumed(@NonNull Activity activity) {
            ...
            if ((Build.VERSION.SDK_INT < 26 ? audioManager.requestAudioFocus(AudioFocusManager.this.onAudioFocusChangeListener, 3, 1) : audioManager.requestAudioFocus(ak.a(1).setOnAudioFocusChangeListener(AudioFocusManager.this.onAudioFocusChangeListener).build())) == 1) {
    ...
    public void requestAudioFocus() {
        ...
        if (audioManager != null) {
            if (Build.VERSION.SDK_INT < 26) {
                ...
                audioManager.requestAudioFocus(ak.a(1).setOnAudioFocusChangeListener(this.onAudioFocusChangeListener).build());
            }
    ...
    public void releaseAudioFocus(boolean z) {
        ...
        if (audioManager != null) {
            if (Build.VERSION.SDK_INT < 26) {
                ...
                audioManager.abandonAudioFocusRequest(ak.a(1).setOnAudioFocusChangeListener(this.onAudioFocusChangeListener).build());
            }
