...
public class InternalRemoteAudioStats {
    ...
    @CalledByNative
    private static InternalRemoteAudioStats create(float f, int i, int i2, int i3, long j, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17) {
