...
public class TextureHelper {
    ...
    private TextureHelper(Object obj, Handler handler, int i, int i2) {
        ...
        if (obj instanceof EGLContext) {
            this.mEglBase = a.d((EGLContext) obj, EglBase.CONFIG_PIXEL_BUFFER);
        } else if (obj instanceof android.opengl.EGLContext) {
            this.mEglBase = a.f((android.opengl.EGLContext) obj, EglBase.CONFIG_PIXEL_BUFFER);
        } else {
            if (!(obj instanceof EglBase.Context)) {
                throw new RuntimeException("unknown shareContext:" + obj);
            }
            this.mEglBase = a.b((EglBase.Context) obj);
        }
        try {
    ...
    public static TextureHelper create(final String str, final EGLContext eGLContext, final int i, final int i2) {
        ...
        return (TextureHelper) ThreadUtils.invokeAtFrontUninterruptibly(handler, new Callable() { // from class: aw5
    ...
    private int generateTexture(final int i, final int i2, final int i3) {
        ...
        return ((Integer) ThreadUtils.invokeAtFrontUninterruptibly(this.mHandler, new Callable() { // from class: dw5
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.f17174a.lambda$generateTexture$6(i, i2, i3);
            }
        })).intValue();
    }
    ...
    public /* synthetic */ void lambda$dequeueTexture$3(int[] iArr) {
        ...
        if (list != null) {
            if (list.size() != 0) {
                ...
                int iGenerateTexture = generateTexture(3553, this.mWidth, this.mHeight);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ Integer lambda$generateTexture$6(int i, int i2, int i3) throws Exception {
    ...
    public int dequeueTexture() {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.mHandler, new Runnable() { // from class: zv5
            @Override // java.lang.Runnable
            public final void run() {
                this.f22528a.lambda$dequeueTexture$3(iArr);
            }
        });
        return iArr[0];
    }
    ...
    public synchronized void dispose() {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.mHandler, new Runnable() { // from class: yv5
            @Override // java.lang.Runnable
            public final void run() {
                this.f22289a.lambda$dispose$7();
            }
        });
    }
    ...
    public void queueTexture(final int i) {
        this.mHandler.post(new Runnable() { // from class: bw5
            @Override // java.lang.Runnable
            public final void run() {
                this.f1844a.lambda$queueTexture$4(i);
            }
        });
    }
    ...
    public void releaseTextureID(final int i) {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.mHandler, new Runnable() { // from class: wv5
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public static TextureHelper create(final String str, final android.opengl.EGLContext eGLContext, final int i, final int i2) {
        ...
        handlerThread.start();
        final Handler handler = new Handler(handlerThread.getLooper());
        return (TextureHelper) ThreadUtils.invokeAtFrontUninterruptibly(handler, new Callable() { // from class: cw5
            @Override // java.util.concurrent.Callable
            public final Object call() {
    ...
    public static TextureHelper create(final String str, final EglBase.Context context, final int i, final int i2) {
        ...
        handlerThread.start();
        final Handler handler = new Handler(handlerThread.getLooper());
        return (TextureHelper) ThreadUtils.invokeAtFrontUninterruptibly(handler, new Callable() { // from class: xv5
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return TextureHelper.lambda$create$2(context, handler, i, i2, str);
            }
        });
    }
}
