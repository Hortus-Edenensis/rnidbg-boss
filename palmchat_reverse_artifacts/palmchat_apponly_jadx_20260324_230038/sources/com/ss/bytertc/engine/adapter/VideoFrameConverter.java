...
public class VideoFrameConverter {
    ...
    public VideoFrame.I420Buffer convertToJavaI420Buffer(ByteBuffer byteBuffer, int i, int i2, boolean z) {
        ...
        return z ? CountDownLatchI420Buffer.wrap(i, i2, byteBufferSlice, i, byteBufferSlice2, i5, byteBufferSlice3, i5, new Runnable() { // from class: tb6
            @Override // java.lang.Runnable
            public final void run() {
                pendingBuffer.setPending(false);
            }
        }) : JavaI420Buffer.wrap(i, i2, byteBufferSlice, i, byteBufferSlice2, i5, byteBufferSlice3, i5, new Runnable() { // from class: vb6
            @Override // java.lang.Runnable
            public final void run() {
                pendingBuffer.setPending(false);
            }
    ...
    public VideoFrame.I420Buffer convertToJavaI420Buffer(byte[] bArr, int i, int i2, boolean z) {
        ...
        if (z) {
            return CountDownLatchI420Buffer.wrap(i, i2, byteBufferSlice, i, byteBufferSlice2, i5, byteBufferSlice3, i5, new Runnable() { // from class: wb6
                @Override // java.lang.Runnable
                public final void run() {
                    pendingBuffer.setPending(false);
                }
        ...
        return JavaI420Buffer.wrap(i, i2, byteBufferSlice, i, byteBufferSlice2, i5, byteBufferSlice3, i5, new Runnable() { // from class: xb6
            @Override // java.lang.Runnable
            public final void run() {
                pendingBuffer.setPending(false);
            }
