...
public class NativeRTCVideoFunctions {
    ...
    public static native int nativeEnableAudioPropertiesReport(long j, int i, boolean z, boolean z2, int i2, float f, int i3, boolean z3, boolean z4);
    ...
    public static native int nativeEnableP2PAbility(long j, String str, boolean z);
    ...
    public static native int nativeRegisterInternalP2PEventObserver(long j, RTCEngineInternalP2PEventHandler rTCEngineInternalP2PEventHandler);
    ...
    public static native int nativeSetAudioScene(long j, int i);
    ...
    public static native int nativeSetLocalVideoRender(long j, int i, IVideoSink iVideoSink, int i2, int i3);
    ...
    public static native int nativeSetRemoteVideoRender(long j, String str, String str2, int i, IVideoSink iVideoSink, int i2, int i3, int i4, int i5);
