...
public class HWEarBackDeviceSupport implements kk2 {
    ...
    private void initKaraokeFeature() {
        ...
        if (hwAudioKit != null) {
            this.mHwAudioKaraokeFeatureKit = (HwAudioKaraokeFeatureKit) hwAudioKit.l(HwAudioKit.FeatureType.HWAUDIO_FEATURE_KARAOKE);
        }
    }
    ...
    public int HWEnableKaraoke(boolean z) {
        ...
        return this.mHwAudioKaraokeFeatureKit.m(z);
    }
    ...
    public boolean HWGetKaraokeSupport() {
        ...
        return hwAudioKaraokeFeatureKit.p();
    }
    ...
    public int HWSetEffectMode(int i) {
        ...
        return this.mHwAudioKaraokeFeatureKit.s(HwAudioKaraokeFeatureKit.ParameName.CMD_SET_AUDIO_EFFECT_MODE_BASE, i);
    }
    ...
    public int HWSetEqualizerMode(int i) {
        ...
        return this.mHwAudioKaraokeFeatureKit.s(HwAudioKaraokeFeatureKit.ParameName.CMD_SET_VOCAL_EQUALIZER_MODE, i);
    }
    ...
    public int getLatency() {
        ...
        return hwAudioKaraokeFeatureKit.n();
    }
    ...
    public int setVolume(int i) {
        ...
        return this.mHwAudioKaraokeFeatureKit.s(HwAudioKaraokeFeatureKit.ParameName.CMD_SET_VOCAL_VOLUME_BASE, i);
    }
}
