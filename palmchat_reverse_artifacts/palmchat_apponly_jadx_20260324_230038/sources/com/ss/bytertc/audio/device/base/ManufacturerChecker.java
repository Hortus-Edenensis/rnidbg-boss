...
public class ManufacturerChecker {
    ...
    public static Type getManufacturerType(String str) {
        ...
        if (lowerCase.equalsIgnoreCase(xmType)) {
            ...
            typeResult = Type.VO;
        } else if ((lowerCase.length() == 4 && lowerCase.startsWith(ConfigConstant.COLUMN_OP) && lowerCase.endsWith("po")) || lowerCase.equalsIgnoreCase(oneType) || lowerCase.equalsIgnoreCase(realType)) {
            typeResult = Type.OP;
        } else {
