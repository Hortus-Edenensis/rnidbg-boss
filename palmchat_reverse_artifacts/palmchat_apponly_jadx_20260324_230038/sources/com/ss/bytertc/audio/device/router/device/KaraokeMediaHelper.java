...
public class KaraokeMediaHelper {
    ...
    public boolean isAppSupportKaraoke(String str) {
        return this.mAudioManager.getParameters("karaoke_app_support:" + str).contains(ex.Code);
    }

    public boolean isDeviceSupportKaraoke() {
        return this.mAudioManager.getParameters("audio_karaoke_support").contains(ex.Code);
    }
