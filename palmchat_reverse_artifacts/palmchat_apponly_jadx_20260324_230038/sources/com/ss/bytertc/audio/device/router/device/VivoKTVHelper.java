...
public class VivoKTVHelper {
    ...
    static {
        int[][] iArr = {new int[]{200, 1000, 500, 4500, 1000, TTAdConstant.STYLE_SIZE_RADIO_3_2}, new int[]{5000, 4500, 1200, 4500, p.f, 1200}, new int[]{4500, 8000, 1000, 4000, p.f, TTAdConstant.STYLE_SIZE_RADIO_3_2}, new int[]{2500, 3000, TTAdConstant.STYLE_SIZE_RADIO_3_2, 4000, 5000, TTAdConstant.STYLE_SIZE_RADIO_3_2}, new int[]{3500, 5500, TTAdConstant.STYLE_SIZE_RADIO_3_2, 5000, 5500, TTAdConstant.STYLE_SIZE_RADIO_3_2}, new int[]{4000, 3000, 1000, 2500, 5500, 1200}, new int[]{500, 5000, 800, 4500, 3000, 1200}, new int[]{20, 500, 60, 4500, 5000, TTAdConstant.STYLE_SIZE_RADIO_3_2}, new int[]{0, 0, 0, 4000, 0, 1200}};
        ...
        EchoCustomParams = new int[][]{new int[]{3200, 150, TTAdConstant.STYLE_SIZE_RADIO_3_2, 2000}};
    }
