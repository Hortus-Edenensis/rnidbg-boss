...
public class WebRtcAudioManager implements VolumeChangedObserver.OnVolumeChangedListener, MicMuteChangedObserver.OnMicMuteChangedListener {
    ...
    public class AudioManagerRecordingCallback extends AudioManager.AudioRecordingCallback {
        ...
        public void onRecordingConfigChanged(List<AudioRecordingConfiguration> list) {
            ...
            for (int i = 0; i < list.size(); i++) {
                AudioRecordingConfiguration audioRecordingConfigurationA = dj6.a(list.get(i));
                NativeRecordCallbackInfo nativeRecordCallbackInfo = new NativeRecordCallbackInfo();
                nativeRecordCallbackInfo.audio_session_id = audioRecordingConfigurationA.getClientAudioSessionId();
                nativeRecordCallbackInfo.client_audio_source = audioRecordingConfigurationA.getClientAudioSource();
                int i2 = Build.VERSION.SDK_INT;
                int i3 = -1;
                nativeRecordCallbackInfo.audio_source = i2 >= 29 ? audioRecordingConfigurationA.getAudioSource() : -1;
                if (i2 >= 29) {
                    i3 = audioRecordingConfigurationA.isClientSilenced() ? 1 : 0;
                }
    ...
    private int[] getActiveRecordingSessionIds() {
        ...
        try {
            ...
            for (int i = 0; i < activeRecordingConfigurations.size(); i++) {
                AudioRecordingConfiguration audioRecordingConfigurationA = dj6.a(activeRecordingConfigurations.get(i));
                if (audioRecordingConfigurationA != null) {
                    arrayList.add(Integer.valueOf(audioRecordingConfigurationA.getClientAudioSessionId()));
                }
            }
    ...
    /* JADX WARN: Removed duplicated region for block: B:20:0x008f A[Catch: Exception -> 0x00a7, all -> 0x00f1, TryCatch #2 {Exception -> 0x00a7, blocks: (B:18:0x0086, B:20:0x008f, B:23:0x00a4, B:22:0x009b), top: B:44:0x0086, outer: #0 }] */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:14:0x0055 A[Catch: all -> 0x0074, TryCatch #0 {, blocks: (B:3:0x0001, B:5:0x002a, B:7:0x002e, B:11:0x004b, B:10:0x0035, B:12:0x004d, B:14:0x0055, B:15:0x005a, B:17:0x005e, B:18:0x0063, B:20:0x0067, B:21:0x006c, B:22:0x0072), top: B:27:0x0001, inners: #1 }] */
    /* JADX WARN: Removed duplicated region for block: B:17:0x005e A[Catch: all -> 0x0074, TryCatch #0 {, blocks: (B:3:0x0001, B:5:0x002a, B:7:0x002e, B:11:0x004b, B:10:0x0035, B:12:0x004d, B:14:0x0055, B:15:0x005a, B:17:0x005e, B:18:0x0063, B:20:0x0067, B:21:0x006c, B:22:0x0072), top: B:27:0x0001, inners: #1 }] */
    /* JADX WARN: Removed duplicated region for block: B:20:0x0067 A[Catch: all -> 0x0074, TryCatch #0 {, blocks: (B:3:0x0001, B:5:0x002a, B:7:0x002e, B:11:0x004b, B:10:0x0035, B:12:0x004d, B:14:0x0055, B:15:0x005a, B:17:0x005e, B:18:0x0063, B:20:0x0067, B:21:0x006c, B:22:0x0072), top: B:27:0x0001, inners: #1 }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
