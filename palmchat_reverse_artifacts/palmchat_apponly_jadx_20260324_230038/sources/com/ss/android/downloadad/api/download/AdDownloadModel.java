...
import com.ss.android.download.api.fx.nr;
import com.ss.android.download.api.model.DeepLink;
import com.ss.android.download.api.model.b;
import com.ss.android.downloadad.api.constant.AdBaseConstants;
import com.ss.android.downloadlib.addownload.l;
import com.ss.android.socialbase.downloader.depend.IDownloadFileUriProvider;
import com.ss.android.socialbase.downloader.n.u;
...
public class AdDownloadModel implements DownloadModel {
    ...
    private static void appendQuickAppUrlFromJson(JSONObject jSONObject, Builder builder) {
        ...
        builder.setQuickAppModel(new b.u().u(strOptString).u());
    }
    ...
    public static AdDownloadModel fromJson(JSONObject jSONObject) {
        ...
        try {
            ...
            l.bq().u(e, "AdDownloadModel fromJson");
        }
    ...
    public boolean shouldDownloadWithPatchApply() {
        return nr.u(u.u(getDownloadSettings()), getMimeType());
    }
    ...
    public JSONObject toJson() {
        ...
        try {
            ...
            jSONObject.putOpt(WfConstant.EXTRA_KEY_DOWNLOAD_URL, this.mDownloadUrl);
            jSONObject.putOpt("app_name", this.mAppName);
            jSONObject.putOpt(WfConstant.EXTRA_KEY_APP_ICON, this.mAppIcon);
            ...
            b bVar = this.mQuickAppModel;
            if (bVar != null) {
                jSONObject.putOpt("quick_app_url", bVar.u());
            }
            ...
            l.bq().u(e, "AdDownloadModel toJson");
        }
        return jSONObject;
    }
