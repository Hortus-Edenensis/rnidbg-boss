...
public class Downloader extends nr {
    ...
    public static synchronized void initOrCover(DownloaderBuilder downloaderBuilder, boolean z) {
        ...
        if (instance == null) {
            ...
            fx.u(downloaderBuilder);
        } else {
            if (z) {
                fx.nr(downloaderBuilder);
            }
        }
    }

    @Override // com.ss.android.socialbase.downloader.downloader.nr
    ...
    @Override // com.ss.android.socialbase.downloader.downloader.nr
    public /* bridge */ /* synthetic */ sx getReserveWifiStatusListener() {
    ...
    @Override // com.ss.android.socialbase.downloader.downloader.nr
    public /* bridge */ /* synthetic */ void registerDownloadCacheSyncListener(com.ss.android.socialbase.downloader.depend.t tVar) {
        super.registerDownloadCacheSyncListener(tVar);
    }

    @Override // com.ss.android.socialbase.downloader.downloader.nr
    public /* bridge */ /* synthetic */ void registerDownloaderProcessConnectedListener(d dVar) {
        super.registerDownloaderProcessConnectedListener(dVar);
    }
    ...
    @Override // com.ss.android.socialbase.downloader.downloader.nr
    public /* bridge */ /* synthetic */ void setReserveWifiStatusListener(sx sxVar) {
        super.setReserveWifiStatusListener(sxVar);
    }
    ...
    @Override // com.ss.android.socialbase.downloader.downloader.nr
    public /* bridge */ /* synthetic */ void unRegisterDownloadCacheSyncListener(com.ss.android.socialbase.downloader.depend.t tVar) {
        super.unRegisterDownloadCacheSyncListener(tVar);
    }

    @Override // com.ss.android.socialbase.downloader.downloader.nr
    public /* bridge */ /* synthetic */ void unRegisterDownloaderProcessConnectedListener(d dVar) {
        super.unRegisterDownloaderProcessConnectedListener(dVar);
    }
