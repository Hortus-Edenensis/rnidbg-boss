...
public class fx {
    public static void u(int i, SparseArray<IDownloadListener> sparseArray, boolean z, DownloadInfo downloadInfo, BaseException baseException) {
        ...
        try {
            ...
            for (int i2 = 0; i2 < sparseArrayClone.size(); i2++) {
                ...
                if (iDownloadListener != null) {
                    ...
                    } else if (iDownloadListener instanceof bg) {
