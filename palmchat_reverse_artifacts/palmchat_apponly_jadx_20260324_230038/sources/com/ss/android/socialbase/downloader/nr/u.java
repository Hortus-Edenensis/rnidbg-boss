...
public class u extends SQLiteOpenHelper {
    ...
    private u() {
        super(new com.bytedance.sdk.openadsdk.api.plugin.u(com.ss.android.socialbase.downloader.downloader.fx.oa()), "downloader.db", (SQLiteDatabase.CursorFactory) null, 15);
        this.nr = false;
    }
    ...
    public SQLiteDatabase getReadableDatabase() {
        ...
        if (this.nr || contextOa == null) {
            return super.getReadableDatabase();
        }
        try {
            File file = new File("/data/data/" + contextOa.getPackageName() + "/database/main/");
            if (!file.exists()) {
                file.mkdir();
            }
    ...
    public void onConfigure(SQLiteDatabase sQLiteDatabase) {
        ...
        if (com.ss.android.socialbase.downloader.n.u.fx().nr("disable_sqlite_wal") <= 0 || Build.VERSION.SDK_INT != 28) {
            return;
        }
    ...
    public void onDowngrade(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        if (com.ss.android.socialbase.downloader.fx.u.u()) {
            com.ss.android.socialbase.downloader.fx.u.u("onDowngrade");
        }
    }
