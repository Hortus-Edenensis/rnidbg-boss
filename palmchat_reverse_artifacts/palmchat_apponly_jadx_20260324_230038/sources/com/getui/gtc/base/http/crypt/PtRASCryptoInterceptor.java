...
public class PtRASCryptoInterceptor implements Interceptor {
    ...
    public PtRASCryptoInterceptor(String str, String str2) {
        ...
        try {
            this.rsaPublicKey = CryptTools.parsePublicKey(EncryptUtils.RSA_ENCRYPT_ALGORITHM, str2);
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        try {
            boolean zStartsWith = request.url().toString().toLowerCase().startsWith(BaseConstants.SCHEME_HTTPS);
