...
public final class b {
    ...
    private static final Map<String, String> f5733a = new HashMap<String, String>() { // from class: com.getui.gtc.dim.c.b.1
        {
    ...
    private static Object b(DimRequest dimRequest) {
        String str = f5733a.get(dimRequest.getKey());
        if (TextUtils.isEmpty(str)) {
            return null;
        }
        return a.C0335a.f5715a.a(new DimRequest.Builder(dimRequest).key(str).build(), false);
    }
