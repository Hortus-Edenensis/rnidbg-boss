...
public final class b {
    ...
    public static class a {
        ...
        public final String toString() {
            return "Config{key='" + this.f5718a + "', sdkTotalRuntimeCondition=" + this.b + ", timeRangeStart='" + this.c + "', timeRangeEnd='" + this.d + "', timeRangeState=" + this.e + ", weekState=" + this.f + ", sdkAccessCountCondition=" + this.g + ", installDurationDayCondition=" + this.h + '}';
        }
    }
    ...
    */
    ...
    public static long b(String str) {
        try {
            d unused = d.a.f5722a;
            h hVarA = d.a(str);
            Object obj = hVarA != null ? hVarA.f5729a : null;
    ...
    public final boolean c(String str) {
        ...
        try {
            ...
            if (aVar.e == 1) {
                String str2 = aVar.c;
                String str3 = aVar.d;
                Calendar calendarA = C0336b.a(jCurrentTimeMillis, str2);
                Calendar calendarA2 = C0336b.a(jCurrentTimeMillis, str3);
                Calendar calendar = Calendar.getInstance();
                ...
                if (z) {
                    int i2 = aVar.f;
                    if (i2 > 0 && i2 <= 3 && ((i2 != 1 || !C0336b.a(jCurrentTimeMillis)) && (aVar.f != 2 || C0336b.a(jCurrentTimeMillis)))) {
                        int i3 = aVar.g;
                        if (i3 > 0 && this.b < i3) {
                        ...
                        if (aVar.h <= 0 || jCurrentTimeMillis - jB >= r2 * BaseConstants.Time.DAY) {
