...
public final class b {
    ...
    private final AtomicBoolean f5799a;
    ...
    public static class C0345b {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private static final b f5803a = new b(0);
    }

    private b() {
        this.f5799a = new AtomicBoolean(false);
        final Map<String, String> mapA = c.a(com.heytap.mcssdk.constant.a.g, new com.getui.gtc.f.e() { // from class: com.getui.gtc.i.d.b.1
                    ...
                    if (bVarA.b.compareAndSet(false, true)) {
                        try {
                            synchronized (bVarA.b) {
                                onDycEnableChangedListenerArr = (OnDycEnableChangedListener[]) bVarA.f5771a.toArray(new OnDycEnableChangedListener[0]);
                                bVarA.f5771a.clear();
                            }
                            ...
                            for (int i = 0; i < 39; i++) {
                                ...
                                switch (str2.hashCode()) {
                                    case 320892099:
                                        b = str2.equals("dim-2-1-14-1") ? (byte) 30 : (byte) -1;
                                        break;
                                    case 320894021:
    ...
    private void a() {
        if (this.f5799a.getAndSet(true) || a(GtcProvider.context())) {
            return;
        }
        ...
        aVar.f5661a = "https://sdk-open-phone.getui.com/";
