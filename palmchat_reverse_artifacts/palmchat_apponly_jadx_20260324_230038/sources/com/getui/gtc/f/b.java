...
public final class b {
    ...
    public final List<OnDycEnableChangedListener> f5771a = new ArrayList();
    ...
    */
    public static Map<String, Boolean> b(Map<String, String> map) {
        ...
        try {
            String str3 = map.get("sdk.gtc.dim.sys.call.enable");
            if (!TextUtils.isEmpty(str3)) {
                ...
                while (i3 < length) {
                    ...
                    if (str4.contains(str2)) {
                        String[] strArrSplit2 = str4.split(str2);
                        String str5 = strArrSplit2[c2];
                        ArrayList arrayList = new ArrayList();
                        byte b = 2;
                        String strEncodeToString = Base64.encodeToString(str5.getBytes(), 2);
                        ...
                        try {
                            ...
                            while (it.hasNext()) {
                                map2 = map5;
                                try {
                                    map2.put((String) it.next(), Boolean.valueOf(i4 != 0));
                                    map5 = map2;
                                } catch (Throwable th) {
                                    th = th;
                        ...
                        i2 = i3;
                        map3 = map4;
                        map3.put("dim-2-2-0-1", Boolean.valueOf(Integer.parseInt(str4) != 0));
                    }
                    map4 = map3;
                    strArrSplit = strArr;
                    length = i;
    ...
    public final void a(OnDycEnableChangedListener onDycEnableChangedListener) {
        ...
        synchronized (this.f5771a) {
            this.f5771a.add(onDycEnableChangedListener);
        }
    }
}
