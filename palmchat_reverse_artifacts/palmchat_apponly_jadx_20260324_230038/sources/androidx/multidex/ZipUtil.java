    ...
    public static CentralDirectory findCentralDirectory(RandomAccessFile randomAccessFile) throws IOException {
        ...
        do {
            ...
            if (randomAccessFile.readInt() == iReverseBytes) {
                ...
                centralDirectory.size = ((long) Integer.reverseBytes(randomAccessFile.readInt())) & MuxerUtil.UNSIGNED_INT_MAX_VALUE;
                centralDirectory.offset = ((long) Integer.reverseBytes(randomAccessFile.readInt())) & MuxerUtil.UNSIGNED_INT_MAX_VALUE;
