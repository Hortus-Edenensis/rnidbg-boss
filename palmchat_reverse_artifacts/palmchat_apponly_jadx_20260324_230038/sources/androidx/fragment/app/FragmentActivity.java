...
public class FragmentActivity extends ComponentActivity implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
    ...
    private void init() {
        getSavedStateRegistry().registerSavedStateProvider(LIFECYCLE_TAG, new SavedStateRegistry.SavedStateProvider() { // from class: b22
            @Override // androidx.savedstate.SavedStateRegistry.SavedStateProvider
            public final Bundle saveState() {
                return this.f1633a.lambda$init$0();
            }
        });
        addOnConfigurationChangedListener(new Consumer() { // from class: c22
            @Override // androidx.core.util.Consumer
            public final void accept(Object obj) {
                this.f1883a.lambda$init$1((Configuration) obj);
            }
        });
        addOnNewIntentListener(new Consumer() { // from class: d22
            @Override // androidx.core.util.Consumer
            public final void accept(Object obj) {
                this.f16963a.lambda$init$2((Intent) obj);
            }
        });
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: e22
            @Override // androidx.activity.contextaware.OnContextAvailableListener
            public final void onContextAvailable(Context context) {
                this.f17204a.lambda$init$3(context);
            }
        });
    }
