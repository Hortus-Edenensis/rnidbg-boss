        ...
        for (String str : this.mFragments) {
            ...
            if (fragment != null) {
                ...
                if (savedState != null) {
                    ...
                    Fragment fragmentInstantiate = ((FragmentState) savedState.getParcelable(LocationConst.HDYawConst.KEY_HD_YAW_STATE)).instantiate(fragmentManager.getFragmentFactory(), classLoader);
