...
public final class HttpEngineDataSource extends BaseDataSource implements HttpDataSource {
    ...
    @UnstableApi
    public HttpEngineDataSource(HttpEngine httpEngine, Executor executor, int i, int i2, int i3, boolean z, boolean z2, @Nullable String str, @Nullable HttpDataSource.RequestProperties requestProperties, @Nullable em4<String> em4Var, boolean z3) {
        super(true);
        this.httpEngine = (HttpEngine) Assertions.checkNotNull(httpEngine);
        ...
        try {
            ...
            try {
                ...
                if (iOException != null) {
                    ...
                    if (message == null || !th.e(message).contains("err_cleartext_not_permitted")) {
                ...
                if (em4Var != null && (firstHeader = getFirstHeader(asMap, "Content-Type")) != null && !em4Var.apply(firstHeader)) {
    ...
    public int read(byte[] bArr, int i, int i2) throws HttpDataSource.HttpDataSourceException {
        ...
        jArr[2] = i2;
        int iK = (int) n73.k(jArr);
        orCreateReadBuffer.get(bArr, i, iK);
        long j2 = this.bytesRemaining;
        if (j2 != -1) {
            this.bytesRemaining = j2 - ((long) iK);
        }
        bytesTransferred(iK);
        return iK;
    }
