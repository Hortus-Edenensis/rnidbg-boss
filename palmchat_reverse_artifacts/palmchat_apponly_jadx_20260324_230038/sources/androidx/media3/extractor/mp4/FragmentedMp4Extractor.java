...
public class FragmentedMp4Extractor implements Extractor {
    ...
    @Deprecated
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() { // from class: v22
    ...
    public static ExtractorsFactory newFactory(final SubtitleParser.Factory factory) {
        return new ExtractorsFactory() { // from class: y22
            @Override // androidx.media3.extractor.ExtractorsFactory
            public final Extractor[] createExtractors() {
    ...
    private void onMoovContainerAtomRead(Mp4Box.ContainerBox containerBox) throws ParserException {
        ...
        Metadata metadata2 = new Metadata(BoxParser.parseMvhd(((Mp4Box.LeafBox) Assertions.checkNotNull(containerBox.getLeafBoxOfType(1836476516))).data));
        List<TrackSampleTable> traks = BoxParser.parseTraks(containerBox, gaplessInfoHolder, mehd, drmInitDataFromAtoms, (this.flags & 16) != 0, false, new u42() { // from class: a32
            @Override // defpackage.u42
            public final Object apply(Object obj) {
                return this.f1143a.modifyTrack((Track) obj);
            }
        });
    ...
    private static int parseTrun(TrackBundle trackBundle, int i, int i2, ParsableByteArray parsableByteArray, int i3) throws ParserException {
        ...
        while (i10 < i9) {
            ...
            long jScaleLargeTimestamp = Util.scaleLargeTimestamp((((long) i6) + j4) - j2, 1000000L, j3);
    ...
    */
    ...
    public FragmentedMp4Extractor(SubtitleParser.Factory factory, int i, @Nullable TimestampAdjuster timestampAdjuster, @Nullable Track track, List<Format> list, @Nullable TrackOutput trackOutput) {
        ...
        this.reorderingBufferQueue = new ReorderingBufferQueue(new ReorderingBufferQueue.OutputConsumer() { // from class: z22
            ...
            public final void consume(long j, ParsableByteArray parsableByteArray) {
                this.f22324a.lambda$new$2(j, parsableByteArray);
            }
        });
