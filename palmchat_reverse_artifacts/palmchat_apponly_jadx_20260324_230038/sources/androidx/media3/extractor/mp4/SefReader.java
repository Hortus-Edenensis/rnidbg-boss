...
final class SefReader {
    ...
    private static final jh5 COLON_SPLITTER = jh5.d(':');
    private static final jh5 ASTERISK_SPLITTER = jh5.d('*');
    ...
    private static SlowMotionData readSlowMotionData(ParsableByteArray parsableByteArray, int i) throws ParserException {
        ...
        List<String> listF = ASTERISK_SPLITTER.f(parsableByteArray.readString(i));
        for (int i2 = 0; i2 < listF.size(); i2++) {
            List<String> listF2 = COLON_SPLITTER.f(listF.get(i2));
            if (listF2.size() != 3) {
