...
final class OverlayShaderProgram extends BaseGlShaderProgram {
    ...
    public OverlayShaderProgram(Context context, boolean z, ImmutableList<TextureOverlay> immutableList) throws VideoFrameProcessingException {
        ...
        if (z) {
            ...
            this.hdrTypes = null;
            Assertions.checkArgument(immutableList.size() <= 15, "OverlayShaderProgram does not support more than 15 SDR overlays in the same instance.");
        }
        ...
        try {
            GlProgram glProgram = new GlProgram(createVertexShader(immutableList.size()), createFragmentShader(context, immutableList.size(), this.hdrTypes));
    ...
    */
    private static String createFragmentShader(Context context, int i, @Nullable int[] iArr) throws IOException {
        String str;
        ...
        for (int i2 = 1; i2 <= i; i2++) {
            ...
            if (iArr != null) {
                ...
                if (i3 == 1) {
                    ...
                    sb.append(Util.formatInvariant("uniform sampler2D uGainmapTexSampler%d;\n", Integer.valueOf(i2)));
                    sb.append(Util.formatInvariant("uniform int uGainmapIsAlpha%d;\n", Integer.valueOf(i2)));
                    sb.append(Util.formatInvariant("uniform int uNoGamma%d;\n", Integer.valueOf(i2)));
                    sb.append(Util.formatInvariant("uniform int uSingleChannel%d;\n", Integer.valueOf(i2)));
                    sb.append(Util.formatInvariant("uniform vec4 uLogRatioMin%d;\n", Integer.valueOf(i2)));
                    sb.append(Util.formatInvariant("uniform vec4 uLogRatioMax%d;\n", Integer.valueOf(i2)));
                    sb.append(Util.formatInvariant("uniform vec4 uEpsilonSdr%d;\n", Integer.valueOf(i2)));
                    sb.append(Util.formatInvariant("uniform vec4 uEpsilonHdr%d;\n", Integer.valueOf(i2)));
                    sb.append(Util.formatInvariant("uniform vec4 uGainmapGamma%d;\n", Integer.valueOf(i2)));
                    sb.append(Util.formatInvariant("uniform float uDisplayRatioHdr%d;\n", Integer.valueOf(i2)));
                    sb.append(Util.formatInvariant("uniform float uDisplayRatioSdr%d;\n", Integer.valueOf(i2)));
                    sb.append("\n");
                } else if (i3 == 2) {
    ...
    public void drawFrame(int i, long j) throws VideoFrameProcessingException {
        try {
            ...
            for (int i2 = 1; i2 <= this.overlays.size(); i2++) {
                int i3 = i2 - 1;
                TextureOverlay textureOverlay = this.overlays.get(i3);
                ...
                if (iArr != null) {
                    ...
                    if (i4 == 1) {
                        ...
                        if (gainmap2 == null || !GainmapUtil.equals(gainmap2, gainmap)) {
                            ...
                            this.glProgram.setSamplerTexIdUniform("uGainmapTexSampler" + i2, this.gainmapTexIds.get(i2), this.overlays.size() + i2);
                        ...
                        float hdrLuminanceMultiplier = textureOverlay.getOverlaySettings(j).getHdrLuminanceMultiplier();
                        Matrix.scaleM(fArrCreate4x4IdentityMatrix, 0, hdrLuminanceMultiplier, hdrLuminanceMultiplier, hdrLuminanceMultiplier);
                        this.glProgram.setFloatsUniform(Util.formatInvariant("uLuminanceMatrix%d", Integer.valueOf(i2)), fArrCreate4x4IdentityMatrix);
                    }
                }
                ...
                this.glProgram.setFloatUniform(Util.formatInvariant("uOverlayAlphaScale%d", Integer.valueOf(i2)), overlaySettings.getAlphaScale());
            }
