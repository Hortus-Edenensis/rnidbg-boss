...
public class DefaultDrmSessionManager implements DrmSessionManager {
    ...
    public class PreacquiredSessionReference implements DrmSessionManager.DrmSessionReference {
        ...
        public void acquire(final Format format) {
            ((Handler) Assertions.checkNotNull(DefaultDrmSessionManager.this.playbackHandler)).post(new Runnable() { // from class: androidx.media3.exoplayer.drm.d
                @Override // java.lang.Runnable
                public final void run() {
                    this.f1384a.lambda$acquire$0(format);
                }
            });
        }
        ...
        public void release() {
            Util.postOrRun((Handler) Assertions.checkNotNull(DefaultDrmSessionManager.this.playbackHandler), new Runnable() { // from class: androidx.media3.exoplayer.drm.c
                @Override // java.lang.Runnable
                public final void run() {
                    this.f1383a.lambda$release$1();
                }
            });
        }
    }
    ...
    private void releaseAllKeepaliveSessions() {
        o46 it = ImmutableSet.copyOf((Collection) this.keepaliveSessions).iterator();
        while (it.hasNext()) {
    ...
    private void releaseAllPreacquiredSessions() {
        o46 it = ImmutableSet.copyOf((Collection) this.preacquiredSessionReferences).iterator();
        while (it.hasNext()) {
    ...
    private DefaultDrmSessionManager(UUID uuid, ExoMediaDrm.Provider provider, MediaDrmCallback mediaDrmCallback, HashMap<String, String> map, boolean z, int[] iArr, boolean z2, LoadErrorHandlingPolicy loadErrorHandlingPolicy, long j) {
        ...
        this.preacquiredSessionReferences = k0.i();
        this.keepaliveSessions = k0.i();
        this.sessionKeepaliveMs = j;
    }
