...
public final class AsynchronousMediaCodecAdapter implements MediaCodecAdapter {
    ...
    public static final class Factory implements MediaCodecAdapter.Factory {
        ...
        public Factory(qo5<HandlerThread> qo5Var, qo5<HandlerThread> qo5Var2) {
            ...
            try {
                ...
                try {
                    if (this.enableSynchronousBufferQueueingWithAsyncCryptoFlag && useSynchronousBufferQueueingWithAsyncCryptoFlag(configuration.format)) {
                        ...
                        asynchronousMediaCodecBufferEnqueuer = new AsynchronousMediaCodecBufferEnqueuer(mediaCodecCreateByCodecName, this.queueingThreadSupplier.get2());
                        i = 0;
                    }
                    asynchronousMediaCodecAdapter = new AsynchronousMediaCodecAdapter(mediaCodecCreateByCodecName, this.callbackThreadSupplier.get2(), asynchronousMediaCodecBufferEnqueuer, configuration.loudnessCodecController);
                } catch (Exception e) {
                    e = e;
                }
            } catch (Exception e2) {
    ...
    public void setOnFrameRenderedListener(final MediaCodecAdapter.OnFrameRenderedListener onFrameRenderedListener, Handler handler) {
        this.codec.setOnFrameRenderedListener(new MediaCodec.OnFrameRenderedListener() { // from class: androidx.media3.exoplayer.mediacodec.a
            ...
            public final void onFrameRendered(MediaCodec mediaCodec, long j, long j2) {
                this.f1419a.lambda$setOnFrameRenderedListener$0(onFrameRenderedListener, mediaCodec, j, j2);
            }
        }, handler);
    }
