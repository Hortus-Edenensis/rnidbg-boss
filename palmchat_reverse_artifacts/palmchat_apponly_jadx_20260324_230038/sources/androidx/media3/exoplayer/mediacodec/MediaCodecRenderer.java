...
public abstract class MediaCodecRenderer extends BaseRenderer {
    ...
    private boolean drainOutputBuffer(long j, long j2) throws ExoPlaybackException {
        ...
        if (this.codecNeedsEosOutputExceptionWorkaround && this.codecReceivedEos) {
            ...
            try {
                zProcessOutputBuffer = processOutputBuffer(j, j2, mediaCodecAdapter, byteBuffer, i, bufferInfo.flags, 1, bufferInfo.presentationTimeUs, this.isDecodeOnlyOutputBuffer, this.isLastOutputBuffer, (Format) Assertions.checkNotNull(this.outputFormat));
    ...
    private void setCodecDrmSession(@Nullable DrmSession drmSession) {
        eh1.b(this.codecDrmSession, drmSession);
    ...
    private void setSourceDrmSession(@Nullable DrmSession drmSession) {
        eh1.b(this.sourceDrmSession, drmSession);
    ...
    */
    public DecoderReuseEvaluation onInputFormatChanged(FormatHolder formatHolder) throws ExoPlaybackException {
        ...
        if ((Objects.equals(str, "video/av01") || Objects.equals(formatBuild.sampleMimeType, "video/x-vnd.on2.vp9")) && !formatBuild.initializationData.isEmpty()) {
