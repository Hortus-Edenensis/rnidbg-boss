        ...
        private void postCheckRequirements() {
            RequirementsWatcher.this.handler.post(new Runnable() { // from class: androidx.media3.exoplayer.scheduler.b
                ...
                public final void run() {
                    this.f1447a.lambda$postCheckRequirements$0();
                }
            });
        }

        private void postRecheckNotMetNetworkRequirements() {
            RequirementsWatcher.this.handler.post(new Runnable() { // from class: androidx.media3.exoplayer.scheduler.a
                @Override // java.lang.Runnable
                public final void run() {
                    this.f1446a.lambda$postRecheckNotMetNetworkRequirements$1();
                }
            });
        }
