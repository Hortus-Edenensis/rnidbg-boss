...
public final class SphericalGLSurfaceView extends GLSurfaceView {
    ...
    public void onSurfaceTextureAvailable(final SurfaceTexture surfaceTexture) {
        this.mainHandler.post(new Runnable() { // from class: ch5
            @Override // java.lang.Runnable
            public final void run() {
                this.f1991a.lambda$onSurfaceTextureAvailable$1(surfaceTexture);
            }
        });
    }
    ...
    public void onDetachedFromWindow() {
        ...
        this.mainHandler.post(new Runnable() { // from class: eh5
            @Override // java.lang.Runnable
            public final void run() {
                this.f17302a.lambda$onDetachedFromWindow$0();
            }
        });
    }
