...
public final class MediaExtractorCompat {
    ...
    public final class MediaExtractorSampleQueue extends SampleQueue {
        ...
        private void queueSampleMetadata(long j, int i) {
            int i2 = ((1073741824 & i) != 0 ? 2 : 0) | 0 | ((i & 1) != 0 ? 1 : 0);
    ...
    public static final class MediaExtractorTrack {
        ...
        public MediaFormat createDownstreamMediaFormat(FormatHolder formatHolder, DecoderInputBuffer decoderInputBuffer) {
            ...
            if (codecProfileAndLevel != null && Build.VERSION.SDK_INT >= 23) {
                mediaFormatCreateMediaFormatFromFormat.setInteger(IMediaFormat.KEY_PROFILE, ((Integer) codecProfileAndLevel.first).intValue());
    ...
    private Extractor selectExtractor(ExtractorInput extractorInput) throws IOException {
        ...
        throw new UnrecognizedInputFormatException("None of the available extractors (" + qy2.h(", ").d(d43.n(ImmutableList.copyOf(extractorArrCreateExtractors), new u42() { // from class: qg3
    ...
    public boolean getSampleCryptoInfo(MediaCodec.CryptoInfo cryptoInfo) {
        ...
        if (!((this.sampleMetadataQueue.peekFirst().flags & 2) != 0)) {
            return false;
        }
    ...
    public MediaFormat getTrackFormat(int i) {
        ...
        if (j != -9223372036854775807L) {
            mediaFormatCreateDownstreamMediaFormat.setLong(IMediaFormat.KEY_DURATION, j);
        } else {
            SeekMap seekMap = this.seekMap;
            if (seekMap != null && seekMap.getDurationUs() != -9223372036854775807L) {
                mediaFormatCreateDownstreamMediaFormat.setLong(IMediaFormat.KEY_DURATION, this.seekMap.getDurationUs());
            }
        }
    ...
    */
    public void seekTo(long j, int i) {
        ...
        if (this.selectedTrackIndices.size() == 1) {
            Extractor extractor = this.currentExtractor;
            seekPoints = extractor instanceof Mp4Extractor ? ((Mp4Extractor) extractor).getSeekPoints(j, this.tracks.get(this.selectedTrackIndices.iterator().next().intValue()).getIdOfBackingTrack()) : this.seekMap.getSeekPoints(j);
        }
        if (i == 0) {
    ...
    public void setDataSource(Context context, Uri uri, @Nullable Map<String, String> map) throws IOException {
        ...
        try {
            assetFileDescriptorOpenAssetFileDescriptor = context.getContentResolver().openAssetFileDescriptor(uri, com.kuaishou.weapon.p0.t.k);
