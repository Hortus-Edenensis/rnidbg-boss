...
public final class ScrubbingModeParameters {
    ...
    public static final class Builder {
        ...
        public Builder setFractionalSeekTolerance(@Nullable @FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) Double d, @Nullable @FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) Double d2) {
            boolean z = true;
