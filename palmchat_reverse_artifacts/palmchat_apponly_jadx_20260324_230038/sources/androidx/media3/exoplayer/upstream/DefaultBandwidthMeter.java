...
public final class DefaultBandwidthMeter implements BandwidthMeter, TransferListener {
    ...
    public static final class Builder {
        ...
        public Builder setInitialBitrateEstimate(String str) {
            ...
            for (Integer num : this.initialBitrateEstimates.keySet()) {
                setInitialBitrateEstimate(num.intValue(), DefaultBandwidthMeter.getInitialBitrateEstimatesForCountry(strG, num.intValue()));
            }
            return this;
        }
    }
    ...
    private DefaultBandwidthMeter(@Nullable Context context, Map<Integer, Long> map, int i, Clock clock, boolean z) {
        ...
        networkTypeObserver.register(new NetworkTypeObserver.Listener() { // from class: w31
            @Override // androidx.media3.common.util.NetworkTypeObserver.Listener
            public final void onNetworkTypeChanged(int i2) {
                this.f21599a.onNetworkTypeChanged(i2);
            }
