...
public final class ExperimentalBandwidthMeter implements BandwidthMeter, TransferListener {
    ...
    public static long getInitialBitrateEstimatesForCountry(@Nullable String str, int i) {
        int[] initialBitrateCountryGroupAssignment = getInitialBitrateCountryGroupAssignment(ol5.e(str));
        if (i != 2) {
            if (i == 3) {
    ...
    public static final class Builder {
        ...
        public Builder setInitialBitrateEstimate(String str) {
            String strG = th.g(str);
            for (Integer num : this.initialBitrateEstimates.keySet()) {
                setInitialBitrateEstimate(num.intValue(), ExperimentalBandwidthMeter.getInitialBitrateEstimatesForCountry(strG, num.intValue()));
            }
            return this;
        }
    }
    ...
    private ExperimentalBandwidthMeter(Context context, Map<Integer, Long> map, TimeToFirstByteEstimator timeToFirstByteEstimator, BandwidthEstimator bandwidthEstimator, boolean z) {
        ...
        networkTypeObserver.register(new NetworkTypeObserver.Listener() { // from class: sr1
            @Override // androidx.media3.common.util.NetworkTypeObserver.Listener
            public final void onNetworkTypeChanged(int i) {
                this.f20827a.onNetworkTypeChanged(i);
            }
