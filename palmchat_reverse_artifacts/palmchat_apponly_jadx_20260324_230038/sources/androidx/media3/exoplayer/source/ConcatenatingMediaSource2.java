...
public final class ConcatenatingMediaSource2 extends CompositeMediaSource<Integer> {
    ...
    public static final class Builder {
        ...
        public Builder add(MediaSource mediaSource, long j) {
            ...
            int i = this.index;
            this.index = i + 1;
            aVar.a(new MediaSourceHolder(mediaSource, i, Util.msToUs(j)));
            return this;
        }
    }
    ...
    private ConcatenatedTimeline maybeCreateConcatenatedTimeline() {
        ...
        while (i2 < size) {
            ...
            while (i3 < timeline2.getWindowCount()) {
                ...
                while (i4 <= window.lastPeriodIndex) {
                    aVarBuilder3.a(Long.valueOf(j4));
        ...
        return new ConcatenatedTimeline(getMediaItem(), aVarBuilder.e(), aVarBuilder2.e(), aVarBuilder3.e(), z7, z8, j2, j3, z5 ? obj3 : null);
    }
    ...
    public void prepareSourceInternal(@Nullable TransferListener transferListener) {
        ...
        this.playbackThreadHandler = new Handler(new Handler.Callback() { // from class: al0
            @Override // android.os.Handler.Callback
            public final boolean handleMessage(Message message) {
                return this.f1249a.handleMessage(message);
            }
        });
        for (int i = 0; i < this.mediaSourceHolders.size(); i++) {
