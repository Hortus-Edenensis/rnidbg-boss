...
public final class TrackGroupArray {
    ...
    public static TrackGroupArray fromBundle(Bundle bundle) {
        ...
        return parcelableArrayList == null ? new TrackGroupArray(new TrackGroup[0]) : new TrackGroupArray((TrackGroup[]) BundleCollectionUtil.fromBundleList(new u42() { // from class: uz5
    ...
    public ImmutableList<Integer> getTrackTypes() {
        return ImmutableList.copyOf((Collection) d43.n(this.trackGroups, new u42() { // from class: sz5
            @Override // defpackage.u42
            public final Object apply(Object obj) {
    ...
    public Bundle toBundle() {
        ...
        bundle.putParcelableArrayList(FIELD_TRACK_GROUPS, BundleCollectionUtil.toBundleArrayList(this.trackGroups, new u42() { // from class: tz5
            @Override // defpackage.u42
            public final Object apply(Object obj) {
