...
public final class PreloadMediaSource extends WrappingMediaSource {
    ...
    public class PreloadMediaPeriodCallback implements MediaPeriod.Callback {
        ...
        public void onPrepared(final MediaPeriod mediaPeriod) {
            this.prepared = true;
            PreloadMediaSource.this.preloadHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.preload.n
                @Override // java.lang.Runnable
                public final void run() {
                    this.f1473a.lambda$onPrepared$0(mediaPeriod);
                }
            });
        }
        ...
        public void onContinueLoadingRequested(final MediaPeriod mediaPeriod) {
            PreloadMediaSource.this.preloadHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.preload.m
                @Override // java.lang.Runnable
                public final void run() {
                    this.f1472a.lambda$onContinueLoadingRequested$1(mediaPeriod);
                }
            });
        }
    }
    ...
    public void checkForPreloadError() {
        try {
            ...
            this.preloadHandler.postDelayed(new Runnable() { // from class: lm4
                @Override // java.lang.Runnable
                public final void run() {
                    this.f19031a.checkForPreloadError();
                }
            }, 100L);
        } catch (IOException e) {
    ...
    public void clear() {
        Util.postOrRun(this.preloadHandler, new Runnable() { // from class: hm4
            @Override // java.lang.Runnable
            public final void run() {
                this.f17994a.lambda$clear$1();
            }
        });
    }
    ...
    public void onChildSourceInfoRefreshed(final Timeline timeline) {
        ...
        this.preloadHandler.post(new Runnable() { // from class: im4
            @Override // java.lang.Runnable
            public final void run() {
                this.f18202a.lambda$onChildSourceInfoRefreshed$2(timeline);
            }
        });
    }

    public void preload(final long j) {
        this.preloadHandler.post(new Runnable() { // from class: jm4
            @Override // java.lang.Runnable
            public final void run() {
                this.f18436a.lambda$preload$0(j);
            }
        });
    }
    ...
    public void releasePreloadMediaSource() {
        this.releaseHandler.post(new Runnable() { // from class: km4
            @Override // java.lang.Runnable
            public final void run() {
                this.f18724a.lambda$releasePreloadMediaSource$3();
            }
        });
    }
