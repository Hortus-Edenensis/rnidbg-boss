...
public class DefaultTrackSelector extends MappingTrackSelector implements RendererCapabilities.Listener {
    ...
    private static final q94<Integer> FORMAT_VALUE_ORDERING = q94.b(new Comparator() { // from class: s91
    ...
    public static final class AudioTrackInfo extends TrackInfo<AudioTrackInfo> implements Comparable<AudioTrackInfo> {
        ...
        public AudioTrackInfo(int i, TrackGroup trackGroup, int i2, Parameters parameters, int i3, boolean z, em4<Format> em4Var, int i4) {
            int i5;
            ...
            this.isWithinRendererCapabilities = sv4.n(i3, false);
            int i7 = 0;
            while (true) {
            ...
            this.bitrate = i10;
            this.isWithinConstraints = (i10 == -1 || i10 <= parameters.maxAudioBitrate) && (i9 == -1 || i9 <= parameters.maxAudioChannelCount) && em4Var.apply(format2);
            ...
            this.usesPrimaryDecoder = sv4.j(i3) == 128;
            this.usesHardwareAcceleration = sv4.l(i3) == 64;
        ...
        public static ImmutableList<AudioTrackInfo> createForTrackGroup(int i, TrackGroup trackGroup, Parameters parameters, int[] iArr, boolean z, em4<Format> em4Var, int i2) {
            ImmutableList.a aVarBuilder = ImmutableList.builder();
            for (int i3 = 0; i3 < trackGroup.length; i3++) {
                aVarBuilder.a(new AudioTrackInfo(i, trackGroup, i3, parameters, iArr[i3], z, em4Var, i2));
            }
            return aVarBuilder.e();
        }

        private int evaluateSelectionEligibility(int i, boolean z, int i2) {
            if (!sv4.n(i, this.parameters.exceedRendererCapabilitiesIfNecessary)) {
                return 0;
            }
            ...
            if (sv4.n(i, false) && this.isWithinConstraints && this.format.bitrate != -1) {
        ...
        public int compareTo(AudioTrackInfo audioTrackInfo) {
            ...
            hj0 hj0VarG = hj0.k().h(this.isWithinRendererCapabilities, audioTrackInfo.isWithinRendererCapabilities).g(Integer.valueOf(this.preferredLanguageIndex), Integer.valueOf(audioTrackInfo.preferredLanguageIndex), q94.o().s()).d(this.preferredLanguageScore, audioTrackInfo.preferredLanguageScore).d(this.preferredRoleFlagsScore, audioTrackInfo.preferredRoleFlagsScore).h(this.isDefaultSelectionFlag, audioTrackInfo.isDefaultSelectionFlag).h(this.hasMainOrNoRoleFlag, audioTrackInfo.hasMainOrNoRoleFlag).g(Integer.valueOf(this.localeLanguageMatchIndex), Integer.valueOf(audioTrackInfo.localeLanguageMatchIndex), q94.o().s()).d(this.localeLanguageScore, audioTrackInfo.localeLanguageScore).h(this.isWithinConstraints, audioTrackInfo.isWithinConstraints).g(Integer.valueOf(this.preferredMimeTypeMatchIndex), Integer.valueOf(audioTrackInfo.preferredMimeTypeMatchIndex), q94.o().s());
            if (this.parameters.forceLowestBitrate) {
                hj0VarG = hj0VarG.g(Integer.valueOf(this.bitrate), Integer.valueOf(audioTrackInfo.bitrate), DefaultTrackSelector.FORMAT_VALUE_ORDERING.s());
            }
            hj0 hj0VarG2 = hj0VarG.h(this.usesPrimaryDecoder, audioTrackInfo.usesPrimaryDecoder).h(this.usesHardwareAcceleration, audioTrackInfo.usesHardwareAcceleration).h(this.isObjectBasedAudio, audioTrackInfo.isObjectBasedAudio).g(Integer.valueOf(this.channelCount), Integer.valueOf(audioTrackInfo.channelCount), q94VarS).g(Integer.valueOf(this.sampleRate), Integer.valueOf(audioTrackInfo.sampleRate), q94VarS);
            if (Objects.equals(this.language, audioTrackInfo.language)) {
                hj0VarG2 = hj0VarG2.g(Integer.valueOf(this.bitrate), Integer.valueOf(audioTrackInfo.bitrate), q94VarS);
            }
            return hj0VarG2.j();
        }
    ...
    public static final class ImageTrackInfo extends TrackInfo<ImageTrackInfo> implements Comparable<ImageTrackInfo> {
        ...
        public ImageTrackInfo(int i, TrackGroup trackGroup, int i2, Parameters parameters, int i3) {
            super(i, trackGroup, i2);
            this.selectionEligibility = sv4.n(i3, parameters.exceedRendererCapabilitiesIfNecessary) ? 1 : 0;
        ...
        public static ImmutableList<ImageTrackInfo> createForTrackGroup(int i, TrackGroup trackGroup, Parameters parameters, int[] iArr) {
            ...
            for (int i2 = 0; i2 < trackGroup.length; i2++) {
                aVarBuilder.a(new ImageTrackInfo(i, trackGroup, i2, parameters, iArr[i2]));
            }
            return aVarBuilder.e();
        }
    ...
    public static final class OtherTrackScore implements Comparable<OtherTrackScore> {
        ...
        public OtherTrackScore(Format format, int i) {
            ...
            this.isWithinRendererCapabilities = sv4.n(i, false);
        }
    ...
    public static final class Parameters extends TrackSelectionParameters {
        ...
        public static final class Builder extends TrackSelectionParameters.Builder {
            ...
            private void setSelectionOverridesFromBundle(Bundle bundle) {
                ...
                ImmutableList immutableListOf = parcelableArrayList == null ? ImmutableList.of() : BundleCollectionUtil.fromBundleList(new u42() { // from class: x91
                ...
                SparseArray sparseArray = sparseParcelableArray == null ? new SparseArray() : BundleCollectionUtil.fromBundleSparseArray(new u42() { // from class: y91
                    @Override // defpackage.u42
                    public final Object apply(Object obj) {
        ...
        private static void putSelectionOverridesToBundle(Bundle bundle, SparseArray<Map<TrackGroupArray, SelectionOverride>> sparseArray) {
            ...
            for (int i = 0; i < sparseArray.size(); i++) {
                ...
                bundle.putIntArray(FIELD_SELECTION_OVERRIDES_RENDERER_INDICES, ku2.p(arrayList));
                bundle.putParcelableArrayList(FIELD_SELECTION_OVERRIDES_TRACK_GROUP_ARRAYS, BundleCollectionUtil.toBundleArrayList(arrayList2, new u42() { // from class: v91
                    @Override // defpackage.u42
                    public final Object apply(Object obj) {
                        return ((TrackGroupArray) obj).toBundle();
                    }
                }));
                bundle.putSparseParcelableArray(FIELD_SELECTION_OVERRIDES, BundleCollectionUtil.toBundleSparseArray(sparseArray2, new u42() { // from class: w91
                    @Override // defpackage.u42
                    public final Object apply(Object obj) {
    ...
    public static class SpatializerWrapperV32 {
        ...
        public SpatializerWrapperV32(@Nullable Context context, final DefaultTrackSelector defaultTrackSelector, @Nullable Boolean bool) {
            ...
            spatializer.addOnSpatializerStateChangedListener(new bl0(handler), onSpatializerStateChangedListener);
        }
        ...
        public boolean canBeSpatialized(AudioAttributes audioAttributes, Format format) {
            ...
            return aa1.a(Assertions.checkNotNull(this.spatializer)).canBeSpatialized(audioAttributes.getAudioAttributesV21().audioAttributes, channelMask.build());
        }

        public boolean isAvailable() {
            return aa1.a(Assertions.checkNotNull(this.spatializer)).isAvailable();
        }

        public boolean isEnabled() {
            return aa1.a(Assertions.checkNotNull(this.spatializer)).isEnabled();
        }
    ...
    public static final class TextTrackInfo extends TrackInfo<TextTrackInfo> implements Comparable<TextTrackInfo> {
        ...
        public TextTrackInfo(int i, TrackGroup trackGroup, int i2, Parameters parameters, int i3, @Nullable String str, @Nullable String str2) {
            ...
            ImmutableList<String> immutableListOf = str2 != null ? ImmutableList.of(str2) : parameters.preferredTextLanguages.isEmpty() ? ImmutableList.of("") : parameters.preferredTextLanguages;
            int i6 = 0;
            while (true) {
            ...
            if (sv4.n(i3, parameters.exceedRendererCapabilitiesIfNecessary) && z) {
                i4 = 1;
            }
        ...
        public static ImmutableList<TextTrackInfo> createForTrackGroup(int i, TrackGroup trackGroup, Parameters parameters, int[] iArr, @Nullable String str, @Nullable String str2) {
            ImmutableList.a aVarBuilder = ImmutableList.builder();
            for (int i2 = 0; i2 < trackGroup.length; i2++) {
                aVarBuilder.a(new TextTrackInfo(i, trackGroup, i2, parameters, iArr[i2], str, str2));
            }
            return aVarBuilder.e();
        }
        ...
        public int compareTo(TextTrackInfo textTrackInfo) {
            hj0 hj0VarD = hj0.k().h(this.isWithinRendererCapabilities, textTrackInfo.isWithinRendererCapabilities).g(Integer.valueOf(this.preferredLanguageIndex), Integer.valueOf(textTrackInfo.preferredLanguageIndex), q94.o().s()).d(this.preferredLanguageScore, textTrackInfo.preferredLanguageScore).d(this.preferredRoleFlagsScore, textTrackInfo.preferredRoleFlagsScore).h(this.isDefault, textTrackInfo.isDefault).g(Boolean.valueOf(this.isForced), Boolean.valueOf(textTrackInfo.isForced), this.preferredLanguageScore == 0 ? q94.o() : q94.o().s()).d(this.selectedAudioLanguageScore, textTrackInfo.selectedAudioLanguageScore);
            if (this.preferredRoleFlagsScore == 0) {
                hj0VarD = hj0VarD.i(this.hasCaptionRoleFlags, textTrackInfo.hasCaptionRoleFlags);
            }
            return hj0VarD.j();
        }
    }
    ...
    public static final class VideoTrackInfo extends TrackInfo<VideoTrackInfo> {
        ...
        */
        public VideoTrackInfo(int i, TrackGroup trackGroup, int i2, Parameters parameters, int i3, @Nullable String str, int i4, boolean z) {
            ...
            while (true) {
                ...
                if (i13 >= parameters.preferredVideoLanguages.size()) {
                    ...
                    formatLanguageScore = DefaultTrackSelector.getFormatLanguageScore(this.format, parameters.preferredVideoLanguages.get(i13), false);
                    if (formatLanguageScore > 0) {
                        break;
                    } else {
                        i13++;
            ...
            int i15 = 0;
            while (true) {
                if (i15 < parameters.preferredVideoMimeTypes.size()) {
        ...
        public static int compareNonQualityPreferences(VideoTrackInfo videoTrackInfo, VideoTrackInfo videoTrackInfo2) {
            hj0 hj0VarH = hj0.k().h(videoTrackInfo.isWithinRendererCapabilities, videoTrackInfo2.isWithinRendererCapabilities).g(Integer.valueOf(videoTrackInfo.preferredLanguageIndex), Integer.valueOf(videoTrackInfo2.preferredLanguageIndex), q94.o().s()).d(videoTrackInfo.preferredLanguageScore, videoTrackInfo2.preferredLanguageScore).d(videoTrackInfo.preferredRoleFlagsScore, videoTrackInfo2.preferredRoleFlagsScore).h(videoTrackInfo.hasMainOrNoRoleFlag, videoTrackInfo2.hasMainOrNoRoleFlag).d(videoTrackInfo.selectedAudioLanguageScore, videoTrackInfo2.selectedAudioLanguageScore).h(videoTrackInfo.hasReasonableFrameRate, videoTrackInfo2.hasReasonableFrameRate).h(videoTrackInfo.isWithinMaxConstraints, videoTrackInfo2.isWithinMaxConstraints).h(videoTrackInfo.isWithinMinConstraints, videoTrackInfo2.isWithinMinConstraints).g(Integer.valueOf(videoTrackInfo.preferredMimeTypeMatchIndex), Integer.valueOf(videoTrackInfo2.preferredMimeTypeMatchIndex), q94.o().s()).h(videoTrackInfo.usesPrimaryDecoder, videoTrackInfo2.usesPrimaryDecoder).h(videoTrackInfo.usesHardwareAcceleration, videoTrackInfo2.usesHardwareAcceleration);
            if (videoTrackInfo.usesPrimaryDecoder && videoTrackInfo.usesHardwareAcceleration) {
                hj0VarH = hj0VarH.d(videoTrackInfo.codecPreferenceScore, videoTrackInfo2.codecPreferenceScore);
            }
            return hj0VarH.j();
        }
        ...
        public static int compareQualityPreferences(VideoTrackInfo videoTrackInfo, VideoTrackInfo videoTrackInfo2) {
            q94 q94VarS = (videoTrackInfo.isWithinMaxConstraints && videoTrackInfo.isWithinRendererCapabilities) ? DefaultTrackSelector.FORMAT_VALUE_ORDERING : DefaultTrackSelector.FORMAT_VALUE_ORDERING.s();
            hj0 hj0VarK = hj0.k();
            if (videoTrackInfo.parameters.forceLowestBitrate) {
                hj0VarK = hj0VarK.g(Integer.valueOf(videoTrackInfo.bitrate), Integer.valueOf(videoTrackInfo2.bitrate), DefaultTrackSelector.FORMAT_VALUE_ORDERING.s());
            }
            return hj0VarK.g(Integer.valueOf(videoTrackInfo.pixelCount), Integer.valueOf(videoTrackInfo2.pixelCount), q94VarS).g(Integer.valueOf(videoTrackInfo.bitrate), Integer.valueOf(videoTrackInfo2.bitrate), q94VarS).j();
        }

        public static int compareSelections(List<VideoTrackInfo> list, List<VideoTrackInfo> list2) {
            return hj0.k().g((VideoTrackInfo) Collections.max(list, new Comparator() { // from class: androidx.media3.exoplayer.trackselection.e
                @Override // java.util.Comparator
                public final int compare(Object obj, Object obj2) {
            ...
            }).d(list.size(), list2.size()).g((VideoTrackInfo) Collections.max(list, new Comparator() { // from class: androidx.media3.exoplayer.trackselection.f
                @Override // java.util.Comparator
                public final int compare(Object obj, Object obj2) {
        ...
        public static ImmutableList<VideoTrackInfo> createForTrackGroup(int i, TrackGroup trackGroup, Parameters parameters, int[] iArr, @Nullable String str, int i2, @Nullable Point point) {
            ...
            for (int i3 = 0; i3 < trackGroup.length; i3++) {
                ...
                aVarBuilder.a(new VideoTrackInfo(i, trackGroup, i3, parameters, iArr[i3], str, i2, maxVideoPixelsToRetainForViewport == Integer.MAX_VALUE || (pixelCount != -1 && pixelCount <= maxVideoPixelsToRetainForViewport)));
            }
            return aVarBuilder.e();
        }

        private int evaluateSelectionEligibility(int i, int i2) {
            if ((this.format.roleFlags & 16384) != 0 || !sv4.n(i, this.parameters.exceedRendererCapabilitiesIfNecessary)) {
                return 0;
            }
            if (!this.isWithinMaxConstraints && !this.parameters.exceedVideoConstraintsIfNecessary) {
                return 0;
            }
            if (sv4.n(i, false) && this.isWithinMinConstraints && this.isWithinMaxConstraints && this.format.bitrate != -1) {
                Parameters parameters = this.parameters;
    ...
    private static void applyTrackSelectionOverrides(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, TrackSelectionParameters trackSelectionParameters, ExoTrackSelection.Definition[] definitionArr) {
        ...
        for (int i2 = 0; i2 < rendererCount; i2++) {
            ...
            if (trackSelectionOverride != null) {
                definitionArr[i2] = (trackSelectionOverride.trackIndices.isEmpty() || mappedTrackInfo.getTrackGroups(i2).indexOf(trackSelectionOverride.mediaTrackGroup) == -1) ? null : new ExoTrackSelection.Definition(trackSelectionOverride.mediaTrackGroup, ku2.p(trackSelectionOverride.trackIndices));
            }
        }
    }
    ...
    public /* synthetic */ List lambda$selectAudioTrack$3(final Parameters parameters, boolean z, int[] iArr, int i, TrackGroup trackGroup, int[] iArr2) {
        return AudioTrackInfo.createForTrackGroup(i, trackGroup, parameters, iArr2, z, new em4() { // from class: i91
            @Override // defpackage.em4
            public final boolean apply(Object obj) {
                return this.f18127a.lambda$selectAudioTrack$2(parameters, (Format) obj);
            }
        }, iArr[i]);
    }
    ...
    public static boolean rendererSupportsOffload(Parameters parameters, int i, Format format) {
        ...
        if (parameters.audioOffloadPreferences.isSpeedChangeSupportRequired && (sv4.i(i) & 2048) == 0) {
            return false;
        }
        if (parameters.audioOffloadPreferences.isGaplessSupportRequired) {
            return !(format.encoderDelay != 0 || format.encoderPadding != 0) || ((sv4.i(i) & 1024) != 0);
        }
        return true;
    }
    ...
    private static boolean rendererSupportsTunneling(int[][] iArr, TrackGroupArray trackGroupArray, ExoTrackSelection exoTrackSelection) {
        ...
        for (int i = 0; i < exoTrackSelection.length(); i++) {
            if (sv4.m(iArr[iIndexOf][exoTrackSelection.getIndexInTrackGroup(i)]) != 32) {
                return false;
            }
        }
        return true;
    ...
    public Pair<ExoTrackSelection.Definition, Integer> selectAudioTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, final int[] iArr2, final Parameters parameters) throws ExoPlaybackException {
        ...
        return selectTracksForType(1, mappedTrackInfo, iArr, new TrackInfo.Factory() { // from class: e91
            @Override // androidx.media3.exoplayer.trackselection.DefaultTrackSelector.TrackInfo.Factory
            public final List create(int i2, TrackGroup trackGroup, int[] iArr3) {
                return this.f17237a.lambda$selectAudioTrack$3(parameters, z, iArr2, i2, trackGroup, iArr3);
            }
    ...
    public Pair<ExoTrackSelection.Definition, Integer> selectImageTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, final Parameters parameters) throws ExoPlaybackException {
        ...
        return selectTracksForType(4, mappedTrackInfo, iArr, new TrackInfo.Factory() { // from class: q91
            @Override // androidx.media3.exoplayer.trackselection.DefaultTrackSelector.TrackInfo.Factory
    ...
    public ExoTrackSelection.Definition selectOtherTrack(int i, TrackGroupArray trackGroupArray, int[][] iArr, Parameters parameters) throws ExoPlaybackException {
        ...
        for (int i3 = 0; i3 < trackGroupArray.length; i3++) {
            ...
            for (int i4 = 0; i4 < trackGroup2.length; i4++) {
                if (sv4.n(iArr2[i4], parameters.exceedRendererCapabilitiesIfNecessary)) {
    ...
    public Pair<ExoTrackSelection.Definition, Integer> selectTextTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, final Parameters parameters, @Nullable final String str) throws ExoPlaybackException {
        ...
        return selectTracksForType(3, mappedTrackInfo, iArr, new TrackInfo.Factory() { // from class: n91
            @Override // androidx.media3.exoplayer.trackselection.DefaultTrackSelector.TrackInfo.Factory
            public final List create(int i, TrackGroup trackGroup, int[] iArr2) {
                return DefaultTrackSelector.lambda$selectTextTrack$4(parameters, str, preferredLanguageFromCaptioningManager, i, trackGroup, iArr2);
            }
    ...
    public Pair<ExoTrackSelection.Definition, Integer> selectVideoTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, final int[] iArr2, final Parameters parameters, @Nullable final String str) throws ExoPlaybackException {
        ...
        return selectTracksForType(2, mappedTrackInfo, iArr, new TrackInfo.Factory() { // from class: k91
            @Override // androidx.media3.exoplayer.trackselection.DefaultTrackSelector.TrackInfo.Factory
