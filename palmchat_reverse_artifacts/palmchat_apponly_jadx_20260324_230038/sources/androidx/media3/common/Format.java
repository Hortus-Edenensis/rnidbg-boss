...
public final class Format {
    ...
    public static Format fromBundle(Bundle bundle) {
        ...
        builder.setLabels(parcelableArrayList == null ? ImmutableList.of() : BundleCollectionUtil.fromBundleList(new u42() { // from class: b12
    ...
    public static String toLogString(@Nullable Format format) {
        ...
        if (!ue1.a(format.pixelWidthHeightRatio, 1.0d, 0.001d)) {
            sb.append(", par=");
        ...
        if (!format.labels.isEmpty()) {
            sb.append(", labels=[");
            qy2VarG.b(sb, d43.n(format.labels, new u42() { // from class: c12
                @Override // defpackage.u42
                public final Object apply(Object obj) {
        ...
        if (format.selectionFlags != 0) {
            ...
            qy2VarG.b(sb, Util.getSelectionFlagStrings(format.selectionFlags));
            sb.append("]");
        }
        if (format.roleFlags != 0) {
            sb.append(", roleFlags=[");
            qy2VarG.b(sb, Util.getRoleFlagStrings(format.roleFlags));
            sb.append("]");
        }
    ...
    public Bundle toBundle() {
        ...
        bundle.putParcelableArrayList(FIELD_LABELS, BundleCollectionUtil.toBundleArrayList(this.labels, new u42() { // from class: d12
            @Override // defpackage.u42
            public final Object apply(Object obj) {
