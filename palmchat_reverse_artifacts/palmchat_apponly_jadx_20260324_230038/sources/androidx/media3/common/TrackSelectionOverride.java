...
public final class TrackSelectionOverride {
    ...
    public static TrackSelectionOverride fromBundle(Bundle bundle) {
        return new TrackSelectionOverride(TrackGroup.fromBundle((Bundle) Assertions.checkNotNull(bundle.getBundle(FIELD_TRACK_GROUP))), ku2.c((int[]) Assertions.checkNotNull(bundle.getIntArray(FIELD_TRACKS))));
    }
    ...
    public Bundle toBundle() {
        ...
        bundle.putIntArray(FIELD_TRACKS, ku2.p(this.trackIndices));
        return bundle;
    }
