...
final class Sonic {
    ...
    private int insertPitchPeriod(short[] sArr, int i, double d, int i2) {
        ...
        this.outputBuffer = sArrEnsureSpaceForAdditionalFrames;
        int i4 = this.channelCount;
        System.arraycopy(sArr, i * i4, sArrEnsureSpaceForAdditionalFrames, this.outputFrameCount * i4, i4 * i2);
        overlapAdd(iRound, this.channelCount, this.outputBuffer, this.outputFrameCount + i2, sArr, i + i2, sArr, i);
