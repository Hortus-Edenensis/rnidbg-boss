...
public class TrackSelectionParameters {
    ...
    public Bundle toBundle() {
        ...
        bundle.putParcelableArrayList(FIELD_SELECTION_OVERRIDES, BundleCollectionUtil.toBundleArrayList(this.overrides.values(), new u42() { // from class: i06
            @Override // defpackage.u42
            public final Object apply(Object obj) {
                return ((TrackSelectionOverride) obj).toBundle();
            }
        }));
        bundle.putIntArray(FIELD_DISABLED_TRACK_TYPE, ku2.p(this.disabledTrackTypes));
        return bundle;
    }
    ...
    public static class Builder {
        ...
        public Builder(Bundle bundle) {
            ...
            this.preferredVideoMimeTypes = ImmutableList.copyOf((String[]) fr3.a(bundle.getStringArray(TrackSelectionParameters.FIELD_PREFERRED_VIDEO_MIMETYPES), new String[0]));
            this.preferredVideoLanguages = ImmutableList.copyOf((String[]) fr3.a(bundle.getStringArray(TrackSelectionParameters.FIELD_PREFERRED_VIDEO_LANGUAGES), new String[0]));
            ...
            this.preferredAudioLanguages = normalizeLanguageCodes((String[]) fr3.a(bundle.getStringArray(TrackSelectionParameters.FIELD_PREFERRED_AUDIO_LANGUAGES), new String[0]));
            ...
            this.preferredAudioMimeTypes = ImmutableList.copyOf((String[]) fr3.a(bundle.getStringArray(TrackSelectionParameters.FIELD_PREFERRED_AUDIO_MIME_TYPES), new String[0]));
            this.audioOffloadPreferences = getAudioOffloadPreferencesFromBundle(bundle);
            this.preferredTextLanguages = normalizeLanguageCodes((String[]) fr3.a(bundle.getStringArray(TrackSelectionParameters.FIELD_PREFERRED_TEXT_LANGUAGES), new String[0]));
            ...
            if (parcelableArrayList == null) {
                ...
                immutableListFromBundleList = BundleCollectionUtil.fromBundleList(new u42() { // from class: j06
                    @Override // defpackage.u42
                    public final Object apply(Object obj) {
            ...
            int[] iArr = (int[]) fr3.a(bundle.getIntArray(TrackSelectionParameters.FIELD_DISABLED_TRACK_TYPE), new int[0]);
            this.disabledTrackTypes = new HashSet<>();
            for (int i3 : iArr) {
