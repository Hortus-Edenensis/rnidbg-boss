...
public final class MediaItem {
    ...
    public static final class LocalConfiguration {
        ...
        public static LocalConfiguration fromBundle(Bundle bundle) {
            ...
            ImmutableList immutableListOf = parcelableArrayList == null ? ImmutableList.of() : BundleCollectionUtil.fromBundleList(new u42() { // from class: gh3
        ...
        public Bundle toBundle() {
            ...
            if (!this.streamKeys.isEmpty()) {
                bundle.putParcelableArrayList(FIELD_STREAM_KEYS, BundleCollectionUtil.toBundleArrayList(this.streamKeys, new u42() { // from class: dh3
                    @Override // defpackage.u42
                    public final Object apply(Object obj) {
            ...
            if (!this.subtitleConfigurations.isEmpty()) {
                bundle.putParcelableArrayList(FIELD_SUBTITLE_CONFIGURATION, BundleCollectionUtil.toBundleArrayList(this.subtitleConfigurations, new u42() { // from class: fh3
                    @Override // defpackage.u42
                    public final Object apply(Object obj) {
        ...
        private LocalConfiguration(Uri uri, @Nullable String str, @Nullable DrmConfiguration drmConfiguration, @Nullable AdsConfiguration adsConfiguration, List<StreamKey> list, @Nullable String str2, ImmutableList<SubtitleConfiguration> immutableList, @Nullable Object obj, long j) {
            ...
            for (int i = 0; i < immutableList.size(); i++) {
                aVarBuilder.a(immutableList.get(i).buildUpon().buildSubtitle());
            }
            this.subtitles = aVarBuilder.e();
            this.tag = obj;
            this.imageDurationMs = j;
        }
    }
