...
public abstract class Timeline {
    ...
    public static Timeline fromBundle(Bundle bundle) {
        ImmutableList immutableListFromBundleListRetriever = fromBundleListRetriever(new u42() { // from class: fy5
            @Override // defpackage.u42
            public final Object apply(Object obj) {
                return Timeline.Window.fromBundle((Bundle) obj);
            }
        }, bundle.getBinder(FIELD_WINDOWS));
        ImmutableList immutableListFromBundleListRetriever2 = fromBundleListRetriever(new u42() { // from class: gy5
            @Override // defpackage.u42
            public final Object apply(Object obj) {
    ...
    private static <T> ImmutableList<T> fromBundleListRetriever(u42<Bundle, T> u42Var, @Nullable IBinder iBinder) {
        return iBinder == null ? ImmutableList.of() : BundleCollectionUtil.fromBundleList(u42Var, BundleListRetriever.getList(iBinder));
    }
    ...
    public final Timeline copyWithSingleWindow(int i) {
        ...
        while (true) {
            ...
            if (i2 > i3) {
                ...
                return new RemotableTimeline(ImmutableList.of(window), aVarBuilder.e(), new int[]{0});
            }
