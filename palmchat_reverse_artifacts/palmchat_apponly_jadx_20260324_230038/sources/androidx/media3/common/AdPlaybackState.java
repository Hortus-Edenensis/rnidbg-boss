...
public final class AdPlaybackState {
    ...
    public static final class AdGroup {
        ...
        public AdGroup withAdState(int i, @IntRange(from = 0) int i2) {
            ...
            return new AdGroup(this.timeUs, this.count, this.originalCount, iArrCopyStatesWithSpaceForAdCount, mediaItemArr2, jArr, this.contentResumeOffsetUs, this.isServerSideInserted, strArr, this.isPlaceholder);
        }
    ...
    public int getAdGroupIndexAfterPositionUs(long j, long j2) {
        ...
        if (j2 == -9223372036854775807L || getAdGroup(i).timeUs <= j2) {
            return i;
        }
        return -1;
    }
