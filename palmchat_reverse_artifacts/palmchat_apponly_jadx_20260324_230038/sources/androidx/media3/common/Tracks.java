...
public final class Tracks {
    ...
    public static final class Group {
        ...
        public static Group fromBundle(Bundle bundle) {
            ...
            return new Group(trackGroupFromBundle, bundle.getBoolean(FIELD_ADAPTIVE_SUPPORTED, false), (int[]) fr3.a(bundle.getIntArray(FIELD_TRACK_SUPPORT), new int[trackGroupFromBundle.length]), (boolean[]) fr3.a(bundle.getBooleanArray(FIELD_TRACK_SELECTED), new boolean[trackGroupFromBundle.length]));
        }
        ...
        public boolean isSelected() {
            return ku.a(this.trackSelected, true);
        }
    ...
    public static Tracks fromBundle(Bundle bundle) {
        ...
        return new Tracks(parcelableArrayList == null ? ImmutableList.of() : BundleCollectionUtil.fromBundleList(new u42() { // from class: s06
    ...
    public Bundle toBundle() {
        Bundle bundle = new Bundle();
        bundle.putParcelableArrayList(FIELD_TRACK_GROUPS, BundleCollectionUtil.toBundleArrayList(this.groups, new u42() { // from class: r06
            @Override // defpackage.u42
            public final Object apply(Object obj) {
