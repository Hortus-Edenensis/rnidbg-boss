...
public final class NetworkTypeObserver {
    ...
    public final class ListenerHolder {
        ...
        public void callOnNetworkTypeChanged() {
            this.executor.execute(new Runnable() { // from class: androidx.media3.common.util.a
                @Override // java.lang.Runnable
                public final void run() {
                    this.f1298a.lambda$callOnNetworkTypeChanged$0();
                }
            });
        }
    ...
    public final class Receiver extends BroadcastReceiver {
        ...
        public void onReceive(final Context context, Intent intent) {
            NetworkTypeObserver.this.backgroundExecutor.execute(new Runnable() { // from class: androidx.media3.common.util.b
                @Override // java.lang.Runnable
                public final void run() {
                    this.f1299a.lambda$onReceive$0(context);
                }
            });
        }
    }
    ...
    private NetworkTypeObserver(final Context context) {
        ...
        this.networkType = 0;
        executor.execute(new Runnable() { // from class: vw3
            @Override // java.lang.Runnable
            public final void run() {
                this.f21546a.lambda$new$0(context);
            }
        });
    }
    ...
    public void register(Listener listener) {
        register(listener, new bl0(new Handler(Looper.getMainLooper())));
    }
