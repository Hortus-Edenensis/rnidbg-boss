...
public final class UriCompat {
    ...
    public static String toSafeString(@NonNull Uri uri) {
        ...
        if (scheme != null) {
            ...
            if (scheme.equalsIgnoreCase(HttpHost.DEFAULT_SCHEME_NAME) || scheme.equalsIgnoreCase(BaseConstants.SCHEME_HTTPS) || scheme.equalsIgnoreCase(OapsKey.KEY_FILE_TYPE) || scheme.equalsIgnoreCase("rtsp")) {
