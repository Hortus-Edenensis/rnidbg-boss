...
public final class NotificationManagerCompat {
    ...
    public void deleteUnlistedNotificationChannels(@NonNull Collection<String> collection) {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it.hasNext()) {
                ...
                if (!collection.contains(notificationChannelA.getId()) && (Build.VERSION.SDK_INT < 30 || !collection.contains(notificationChannelA.getParentChannelId()))) {
                    this.mNotificationManager.deleteNotificationChannel(notificationChannelA.getId());
                }
            }
        }
    }
    ...
    public NotificationChannelGroup getNotificationChannelGroup(@NonNull String str) {
        ...
        if (i >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannelGroup notificationChannelGroupA = j34.a(it.next());
                if (notificationChannelGroupA.getId().equals(str)) {
    ...
    public List<NotificationChannelCompat> getNotificationChannelsCompat() {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannels.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(new NotificationChannelCompat(i04.a(it.next())));
                }
                return arrayList;
            }
        }
