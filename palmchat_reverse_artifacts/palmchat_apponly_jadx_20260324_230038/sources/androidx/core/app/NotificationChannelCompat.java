...
public class NotificationChannelCompat {
    ...
    public NotificationChannel getNotificationChannel() {
        ...
        tz3.a();
        NotificationChannel notificationChannelA = sz3.a(this.mId, this.mName, this.mImportance);
        notificationChannelA.setDescription(this.mDescription);
        notificationChannelA.setGroup(this.mGroupId);
        notificationChannelA.setShowBadge(this.mShowBadge);
        notificationChannelA.setSound(this.mSound, this.mAudioAttributes);
        notificationChannelA.enableLights(this.mLights);
        notificationChannelA.setLightColor(this.mLightColor);
        notificationChannelA.setVibrationPattern(this.mVibrationPattern);
        notificationChannelA.enableVibration(this.mVibrationEnabled);
