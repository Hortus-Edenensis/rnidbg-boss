...
public class NotificationChannelGroupCompat {
    ...
    private List<NotificationChannelCompat> getChannelsCompat(List<NotificationChannel> list) {
        ...
        while (it.hasNext()) {
            ...
            if (this.mId.equals(notificationChannelA.getGroup())) {
    ...
    public NotificationChannelGroup getNotificationChannelGroup() {
        ...
        k04.a();
        NotificationChannelGroup notificationChannelGroupA = j04.a(this.mId, this.mName);
        if (i >= 28) {
            notificationChannelGroupA.setDescription(this.mDescription);
        }
