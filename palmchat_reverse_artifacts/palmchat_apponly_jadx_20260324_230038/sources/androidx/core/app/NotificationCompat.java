...
public class NotificationCompat {
    ...
    public static class BigPictureStyle extends Style {
        ...
        private static IconCompat asIconCompat(@Nullable Parcelable parcelable) {
            ...
            if (Build.VERSION.SDK_INT >= 23 && b14.a(parcelable)) {
                return IconCompat.createFromIcon(c14.a(parcelable));
            }
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Context context, @NonNull Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it2.hasNext()) {
                    addPerson(Person.fromAndroidPerson(q04.a(it2.next())));
                }
            }
            int i = Build.VERSION.SDK_INT;
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            if (Build.VERSION.SDK_INT >= 24) {
                notificationBuilderWithBuilderAccessor.getBuilder().setStyle(i14.a());
            }
        }
    ...
    public static abstract class Style {
        ...
        private static Style constructCompatStyleByPlatformName(@Nullable String str) {
            ...
            if (i >= 24) {
                if (str.equals(w14.a().getName())) {
                    return new MessagingStyle();
                }
                if (str.equals(x14.a().getName())) {
                    return new DecoratedCustomViewStyle();
                }
            }
            return null;
    ...
    public static final class WearableExtender implements Extender {
        ...
        private static Notification.Action getActionFromActionCompat(Action action) {
            ...
            if (i >= 23) {
                IconCompat iconCompat = action.getIconCompat();
                b24.a();
                builder = a24.a(iconCompat == null ? null : iconCompat.toIcon(), action.getTitle(), action.getActionIntent());
            } else {
    ...
    public static List<Person> getPeople(@NonNull Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(Person.fromAndroidPerson(q04.a(it.next())));
                }
            }
        } else {
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (i >= 24) {
                if (i >= 28) {
                    q14.a();
                    messagingStyleA = p14.a(this.mUser.toAndroidPerson());
                } else {
                    q14.a();
                    messagingStyleA = o14.a(this.mUser.getName());
                }
                Iterator<Message> it = this.mMessages.iterator();
                while (it.hasNext()) {
                    messagingStyleA.addMessage(it.next().toAndroidMessage());
                }
                if (Build.VERSION.SDK_INT >= 26) {
                    Iterator<Message> it2 = this.mHistoricMessages.iterator();
                    while (it2.hasNext()) {
                        messagingStyleA.addHistoricMessage(it2.next().toAndroidMessage());
                    }
                }
        ...
        public static final class Message {
            ...
            public Notification.MessagingStyle.Message toAndroidMessage() {
                ...
                if (Build.VERSION.SDK_INT >= 28) {
                    u14.a();
                    messageA = t14.a(getText(), getTimestamp(), person != null ? person.toAndroidPerson() : null);
                } else {
                    u14.a();
                    messageA = s14.a(getText(), getTimestamp(), person != null ? person.getName() : null);
                }
                if (getDataMimeType() != null) {
                    messageA.setData(getDataMimeType(), getDataUri());
                }
                return messageA;
            }
