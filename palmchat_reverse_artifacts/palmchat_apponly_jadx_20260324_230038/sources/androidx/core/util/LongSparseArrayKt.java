...
public final class LongSparseArrayKt {
    ...
    public static final class C13041<T> implements Iterator<T>, KMappedMarker {
        final /* synthetic */ LongSparseArray $this_valueIterator;
        private int index;

        public C13041(LongSparseArray<T> longSparseArray) {
    ...
    public static final <T> void forEach(LongSparseArray<T> forEach, Function2<? super Long, ? super T, Unit> action) {
        ...
        for (int i = 0; i < size; i++) {
            action.mo5invoke(Long.valueOf(forEach.keyAt(i)), forEach.valueAt(i));
        }
    }
    ...
    public static final <T> Iterator<T> valueIterator(LongSparseArray<T> valueIterator) {
        ...
        return new C13041(valueIterator);
    }
}
