...
public final class SparseArrayKt {
    ...
    public static final class C13051<T> implements Iterator<T>, KMappedMarker {
        final /* synthetic */ SparseArray $this_valueIterator;
        private int index;

        public C13051(SparseArray<T> sparseArray) {
    ...
    public static final <T> void forEach(SparseArray<T> forEach, Function2<? super Integer, ? super T, Unit> action) {
        ...
        for (int i = 0; i < size; i++) {
            action.mo5invoke(Integer.valueOf(forEach.keyAt(i)), forEach.valueAt(i));
        }
    }
    ...
    public static final <T> Iterator<T> valueIterator(SparseArray<T> valueIterator) {
        ...
        return new C13051(valueIterator);
    }
}
