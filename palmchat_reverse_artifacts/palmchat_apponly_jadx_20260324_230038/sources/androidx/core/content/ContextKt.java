...
public final class ContextKt {
    ...
    public static final void withStyledAttributes(Context withStyledAttributes, AttributeSet attributeSet, int[] attrs, @AttrRes int i, @StyleRes int i2, Function1<? super TypedArray, Unit> block) {
    ...
    public static final void withStyledAttributes(Context withStyledAttributes, @StyleRes int i, int[] attrs, Function1<? super TypedArray, Unit> block) {
        Intrinsics.checkNotNullParameter(withStyledAttributes, "$this$withStyledAttributes");
        Intrinsics.checkNotNullParameter(attrs, "attrs");
        Intrinsics.checkNotNullParameter(block, "block");
