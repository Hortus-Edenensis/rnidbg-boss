...
public final class PackageManagerCompat {
    ...
    @NonNull
    public static r33<Integer> getUnusedAppRestrictionsStatus(@NonNull Context context) {
        ...
        resolvableFutureCreate.addListener(new Runnable() { // from class: androidx.core.content.a
