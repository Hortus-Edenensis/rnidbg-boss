...
public class ShortcutInfoCompat {
    ...
    public static List<ShortcutInfoCompat> fromShortcuts(@NonNull Context context, @NonNull List<ShortcutInfo> list) {
        ...
        while (it.hasNext()) {
            arrayList.add(new Builder(context, g85.a(it.next())).build());
        }
        return arrayList;
    }
    ...
    public ShortcutInfo toShortcutInfo() {
        d85.a();
        ShortcutInfo.Builder intents = c85.a(this.mContext, this.mId).setShortLabel(this.mLabel).setIntents(this.mIntents);
