...
public class ShortcutManagerCompat {
    ...
    public static boolean addDynamicShortcuts(@NonNull Context context, @NonNull List<ShortcutInfoCompat> list) {
        ...
        if (i >= 25) {
            ...
            if (!r95.a(context.getSystemService(g95.a())).addDynamicShortcuts(arrayList)) {
                return false;
            }
        }
    ...
    public static Intent createShortcutResultIntent(@NonNull Context context, @NonNull ShortcutInfoCompat shortcutInfoCompat) {
        Intent intentCreateShortcutResultIntent = Build.VERSION.SDK_INT >= 26 ? r95.a(context.getSystemService(g95.a())).createShortcutResultIntent(shortcutInfoCompat.toShortcutInfo()) : null;
    ...
    public static void disableShortcuts(@NonNull Context context, @NonNull List<String> list, @Nullable CharSequence charSequence) {
        if (Build.VERSION.SDK_INT >= 25) {
            r95.a(context.getSystemService(g95.a())).disableShortcuts(list, charSequence);
        }
    ...
    public static void enableShortcuts(@NonNull Context context, @NonNull List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            r95.a(context.getSystemService(g95.a())).enableShortcuts(arrayList);
        }
        getShortcutInfoSaverInstance(context).addShortcuts(listRemoveShortcutsExcludedFromSurface);
        Iterator<ShortcutInfoChangeListener> it2 = getShortcutInfoListeners(context).iterator();
        while (it2.hasNext()) {
    ...
    public static List<ShortcutInfoCompat> getDynamicShortcuts(@NonNull Context context) {
        ...
        List dynamicShortcuts = r95.a(context.getSystemService(g95.a())).getDynamicShortcuts();
        ArrayList arrayList = new ArrayList(dynamicShortcuts.size());
        Iterator it = dynamicShortcuts.iterator();
        while (it.hasNext()) {
            arrayList.add(new ShortcutInfoCompat.Builder(context, g85.a(it.next())).build());
        }
        return arrayList;
    }
    ...
    public static int getIconMaxHeight(@NonNull Context context) {
        ...
        return Build.VERSION.SDK_INT >= 25 ? r95.a(context.getSystemService(g95.a())).getIconMaxHeight() : getIconDimensionInternal(context, false);
    }

    public static int getIconMaxWidth(@NonNull Context context) {
        Preconditions.checkNotNull(context);
        return Build.VERSION.SDK_INT >= 25 ? r95.a(context.getSystemService(g95.a())).getIconMaxWidth() : getIconDimensionInternal(context, true);
    }

    public static int getMaxShortcutCountPerActivity(@NonNull Context context) {
        Preconditions.checkNotNull(context);
        if (Build.VERSION.SDK_INT >= 25) {
            return r95.a(context.getSystemService(g95.a())).getMaxShortcutCountPerActivity();
        }
        return 5;
    }
    ...
    public static List<ShortcutInfoCompat> getShortcuts(@NonNull Context context, int i) {
        ...
        if (i2 >= 30) {
            return ShortcutInfoCompat.fromShortcuts(context, r95.a(context.getSystemService(g95.a())).getShortcuts(i));
        }
        if (i2 < 25) {
            if ((i & 2) != 0) {
                try {
        ...
        ShortcutManager shortcutManagerA = r95.a(context.getSystemService(g95.a()));
        ArrayList arrayList = new ArrayList();
        if ((i & 1) != 0) {
            arrayList.addAll(shortcutManagerA.getManifestShortcuts());
        }
        if ((i & 2) != 0) {
            arrayList.addAll(shortcutManagerA.getDynamicShortcuts());
        }
        if ((i & 4) != 0) {
            arrayList.addAll(shortcutManagerA.getPinnedShortcuts());
        }
    ...
    public static boolean isRateLimitingActive(@NonNull Context context) {
        Preconditions.checkNotNull(context);
        return Build.VERSION.SDK_INT >= 25 ? r95.a(context.getSystemService(g95.a())).isRateLimitingActive() : getShortcuts(context, 3).size() == getMaxShortcutCountPerActivity(context);
    }

    public static boolean isRequestPinShortcutSupported(@NonNull Context context) {
        if (Build.VERSION.SDK_INT >= 26) {
            return r95.a(context.getSystemService(g95.a())).isRequestPinShortcutSupported();
        }
    ...
    public static boolean pushDynamicShortcut(@NonNull Context context, @NonNull ShortcutInfoCompat shortcutInfoCompat) {
        ...
        if (i >= 30) {
            r95.a(context.getSystemService(g95.a())).pushDynamicShortcut(shortcutInfoCompat.toShortcutInfo());
        } else if (i >= 25) {
            ShortcutManager shortcutManagerA = r95.a(context.getSystemService(g95.a()));
            ...
            if (dynamicShortcuts.size() >= maxShortcutCountPerActivity) {
                shortcutManagerA.removeDynamicShortcuts(Arrays.asList(Api25Impl.getShortcutInfoWithLowestRank(dynamicShortcuts)));
            }
            shortcutManagerA.addDynamicShortcuts(Arrays.asList(shortcutInfoCompat.toShortcutInfo()));
        }
    ...
    public static void removeAllDynamicShortcuts(@NonNull Context context) {
        if (Build.VERSION.SDK_INT >= 25) {
            r95.a(context.getSystemService(g95.a())).removeAllDynamicShortcuts();
        }
    ...
    public static void removeDynamicShortcuts(@NonNull Context context, @NonNull List<String> list) {
        if (Build.VERSION.SDK_INT >= 25) {
            r95.a(context.getSystemService(g95.a())).removeDynamicShortcuts(list);
        }
        getShortcutInfoSaverInstance(context).removeShortcuts(list);
        Iterator<ShortcutInfoChangeListener> it = getShortcutInfoListeners(context).iterator();
        while (it.hasNext()) {
    ...
    public static void removeLongLivedShortcuts(@NonNull Context context, @NonNull List<String> list) {
        ...
        r95.a(context.getSystemService(g95.a())).removeLongLivedShortcuts(list);
        getShortcutInfoSaverInstance(context).removeShortcuts(list);
        Iterator<ShortcutInfoChangeListener> it = getShortcutInfoListeners(context).iterator();
        while (it.hasNext()) {
            it.next().onShortcutRemoved(list);
    ...
    public static void reportShortcutUsed(@NonNull Context context, @NonNull String str) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            r95.a(context.getSystemService(g95.a())).reportShortcutUsed(str);
        }
        Iterator<ShortcutInfoChangeListener> it = getShortcutInfoListeners(context).iterator();
        while (it.hasNext()) {
    ...
    public static boolean requestPinShortcut(@NonNull Context context, @NonNull ShortcutInfoCompat shortcutInfoCompat, @Nullable final IntentSender intentSender) {
        ...
        if (i >= 26) {
            return r95.a(context.getSystemService(g95.a())).requestPinShortcut(shortcutInfoCompat.toShortcutInfo(), intentSender);
        }
    ...
    public static boolean setDynamicShortcuts(@NonNull Context context, @NonNull List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            if (!r95.a(context.getSystemService(g95.a())).setDynamicShortcuts(arrayList)) {
                return false;
            }
        }
        getShortcutInfoSaverInstance(context).removeAllShortcuts();
    ...
    public static boolean updateShortcuts(@NonNull Context context, @NonNull List<ShortcutInfoCompat> list) {
        ...
        if (i >= 25) {
            ...
            if (!r95.a(context.getSystemService(g95.a())).updateShortcuts(arrayList)) {
                return false;
            }
        }
        getShortcutInfoSaverInstance(context).addShortcuts(listRemoveShortcutsExcludedFromSurface);
