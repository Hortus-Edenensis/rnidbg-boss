...
class CamColor {
    ...
    @Nullable
    private static CamColor findCamByJ(@FloatRange(from = 0.0d, to = 360.0d) float f, @FloatRange(from = 0.0d, to = DoubleCompanionObject.POSITIVE_INFINITY, toInclusive = false) float f2, @FloatRange(from = 0.0d, to = RemoteConfig.FULL_RATE) float f3) {
        float f4 = 100.0f;
        float f5 = 1000.0f;
    ...
    @NonNull
    private static CamColor fromJch(@FloatRange(from = 0.0d, to = RemoteConfig.FULL_RATE) float f, @FloatRange(from = 0.0d, to = DoubleCompanionObject.POSITIVE_INFINITY, toInclusive = false) float f2, @FloatRange(from = 0.0d, to = 360.0d) float f3) {
        return fromJchInFrame(f, f2, f3, ViewingConditions.DEFAULT);
    }

    @NonNull
    private static CamColor fromJchInFrame(@FloatRange(from = 0.0d, to = RemoteConfig.FULL_RATE) float f, @FloatRange(from = 0.0d, to = DoubleCompanionObject.POSITIVE_INFINITY, toInclusive = false) float f2, @FloatRange(from = 0.0d, to = 360.0d) float f3, ViewingConditions viewingConditions) {
    ...
    public static int toColor(@FloatRange(from = 0.0d, to = 360.0d) float f, @FloatRange(from = 0.0d, to = DoubleCompanionObject.POSITIVE_INFINITY, toInclusive = false) float f2, @FloatRange(from = 0.0d, to = RemoteConfig.FULL_RATE) float f3) {
    ...
    @FloatRange(from = 0.0d, to = RemoteConfig.FULL_RATE)
    public float getJ() {
        return this.mJ;
    }
    ...
    @ColorInt
    public static int toColor(@FloatRange(from = 0.0d, to = 360.0d) float f, @FloatRange(from = 0.0d, to = DoubleCompanionObject.POSITIVE_INFINITY, toInclusive = false) float f2, @FloatRange(from = 0.0d, to = RemoteConfig.FULL_RATE) float f3, @NonNull ViewingConditions viewingConditions) {
