...
public final class ResourcesCompat {
    ...
    public static abstract class FontCallback {
        ...
        public final void callbackFailAsync(final int i, @Nullable Handler handler) {
            getHandler(handler).post(new Runnable() { // from class: lx4
                @Override // java.lang.Runnable
                public final void run() {
                    this.f19097a.lambda$callbackFailAsync$1(i);
                }
            });
        }
        ...
        public final void callbackSuccessAsync(@NonNull final Typeface typeface, @Nullable Handler handler) {
            getHandler(handler).post(new Runnable() { // from class: kx4
                @Override // java.lang.Runnable
                public final void run() {
                    this.f18849a.lambda$callbackSuccessAsync$0(typeface);
                }
            });
        }
