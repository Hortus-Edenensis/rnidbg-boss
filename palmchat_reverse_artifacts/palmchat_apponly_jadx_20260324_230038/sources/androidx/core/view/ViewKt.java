...
public final class ViewKt {
    ...
    public static final Sequence<View> getAllViews(View allViews) {
        ...
        return SequencesKt__SequenceBuilderKt.sequence(new ViewKt$allViews$1(allViews, null));
    }
    ...
    public static final Sequence<ViewParent> getAncestors(View ancestors) {
        ...
        return SequencesKt__SequencesKt.generateSequence(ancestors.getParent(), (Function1<? super ViewParent, ? extends ViewParent>) ((Function1<? super Object, ? extends Object>) ViewKt$ancestors$1.INSTANCE));
    }
    ...
    public static final void setPadding(View setPadding, @Px int i) {
    ...
    public static final void updatePadding(View updatePadding, @Px int i, @Px int i2, @Px int i3, @Px int i4) {
    ...
    @RequiresApi(17)
    public static final void updatePaddingRelative(View updatePaddingRelative, @Px int i, @Px int i2, @Px int i3, @Px int i4) {
