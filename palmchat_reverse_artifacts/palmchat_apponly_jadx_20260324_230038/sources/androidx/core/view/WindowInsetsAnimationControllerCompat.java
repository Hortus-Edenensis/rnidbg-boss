...
public final class WindowInsetsAnimationControllerCompat {
    ...
    public void setInsetsAndAlpha(@Nullable Insets insets, @FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) float f, @FloatRange(from = 0.0d, to = WeightedLatLng.DEFAULT_INTENSITY) float f2) {
