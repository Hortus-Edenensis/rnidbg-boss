...
public final class ContentInfoCompat {
    ...
    public static final class Api31Impl {
        ...
        public static Pair<ContentInfo, ContentInfo> partition(@NonNull ContentInfo contentInfo, @NonNull final Predicate<ClipData.Item> predicate) {
            ...
            if (clip.getItemCount() != 1) {
                ...
                Pair<ClipData, ClipData> pairPartition = ContentInfoCompat.partition(clip, (androidx.core.util.Predicate<ClipData.Item>) new androidx.core.util.Predicate() { // from class: po0
    ...
    public static final class Compat31Impl implements Compat {
        ...
        public Compat31Impl(@NonNull ContentInfo contentInfo) {
            this.mWrapped = oo0.a(Preconditions.checkNotNull(contentInfo));
        }
    ...
    public static final class CompatImpl implements Compat {
        ...
        public CompatImpl(BuilderCompatImpl builderCompatImpl) {
            ...
            this.mSource = Preconditions.checkArgumentInRange(builderCompatImpl.mSource, 0, 5, az.at);
    ...
    public static final class BuilderCompat31Impl implements BuilderCompat {
        ...
        public BuilderCompat31Impl(@NonNull ClipData clipData, int i) {
            this.mPlatformBuilder = wo0.a(clipData, i);
        }
        ...
        public BuilderCompat31Impl(@NonNull ContentInfoCompat contentInfoCompat) {
            yo0.a();
            this.mPlatformBuilder = xo0.a(contentInfoCompat.toContentInfo());
        }
    }
