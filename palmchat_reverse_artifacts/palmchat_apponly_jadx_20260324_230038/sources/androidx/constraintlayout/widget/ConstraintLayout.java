    ...
    public class Measurer implements BasicMeasure.Measurer {
        ...
        */
        public final void measure(ConstraintWidget constraintWidget, BasicMeasure.Measure measure) {
            ...
            if (i10 != 1) {
                if (i10 == 2) {
                    iMakeMeasureSpec = ViewGroup.getChildMeasureSpec(this.layoutWidthSpec, i9, -2);
                    constraintWidget.wrapMeasure[2] = -2;
                } else if (i10 == 3) {
                    iMakeMeasureSpec = ViewGroup.getChildMeasureSpec(this.layoutWidthSpec, i9 + constraintWidget.getHorizontalMargin(), -1);
                    ...
                    if (measure.useCurrentDimensions) {
                        boolean z7 = !(!z6 || iArr2[3] == 0 || iArr2[0] == constraintWidget.getWidth()) || (view instanceof Placeholder);
                        if (!z6 || z7) {
                ...
                if (i == 1) {
                    if (i != 2) {
                        if (i == 3) {
                            childMeasureSpec2 = ViewGroup.getChildMeasureSpec(this.layoutHeightSpec, i8 + constraintWidget.getVerticalMargin(), -1);
                            ...
                            if (i != 4) {
                                ...
                                z3 = !z8 && constraintWidget.mDimensionRatio > 0.0f;
                                z4 = !z9 && constraintWidget.mDimensionRatio > 0.0f;
                                LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
                                if (measure.useCurrentDimensions && z8 && constraintWidget.mMatchConstraintDefaultWidth == 0 && z9 && constraintWidget.mMatchConstraintDefaultHeight == 0) {
                                    measuredWidth2 = 0;
                                    measuredHeight2 = 0;
                                    baseline = 0;
                                    i5 = -1;
                                    ...
                                    iMax2 = i12 <= 0 ? Math.max(i12, measuredHeight) : measuredHeight;
                                ...
                                z5 = !layoutParams.needsBaseline ? true : z12;
                            ...
                            boolean z13 = constraintWidget.mMatchConstraintDefaultHeight == 1;
                            int[] iArr7 = constraintWidget.wrapMeasure;
                            iArr7[3] = 0;
                            if (measure.useCurrentDimensions) {
                                boolean z14 = !(!z13 || iArr7[2] == 0 || iArr7[1] == constraintWidget.getHeight()) || (view instanceof Placeholder);
                                if (!z13 || z14) {
