...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public class Model {
        ...
        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                sb2.append(string);
                sb2.append(constraintWidget.mBottom.mTarget != null ? WkAdxAdConfigMg.DSP_NAME_BAIDU : "_");
        ...
        private void debugWidget(String str, ConstraintWidget constraintWidget) {
            ...
            String str2 = WkAdxAdConfigMg.DSP_NAME_BAIDU;
            String string4 = "__";
            if (constraintAnchor != null) {
                StringBuilder sb2 = new StringBuilder();
                sb2.append(ExifInterface.GPS_DIRECTION_TRUE);
                sb2.append(constraintWidget.mTop.mTarget.mType == ConstraintAnchor.Type.TOP ? ExifInterface.GPS_DIRECTION_TRUE : WkAdxAdConfigMg.DSP_NAME_BAIDU);
                string = sb2.toString();
            } else {
                string = "__";
            }
            ...
            if (constraintWidget.mBottom.mTarget != null) {
                StringBuilder sb4 = new StringBuilder();
                sb4.append(WkAdxAdConfigMg.DSP_NAME_BAIDU);
    ...
    public static class MyTracker implements MotionTracker {
        ...
        private static MyTracker f1264me = new MyTracker();
        ...
        public static MyTracker obtain() {
            f1264me.tracker = VelocityTracker.obtain();
            return f1264me;
        }
