                ...
                if (f3 > 0.0f) {
                    ...
                    if (((ViewGroup.MarginLayoutParams) layoutParams).width != 0) {
                        ...
                        if (i10 == -2) {
                            ...
                            f = f2;
                            i6 = Integer.MIN_VALUE;
                            iMakeMeasureSpec3 = i10 == -1 ? View.MeasureSpec.makeMeasureSpec(paddingLeft - i9, 1073741824) : View.MeasureSpec.makeMeasureSpec(i10, 1073741824);
                        }
                        int i11 = ((ViewGroup.MarginLayoutParams) layoutParams).height;
                        if (i11 == -2) {
                            iMakeMeasureSpec4 = View.MeasureSpec.makeMeasureSpec(paddingTop, i6);
                        } else {
                            iMakeMeasureSpec4 = i11 == -1 ? View.MeasureSpec.makeMeasureSpec(paddingTop, 1073741824) : View.MeasureSpec.makeMeasureSpec(i11, 1073741824);
                        }
                        ...
                        if (!z2 || childAt2 == this.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                if (((ViewGroup.MarginLayoutParams) layoutParams2).width == 0) {
                                    ...
                                    iMakeMeasureSpec = i14 == -2 ? View.MeasureSpec.makeMeasureSpec(paddingTop, Integer.MIN_VALUE) : i14 == -1 ? View.MeasureSpec.makeMeasureSpec(paddingTop, 1073741824) : View.MeasureSpec.makeMeasureSpec(i14, 1073741824);
                                } else {
                                ...
                                if (z2) {
                                    ...
                                    i4 = i12;
                                    childAt2.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth2 + ((int) ((layoutParams2.weight * Math.max(0, i7)) / f2)), 1073741824), iMakeMeasureSpec);
                                }
                            }
