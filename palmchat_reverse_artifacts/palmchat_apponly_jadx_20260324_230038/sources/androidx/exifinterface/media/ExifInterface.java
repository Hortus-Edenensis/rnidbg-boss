...
public class ExifInterface {
    ...
    private static final byte[] PNG_SIGNATURE = {-119, 80, 78, 71, dn.k, 10, 26, 10};
    ...
    */
    private void readImageFileDirectory(SeekableByteOrderedDataInputStream seekableByteOrderedDataInputStream, int i) throws IOException {
                                    ...
                                    if (num != null) {
                                        if (unsignedShort3 != 3) {
                                            ...
                                            if (unsignedInt <= 0) {
                                                ...
                                                Log.d(str3, "Skip jump into the IFD since its offset is invalid: " + unsignedInt);
                                            }
        ...
        boolean z4 = DEBUG;
        if (z4) {
            Log.d(str5, String.format("nextIfdOffset: %d", Integer.valueOf(i5)));
        }
        long j4 = i5;
        if (j4 <= 0) {
            if (z4) {
                Log.d(str5, "Stop reading file since a wrong offset may cause an infinite loop: " + i5);
                return;
            }
            return;
        }
        if (this.mAttributesOffsets.contains(Integer.valueOf(i5))) {
            if (z4) {
                Log.d(str5, "Stop reading file since re-reading an IFD may cause an infinite loop: " + i5);
                return;
            }
            return;
        }
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:64:0x00e6 A[Catch: all -> 0x010e, Exception -> 0x0111, TryCatch #17 {Exception -> 0x0111, all -> 0x010e, blocks: (B:62:0x00e2, B:64:0x00e6, B:66:0x00fc, B:65:0x00f5), top: B:127:0x00e2 }] */
    /* JADX WARN: Removed duplicated region for block: B:65:0x00f5 A[Catch: all -> 0x010e, Exception -> 0x0111, TryCatch #17 {Exception -> 0x0111, all -> 0x010e, blocks: (B:62:0x00e2, B:64:0x00e6, B:66:0x00fc, B:65:0x00f5), top: B:127:0x00e2 }] */
                    ...
                    switch (i) {
                        ...
                        case 5:
                            ...
                            while (i10 < strArrSplit3.length) {
                                String[] strArrSplit4 = strArrSplit3[i10].split("/", i5);
