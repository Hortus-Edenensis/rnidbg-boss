...
public class ProfileInstallerInitializer implements Initializer<Result> {
    ...
    public static void writeInBackground(@NonNull final Context context) {
        new ThreadPoolExecutor(0, 1, 0L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue()).execute(new Runnable() { // from class: sn4
    ...
    public void delayAfterFirstFrame(@NonNull final Context context) {
        Choreographer16Impl.postFrameCallback(new Runnable() { // from class: rn4
            @Override // java.lang.Runnable
            public final void run() {
                this.f20513a.lambda$delayAfterFirstFrame$0(context);
            }
        });
    }
    ...
    public void lambda$delayAfterFirstFrame$0(@NonNull final Context context) {
        (Build.VERSION.SDK_INT >= 28 ? Handler28Impl.createAsync(Looper.getMainLooper()) : new Handler(Looper.getMainLooper())).postDelayed(new Runnable() { // from class: qn4
            @Override // java.lang.Runnable
            public final void run() {
