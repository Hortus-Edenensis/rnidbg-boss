...
public final class WithLifecycleStateKt {
    ...
    /* JADX INFO: compiled from: SearchBox */
    @Metadata(d1 = {"\u0000\u0004\n\u0002\b\u0004\u0010\u0000\u001a\u0002H\u0001\"\u0004\b\u0000\u0010\u0001H\n¢\u0006\u0004\b\u0002\u0010\u0003"}, d2 = {"<anonymous>", "R", Launcher.Method.INVOKE_CALLBACK, "()Ljava/lang/Object;"}, k = 3, mv = {1, 8, 0}, xi = MediaPlayer.MEDIA_PLAYER_OPTION_ABR_HURRY_THRESHOLD)
    ...
    @PublishedApi
    public static final <R> Object suspendWithStateAtLeastUnchecked(final Lifecycle lifecycle, final Lifecycle.State state, boolean z, final lq0 lq0Var, final Function0<? extends R> function0, Continuation<? super R> continuation) {
        final bz bzVar = new bz(IntrinsicsKt__IntrinsicsJvmKt.intercepted(continuation), 1);
        bzVar.y();
            ...
            public void onStateChanged(LifecycleOwner source, Lifecycle.Event event) {
                ...
                if (event != Lifecycle.Event.INSTANCE.upTo(state)) {
                    if (event == Lifecycle.Event.ON_DESTROY) {
                        ...
                        Continuation continuation2 = bzVar;
                        Result.Companion companion = Result.INSTANCE;
                        continuation2.resumeWith(Result.m840constructorimpl(ResultKt.createFailure(new LifecycleDestroyedException())));
                        return;
                    }
                    return;
                }
                lifecycle.removeObserver(this);
                Continuation continuation3 = bzVar;
                Function0<R> function02 = function0;
                try {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM840constructorimpl = Result.m840constructorimpl(function02.invoke());
                } catch (Throwable th) {
                    Result.Companion companion3 = Result.INSTANCE;
                    objM840constructorimpl = Result.m840constructorimpl(ResultKt.createFailure(th));
                }
                continuation3.resumeWith(objM840constructorimpl);
            }
        };
        if (z) {
            lq0Var.dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$2$1
        ...
        bzVar.m(new Function1<Throwable, Unit>() { // from class: androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$2$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(Throwable th) {
                ...
                if (!lq0Var2.isDispatchNeeded(emptyCoroutineContext)) {
                ...
                lq0Var3.dispatch(emptyCoroutineContext, new Runnable() { // from class: androidx.lifecycle.WithLifecycleStateKt$suspendWithStateAtLeastUnchecked$2$2.1
                    @Override // java.lang.Runnable
                    public final void run() {
