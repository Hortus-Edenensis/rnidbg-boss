...
public abstract class ComputableLiveData<T> {
    ...
    public ComputableLiveData(Executor executor) {
        ...
        this.refreshRunnable = new Runnable() { // from class: wk0
            @Override // java.lang.Runnable
            public final void run() {
                ComputableLiveData.refreshRunnable$lambda$0(this.f21736a);
            }
        };
        this.invalidationRunnable = new Runnable() { // from class: xk0
            @Override // java.lang.Runnable
            public final void run() {
                ComputableLiveData.invalidationRunnable$lambda$1(this.f21992a);
            }
        };
    }
