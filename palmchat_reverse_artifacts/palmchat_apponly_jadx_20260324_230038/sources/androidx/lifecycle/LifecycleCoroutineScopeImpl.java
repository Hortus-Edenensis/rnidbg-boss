...
public final class LifecycleCoroutineScopeImpl extends LifecycleCoroutineScope implements LifecycleEventObserver {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<rq0, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (LifecycleCoroutineScopeImpl.this.getLifecycle().getState().compareTo(Lifecycle.State.INITIALIZED) >= 0) {
                ...
                my2.b(rq0Var.getCoroutineContext(), null, 1, null);
            }
    ...
    public LifecycleCoroutineScopeImpl(Lifecycle lifecycle, CoroutineContext coroutineContext) {
        ...
        if (getLifecycle().getState() == Lifecycle.State.DESTROYED) {
            my2.b(getCoroutineContext(), null, 1, null);
        }
    }

    @Override // androidx.lifecycle.LifecycleCoroutineScope, defpackage.rq0
    ...
    public final void register() {
        cv.b(this, he1.c().getImmediate(), null, new AnonymousClass1(null), 2, null);
    }
}
