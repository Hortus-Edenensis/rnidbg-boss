...
public class ArchTaskExecutor extends TaskExecutor {
    ...
    @NonNull
    private static final Executor sMainThreadExecutor = new Executor() { // from class: jh
    ...
    @NonNull
    private static final Executor sIOThreadExecutor = new Executor() { // from class: kh
        @Override // java.util.concurrent.Executor
        public final void execute(Runnable runnable) {
