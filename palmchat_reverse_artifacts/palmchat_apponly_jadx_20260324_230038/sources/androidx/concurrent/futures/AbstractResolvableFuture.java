...
public abstract class AbstractResolvableFuture<V> implements r33<V> {
    ...
    static final boolean GENERATE_CANCELLATION_CAUSES = Boolean.parseBoolean(System.getProperty("guava.concurrent.generate_cancellation_cause", ex.V));
    ...
    public static final class SafeAtomicHelper extends AtomicHelper {
        ...
        public boolean casListeners(AbstractResolvableFuture<?> abstractResolvableFuture, Listener listener, Listener listener2) {
            return p1.a(this.listenersUpdater, abstractResolvableFuture, listener, listener2);
        }

        @Override // androidx.concurrent.futures.AbstractResolvableFuture.AtomicHelper
        public boolean casValue(AbstractResolvableFuture<?> abstractResolvableFuture, Object obj, Object obj2) {
            return p1.a(this.valueUpdater, abstractResolvableFuture, obj, obj2);
        }

        @Override // androidx.concurrent.futures.AbstractResolvableFuture.AtomicHelper
        public boolean casWaiters(AbstractResolvableFuture<?> abstractResolvableFuture, Waiter waiter, Waiter waiter2) {
            return p1.a(this.waitersUpdater, abstractResolvableFuture, waiter, waiter2);
        }
    ...
    public static final class SetFuture<V> implements Runnable {
        final r33<? extends V> future;
        final AbstractResolvableFuture<V> owner;

        public SetFuture(AbstractResolvableFuture<V> abstractResolvableFuture, r33<? extends V> r33Var) {
    ...
    public static Object getFutureValue(r33<?> r33Var) {
        if (r33Var instanceof AbstractResolvableFuture) {
            Object obj = ((AbstractResolvableFuture) r33Var).value;
            if (!(obj instanceof Cancellation)) {
                return obj;
            }
        ...
        try {
            Object uninterruptibly = getUninterruptibly(r33Var);
            return uninterruptibly == null ? NULL : uninterruptibly;
        } catch (CancellationException e) {
            if (zIsCancelled) {
                return new Cancellation(false, e);
            }
            return new Failure(new IllegalArgumentException("get() threw CancellationException, despite reporting isCancelled() == false: " + r33Var, e));
        } catch (ExecutionException e2) {
    ...
    public final boolean cancel(boolean z) {
        ...
        while (true) {
            if (ATOMIC_HELPER.casValue(abstractResolvableFuture, obj, cancellation)) {
                ...
                r33<? extends V> r33Var = ((SetFuture) obj).future;
                if (!(r33Var instanceof AbstractResolvableFuture)) {
                    r33Var.cancel(z);
                    return true;
                }
                abstractResolvableFuture = (AbstractResolvableFuture) r33Var;
    ...
    public boolean setFuture(r33<? extends V> r33Var) {
        ...
        if (obj == null) {
            if (r33Var.isDone()) {
                if (!ATOMIC_HELPER.casValue(this, null, getFutureValue(r33Var))) {
                    return false;
                }
                complete(this);
                return true;
            }
            SetFuture setFuture = new SetFuture(this, r33Var);
            if (ATOMIC_HELPER.casValue(this, null, setFuture)) {
                try {
                    r33Var.addListener(setFuture, DirectExecutor.INSTANCE);
                } catch (Throwable th) {
                    try {
        ...
        if (obj instanceof Cancellation) {
            r33Var.cancel(((Cancellation) obj).wasInterrupted);
        }
        return false;
    }
