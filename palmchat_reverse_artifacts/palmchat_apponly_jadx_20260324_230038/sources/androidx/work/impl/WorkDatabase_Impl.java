    ...
    public SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration databaseConfiguration) {
        return databaseConfiguration.sqliteOpenHelperFactory.create(SupportSQLiteOpenHelper.Configuration.builder(databaseConfiguration.context).name(databaseConfiguration.name).callback(new RoomOpenHelper(databaseConfiguration, new RoomOpenHelper.Delegate(5) { // from class: androidx.work.impl.WorkDatabase_Impl.1
            ...
            public void validateMigration(SupportSQLiteDatabase supportSQLiteDatabase) {
                ...
                map.put("work_spec_id", new TableInfo.Column("work_spec_id", "TEXT", true, 1));
                map.put("prerequisite_id", new TableInfo.Column("prerequisite_id", "TEXT", true, 2));
                ...
                map2.put("id", new TableInfo.Column("id", "TEXT", true, 1));
                map2.put(LocationConst.HDYawConst.KEY_HD_YAW_STATE, new TableInfo.Column(LocationConst.HDYawConst.KEY_HD_YAW_STATE, "INTEGER", true, 0));
                map2.put("worker_class_name", new TableInfo.Column("worker_class_name", "TEXT", true, 0));
                map2.put("input_merger_class_name", new TableInfo.Column("input_merger_class_name", "TEXT", false, 0));
                map2.put("input", new TableInfo.Column("input", "BLOB", true, 0));
                map2.put("output", new TableInfo.Column("output", "BLOB", true, 0));
                map2.put("initial_delay", new TableInfo.Column("initial_delay", "INTEGER", true, 0));
                map2.put("interval_duration", new TableInfo.Column("interval_duration", "INTEGER", true, 0));
                map2.put("flex_duration", new TableInfo.Column("flex_duration", "INTEGER", true, 0));
                map2.put("run_attempt_count", new TableInfo.Column("run_attempt_count", "INTEGER", true, 0));
                map2.put("backoff_policy", new TableInfo.Column("backoff_policy", "INTEGER", true, 0));
                map2.put("backoff_delay_duration", new TableInfo.Column("backoff_delay_duration", "INTEGER", true, 0));
                map2.put("period_start_time", new TableInfo.Column("period_start_time", "INTEGER", true, 0));
                map2.put("minimum_retention_duration", new TableInfo.Column("minimum_retention_duration", "INTEGER", true, 0));
                map2.put("schedule_requested_at", new TableInfo.Column("schedule_requested_at", "INTEGER", true, 0));
                map2.put("required_network_type", new TableInfo.Column("required_network_type", "INTEGER", false, 0));
                map2.put("requires_charging", new TableInfo.Column("requires_charging", "INTEGER", true, 0));
                map2.put("requires_device_idle", new TableInfo.Column("requires_device_idle", "INTEGER", true, 0));
                map2.put("requires_battery_not_low", new TableInfo.Column("requires_battery_not_low", "INTEGER", true, 0));
                map2.put("requires_storage_not_low", new TableInfo.Column("requires_storage_not_low", "INTEGER", true, 0));
                map2.put("trigger_content_update_delay", new TableInfo.Column("trigger_content_update_delay", "INTEGER", true, 0));
                map2.put("trigger_max_content_delay", new TableInfo.Column("trigger_max_content_delay", "INTEGER", true, 0));
                map2.put("content_uri_triggers", new TableInfo.Column("content_uri_triggers", "BLOB", false, 0));
                ...
                map3.put("tag", new TableInfo.Column("tag", "TEXT", true, 1));
                map3.put("work_spec_id", new TableInfo.Column("work_spec_id", "TEXT", true, 2));
                ...
                map4.put("work_spec_id", new TableInfo.Column("work_spec_id", "TEXT", true, 1));
                map4.put("system_id", new TableInfo.Column("system_id", "INTEGER", true, 0));
                ...
                map5.put("name", new TableInfo.Column("name", "TEXT", true, 1));
                map5.put("work_spec_id", new TableInfo.Column("work_spec_id", "TEXT", true, 2));
