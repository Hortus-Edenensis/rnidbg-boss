...
public class ConstraintTrackingWorker extends ListenableWorker implements WorkConstraintsCallback {
    ...
    public void setupAndRunConstraintTrackingWork() {
        ...
        try {
            final r33<ListenableWorker.Result> r33VarStartWork = this.mDelegate.startWork();
            r33VarStartWork.addListener(new Runnable() { // from class: androidx.work.impl.workers.ConstraintTrackingWorker.2
                ...
                public void run() {
                    synchronized (ConstraintTrackingWorker.this.mLock) {
                        if (ConstraintTrackingWorker.this.mAreConstraintsUnmet) {
                            ...
                            ConstraintTrackingWorker.this.mFuture.setFuture(r33VarStartWork);
                        }
                    }
                }
    ...
    @Override // androidx.work.ListenableWorker
    @NonNull
    public r33<ListenableWorker.Result> startWork() {
