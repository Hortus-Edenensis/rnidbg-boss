...
public final class r86 {
    ...
    public static final ThreadLocal<PathMeasure> f20415a = new a();
    ...
    public static void a(Path path, float f, float f2, float f3) {
        m03.a("applyTrimPathIfNeeded");
        PathMeasure pathMeasure = f20415a.get();
        Path path2 = b.get();
        Path path3 = c.get();
        pathMeasure.setPath(path, false);
        float length = pathMeasure.getLength();
        if (f == 1.0f && f2 == 0.0f) {
            m03.b("applyTrimPathIfNeeded");
            return;
        }
        ...
        if (fMin >= length && fMax >= length) {
            fMin = sp3.f(fMin, length);
            fMax = sp3.f(fMax, length);
        }
        if (fMin < 0.0f) {
            fMin = sp3.f(fMin, length);
        }
    ...
    public static void b(Path path, @Nullable q16 q16Var) {
        if (q16Var == null || q16Var.k()) {
            return;
        }
        a(path, ((ux1) q16Var.i()).p() / 100.0f, ((ux1) q16Var.c()).p() / 100.0f, ((ux1) q16Var.h()).p() / 360.0f);
    }
    ...
    public static void n(Canvas canvas, RectF rectF, Paint paint, int i) {
        m03.a("Utils#saveLayer");
        if (Build.VERSION.SDK_INT < 23) {
            canvas.saveLayer(rectF, paint, i);
        } else {
            canvas.saveLayer(rectF, paint);
        }
        m03.b("Utils#saveLayer");
    }
}
