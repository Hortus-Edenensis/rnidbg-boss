...
public class yn4 extends xb4 implements Animatable, ValueAnimator.AnimatorUpdateListener {
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        for (int i = 0; i < 12; i++) {
            this.f21918a.setAlpha((i + 5) * 17);
            canvas.rotate(30.0f, f5, f6);
            canvas.drawPath(this.f, this.f21918a);
        }
        canvas.restore();
    }
