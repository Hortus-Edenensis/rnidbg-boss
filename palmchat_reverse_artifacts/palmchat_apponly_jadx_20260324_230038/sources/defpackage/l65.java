...
public class l65 extends wt0 {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public String f18917a = nl0.s + "/room/v3/nick/update";
    public Response.Listener<JSONObject> b;
    public Response.ErrorListener c;

    public l65(Response.Listener<JSONObject> listener, Response.ErrorListener errorListener) {
        this.b = listener;
    ...
    public void n(String str, String str2) throws DaoException {
        ...
        try {
            String strGenerateEncodedURL = wt0.generateEncodedURL(this.f18917a);
