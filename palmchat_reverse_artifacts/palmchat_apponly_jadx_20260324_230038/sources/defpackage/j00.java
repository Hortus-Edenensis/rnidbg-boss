...
public class j00 extends wt0 {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public String f18296a = nl0.z + "/service.ids.follow.v1";
    public Response.Listener<JSONObject> b;
    public Response.ErrorListener c;

    public j00(Response.Listener<JSONObject> listener, Response.ErrorListener errorListener) {
        this.b = listener;
        this.c = errorListener;
    }

    public void n(String str, String str2, Boolean bool, Boolean bool2) throws DaoException {
        if (this.c == null || this.b == null) {
            throw new DaoException(DaoException.DAO_INITIAL_ERROR_MESSAGE);
        }
        try {
            String strZ = k86.Z(this.f18296a);
