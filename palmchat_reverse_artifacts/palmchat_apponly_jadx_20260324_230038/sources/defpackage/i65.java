...
public class i65 extends wt0 {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public String f18115a = nl0.n + "/friend/v3/config.json";
    public Response.Listener<JSONObject> b;
    public Response.ErrorListener c;

    public i65(Response.Listener<JSONObject> listener, Response.ErrorListener errorListener) {
        this.b = listener;
    ...
    public void n(String str, int i) throws DaoException {
        ...
        try {
            String strGenerateEncodedURL = wt0.generateEncodedURL(this.f18115a);
            JSONObject jSONObject = new JSONObject();
            jSONObject.put("fuid", str);
            jSONObject.put("sessionConfig", i);
