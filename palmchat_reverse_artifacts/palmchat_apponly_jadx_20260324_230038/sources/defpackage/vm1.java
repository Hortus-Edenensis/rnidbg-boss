...
public class vm1 extends wt0 {
    public static final String b = "vm1";

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public String f21479a = nl0.s + "/room/v4/card/join";

    public GroupModifyResultVo n(String str, String str2) throws DaoException {
        GroupModifyResultVo groupModifyResultVoBuildFromJsonObject = null;
        try {
            String strZ = k86.Z(this.f21479a);
