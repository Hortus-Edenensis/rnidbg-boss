...
public class y00 implements ky3 {
    ...
    public String toString() {
        return "Node{edge=" + this.f22090a + ", value=" + ph6.f20019a + ", edges=" + b() + "}";
    }
}
