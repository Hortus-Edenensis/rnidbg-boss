...
public final class lu6 {
    ...
    public static final byte[] f19079a = new byte[128];
    ...
    public static String b(byte[] bArr) {
        ...
        while (i3 < i2) {
            ...
            byte b5 = (byte) (b3 & 15);
            byte b6 = (byte) (b2 & 3);
            int i9 = b2 & ByteCompanionObject.MIN_VALUE;
            int i10 = b2 >> 2;
            if (i9 != 0) {
                i10 ^= 192;
            }
            ...
            byte b8 = (byte) i12;
            int i13 = (b4 & ByteCompanionObject.MIN_VALUE) == 0 ? b4 >> 6 : (b4 >> 6) ^ MediaPlayer.MEDIA_PLAYER_OPTION_HW_DEC_DROP_NON_REF;
            int i14 = i5 + 1;
            char[] cArr2 = b;
            cArr[i5] = cArr2[b7];
            int i15 = i14 + 1;
            ...
            cArr[i16] = cArr2[b4 & Utf8.REPLACEMENT_BYTE];
            i3++;
            i5 = i16 + 1;
            i4 = i8;
        }
        if (i == 8) {
            ...
            byte b14 = (byte) (b11 & 3);
            int i21 = b11 & ByteCompanionObject.MIN_VALUE;
            int i22 = b11 >> 2;
            if (i21 != 0) {
                i22 ^= 192;
            }
            byte b15 = (byte) i22;
            int i23 = b12 & ByteCompanionObject.MIN_VALUE;
            int i24 = b12 >> 4;
            if (i23 != 0) {
                i24 ^= 240;
            }
