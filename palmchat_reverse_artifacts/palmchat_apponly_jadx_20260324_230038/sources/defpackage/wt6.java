...
public class wt6 {
    ...
    public class a implements Runnable {
        ...
        public void run() {
            if (wt6.this.f21798a == null) {
                wt6 wt6Var = wt6.this;
                wt6 wt6Var2 = wt6.this;
                wt6Var.f21798a = wt6Var2.new d(wt6Var2.b);
                wt6.this.f21798a.setCancelable(wt6.this.g);
            }
            try {
                if (wt6.this.f21798a.isShowing()) {
                    return;
                }
                wt6.this.f21798a.show();
                wt6.this.h.sendEmptyMessageDelayed(1, 10000L);
            } catch (Exception e) {
                w97.d(e);
            }
        }
    ...
    public class b implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            if (wt6.this.f21798a == null || !wt6.this.f21798a.isShowing()) {
                return;
            }
            try {
                wt6.this.h.removeMessages(1);
                wt6.this.f21798a.dismiss();
            } catch (Exception e) {
                w97.d(e);
            }
        }
    ...
    public class d extends AlertDialog {
        ...
        public final View c(Context context) {
            ...
            layoutParams2.setMargins(a(wt6.this.b, 17.0f), a(wt6.this.b, 10.0f), a(wt6.this.b, 8.0f), a(wt6.this.b, 10.0f));
            imageView.setLayoutParams(layoutParams2);
            imageView.setScaleType(ImageView.ScaleType.FIT_CENTER);
            imageView.setImageDrawable(b(context, wt6.i, TECameraSettings.FPS_480));
            ...
            textView.setText(TextUtils.isEmpty(wt6.this.c) ? "正在加载" : wt6.this.c);
    ...
    public wt6(Activity activity, String str) {
        this.b = activity;
        this.c = str;
    }
