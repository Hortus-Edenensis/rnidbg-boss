...
public final class cu1 {
    ...
    public static final Object f16916a;
    ...
    static {
        ...
        f16916a = obj;
        b = new Object[][]{new Object[]{"00", 18}, new Object[]{HiAnalyticsConstant.KeyAndValue.NUMBER_01, 14}, new Object[]{a.t, 14}, new Object[]{"10", obj, 20}, new Object[]{"11", 6}, new Object[]{BaseWrapper.ENTER_ID_MARKET, 6}, new Object[]{BaseWrapper.ENTER_ID_GAME_CENTER, 6}, new Object[]{"15", 6}, new Object[]{BaseWrapper.ENTER_ID_17, 6}, new Object[]{BaseWrapper.ENTER_ID_SYSTEM_HELPER, 2}, new Object[]{"21", obj, 20}, new Object[]{BaseWrapper.ENTER_ID_SYSTEM_SIM_SETTING, obj, 29}, new Object[]{BaseWrapper.ENTER_ID_TOOLKIT, obj, 8}, new Object[]{BaseWrapper.ENTER_ID_OAPS_GAMESPACE, obj, 8}, new Object[]{"90", obj, 30}, new Object[]{"91", obj, 30}, new Object[]{"92", obj, 30}, new Object[]{"93", obj, 30}, new Object[]{"94", obj, 30}, new Object[]{"95", obj, 30}, new Object[]{"96", obj, 30}, new Object[]{"97", obj, 30}, new Object[]{"98", obj, 30}, new Object[]{"99", obj, 30}};
    ...
    public static String a(String str) throws NotFoundException {
        ...
        for (Object[] objArr : b) {
            if (objArr[0].equals(strSubstring)) {
                Object obj = objArr[1];
                return obj == f16916a ? c(2, ((Integer) objArr[2]).intValue(), str) : b(2, ((Integer) obj).intValue(), str);
            }
        }
        if (str.length() < 3) {
            throw NotFoundException.getNotFoundInstance();
        ...
        for (Object[] objArr2 : c) {
            if (objArr2[0].equals(strSubstring2)) {
                ...
                return obj2 == f16916a ? c(3, ((Integer) objArr2[2]).intValue(), str) : b(3, ((Integer) obj2).intValue(), str);
            }
        }
        for (Object[] objArr3 : d) {
            if (objArr3[0].equals(strSubstring2)) {
                Object obj3 = objArr3[1];
                return obj3 == f16916a ? c(4, ((Integer) objArr3[2]).intValue(), str) : b(4, ((Integer) obj3).intValue(), str);
            }
        }
        if (str.length() < 4) {
            throw NotFoundException.getNotFoundInstance();
        ...
        for (Object[] objArr4 : e) {
            if (objArr4[0].equals(strSubstring3)) {
                ...
                return obj4 == f16916a ? c(4, ((Integer) objArr4[2]).intValue(), str) : b(4, ((Integer) obj4).intValue(), str);
            }
        }
        throw NotFoundException.getNotFoundInstance();
    }
