...
public class j65 extends wt0 {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public String f18336a = nl0.s + "/room/v3/category";
    public Response.Listener<JSONObject> b;
    public Response.ErrorListener c;

    public j65(Response.Listener<JSONObject> listener, Response.ErrorListener errorListener) {
        this.b = listener;
    ...
    public void n(String str, int i) throws DaoException {
        ...
        try {
            String strGenerateEncodedURL = wt0.generateEncodedURL(this.f18336a);
