                ...
                if (TextUtils.isEmpty(strC3)) {
                    ...
                    if (TextUtils.isEmpty(strC4)) {
                        ...
                        if (!TextUtils.isEmpty(strC5)) {
                            f19640a = LxAdOSUtils.ROM_SMARTISAN;
                            ...
                            if (str3.toUpperCase().contains(LxAdOSUtils.ROM_FLYME)) {
                                f19640a = LxAdOSUtils.ROM_FLYME;
                            }
                        } else {
                            f19640a = "ONEPLUS";
                        }
                    } else {
                        f19640a = LxAdOSUtils.ROM_VIVO;
                    }
                } else {
                    f19640a = "OPPO";
                }
            } else {
                f19640a = LxAdOSUtils.ROM_EMUI;
            }
        } else {
            f19640a = LxAdOSUtils.ROM_MIUI;
        }
        return TextUtils.equals(f19640a, str);
    }
