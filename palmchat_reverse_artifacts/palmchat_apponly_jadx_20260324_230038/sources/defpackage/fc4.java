...
public final class fc4 {
    ...
    public final void a() {
        int i;
        int i2 = this.b;
        vh.g(i2 >= 0 && (i2 < (i = this.d) || (i2 == i && this.c == 0)));
    }
    ...
    public boolean g() {
        boolean z = (this.f17507a[this.b] & (128 >> this.c)) != 0;
        q();
        return z;
    }
    ...
    public long j(int i) {
        return i <= 32 ? g86.k1(h(i)) : g86.j1(h(i - 32), h(32));
    }

    public void k(byte[] bArr, int i, int i2) {
        vh.g(this.c == 0);
        System.arraycopy(this.f17507a, this.b, bArr, i, i2);
        this.b += i2;
        a();
    }
    ...
    public fc4(byte[] bArr) {
        this(bArr, bArr.length);
    }

    public fc4(byte[] bArr, int i) {
        this.f17507a = bArr;
        this.d = i;
    }
}
