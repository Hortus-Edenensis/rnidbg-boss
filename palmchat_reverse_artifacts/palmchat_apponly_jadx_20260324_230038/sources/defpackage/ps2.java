...
public abstract class ps2 extends Drawable implements Animatable {
    ...
    public HashMap<ValueAnimator, ValueAnimator.AnimatorUpdateListener> f20090a = new HashMap<>();
    public int c = 255;
    public Rect d = g;
    ...
    public void a(ValueAnimator valueAnimator, ValueAnimator.AnimatorUpdateListener animatorUpdateListener) {
        this.f20090a.put(valueAnimator, animatorUpdateListener);
    }
    ...
    public final void l() {
        for (int i = 0; i < this.b.size(); i++) {
            ...
            ValueAnimator.AnimatorUpdateListener animatorUpdateListener = this.f20090a.get(valueAnimator);
