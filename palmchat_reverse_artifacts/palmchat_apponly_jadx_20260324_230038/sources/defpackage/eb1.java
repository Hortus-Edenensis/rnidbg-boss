...
public class eb1 {
    ...
    public class b implements hb1.j {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public final /* synthetic */ ViewGroup f17256a;

        public b(ViewGroup viewGroup) {
            this.f17256a = viewGroup;
        }

        @Override // hb1.j
        public void a(View view) {
            WifiLog.d("AdUIHelper onDislikeClicked4: " + this.f17256a);
    ...
    public static void c() {
        ...
        if (b6.f || b6.e("DetailAdManagerV2")) {
            LogUtil.d("ClearAd", "clearCacheAd DetailAdManagerV2 clearAllAd");
            cb1 cb1Var = c;
            if (cb1Var != null) {
                cb1Var.b();
                c = null;
    ...
    public static void e(String str, String str2) {
        ...
        if (i()) {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                try {
                    f17254a = new JSONObject(str).optString(f(), "");
                    z = true;
    ...
    public static void j(Activity activity) {
        ...
        try {
            jSONObject.put("new_user_detail", 1);
        } catch (Exception e2) {
            e2.printStackTrace();
        }
    ...
    public static void k(Activity activity, int i) {
        WifiLog.d("DDDD 3333 tryRequest context " + activity + " mStrategyJson " + f17254a);
        ...
        AdParams adParamsBuild = new AdParams.Builder().setExt(map).setScene(i2).setAdUnitId(zH ? "cij9hp79ntqdm53ijkeg" : "cagm9rqch5lb7q8042h0").setFullStrategyJson(f17254a).setAdSize(new AdSize(320.0f, -2.0f)).build();
    ...
    public class a implements FeedLoadListener {
        ...
        public void onAdLoaded(String str, List<NestAdData> list) {
            ...
            cb1 cb1Var = new cb1(this.f17255a, nestAdData, this.b);
            if (!this.b) {
                cb1Var.e = this.c;
                cb1Var.f = this.d;
            }
            eb1.c = cb1Var;
            gb1.c(this.f17255a, "LX-39904", eb1.f(), this.e, nestAdData);
            if (this.f != 2) {
                if (!b6.d()) {
                    eb1.j(this.h);
                    return;
                ...
                if (weakReference != null) {
                    eb1.j((Activity) weakReference.get());
                }
            }
        }
