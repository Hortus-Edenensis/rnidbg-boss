...
public class f25 extends wt0 {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public String f17422a = nl0.s + "/room/v3/addresslist/set";
    public Response.Listener<JSONObject> b;
    public Response.ErrorListener c;

    public f25(Response.Listener<JSONObject> listener, Response.ErrorListener errorListener) {
        this.b = listener;
    ...
    public void n(String str, int i) throws DaoException {
        ...
        try {
            String strGenerateEncodedURL = wt0.generateEncodedURL(this.f17422a);
