...
public class vq4 extends wt0 {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public String f21511a = nl0.s + "/room/v3/quit";
    public Response.Listener<JSONObject> b;
    public Response.ErrorListener c;

    public vq4(Response.Listener<JSONObject> listener, Response.ErrorListener errorListener) {
        this.b = listener;
    ...
    public void n(String str) throws DaoException {
        ...
        try {
            String strGenerateEncodedURL = wt0.generateEncodedURL(this.f21511a);
