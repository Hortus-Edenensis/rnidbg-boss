...
public class lz6 implements r37 {
    ...
    public class a implements y37.a {
        ...
        public ev6 b(int i, ev6 ev6Var) {
            String str;
            String strValueOf;
            this.f19111a = SystemClock.uptimeMillis();
            if (i != 0) {
                if (i == 1) {
                    ev6Var.j("timestamp", Long.valueOf(this.d));
                    ev6Var.j("main_process", Boolean.valueOf(kv6.k(lz6.this.f19110a)));
                    ev6Var.j(CrashHianalyticsData.CRASH_TYPE, CrashType.JAVA);
                    ...
                    st6.c().j(this.g, this.b, true, ev6Var);
                } else if (i == 2) {
                    if (this.c) {
                        kv6.d(lz6.this.f19110a, ev6Var.G());
                    }
                    ev6Var.j("launch_did", gv6.a(lz6.this.f19110a));
                    ...
                    if (i == 5) {
                        ...
                        nd7.a(wi7.F(x97.m()), CrashType.LAUNCH, "");
                    }
                } else if (!this.c) {
                    kv6.d(lz6.this.f19110a, ev6Var.G());
                }
            } else {
                ev6Var.j(SharePluginInfo.ISSUE_TRACE_STACK, yl7.b(this.b));
                ev6Var.j("event_type", "start_crash");
    ...
    public final synchronized void c(long j, Thread thread, Throwable th, String str, File file, String str2, boolean z) {
        File file2 = new File(wi7.b(this.f19110a), str);
        st6.c().h(file2.getName());
        file2.mkdirs();
        re7.F(file2);
        ev6 ev6VarB = da7.d().b(CrashType.LAUNCH, null, new a(th, yl7.w(th), j, str2, z, thread, str, file2), true);
