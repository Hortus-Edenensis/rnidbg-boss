...
public final class OkHostnameVerifier implements HostnameVerifier {
    ...
    private final boolean verifyHostname(String hostname, String pattern) {
        if (!(hostname == null || hostname.length() == 0) && !StringsKt__StringsJVMKt.startsWith$default(hostname, ".", false, 2, null) && !StringsKt__StringsJVMKt.endsWith$default(hostname, "..", false, 2, null)) {
            if (!(pattern == null || pattern.length() == 0) && !StringsKt__StringsJVMKt.startsWith$default(pattern, ".", false, 2, null) && !StringsKt__StringsJVMKt.endsWith$default(pattern, "..", false, 2, null)) {
