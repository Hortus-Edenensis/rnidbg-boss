...
public final class HttpHeaders {
    ...
    public static final boolean promisesBody(Response response) {
        ...
        if (Intrinsics.areEqual(response.request().method(), Request.HttpMethodHEAD)) {
            return false;
        }
    ...
    */
    private static final void readChallengeHeader(Buffer buffer, List<Challenge> list) throws EOFException {
        ...
        while (true) {
            ...
            Map mapSingletonMap = Collections.singletonMap(null, Intrinsics.stringPlus(token, StringsKt__StringsJVMKt.repeat(ContainerUtils.KEY_VALUE_DELIMITER, iSkipAll)));
