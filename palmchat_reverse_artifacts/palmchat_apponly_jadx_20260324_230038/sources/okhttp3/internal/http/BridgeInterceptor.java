...
public final class BridgeInterceptor implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (request.header(org.apache.http.HttpHeaders.ACCEPT_ENCODING) == null && request.header(org.apache.http.HttpHeaders.RANGE) == null) {
            builderNewBuilder.header(org.apache.http.HttpHeaders.ACCEPT_ENCODING, Constants.CP_GZIP);
            z = true;
        }
        ...
        if (z && StringsKt__StringsJVMKt.equals(Constants.CP_GZIP, Response.header$default(responseProceed, "Content-Encoding", null, 2, null), true) && HttpHeaders.promisesBody(responseProceed) && (responseBodyBody = responseProceed.body()) != null) {
