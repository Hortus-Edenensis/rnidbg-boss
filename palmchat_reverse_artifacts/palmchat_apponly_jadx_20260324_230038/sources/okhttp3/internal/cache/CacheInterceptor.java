    ...
    public static final class Companion {
        ...
        public final Headers combine(Headers cachedHeaders, Headers networkHeaders) {
            ...
            while (i2 < size) {
                ...
                if ((!StringsKt__StringsJVMKt.equals(HttpHeaders.WARNING, strName, true) || !StringsKt__StringsJVMKt.startsWith$default(strValue, "1", false, 2, null)) && (isContentSpecificHeader(strName) || !isEndToEnd(strName) || networkHeaders.get(strName) == null)) {
        ...
        private final boolean isEndToEnd(String fieldName) {
            return (StringsKt__StringsJVMKt.equals("Connection", fieldName, true) || StringsKt__StringsJVMKt.equals(HTTP.CONN_KEEP_ALIVE, fieldName, true) || StringsKt__StringsJVMKt.equals(HttpHeaders.PROXY_AUTHENTICATE, fieldName, true) || StringsKt__StringsJVMKt.equals(HttpHeaders.PROXY_AUTHORIZATION, fieldName, true) || StringsKt__StringsJVMKt.equals(HttpHeaders.TE, fieldName, true) || StringsKt__StringsJVMKt.equals("Trailers", fieldName, true) || StringsKt__StringsJVMKt.equals("Transfer-Encoding", fieldName, true) || StringsKt__StringsJVMKt.equals(HttpHeaders.UPGRADE, fieldName, true)) ? false : true;
        }
