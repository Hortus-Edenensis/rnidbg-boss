...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public static final class Builder {
        ...
        public final Builder m2467addInterceptor(final Function1<? super Interceptor.Chain, Response> block) {
        ...
        public final Builder m2468addNetworkInterceptor(final Function1<? super Interceptor.Chain, Response> block) {
            Intrinsics.checkNotNullParameter(block, "block");
        ...
        public final Builder callTimeout(long timeout, TimeUnit unit) {
            ...
            setCallTimeout$okhttp(Util.checkDuration(WkAdConfigModel.TAG_TIMEOUT, timeout, unit));
            return this;
        }
        ...
        public final Builder connectTimeout(long timeout, TimeUnit unit) {
            Intrinsics.checkNotNullParameter(unit, "unit");
            setConnectTimeout$okhttp(Util.checkDuration(WkAdConfigModel.TAG_TIMEOUT, timeout, unit));
            return this;
        }
        ...
        public final Builder readTimeout(long timeout, TimeUnit unit) {
            Intrinsics.checkNotNullParameter(unit, "unit");
            setReadTimeout$okhttp(Util.checkDuration(WkAdConfigModel.TAG_TIMEOUT, timeout, unit));
            return this;
        }
        ...
        public final Builder writeTimeout(long timeout, TimeUnit unit) {
            Intrinsics.checkNotNullParameter(unit, "unit");
            setWriteTimeout$okhttp(Util.checkDuration(WkAdConfigModel.TAG_TIMEOUT, timeout, unit));
            return this;
        }
    ...
    public final List<ConnectionSpec> m2447deprecated_connectionSpecs() {
        return this.connectionSpecs;
    }
    ...
    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = DnsSource.Udp, imports = {}))
    ...
    public final List<Interceptor> m2455deprecated_interceptors() {
        return this.interceptors;
    }
    ...
    public final List<Interceptor> m2456deprecated_networkInterceptors() {
        return this.networkInterceptors;
    }
    ...
    public final List<Protocol> m2458deprecated_protocols() {
        return this.protocols;
    }
    ...
    public final SSLSocketFactory m2465deprecated_sslSocketFactory() {
