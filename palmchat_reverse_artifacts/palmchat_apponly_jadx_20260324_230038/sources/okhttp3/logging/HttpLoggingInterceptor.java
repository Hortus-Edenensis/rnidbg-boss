...
public final class HttpLoggingInterceptor implements Interceptor {
    ...
    private final boolean bodyHasUnknownEncoding(Headers headers) {
        ...
        return (str == null || StringsKt__StringsJVMKt.equals(str, HTTP.IDENTITY_CODING, true) || StringsKt__StringsJVMKt.equals(str, Constants.CP_GZIP, true)) ? false : true;
    }
        ...
        try {
            ...
            if (z2) {
                ...
                if (!z || !HttpHeaders.promisesBody(responseProceed)) {
                    ...
                    Long l = null;
                    if (StringsKt__StringsJVMKt.equals(Constants.CP_GZIP, headers2.get("Content-Encoding"), true)) {
