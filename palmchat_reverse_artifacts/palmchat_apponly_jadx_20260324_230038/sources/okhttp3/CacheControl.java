        ...
        public final CacheControl parse(Headers headers) {
            ...
            while (i2 < size) {
                ...
                if (StringsKt__StringsJVMKt.equals(strName, HttpHeaders.CACHE_CONTROL, z)) {
                    ...
                    while (i < strValue.length()) {
                        ...
                        if (iIndexOfElement2 == strValue.length() || strValue.charAt(iIndexOfElement2) == ',' || strValue.charAt(iIndexOfElement2) == ';') {
                            ...
                            if (iIndexOfNonWhitespace >= strValue.length() || strValue.charAt(iIndexOfNonWhitespace) != '\"') {
                                ...
                                int iIndexOf$default = StringsKt__StringsKt.indexOf$default((CharSequence) strValue, Typography.quote, i4, false, 4, (Object) null);
                    ...
                    headers2 = headers;
                    i2 = i3;
                } else if (!StringsKt__StringsJVMKt.equals(strName, HttpHeaders.PRAGMA, z)) {
                    headers2 = headers;
                    i2 = i3;
                }
                z2 = false;
