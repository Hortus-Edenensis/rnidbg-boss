...
public final class MediaType {
    ...
    public static final class Companion {
        ...
        public final MediaType m2433deprecated_get(String mediaType) {
        ...
        public final MediaType m2434deprecated_parse(String mediaType) {
            Intrinsics.checkNotNullParameter(mediaType, "mediaType");
    ...
    public final String parameter(String name) {
        ...
        while (true) {
            int i2 = i + 2;
            if (StringsKt__StringsJVMKt.equals(this.parameterNamesAndValues[i], name, true)) {
