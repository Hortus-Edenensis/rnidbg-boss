...
public final class Response implements Closeable {
    ...
    public final CacheControl m2475deprecated_cacheControl() {
        return cacheControl();
    }
    ...
    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = ReportItem.LogTypeRequest, imports = {}))
