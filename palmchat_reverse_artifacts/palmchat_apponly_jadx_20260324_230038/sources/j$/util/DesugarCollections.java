...
public class DesugarCollections {
    ...
    private static class SynchronizedMap implements java.util.Map, Serializable, Map {
        ...
        private java.util.Set instantiateSet(java.util.Set set, Object obj) {
            if (DesugarCollections.SYNCHRONIZED_SET_CONSTRUCTOR == null) {
                return Collections.synchronizedSet(set);
            }
            try {
                return (java.util.Set) DesugarCollections.SYNCHRONIZED_SET_CONSTRUCTOR.newInstance(set, obj);
            } catch (IllegalAccessException | InstantiationException | InvocationTargetException e) {
                throw new Error("Unable to instantiate a synchronized list.", e);
            }
        }
    ...
    static {
        ...
        Constructor constructor = getConstructor(Collections.synchronizedSet(new HashSet()).getClass(), java.util.Set.class, Object.class);
