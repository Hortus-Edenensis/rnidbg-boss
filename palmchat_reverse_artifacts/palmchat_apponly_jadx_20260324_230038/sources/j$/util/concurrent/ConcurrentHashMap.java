...
public class ConcurrentHashMap<K, V> extends AbstractMap<K, V> implements java.util.concurrent.ConcurrentMap<K, V>, Serializable, ConcurrentMap<K, V> {
    ...
    static final class EntrySetView extends CollectionView implements Set, j$.util.Set {
    ...
    public static class KeySetView extends CollectionView implements Set, j$.util.Set {
        private static final long serialVersionUID = 7249069246763182397L;
    ...
    static final class TreeBin extends Node {
        ...
        */
        final TreeNode putTreeVal(int i, Object obj, Object obj2) {
            ...
            while (true) {
                if (treeNode2 == null) {
                    TreeNode treeNode3 = new TreeNode(i, obj, obj2, null, null);
                    this.root = treeNode3;
                ...
                if (i2 > i) {
                    ...
                    if ((clsComparableClassFor == null && (clsComparableClassFor = ConcurrentHashMap.comparableClassFor(obj)) == null) || (iCompareComparables = ConcurrentHashMap.compareComparables(clsComparableClassFor, obj, obj3)) == 0) {
                        if (!z) {
                            ...
                            if ((treeNode4 != null && (r2 = treeNode4.findTreeNode(i, obj, clsComparableClassFor)) != null) || ((treeNode = treeNode2.right) != null && (r2 = treeNode.findTreeNode(i, obj, clsComparableClassFor)) != null)) {
                                break;
                            }
                            z = true;
                        }
                ...
                TreeNode treeNode5 = iTieBreakOrder <= 0 ? treeNode2.left : treeNode2.right;
                if (treeNode5 == null) {
                    TreeNode treeNode6 = this.first;
                    TreeNode treeNode7 = new TreeNode(i, obj, obj2, treeNode6, treeNode2);
                    ...
                    if (treeNode2.red) {
                        lockRoot();
                        try {
                            this.root = balanceInsertion(this.root, treeNode7);
                        } finally {
                            unlockRoot();
                        }
                    } else {
    ...
    static {
        ...
        CELLVALUE = unsafe.objectFieldOffset(CounterCell.class, ActionUtils.PAYMENT_AMOUNT);
        ...
        if (counterCellArr == null) {
            ...
            if (!desugarUnsafe.compareAndSetLong(this, j2, j3, jSumCount)) {
                ...
                if (counterCellArr != null && (length = counterCellArr.length - 1) >= 0 && (counterCell = counterCellArr[length & ThreadLocalRandom.getProbe()]) != null) {
                    ...
                    boolean zCompareAndSetLong = desugarUnsafe2.compareAndSetLong(counterCell, j4, j5, j5 + j);
                                        ...
                                        while (true) {
                                            ...
                                            if (node4 == null) {
                                                ...
                                                if (objApply3 == null) {
                                                    ...
                                                    node3.next = new Node(iSpread, obj, objApply3);
                                                    objApply = objApply3;
                                                    i3 = 1;
                                                }
                                            } else {
                ...
                if (length != 0) {
                    ...
                    if (nodeTabAt == null) {
                        ...
                        synchronized (reservationNode) {
                            if (casTabAt(nodeArrInitTable, i2, null, reservationNode)) {
                                try {
                                    ...
                                    setTabAt(nodeArrInitTable, i2, objApply != null ? new Node(iSpread, obj, objApply) : null);
                                    obj7 = objApply;
                                    i = 1;
                                } catch (Throwable th) {
                        ...
                        if (i3 == -1) {
                            ...
                            if (i3 == iSpread && (((obj5 = nodeTabAt.key) == obj || (obj5 != null && obj.equals(obj5))) && (obj6 = nodeTabAt.val) != null)) {
                                return obj6;
                            }
                            synchronized (nodeTabAt) {
                                if (tabAt(nodeArrInitTable, i2) == nodeTabAt) {
                                    if (i3 >= 0) {
                                        ...
                                        while (true) {
                                            ...
                                            if (node2 == null) {
                                                ...
                                                if (objApply2 == null) {
                                                    ...
                                                    node.next = new Node(iSpread, obj, objApply2);
                                                    obj3 = objApply2;
                                                }
                                            } else {
                                                i4++;
                                        ...
                                        if (treeNode == null || (treeNodeFindTreeNode = treeNode.findTreeNode(iSpread, obj, null)) == null) {
                                            ...
                                            if (objApply3 != null) {
                                                treeBin.putTreeVal(iSpread, obj, objApply3);
                                                obj2 = objApply3;
                                                obj7 = obj2;
                                                i = 2;
                                            } else {
    ...
    */
    ...
    final Node[] helpTransfer(Node[] nodeArr, Node node) {
        ...
        while (true) {
            if (nodeArr2 != this.nextTable || this.table != nodeArr || (i = this.sizeCtl) >= 0 || (i >>> 16) != iResizeStamp || i == iResizeStamp + 1 || i == 65535 + iResizeStamp || this.transferIndex <= 0) {
                break;
            }
