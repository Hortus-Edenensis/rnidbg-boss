...
public final class LocalDateTime implements Temporal, TemporalAdjuster, ChronoLocalDateTime, Serializable {
    ...
    public static LocalDateTime of(LocalDate localDate, LocalTime localTime) {
        Objects.requireNonNull(localDate, FFmpegMediaMetadataRetriever.METADATA_KEY_DATE);
    ...
    public static LocalDateTime ofEpochSecond(long j, int i, ZoneOffset zoneOffset) {
        ...
        return new LocalDateTime(LocalDate.ofEpochDay(DesugarLocalDate$$ExternalSyntheticBackport1.m(totalSeconds, 86400)), LocalTime.ofNanoOfDay((((long) LocalDateTime$$ExternalSyntheticBackport5.m(totalSeconds, 86400)) * 1000000000) + j2));
    }
    ...
    private LocalDateTime plusWithOverflow(LocalDate localDate, long j, long j2, long j3, long j4, int i) {
        ...
        if ((j | j2 | j3 | j4) == 0) {
            ...
            long jM = (((j4 / 86400000000000L) + (j3 / 86400) + (j2 / 1440) + (j / 24)) * j5) + DesugarLocalDate$$ExternalSyntheticBackport1.m(j6, 86400000000000L);
