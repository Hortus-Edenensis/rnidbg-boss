...
public final class Instant implements Temporal, TemporalAdjuster, Comparable<Instant>, Serializable {
    ...
    public static Instant ofEpochMilli(long j) {
        return create(DesugarLocalDate$$ExternalSyntheticBackport1.m(j, 1000), Instant$$ExternalSyntheticBackport8.m(j, 1000) * 1000000);
    }
    ...
    public Instant plus(long j, TemporalUnit temporalUnit) {
        ...
        switch (AnonymousClass1.$SwitchMap$java$time$temporal$ChronoUnit[((ChronoUnit) temporalUnit).ordinal()]) {
            ...
            case 5:
                return plusSeconds(Duration$$ExternalSyntheticBackport0.m(j, 60));
            case 6:
                return plusSeconds(Duration$$ExternalSyntheticBackport0.m(j, 3600));
            case 7:
                return plusSeconds(Duration$$ExternalSyntheticBackport0.m(j, 43200));
            case 8:
                return plusSeconds(Duration$$ExternalSyntheticBackport0.m(j, 86400));
            default:
    ...
    public long toEpochMilli() {
        ...
        long j = this.seconds;
        if (j >= 0 || this.nanos <= 0) {
            jM = Duration$$ExternalSyntheticBackport0.m(j, 1000);
            i = this.nanos / 1000000;
        } else {
            jM = Duration$$ExternalSyntheticBackport0.m(j + 1, 1000);
