...
public final class DateTimeFormatterBuilder {
    ...
    static final class InstantPrinterParser implements DateTimePrinterParser {
        ...
        public boolean format(DateTimePrintContext dateTimePrintContext, StringBuilder sb) {
            ...
            if (jLongValue >= -62167219200L) {
                ...
                long jM = DesugarLocalDate$$ExternalSyntheticBackport1.m(j, 315569520000L) + 1;
    ...
    static class NumberPrinterParser implements DateTimePrinterParser {
        static final long[] EXCEED_POINTS = {0, 10, 100, 1000, 10000, SilenceSkippingAudioProcessor.DEFAULT_MINIMUM_SILENCE_DURATION_US, 1000000, 10000000, 100000000, 1000000000, RealConnection.IDLE_CONNECTION_HEALTHY_NS};
    ...
    static final class OffsetIdPrinterParser implements DateTimePrinterParser {
        ...
        public boolean format(DateTimePrintContext dateTimePrintContext, StringBuilder sb) {
            ...
            int iM = LocalDate$$ExternalSyntheticBackport5.m(value.longValue());
            if (iM == 0) {
