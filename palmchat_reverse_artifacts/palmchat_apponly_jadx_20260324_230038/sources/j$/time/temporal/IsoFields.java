...
public abstract class IsoFields {
    ...
    private static abstract class Field implements TemporalField {
        ...
        static {
            ...
            QUARTER_DAYS = new int[]{0, 90, MediaPlayer.MEDIA_PLAYER_OPTION_ASYNC_INIT_CODEC, 273, 0, 91, MediaPlayer.MEDIA_PLAYER_OPTION_SET_DEFAULT_CODEC_ID, MediaPlayer.MEDIA_PLAYER_OPTION_VIDEO_HTTP_RES_FINSIH_TIME};
        }
        ...
        public static int getWeek(LocalDate localDate) {
            ...
            if (dayOfYear < i2) {
                return (int) getWeekRange(localDate.withDayOfYear(EffectConstants.ROTATION_DEGREES_180).minusYears(1L)).getMaximum();
            }
