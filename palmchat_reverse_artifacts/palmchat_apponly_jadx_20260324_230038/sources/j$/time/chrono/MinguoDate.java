    ...
    */
    public MinguoDate with(TemporalField temporalField, long j) {
        ...
        if (i == 4) {
            ...
            if (i2 == 4) {
                return with(this.isoDate.withYear(getProlepticYear() >= 1 ? iCheckValidIntValue + FeedNetDao.MOMENT_COMMENT_DELETED : (1 - iCheckValidIntValue) + FeedNetDao.MOMENT_COMMENT_DELETED));
            }
            if (i2 == 6) {
                return with(this.isoDate.withYear(iCheckValidIntValue + FeedNetDao.MOMENT_COMMENT_DELETED));
            }
            if (i2 == 7) {
                return with(this.isoDate.withYear((1 - getProlepticYear()) + FeedNetDao.MOMENT_COMMENT_DELETED));
            }
        } else {
            if (i == 5) {
