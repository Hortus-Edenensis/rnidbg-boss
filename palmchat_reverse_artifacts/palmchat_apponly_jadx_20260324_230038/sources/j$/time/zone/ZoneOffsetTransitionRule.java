...
public final class ZoneOffsetTransitionRule implements Serializable {
    ...
    static ZoneOffsetTransitionRule readExternal(DataInput dataInput) throws IOException {
        ...
        int i4 = (507904 & i) >>> 14;
        TimeDefinition timeDefinition = TimeDefinition.values()[(i & MessageConstant.CommandId.COMMAND_BASE) >>> 12];
        int i5 = (i & 4080) >>> 4;
        int i6 = (i & 12) >>> 2;
        int i7 = i & 3;
        ...
        return of(monthOf, i2, dayOfWeekOf, localTimeOfSecondOfDay, i4 == 24, timeDefinition, zoneOffsetOfTotalSeconds, ZoneOffset.ofTotalSeconds(i6 == 3 ? dataInput.readInt() : zoneOffsetOfTotalSeconds.getTotalSeconds() + (i6 * AMapException.CODE_AMAP_CLIENT_ERRORCODE_MISSSING)), ZoneOffset.ofTotalSeconds(i7 == 3 ? dataInput.readInt() : zoneOffsetOfTotalSeconds.getTotalSeconds() + (i7 * AMapException.CODE_AMAP_CLIENT_ERRORCODE_MISSSING)));
    }
    ...
    public ZoneOffsetTransition createTransition(int i) {
        ...
        TemporalAdjuster temporalAdjusterNextOrSame;
        byte b = this.dom;
        if (b < 0) {
            ...
            if (dayOfWeek != null) {
                temporalAdjusterNextOrSame = TemporalAdjusters.previousOrSame(dayOfWeek);
                localDateOf = localDateOf.with(temporalAdjusterNextOrSame);
            }
        } else {
            localDateOf = LocalDate.of(i, this.month, b);
            DayOfWeek dayOfWeek2 = this.dow;
            if (dayOfWeek2 != null) {
                temporalAdjusterNextOrSame = TemporalAdjusters.nextOrSame(dayOfWeek2);
                localDateOf = localDateOf.with(temporalAdjusterNextOrSame);
            }
        }
    ...
    void writeExternal(DataOutput dataOutput) {
        ...
        int i2 = (totalSeconds2 == 0 || totalSeconds2 == 1800 || totalSeconds2 == 3600) ? totalSeconds2 / AMapException.CODE_AMAP_CLIENT_ERRORCODE_MISSSING : 3;
        int i3 = (totalSeconds3 == 0 || totalSeconds3 == 1800 || totalSeconds3 == 3600) ? totalSeconds3 / AMapException.CODE_AMAP_CLIENT_ERRORCODE_MISSSING : 3;
        DayOfWeek dayOfWeek = this.dow;
