...
public final class ZoneRules implements Serializable {
        ...
        while (epochSecond < j4) {
            ...
            if (offset != this.timeZone.getOffset(j5 * j3)) {
                ...
                while (j5 - epochSecond > 1) {
                    long j7 = j4;
                    long jM = DesugarLocalDate$$ExternalSyntheticBackport1.m(j5 + epochSecond, 2L);
                    long j8 = j5;
    ...
    private int findYear(long j, ZoneOffset zoneOffset) {
        return LocalDate.ofEpochDay(DesugarLocalDate$$ExternalSyntheticBackport1.m(j + ((long) zoneOffset.getTotalSeconds()), 86400)).getYear();
    }
    ...
    public ZoneOffsetTransition previousTransition(Instant instant) {
        ...
        if (iFindYear2 > 1800) {
            ...
            long epochDay = LocalDate.of(AMapException.CODE_AMAP_CLIENT_ERRORCODE_MISSSING, 1, 1).toEpochDay() * 86400;
