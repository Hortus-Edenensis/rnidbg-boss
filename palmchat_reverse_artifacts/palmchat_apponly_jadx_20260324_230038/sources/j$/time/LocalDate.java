...
public final class LocalDate implements Temporal, TemporalAdjuster, ChronoLocalDate, Serializable {
    ...
    public static LocalDate ofEpochDay(long j) {
        ...
        int i = (int) j6;
        int i2 = ((i * 5) + 2) / 153;
        return new LocalDate(ChronoField.YEAR.checkValidIntValue(j5 + j2 + ((long) (i2 / 10))), ((i2 + 2) % 12) + 1, (i - (((i2 * MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_EFFECT_PREDELAY) + 5) / 10)) + 1);
    }
    ...
    public LocalDate plus(long j, TemporalUnit temporalUnit) {
        ...
        switch (AnonymousClass1.$SwitchMap$java$time$temporal$ChronoUnit[((ChronoUnit) temporalUnit).ordinal()]) {
            ...
            case 4:
                return plusYears(j);
            case 5:
                return plusYears(Duration$$ExternalSyntheticBackport0.m(j, 10));
            case 6:
                return plusYears(Duration$$ExternalSyntheticBackport0.m(j, 100));
            case 7:
                return plusYears(Duration$$ExternalSyntheticBackport0.m(j, 1000));
            case 8:
    ...
    public LocalDate plusMonths(long j) {
        ...
        return resolvePreviousValid(ChronoField.YEAR.checkValidIntValue(DesugarLocalDate$$ExternalSyntheticBackport1.m(j2, 12)), LocalDate$$ExternalSyntheticBackport7.m(j2, 12) + 1, this.day);
    }

    public LocalDate plusWeeks(long j) {
        return plusDays(Duration$$ExternalSyntheticBackport0.m(j, 7));
    }
