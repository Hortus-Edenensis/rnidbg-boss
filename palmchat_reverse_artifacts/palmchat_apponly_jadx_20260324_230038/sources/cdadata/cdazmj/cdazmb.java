...
public class cdazmb {
    ...
    public static String f1964a = null;
    public static String b = "";
    public static final Map<String, String> c = new HashMap();
    public static final List<String> d = new cdazma();
    ...
    /* JADX INFO: compiled from: SearchBox */
    public class cdazma extends ArrayList<String> {
        public cdazma() {
    ...
    public static int a(Context context, String str) {
        ...
        try {
            ...
            int i = point.x;
            int i2 = point.y;
            iArr[0] = (rotation == 0 || rotation == 2) ? i : i2;
        ...
        return "width".equals(str) ? iArr[0] : iArr[1];
    }
    ...
    public static String c(Context context) {
        String strC = r67.a().c("aid", "");
        if (!TextUtils.isEmpty(strC)) {
            return strC;
        }
        String string = Settings.Secure.getString(context.getContentResolver(), "android_id");
        if (!(TextUtils.isEmpty(string) ? false : !d.contains(string.toLowerCase(Locale.getDefault())))) {
            string = UUID.randomUUID().toString().replace("-", "");
        }
        r67 r67VarA = r67.a();
        synchronized (r67VarA) {
            r67VarA.f20404a.edit().putString("aid", string).apply();
        }
        return string;
    }
    ...
    public static String d(Context context, int i) {
        ...
        try {
            ...
            strC = r67.a().c(str, "");
            if (TextUtils.isEmpty(strC) && u(context) && (telephonyManager = (TelephonyManager) context.getSystemService("phone")) != null) {
                if (i == -1) {
    ...
    public static String e(Context context, String str, TelephonyManager telephonyManager) {
        try {
            ...
            String strF = f(telephonyManager);
            map.put(str, strF);
            return strF;
        } catch (Throwable th) {
            g57.b("DeviceInfoUtils", th.getMessage());
            return f(telephonyManager);
        }
    }
    ...
    */
    public static String f(TelephonyManager telephonyManager) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            string = !TextUtils.isEmpty(simCarrierIdName) ? simCarrierIdName.toString() : null;
        }
        return TextUtils.isEmpty(string) ? telephonyManager.getSimState() == 5 ? telephonyManager.getSimOperatorName() : "未知" : string;
    }
    ...
    public static String g(String str) {
        ...
        return "os".equals(str) ? strArr[0] : strArr[1];
    }
    ...
    */
    public static String j() throws Throwable {
        MediaDrm mediaDrm;
        r67 r67VarA;
        String strC = r67.a().c("udid", "");
        if (TextUtils.isEmpty(strC)) {
            String str = r57.f20397a;
            String strB = "";
            ...
            try {
                ...
                strB = r57.b(messageDigest.digest());
            ...
            mediaDrm.release();
            if (TextUtils.isEmpty(strB)) {
                strC = y47.k().b(ZMDataSDKManager.getInstance().getContext());
            } else {
                strC = "drm" + e67.d(strB);
            }
            r67VarA = r67.a();
            synchronized (r67VarA) {
                r67VarA.f20404a.edit().putString("udid", strC).apply();
            }
        }
        return strC;
    }
    ...
    public static String k(Context context) {
        ...
        try {
            ...
            if (TextUtils.isEmpty(strC) && u(context)) {
                if (Build.VERSION.SDK_INT < 29 && (telephonyManager = (TelephonyManager) context.getSystemService("phone")) != null) {
                    strC = telephonyManager.getSimSerialNumber();
                }
                r67 r67VarA = r67.a();
                synchronized (r67VarA) {
                    r67VarA.f20404a.edit().putString("iccid", strC).apply();
                }
            }
        } catch (Exception e2) {
            g57.a(e2);
    ...
    /* JADX WARN: Can't wrap try/catch for region: R(12:27|83|76|28|(4:93|29|91|30)|(4:31|(1:33)(1:95)|82|71)|34|85|35|39|82|71) */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:38:0x0099, code lost:
        ...
        defpackage.g57.b("DeviceInfoUtils", r1.getMessage());
     */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:42:0x00a5 -> B:82:0x00f1). Please report as a decompilation issue!!! */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static String l() {
        ...
        try {
            ...
            objInvoke = cls.getMethod("getOsBrand", new Class[0]).invoke(cls, new Object[0]);
        } catch (Throwable th2) {
            g57.b("HasHarmonyOS", th2.getMessage());
        }
        boolean zEqualsIgnoreCase = objInvoke == null ? false : "harmony".equalsIgnoreCase(objInvoke.toString());
        String string = null;
        ...
        try {
            ...
            g57.b("DeviceInfoUtils", th3.getMessage());
        }
        if (TextUtils.isEmpty(str)) {
            str = "";
        }
        ...
        try {
            try {
                inputStreamReader = new InputStreamReader(Runtime.getRuntime().exec("getprop hw_sc.build.platform.version").getInputStream());
                try {
                        ...
                        try {
                            ...
                            if (bufferedReader != null) {
                                try {
                                    ...
                                    g57.b("DeviceInfoUtils", th5.getMessage());
                                }
                            }
            ...
            g57.b("DeviceInfoUtils", e2.getMessage());
        }
        while (true) {
    ...
    */
        ...
        try {
            ...
            if (TextUtils.isEmpty(strC) && u(context) && (telephonyManager = (TelephonyManager) context.getSystemService("phone")) != null) {
                ...
                if (i > 28) {
                    ...
                    r67VarA = r67.a();
                    synchronized (r67VarA) {
                        r67VarA.f20404a.edit().putString(WkParams.IMEI, strC).apply();
                    }
                } else {
                    if (i < 26) {
                        deviceId = telephonyManager.getDeviceId();
    ...
    public static String o(Context context) {
        ...
        try {
            ...
            if (TextUtils.isEmpty(strC) && u(context) && Build.VERSION.SDK_INT < 29 && (telephonyManager = (TelephonyManager) context.getSystemService("phone")) != null) {
                strC = telephonyManager.getSubscriberId();
                r67 r67VarA = r67.a();
                synchronized (r67VarA) {
                    r67VarA.f20404a.edit().putString(WkParams.IMEI, strC).apply();
                }
    ...
    public static String q(Context context) {
        ...
        try {
            ...
            if (TextUtils.isEmpty(strC) && l67.a(context, g.d) && (wifiManager = (WifiManager) context.getApplicationContext().getSystemService("wifi")) != null && (connectionInfo = wifiManager.getConnectionInfo()) != null) {
                strC = connectionInfo.getMacAddress();
                if (!TextUtils.isEmpty(strC)) {
                    if ("02:00:00:00:00:00".equals(strC)) {
                        String strN = n();
                        if (strN == null) {
                            strN = "02:00:00:00:00:00";
                        }
                        strC = strN;
                    }
                    r67 r67VarA = r67.a();
                    synchronized (r67VarA) {
                        r67VarA.f20404a.edit().putString("mac", strC).apply();
                    }
                }
            }
        } catch (Exception e2) {
    ...
    public static boolean u(Context context) {
        return Build.VERSION.SDK_INT > 28 ? l67.a(context, "android.permission.READ_PRECISE_PHONE_STATE") : l67.a(context, g.c);
    }
    ...
    */
    public static String v(Context context) {
        ...
        NetworkCapabilities networkCapabilities;
        try {
            if (!TextUtils.isEmpty(f1964a) && !"NULL".equals(f1964a)) {
                return f1964a;
            }
            ...
            if (telephonyManager != null) {
                if (Build.VERSION.SDK_INT < 30 || !(l67.a(context, g.c) || telephonyManager.hasCarrierPrivileges())) {
                    try {
