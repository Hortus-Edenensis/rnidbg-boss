...
public class GifImageView extends ImageView {
    ...
    private void postInit(b.a aVar) {
        this.mFreezesAnimation = aVar.f20044a;
        int i = aVar.c;
        if (i > 0) {
    ...
    public GifImageView(Context context, AttributeSet attributeSet) {
        ...
        postInit(b.c(this, attributeSet, 0, 0));
    }

    public GifImageView(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        postInit(b.c(this, attributeSet, i, 0));
    }

    @RequiresApi(21)
    public GifImageView(Context context, AttributeSet attributeSet, int i, int i2) {
        super(context, attributeSet, i, i2);
        postInit(b.c(this, attributeSet, i, i2));
    }
}
