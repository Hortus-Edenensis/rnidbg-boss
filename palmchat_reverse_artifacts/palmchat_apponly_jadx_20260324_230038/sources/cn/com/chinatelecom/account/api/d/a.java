...
public final class a {
    ...
    public static cn.com.chinatelecom.account.api.c.d a(Context context, HttpURLConnection httpURLConnection, boolean z) {
        ...
        try {
            ...
            if (list != null && list.size() > 0) {
                ...
                CtAuth.info(f2049a, "request protocol : " + str2);
                dVar.b = false;
            }
    ...
    public static cn.com.chinatelecom.account.api.c.d a(HttpURLConnection httpURLConnection) {
        ...
        try {
            ...
            if (list != null && list.size() > 0) {
                dVar.d = list.get(0);
                CtAuth.info(f2049a, "request method : " + dVar.d);
            }
    ...
    public static JSONObject a(Context context, cn.com.chinatelecom.account.api.c.h hVar, String str, Network network, boolean z, String str2) {
        ...
        if (hVar.f2048a != -1 && !TextUtils.isEmpty(str)) {
            ...
            if (!TextUtils.isEmpty(strOptString)) {
                try {
                    ...
                    if (strA.isEmpty()) {
                        ...
                        if (iOptInt == -10020) {
                            jSONObject.put(WfConstant.EVENT_KEY_TASK_ID, str);
                        }
                        jSONObject.put("data", jSONObject2);
                    }
                } catch (Throwable th) {
                    CtAuth.warn(f2049a, "dct", th);
                    jSONObject.put("result", 80107);
                    jSONObject.put("msg", cn.com.chinatelecom.account.api.a.d.a(j.r));
