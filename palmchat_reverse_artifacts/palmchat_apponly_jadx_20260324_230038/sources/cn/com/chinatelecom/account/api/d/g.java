...
public class g {
    ...
    public static String f2054a = null;
    ...
    public static String e(Context context) {
        int iM = m(context);
        return iM != -101 ? (iM == -1 || iM == 0) ? com.igexin.push.core.b.m : iM != 1 ? iM != 2 ? iM != 3 ? iM != 4 ? Integer.toString(iM) : "5G" : "4G" : "3G" : "2G" : "WIFI";
    }
    ...
    public static String g(Context context) {
        ...
        if (!TextUtils.isEmpty(strF) && !strF.equals(com.igexin.push.core.b.m)) {
            ...
            if (strF.equals("4G")) {
                return BaseWrapper.ENTER_ID_MARKET;
            }
            if (strF.equals("5G")) {
                return "16";
            }
            if (strF.equals("WIFI")) {
                return BaseWrapper.ENTER_ID_GAME_CENTER;
            }
            if (strF.equals("BOTH")) {
                return BaseWrapper.ENTER_ID_AD_SDK;
            }
        }
        return "15";
    }
