...
public class b {
    ...
    private static String f2025a = "RSA/ECB/PKCS1Padding";
    ...
    public static PublicKey a(String str) {
        return KeyFactory.getInstance(EncryptUtils.RSA_ENCRYPT_ALGORITHM).generatePublic(new X509EncodedKeySpec(a.a(str)));
    }
    ...
    public static byte[] a(RSAPublicKey rSAPublicKey, byte[] bArr) throws Exception {
        ...
        try {
            Cipher cipher = Cipher.getInstance(f2025a);
