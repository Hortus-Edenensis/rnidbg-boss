...
public class c {
    ...
    private static final String f2032a = "c";
    ...
    public int c(String str) {
        try {
            ...
            CtAuth.info(f2032a, "STMN_V4 ：" + zBooleanValue);
            return zBooleanValue ? 0 : -2;
        } catch (Throwable th2) {
            CtAuth.warn(f2032a, "STMN_V4_T", th2);
            return -1;
        }
    }
    ...
    public static int a(String str) {
        try {
            ...
            CtAuth.warn(f2032a, "When InetAddress.getByName(),throws exception", th);
            return -1;
        }
    }
