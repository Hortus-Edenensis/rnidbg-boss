...
public class an {
    ...
    private static Random f2072a = new Random();
    private static fw b = new fw(1024);
    ...
    public static String b(byte[] bArr, String str) {
        ...
        try {
            ...
            while (dataInputStream.available() > 0) {
                ...
                str2 = new String(fr.b(bArr, bArr2));
            }
    ...
    public static byte[] a() throws Throwable {
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
        DataOutputStream dataOutputStream = new DataOutputStream(byteArrayOutputStream);
        f2072a.setSeed(System.currentTimeMillis());
        dataOutputStream.writeLong(f2072a.nextLong());
        dataOutputStream.writeLong(f2072a.nextLong());
        dataOutputStream.flush();
        dataOutputStream.close();
