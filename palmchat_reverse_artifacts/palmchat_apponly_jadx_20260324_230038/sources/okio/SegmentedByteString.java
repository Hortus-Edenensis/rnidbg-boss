...
public final class SegmentedByteString extends ByteString {
    ...
    public void copyInto(int offset, byte[] target, int targetOffset, int byteCount) {
        ...
        while (offset < i) {
            ...
            int i5 = i4 + (offset - i2);
            ArraysKt___ArraysJvmKt.copyInto(getSegments()[iSegment], target, targetOffset, i5, i5 + iMin);
            targetOffset += iMin;
            offset += iMin;
            iSegment++;
        }
