...
public class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt {
    ...
    /* JADX INFO: compiled from: SearchBox */
    @Metadata(d1 = {"\u0000\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0000\u0010\u0005\u001a\u00020\u0004\"\u0004\b\u0000\u0010\u0000\"\u0004\b\u0001\u0010\u0001\"\u0004\b\u0002\u0010\u0002*\b\u0012\u0004\u0012\u00028\u00020\u0003H\u008a@"}, d2 = {ExifInterface.GPS_DIRECTION_TRUE, WkAdxAdConfigMg.DSP_NAME_CSJ, "R", "Lkotlin/sequences/SequenceScope;", "", "<anonymous>"}, k = 3, mv = {1, 8, 0})
    ...
    public static final class C14461<R> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super R>, Continuation<? super Unit>, Object> {
        ...
        public C14461(Sequence<? extends T> sequence, Function2<? super Integer, ? super T, ? extends C> function2, Function1<? super C, ? extends Iterator<? extends R>> function1, Continuation<? super C14461> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C14461 c14461 = new C14461(this.$source, this.$transform, this.$iterator, continuation);
            c14461.L$0 = obj;
            return c14461;
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            while (it.hasNext()) {
                ...
                Iterator<R> itInvoke = this.$iterator.invoke(function2.mo5invoke(Boxing.boxInt(i), next));
        ...
        public final Object mo5invoke(SequenceScope<? super R> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C14461) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    public static final class C14501<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C14501(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> function0, Continuation<? super C14501> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C14501 c14501 = new C14501(this.$this_ifEmpty, this.$defaultValue, continuation);
            c14501.L$0 = obj;
            return c14501;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        /* JADX INFO: renamed from: invoke, reason: merged with bridge method [inline-methods] */
        public final Object mo5invoke(SequenceScope<? super T> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C14501) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    public static final class C14511<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public C14511(Sequence<? extends T> sequence, Random random, Continuation<? super C14511> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C14511 c14511 = new C14511(this.$this_shuffled, this.$random, continuation);
            c14511.L$0 = obj;
            return c14511;
        }
        ...
        /* JADX INFO: renamed from: invoke, reason: merged with bridge method [inline-methods] */
        public final Object mo5invoke(SequenceScope<? super T> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C14511) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    public static final <T, C, R> Sequence<R> flatMapIndexed(Sequence<? extends T> source, Function2<? super Integer, ? super T, ? extends C> transform, Function1<? super C, ? extends Iterator<? extends R>> iterator) {
        ...
        Intrinsics.checkNotNullParameter(iterator, "iterator");
        return SequencesKt__SequenceBuilderKt.sequence(new C14461(source, transform, iterator, null));
    }
    ...
    public static final <T> Sequence<T> ifEmpty(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> defaultValue) {
        ...
        return SequencesKt__SequenceBuilderKt.sequence(new C14501(sequence, defaultValue, null));
    }
    ...
    public static final <T> Sequence<T> shuffled(Sequence<? extends T> sequence, Random random) {
        ...
        return SequencesKt__SequenceBuilderKt.sequence(new C14511(sequence, random, null));
    }
