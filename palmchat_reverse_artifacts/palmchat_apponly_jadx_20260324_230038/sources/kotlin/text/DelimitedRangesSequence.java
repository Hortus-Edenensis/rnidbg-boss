        ...
        */
        private final void calcNext() {
            ...
            if (DelimitedRangesSequence.this.limit > 0) {
                ...
                } else if (this.nextSearchIndex <= DelimitedRangesSequence.this.input.length() && (pair = (Pair) DelimitedRangesSequence.this.getNextMatch.mo5invoke(DelimitedRangesSequence.this.input, Integer.valueOf(this.nextSearchIndex))) != null) {
