...
public final class Regex implements Serializable {
    ...
    /* JADX INFO: compiled from: SearchBox */
    @Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0004H\u0002J\u000e\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\u0007J\u000e\u0010\t\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\u0007J\u000e\u0010\n\u001a\u00020\u000b2\u0006\u0010\b\u001a\u00020\u0007¨\u0006\f"}, d2 = {"Lkotlin/text/Regex$Companion;", "", "()V", "ensureUnicodeCase", "", bq.f.z, "escape", "", "literal", "escapeReplacement", "fromLiteral", "Lkotlin/text/Regex;", "kotlin-stdlib"}, k = 1, mv = {1, 8, 0}, xi = 48)
    ...
    /* JADX INFO: compiled from: SearchBox */
    @Metadata(d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0002\b\u0006\n\u0002\u0010\u0000\n\u0002\b\u0002\b\u0002\u0018\u0000 \u000e2\u00060\u0001j\u0002`\u0002:\u0001\u000eB\u0015\u0012\u0006\u0010\u0003\u001a\u00020\u0004\u0012\u0006\u0010\u0005\u001a\u00020\u0006¢\u0006\u0002\u0010\u0007J\b\u0010\f\u001a\u00020\rH\u0002R\u0011\u0010\u0005\u001a\u00020\u0006¢\u0006\b\n\u0000\u001a\u0004\b\b\u0010\tR\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u000b¨\u0006\u000f"}, d2 = {"Lkotlin/text/Regex$Serialized;", "Ljava/io/Serializable;", "Lkotlin/io/Serializable;", "pattern", "", bq.f.z, "", "(Ljava/lang/String;I)V", "getFlags", "()I", "getPattern", "()Ljava/lang/String;", "readResolve", "", "Companion", "kotlin-stdlib"}, k = 1, mv = {1, 8, 0}, xi = 48)
    ...
    public static final class C14731 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super String>, Continuation<? super Unit>, Object> {
        ...
        public C14731(CharSequence charSequence, int i, Continuation<? super C14731> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C14731 c14731 = Regex.this.new C14731(this.$input, this.$limit, continuation);
            c14731.L$0 = obj;
            return c14731;
        }
        ...
        */
        public final Object invokeSuspend(Object obj) {
            ...
            if (i2 == 0) {
                ...
                if (this.$limit != 1 && matcher2.find()) {
                    ...
                    matcher = matcher2;
                    i = 0;
                    string = c14731.$input.subSequence(iEnd, matcher.start()).toString();
                    c14731.L$0 = sequenceScope;
                    c14731.L$1 = matcher;
                    c14731.I$0 = i;
                    c14731.label = 2;
                    if (sequenceScope.yield(string, c14731) == coroutine_suspended) {
                    }
                    iEnd = matcher.end();
                    i++;
                    if (i != c14731.$limit - 1) {
                    }
                    CharSequence charSequence = c14731.$input;
                    string2 = charSequence.subSequence(iEnd, charSequence.length()).toString();
                    c14731.L$0 = null;
                    c14731.L$1 = null;
                    c14731.label = 3;
                    if (sequenceScope.yield(string2, c14731) == coroutine_suspended) {
                    }
                ...
                if (i2 != 1) {
                    ...
                    iEnd = matcher.end();
                    i++;
                    if (i != c14731.$limit - 1 || !matcher.find()) {
                        CharSequence charSequence2 = c14731.$input;
                    ...
                    CharSequence charSequence22 = c14731.$input;
        ...
        public final Object mo5invoke(SequenceScope<? super String> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C14731) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    }
    ...
    public final Sequence<String> splitToSequence(CharSequence input, int limit) {
        Intrinsics.checkNotNullParameter(input, "input");
        StringsKt__StringsKt.requireNonNegativeLimit(limit);
        return SequencesKt__SequenceBuilderKt.sequence(new C14731(input, limit, null));
    }
