...
public final class UArraysKt___UArraysJvmKt$asList$4 extends AbstractList<UShort> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UShort) {
            return m1367containsxj2QHRw(((UShort) obj).getData());
        }
        return false;
    }

    /* JADX INFO: renamed from: contains-xj2QHRw, reason: not valid java name */
    public boolean m1367containsxj2QHRw(short element) {
        return UShortArray.m1175containsxj2QHRw(this.$this_asList, element);
    }

    @Override // kotlin.collections.AbstractList, java.util.List
    public /* bridge */ /* synthetic */ Object get(int i) {
        return UShort.m1115boximpl(m1368getMh2AYeg(i));
    }

    /* JADX INFO: renamed from: get-Mh2AYeg, reason: not valid java name */
    public short m1368getMh2AYeg(int index) {
        return UShortArray.m1179getMh2AYeg(this.$this_asList, index);
    }
    ...
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof UShort) {
            return m1369indexOfxj2QHRw(((UShort) obj).getData());
        }
        return -1;
    }

    /* JADX INFO: renamed from: indexOf-xj2QHRw, reason: not valid java name */
    public int m1369indexOfxj2QHRw(short element) {
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof UShort) {
            return m1370lastIndexOfxj2QHRw(((UShort) obj).getData());
        }
        return -1;
    }

    /* JADX INFO: renamed from: lastIndexOf-xj2QHRw, reason: not valid java name */
    public int m1370lastIndexOfxj2QHRw(short element) {
