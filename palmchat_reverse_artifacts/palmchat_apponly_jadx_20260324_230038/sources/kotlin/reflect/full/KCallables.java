...
public final class KCallables {
    ...
    public static final class C14221<R> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        Object L$2;
        int label;
        ...
        public C14221(Continuation<? super C14221> continuation) {
            super(continuation);
        }
    ...
    */
    public static final <R> Object callSuspend(KCallable<? extends R> kCallable, Object[] objArr, Continuation<? super R> continuation) {
        ...
        if (i2 == 0) {
            ...
            if (objCall == IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    */
    public static final <R> Object callSuspendBy(KCallable<? extends R> kCallable, Map<KParameter, ? extends Object> map, Continuation<? super R> continuation) throws IllegalCallableAccessException {
        ...
        if (continuation instanceof C14221) {
            ...
            int i = c14221.label;
            if ((i & Integer.MIN_VALUE) != 0) {
                c14221.label = i - Integer.MIN_VALUE;
            } else {
                c14221 = new C14221(continuation);
            }
        }
        Object objCallDefaultMethod$kotlin_reflection = c14221.result;
        Object coroutine_suspended = IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i2 = c14221.label;
        if (i2 == 0) {
            ...
            c14221.L$0 = kCallable;
            c14221.L$1 = map;
            c14221.L$2 = kCallableImplAsKCallableImpl;
            c14221.label = 1;
            objCallDefaultMethod$kotlin_reflection = kCallableImplAsKCallableImpl.callDefaultMethod$kotlin_reflection(map, c14221);
            if (objCallDefaultMethod$kotlin_reflection == IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                DebugProbesKt.probeCoroutineSuspended(c14221);
            }
            ...
            kCallable = (KCallable) c14221.L$0;
            ResultKt.throwOnFailure(objCallDefaultMethod$kotlin_reflection);
        }
