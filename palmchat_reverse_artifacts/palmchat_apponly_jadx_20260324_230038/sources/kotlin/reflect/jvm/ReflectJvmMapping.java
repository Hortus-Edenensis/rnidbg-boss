...
public final class ReflectJvmMapping {
    ...
    public static final <T> Constructor<T> getJavaConstructor(KFunction<? extends T> kFunction) {
        ...
        Member memberMo2135getMember = (kCallableImplAsKCallableImpl == null || (caller = kCallableImplAsKCallableImpl.getCaller()) == null) ? null : caller.mo2135getMember();
        if (memberMo2135getMember instanceof Constructor) {
            return (Constructor) memberMo2135getMember;
        }
        return null;
    }
    ...
    public static final Method getJavaMethod(KFunction<?> kFunction) {
        ...
        KCallableImpl<?> kCallableImplAsKCallableImpl = UtilKt.asKCallableImpl(kFunction);
        Member memberMo2135getMember = (kCallableImplAsKCallableImpl == null || (caller = kCallableImplAsKCallableImpl.getCaller()) == null) ? null : caller.mo2135getMember();
        if (memberMo2135getMember instanceof Method) {
            return (Method) memberMo2135getMember;
        }
        return null;
    }
