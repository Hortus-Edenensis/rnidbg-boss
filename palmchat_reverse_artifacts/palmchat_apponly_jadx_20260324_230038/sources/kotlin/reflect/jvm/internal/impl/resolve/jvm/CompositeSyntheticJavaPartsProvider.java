...
public final class CompositeSyntheticJavaPartsProvider implements SyntheticJavaPartsProvider {
    ...
    public List<Name> getMethodNames(LazyJavaResolverContext lazyJavaResolverContext, ClassDescriptor thisDescriptor) {
        ...
        while (it.hasNext()) {
            CollectionsKt__MutableCollectionsKt.addAll(arrayList, ((SyntheticJavaPartsProvider) it.next()).getMethodNames(lazyJavaResolverContext, thisDescriptor));
        }
        return arrayList;
    }
    ...
    public List<Name> getNestedClassNames(LazyJavaResolverContext lazyJavaResolverContext, ClassDescriptor thisDescriptor) {
        ...
        Iterator<T> it = list.iterator();
        while (it.hasNext()) {
            CollectionsKt__MutableCollectionsKt.addAll(arrayList, ((SyntheticJavaPartsProvider) it.next()).getNestedClassNames(lazyJavaResolverContext, thisDescriptor));
        }
        return arrayList;
    }
    ...
    public List<Name> getStaticFunctionNames(LazyJavaResolverContext lazyJavaResolverContext, ClassDescriptor thisDescriptor) {
        ...
        Iterator<T> it = list.iterator();
        while (it.hasNext()) {
            CollectionsKt__MutableCollectionsKt.addAll(arrayList, ((SyntheticJavaPartsProvider) it.next()).getStaticFunctionNames(lazyJavaResolverContext, thisDescriptor));
        }
        return arrayList;
    }
}
