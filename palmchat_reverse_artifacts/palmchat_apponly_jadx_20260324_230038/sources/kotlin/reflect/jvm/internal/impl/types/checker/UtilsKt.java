...
public final class UtilsKt {
    ...
    private static final String debugInfo(TypeConstructor typeConstructor) {
        ...
        for (DeclarationDescriptor declarationDescriptorMo2143getDeclarationDescriptor = typeConstructor.mo2143getDeclarationDescriptor(); declarationDescriptorMo2143getDeclarationDescriptor != null; declarationDescriptorMo2143getDeclarationDescriptor = declarationDescriptorMo2143getDeclarationDescriptor.getContainingDeclaration()) {
            debugInfo$lambda$1$unaryPlus("fqName: " + DescriptorRenderer.FQ_NAMES_IN_TYPES.render(declarationDescriptorMo2143getDeclarationDescriptor), sb);
            debugInfo$lambda$1$unaryPlus("javaClass: " + declarationDescriptorMo2143getDeclarationDescriptor.getClass().getCanonicalName(), sb);
        }
    ...
    public static final KotlinType findCorrespondingSupertype(KotlinType subtype, KotlinType supertype, TypeCheckingProcedureCallbacks typeCheckingProcedureCallbacks) {
        ...
        while (!arrayDeque.isEmpty()) {
            ...
            for (KotlinType immediateSupertype : constructor2.mo2144getSupertypes()) {
