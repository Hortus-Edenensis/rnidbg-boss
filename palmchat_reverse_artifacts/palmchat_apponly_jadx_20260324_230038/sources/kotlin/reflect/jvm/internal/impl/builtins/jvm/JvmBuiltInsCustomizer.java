...
public final class JvmBuiltInsCustomizer implements AdditionalClassPartsProvider, PlatformDependentDeclarationFilter {
    ...
    private final Collection<SimpleFunctionDescriptor> getAdditionalFunctions(ClassDescriptor classDescriptor, Function1<? super MemberScope, ? extends Collection<? extends SimpleFunctionDescriptor>> function1) {
        ...
        final ClassDescriptor classDescriptor2 = (ClassDescriptor) CollectionsKt___CollectionsKt.lastOrNull(collectionMapPlatformClass);
    ...
    private final JDKMemberStatus getJdkMethodStatus(FunctionDescriptor functionDescriptor) {
        ...
        Object objDfs = DFS.dfs(CollectionsKt__CollectionsJVMKt.listOf((ClassDescriptor) containingDeclaration), new DFS.Neighbors(this) { // from class: kotlin.reflect.jvm.internal.impl.builtins.jvm.JvmBuiltInsCustomizer$$Lambda$1
    ...
    public static final Iterable getJdkMethodStatus$lambda$9(JvmBuiltInsCustomizer this$0, ClassDescriptor classDescriptor) {
        ...
        Intrinsics.checkNotNullExpressionValue(collectionMo2144getSupertypes, "it.typeConstructor.supertypes");
        ArrayList arrayList = new ArrayList();
        Iterator<T> it = collectionMo2144getSupertypes.iterator();
        while (it.hasNext()) {
            ClassifierDescriptor classifierDescriptorMo2143getDeclarationDescriptor = ((KotlinType) it.next()).getConstructor().mo2143getDeclarationDescriptor();
            ClassifierDescriptor original = classifierDescriptorMo2143getDeclarationDescriptor != null ? classifierDescriptorMo2143getDeclarationDescriptor.getOriginal() : null;
    ...
    private final boolean isMutabilityViolation(SimpleFunctionDescriptor simpleFunctionDescriptor, boolean z) {
        ...
        Boolean boolIfAny = DFS.ifAny(CollectionsKt__CollectionsJVMKt.listOf(simpleFunctionDescriptor), new DFS.Neighbors() { // from class: kotlin.reflect.jvm.internal.impl.builtins.jvm.JvmBuiltInsCustomizer$$Lambda$0
            @Override // kotlin.reflect.jvm.internal.impl.utils.DFS.Neighbors
            public Iterable getNeighbors(Object obj) {
            ...
            */
            public final Boolean invoke(CallableMemberDescriptor callableMemberDescriptor) {
                ...
                if (callableMemberDescriptor.getKind() == CallableMemberDescriptor.Kind.DECLARATION) {
                    ...
                    z2 = javaToKotlinClassMapper.isMutable((ClassDescriptor) containingDeclaration2);
                }
    ...
    private final boolean isTrivialCopyConstructorFor(ConstructorDescriptor constructorDescriptor, ClassDescriptor classDescriptor) {
        if (constructorDescriptor.getValueParameters().size() == 1) {
            ...
            ClassifierDescriptor classifierDescriptorMo2143getDeclarationDescriptor = ((ValueParameterDescriptor) CollectionsKt___CollectionsKt.single((List) valueParameters)).getType().getConstructor().mo2143getDeclarationDescriptor();
            if (Intrinsics.areEqual(classifierDescriptorMo2143getDeclarationDescriptor != null ? DescriptorUtilsKt.getFqNameUnsafe(classifierDescriptorMo2143getDeclarationDescriptor) : null, DescriptorUtilsKt.getFqNameUnsafe(classDescriptor))) {
                return true;
            }
        }
        return false;
