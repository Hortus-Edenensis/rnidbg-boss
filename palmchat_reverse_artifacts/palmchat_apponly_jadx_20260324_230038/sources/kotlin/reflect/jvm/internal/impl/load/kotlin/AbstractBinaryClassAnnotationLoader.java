...
public abstract class AbstractBinaryClassAnnotationLoader<A, S extends AnnotationsContainer<? extends A>> implements AnnotationLoader<A> {
    ...
    private final List<A> findClassAndLoadMemberAnnotations(ProtoContainer protoContainer, MemberSignature memberSignature, boolean z, boolean z2, Boolean bool, boolean z3) {
        ...
        return (kotlinJvmBinaryClassFindClassWithAnnotationsAndInitializers == null || (list = getAnnotationsContainer(kotlinJvmBinaryClassFindClassWithAnnotationsAndInitializers).getMemberAnnotations().get(memberSignature)) == null) ? CollectionsKt__CollectionsKt.emptyList() : list;
    }
    ...
    private final List<A> loadPropertyAnnotations(ProtoContainer protoContainer, ProtoBuf.Property property, PropertyRelatedElement propertyRelatedElement) {
        ...
        if (propertyRelatedElement == PropertyRelatedElement.PROPERTY) {
            MemberSignature propertySignature = AbstractBinaryClassAnnotationLoaderKt.getPropertySignature(property, protoContainer.getNameResolver(), protoContainer.getTypeTable(), (40 & 8) != 0 ? false : false, (40 & 16) != 0 ? false : true, (40 & 32) != 0);
            return propertySignature == null ? CollectionsKt__CollectionsKt.emptyList() : findClassAndLoadMemberAnnotations$default(this, protoContainer, propertySignature, true, false, Boolean.valueOf(zBooleanValue), zIsMovedFromInterfaceCompanion, 8, null);
        }
        MemberSignature propertySignature2 = AbstractBinaryClassAnnotationLoaderKt.getPropertySignature(property, protoContainer.getNameResolver(), protoContainer.getTypeTable(), (40 & 8) != 0 ? false : true, (40 & 16) != 0 ? false : false, (40 & 32) != 0);
        if (propertySignature2 == null) {
            return CollectionsKt__CollectionsKt.emptyList();
        }
        return StringsKt__StringsKt.contains$default((CharSequence) propertySignature2.getSignature(), (CharSequence) "$delegate", false, 2, (Object) null) != (propertyRelatedElement == PropertyRelatedElement.DELEGATE_FIELD) ? CollectionsKt__CollectionsKt.emptyList() : findClassAndLoadMemberAnnotations(protoContainer, propertySignature2, true, true, Boolean.valueOf(zBooleanValue), zIsMovedFromInterfaceCompanion);
    }
