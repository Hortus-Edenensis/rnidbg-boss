...
public abstract class ClassifierBasedTypeConstructor implements TypeConstructor {
    ...
    public boolean equals(Object obj) {
        ...
        ClassifierDescriptor classifierDescriptorMo2143getDeclarationDescriptor = mo2143getDeclarationDescriptor();
        ClassifierDescriptor classifierDescriptorMo2143getDeclarationDescriptor2 = typeConstructor.mo2143getDeclarationDescriptor();
        if (classifierDescriptorMo2143getDeclarationDescriptor2 != null && hasMeaningfulFqName(classifierDescriptorMo2143getDeclarationDescriptor) && hasMeaningfulFqName(classifierDescriptorMo2143getDeclarationDescriptor2)) {
            return isSameClassifier(classifierDescriptorMo2143getDeclarationDescriptor2);
        }
        return false;
    }
    ...
    public abstract ClassifierDescriptor mo2143getDeclarationDescriptor();
    ...
    public int hashCode() {
        ...
        ClassifierDescriptor classifierDescriptorMo2143getDeclarationDescriptor = mo2143getDeclarationDescriptor();
        int iHashCode = hasMeaningfulFqName(classifierDescriptorMo2143getDeclarationDescriptor) ? DescriptorUtils.getFqName(classifierDescriptorMo2143getDeclarationDescriptor).hashCode() : System.identityHashCode(this);
