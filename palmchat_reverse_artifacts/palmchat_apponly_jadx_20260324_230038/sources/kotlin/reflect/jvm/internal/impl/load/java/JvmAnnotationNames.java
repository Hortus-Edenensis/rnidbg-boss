...
public final class JvmAnnotationNames {
    ...
    static {
        ...
        METADATA_DESC = "L" + JvmClassName.byFqNameWithoutInnerClasses(fqName).getInternalName() + x.aQ;
        DEFAULT_ANNOTATION_MEMBER_NAME = Name.identifier(ActionUtils.PAYMENT_AMOUNT);
        ...
        SERIALIZED_IR_DESC = "L" + JvmClassName.byFqNameWithoutInnerClasses(fqName2).getInternalName() + x.aQ;
