...
public abstract class AbstractClassTypeConstructor extends AbstractTypeConstructor {
    ...
    */
    ...
    public KotlinType defaultSupertypeIfEmpty() {
        if (KotlinBuiltIns.isSpecialClassWithNoSupertypes(mo2143getDeclarationDescriptor())) {
            return null;
        }
    ...
    public Collection<KotlinType> getAdditionalNeighboursInSupertypeGraph(boolean z) {
        DeclarationDescriptor containingDeclaration = mo2143getDeclarationDescriptor().getContainingDeclaration();
        ...
        ClassDescriptor classDescriptorMo2136getCompanionObjectDescriptor = classDescriptor.mo2136getCompanionObjectDescriptor();
        if (z && classDescriptorMo2136getCompanionObjectDescriptor != null) {
            smartList.add(classDescriptorMo2136getCompanionObjectDescriptor.getDefaultType());
        }
        return smartList;
    }
    ...
    public KotlinBuiltIns getBuiltIns() {
        KotlinBuiltIns builtIns = DescriptorUtilsKt.getBuiltIns(mo2143getDeclarationDescriptor());
        if (builtIns == null) {
            $$$reportNull$$$0(1);
        }
        return builtIns;
    ...
    public abstract ClassDescriptor mo2143getDeclarationDescriptor();
    ...
    public boolean isSameClassifier(ClassifierDescriptor classifierDescriptor) {
        ...
        return (classifierDescriptor instanceof ClassDescriptor) && areFqNamesEqual(mo2143getDeclarationDescriptor(), classifierDescriptor);
    }
}
