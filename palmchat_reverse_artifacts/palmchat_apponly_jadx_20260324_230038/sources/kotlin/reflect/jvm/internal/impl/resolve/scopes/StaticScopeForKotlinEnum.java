...
public final class StaticScopeForKotlinEnum extends MemberScopeImpl {
    ...
    public StaticScopeForKotlinEnum(StorageManager storageManager, ClassDescriptor containingClass) {
        ...
        this.properties$delegate = storageManager.createLazyValue(new Function0<List<? extends PropertyDescriptor>>() { // from class: kotlin.reflect.jvm.internal.impl.resolve.scopes.StaticScopeForKotlinEnum$properties$2
            ...
            public final List<? extends PropertyDescriptor> invoke() {
                return CollectionsKt__CollectionsKt.listOfNotNull(DescriptorFactory.createEnumEntriesProperty(this.this$0.containingClass));
            }
        });
    }
    ...
    public /* bridge */ /* synthetic */ ClassifierDescriptor mo2145getContributedClassifier(Name name, LookupLocation lookupLocation) {
    ...
    public List<CallableMemberDescriptor> getContributedDescriptors(DescriptorKindFilter kindFilter, Function1<? super Name, Boolean> nameFilter) {
        ...
        return CollectionsKt___CollectionsKt.plus((Collection) getFunctions(), (Iterable) getProperties());
    }
