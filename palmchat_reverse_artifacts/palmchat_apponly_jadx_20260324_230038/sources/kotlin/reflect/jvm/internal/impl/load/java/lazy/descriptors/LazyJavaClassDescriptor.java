...
public final class LazyJavaClassDescriptor extends ClassDescriptorBase implements JavaClassDescriptor {
        ...
        */
        private final KotlinType getPurelyImplementedSupertype() {
            ...
            if (size2 == size) {
                ...
                TypeProjectionImpl typeProjectionImpl = new TypeProjectionImpl(Variance.INVARIANT, ((TypeParameterDescriptor) CollectionsKt___CollectionsKt.single((List) parameters)).getDefaultType());
        ...
        private final FqName getPurelyImplementsFqNameFromAnnotation() {
            ...
            AnnotationDescriptor annotationDescriptorMo2138findAnnotation = annotations.mo2138findAnnotation(PURELY_IMPLEMENTS_ANNOTATION);
        ...
        public Collection<KotlinType> computeSupertypes() {
            ...
            while (true) {
                ...
                if (kotlinTypeEnhanceSuperType.getConstructor().mo2143getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor) {
                    arrayList2.add(next);
                }
            ...
            if (!arrayList2.isEmpty()) {
                ...
                ClassDescriptor classDescriptorMo2143getDeclarationDescriptor = mo2143getDeclarationDescriptor();
                ...
                errorReporter.reportIncompleteHierarchy(classDescriptorMo2143getDeclarationDescriptor, arrayList3);
            }
        ...
        public ClassDescriptor mo2143getDeclarationDescriptor() {
    ...
    public Collection<ClassDescriptor> getSealedSubclasses() {
        ...
        while (it.hasNext()) {
            ClassifierDescriptor classifierDescriptorMo2143getDeclarationDescriptor = this.c.getTypeResolver().transformJavaType((JavaClassifierType) it.next(), attributes$default).getConstructor().mo2143getDeclarationDescriptor();
