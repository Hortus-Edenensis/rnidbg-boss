    ...
    public AbstractTypeAliasDescriptor(DeclarationDescriptor containingDeclaration, Annotations annotations, Name name, SourceElement sourceElement, DescriptorVisibility visibilityImpl) {
        ...
        this.typeConstructor = new TypeConstructor() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeAliasDescriptor$typeConstructor$1
            ...
            public KotlinBuiltIns getBuiltIns() {
                return DescriptorUtilsKt.getBuiltIns(mo2143getDeclarationDescriptor());
            }
            ...
            public Collection<KotlinType> mo2144getSupertypes() {
                Collection<KotlinType> collectionMo2144getSupertypes = mo2143getDeclarationDescriptor().getUnderlyingType().getConstructor().mo2144getSupertypes();
                Intrinsics.checkNotNullExpressionValue(collectionMo2144getSupertypes, "declarationDescriptor.un…pe.constructor.supertypes");
            ...
            public String toString() {
                return "[typealias " + mo2143getDeclarationDescriptor().getName().asString() + ']';
            }

            @Override // kotlin.reflect.jvm.internal.impl.types.TypeConstructor
            /* JADX INFO: renamed from: getDeclarationDescriptor */
            public TypeAliasDescriptor mo2143getDeclarationDescriptor() {
                return this.this$0;
            }
        };
    }
        ...
        return TypeUtils.contains(getUnderlyingType(), new Function1<UnwrappedType, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeAliasDescriptor.isInner.1
            ...
            public final Boolean invoke(UnwrappedType type) {
                ...
                if (!KotlinTypeKt.isError(type)) {
                    ...
                    ClassifierDescriptor classifierDescriptorMo2143getDeclarationDescriptor = type.getConstructor().mo2143getDeclarationDescriptor();
                    if ((classifierDescriptorMo2143getDeclarationDescriptor instanceof TypeParameterDescriptor) && !Intrinsics.areEqual(((TypeParameterDescriptor) classifierDescriptorMo2143getDeclarationDescriptor).getContainingDeclaration(), abstractTypeAliasDescriptor)) {
                        z = true;
                    }
                }
