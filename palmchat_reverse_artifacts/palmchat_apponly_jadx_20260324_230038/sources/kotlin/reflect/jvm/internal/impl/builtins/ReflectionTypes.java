...
public final class ReflectionTypes {
    ...
    public final ClassDescriptor find(String str, int i) {
        ...
        ClassifierDescriptor classifierDescriptorMo2145getContributedClassifier = getKotlinReflectScope().mo2145getContributedClassifier(nameIdentifier, NoLookupLocation.FROM_REFLECTION);
        ClassDescriptor classDescriptor = classifierDescriptorMo2145getContributedClassifier instanceof ClassDescriptor ? (ClassDescriptor) classifierDescriptorMo2145getContributedClassifier : null;
