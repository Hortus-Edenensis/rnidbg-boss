    ...
    private final SimpleType transformToNewType(SimpleType simpleType) {
        ...
        if (constructor instanceof CapturedTypeConstructorImpl) {
            ...
            if (capturedTypeConstructorImpl.getNewTypeConstructor() == null) {
                ...
                Collection<KotlinType> collectionMo2144getSupertypes = capturedTypeConstructorImpl.mo2144getSupertypes();
                ArrayList arrayList = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(collectionMo2144getSupertypes, 10));
        ...
        if (constructor instanceof IntegerValueTypeConstructor) {
            Collection<KotlinType> collectionMo2144getSupertypes2 = ((IntegerValueTypeConstructor) constructor).mo2144getSupertypes();
            ArrayList arrayList2 = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(collectionMo2144getSupertypes2, 10));
            Iterator<T> it2 = collectionMo2144getSupertypes2.iterator();
            while (it2.hasNext()) {
        ...
        Collection<KotlinType> collectionMo2144getSupertypes3 = intersectionTypeConstructor.mo2144getSupertypes();
        ArrayList arrayList3 = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(collectionMo2144getSupertypes3, 10));
        Iterator<T> it3 = collectionMo2144getSupertypes3.iterator();
        while (it3.hasNext()) {
