...
public final class ClassMapperLite {
    ...
    private static final String f18798kotlin = CollectionsKt___CollectionsKt.joinToString$default(CollectionsKt__CollectionsKt.listOf((Object[]) new Character[]{'k', 'o', 't', 'l', 'i', 'n'}), "", null, null, 0, null, null, 62, null);
    private static final Map<String, String> map;

    static {
        LinkedHashMap linkedHashMap = new LinkedHashMap();
        List listListOf = CollectionsKt__CollectionsKt.listOf((Object[]) new String[]{"Boolean", "Z", "Char", WkAdxAdConfigMg.DSP_NAME_CSJ, "Byte", WkAdxAdConfigMg.DSP_NAME_BAIDU, "Short", ExifInterface.LATITUDE_SOUTH, "Int", "I", "Float", "F", "Long", ContentClassification.AD_CONTENT_CLASSIFICATION_J, "Double", "D"});
        int progressionLastElement = ProgressionUtilKt.getProgressionLastElement(0, listListOf.size() - 1, 2);
        if (progressionLastElement >= 0) {
            int i = 0;
            while (true) {
                StringBuilder sb = new StringBuilder();
                String str = f18798kotlin;
                sb.append(str);
                sb.append('/');
        ...
        linkedHashMap.put(f18798kotlin + "/Unit", ExifInterface.GPS_MEASUREMENT_INTERRUPTED);
        ...
        for (String str5 : CollectionsKt__CollectionsKt.listOf((Object[]) new String[]{"Char", "Byte", "Short", "Int", "Float", "Long", "Double", "String", "Enum"})) {
            map$lambda$0$add(linkedHashMap, str5 + ".Companion", f18798kotlin + "/jvm/internal/" + str5 + "CompanionObject");
        }
        map = linkedHashMap;
    }
    ...
    private static final void map$lambda$0$add(Map<String, String> map2, String str, String str2) {
        map2.put(f18798kotlin + '/' + str, 'L' + str2 + ';');
    }
