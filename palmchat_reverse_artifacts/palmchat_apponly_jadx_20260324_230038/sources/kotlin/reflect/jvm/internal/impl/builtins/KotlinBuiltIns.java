...
public abstract class KotlinBuiltIns {
    ...
    public KotlinBuiltIns(StorageManager storageManager) {
        ...
        this.builtInClassesByName = storageManager.createMemoizedFunction(new Function1<Name, ClassDescriptor>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.KotlinBuiltIns.3
            ...
            public ClassDescriptor invoke(Name name) {
                ClassifierDescriptor classifierDescriptorMo2145getContributedClassifier = KotlinBuiltIns.this.getBuiltInsPackageScope().mo2145getContributedClassifier(name, NoLookupLocation.FROM_BUILTINS);
                ...
                throw new AssertionError("Must be a class descriptor " + name + ", but was " + classifierDescriptorMo2145getContributedClassifier);
            }
        });
    }
    ...
    private static KotlinType getElementTypeForUnsignedArray(KotlinType kotlinType, ModuleDescriptor moduleDescriptor) {
        ...
        if (!unsignedTypes.isShortNameOfUnsignedArray(classifierDescriptorMo2143getDeclarationDescriptor.getName()) || (classId = DescriptorUtilsKt.getClassId(classifierDescriptorMo2143getDeclarationDescriptor)) == null || (unsignedClassIdByArrayClassId = unsignedTypes.getUnsignedClassIdByArrayClassId(classId)) == null || (classDescriptorFindClassAcrossModuleDependencies = FindClassInModuleKt.findClassAcrossModuleDependencies(moduleDescriptor, unsignedClassIdByArrayClassId)) == null) {
            return null;
        }
    ...
    public static PrimitiveType getPrimitiveArrayElementType(KotlinType kotlinType) {
        ...
        return getPrimitiveArrayType(classifierDescriptorMo2143getDeclarationDescriptor);
    }
    ...
    public static boolean isDefaultBound(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(MediaPlayer.MEDIA_PLAYER_OPTION_VIDEO_CODEC_ID);
        }
    ...
    public static boolean isNullableAny(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(MediaPlayer.MEDIA_PLAYER_OPTION_AUDIO_CODEC_ID);
        }
    ...
    public static boolean isPrimitiveArray(KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo2143getDeclarationDescriptor = kotlinType.getConstructor().mo2143getDeclarationDescriptor();
        return (classifierDescriptorMo2143getDeclarationDescriptor == null || getPrimitiveArrayType(classifierDescriptorMo2143getDeclarationDescriptor) == null) ? false : true;
    }
    ...
    public static boolean isPrimitiveTypeOrNullablePrimitiveType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo2143getDeclarationDescriptor = kotlinType.getConstructor().mo2143getDeclarationDescriptor();
        return (classifierDescriptorMo2143getDeclarationDescriptor instanceof ClassDescriptor) && isPrimitiveClass((ClassDescriptor) classifierDescriptorMo2143getDeclarationDescriptor);
    }
    ...
    public static boolean isTypeConstructorForGivenClass(TypeConstructor typeConstructor, FqNameUnsafe fqNameUnsafe) {
        ...
        return (classifierDescriptorMo2143getDeclarationDescriptor instanceof ClassDescriptor) && classFqNameEquals(classifierDescriptorMo2143getDeclarationDescriptor, fqNameUnsafe);
    }
    ...
    public static boolean isUnit(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(MediaPlayer.MEDIA_PLAYER_OPTION_META_DATA_INFO);
        }
    ...
    public static boolean isUnsignedArrayType(KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(MediaPlayer.MEDIA_PLAYER_OPTION_MEDIA_CODEC_SIDE_DATA);
        }
