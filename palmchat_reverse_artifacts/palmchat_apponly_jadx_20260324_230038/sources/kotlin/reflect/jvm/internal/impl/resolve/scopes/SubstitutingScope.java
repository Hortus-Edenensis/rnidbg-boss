...
public final class SubstitutingScope implements MemberScope {
    ...
    public SubstitutingScope(MemberScope workerScope, final TypeSubstitutor givenSubstitutor) {
        ...
        this.substitutor$delegate = LazyKt__LazyJVMKt.lazy(new Function0<TypeSubstitutor>() { // from class: kotlin.reflect.jvm.internal.impl.resolve.scopes.SubstitutingScope$substitutor$2
            {
                super(0);
            }
    ...
    public ClassifierDescriptor mo2145getContributedClassifier(Name name, LookupLocation location) {
        ...
        ClassifierDescriptor classifierDescriptorMo2145getContributedClassifier = this.workerScope.mo2145getContributedClassifier(name, location);
        if (classifierDescriptorMo2145getContributedClassifier != null) {
            return (ClassifierDescriptor) substitute(classifierDescriptorMo2145getContributedClassifier);
        }
        return null;
    }
    ...
    public void mo2149recordLookup(Name name, LookupLocation lookupLocation) {
