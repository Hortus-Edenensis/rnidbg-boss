...
public final class JvmPackageScope implements MemberScope {
    ...
    public ClassifierDescriptor mo2145getContributedClassifier(Name name, LookupLocation location) {
        ...
        ClassDescriptor classDescriptorMo2145getContributedClassifier = this.javaScope.mo2145getContributedClassifier(name, location);
        if (classDescriptorMo2145getContributedClassifier != null) {
            return classDescriptorMo2145getContributedClassifier;
        }
        ClassifierDescriptor classifierDescriptor = null;
        for (MemberScope memberScope : getKotlinScopes()) {
            ClassifierDescriptor classifierDescriptorMo2145getContributedClassifier = memberScope.mo2145getContributedClassifier(name, location);
            if (classifierDescriptorMo2145getContributedClassifier != null) {
                if (!(classifierDescriptorMo2145getContributedClassifier instanceof ClassifierDescriptorWithTypeParameters) || !((ClassifierDescriptorWithTypeParameters) classifierDescriptorMo2145getContributedClassifier).isExpect()) {
