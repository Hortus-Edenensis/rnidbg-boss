...
public abstract class AbstractSignatureParts<TAnnotation> {
    ...
    */
    private final JavaTypeQualifiers extractQualifiersFromAnnotations(TypeAndDefaultQualifiers typeAndDefaultQualifiers) {
        ...
        if (type == null || (listEmptyList = getAnnotations(type)) == null) {
        ...
        if (z2) {
            if (z3 || !getEnableImprovementsInStrictMode()) {
                listEmptyList = CollectionsKt___CollectionsKt.plus((Iterable) getContainerAnnotations(), (Iterable) listEmptyList);
            } else {
                ...
                if (type3 != null && isArrayOrPrimitiveArray(type3)) {
                    ...
                    listEmptyList = CollectionsKt___CollectionsKt.plus((Collection) arrayList, (Iterable) listEmptyList);
                }
            }
        }
    ...
    */
    public final Function1<Integer, JavaTypeQualifiers> computeIndexedQualifiers(KotlinTypeMarker kotlinTypeMarker, Iterable<? extends KotlinTypeMarker> overrides, final TypeEnhancementInfo typeEnhancementInfo, boolean z) {
        ...
        ArrayList arrayList = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(overrides, 10));
        ...
        while (i < size) {
            ...
            while (it3.hasNext()) {
                TypeAndDefaultQualifiers typeAndDefaultQualifiers = (TypeAndDefaultQualifiers) CollectionsKt___CollectionsKt.getOrNull((List) it3.next(), i);
        ...
        return new Function1<Integer, JavaTypeQualifiers>() { // from class: kotlin.reflect.jvm.internal.impl.load.java.typeEnhancement.AbstractSignatureParts.computeIndexedQualifiers.1
            ...
            public final JavaTypeQualifiers invoke(int i2) {
                ...
                return (i2 < 0 || i2 > ArraysKt___ArraysKt.getLastIndex(javaTypeQualifiersArr2)) ? JavaTypeQualifiers.Companion.getNONE() : javaTypeQualifiersArr2[i2];
            }
        };
    }
