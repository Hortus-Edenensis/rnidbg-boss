...
public abstract class GivenFunctionsMemberScope extends MemberScopeImpl {
    ...
    public final List<DeclarationDescriptor> createFakeOverrides(List<? extends FunctionDescriptor> list) {
        ...
        Collection<KotlinType> collectionMo2144getSupertypes = this.containingClass.getTypeConstructor().mo2144getSupertypes();
        Intrinsics.checkNotNullExpressionValue(collectionMo2144getSupertypes, "containingClass.typeConstructor.supertypes");
        ...
        for (Map.Entry entry : linkedHashMap.entrySet()) {
            ...
            for (Map.Entry entry2 : linkedHashMap2.entrySet()) {
                ...
                overridingUtil.generateOverridesInFunctionGroup(name2, list4, collectionEmptyList, this.containingClass, new NonReportingOverrideStrategy() { // from class: kotlin.reflect.jvm.internal.impl.resolve.scopes.GivenFunctionsMemberScope.createFakeOverrides.4
