...
public final class AnnotationConstructorCaller implements Caller {
    ...
    public AnnotationConstructorCaller(Class<?> jClass, List<String> parameterNames, CallMode callMode, Origin origin, List<Method> methods) {
        ...
        if (this.callMode == CallMode.POSITIONAL_CALL && origin == Origin.JAVA && (!CollectionsKt___CollectionsKt.minus(this.parameterNames, ActionUtils.PAYMENT_AMOUNT).isEmpty())) {
    ...
    public /* bridge */ /* synthetic */ Member mo2135getMember() {
