...
public abstract class CallerImpl<M extends Member> implements Caller<M> {
    ...
    public static final class AccessorForHiddenBoundConstructor extends CallerImpl<java.lang.reflect.Constructor<?>> implements BoundCaller {
        ...
        public AccessorForHiddenBoundConstructor(java.lang.reflect.Constructor<?> constructor, Object obj) {
            ...
            super(constructor, declaringClass, cls, (Type[]) (genericParameterTypes.length <= 2 ? new Type[0] : ArraysKt___ArraysJvmKt.copyOfRange(genericParameterTypes, 1, genericParameterTypes.length - 1)), null);
        ...
        public Object call(Object[] args) {
            ...
            checkArguments(args);
            java.lang.reflect.Constructor<?> constructorMo2135getMember = mo2135getMember();
            SpreadBuilder spreadBuilder = new SpreadBuilder(3);
            spreadBuilder.add(this.boundReceiver);
            spreadBuilder.addSpread(args);
            spreadBuilder.add(null);
            return constructorMo2135getMember.newInstance(spreadBuilder.toArray(new Object[spreadBuilder.size()]));
        }
    }
    ...
    public static final class AccessorForHiddenConstructor extends CallerImpl<java.lang.reflect.Constructor<?>> {
        ...
        public AccessorForHiddenConstructor(java.lang.reflect.Constructor<?> constructor) {
            ...
            Type[] genericParameterTypes = constructor.getGenericParameterTypes();
            Intrinsics.checkNotNullExpressionValue(genericParameterTypes, "constructor.genericParameterTypes");
            super(constructor, declaringClass, cls, (Type[]) (genericParameterTypes.length <= 1 ? new Type[0] : ArraysKt___ArraysJvmKt.copyOfRange(genericParameterTypes, 0, genericParameterTypes.length - 1)), null);
        }
    ...
    public static final class Constructor extends CallerImpl<java.lang.reflect.Constructor<?>> {
        ...
        public Object call(Object[] args) {
            Intrinsics.checkNotNullParameter(args, "args");
            checkArguments(args);
            return mo2135getMember().newInstance(Arrays.copyOf(args, args.length));
        }
    }
    ...
    public static abstract class FieldGetter extends CallerImpl<Field> {
        ...
        public static final class BoundInstance extends FieldGetter implements BoundCaller {
            ...
            public Object call(Object[] args) {
                Intrinsics.checkNotNullParameter(args, "args");
                checkArguments(args);
                return mo2135getMember().get(this.boundReceiver);
            }
        }
        ...
        public Object call(Object[] args) {
            Intrinsics.checkNotNullParameter(args, "args");
            checkArguments(args);
            return mo2135getMember().get(getInstanceClass() != null ? ArraysKt___ArraysKt.first(args) : null);
        }
    ...
    public static abstract class FieldSetter extends CallerImpl<Field> {
        ...
        public static final class BoundInstance extends FieldSetter implements BoundCaller {
            ...
            public Object call(Object[] args) throws IllegalAccessException {
                Intrinsics.checkNotNullParameter(args, "args");
                checkArguments(args);
                mo2135getMember().set(this.boundReceiver, ArraysKt___ArraysKt.first(args));
        ...
        public static final class BoundJvmStaticInObject extends FieldSetter implements BoundCaller {
            ...
            public Object call(Object[] args) throws IllegalAccessException {
                Intrinsics.checkNotNullParameter(args, "args");
                checkArguments(args);
                mo2135getMember().set(null, ArraysKt___ArraysKt.last(args));
                return Unit.INSTANCE;
            }
        }
        ...
        public Object call(Object[] args) throws IllegalAccessException {
            Intrinsics.checkNotNullParameter(args, "args");
            checkArguments(args);
            mo2135getMember().set(getInstanceClass() != null ? ArraysKt___ArraysKt.first(args) : null, ArraysKt___ArraysKt.last(args));
            return Unit.INSTANCE;
        }
    ...
    public static abstract class Method extends CallerImpl<java.lang.reflect.Method> {
        ...
        public static final class BoundStatic extends Method implements BoundCaller {
            ...
            public BoundStatic(java.lang.reflect.Method method, Object obj) {
                ...
                super(method, false, (Type[]) (genericParameterTypes.length <= 1 ? new Type[0] : ArraysKt___ArraysJvmKt.copyOfRange(genericParameterTypes, 1, genericParameterTypes.length)), null);
                this.boundReceiver = obj;
            }
        ...
        /* JADX INFO: compiled from: SearchBox */
        @Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0011\n\u0002\b\u0002\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u001b\u0010\u0005\u001a\u0004\u0018\u00010\u00062\n\u0010\u0007\u001a\u0006\u0012\u0002\b\u00030\bH\u0016¢\u0006\u0002\u0010\t¨\u0006\n"}, d2 = {"Lkotlin/reflect/jvm/internal/calls/CallerImpl$Method$Static;", "Lkotlin/reflect/jvm/internal/calls/CallerImpl$Method;", ActionUtils.METHOD, "Ljava/lang/reflect/Method;", "(Ljava/lang/reflect/Method;)V", NotificationCompat.CATEGORY_CALL, "", "args", "", "([Ljava/lang/Object;)Ljava/lang/Object;", "kotlin-reflection"}, k = 1, mv = {1, 8, 0}, xi = 48)
        ...
        public final Object callMethod(Object instance, Object[] args) {
            Intrinsics.checkNotNullParameter(args, "args");
            return this.isVoidMethod ? Unit.INSTANCE : mo2135getMember().invoke(instance, Arrays.copyOf(args, args.length));
        }
    ...
    public final M mo2135getMember() {
        return this.member;
    }
    ...
    */
    private CallerImpl(M m, Type type, Class<?> cls, Type[] typeArr) {
        ...
        if (cls != null) {
            ...
            list = list == null ? ArraysKt___ArraysKt.toList(typeArr) : list;
        }
