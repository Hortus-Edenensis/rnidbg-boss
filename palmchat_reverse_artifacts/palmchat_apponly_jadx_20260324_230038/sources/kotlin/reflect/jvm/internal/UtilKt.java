...
public final class UtilKt {
    ...
    */
    private static final Object arrayToRuntimeValue(ArrayValue arrayValue, ClassLoader classLoader) {
        ...
        switch (primitiveArrayElementType == null ? -1 : WhenMappings.$EnumSwitchMapping$0[primitiveArrayElementType.ordinal()]) {
            case -1:
                ...
                ClassifierDescriptor classifierDescriptorMo2143getDeclarationDescriptor = type2.getConstructor().mo2143getDeclarationDescriptor();
    ...
    public static final <M extends MessageLite, D extends CallableDescriptor> D deserializeToDescriptor(Class<?> moduleAnchor, M proto, NameResolver nameResolver, TypeTable typeTable, BinaryVersion metadataVersion, Function2<? super MemberDeserializer, ? super M, ? extends D> createDescriptor) {
        ...
        return createDescriptor.mo5invoke(new MemberDeserializer(new DeserializationContext(deserialization, nameResolver, module, typeTable, empty, metadataVersion, null, null, typeParameters)), proto);
    }
    ...
    private static final Object toRuntimeValue(ConstantValue<?> constantValue, ClassLoader classLoader) {
        ...
        if (constantValue instanceof EnumValue) {
            ...
            ClassifierDescriptor classifierDescriptorMo2143getDeclarationDescriptor = ((KClassValue.Value.LocalClass) value2).getType().getConstructor().mo2143getDeclarationDescriptor();
            ClassDescriptor classDescriptor = classifierDescriptorMo2143getDeclarationDescriptor instanceof ClassDescriptor ? (ClassDescriptor) classifierDescriptorMo2143getDeclarationDescriptor : null;
            if (classDescriptor != null) {
    ...
    /* JADX WARN: Type inference failed for: r7v2, types: [java.util.ArrayList, java.util.Collection] */
        ...
        if (z) {
            ...
            for (Annotation annotation : iterable) {
                ...
                if (!Intrinsics.areEqual(javaClass.getSimpleName(), "Container") || javaClass.getAnnotation(RepeatableContainer.class) == null) {
                    ...
                    Object objInvoke = javaClass.getDeclaredMethod(ActionUtils.PAYMENT_AMOUNT, new Class[0]).invoke(annotation, new Object[0]);
    ...
    private static final Class<?> loadClass(ClassLoader classLoader, String str, String str2, int i) {
        ...
        if (i > 0) {
            str3 = StringsKt__StringsJVMKt.repeat("[", i) + 'L' + str3 + ';';
        }
