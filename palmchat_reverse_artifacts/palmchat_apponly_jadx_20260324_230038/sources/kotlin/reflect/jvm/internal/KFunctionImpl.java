        ...
        this.caller = ReflectProperties.lazy(new Function0<Caller<? extends Executable>>() { // from class: kotlin.reflect.jvm.internal.KFunctionImpl$caller$2
            ...
            public final Caller<? extends Executable> invoke() {
                ...
                if (constructor instanceof Constructor) {
                    ...
                    callerCreateInstanceMethodCaller = !Modifier.isStatic(method.getModifiers()) ? this.this$0.createInstanceMethodCaller(method) : this.this$0.getDescriptor().getAnnotations().mo2138findAnnotation(UtilKt.getJVM_STATIC()) != null ? this.this$0.createJvmStaticInObjectCaller(method) : this.this$0.createStaticMethodCaller(method);
                }
            ...
            */
            public final Caller<? extends Executable> invoke() {
                ...
                if (jvmFunctionSignatureMapSignature instanceof JvmFunctionSignature.KotlinFunction) {
                    ...
                    Intrinsics.checkNotNull(this.this$0.getCaller().mo2135getMember());
                ...
                } else if (this.this$0.getDescriptor().getAnnotations().mo2138findAnnotation(UtilKt.getJVM_STATIC()) != null) {
                    DeclarationDescriptor containingDeclaration = this.this$0.getDescriptor().getContainingDeclaration();
                    Intrinsics.checkNotNull(containingDeclaration, "null cannot be cast to non-null type org.jetbrains.kotlin.descriptors.ClassDescriptor");
                    callerCreateJvmStaticInObjectCaller = !((ClassDescriptor) containingDeclaration).isCompanionObject() ? this.this$0.createJvmStaticInObjectCaller((Method) genericDeclarationFindDefaultConstructor) : this.this$0.createStaticMethodCaller((Method) genericDeclarationFindDefaultConstructor);
                }
                if (callerCreateJvmStaticInObjectCaller != null) {
                    return InlineClassAwareCallerKt.createInlineClassAwareCallerIfNeeded(callerCreateJvmStaticInObjectCaller, this.this$0.getDescriptor(), true);
                }
                return null;
            }
        });
