...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public final long m2323adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m2335constructorimpl(LongSaturatedMathKt.m2321saturatingAddpTJri5U(timeMark, duration));
    }

    /* JADX INFO: renamed from: differenceBetween-fRLX17w, reason: not valid java name */
    public final long m2324differenceBetweenfRLX17w(long one, long another) {
    ...
    public final long m2325elapsedFrom6eNON_k(long timeMark) {
        return LongSaturatedMathKt.saturatingDiff(read(), timeMark);
    }

    @Override // kotlin.time.TimeSource.WithComparableMarks, kotlin.time.TimeSource
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m2332boximpl(m2326markNowz9LOYto());
    }

    /* JADX INFO: renamed from: markNow-z9LOYto, reason: not valid java name */
    public long m2326markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m2335constructorimpl(read());
    }
