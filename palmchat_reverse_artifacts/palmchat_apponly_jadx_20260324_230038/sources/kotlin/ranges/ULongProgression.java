...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final ULongProgression m2096fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM1014constructorimpl = ((int) ULong.m1014constructorimpl(j ^ ULong.m1014constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM1014constructorimpl2 = (iM1014constructorimpl + ((int) ULong.m1014constructorimpl(j2 ^ ULong.m1014constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return ((int) (j3 ^ (j3 >>> 32))) + iM1014constructorimpl2;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.m1060toStringimpl(this.first));
            sb.append("..");
            sb.append((Object) ULong.m1060toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m2070getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
}
