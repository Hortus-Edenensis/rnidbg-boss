...
class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    */
    public static final boolean copyRecursively(File file, File target, boolean z, final Function2<? super File, ? super IOException, ? extends OnErrorAction> onError) {
        ...
        if (!file.exists()) {
            return onError.mo5invoke(file, new NoSuchFileException(file, null, "The source file doesn't exist.", 2, null)) != OnErrorAction.TERMINATE;
        }
        try {
            for (File file2 : FilesKt__FileTreeWalkKt.walkTopDown(file).onFail(new Function2<File, IOException, Unit>() { // from class: kotlin.io.FilesKt__UtilsKt.copyRecursively.2
                ...
                public /* bridge */ /* synthetic */ Unit mo5invoke(File file3, IOException iOException) throws TerminateException {
                ...
                public final void invoke2(File f, IOException e) throws TerminateException {
                    ...
                    if (onError.mo5invoke(f, e) == OnErrorAction.TERMINATE) {
                ...
                if (file2.exists()) {
                    ...
                    if (file3.exists() && (!file2.isDirectory() || !file3.isDirectory())) {
                        if (z) {
                            if (file3.isDirectory()) {
                                z2 = deleteRecursively(file3) ? false : true;
                            } else if (!file3.delete()) {
                            }
                            if (!z2) {
                                if (onError.mo5invoke(file3, new FileAlreadyExistsException(file2, file3, "The destination file already exists.")) == OnErrorAction.TERMINATE) {
                                    return false;
                                }
                            }
                        } else if (!z2) {
                    ...
                    if (file2.isDirectory()) {
                        file3.mkdirs();
                    } else if (copyTo$default(file2, file3, z, 0, 4, null).length() != file2.length() && onError.mo5invoke(file2, new IOException("Source file wasn't copied completely, length of destination file differs.")) == OnErrorAction.TERMINATE) {
                        return false;
                    }
                } else if (onError.mo5invoke(file2, new NoSuchFileException(file2, null, "The source file doesn't exist.", 2, null)) == OnErrorAction.TERMINATE) {
                    return false;
                }
            }
            return true;
    ...
    public static /* synthetic */ boolean copyRecursively$default(File file, File file2, boolean z, Function2 function2, int i, Object obj) {
        ...
        if ((i & 4) != 0) {
            function2 = new Function2() { // from class: kotlin.io.FilesKt__UtilsKt.copyRecursively.1
                ...
                public final Void mo5invoke(File file3, IOException exception) throws IOException {
