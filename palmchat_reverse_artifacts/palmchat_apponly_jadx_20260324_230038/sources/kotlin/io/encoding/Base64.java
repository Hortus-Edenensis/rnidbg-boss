...
public class Base64 {
    ...
    private static final byte[] mimeLineSeparatorSymbols = {dn.k, 10};
    ...
    private final int decodeImpl(byte[] source, byte[] destination, int destinationOffset, int startIndex, int endIndex) {
        ...
        while (true) {
            ...
            if (i4 == i && iHandlePaddingSymbol + 3 < endIndex) {
                int i5 = iHandlePaddingSymbol + 1;
                int i6 = iArr[source[iHandlePaddingSymbol] & UByte.MAX_VALUE];
                int i7 = i5 + 1;
                int i8 = iArr[source[i5] & UByte.MAX_VALUE];
                int i9 = i7 + 1;
                int i10 = iArr[source[i7] & UByte.MAX_VALUE];
                int i11 = i9 + 1;
                int i12 = (i10 << 6) | (i6 << 18) | (i8 << 12) | iArr[source[i9] & UByte.MAX_VALUE];
                if (i12 >= 0) {
                    int i13 = i2 + 1;
                    destination[i2] = (byte) (i12 >> 16);
                    int i14 = i13 + 1;
                    destination[i13] = (byte) (i12 >> 8);
                    destination[i14] = (byte) i12;
                    i2 = i14 + 1;
                    iHandlePaddingSymbol = i11;
                    i = -8;
                } else {
                    iHandlePaddingSymbol = i11 - 4;
                }
            }
            int i15 = source[iHandlePaddingSymbol] & UByte.MAX_VALUE;
            int i16 = iArr[i15];
            if (i16 >= 0) {
                ...
                if (!this.isMimeScheme) {
                    ...
                    sb.append((char) i15);
                    sb.append("'(");
                    String string = Integer.toString(i15, CharsKt__CharJVMKt.checkRadix(8));
