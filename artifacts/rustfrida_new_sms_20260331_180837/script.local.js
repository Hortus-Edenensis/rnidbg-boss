...
function summarizeSw4State(sw4Obj) {
    ...
    return {
        ...
        body_map_json: hasMeaningfulJson(mapJson) ? mapJson : summarizeJavaValue(mapValue).json,
        body_map_decode_mode: hasMeaningfulJson(mapJson) ? "java_map_passive" : summarizeJavaValue(mapValue).decode_mode,
        header_map_text: headerText,
        header_map_json: hasMeaningfulJson(headerJson) ? headerJson : summarizeJavaValue(headerValue).json,
        header_map_decode_mode: hasMeaningfulJson(headerJson) ? "java_map_passive" : summarizeJavaValue(headerValue).decode_mode,
