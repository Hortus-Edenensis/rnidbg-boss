...
function hookSw4Producer() {
    try {
        ...
        dOv.impl = function(ctx) {
            ...
            var mapSummary = summarizeJavaValue(readJavaInstanceField(ctx.thisObj, "f20862a"));
            var jsonSummary = summarizeJavaValue(readJavaInstanceField(ctx.thisObj, "e"));
            var fieldSnapshot = null;
            ...
            emitEvidence({
                ...
                body_map_text: mapSummary.text,
                body_map_json: mapSummary.json,
                body_map_decode_mode: mapSummary.decode_mode,
                body_json_field_text: jsonSummary.text,
                body_json_field_json: jsonSummary.json,
                body_json_field_decode_mode: jsonSummary.decode_mode,
