...
function summarizeSw4State(sw4Obj) {
    ...
    return {
        body_map_text: javaValueToText(mapValue),
        body_map_json: summarizeJavaValue(mapValue).json,
        body_map_decode_mode: summarizeJavaValue(mapValue).decode_mode,
        header_map_text: javaValueToText(headerValue),
        header_map_json: summarizeJavaValue(headerValue).json,
        header_map_decode_mode: summarizeJavaValue(headerValue).decode_mode,
